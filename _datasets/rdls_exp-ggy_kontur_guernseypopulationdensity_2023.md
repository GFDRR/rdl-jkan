...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-guernsey
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-guernsey
dataset_id: rdls_exp-ggy_kontur_guernseypopulationdensity_2023
description: 'Guernsey population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-guernsey]'
...
exposure:
- asset_type:
    description: Gridded population density for Guernsey at 400m H3 hexagon resolution,
      derived from fusion of GHSL, Facebook HRSL, Microsoft Buildings, and other datasets
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: The Kontur Population dataset was constructed by overlapping the Global
    ...
    (HRSL) and additional building footprint data from Microsoft Buildings, Copernicus
    land cover, Land Information New Zealand, and OpenStreetMap. Population counts
    were disaggregated and allocated to 400m H3 hexagonal grid cells using a dasymetric
    mapping approach. The resulting dataset provides sub-national gridded population
    density for Guernsey, suitable for use as an exposure layer in disaster risk assessments.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-guernsey
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Guernsey: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_GG_20220630.gpkg.gz
  format: null
  id: resource_9d13b61e
  ...
  title: kontur_population_GG_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Guernsey: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_GG_20231101.gpkg.gz
  format: null
  id: resource_9557f243
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_GG_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ggy_kontur_guernseypopulationdensity_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Guernsey: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
