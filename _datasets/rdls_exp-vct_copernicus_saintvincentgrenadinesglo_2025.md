...
- entity:
    ...
    url: https://data.humdata.org/dataset/vct-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/vct-ghsl
dataset_id: rdls_exp-vct_copernicus_saintvincentgrenadinesglo_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/vct-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams,
    ...
    area and population distribution at global scale, applied here to Saint Vincent
    and the Grenadines.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vct-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/2a40b337-5e68-4e58-8023-103110ec3cd2/resource/dc854acf-4a70-496d-88cc-d19b2e623fee/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_vct.tif
  format: null
  id: resource_dc854acf
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Saint Vincent and the Grenadines: Copernicus Global Human Settlement
    Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system:
    Mollweide)'
  download_url: https://data.humdata.org/dataset/2a40b337-5e68-4e58-8023-103110ec3cd2/resource/b226d934-866b-4a4a-b036-840bca78b84f/download/ghs_pop_e2025_r2023a_54009_100_v1_0_vct.tif
  format: null
  id: resource_b226d934
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-vct_copernicus_saintvincentgrenadinesglo_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Saint Vincent and the Grenadines: Copernicus Global Human Settlement Layer
  (GHSL)'
version: null
vulnerability: null
---
