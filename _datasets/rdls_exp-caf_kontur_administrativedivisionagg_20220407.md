...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-central-african-republic
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-central-african-republic
dataset_id: rdls_exp-caf_kontur_administrativedivisionagg_20220407
description: 'Central African Republic administrative division with aggregated population.
  Built from Kontur Population: Global Population Density for 400m H3 Hexagons on
  top of OpenStreetMap administrative boundaries data. Enriched with HASC codes for
  regions taken from Wikidata. Gobal version of boundaries dataset: Kontur Boundaries:
  Global administrative division with aggregated population. [Source: This metadata
  record was automatically extracted from the Humanitarian Data Exchange (HDX); Original
  dataset: https://data.humdata.org/dataset/kontur-boundaries-central-african-republic]'
...
- asset_type:
    description: Aggregated population counts at administrative division level derived
      from Kontur global population density dataset
    id: population
    scheme: null
    title: null
    uri: null
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries for Central African Republic were extracted
    from OpenStreetMap and enhanced with proprietary methods. Population counts were
    aggregated from the Kontur global population density dataset (400m H3 hexagons)
    to administrative division level. HASC codes were enriched from Wikidata to provide
    standardized administrative identifiers.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-central-african-republic
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Central African Republic: Administrative Division with Aggregated
    Population (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_CF_20220407.gpkg.gz
  format: null
  id: resource_95385d45
  ...
  title: kontur_boundaries_CF_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_CF_20230628.gpkg.gz
  format: null
  id: resource_ae7d6714
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_CF_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Central African Republic: Administrative Division with Aggregated
    Population (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_CF_20230628.gpkg.gz
  format: null
  id: resource_9378abd3
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_CF_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-caf_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Central African Republic: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
