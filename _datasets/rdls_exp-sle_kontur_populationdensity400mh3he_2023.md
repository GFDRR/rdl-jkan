...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-sierra-leone
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-sierra-leone
dataset_id: rdls_exp-sle_kontur_populationdensity400mh3he_2023
description: 'Sierra Leone population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-sierra-leone]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    and aggregating population counts to 400m H3 hexagonal grid cells using the H3
    hierarchical spatial indexing system. The resulting dataset provides baseline
    population exposure at sub-kilometer resolution for Sierra Leone.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-sierra-leone
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Sierra Leone: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_SL_20220630.gpkg.gz
  format: null
  id: resource_0e97012e
  ...
  title: kontur_population_SL_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Sierra Leone: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_SL_20231101.gpkg.gz
  format: null
  id: resource_9682a1d4
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_SL_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sle_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Sierra Leone: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
