...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-georgia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-georgia
dataset_id: rdls_exp-geo_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-georgia]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    for the Global Assessment Report on Disaster Risk Reduction (GAR15) to create
    a spatially-explicit global exposure inventory for risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-georgia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Georgia.zip
  download_url: https://data.humdata.org/dataset/743e4605-d7c5-4889-a6f0-3587715d9381/resource/e775a9c2-642e-407c-84d0-d94de1d796cd/download/geo.zip
  format: null
  id: resource_e775a9c2
  ...
  title: GAR15 Global Exposure Dataset for Georgia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-geo_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Georgia
version: null
vulnerability: null
---
