...
- entity:
    ...
    url: https://data.humdata.org/dataset/bermuda-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/bermuda-road-surface-data
dataset_id: rdls_exp-bmu_heigit_bermudaroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bermuda-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    learning model to classify and predict surface types (paved vs unpaved). The model
    generated predictions for roads with missing or incomplete surface information,
    producing a comprehensive road surface inventory with both observed and predicted
    classifications across Bermuda.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bermuda-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Bermuda: Road Surface Data (GeoJSON data for Bermuda.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bmu_roadsurface_lines.geojson
  format: null
  id: resource_ae8ea4c8
  ...
  title: Bermuda GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Bermuda: Road Surface Data (Geopackage data for Bermuda.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bmu_roadsurface_lines.gpkg
  format: null
  id: resource_7100644c
  ...
  temporal: null
  temporal_resolution: null
  title: Bermuda GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bmu_heigit_bermudaroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Bermuda: Road Surface Data'
version: null
vulnerability: null
---
