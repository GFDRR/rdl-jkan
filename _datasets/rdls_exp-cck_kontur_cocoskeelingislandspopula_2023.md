...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-cocos-keeling-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-cocos-keeling-islands
dataset_id: rdls_exp-cck_kontur_cocoskeelingislandspopula_2023
description: 'Cocos (Keeling) Islands population density for 400m H3 hexagons. Built
  from Kontur Population: Global Population Density for 400m H3 Hexagons Vector H3
  hexagons with population counts at 400m resolution. Fixed up fusion of GHSL, Facebook,
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-cocos-keeling-islands]'
...
- asset_type:
    description: Gridded population counts at 400m H3 hexagon resolution derived from
      multi-source settlement data fusion
    id: population
    scheme: null
    title: null
    uri: null
...
license: CC-BY-4.0
lineage:
  description: Population density was derived by fusing multiple global and regional
    datasets (GHSL, HRSL, Microsoft Buildings, Copernicus Land Cover, LINZ, and OpenStreetMap)
    to create a consistent settlement layer. Population counts were then allocated
    to H3 hexagonal grid cells at 400m resolution using spatial overlay and density
    estimation techniques. The resulting dataset provides gridded baseline population
    exposure for the Cocos (Keeling) Islands.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-cocos-keeling-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Cocos (Keeling) Islands: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CC_20220630.gpkg.gz
  format: null
  id: resource_53871f7a
  ...
  title: kontur_population_CC_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Cocos (Keeling) Islands: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CC_20231101.gpkg.gz
  format: null
  id: resource_4e4f761c
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_CC_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cck_kontur_cocoskeelingislandspopula_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Cocos (Keeling) Islands: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
