...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/guy-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/guy-rainfall-subnational
dataset_id: rdls_hzd-guy_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/guy-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery integrated
    ...
    units. Dekadal rainfall indicators including 10-day totals, 1-month and 3-month
    rolling aggregations, and long-term averages were computed to support drought
    monitoring and early warning. CHIRPS-GEFS forecasts provide short-term predictive
    rainfall indicators.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guy-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135537993348_88df2655'
  download_url: https://data.humdata.org/dataset/c3ea5976-c7c7-42a7-9d18-4c1f623caf27/resource/42761449-7083-471f-9eda-6ce9c63ce979/download/guy-rainfall-subnat-full.csv
  format: null
  id: resource_42761449
  media_type: text/csv
  spatial: null
  ...
  title: guy-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135537993348_88df2655'
  download_url: https://data.humdata.org/dataset/c3ea5976-c7c7-42a7-9d18-4c1f623caf27/resource/f52637e1-06f5-4b7c-8f91-9a916287b361/download/guy-rainfall-subnat-5ytd.csv
  format: null
  id: resource_f52637e1
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: guy-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-guy_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Guyana: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
