...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-tto_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Trinidad and Tobago. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539774
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539774
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Trinidad and Tobago, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16539774/files/TTO.zip
  format: null
  id: resource_sdkicra_tto
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Trinidad
    and Tobago
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-tto_nismod_sdkicra
spatial:
  bbox:
  - -61.93
  - 10.04
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3573591/trinidad-and-tobago.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Trinidad
  and Tobago
version: 0.1.0
vulnerability: null
---
