...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-norway
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-norway
dataset_id: rdls_exp-nor_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-norway]'
...
lineage:
  description: The GAR15 global exposure dataset for Norway was developed using a
    ...
    economic values of exposed assets across the country.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-norway
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Norway.zip
  download_url: https://data.humdata.org/dataset/766a5dd8-eb50-43bb-8d43-c20e2f51b955/resource/afd7d764-a9f9-44a1-bf77-193c694e9798/download/nor.zip
  format: null
  id: resource_afd7d764
  ...
  title: GAR15 Global Exposure Dataset for Norway.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nor_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Norway
version: null
vulnerability: null
---
