...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-slb_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Solomon Islands. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540204
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540204
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Solomon Islands, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16540204/files/SLB.zip
  format: null
  id: resource_sdkicra_slb
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Solomon
    Islands
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-slb_nismod_sdkicra
spatial:
  bbox:
  - 155.51
  - -12.29
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2103350/solomon-islands.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Solomon Islands
version: 0.1.0
vulnerability: null
---
