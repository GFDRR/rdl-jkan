...
- entity:
    ...
    url: https://data.humdata.org/dataset/philippines---risk-assessment-indicators
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/philippines---risk-assessment-indicators
dataset_id: rdls_ev-phl_heigit_riskassessmentindicators_2025
description: 'This dataset provides comprehensive Risk Assessment Indicators for Philippines
  ...
  on HDX COD-AB boundaries. Data Overview Access to Services ( PHL_ADM2_access ) Facilities
  ( PHL_ADM2_facilities ) Coping Capacity ( PHL_ADM2_coping ) Demographics ( PHL_ADM2_demographics
  ) Rural Population ( PHL_ADM2_rural_population ) Vulnerability ( PHL_ADM2_vulnerability
  ) Flood Exposure ( PHL_ADM2_flood_exposure ) Cyclone Exposure ( PHL_ADM2_cyclone_exposure
  ) Indicator Descriptions Access to Services ( PHL_ADM2_access ) Represents the share
  ...
  care facility Data Source: openrouteservice (ORS) Facilities ( PHL_ADM2_facilities
  ...
  Data Source: OpenStreetMap (OSM) Coping Capacity ( PHL_ADM2_coping ) Combines Access
  to Services and Facilities data to represent a district''s coping capacity. Demographics
  ( PHL_ADM2_demographics ) Shows the population composition by age and gender. ADM2_PCODE
  ...
  PHL_ADM2_rural_population ) Same demographic breakdown as above, but limited to
  ...
  PHL_ADM2_vulnerability ) Combines Demographics and Rural Population indicators.
  Flood Exposure ( PHL_ADM2_flood_exposure ) Shows population and facility exposure
  ...
  Exposure ( PHL_ADM2_cyclone_exposure ) Represents the exposure of populations and
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/philippines---risk-assessment-indicators]'
details: null
exposure:
- asset_type:
    description: Demographic population data including rural population distribution
      at admin level 2
    id: population
    scheme: null
    title: null
...
- asset_type:
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: count
- asset_type:
    description: Building stock exposed to flood and cyclone hazards at admin level
      2
    id: buildings
    scheme: null
    title: null
...
lineage:
  description: This dataset aggregates multiple risk assessment indicators from diverse
    ...
    data) processed through HeiGIT's GAIA indicators methodology and spatially aggregated
    to Philippines admin level 2 boundaries to support structured risk assessment
    for flood and cyclone hazards.
  sources:
  - id: source_1
    license: null
    name: HeiGIT GAIA Indicators
...
- access_url: null
  ...
  description: Philippines - Risk Assessment Indicators (PHL_ADM2_facilities.csv -
    Risk assessment indicator for Philippines)
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/risk_assessment_inputs/phl/PHL_ADM2_facilities.csv
  format: null
  id: resource_84de57ff
  media_type: text/csv
  spatial: null
  ...
  title: PHL_ADM2_facilities.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Philippines - Risk Assessment Indicators (PHL_ADM2_flood_exposure.csv
    - Risk assessment indicator for Philippines)
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/risk_assessment_inputs/phl/PHL_ADM2_flood_exposure.csv
  format: null
  id: resource_1eb585da
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: PHL_ADM2_flood_exposure.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Philippines - Risk Assessment Indicators (PHL_ADM2_vulnerability.csv
    - Risk assessment indicator for Philippines)
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/risk_assessment_inputs/phl/PHL_ADM2_vulnerability.csv
  format: null
  id: resource_6e96a202
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: PHL_ADM2_vulnerability.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Philippines - Risk Assessment Indicators (PHL_ADM2_demographics.csv
    - Risk assessment indicator for Philippines)
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/risk_assessment_inputs/phl/PHL_ADM2_demographics.csv
  format: null
  id: resource_15ef1ecf
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: PHL_ADM2_demographics.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Philippines - Risk Assessment Indicators (PHL_ADM2_coping.csv - Risk
    assessment indicator for Philippines)
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/risk_assessment_inputs/phl/PHL_ADM2_coping.csv
  format: null
  id: resource_c853e35b
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: PHL_ADM2_coping.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Philippines - Risk Assessment Indicators (PHL_ADM2_access.csv - Risk
    assessment indicator for Philippines)
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/risk_assessment_inputs/phl/PHL_ADM2_access.csv
  format: null
  id: resource_a5982430
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: PHL_ADM2_access.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Philippines - Risk Assessment Indicators (PHL_ADM2_rural_population.csv
    - Risk assessment indicator for Philippines)
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/risk_assessment_inputs/phl/PHL_ADM2_rural_population.csv
  format: null
  id: resource_6cc9e24f
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: PHL_ADM2_rural_population.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Philippines - Risk Assessment Indicators (PHL_ADM2_cyclone_exposure.csv
    - Risk assessment indicator for Philippines)
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/risk_assessment_inputs/phl/PHL_ADM2_cyclone_exposure.csv
  format: null
  id: resource_b306e069
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: PHL_ADM2_cyclone_exposure.csv
risk_data_type:
- exposure
- vulnerability
schema: rdls-10
