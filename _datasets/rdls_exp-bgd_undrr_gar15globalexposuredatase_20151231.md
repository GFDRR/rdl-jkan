...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bangladesh
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bangladesh
dataset_id: rdls_exp-bgd_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bangladesh]'
...
lineage:
  description: The GAR15 global exposure database for Bangladesh was developed using
    ...
    geographic population density and GDP as spatial proxies. The dataset integrates
    inputs from multiple international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai
    Kogyo) to estimate the economic value and spatial distribution of exposed assets.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bangladesh
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Bangladesh.zip
  download_url: https://data.humdata.org/dataset/ea1e72cd-0b63-44aa-976f-dd4790711ca9/resource/ad54d35b-dc09-4dbe-9cb8-fa1331a374c2/download/bgd.zip
  format: null
  id: resource_ad54d35b
  ...
  title: GAR15 Global Exposure Dataset for Bangladesh.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bgd_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Bangladesh
version: null
vulnerability: null
---
