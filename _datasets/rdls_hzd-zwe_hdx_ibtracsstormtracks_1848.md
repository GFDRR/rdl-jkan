...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/zwe-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-zwe_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/zwe-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates historical and recent tropical cyclone observations
    from multiple meteorological agencies into a unified best-track dataset. The Zimbabwe
    subset contains observed storm track positions with associated wind speed (WMO)
    and pressure measurements in both CSV and GeoJSON formats, representing actual
    cyclone observations rather than modeled or probabilistic hazard data.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zwe-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Zimbabwe.
  download_url: https://data.humdata.org/dataset/1a76e9f7-5646-49d5-b344-7124524cbd4a/resource/af0c158f-928a-4428-9ec0-b81f0c818a8b/download/ibtracs_all_list_v04r01_zwe.csv
  format: null
  id: resource_af0c158f
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ZWE.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Zimbabwe.
  download_url: https://data.humdata.org/dataset/1a76e9f7-5646-49d5-b344-7124524cbd4a/resource/3b6261af-a5ed-4e23-ae4c-9aac9b250905/download/ibtracs_all_list_v04r01_lines_zwe.geojson
  format: null
  id: resource_3b6261af
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ZWE.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-zwe_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
