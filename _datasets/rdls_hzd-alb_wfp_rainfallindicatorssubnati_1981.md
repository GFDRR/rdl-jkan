...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/alb-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/alb-rainfall-subnational
dataset_id: rdls_hzd-alb_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/alb-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    1-month, and 3-month rolling sums) and anomalies at subnational administrative
    units in Albania. The dataset includes both historical observations and CHIRPS-GEFS
    forecast-based indicators for meteorological drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/alb-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135452105791_a0ff4248'
  download_url: https://data.humdata.org/dataset/52d267c4-dc41-4afd-b3df-a44d43b71a0a/resource/15a4ac8d-b3ff-448f-bcfe-3203747d0bce/download/alb-rainfall-subnat-full.csv
  format: null
  id: resource_15a4ac8d
  media_type: text/csv
  spatial: null
  ...
  title: alb-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135452105791_a0ff4248'
  download_url: https://data.humdata.org/dataset/52d267c4-dc41-4afd-b3df-a44d43b71a0a/resource/302dc0a7-b8a4-47c9-a49e-1fb1315475b0/download/alb-rainfall-subnat-5ytd.csv
  format: null
  id: resource_302dc0a7
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: alb-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-alb_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Albania: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
