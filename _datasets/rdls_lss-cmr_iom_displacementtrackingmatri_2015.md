...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/cmr-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/cmr-iom-dtm-from-api
dataset_id: rdls_lss-cmr_iom_displacementtrackingmatri_2015
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cmr-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through field assessments (Baseline
    Assessment, Emergency Tracking Tool, and Site Assessment methodologies) and aggregates
    IDP counts by administrative level, displacement reason, and demographic characteristics
    (sex). Data is accessed via the publicly available DTM API and represents post-displacement
    impact records.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cmr-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Cameroon IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/22882060-3e5e-4744-845a-e8c5d5dfc598/resource/b1f6a445-fc18-4017-8fa8-ee3246e7c22b/download/cmr-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_b1f6a445
  media_type: text/csv
  spatial: null
  ...
  title: Cameroon IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-cmr_iom_displacementtrackingmatri_2015
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-11-30'
temporal_resolution: null
title: Cameroon IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
