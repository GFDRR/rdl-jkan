...
- entity:
    ...
    url: https://data.humdata.org/dataset/palau-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/palau-planet-road-surface-data
dataset_id: rdls_exp-plw_heigit_palauplanetroadsurfacewid_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (81.4535%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (36.7921%) - PlanetScope predictions cover: 0.0001\
  \ million km (221.3883%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/palau-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
license: CC-BY-4.0
lineage:
  description: Road network data from OpenStreetMap was extracted for Palau's arterial
    ...
    on passability risk scores. The resulting geospatial dataset supports humanitarian
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/palau-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Palau: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Palau)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_PW_planet_roadsurface_lines.gpkg
  format: null
  id: resource_f348a5af
  ...
  title: Palau GPKG heigit_PW_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Palau: Planet Road Surface, Width, and Passability Data (GeoJSON file
    for Palau)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_PW_planet_roadsurface_lines.geojson
  format: null
  id: resource_f00412ac
  ...
  temporal: null
  temporal_resolution: null
  title: Palau GeoJSON heigit_PW_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-plw_heigit_palauplanetroadsurfacewid_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Palau: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
