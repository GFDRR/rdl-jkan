...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-republic-of-moldova
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-republic-of-moldova
dataset_id: rdls_exp-mda_kontur_republicpopulationdensity_2023
description: 'Republic of Moldova population density for 400m H3 hexagons. Built from
  Kontur Population: Global Population Density for 400m H3 Hexagons Vector H3 hexagons
  with population counts at 400m resolution. Fixed up fusion of GHSL, Facebook, Microsoft
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-republic-of-moldova]'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-republic-of-moldova
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Republic of Moldova: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MD_20220630.gpkg.gz
  format: null
  id: resource_5b8766e0
  ...
  title: kontur_population_MD_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Republic of Moldova: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MD_20231101.gpkg.gz
  format: null
  id: resource_5e098955
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_MD_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mda_kontur_republicpopulationdensity_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Republic of Moldova: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
