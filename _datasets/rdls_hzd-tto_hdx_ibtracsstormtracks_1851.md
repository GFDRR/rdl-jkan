...
- entity:
    ...
    url: https://data.humdata.org/dataset/tto-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/tto-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-tto_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tto-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Trinidad and Tobago subset contains observed storm positions, wind speeds (wmo_wind
    in m/s), and central pressure measurements recorded at regular time intervals
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tto-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/4fa73525-16ac-40f0-a93c-e1cc6ccc2c6a/resource/41129795-722a-41f5-aed1-ebbde74c18d8/download/ibtracs_all_list_v04r01_tto.csv
  format: null
  id: resource_41129795
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_TTO.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Trinidad and Tobago.
  download_url: https://data.humdata.org/dataset/4fa73525-16ac-40f0-a93c-e1cc6ccc2c6a/resource/51cdd4ca-525c-4ae7-8426-9c9e72c1d74f/download/ibtracs_all_list_v04r01_lines_tto.geojson
  format: null
  id: resource_51cdd4ca
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_TTO.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tto_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Trinidad and Tobago: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
