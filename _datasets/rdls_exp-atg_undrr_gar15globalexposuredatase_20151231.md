...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-antigua-and-barbuda
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-antigua-and-barbuda
dataset_id: rdls_exp-atg_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-antigua-and-barbuda]'
...
lineage:
  description: The GAR15 global exposure database was developed using a top-down approach
    ...
    density and GDP as spatial proxies. The dataset for Antigua and Barbuda represents
    the country-specific extraction from this global database, integrating inputs
    from multiple international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai Kogyo)
    to estimate economic value and distribution of exposed assets.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-antigua-and-barbuda
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Antigua and Barbuda.zip
  download_url: https://data.humdata.org/dataset/eb7d08b9-f2ec-439a-9e33-87dce123e9ab/resource/91af52f4-5163-484b-ba87-725fff425103/download/atg.zip
  format: null
  id: resource_91af52f4
  ...
  title: GAR15 Global Exposure Dataset for Antigua and Barbuda.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-atg_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Antigua and Barbuda
version: null
vulnerability: null
---
