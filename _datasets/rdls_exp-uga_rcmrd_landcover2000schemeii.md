...
contact_point:
  ...
  url: https://geoportal.rcmrd.org/catalogue/#/dataset/9
creator:
  affiliation: null
  email: null
  name: Patrick Kabatha
  url: https://geoportal.rcmrd.org/catalogue/#/dataset/9
dataset_id: rdls_exp-uga_rcmrd_landcover2000schemeii
...
lineage:
  description: 'This land cover products were generated from LandSat thematic mapper
    ...
    Uganda 2000 Scheme II were as follows: Overall Accuracy = (436/505) 86.33% Kappa
    Coefficient = 0.8444'
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://geoportal.rcmrd.org/catalogue/#/dataset/9
  rel: source
loss: null
project: null
publisher:
...
referenced_by: []
resources:
- access_url: https://geoportal.rcmrd.org/datasets/geonode:Uganda_Landcover_2000_Scheme_II_
  baseline_period: null
  climate: null
  conforms_to: http://www.opengis.net/def/serviceType/ogc/wms
  coordinate_system: EPSG:32636
  description: 'Uganda Land Cover 2000 Scheme II (OGC WMS: geonode Service)'
  download_url: https://geoportal.rcmrd.org/geoserver/ows?service=WMS&version=1.1.1&request=GetMap&layers=geonode:Uganda_Landcover_2000_Scheme_II_&format=image%2Fpng
  format: null
  id: resource_0
...
- access_url: https://geoportal.rcmrd.org/datasets/geonode:Uganda_Landcover_2000_Scheme_II_
  ...
  coordinate_system: EPSG:32636
  description: 'Uganda Land Cover 2000 Scheme II (OGC WCS: geonode Service)'
  download_url: https://geoportal.rcmrd.org/geoserver/ows?service=WCS&version=2.0.1&request=DescribeCoverage&CoverageId=geonode__Uganda_Landcover_2000_Scheme_II_
  format: null
  id: resource_1
...
- exposure
schema: rdls-10
slug: rdls_exp-uga_rcmrd_landcover2000schemeii
spatial:
  bbox:
  - 108550.489
  - -173925.0
...
temporal:
  ...
  start: null
temporal_resolution: null
title: Uganda Land Cover 2000 Scheme II
version: null
vulnerability: null
---
