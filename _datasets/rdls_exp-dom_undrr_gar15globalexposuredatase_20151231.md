...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-dominican-republic
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-dominican-republic
dataset_id: rdls_exp-dom_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-dominican-republic]'
...
lineage:
  description: National-level socio-economic data, building type distributions, and
    ...
    using a top-down approach onto 5x5 km and 1x1 km gridded surfaces, with geographic
    population density and GDP serving as spatial proxies for distribution. The dataset
    was developed by UNEP-GRID in collaboration with WAPMERR, EU JRC, and Kokusai
    Kogyo as part of the GAR15 (Global Assessment Report on Disaster Risk Reduction
    2015) initiative.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-dominican-republic
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Dominican Republic.zip
  download_url: https://data.humdata.org/dataset/9862bbec-dc4f-46d2-8c49-660f57f5a9d2/resource/a63b9a95-81d5-4fa7-b4d4-fcf6c60f6b92/download/dom.zip
  format: null
  id: resource_a63b9a95
  ...
  title: GAR15 Global Exposure Dataset for Dominican Republic.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dom_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Dominican Republic
version: null
vulnerability: null
---
