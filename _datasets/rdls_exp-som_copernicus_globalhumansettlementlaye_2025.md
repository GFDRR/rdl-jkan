...
- entity:
    ...
    url: https://data.humdata.org/dataset/som-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/som-ghsl
dataset_id: rdls_exp-som_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/som-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    and infrastructure at national scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/som-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/c5ccade6-1f7a-442a-a4fe-715ff787a97e/resource/80ebb41d-3d2a-4d19-ba6d-36db0e86f17c/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_som.tif
  format: null
  id: resource_80ebb41d
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Somalia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/c5ccade6-1f7a-442a-a4fe-715ff787a97e/resource/c3529f1e-11c7-48c2-9a4d-e91cb023a0db/download/ghs_pop_e2025_r2023a_54009_100_v1_0_som.tif
  format: null
  id: resource_c3529f1e
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-som_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Somalia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
