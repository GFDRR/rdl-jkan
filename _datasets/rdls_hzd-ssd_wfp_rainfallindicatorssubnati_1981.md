...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/ssd-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ssd-rainfall-subnational
dataset_id: rdls_hzd-ssd_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/ssd-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations integrated
    with in-situ station measurements, then aggregated by dekad and subnational administrative
    units. Rolling aggregations (1-month and 3-month) and anomalies relative to long-term
    averages were computed to generate meteorological drought indicators for monitoring
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ssd-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135658341389_894dacc8'
  download_url: https://data.humdata.org/dataset/afbbb424-62d4-4654-908a-606317fb06ca/resource/3c1cd950-67ad-4e65-b0ef-2a80563e99aa/download/ssd-rainfall-subnat-full.csv
  format: null
  id: resource_3c1cd950
  media_type: text/csv
  spatial: null
  ...
  title: ssd-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135658341389_894dacc8'
  download_url: https://data.humdata.org/dataset/afbbb424-62d4-4654-908a-606317fb06ca/resource/d3d362bc-ef61-45a4-a50d-2fa185ebcb0b/download/ssd-rainfall-subnat-5ytd.csv
  format: null
  id: resource_d3d362bc
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ssd-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ssd_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'South Sudan: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
