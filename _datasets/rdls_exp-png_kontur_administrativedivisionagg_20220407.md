...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-papua-new-guinea
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-papua-new-guinea
dataset_id: rdls_exp-png_kontur_administrativedivisionagg_20220407
description: 'Papua New Guinea administrative division with aggregated population.
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-papua-new-guinea]'
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    ...
    division level for Papua New Guinea.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-papua-new-guinea
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Papua New Guinea: Administrative Division with Aggregated Population
    (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_PG_20220407.gpkg.gz
  format: null
  id: resource_66f72580
  ...
  title: kontur_boundaries_PG_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Papua New Guinea: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_PG_20230628.gpkg.gz
  format: null
  id: resource_59179f88
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_PG_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Papua New Guinea: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_PG_20230628.gpkg.gz
  format: null
  id: resource_5956ef7b
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_PG_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-png_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Papua New Guinea: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
