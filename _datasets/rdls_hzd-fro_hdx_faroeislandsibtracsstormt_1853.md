...
- entity:
    ...
    url: https://data.humdata.org/dataset/fro-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/fro-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-fro_hdx_faroeislandsibtracsstormt_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/fro-ibtracs-tropical-storm-tracks]'
...
license: CC-BY-4.0
lineage:
  description: Historical tropical cyclone observations from multiple international
    agencies were merged by the IBTrACS algorithm to create a unified best-track dataset.
    Track positions, wind speeds (wmo_wind), and central pressures (wmo_pres) were
    extracted for storms affecting the Faroe Islands region and provided in both tabular
    (CSV) and spatial (GeoJSON) formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fro-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Faroe Islands.
  download_url: https://data.humdata.org/dataset/d65a0bc6-01bf-4213-a761-5ac831155242/resource/a9cedd96-411b-4032-a40a-78fba274386f/download/ibtracs_all_list_v04r01_fro.csv
  format: null
  id: resource_a9cedd96
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_FRO.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Faroe Islands.
  download_url: https://data.humdata.org/dataset/d65a0bc6-01bf-4213-a761-5ac831155242/resource/6434ad86-b8d7-44c8-90cb-5476a031e9be/download/ibtracs_all_list_v04r01_lines_fro.geojson
  format: null
  id: resource_6434ad86
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_FRO.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-fro_hdx_faroeislandsibtracsstormt_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Faroe Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
