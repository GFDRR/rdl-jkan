...
- entity:
    ...
    url: https://data.humdata.org/dataset/phl-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/phl-ghsl
dataset_id: rdls_exp-phl_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/phl-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    and population distribution at global scale. The Philippines subset represents
    national-level exposure data derived from this global processing pipeline.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/phl-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/a3c97547-8277-4c30-841d-6ebe472a7bb4/resource/4ba83afd-4979-483b-aef2-ad881997c6eb/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_phl.tif
  format: null
  id: resource_4ba83afd
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Philippines: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/a3c97547-8277-4c30-841d-6ebe472a7bb4/resource/31cc6f8a-db4d-4b37-989b-d3bba33b2869/download/ghs_pop_e2025_r2023a_54009_100_v1_0_phl.tif
  format: null
  id: resource_31cc6f8a
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-phl_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Philippines: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
