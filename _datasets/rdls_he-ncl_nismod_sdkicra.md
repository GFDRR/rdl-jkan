...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-ncl_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for New Caledonia. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796607
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796607
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    New Caledonia, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/10796607/files/NCL.zip
  format: null
  id: resource_sdkicra_ncl
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - New Caledonia
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-ncl_nismod_sdkicra
spatial:
  bbox:
  - 163.62
  - -22.67
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2139685/new-caledonia.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for New Caledonia
version: 0.1.0
vulnerability: null
---
