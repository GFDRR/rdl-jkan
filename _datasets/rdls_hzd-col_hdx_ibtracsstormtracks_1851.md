...
- entity:
    ...
    url: https://data.humdata.org/dataset/col-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/col-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-col_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/col-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    Track positions, timestamps, wind speeds, and pressure measurements are standardized
    and quality-controlled. The Colombia subset contains all tropical cyclone tracks
    affecting or passing through Colombian territory.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/col-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Colombia.
  download_url: https://data.humdata.org/dataset/344d0eb8-db9a-43f7-8c8b-640d754ca89c/resource/01901511-d33e-41ff-be83-66699309ee67/download/ibtracs_all_list_v04r01_col.csv
  format: null
  id: resource_01901511
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_COL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Colombia.
  download_url: https://data.humdata.org/dataset/344d0eb8-db9a-43f7-8c8b-640d754ca89c/resource/682309b2-a8ab-49d2-91f2-16910fe55991/download/ibtracs_all_list_v04r01_lines_col.geojson
  format: null
  id: resource_682309b2
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_COL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-col_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Colombia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
