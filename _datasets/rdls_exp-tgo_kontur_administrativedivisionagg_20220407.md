...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-togo
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-togo
dataset_id: rdls_exp-tgo_kontur_administrativedivisionagg_20220407
description: 'Togo administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-togo]'
...
lineage:
  description: Administrative boundaries for Togo were extracted from OpenStreetMap
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-togo
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Togo: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_TG_20220407.gpkg.gz
  format: null
  id: resource_82253cb1
  ...
  title: kontur_boundaries_TG_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Togo: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_TG_20230628.gpkg.gz
  format: null
  id: resource_15c74460
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_TG_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Togo: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_TG_20230628.gpkg.gz
  format: null
  id: resource_6cecd816
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_TG_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tgo_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Togo: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
