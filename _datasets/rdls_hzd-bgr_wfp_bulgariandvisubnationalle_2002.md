...
- entity:
    ...
    url: https://data.humdata.org/dataset/bgr-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/bgr-ndvi-subnational
dataset_id: rdls_hzd-bgr_wfp_bulgariandvisubnationalle_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bgr-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    indicators (vim, vim_lta, viq) aggregated by WFP-defined subnational administrative
    units with Pcode references. NDVI anomalies were calculated as percentage deviations
    from long-term averages to support agricultural drought monitoring.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bgr-ndvi-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135633023605_ff3842a3'
  download_url: https://data.humdata.org/dataset/4b617bf1-d153-41f1-a3a6-ce32f5d3480a/resource/1b30946a-b05a-4a9a-a30d-f452ca3b3d5c/download/bgr-ndvi-subnat-full.csv
  format: null
  id: resource_1b30946a
  media_type: text/csv
  spatial: null
  ...
  title: bgr-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135633023605_ff3842a3'
  download_url: https://data.humdata.org/dataset/4b617bf1-d153-41f1-a3a6-ce32f5d3480a/resource/0ebecf72-2f00-4acc-bd45-51e02468a37b/download/bgr-ndvi-subnat-5ytd.csv
  format: null
  id: resource_0ebecf72
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: bgr-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bgr_wfp_bulgariandvisubnationalle_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Bulgaria: NDVI at Subnational Level'
version: null
vulnerability: null
---
