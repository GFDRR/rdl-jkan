...
- entity:
    ...
    url: https://data.humdata.org/dataset/haiti-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/haiti-road-surface-data
dataset_id: rdls_exp-hti_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0525 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0031 and 0.0109
  (in million kms), corressponding to 5.8369% and 20.7147% respectively of the total
  road length in the dataset region. 0.0385 million km or 73.4485% of road surface
  ...
  to 0.3296% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/haiti-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for Haiti. A hybrid deep learning model was applied to classify and predict road
    surface types (paved vs unpaved), generating predicted surface classifications
    and confidence metrics for approximately 0.0525 million km of mapped roads. The
    dataset integrates OSM-documented surfaces with AI-predicted classifications to
    provide comprehensive road surface coverage for humanitarian access and infrastructure
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/haiti-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Haiti: Road Surface Data (GeoJSON data for Haiti.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_hti_roadsurface_lines.geojson
  format: null
  id: resource_e81e683f
  ...
  title: Haiti GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Haiti: Road Surface Data (Geopackage data for Haiti.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_hti_roadsurface_lines.gpkg
  format: null
  id: resource_80983813
  ...
  temporal: null
  temporal_resolution: null
  title: Haiti GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-hti_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
