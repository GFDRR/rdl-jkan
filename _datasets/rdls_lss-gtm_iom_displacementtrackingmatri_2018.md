...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/gtm-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/gtm-iom-dtm-from-api
dataset_id: rdls_lss-gtm_iom_displacementtrackingmatri_2018
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gtm-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through multiple assessment types
    (baseline, emergency tracking, site assessments) and aggregates internally displaced
    person figures at national and subnational administrative levels. The data is
    made publicly available through the DTM API for humanitarian analysis and monitoring
    of displacement populations.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gtm-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Guatemala IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/cd891c9f-5b25-4d83-a704-eccfbb9a4fa1/resource/b0d39b22-ebdc-4d83-a68d-41af72875027/download/gtm-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_b0d39b22
  media_type: text/csv
  spatial: null
  ...
  title: Guatemala IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-gtm_iom_displacementtrackingmatri_2018
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2018-06-30'
temporal_resolution: null
title: Guatemala IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
