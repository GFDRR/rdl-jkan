...
- entity:
    ...
    url: https://data.humdata.org/dataset/svn-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/svn-ghsl
dataset_id: rdls_exp-svn_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/svn-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distributions. For Slovenia,
    this produces rasterized exposure layers representing building footprints and
    population density at high spatial resolution.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/svn-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/17000481-4364-4945-a847-93571cf80256/resource/59f49d6b-3074-439c-83be-2bc6b7004e11/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_svn.tif
  format: null
  id: resource_59f49d6b
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Slovenia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/17000481-4364-4945-a847-93571cf80256/resource/18f9e0e8-568d-4886-becd-57cd9514317c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_svn.tif
  format: null
  id: resource_18f9e0e8
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-svn_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Slovenia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
