...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/ner-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ner-rainfall-subnational
dataset_id: rdls_hzd-ner_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/ner-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    observations, aggregated into dekadal (10-day) indicators at subnational administrative
    units. Rolling 1-month and 3-month aggregations computed alongside long-term climatological
    averages to enable drought monitoring and anomaly detection.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ner-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135851717535_23ef023d'
  download_url: https://data.humdata.org/dataset/7fd33ae6-57ad-4459-93ea-80033e3aebc5/resource/febb0cf6-07da-4a2a-83ad-a14420dfd25b/download/ner-rainfall-subnat-full.csv
  format: null
  id: resource_febb0cf6
  media_type: text/csv
  spatial: null
  ...
  title: ner-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135851717535_23ef023d'
  download_url: https://data.humdata.org/dataset/7fd33ae6-57ad-4459-93ea-80033e3aebc5/resource/3c44ef03-24e1-4b69-96aa-a4441248fd09/download/ner-rainfall-subnat-5ytd.csv
  format: null
  id: resource_3c44ef03
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ner-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ner_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Niger: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
