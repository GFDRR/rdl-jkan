...
- entity:
    ...
    url: https://data.humdata.org/dataset/gambia-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/gambia-road-surface-data
dataset_id: rdls_exp-gmb_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0282 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0019 and 0.006
  (in million kms), corressponding to 6.6068% and 21.4047% respectively of the total
  road length in the dataset region. 0.0203 million km or 71.9884% of road surface
  ...
  to 0.6668% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/gambia-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    ...
    from unpaved surfaces. The resulting dataset provides both OSM-attributed and
    model-predicted surface classifications for approximately 28,200 km of mapped
    roads in Gambia, supporting humanitarian access and infrastructure planning applications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gambia-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Gambia: Road Surface Data (GeoJSON data for Gambia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_gmb_roadsurface_lines.geojson
  format: null
  id: resource_047e47ac
  ...
  title: Gambia GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Gambia: Road Surface Data (Geopackage data for Gambia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_gmb_roadsurface_lines.gpkg
  format: null
  id: resource_b929f414
  ...
  temporal: null
  temporal_resolution: null
  title: Gambia GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gmb_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Gambia: Road Surface Data'
version: null
vulnerability: null
---
