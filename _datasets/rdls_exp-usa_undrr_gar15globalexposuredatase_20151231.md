...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-states-of-america
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-states-of-america
dataset_id: rdls_exp-usa_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-states-of-america]'
...
lineage:
  description: The GAR15 global exposure database was developed using a top-down approach
    ...
    were transposed onto 5x5 km and 1x1 km grid cells using geographic distribution
    of population density and GDP as spatial proxies. The dataset represents economic
    value and population distribution of exposed assets across the United States without
    hazard or loss components.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-states-of-america
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for United States of America (Shapefile)
  download_url: https://data.humdata.org/dataset/132ccaad-a1bb-4974-84b5-c345d7c70b2c/resource/bfdd485d-d75b-4a66-b843-55c8066da524/download/usa.zip
  format: null
  id: resource_bfdd485d
  ...
  title: GAR15 Global Exposure Dataset for United States of America.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-usa_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for United States of America
version: null
vulnerability: null
---
