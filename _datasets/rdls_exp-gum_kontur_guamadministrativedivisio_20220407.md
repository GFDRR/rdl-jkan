...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-guam
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-guam
dataset_id: rdls_exp-gum_kontur_guamadministrativedivisio_20220407
description: 'Guam administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-guam]'
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    ...
    level for Guam, with HASC codes added from Wikidata.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-guam
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Guam: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_GU_20220407.gpkg.gz
  format: null
  id: resource_55051cdd
  ...
  title: kontur_boundaries_GU_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Guam: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_GU_20230628.gpkg.gz
  format: null
  id: resource_2ce3c6c1
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_GU_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Guam: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_GU_20230628.gpkg.gz
  format: null
  id: resource_a0c3d967
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_GU_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gum_kontur_guamadministrativedivisio_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Guam: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
