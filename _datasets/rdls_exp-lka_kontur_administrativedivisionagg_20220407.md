...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-sri-lanka
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-sri-lanka
dataset_id: rdls_exp-lka_kontur_administrativedivisionagg_20220407
description: 'Sri Lanka administrative division with aggregated population. Built
  from Kontur Population: Global Population Density for 400m H3 Hexagons on top of
  OpenStreetMap administrative boundaries data. Enriched with HASC codes for regions
  taken from Wikidata. Global version of boundaries dataset: Kontur Boundaries: Global
  administrative division with aggregated population. [Source: This metadata record
  was automatically extracted from the Humanitarian Data Exchange (HDX); Original
  dataset: https://data.humdata.org/dataset/kontur-boundaries-sri-lanka]'
...
lineage:
  description: Administrative boundaries for Sri Lanka were extracted from OpenStreetMap
    data using proprietary enhancements and filtered to create consistent administrative
    divisions. Population counts were aggregated from the Kontur Population dataset
    (400m H3 hexagons) and assigned to each administrative unit. Boundaries were enriched
    with HASC codes from Wikidata to enable standardized geographic referencing.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-sri-lanka
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Sri Lanka: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_LK_20220407.gpkg.gz
  format: null
  id: resource_973431ba
  ...
  title: kontur_boundaries_LK_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Sri Lanka: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_LK_20230628.gpkg.gz
  format: null
  id: resource_31bb6393
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_LK_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Sri Lanka: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_LK_20230628.gpkg.gz
  format: null
  id: resource_b7104acd
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_LK_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lka_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Sri Lanka: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
