...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kyrgyzstan
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kyrgyzstan
dataset_id: rdls_exp-kgz_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kyrgyzstan]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Kyrgyzstan were transposed onto 5x5 km and 1x1 km gridded layers using geographic
    population distribution and GDP as spatial proxies. The dataset was developed
    through a top-down approach by UNEP-GRID in collaboration with WAPMERR, EU JRC,
    and Kokusai Kogyo for the GAR15 global exposure database.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kyrgyzstan
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Kyrgyzstan.zip
  download_url: https://data.humdata.org/dataset/82df34f6-e083-4497-b592-03c9de9042bb/resource/6549cd4b-ff48-4deb-923a-852035453c6d/download/kgz.zip
  format: null
  id: resource_6549cd4b
  ...
  title: GAR15 Global Exposure Dataset for Kyrgyzstan.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kgz_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Kyrgyzstan
version: null
vulnerability: null
---
