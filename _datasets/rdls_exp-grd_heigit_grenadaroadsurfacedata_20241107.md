...
- entity:
    ...
    url: https://data.humdata.org/dataset/grenada-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/grenada-road-surface-data
dataset_id: rdls_exp-grd_heigit_grenadaroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grenada-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    surface classifications for humanitarian access and infrastructure planning applications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grenada-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Grenada: Road Surface Data (GeoJSON data for Grenada.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_grd_roadsurface_lines.geojson
  format: null
  id: resource_ef821faf
  ...
  title: Grenada GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Grenada: Road Surface Data (Geopackage data for Grenada.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_grd_roadsurface_lines.gpkg
  format: null
  id: resource_f911babb
  ...
  temporal: null
  temporal_resolution: null
  title: Grenada GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-grd_heigit_grenadaroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Grenada: Road Surface Data'
version: null
vulnerability: null
---
