...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-united-states-virgin-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-united-states-virgin-islands
dataset_id: rdls_exp-vir_kontur_unitedstatesvirginislands_2023
description: 'United States Virgin Islands population density for 400m H3 hexagons.
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-united-states-virgin-islands]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    and aggregating the results into H3 hexagonal grid cells at 400m resolution using
    hierarchical spatial indexing. The dataset provides baseline population exposure
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-united-states-virgin-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'United States Virgin Islands: Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_VI_20220630.gpkg.gz
  format: null
  id: resource_81b7b61a
  ...
  title: kontur_population_VI_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'United States Virgin Islands: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_VI_20231101.gpkg.gz
  format: null
  id: resource_7221b1de
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_VI_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vir_kontur_unitedstatesvirginislands_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'United States Virgin Islands: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
