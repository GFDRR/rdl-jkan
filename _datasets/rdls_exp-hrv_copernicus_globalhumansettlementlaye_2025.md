...
- entity:
    ...
    url: https://data.humdata.org/dataset/hrv-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/hrv-ghsl
dataset_id: rdls_exp-hrv_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/hrv-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distribution. The Croatia
    dataset represents the national application of this global methodology, producing
    raster layers of built-up areas and population density.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hrv-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/7a932900-d59c-4ccb-8976-70f0b59bfd45/resource/88266a22-06ba-437a-9e02-663acaefbb3f/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_hrv.tif
  format: null
  id: resource_88266a22
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Croatia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/7a932900-d59c-4ccb-8976-70f0b59bfd45/resource/509ee318-ff66-4aaa-b3ca-a7aec3e7aab3/download/ghs_pop_e2025_r2023a_54009_100_v1_0_hrv.tif
  format: null
  id: resource_509ee318
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-hrv_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Croatia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
