...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/bgd-iom-dtm-from-api
dataset_id: rdls_lss-bgd_iom_displacementtrackingmatri_20251031
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bgd-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through field assessments (baseline,
    ...
    administrative levels. Data is disaggregated by displacement reason, gender, and
    origin location, then published via the DTM API for humanitarian and research
    use.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bgd-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Bangladesh IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/de66c608-b36e-4024-9119-83ea1aa9bb82/resource/6ea8e4f9-897b-4357-93d7-52db54c5b2dd/download/bgd-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_6ea8e4f9
  media_type: text/csv
  spatial: null
  ...
  title: Bangladesh IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-bgd_iom_displacementtrackingmatri_20251031
spatial:
  bbox: null
  centroid: null
  countries:
