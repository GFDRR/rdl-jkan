...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/dza-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/dza-rainfall-subnational
dataset_id: rdls_hzd-dza_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/dza-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    observations, aggregated into dekadal indicators (10-day, 1-month, 3-month rolling
    totals) and compared against long-term averages at subnational administrative
    units to support drought monitoring and early warning in Algeria.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dza-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135545045544_cb49460a'
  download_url: https://data.humdata.org/dataset/f18fb0de-5323-4c2c-a987-246ece96e8bb/resource/4efa64e8-c70e-422f-9221-c594e5cb47cd/download/dza-rainfall-subnat-full.csv
  format: null
  id: resource_4efa64e8
  media_type: text/csv
  spatial: null
  ...
  title: dza-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135545045544_cb49460a'
  download_url: https://data.humdata.org/dataset/f18fb0de-5323-4c2c-a987-246ece96e8bb/resource/5f94ce52-5274-4f5e-9915-f2e18d07a93f/download/dza-rainfall-subnat-5ytd.csv
  format: null
  id: resource_5f94ce52
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: dza-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-dza_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Algeria: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
