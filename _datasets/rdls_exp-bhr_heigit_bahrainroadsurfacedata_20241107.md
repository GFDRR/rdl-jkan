...
- entity:
    ...
    url: https://data.humdata.org/dataset/bahrain-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/bahrain-road-surface-data
dataset_id: rdls_exp-bhr_heigit_bahrainroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0148 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0077 and 0.0006
  (in million kms), corressponding to 52.1655% and 3.9661% respectively of the total
  road length in the dataset region. 0.0065 million km or 43.8684% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0007 million km of information (corressponding
  to 11.5889% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bahrain-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    learning approach to classify road surfaces as paved or unpaved. The model generated
    predictions for road surface types, which were integrated with existing OSM attributes
    to create a comprehensive road infrastructure dataset with dual surface classifications
    (OSM-based and AI-predicted).
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bahrain-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Bahrain: Road Surface Data (GeoJSON data for Bahrain.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bhr_roadsurface_lines.geojson
  format: null
  id: resource_ea9e721a
  ...
  title: Bahrain GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Bahrain: Road Surface Data (Geopackage data for Bahrain.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bhr_roadsurface_lines.gpkg
  format: null
  id: resource_4bae0826
  ...
  temporal: null
  temporal_resolution: null
  title: Bahrain GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bhr_heigit_bahrainroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Bahrain: Road Surface Data'
version: null
vulnerability: null
---
