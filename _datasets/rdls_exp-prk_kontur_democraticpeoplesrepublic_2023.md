...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-democratic-people-s-republic-of-korea
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-democratic-people-s-republic-of-korea
dataset_id: rdls_exp-prk_kontur_democraticpeoplesrepublic_2023
description: 'Democratic People''s Republic of Korea population density for 400m H3
  hexagons. Built from Kontur Population: Global Population Density for 400m H3 Hexagons
  Vector H3 hexagons with population counts at 400m resolution. Fixed up fusion of
  GHSL, Facebook, Microsoft Buildings, Copernicus Global Land Service Land Cover,
  Land Information New Zealand, and OpenStreetMap data.. [Source: This metadata record
  was automatically extracted from the Humanitarian Data Exchange (HDX); Original
  dataset: https://data.humdata.org/dataset/kontur-population-democratic-people-s-republic-of-korea]'
...
- asset_type:
    description: Population density distributed across 400m H3 hexagonal grid cells
      for Democratic People's Republic of Korea
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    to create a consistent population distribution model. The resulting population
    counts were aggregated into 400m H3 hexagonal grid cells using the H3 hierarchical
    spatial indexing system, providing fine-resolution baseline population exposure
    data for Democratic People's Republic of Korea.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-democratic-people-s-republic-of-korea
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Democratic People''s Republic of Korea: Population Density for 400m
    H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_KP_20220630.gpkg.gz
  format: null
  id: resource_ff8cf8c8
  ...
  title: kontur_population_KP_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Democratic People''s Republic of Korea: Population Density for 400m
    H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_KP_20231101.gpkg.gz
  format: null
  id: resource_7f94c873
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_KP_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-prk_kontur_democraticpeoplesrepublic_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Democratic People''s Republic of Korea: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
