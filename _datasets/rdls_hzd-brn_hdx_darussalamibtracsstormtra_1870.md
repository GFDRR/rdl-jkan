...
- entity:
    ...
    url: https://data.humdata.org/dataset/brn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/brn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-brn_hdx_darussalamibtracsstormtra_1870
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/brn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The Brunei subset contains historical
    and recent storm tracks with ISO-formatted timestamps, basin/subbasin classifications,
    wind speed (wmo_wind), and central pressure (wmo_pres) measurements at observation
    points, provided as both tabular CSV and GeoJSON line geometry formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/brn-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/4770dc74-3e7d-4471-b284-0b1d54a359b7/resource/2f210d31-b59d-4375-81d7-d40d58faa80d/download/ibtracs_all_list_v04r01_brn.csv
  format: null
  id: resource_2f210d31
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BRN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1870 to date that pass within 2000 kilometers
    of Brunei Darussalam.
  download_url: https://data.humdata.org/dataset/4770dc74-3e7d-4471-b284-0b1d54a359b7/resource/86149510-0bcf-4cea-b4f2-4c59cced3b4d/download/ibtracs_all_list_v04r01_lines_brn.geojson
  format: null
  id: resource_86149510
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BRN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-brn_hdx_darussalamibtracsstormtra_1870
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1870-04-10'
temporal_resolution: null
title: 'Brunei Darussalam: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
