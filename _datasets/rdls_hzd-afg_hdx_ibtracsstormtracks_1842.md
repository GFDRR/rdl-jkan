...
- entity:
    ...
    url: https://data.humdata.org/dataset/afg-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/afg-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-afg_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/afg-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone data from multiple
    national meteorological agencies into a unified best-track dataset. The Afghanistan
    subset contains observed storm tracks with ISO-formatted timestamps, basin/sub-basin
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/afg-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Afghanistan.
  download_url: https://data.humdata.org/dataset/8d9a5ed4-1805-456b-8897-0e194b107ded/resource/5b06eb5d-bea3-4851-b56d-6ea608cde1aa/download/ibtracs_all_list_v04r01_afg.csv
  format: null
  id: resource_5b06eb5d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_AFG.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Afghanistan.
  download_url: https://data.humdata.org/dataset/8d9a5ed4-1805-456b-8897-0e194b107ded/resource/e55543c7-9758-4a74-9308-855c93667223/download/ibtracs_all_list_v04r01_lines_afg.geojson
  format: null
  id: resource_e55543c7
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_AFG.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-afg_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Afghanistan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
