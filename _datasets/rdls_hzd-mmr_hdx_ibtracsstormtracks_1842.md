...
- entity:
    ...
    url: https://data.humdata.org/dataset/mmr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mmr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mmr_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mmr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS aggregates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Myanmar subset
    contains historical and recent storm tracks with ISO-formatted timestamps, basin/sub-basin
    classifications, wind speed (wmo_wind), and central pressure (wmo_pres) measurements
    at observation points along each cyclone's path.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mmr-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Myanmar.
  download_url: https://data.humdata.org/dataset/b180a4fe-2875-4aef-83e1-422bf54b0381/resource/b5c7c20c-c4e6-4454-87a5-774cd85b0aa1/download/ibtracs_all_list_v04r01_mmr.csv
  format: null
  id: resource_b5c7c20c
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MMR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Myanmar.
  download_url: https://data.humdata.org/dataset/b180a4fe-2875-4aef-83e1-422bf54b0381/resource/22022a68-c467-430d-81e2-81269fbcfd2c/download/ibtracs_all_list_v04r01_lines_mmr.geojson
  format: null
  id: resource_22022a68
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MMR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mmr_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Myanmar: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
