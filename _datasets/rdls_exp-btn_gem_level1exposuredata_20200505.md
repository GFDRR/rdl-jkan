...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/bhutan-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/bhutan-level-1-exposure-data
dataset_id: rdls_exp-btn_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bhutan-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    intended for catastrophe modeling and disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Bhutan produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/0fa1dfc5-936c-4a5d-9a86-579677242099/resource/c766b77b-7a00-4b63-98d4-31cfdc3f6449/download/btn_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_c766b77b
  ...
  title: BTN_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-btn_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Bhutan: Level 1 Exposure Data'
version: null
vulnerability: null
---
