...
- entity:
    ...
    url: https://data.humdata.org/dataset/kna-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/kna-ghsl
dataset_id: rdls_exp-kna_copernicus_saintkittsnevisglobalhuma_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/kna-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale, applied here to Saint Kitts
    and Nevis.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kna-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/d4e7692d-120d-4581-802d-c4f28da44b01/resource/af92e805-1888-42ff-af21-2ec1167f21c1/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_kna.tif
  format: null
  id: resource_af92e805
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Saint Kitts and Nevis: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/d4e7692d-120d-4581-802d-c4f28da44b01/resource/92192982-941d-4549-9de9-7e14533ab3e4/download/ghs_pop_e2025_r2023a_54009_100_v1_0_kna.tif
  format: null
  id: resource_92192982
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-kna_copernicus_saintkittsnevisglobalhuma_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Saint Kitts and Nevis: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
