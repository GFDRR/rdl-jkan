...
- entity:
    ...
    url: https://data.humdata.org/dataset/cym-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cym-ghsl
dataset_id: rdls_exp-cym_copernicus_caymanislandsglobalhumans_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cym-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    patterns and population density at global scale with local application to Cayman
    Islands.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cym-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/720cffb3-a933-44ee-ba25-58c7ff1ff434/resource/4ccbb2db-cbcd-4f6b-8241-2e8f8383676a/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cym.tif
  format: null
  id: resource_4ccbb2db
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Cayman Islands: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/720cffb3-a933-44ee-ba25-58c7ff1ff434/resource/0e88ca95-472c-44ec-8ed2-fe820593cc14/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cym.tif
  format: null
  id: resource_0e88ca95
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cym_copernicus_caymanislandsglobalhumans_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Cayman Islands: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
