...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-eritrea
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-eritrea
dataset_id: rdls_exp-eri_kontur_administrativedivisionagg_20220407
description: 'Eritrea administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-eritrea]'
...
lineage:
  description: Administrative boundaries for Eritrea were extracted from OpenStreetMap
    and enriched with aggregated population counts derived from the Kontur global
    population density dataset at 400m H3 hexagon resolution. HASC codes for regions
    were added from Wikidata. The dataset provides baseline population exposure at
    the administrative division level for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-eritrea
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Eritrea: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_ER_20220407.gpkg.gz
  format: null
  id: resource_b0f82c79
  ...
  title: kontur_boundaries_ER_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Eritrea: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_ER_20230628.gpkg.gz
  format: null
  id: resource_c065eade
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_ER_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Eritrea: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_ER_20230628.gpkg.gz
  format: null
  id: resource_37bdaedf
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_ER_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-eri_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Eritrea: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
