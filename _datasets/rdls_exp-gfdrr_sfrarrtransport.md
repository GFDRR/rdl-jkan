...
creator:
  ...
  name: Chiara Scaini
  url: null
dataset_id: rdls_exp-gfdrr_sfrarrtransport
description: Regional transport system exposure (roads, railways and bridges) for
  Central Asia (Kazakhstan, Kyrgyz Republic, Tajikistan, Turkmenistan, Uzbekistan),
  developed under the SFRARR program from official transportation data harmonized
...
- asset_type:
  ...
  id: rdls_exp-gfdrr_sfrarrtransport_exp
  metrics:
  - dimension: structure
    id: rdls_exp-gfdrr_sfrarrtransport_m1
    measurement:
...
resources:
- access_url: https://datacatalog.worldbank.org/search/dataset/0064252
  ...
  description: 'Regional layer of transportation infrastructure in Central Asia. The
    ...
    analysis, in particular identifying the intersection of main roads/railways and
    rivers. These data have been derived on a regional scale for the purpose of consistent
    regional (multi-country hazard and risk assessment). The folder includes one point
    layer containing Central Asia bridges, and one lines layer containing roads and
    railways of different types. Note that minor roads (e.g. residential, service)
    and railway types (e.g. subway) were not included in the analysis. Application
    of this information should on smaller scales should be done with care and taking
    into account the limitations of the approach. Central Asia exposure dataset -
    Transport - Bridges - UZB Files: BRIDGES_[OBLAST].csv; BRIDGES_[OBLAST].shp'
  download_url: null
  format: csv
  id: rdls_exp-gfdrr_sfrarrtransport_r1
  media_type: text/csv
  spatial: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gfdrr_sfrarrtransport
spatial:
  bbox:
  - 46.0
  - 34.0
...
temporal: null
temporal_resolution: null
title: Central Asia Exposure - Transport System (SFRARR)
version: '2022'
vulnerability: null
---
