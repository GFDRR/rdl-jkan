...
contact_point:
  ...
  url: https://geonode.pacificdata.org/catalogue/#/dataset/69
creator:
  affiliation: null
  email: null
  name: Earth and Oceans Observations Team Pacific Community
  url: https://geonode.pacificdata.org/catalogue/#/dataset/69
dataset_id: rdls_hzd-cok_pacificdata_ckeqhazardmap102500mrp
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://geonode.pacificdata.org/catalogue/#/dataset/69
  rel: source
loss:
  losses: []
project: null
...
referenced_by: []
resources:
- access_url: https://geonode.pacificdata.org/datasets/geonode:coo_10_2500t
  baseline_period: null
  climate: null
  conforms_to: http://www.opengis.net/def/serviceType/ogc/wms
  coordinate_system: EPSG:4326
  description: 'Cook Islands Earthquake Hazard Map, 1.0s Spectral Acceleration, 2500-year
    Return Period (OGC WMS: geonode Service)'
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WMS&version=1.1.1&request=GetMap&layers=geonode:coo_10_2500t&format=image%2Fpng
  format: null
  id: resource_0
...
- access_url: https://geonode.pacificdata.org/datasets/geonode:coo_10_2500t
  ...
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WCS&version=2.0.1&request=DescribeCoverage&CoverageId=geonode__coo_10_2500t
  format: null
  id: resource_1
...
- access_url: null
  ...
  description: Cook Islands Earthquake Hazard Map, 1.0s Spectral Acceleration, 2500-year
    Return Period
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WCS&request=GetCoverage&coverageid=geonode__coo_10_2500t&format=image%2Ftiff&version=2.0.1&compression=DEFLATE&tileWidth=512&tileHeight=512
  format: null
  id: resource_2
  media_type: image/tiff;application=geotiff
  spatial: null
...
- hazard
schema: rdls-10
slug: rdls_hzd-cok_pacificdata_ckeqhazardmap102500mrp
spatial:
  bbox:
  - -165.88491434149634
  - -21.95832
...
temporal:
  ...
  start: null
temporal_resolution: null
title: Cook Islands Earthquake Hazard Map, 1.0s Spectral Acceleration, 2500-year Return
  Period
version: null
vulnerability: null
---
