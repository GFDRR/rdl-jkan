...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/syr-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/syr-rainfall-subnational
dataset_id: rdls_hzd-syr_wfp_arabrepublicrainfallindic_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/syr-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    1-month, and 3-month rolling aggregations) at subnational administrative boundaries.
    These rainfall metrics serve as meteorological drought indicators for monitoring
    precipitation anomalies relative to long-term averages.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/syr-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135712890005_34496d1a'
  download_url: https://data.humdata.org/dataset/7f866980-92df-427d-997d-4aab0bf4f968/resource/dcdb5e03-4d4d-4479-a06c-cbe0a206dfd3/download/syr-rainfall-subnat-full.csv
  format: null
  id: resource_dcdb5e03
  media_type: text/csv
  spatial: null
  ...
  title: syr-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135712890005_34496d1a'
  download_url: https://data.humdata.org/dataset/7f866980-92df-427d-997d-4aab0bf4f968/resource/a2984219-0ecc-442d-843c-f42e4f5ada50/download/syr-rainfall-subnat-5ytd.csv
  format: null
  id: resource_a2984219
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: syr-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-syr_wfp_arabrepublicrainfallindic_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Syrian Arab Republic: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
