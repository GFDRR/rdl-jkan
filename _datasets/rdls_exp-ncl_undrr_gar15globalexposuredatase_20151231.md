...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-new-caledonia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-new-caledonia
dataset_id: rdls_exp-ncl_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-new-caledonia]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    were transposed onto 5x5 km and 1x1 km grid cells using geographic population
    distribution and GDP as spatial proxies. The GAR15 global exposure database was
    developed through a top-down approach combining multiple data sources and institutional
    inputs to create gridded exposure estimates for New Caledonia.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-new-caledonia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for New Caledonia.zip
  download_url: https://data.humdata.org/dataset/c3f73f51-3917-40ff-a1fb-578364a33e8d/resource/60ee08db-08fc-4c5a-a85f-5983d96eac20/download/ncl.zip
  format: null
  id: resource_60ee08db
  ...
  title: GAR15 Global Exposure Dataset for New Caledonia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ncl_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for New Caledonia
version: null
vulnerability: null
---
