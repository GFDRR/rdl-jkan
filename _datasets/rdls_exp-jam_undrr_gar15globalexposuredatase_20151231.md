...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-jamaica
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-jamaica
dataset_id: rdls_exp-jam_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-jamaica]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 exposure dataset for Jamaica was developed using a top-down
    ...
    population density and GDP as spatial proxies. The dataset integrates multi-source
    inputs from UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo to estimate economic values
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-jamaica
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Jamaica.zip
  download_url: https://data.humdata.org/dataset/23d62d61-cb63-430c-9d00-c2f540116577/resource/e7a0c5ab-7e66-4e53-aa4e-3c8fc96741a5/download/jam.zip
  format: null
  id: resource_e7a0c5ab
  ...
  title: GAR15 Global Exposure Dataset for Jamaica.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-jam_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Jamaica
version: null
vulnerability: null
---
