...
- entity:
    ...
    url: https://data.humdata.org/dataset/pak-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/pak-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-pak_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/pak-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Pakistan subset contains observed storm positions,
    wind speeds (wmo_wind), central pressures (wmo_pres), and storm classification
    (nature) extracted from the global archive and filtered for the Pakistan basin
    region.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pak-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Pakistan.
  download_url: https://data.humdata.org/dataset/89829160-a96c-442e-9cef-560577388073/resource/d1fcd71e-b639-4749-9cf6-6a2506f14c5f/download/ibtracs_all_list_v04r01_pak.csv
  format: null
  id: resource_d1fcd71e
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PAK.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Pakistan.
  download_url: https://data.humdata.org/dataset/89829160-a96c-442e-9cef-560577388073/resource/9f1d79b9-5d6e-4802-aad0-3802c804569e/download/ibtracs_all_list_v04r01_lines_pak.geojson
  format: null
  id: resource_9f1d79b9
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PAK.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-pak_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Pakistan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
