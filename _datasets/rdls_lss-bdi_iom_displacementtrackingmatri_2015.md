...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/bdi-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/bdi-iom-dtm-from-api
dataset_id: rdls_lss-bdi_iom_displacementtrackingmatri_2015
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bdi-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through field assessments (baseline,
    emergency tracking, and site assessments) and aggregates IDP figures at country
    and Admin 1-2 levels via a publicly accessible API. The dataset captures post-displacement
    impact metrics for conflict-affected populations in Burundi.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bdi-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Burundi IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/8574206c-da1b-4cbb-94d2-f07737715c05/resource/f551e735-02aa-481c-bf1c-0cb3aac76d39/download/bdi-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_f551e735
  media_type: text/csv
  spatial: null
  ...
  title: Burundi IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-bdi_iom_displacementtrackingmatri_2015
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-10-30'
temporal_resolution: null
title: Burundi IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
