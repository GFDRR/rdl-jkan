...
- entity:
    ...
    url: https://data.humdata.org/dataset/montserrat-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/montserrat-planet-road-surface-data
dataset_id: rdls_exp-msr_heigit_montserratplanetroadsurfa_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0 million km (82.5922%) - Unpaved roads: 0.0 million km (0.3982%) - Missing\
  \ OSM surface tags: 0.0 million km (11.1488%) - PlanetScope predictions cover: 0.0\
  \ million km (744.3898%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/montserrat-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/montserrat-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Montserrat: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Montserrat)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MS_planet_roadsurface_lines.gpkg
  format: null
  id: resource_10d8ff27
  ...
  title: Montserrat GPKG heigit_MS_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Montserrat: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Montserrat)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MS_planet_roadsurface_lines.geojson
  format: null
  id: resource_71ad1ec3
  ...
  temporal: null
  temporal_resolution: null
  title: Montserrat GeoJSON heigit_MS_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-msr_heigit_montserratplanetroadsurfa_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Montserrat: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
