...
- entity:
    ...
    url: https://data.humdata.org/dataset/bel-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bel-ghsl
dataset_id: rdls_exp-bel_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bel-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. The resulting GeoTIFF rasters represent the spatial distribution
    of human settlements and population density at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bel-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/c8c34556-f83d-424f-84a2-4c564407f6c5/resource/b1e3a461-630a-4760-93d4-a404ce7778ec/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bel.tif
  format: null
  id: resource_b1e3a461
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Belgium: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/c8c34556-f83d-424f-84a2-4c564407f6c5/resource/c2374fc9-3837-4c3f-ac87-61d5eb16bf38/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bel.tif
  format: null
  id: resource_c2374fc9
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-bel_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Belgium: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
