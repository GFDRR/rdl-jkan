...
- entity:
    ...
    url: https://data.humdata.org/dataset/lao-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/lao-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-lao_hdx_laopeoplesdemocraticrepub_1877
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lao-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS v4r01 tropical cyclone track data was sourced from NOAA/NCEI,
    which aggregates best-track records from multiple regional meteorological agencies
    into a unified global archive. The dataset was spatially filtered to include only
    storm tracks relevant to Lao PDR, retaining key fields such as storm position
    (lat/lon), wind speed, pressure, basin, and storm nature. The resulting CSV and
    GeoJSON files provide observed historical cyclone track data for hazard characterization
    in the Lao PDR context.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lao-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/02842fdb-4756-484e-91f0-fd0214448152/resource/a7d02a24-b156-48e4-ab83-28ae0a219c2f/download/ibtracs_all_list_v04r01_lao.csv
  format: null
  id: resource_a7d02a24
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_LAO.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1877 to date that pass within 2000 kilometers
    of Lao People's Democratic Republic.
  download_url: https://data.humdata.org/dataset/02842fdb-4756-484e-91f0-fd0214448152/resource/99783b9b-6ad2-4fa9-ae85-90204f19b9b4/download/ibtracs_all_list_v04r01_lines_lao.geojson
  format: null
  id: resource_99783b9b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_LAO.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lao_hdx_laopeoplesdemocraticrepub_1877
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1877-05-15'
temporal_resolution: null
title: 'Lao People''s Democratic Republic: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
