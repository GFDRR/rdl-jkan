...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/nam-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/nam-rainfall-subnational
dataset_id: rdls_hzd-nam_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/nam-rainfall-subnational]'
...
lineage:
  description: Rainfall data are derived from CHIRPS satellite observations merged
    with rain gauge station data at dekadal temporal resolution. Indicators are computed
    including raw 10-day rainfall, rolling 1-month and 3-month aggregations, and anomalies
    relative to long-term averages, then spatially aggregated to Namibian subnational
    administrative units. This dataset supports drought monitoring and early warning
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nam-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135601304988_c93defd3'
  download_url: https://data.humdata.org/dataset/d5211e9a-9b5b-45b5-a62c-bae4da4def46/resource/83cd1603-79f2-4802-ae1b-2021782f1f36/download/nam-rainfall-subnat-full.csv
  format: null
  id: resource_83cd1603
  media_type: text/csv
  spatial: null
  ...
  title: nam-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135601304988_c93defd3'
  download_url: https://data.humdata.org/dataset/d5211e9a-9b5b-45b5-a62c-bae4da4def46/resource/9938c139-8560-4430-8d42-9330846ee988/download/nam-rainfall-subnat-5ytd.csv
  format: null
  id: resource_9938c139
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: nam-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nam_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Namibia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
