...
- entity:
    ...
    url: https://data.humdata.org/dataset/bolivia-plurinational-state-of-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/bolivia-plurinational-state-of-road-surface-data
dataset_id: rdls_exp-bol_heigit_plurinationalstateroadsur_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.4638 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0299 and 0.3277
  (in million kms), corressponding to 6.4374% and 70.6473% respectively of the total
  road length in the dataset region. 0.1063 million km or 22.9153% of road surface
  ...
  to 0.3365% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bolivia-plurinational-state-of-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated predictions for approximately 0.4638 million km of mapped
    roads in Bolivia, with results delivered as GeoJSON and GeoPackage formats for
    spatial analysis and humanitarian access planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bolivia-plurinational-state-of-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Bolivia (Plurinational State of): Road Surface Data (GeoJSON data
    for Bolivia (plurinational state of).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bol_roadsurface_lines.geojson
  format: null
  id: resource_91be9c74
  ...
  title: Bolivia (plurinational state of) GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Bolivia (Plurinational State of): Road Surface Data (Geopackage data
    for Bolivia (plurinational state of).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bol_roadsurface_lines.gpkg
  format: null
  id: resource_3c898af8
  ...
  temporal: null
  temporal_resolution: null
  title: Bolivia (plurinational state of) GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bol_heigit_plurinationalstateroadsur_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Bolivia (Plurinational State of): Road Surface Data'
version: null
vulnerability: null
---
