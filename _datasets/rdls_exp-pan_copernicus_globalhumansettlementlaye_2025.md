...
- entity:
    ...
    url: https://data.humdata.org/dataset/pan-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/pan-ghsl
dataset_id: rdls_exp-pan_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/pan-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    and population distribution at fine spatial resolution for Panama.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pan-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/57f63b0c-6a63-4674-9641-414d6cf2ab77/resource/e6b30934-b951-452d-9252-fb00b7c2556e/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_pan.tif
  format: null
  id: resource_e6b30934
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Panama: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/57f63b0c-6a63-4674-9641-414d6cf2ab77/resource/4a0461ba-5187-4775-92b4-2409aa8c737d/download/ghs_pop_e2025_r2023a_54009_100_v1_0_pan.tif
  format: null
  id: resource_4a0461ba
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-pan_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Panama: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
