...
- entity:
    ...
    url: https://data.humdata.org/dataset/tuvalu-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/tuvalu-road-surface-data
dataset_id: rdls_exp-tuv_heigit_tuvaluroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tuvalu-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated surface predictions for roads across Tuvalu, with results
    integrated into a geospatial dataset providing both observed OSM attributes and
    AI-predicted surface classifications for humanitarian access and infrastructure
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tuvalu-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Tuvalu: Road Surface Data (GeoJSON data for Tuvalu.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tuv_roadsurface_lines.geojson
  format: null
  id: resource_21d1265d
  ...
  title: Tuvalu GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Tuvalu: Road Surface Data (Geopackage data for Tuvalu.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tuv_roadsurface_lines.gpkg
  format: null
  id: resource_6d8e9be6
  ...
  temporal: null
  temporal_resolution: null
  title: Tuvalu GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tuv_heigit_tuvaluroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Tuvalu: Road Surface Data'
version: null
vulnerability: null
---
