...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-eritrea
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-eritrea
dataset_id: rdls_exp-eri_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-eritrea]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    data as spatial proxies. The dataset was developed by UNEP-GRID for the Global
    Assessment Report on Disaster Risk Reduction (GAR15) through multi-agency collaboration
    to create a globally consistent exposure database for risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-eritrea
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Eritrea.zip
  download_url: https://data.humdata.org/dataset/20270df9-4aad-450b-a836-f01684e33683/resource/cb8bb84c-5acf-422a-9354-09d108580e67/download/eri.zip
  format: null
  id: resource_cb8bb84c
  ...
  title: GAR15 Global Exposure Dataset for Eritrea.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-eri_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Eritrea
version: null
vulnerability: null
---
