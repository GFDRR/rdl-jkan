...
- entity:
    ...
    url: https://data.humdata.org/dataset/uganda-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/uganda-road-surface-data
dataset_id: rdls_exp-uga_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.4166 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.027 and 0.1137
  (in million kms), corressponding to 6.4788% and 27.3023% respectively of the total
  road length in the dataset region. 0.2759 million km or 66.219% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.002 million km of information (corressponding
  to 0.7318% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/uganda-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    type attributes across Uganda, supporting humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/uganda-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Uganda: Road Surface Data (GeoJSON data for Uganda.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_uga_roadsurface_lines.geojson
  format: null
  id: resource_f6e591de
  ...
  title: Uganda GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Uganda: Road Surface Data (Geopackage data for Uganda.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_uga_roadsurface_lines.gpkg
  format: null
  id: resource_7199ded2
  ...
  temporal: null
  temporal_resolution: null
  title: Uganda GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-uga_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Uganda: Road Surface Data'
version: null
vulnerability: null
---
