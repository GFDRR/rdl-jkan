...
- entity:
    ...
    url: https://data.humdata.org/dataset/sxm-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/sxm-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-sxm_hdx_sintmaartendutchpartibtra_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sxm-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: Historical tropical cyclone observations for Sint Maarten were extracted
    from the International Best Track Archive for Climate Stewardship (IBTrACS v4r01),
    a multi-agency compilation of best-track tropical cyclone data. Track positions,
    wind speeds (WMO standard), and central pressures were recorded at observation
    times and provided as both tabular CSV and GeoJSON line geometry formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sxm-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Sint Maarten (Dutch part).
  download_url: https://data.humdata.org/dataset/13c22ddf-96a0-4e89-8430-ca4fc8bb3f30/resource/0019c925-8cf0-45aa-84d4-b359109d7fd0/download/ibtracs_all_list_v04r01_sxm.csv
  format: null
  id: resource_0019c925
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SXM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Sint Maarten (Dutch part).
  download_url: https://data.humdata.org/dataset/13c22ddf-96a0-4e89-8430-ca4fc8bb3f30/resource/33774afc-0139-4d04-917e-35c2444d66b1/download/ibtracs_all_list_v04r01_lines_sxm.geojson
  format: null
  id: resource_33774afc
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SXM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-sxm_hdx_sintmaartendutchpartibtra_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Sint Maarten (Dutch part): IBTrACS Storm Tracks'
version: null
vulnerability: null
---
