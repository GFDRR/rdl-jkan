...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-sen-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-sen-settlement-extents-v3-0
dataset_id: rdls_exp-sen_grid3_sensettlementextentsv30_2016
description: 'The GRID3 SEN - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Senegal, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Senegal Settlement Extents,
  ...
  2024. GRID3 SEN - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-sen-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents and building counts were derived from open data
    ...
    distributions. Population was estimated at 3-arc second (~100 meter) grid resolution
    within identified settlement areas. The dataset provides both polygon and point-based
    representations of settlements across Senegal.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-sen-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Senegal - GRID3 SEN - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/51abf6bd-c20c-4da0-997f-1896ddfd7e52/resource/d1d35bf6-f69f-480a-88c5-18d73bd986e2/download/grid3-sen-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_d1d35bf6
  ...
  title: GRID3 SEN - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Senegal - GRID3 SEN - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/51abf6bd-c20c-4da0-997f-1896ddfd7e52/resource/7321a6fe-ec39-47ea-bc7f-1278ce259504/download/grid3_sen_settlement_extents_v3_0.zip
  format: null
  id: resource_7321a6fe
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_SEN_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/51abf6bd-c20c-4da0-997f-1896ddfd7e52/resource/0304dda4-1d59-45e3-9f73-6b76e9886af7/download/grid3_sen_settlement_grid_v3_0.zip
  format: null
  id: resource_0304dda4
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_SEN_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sen_grid3_sensettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Senegal - GRID3 SEN - Settlement Extents v3.0
version: null
vulnerability: null
---
