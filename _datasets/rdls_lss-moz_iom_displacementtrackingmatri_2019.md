...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/moz-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/moz-iom-dtm-from-api
dataset_id: rdls_lss-moz_iom_displacementtrackingmatri_2019
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/moz-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced populations across Mozambique.
    Data is aggregated at admin 0, 1, and 2 levels with demographic disaggregation
    (male/female) and displacement reason classification, then published via public
    API for humanitarian and research use.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/moz-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Mozambique IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/bd7ee999-169e-4aec-b539-be48ef6c12df/resource/6b2b9968-dbb1-4d45-bd61-78335075cf1a/download/moz-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_6b2b9968
  media_type: text/csv
  spatial: null
  ...
  title: Mozambique IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-moz_iom_displacementtrackingmatri_2019
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2019-03-30'
temporal_resolution: null
title: Mozambique IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
