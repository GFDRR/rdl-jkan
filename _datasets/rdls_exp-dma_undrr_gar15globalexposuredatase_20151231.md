...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-dominica
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-dominica
dataset_id: rdls_exp-dma_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-dominica]'
...
lineage:
  description: The GAR15 global exposure dataset for Dominica was developed using
    ...
    geographic population density and GDP as spatial proxies. The methodology was
    developed by UNEP-GRID in collaboration with WAPMERR, EU JRC, and Kokusai Kogyo
    to create a consistent global exposure database for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-dominica
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Dominica.zip
  download_url: https://data.humdata.org/dataset/3b5f6c4e-a823-4513-88c2-90bf4469b5e1/resource/73e1df66-62c2-4a2f-b902-93b2a3eea977/download/dma.zip
  format: null
  id: resource_73e1df66
  ...
  title: GAR15 Global Exposure Dataset for Dominica.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dma_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Dominica
version: null
vulnerability: null
---
