...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-russian-federation
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-russian-federation
dataset_id: rdls_exp-rus_kontur_federationpopulationdensi_2023
description: 'Russian Federation population density for 400m H3 hexagons. Built from
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-russian-federation]'
...
exposure:
- asset_type:
    description: Gridded population density at 400m H3 hexagon resolution for Russian
      Federation
    id: population
    scheme: null
    title: null
...
lineage:
  description: Population density estimates were derived by fusing multiple satellite-based
    ...
    were aggregated to 400m H3 hexagonal grid cells using hierarchical spatial indexing.
    The resulting dataset provides baseline gridded population exposure for disaster
    risk assessment at national scale.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-russian-federation
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Russian Federation: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_RU_20220630.gpkg.gz
  format: null
  id: resource_735ce08a
  ...
  title: kontur_population_RU_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Russian Federation: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_RU_20231101.gpkg.gz
  format: null
  id: resource_b64e44c9
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_RU_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-rus_kontur_federationpopulationdensi_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Russian Federation: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
