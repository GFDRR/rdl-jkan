...
- entity:
    ...
    url: https://data.humdata.org/dataset/slb-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/slb-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-slb_hdx_ibtracsstormtracks_1897
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/slb-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Solomon Islands subset contains track points with ISO timestamps, basin/subbasin
    classifications, wind speed (wmo_wind in m/s), and central pressure (wmo_pres)
    measurements, provided in both tabular CSV and GeoJSON line geometry formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/slb-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1897 to date that pass within 2000 kilometers
    of Solomon Islands.
  download_url: https://data.humdata.org/dataset/f709de52-ab25-4e30-aa35-a70faaec5941/resource/9a2608a6-71a8-4b89-9c69-75a6df9b3364/download/ibtracs_all_list_v04r01_slb.csv
  format: null
  id: resource_9a2608a6
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SLB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1897 to date that pass within 2000 kilometers
    of Solomon Islands.
  download_url: https://data.humdata.org/dataset/f709de52-ab25-4e30-aa35-a70faaec5941/resource/0992c610-ace3-407b-8759-c314e9f3798c/download/ibtracs_all_list_v04r01_lines_slb.geojson
  format: null
  id: resource_0992c610
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SLB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-slb_hdx_ibtracsstormtracks_1897
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1897-12-07'
temporal_resolution: null
title: 'Solomon Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
