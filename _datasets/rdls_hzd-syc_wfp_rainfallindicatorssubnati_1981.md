...
- entity:
    ...
    url: https://data.humdata.org/dataset/syc-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/syc-rainfall-subnational
dataset_id: rdls_hzd-syc_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/syc-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    and 3-month rolling indicators at subnational administrative units. Anomalies
    and quantiles relative to long-term averages were computed to characterize meteorological
    drought conditions.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/syc-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135605777615_f412d541'
  download_url: https://data.humdata.org/dataset/3f3dd7e0-6406-499a-857d-f3a946efed6d/resource/9f38294d-722e-4b43-8170-9b9546a29243/download/syc-rainfall-subnat-full.csv
  format: null
  id: resource_9f38294d
  media_type: text/csv
  spatial: null
  ...
  title: syc-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135605777615_f412d541'
  download_url: https://data.humdata.org/dataset/3f3dd7e0-6406-499a-857d-f3a946efed6d/resource/1e9fbf0d-edf7-4c18-bdb8-274da29a3448/download/syc-rainfall-subnat-5ytd.csv
  format: null
  id: resource_1e9fbf0d
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: syc-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-syc_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Seychelles: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
