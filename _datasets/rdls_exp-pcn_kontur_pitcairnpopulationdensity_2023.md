...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-pitcairn
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-pitcairn
dataset_id: rdls_exp-pcn_kontur_pitcairnpopulationdensity_2023
description: 'Pitcairn population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-pitcairn]'
...
lineage:
  description: Population density estimates were generated by fusing multiple global
    and regional datasets (GHSL, HRSL, Microsoft Buildings, Copernicus Land Cover,
    LINZ, and OpenStreetMap) and aggregating the results into H3 hexagonal grid cells
    at 400m resolution. The Kontur Population dataset provides baseline gridded population
    exposure data suitable for disaster risk assessment and spatial analysis.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-pitcairn
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Pitcairn: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PN_20220630.gpkg.gz
  format: null
  id: resource_011e9606
  ...
  title: kontur_population_PN_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Pitcairn: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PN_20231101.gpkg.gz
  format: null
  id: resource_8d162c9a
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_PN_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pcn_kontur_pitcairnpopulationdensity_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Pitcairn: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
