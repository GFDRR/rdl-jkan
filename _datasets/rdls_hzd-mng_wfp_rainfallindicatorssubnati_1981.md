...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/mng-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mng-rainfall-subnational
dataset_id: rdls_hzd-mng_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/mng-rainfall-subnational]'
...
lineage:
  description: Rainfall data are derived from CHIRPS satellite observations merged
    ...
    (10-day, 1-month, 3-month rolling sums and anomalies) at subnational administrative
    units in Mongolia. These indicators support drought monitoring and early warning
    by tracking precipitation relative to long-term climatological averages.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mng-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135849309115_b2b5864e'
  download_url: https://data.humdata.org/dataset/c608f97a-92b6-4f46-9786-7da8c0b4c74c/resource/a85f1730-9010-4e33-a0de-9e42f3756ccf/download/mng-rainfall-subnat-full.csv
  format: null
  id: resource_a85f1730
  media_type: text/csv
  spatial: null
  ...
  title: mng-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135849309115_b2b5864e'
  download_url: https://data.humdata.org/dataset/c608f97a-92b6-4f46-9786-7da8c0b4c74c/resource/924d5462-9a67-439c-a188-37064f21ca00/download/mng-rainfall-subnat-5ytd.csv
  format: null
  id: resource_924d5462
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mng-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mng_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Mongolia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
