...
- entity:
    ...
    url: https://data.humdata.org/dataset/svn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/svn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-svn_hdx_ibtracsstormtracks_1865
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/svn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS aggregates tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The Slovenia subset contains observed
    cyclone track positions, timestamps, basin classifications, wind speeds (wmo_wind),
    and central pressure (wmo_pres) for storms affecting or passing through the region,
    provided in both tabular CSV and GeoJSON line geometry formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/svn-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Slovenia.
  download_url: https://data.humdata.org/dataset/b117617f-0fd2-49ce-ba8c-d10b1e175832/resource/b47b8851-c352-43d3-bad2-ae745d449e8c/download/ibtracs_all_list_v04r01_svn.csv
  format: null
  id: resource_b47b8851
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SVN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Slovenia.
  download_url: https://data.humdata.org/dataset/b117617f-0fd2-49ce-ba8c-d10b1e175832/resource/1ff9f5ea-806b-4298-97b6-45c2b6d6ce62/download/ibtracs_all_list_v04r01_lines_svn.geojson
  format: null
  id: resource_1ff9f5ea
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SVN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-svn_hdx_ibtracsstormtracks_1865
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1865-10-24'
temporal_resolution: null
title: 'Slovenia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
