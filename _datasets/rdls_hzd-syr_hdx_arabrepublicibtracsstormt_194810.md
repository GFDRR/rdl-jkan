...
- entity:
    ...
    url: https://data.humdata.org/dataset/syr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/syr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-syr_hdx_arabrepublicibtracsstormt_194810
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/syr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Syrian
    Arab Republic subset contains observed storm track positions with associated wind
    speed (wmo_wind) and pressure (wmo_pres) measurements at specific ISO-timestamped
    locations, representing empirical hazard observations rather than modeled projections.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/syr-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/5cc5531e-8307-425f-bdd1-8225515e8200/resource/07aa5509-f8f9-4d1e-b702-d60516209472/download/ibtracs_all_list_v04r01_syr.csv
  format: null
  id: resource_07aa5509
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SYR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1948 to date that pass within 2000 kilometers
    of Syrian Arab Republic.
  download_url: https://data.humdata.org/dataset/5cc5531e-8307-425f-bdd1-8225515e8200/resource/97c3126a-6bf3-429e-b162-ae04c013ff61/download/ibtracs_all_list_v04r01_lines_syr.geojson
  format: null
  id: resource_97c3126a
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SYR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-syr_hdx_arabrepublicibtracsstormt_194810
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1948-10-19'
temporal_resolution: null
title: 'Syrian Arab Republic: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
