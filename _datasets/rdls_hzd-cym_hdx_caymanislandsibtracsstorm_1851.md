...
- entity:
    ...
    url: https://data.humdata.org/dataset/cym-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/cym-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-cym_hdx_caymanislandsibtracsstorm_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cym-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Cayman Islands
    subset contains historical and recent storm tracks with ISO-timestamped positions,
    wind speeds (wmo_wind), and central pressure (wmo_pres) measurements, provided
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cym-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Cayman Islands.
  download_url: https://data.humdata.org/dataset/745b3b1b-62ad-4680-8d6f-ee0c9ec0c559/resource/42e235d8-3707-4053-b929-0eb1848be15c/download/ibtracs_all_list_v04r01_cym.csv
  format: null
  id: resource_42e235d8
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CYM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Cayman Islands.
  download_url: https://data.humdata.org/dataset/745b3b1b-62ad-4680-8d6f-ee0c9ec0c559/resource/782488f1-adcf-41ae-97dd-60b2f64f612e/download/ibtracs_all_list_v04r01_lines_cym.geojson
  format: null
  id: resource_782488f1
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CYM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cym_hdx_caymanislandsibtracsstorm_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Cayman Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
