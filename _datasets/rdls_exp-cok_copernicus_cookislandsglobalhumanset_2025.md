...
- entity:
    ...
    url: https://data.humdata.org/dataset/cok-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cok-ghsl
dataset_id: rdls_exp-cok_copernicus_cookislandsglobalhumanset_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cok-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distribution. For Cook
    Islands, this produces rasterized layers of building footprints and population
    density derived from multi-source geospatial data integration.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cok-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/e8611b21-44a7-4047-b32c-5915bddc7b85/resource/1b107930-3f93-42e1-a3da-6b8a5bc16685/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cok.tif
  format: null
  id: resource_1b107930
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Cook Islands: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/e8611b21-44a7-4047-b32c-5915bddc7b85/resource/d5121056-75c3-4b15-9610-7e99470f6a9a/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cok.tif
  format: null
  id: resource_d5121056
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cok_copernicus_cookislandsglobalhumanset_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Cook Islands: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
