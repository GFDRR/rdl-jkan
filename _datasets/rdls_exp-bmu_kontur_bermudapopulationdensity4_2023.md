...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-bermuda
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-bermuda
dataset_id: rdls_exp-bmu_kontur_bermudapopulationdensity4_2023
description: 'Bermuda population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-bermuda]'
...
exposure:
- asset_type:
    description: Gridded population counts for Bermuda at 400m H3 hexagon resolution,
      derived from a fusion of GHSL, Facebook HRSL, Microsoft Buildings, and other
      land cover datasets
    id: population
    scheme: null
    title: null
...
lineage:
  description: The Kontur Population dataset was constructed by overlapping the Global
    ...
    (HRSL) and supplementary building footprint and land cover datasets (Microsoft
    Buildings, Copernicus, LINZ, OpenStreetMap), then disaggregating population counts
    into H3 hexagonal grid cells at approximately 400m resolution. The resulting vector
    dataset provides gridded population density estimates for Bermuda, suitable for
    use as a baseline exposure layer in disaster risk assessments.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-bermuda
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Bermuda: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_BM_20220630.gpkg.gz
  format: null
  id: resource_d4cd6fe0
  ...
  title: kontur_population_BM_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Bermuda: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_BM_20231101.gpkg.gz
  format: null
  id: resource_057dd975
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_BM_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bmu_kontur_bermudapopulationdensity4_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Bermuda: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
