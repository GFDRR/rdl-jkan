...
- entity:
    ...
    url: https://data.humdata.org/dataset/arg-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/arg-ghsl
dataset_id: rdls_exp-arg_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/arg-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. The Argentina subset represents the national application of this
    global methodology for assessing human presence and settlement patterns.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/arg-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/0dcfc793-13f1-41c7-ae18-b5cf3ced5e2e/resource/7dac481b-ed1c-4b68-9736-fafc51a8524b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_arg.tif
  format: null
  id: resource_7dac481b
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Argentina: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/0dcfc793-13f1-41c7-ae18-b5cf3ced5e2e/resource/aff44d40-075c-4cfb-ad4a-662f035b31a1/download/ghs_pop_e2025_r2023a_54009_100_v1_0_arg.tif
  format: null
  id: resource_aff44d40
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-arg_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Argentina: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
