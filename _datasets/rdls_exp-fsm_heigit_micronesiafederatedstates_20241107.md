...
- entity:
    ...
    url: https://data.humdata.org/dataset/micronesia-federated-states-of-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/micronesia-federated-states-of-road-surface-data
dataset_id: rdls_exp-fsm_heigit_micronesiafederatedstates_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0008 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0002 and 0.0002
  (in million kms), corressponding to 28.0152% and 20.951% respectively of the total
  road length in the dataset region. 0.0004 million km or 51.0338% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0001 million km of information (corressponding
  to 12.5671% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/micronesia-federated-states-of-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    learning algorithm to predict and classify road surface types (paved vs unpaved)
    across Federated States of Micronesia. The model outputs include predicted surface
    classifications, confidence metrics, and length estimates for each road segment,
    enabling infrastructure exposure assessment for humanitarian access and development
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/micronesia-federated-states-of-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Micronesia (Federated States of): Road Surface Data (GeoJSON data
    for Micronesia (federated states of).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_fsm_roadsurface_lines.geojson
  format: null
  id: resource_2aca2f7f
  ...
  title: Micronesia (federated states of) GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Micronesia (Federated States of): Road Surface Data (Geopackage data
    for Micronesia (federated states of).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_fsm_roadsurface_lines.gpkg
  format: null
  id: resource_0917644b
  ...
  temporal: null
  temporal_resolution: null
  title: Micronesia (federated states of) GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-fsm_heigit_micronesiafederatedstates_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Micronesia (Federated States of): Road Surface Data'
version: null
vulnerability: null
---
