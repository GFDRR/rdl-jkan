...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-sao-tome-and-principe
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-sao-tome-and-principe
dataset_id: rdls_exp-stp_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-sao-tome-and-principe]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    to create a spatially-explicit inventory of economic and structural assets for
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-sao-tome-and-principe
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Sao Tome and Principe.zip
  download_url: https://data.humdata.org/dataset/c7ad6504-2ac8-48aa-bf21-721d7f778d5a/resource/a8e5f0d5-9afe-4b88-9246-4f59f1d7786e/download/stp.zip
  format: null
  id: resource_a8e5f0d5
  ...
  title: GAR15 Global Exposure Dataset for Sao Tome and Principe.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-stp_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Sao Tome and Principe
version: null
vulnerability: null
---
