...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-san-marino
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-san-marino
dataset_id: rdls_exp-smr_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-san-marino]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    collaboration to create a globally consistent exposure database for San Marino.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-san-marino
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for San Marino.zip
  download_url: https://data.humdata.org/dataset/99d73230-12cf-495e-abeb-5fe6f00f3691/resource/2f682fd7-7d42-4f80-9a0c-3270d0a0a5c1/download/smr.zip
  format: null
  id: resource_2f682fd7
  ...
  title: GAR15 Global Exposure Dataset for San Marino.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-smr_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for San Marino
version: null
vulnerability: null
---
