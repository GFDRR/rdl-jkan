...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-dji-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-dji-settlement-extents-v3-0
dataset_id: rdls_exp-dji_grid3_djisettlementextentsv30_2016
description: 'The GRID3 DJI - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Djibouti, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Djibouti Settlement Extents,
  ...
  2024. GRID3 DJI - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-dji-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents were derived from open data using a new methodology
    to generate building counts and settlement polygons. The dataset includes spatial
    representation of settlements as polygons and gridded centroids at 100-meter resolution
    with probability estimates, providing a foundational exposure layer for disaster
    risk assessment in Djibouti.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-dji-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Djibouti - GRID3 DJI - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/3a44b926-cd65-4c76-80ba-9404fb169de6/resource/2405a184-5907-4b36-942e-cc6ca75e20ff/download/grid3-dji-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_2405a184
  ...
  title: GRID3 DJI - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Djibouti - GRID3 DJI - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/3a44b926-cd65-4c76-80ba-9404fb169de6/resource/59b1970d-c06a-44f7-bb38-2f345da24366/download/grid3_dji_settlement_extents_v3_0.zip
  format: null
  id: resource_59b1970d
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_DJI_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/3a44b926-cd65-4c76-80ba-9404fb169de6/resource/13daf0ee-ece0-497c-977a-200a5625bc93/download/grid3_dji_settlement_grid_v3_0.zip
  format: null
  id: resource_13daf0ee
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_DJI_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dji_grid3_djisettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Djibouti - GRID3 DJI - Settlement Extents v3.0
version: null
vulnerability: null
---
