...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-afghanistan
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-afghanistan
dataset_id: rdls_exp-afg_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-afghanistan]'
...
lineage:
  description: The GAR15 exposure dataset for Afghanistan was developed using a top-down
    ...
    inputs from UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo to create a comprehensive
    gridded exposure inventory for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-afghanistan
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Afghanistan.zip
  download_url: https://data.humdata.org/dataset/3d2fe0df-7cc9-44a6-b7b3-3b864732a6c1/resource/cb7c27b5-1706-4a11-b5e4-3880d0f2cb92/download/afg.zip
  format: null
  id: resource_cb7c27b5
  ...
  title: GAR15 Global Exposure Dataset for Afghanistan.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-afg_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Afghanistan
version: null
vulnerability: null
---
