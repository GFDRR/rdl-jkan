...
- entity:
    ...
    url: https://data.humdata.org/dataset/ncl-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ncl-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ncl_hdx_newcaledoniaibtracsstormt_1897
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ncl-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The New
    Caledonia subset contains storm track points with ISO timestamps, geographic coordinates,
    wind speed (wmo_wind), and central pressure (wmo_pres) measurements, provided
    in both tabular CSV and GeoJSON line geometry formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ncl-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1897 to date that pass within 2000 kilometers
    of New Caledonia.
  download_url: https://data.humdata.org/dataset/6666c9a3-14b1-4279-a6e1-e37797927394/resource/1ab96774-e7e8-479e-9dbc-7d71085dfff9/download/ibtracs_all_list_v04r01_ncl.csv
  format: null
  id: resource_1ab96774
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NCL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1897 to date that pass within 2000 kilometers
    of New Caledonia.
  download_url: https://data.humdata.org/dataset/6666c9a3-14b1-4279-a6e1-e37797927394/resource/5f924f95-4412-4318-bace-1ad95c5d529d/download/ibtracs_all_list_v04r01_lines_ncl.geojson
  format: null
  id: resource_5f924f95
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NCL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ncl_hdx_newcaledoniaibtracsstormt_1897
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1897-01-04'
temporal_resolution: null
title: 'New Caledonia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
