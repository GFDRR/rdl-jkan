...
- entity:
    ...
    url: https://data.humdata.org/dataset/sjm-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/sjm-ghsl
dataset_id: rdls_exp-sjm_copernicus_svalbardjanmayenislandsgl_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/sjm-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to generate gridded estimates of built-up surfaces and population distribution.
    The resulting GeoTIFF layers represent human settlement patterns and built environment
    extent at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sjm-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/4752f87e-7292-426e-9e6a-67f513db1d03/resource/bc9f4b99-927b-4638-8a8b-9cfa81dda0e4/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_sjm.tif
  format: null
  id: resource_bc9f4b99
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Svalbard and Jan Mayen Islands: Copernicus Global Human Settlement
    Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system:
    Mollweide)'
  download_url: https://data.humdata.org/dataset/4752f87e-7292-426e-9e6a-67f513db1d03/resource/5efdb52c-f29a-4202-a170-6f4faa340b59/download/ghs_pop_e2025_r2023a_54009_100_v1_0_sjm.tif
  format: null
  id: resource_5efdb52c
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-sjm_copernicus_svalbardjanmayenislandsgl_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Svalbard and Jan Mayen Islands: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
