...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/cri-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/cri-rainfall-subnational
dataset_id: rdls_hzd-cri_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    1-month, 3-month rolling totals and anomalies) at subnational administrative units
    in Costa Rica to support drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cri-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135532517168_6757fc20'
  download_url: https://data.humdata.org/dataset/78c8e9e1-8faa-4baf-b4b1-453090915c22/resource/351431b4-61b7-4e66-a635-efe6a0c9dc4a/download/cri-rainfall-subnat-full.csv
  format: null
  id: resource_351431b4
  media_type: text/csv
  spatial: null
  ...
  title: cri-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135532517168_6757fc20'
  download_url: https://data.humdata.org/dataset/78c8e9e1-8faa-4baf-b4b1-453090915c22/resource/09486158-92ef-4cd2-a3f4-0f59dc8e594d/download/cri-rainfall-subnat-5ytd.csv
  format: null
  id: resource_09486158
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: cri-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cri_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Costa Rica: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
