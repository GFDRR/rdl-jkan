...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/malawi-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/malawi-level-1-exposure-data
dataset_id: rdls_exp-mwi_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/malawi-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/malawi-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Malawi produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/7d2f5ed5-f659-4077-ac9d-0d7f8b392d5e/resource/d207e4ce-a2b3-4421-88b4-216edb5b5b64/download/mwi_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_d207e4ce
  ...
  title: MWI_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mwi_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Malawi: Level 1 Exposure Data'
version: null
vulnerability: null
---
