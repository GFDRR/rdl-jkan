...
- entity:
    ...
    url: https://data.humdata.org/dataset/tanzania-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/tanzania-level-1-exposure-data
dataset_id: rdls_exp-tza_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tanzania-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: The METEOR project developed a global-quality Level 1 exposure dataset
    for Tanzania by applying Earth observation-based modeling routines to estimate
    building stock characteristics (count, area, rebuilding value) at 15-arcsecond
    grid resolution (~500m). The data was generated for catastrophe modeling and loss
    estimation applications in disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: METEOR Project (Modelling Exposure Through Earth Observation Routines)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tanzania-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Tanzania produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/b4057152-63ba-4b18-bada-6271620638c7/resource/547c51ef-b511-4420-807c-bc2bc59ee43e/download/tza_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_547c51ef
  ...
  title: TZA_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tza_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Tanzania: Level 1 Exposure Data'
version: null
vulnerability: null
---
