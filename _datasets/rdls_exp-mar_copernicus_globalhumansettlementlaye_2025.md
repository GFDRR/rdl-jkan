...
- entity:
    ...
    url: https://data.humdata.org/dataset/mar-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mar-ghsl
dataset_id: rdls_exp-mar_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mar-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. The Morocco subset represents the national application of this global
    methodology for characterizing human presence and settlement patterns.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mar-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/e0a2038d-f54a-4880-88d6-9045c7a63b76/resource/d03f2443-419e-4227-8c33-9dd1aadfbc5b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mar.tif
  format: null
  id: resource_d03f2443
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Morocco: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/e0a2038d-f54a-4880-88d6-9045c7a63b76/resource/2e8ef800-df25-42af-acea-b65dae87c59c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mar.tif
  format: null
  id: resource_2e8ef800
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mar_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Morocco: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
