...
creator:
  ...
  name: Open street map
  url: https://www.openstreetmap.org/
dataset_id: rdls_exp-crstac_openstreetmaposm_buildings
...
referenced_by: []
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/exposure-vulnerability/buildings/open-street-map-osm/buildings/buildings.json
  ...
  title: 'STAC Item: Open Street Map (OSM) - Buildings'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Open Street Map (OSM) - Buildings - data file
  ...
  temporal: null
  temporal_resolution: null
  title: Open Street Map (OSM) - Buildings - data file
- access_url: https://github.com/osm-flex/osm-flex
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Open Street Map (OSM) - Buildings (Code link)
  download_url: null
...
- exposure
schema: rdls-10
slug: rdls_exp-crstac_openstreetmaposm_buildings
spatial:
  bbox:
  - -180.0
  - -90.0
...
temporal:
  ...
  start: '2004'
temporal_resolution: null
title: Open Street Map (OSM) - Buildings
version: null
vulnerability: null
---
