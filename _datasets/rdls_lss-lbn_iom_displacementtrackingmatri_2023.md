...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/lbn-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/lbn-iom-dtm-from-api
dataset_id: rdls_lss-lbn_iom_displacementtrackingmatri_2023
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/lbn-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced persons across Lebanon
    at admin 0-2 levels. Data is aggregated by displacement reason, demographics (gender),
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lbn-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Lebanon IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/e0729389-06d0-48b1-957b-a22168e85ee2/resource/34e7f993-45dd-4152-895e-31a60dbc4872/download/lbn-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_34e7f993
  media_type: text/csv
  spatial: null
  ...
  title: Lebanon IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-lbn_iom_displacementtrackingmatri_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-10-15'
temporal_resolution: null
title: Lebanon IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
