...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/som-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/som-iom-dtm-from-api
dataset_id: rdls_lss-som_iom_displacementtrackingmatri_2016
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/som-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through baseline assessments, emergency
    tracking tools, and site assessments across Somalia at multiple administrative
    levels. Data is aggregated and published via a public API, providing non-sensitive
    IDP counts disaggregated by gender, displacement reason, and origin location to
    track internally displaced populations.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/som-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Somalia IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/b21eb34d-6ca1-47f5-a4ca-cc83a351369c/resource/97729555-bbaf-4d7c-ac44-e698ebc7b6b1/download/som-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_97729555
  media_type: text/csv
  spatial: null
  ...
  title: Somalia IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-som_iom_displacementtrackingmatri_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-06-01'
temporal_resolution: null
title: Somalia IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
