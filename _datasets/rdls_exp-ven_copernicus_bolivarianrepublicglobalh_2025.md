...
- entity:
    ...
    url: https://data.humdata.org/dataset/ven-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/ven-ghsl
dataset_id: rdls_exp-ven_copernicus_bolivarianrepublicglobalh_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ven-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    satellite imagery, census records, and crowdsourced geographic information through
    automated spatial data analytics to produce fine-scale gridded datasets of built-up
    surfaces and population distribution. The resulting GeoTIFF rasters represent
    the spatial distribution of human settlements and population density across Venezuela.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ven-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/eb38978a-9e62-4c86-bf1f-1c1a66afa5d5/resource/27e23952-8ce3-4eb4-a430-1d9f20cbaa1e/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_ven.tif
  format: null
  id: resource_27e23952
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Venezuela (Bolivarian Republic of): Copernicus Global Human Settlement
    Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system:
    Mollweide)'
  download_url: https://data.humdata.org/dataset/eb38978a-9e62-4c86-bf1f-1c1a66afa5d5/resource/cf1bb0b2-01b1-40ca-aea7-5d045bc028cc/download/ghs_pop_e2025_r2023a_54009_100_v1_0_ven.tif
  format: null
  id: resource_cf1bb0b2
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-ven_copernicus_bolivarianrepublicglobalh_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Venezuela (Bolivarian Republic of): Copernicus Global Human Settlement Layer
  (GHSL)'
version: null
vulnerability: null
---
