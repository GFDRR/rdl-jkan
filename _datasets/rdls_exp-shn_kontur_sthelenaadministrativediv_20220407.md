...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-st-helena
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-st-helena
dataset_id: rdls_exp-shn_kontur_sthelenaadministrativediv_20220407
description: 'St. Helena administrative division with aggregated population. Built
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-st-helena]'
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    ...
    from the Kontur Population dataset (400m H3 hexagons). The resulting dataset provides
    baseline population exposure at the administrative division level for St. Helena,
    with HASC codes added from Wikidata.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-st-helena
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Saint Helena - St. Helena: Administrative Division with Aggregated
    Population (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_SH_20220407.gpkg.gz
  format: null
  id: resource_197925cb
  ...
  title: kontur_boundaries_SH_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_SH_20230628.gpkg.gz
  format: null
  id: resource_aade4b36
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_SH_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Saint Helena - St. Helena: Administrative Division with Aggregated
    Population (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_SH_20230628.gpkg.gz
  format: null
  id: resource_19966ca0
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_SH_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-shn_kontur_sthelenaadministrativediv_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Saint Helena - St. Helena: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
