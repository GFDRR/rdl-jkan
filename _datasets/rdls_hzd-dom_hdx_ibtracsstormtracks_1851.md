...
- entity:
    ...
    url: https://data.humdata.org/dataset/dom-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/dom-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-dom_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/dom-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Dominican Republic subset contains observed storm track positions with ISO-formatted
    timestamps, basin/sub-basin classifications, wind speed, and pressure measurements
    extracted from the global IBTrACS v4r01 archive.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dom-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/3e5fab8f-6541-45b9-a89d-b1fd7f445d02/resource/3e753a2a-ae35-47fe-bd48-bee4d94ff31b/download/ibtracs_all_list_v04r01_dom.csv
  format: null
  id: resource_3e753a2a
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_DOM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Dominican Republic.
  download_url: https://data.humdata.org/dataset/3e5fab8f-6541-45b9-a89d-b1fd7f445d02/resource/94f6c626-1561-4771-993d-dfd52314d478/download/ibtracs_all_list_v04r01_lines_dom.geojson
  format: null
  id: resource_94f6c626
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_DOM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-dom_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Dominican Republic: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
