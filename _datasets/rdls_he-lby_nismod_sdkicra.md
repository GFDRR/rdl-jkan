...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-lby_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Libya. Derived from global datasets clipped
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540030
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540030
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Libya, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540030/files/LBY.zip
  format: null
  id: resource_sdkicra_lby
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Libya
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-lby_nismod_sdkicra
spatial:
  bbox:
  - 9.29
  - 19.5
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2215636/libya.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Libya
version: 0.1.0
vulnerability: null
---
