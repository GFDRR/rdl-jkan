...
- entity:
    ...
    url: https://data.humdata.org/dataset/arg-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/arg-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-arg_hdx_ibtracsstormtracks_2004
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/arg-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Argentina subset
    ...
    at regular intervals, providing empirical hazard characterization for tropical
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/arg-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 2004 to date that pass within 2000 kilometers
    of Argentina.
  download_url: https://data.humdata.org/dataset/1b717fad-c21f-4624-8f87-4b5a64317b46/resource/4b704f25-15c4-4a96-9c26-19b7a6f9c67d/download/ibtracs_all_list_v04r01_arg.csv
  format: null
  id: resource_4b704f25
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ARG.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 2004 to date that pass within 2000 kilometers
    of Argentina.
  download_url: https://data.humdata.org/dataset/1b717fad-c21f-4624-8f87-4b5a64317b46/resource/3809e68b-8e59-4507-9da8-8a630518108f/download/ibtracs_all_list_v04r01_lines_arg.geojson
  format: null
  id: resource_3809e68b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ARG.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-arg_hdx_ibtracsstormtracks_2004
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2004-03-25'
temporal_resolution: null
title: 'Argentina: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
