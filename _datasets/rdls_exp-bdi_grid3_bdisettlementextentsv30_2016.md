...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-bdi-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-bdi-settlement-extents-v3-0
dataset_id: rdls_exp-bdi_grid3_bdisettlementextentsv30_2016
description: 'The GRID3 BDI - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Burundi, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Burundi Settlement Extents,
  ...
  2024. GRID3 BDI - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-bdi-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents and building counts were derived from open data
    ...
    at 3-arc second (~100 meter) resolution. Settlement polygons and grid-based centroids
    with probability estimates were generated to represent the spatial distribution
    of human settlements and structures across Burundi.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-bdi-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Burundi - GRID3 BDI - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/31cd6afa-c78c-4b3b-bf06-fb2f46f70bf2/resource/9f88e8f0-e5b0-45b1-8326-de05ff4e05f9/download/grid3_bdi_settlement_extents_v3_0.zip
  format: null
  id: resource_9f88e8f0
  ...
  title: GRID3_BDI_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/31cd6afa-c78c-4b3b-bf06-fb2f46f70bf2/resource/1964c6f3-f31d-47f4-8925-fdcd1f6af774/download/grid3_bdi_settlement_grid_v3_0.zip
  format: null
  id: resource_1964c6f3
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_BDI_settlement_grid_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Burundi - GRID3 BDI - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks.)
  download_url: https://data.humdata.org/dataset/31cd6afa-c78c-4b3b-bf06-fb2f46f70bf2/resource/b7acca76-1969-493c-82dd-439de5dc8540/download/grid3-bdi-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_b7acca76
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3 BDI - Settlement Extents v3.0 - Data Release Notes .pdf
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bdi_grid3_bdisettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Burundi - GRID3 BDI - Settlement Extents v3.0
version: null
vulnerability: null
---
