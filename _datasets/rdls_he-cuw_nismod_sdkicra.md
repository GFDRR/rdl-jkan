...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-cuw_nismod_sdkicra
description: "Starter data kit collecting extracts from global, open datasets relating\
  ...
  \ area, roads, railways, power infrastructure) for Cura\xE7ao. Derived from global\
  \ datasets clipped to national boundaries to support climate risk analysis and infrastructure\
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540233
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540233
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: "Single ZIP archive containing all hazard and exposure datasets for\
    \ Cura\xE7ao, clipped from global sources. Contents: (1) Hazard - Coastal flood\
    ...
    \ wind speed return period maps (136 GeoTIFF + 1 CSV metadata, STORM, ~10km, 4\
    \ climate models, return periods 10-10000yr). (2) Exposure - Population grid (2\
    ...
    \ mapping); Power distribution lines (GeoPackage, Gridfinder). (3) Supporting\
    \ files - National boundary (GeoJSON), analysis grid (GeoPackage), targets raster\
    \ (GeoTIFF), datapackage descriptor (JSON), flood/heat/cyclone metadata (CSV).\
    \ Data formats include GeoTIFF, GeoPackage, GeoJSON, CSV, JSON, and OSM PBF."
  download_url: https://zenodo.org/records/16540233/files/CUW.zip
  format: null
  id: resource_sdkicra_cuw
  ...
  title: "Starter Data Kit for Infrastructure Climate Resilience Assessment - Cura\xE7\
    ao"
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-cuw_nismod_sdkicra
spatial:
  bbox:
  - -69.17
  - 12.04
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/7626836/curacao.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: "Infrastructure Climate Resilience Assessment Data Starter Kit for Cura\xE7\
  ao"
version: 0.1.0
vulnerability: null
---
