...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-myanmar
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-myanmar
dataset_id: rdls_exp-mmr_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-myanmar]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure database for Myanmar was developed using
    ...
    geographic population distribution and GDP as spatial proxies. The methodology
    was developed by UNEP-GRID in collaboration with WAPMERR, EU JRC, and Kokusai
    Kogyo to create a comprehensive spatial inventory of economic and structural assets
    at risk.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-myanmar
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Myanmar.zip
  download_url: https://data.humdata.org/dataset/2e90b891-1b2e-4b5a-b310-7f82f1c1b433/resource/36dd743c-cfd5-4113-8c4b-4502eb3ef691/download/mmr.zip
  format: null
  id: resource_36dd743c
  ...
  title: GAR15 Global Exposure Dataset for Myanmar.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mmr_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Myanmar
version: null
vulnerability: null
---
