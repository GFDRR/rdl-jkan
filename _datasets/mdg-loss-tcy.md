---
schema: rdl
title: SWIO-RAFI Madagascar Tropical Cyclones (Flood, Wind) Losses
category:
  - Loss
...
geo_coverage: MDG
resources:
  - name: Madagascar AAL and RPs losses from Tropical Cyclones
    url: 'https://rdl-jkan-datasets.s3-ap-southeast-2.amazonaws.com/loss/mdg-loss-tcy.zip'
    format: shp
...
[//]: # RDL-Loss fields
[//]: ## LossModel
model_name: "Flood losses from Tropical Cyclones"
model_description: "Average Annual Losses and RP losses at ADM2 level for all hazards combined"
model_hazard_type: "FL,CF,WI"
model_process_type: "TCY"
model_hazard_link: ""
model_exposure_link: ""
