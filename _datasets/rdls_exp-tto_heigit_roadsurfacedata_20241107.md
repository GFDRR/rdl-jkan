...
- entity:
    ...
    url: https://data.humdata.org/dataset/trinidad-and-tobago-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/trinidad-and-tobago-road-surface-data
dataset_id: rdls_exp-tto_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/trinidad-and-tobago-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    roads, with results integrated into a geospatial dataset providing both observed
    and predicted surface classifications with associated confidence metrics.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/trinidad-and-tobago-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Trinidad and Tobago: Road Surface Data (GeoJSON data for Trinidad
    and tobago.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tto_roadsurface_lines.geojson
  format: null
  id: resource_7e0a079c
  ...
  title: Trinidad and tobago GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Trinidad and Tobago: Road Surface Data (Geopackage data for Trinidad
    and tobago.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tto_roadsurface_lines.gpkg
  format: null
  id: resource_45dcc43d
  ...
  temporal: null
  temporal_resolution: null
  title: Trinidad and tobago GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tto_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Trinidad and Tobago: Road Surface Data'
version: null
vulnerability: null
---
