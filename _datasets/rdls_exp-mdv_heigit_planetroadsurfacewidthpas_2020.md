...
- entity:
    ...
    url: https://data.humdata.org/dataset/maldives-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/maldives-planet-road-surface-data
dataset_id: rdls_exp-mdv_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0 million km (73.6709%) - Unpaved roads: 0.0 million km (1.5487%) - Missing\
  \ OSM surface tags: 0.0 million km (42.5604%) - PlanetScope predictions cover: 0.0\
  \ million km (176.736%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/maldives-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Maldives. Deep learning models were applied to PlanetScope satellite imagery
    ...
    based on passability risk scores. The resulting dataset supports humanitarian
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/maldives-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Maldives: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Maldives)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MV_planet_roadsurface_lines.gpkg
  format: null
  id: resource_ef7b551d
  ...
  title: Maldives GPKG heigit_MV_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Maldives: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Maldives)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MV_planet_roadsurface_lines.geojson
  format: null
  id: resource_9dc19818
  ...
  temporal: null
  temporal_resolution: null
  title: Maldives GeoJSON heigit_MV_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mdv_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Maldives: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
