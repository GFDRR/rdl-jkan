...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-turks-and-caicos-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-turks-and-caicos-islands
dataset_id: rdls_exp-tca_kontur_turkscaicosislandspopulat_2023
description: 'Turks and Caicos Islands population density for 400m H3 hexagons. Built
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-turks-and-caicos-islands]'
...
lineage:
  description: Population density data was derived by fusing multiple global datasets
    (GHSL, Facebook HRSL, Microsoft Buildings, Copernicus Land Cover, LINZ, and OpenStreetMap)
    and aggregating population counts into H3 hexagonal grid cells at 400m resolution
    for Turks and Caicos Islands. The methodology overlays settlement layers and building
    footprints to distribute baseline population estimates spatially.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-turks-and-caicos-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Turks and Caicos Islands: Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TC_20220630.gpkg.gz
  format: null
  id: resource_39b41f0c
  ...
  title: kontur_population_TC_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Turks and Caicos Islands: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TC_20231101.gpkg.gz
  format: null
  id: resource_621c4cfc
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_TC_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tca_kontur_turkscaicosislandspopulat_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Turks and Caicos Islands: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
