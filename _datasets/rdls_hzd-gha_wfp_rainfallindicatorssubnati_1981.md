...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/gha-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/gha-rainfall-subnational
dataset_id: rdls_hzd-gha_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/gha-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery integrated
    with in-situ station observations and aggregated by subnational administrative
    units in Ghana. Dekadal rainfall indicators including 10-day totals, 1-month and
    3-month rolling aggregations, and long-term averages were computed to support
    drought monitoring and early warning. CHIRPS-GEFS forecasts provide short-term
    predictive rainfall indicators.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gha-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135747289459_2f043195'
  download_url: https://data.humdata.org/dataset/187fc57e-07af-43d9-b412-6aaba91a3209/resource/23e0d7d8-2f33-4844-aaff-d056d26b385a/download/gha-rainfall-subnat-full.csv
  format: null
  id: resource_23e0d7d8
  media_type: text/csv
  spatial: null
  ...
  title: gha-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135747289459_2f043195'
  download_url: https://data.humdata.org/dataset/187fc57e-07af-43d9-b412-6aaba91a3209/resource/04e7a0d3-f8a3-4226-8644-f55b9a5bc67e/download/gha-rainfall-subnat-5ytd.csv
  format: null
  id: resource_04e7a0d3
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: gha-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gha_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Ghana: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
