...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-state-of-palestine
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-state-of-palestine
dataset_id: rdls_exp-pse_kontur_stateadministrativedivisi_20230710
description: 'State of Palestine administrative division with aggregated population.
  ...
  Global administrative division with aggregated population The borders of the State
  of Palestine are disputed.. [Source: This metadata record was automatically extracted
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-state-of-palestine]'
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    proprietary processing methods, then enriched by aggregating population counts
    from the Kontur Population global density dataset (400m H3 hexagons). The resulting
    dataset provides baseline population estimates at administrative division levels
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-state-of-palestine
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'State of Palestine: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_PS_20230628.gpkg.gz
  format: null
  id: resource_f3ea7ea8
  ...
  title: kontur_boundaries_PS_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'State of Palestine: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_PS_20230628.gpkg.gz
  format: null
  id: resource_b66921c0
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_PS_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pse_kontur_stateadministrativedivisi_20230710
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'State of Palestine: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
