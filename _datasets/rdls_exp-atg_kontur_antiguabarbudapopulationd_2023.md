...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-antigua-and-barbuda
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-antigua-and-barbuda
dataset_id: rdls_exp-atg_kontur_antiguabarbudapopulationd_2023
description: 'Antigua and Barbuda population density for 400m H3 hexagons. Built from
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-antigua-and-barbuda]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    inventory across Antigua and Barbuda.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-antigua-and-barbuda
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Antigua and Barbuda: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AG_20220630.gpkg.gz
  format: null
  id: resource_db0541e6
  ...
  title: kontur_population_AG_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Antigua and Barbuda: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AG_20231101.gpkg.gz
  format: null
  id: resource_31040b4b
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_AG_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-atg_kontur_antiguabarbudapopulationd_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Antigua and Barbuda: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
