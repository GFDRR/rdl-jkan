...
- entity:
    ...
    url: https://data.humdata.org/dataset/british-virgin-islands-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/british-virgin-islands-planet-road-surface-data
dataset_id: rdls_exp-vgb_heigit_britishvirginislandsplane_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (87.1986%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (0.0485%) - PlanetScope predictions cover: 0.0001\
  \ million km (179932.2646%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/british-virgin-islands-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries from OpenStreetMap were extracted for arterial
    highways in British Virgin Islands. Deep learning models trained on PlanetScope
    satellite imagery (2020 and 2024) classified road surface type (paved/unpaved),
    measured road width, and detected surface changes. A Humanitarian Passability
    Index was derived from these classifications to support logistics and transportation
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/british-virgin-islands-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'British Virgin Islands: Planet Road Surface, Width, and Passability
    Data (Geopackage file for British virgin islands)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_VG_planet_roadsurface_lines.gpkg
  format: null
  id: resource_8beac7c7
  ...
  title: British virgin islands GPKG heigit_VG_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'British Virgin Islands: Planet Road Surface, Width, and Passability
    Data (GeoJSON file for British virgin islands)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_VG_planet_roadsurface_lines.geojson
  format: null
  id: resource_6ff7b9d9
  ...
  temporal: null
  temporal_resolution: null
  title: British virgin islands GeoJSON heigit_VG_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vgb_heigit_britishvirginislandsplane_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'British Virgin Islands: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
