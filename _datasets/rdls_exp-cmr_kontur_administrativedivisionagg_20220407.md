...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-cameroon
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-cameroon
dataset_id: rdls_exp-cmr_kontur_administrativedivisionagg_20220407
description: 'Cameroon administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-cameroon]'
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries for Cameroon were extracted from OpenStreetMap
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-cameroon
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Cameroon: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_CM_20220407.gpkg.gz
  format: null
  id: resource_5ba44af7
  ...
  title: kontur_boundaries_CM_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Cameroon: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_CM_20230628.gpkg.gz
  format: null
  id: resource_ed5ff290
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_CM_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Cameroon: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_CM_20230628.gpkg.gz
  format: null
  id: resource_1635ab5a
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_CM_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cmr_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Cameroon: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
