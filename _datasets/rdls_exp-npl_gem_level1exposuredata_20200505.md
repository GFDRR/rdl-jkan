...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/nepal-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/nepal-level-1-exposure-data
dataset_id: rdls_exp-npl_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nepal-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nepal-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Nepal produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/720e7b82-bc5e-4b2c-8bb5-d8c51657c63f/resource/946f2c7a-b354-4a72-84f9-d2a66f92a187/download/npl_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_946f2c7a
  ...
  title: NPL_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-npl_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Nepal: Level 1 Exposure Data'
version: null
vulnerability: null
---
