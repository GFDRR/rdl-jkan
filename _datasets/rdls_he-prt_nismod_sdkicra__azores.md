...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-prt_nismod_sdkicra__azores
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Azores. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540024
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540024
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Azores, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540024/files/PRT.zip
  format: null
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Azores
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-prt_nismod_sdkicra__azores
spatial:
  bbox:
  - -31.28
  - 30.03
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Azores
version: 0.1.0
vulnerability: null
---
