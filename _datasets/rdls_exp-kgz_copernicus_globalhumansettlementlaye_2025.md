...
- entity:
    ...
    url: https://data.humdata.org/dataset/kgz-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/kgz-ghsl
dataset_id: rdls_exp-kgz_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/kgz-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: The GHSL dataset for Kyrgyzstan integrates fine-scale satellite image
    data streams with census data and crowdsourced geographic information through
    automated spatial data processing technologies to produce gridded estimates of
    built-up surface area and population distribution at national scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kgz-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/d615fed2-8a03-46d7-9a70-23545c22c935/resource/117ff959-966e-4de7-90cd-6d8c5850074e/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_kgz.tif
  format: null
  id: resource_117ff959
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Kyrgyzstan: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/d615fed2-8a03-46d7-9a70-23545c22c935/resource/7812c151-f331-4d7d-8338-c2560146e2e2/download/ghs_pop_e2025_r2023a_54009_100_v1_0_kgz.tif
  format: null
  id: resource_7812c151
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-kgz_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Kyrgyzstan: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
