...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-kyrgyzstan
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-kyrgyzstan
dataset_id: rdls_exp-kgz_kontur_administrativedivisionagg_20220407
description: 'Kyrgyzstan administrative division with aggregated population. Built
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-kyrgyzstan]'
...
lineage:
  description: Administrative boundaries for Kyrgyzstan were extracted from OpenStreetMap
...
- access_url: null
  ...
  description: 'Kyrgyzstan: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_KG_20220407.gpkg.gz
  format: null
  id: resource_456360aa
  ...
  title: kontur_boundaries_KG_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Kyrgyzstan: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_KG_20230628.gpkg.gz
  format: null
  id: resource_f50ca457
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_KG_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Kyrgyzstan: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_KG_20230628.gpkg.gz
  format: null
  id: resource_2a8c92ff
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_KG_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kgz_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Kyrgyzstan: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
