...
- entity:
    ...
    url: https://data.humdata.org/dataset/tgo-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/tgo-ghsl
dataset_id: rdls_exp-tgo_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/tgo-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: 'The GHSL dataset integrates fine-scale satellite imagery, census data,
    and crowdsourced geographic information through automated spatial data processing
    technologies to produce gridded estimates of built-up surfaces and population
    distribution. Two GeoTIFF rasters are provided: GHS Built-up Surface (structure
    extent) and GHS Population Grid (population density/count), both representing
    the human presence and settlement patterns in Togo.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tgo-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/a5ef0798-3338-46c8-93b6-9bca26825952/resource/94ed926b-cecc-4f5f-88af-6ad34c199431/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_tgo.tif
  format: null
  id: resource_94ed926b
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Togo: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/a5ef0798-3338-46c8-93b6-9bca26825952/resource/7419c9ad-d5ad-4269-9f21-5501c0c97033/download/ghs_pop_e2025_r2023a_54009_100_v1_0_tgo.tif
  format: null
  id: resource_7419c9ad
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-tgo_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Togo: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
