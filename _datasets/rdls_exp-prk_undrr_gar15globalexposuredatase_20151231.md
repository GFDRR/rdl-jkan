...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-korea-democratic-peoples-republic-of
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-korea-democratic-peoples-republic-of
dataset_id: rdls_exp-prk_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-korea-democratic-peoples-republic-of]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    distribution and GDP as spatial proxies. The dataset was developed through multi-agency
    collaboration (UNEP-GRID, WAPMERR, JRC, Kokusai Kogyo) for the Global Assessment
    Report on Disaster Risk Reduction 2015 (GAR15).
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-korea-democratic-peoples-republic-of
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Korea (Democratic People's Republic
    of).zip
  download_url: https://data.humdata.org/dataset/e980fe01-dd7a-4e98-9dc2-a7feec135093/resource/6a4fd3a1-3720-4542-b77d-c08063dc3939/download/prk.zip
  format: null
  id: resource_6a4fd3a1
  ...
  title: GAR15 Global Exposure Dataset for Korea (Democratic People's Republic of).zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-prk_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Korea (Democratic People's Republic of)
version: null
vulnerability: null
---
