...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-mkd_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for North Macedonia. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539716
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539716
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    North Macedonia, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16539716/files/MKD.zip
  format: null
  id: resource_sdkicra_mkd
...
- exposure
schema: rdls-10
slug: rdls_he-mkd_nismod_sdkicra
spatial:
  bbox:
  - 20.44
  - 40.85
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/718075/north-macedonia.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for North Macedonia
version: 0.1.0
vulnerability: null
---
