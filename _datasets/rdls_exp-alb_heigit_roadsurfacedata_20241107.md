...
- entity:
    ...
    url: https://data.humdata.org/dataset/albania-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/albania-road-surface-data
dataset_id: rdls_exp-alb_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/albania-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for Albania. A hybrid deep learning model was applied to classify road surfaces
    as paved or unpaved, generating predictions for roads with incomplete surface
    information in OSM. The final dataset combines OSM-tagged surface data with AI-predicted
    classifications, providing comprehensive road surface coverage across the country.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/albania-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Albania: Road Surface Data (GeoJSON data for Albania.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_alb_roadsurface_lines.geojson
  format: null
  id: resource_fdafa7c0
  ...
  title: Albania GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Albania: Road Surface Data (Geopackage data for Albania.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_alb_roadsurface_lines.gpkg
  format: null
  id: resource_61b63c48
  ...
  temporal: null
  temporal_resolution: null
  title: Albania GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-alb_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Albania: Road Surface Data'
version: null
vulnerability: null
---
