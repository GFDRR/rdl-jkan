...
- entity:
    ...
    url: https://data.humdata.org/dataset/nicaragua-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/nicaragua-road-surface-data
dataset_id: rdls_exp-nic_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.066 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0095 and 0.0425
  (in million kms), corressponding to 14.3662% and 64.3445% respectively of the total
  road length in the dataset region. 0.014 million km or 21.2893% of road surface
  ...
  to 2.6528% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nicaragua-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    learning algorithm to predict and classify road surface types (paved/unpaved)
    across Nicaragua. The model outputs were integrated with OSM attributes to create
    a comprehensive road infrastructure dataset with both observed and predicted surface
    classifications, enabling humanitarian access and logistics planning analysis.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nicaragua-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Nicaragua: Road Surface Data (GeoJSON data for Nicaragua.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_nic_roadsurface_lines.geojson
  format: null
  id: resource_ec981598
  ...
  title: Nicaragua GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Nicaragua: Road Surface Data (Geopackage data for Nicaragua.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_nic_roadsurface_lines.gpkg
  format: null
  id: resource_ba51e92a
  ...
  temporal: null
  temporal_resolution: null
  title: Nicaragua GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nic_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Nicaragua: Road Surface Data'
version: null
vulnerability: null
---
