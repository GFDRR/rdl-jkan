...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/hun-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/hun-rainfall-subnational
dataset_id: rdls_hzd-hun_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/hun-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    subnational administrative units. Rolling aggregations (1-month and 3-month) and
    long-term climatological averages were computed to generate drought indicators
    for monitoring and early warning purposes.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hun-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135545176799_c12da14f'
  download_url: https://data.humdata.org/dataset/4aa34165-c135-483b-93a8-18ce1375e759/resource/3cb7ea0a-9a68-49e6-91e4-77d40f6c1b5d/download/hun-rainfall-subnat-full.csv
  format: null
  id: resource_3cb7ea0a
  media_type: text/csv
  spatial: null
  ...
  title: hun-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135545176799_c12da14f'
  download_url: https://data.humdata.org/dataset/4aa34165-c135-483b-93a8-18ce1375e759/resource/f17b0fe3-7b23-46d0-96c6-cef986e9bb0f/download/hun-rainfall-subnat-5ytd.csv
  format: null
  id: resource_f17b0fe3
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: hun-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-hun_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Hungary: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
