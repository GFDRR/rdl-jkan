...
- entity:
    ...
    url: https://data.humdata.org/dataset/mkd-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mkd-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mkd_hdx_ibtracsstormtracks_1887
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mkd-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS aggregates tropical cyclone observations from multiple international
    agencies and applies a standardized algorithm to assign unique storm identifiers
    and merge conflicting track data. The dataset provides observed storm positions,
    wind speeds (wmo_wind), central pressure (wmo_pres), and storm classification
    (nature) for all tropical cyclones affecting North Macedonia, extracted from the
    global IBTrACS archive.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mkd-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of North Macedonia.
  download_url: https://data.humdata.org/dataset/47cf9da4-a845-4e0a-83fe-391468b22536/resource/f3908368-2d06-4bca-8914-fa4703b8aa8b/download/ibtracs_all_list_v04r01_mkd.csv
  format: null
  id: resource_f3908368
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MKD.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of North Macedonia.
  download_url: https://data.humdata.org/dataset/47cf9da4-a845-4e0a-83fe-391468b22536/resource/b1aa72a9-c8b9-4a50-aeee-b48e38636601/download/ibtracs_all_list_v04r01_lines_mkd.geojson
  format: null
  id: resource_b1aa72a9
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MKD.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mkd_hdx_ibtracsstormtracks_1887
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1887-10-29'
temporal_resolution: null
title: 'North Macedonia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
