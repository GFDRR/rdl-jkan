...
- entity:
    ...
    url: https://data.humdata.org/dataset/brn-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/brn-ghsl
dataset_id: rdls_exp-brn_copernicus_darussalamglobalhumansett_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/brn-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: The GHSL dataset for Brunei Darussalam was generated through automated
    spatial data processing of fine-scale satellite imagery, census data, and crowdsourced
    geographic information to produce gridded estimates of built-up surfaces and population
    distribution. The methodology integrates multi-source geospatial data streams
    to create consistent, evidence-based spatial information on human settlements
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/brn-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/ad7f94ac-4660-42cf-aa6e-136f43944c5e/resource/0c2852c1-89f9-4725-a56a-461d365a57b1/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_brn.tif
  format: null
  id: resource_0c2852c1
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Brunei Darussalam: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/ad7f94ac-4660-42cf-aa6e-136f43944c5e/resource/404deb12-6753-47af-a581-f1a43633cfd1/download/ghs_pop_e2025_r2023a_54009_100_v1_0_brn.tif
  format: null
  id: resource_404deb12
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-brn_copernicus_darussalamglobalhumansett_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Brunei Darussalam: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
