...
- entity:
    ...
    url: https://data.humdata.org/dataset/png-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/png-ghsl
dataset_id: rdls_exp-png_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/png-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: 'The GHSL dataset for Papua New Guinea was generated through automated
    spatial data processing of fine-scale satellite imagery integrated with census
    data and crowdsourced geographic information. Two primary outputs are provided:
    built-up surface area classification and gridded population estimates, both representing
    the spatial distribution of human settlements and infrastructure.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/png-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/246fd2be-9fdb-4e76-a0ca-013356588fe3/resource/926e5f83-ab40-48da-807a-97a6faff5234/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_png.tif
  format: null
  id: resource_926e5f83
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Papua New Guinea: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/246fd2be-9fdb-4e76-a0ca-013356588fe3/resource/e6ddcef8-73de-4b3b-aff5-fd1aeb2d2667/download/ghs_pop_e2025_r2023a_54009_100_v1_0_png.tif
  format: null
  id: resource_e6ddcef8
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-png_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Papua New Guinea: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
