...
- entity:
    ...
    url: https://data.humdata.org/dataset/irn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/irn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-irn_hdx_islamicrepublicibtracssto_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/irn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Iran
    subset contains storm track points with ISO timestamps, basin/subbasin classifications,
    nature designations, WMO wind speeds (10-minute sustained), and central pressure
    measurements. Data is provided as both tabular CSV and geospatial GeoJSON formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/irn-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Iran (Islamic Republic of).
  download_url: https://data.humdata.org/dataset/5196809e-ad5b-442e-ab58-66eed9618a1f/resource/f0398051-3777-40ed-a2e8-908f12c2557d/download/ibtracs_all_list_v04r01_irn.csv
  format: null
  id: resource_f0398051
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_IRN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Iran (Islamic Republic of).
  download_url: https://data.humdata.org/dataset/5196809e-ad5b-442e-ab58-66eed9618a1f/resource/9ad87c90-a2e9-4b03-a53d-061230c3488e/download/ibtracs_all_list_v04r01_lines_irn.geojson
  format: null
  id: resource_9ad87c90
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_IRN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-irn_hdx_islamicrepublicibtracssto_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Iran (Islamic Republic of): IBTrACS Storm Tracks'
version: null
vulnerability: null
---
