...
- entity:
    ...
    url: https://data.humdata.org/dataset/saint-vincent-and-the-grenadines-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/saint-vincent-and-the-grenadines-planet-road-surface-data
dataset_id: rdls_exp-vct_heigit_saintvincentgrenadinespla_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (68.0019%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (5.3909%) - PlanetScope predictions cover: 0.0001\
  \ million km (1261.423%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/saint-vincent-and-the-grenadines-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/saint-vincent-and-the-grenadines-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Saint Vincent and the Grenadines: Planet Road Surface, Width, and
    Passability Data (Geopackage file for Saint vincent and the grenadines)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_VC_planet_roadsurface_lines.gpkg
  format: null
  id: resource_ca249bb0
  ...
  title: Saint vincent and the grenadines GPKG heigit_VC_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Saint Vincent and the Grenadines: Planet Road Surface, Width, and
    Passability Data (GeoJSON file for Saint vincent and the grenadines)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_VC_planet_roadsurface_lines.geojson
  format: null
  id: resource_4189e92a
  ...
  temporal: null
  temporal_resolution: null
  title: Saint vincent and the grenadines GeoJSON heigit_VC_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vct_heigit_saintvincentgrenadinespla_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Saint Vincent and the Grenadines: Planet Road Surface, Width, and Passability
  Data'
version: null
vulnerability: null
---
