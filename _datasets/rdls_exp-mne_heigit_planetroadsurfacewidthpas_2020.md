...
- entity:
    ...
    url: https://data.humdata.org/dataset/montenegro-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/montenegro-planet-road-surface-data
dataset_id: rdls_exp-mne_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ surface conditions in many regions. Summary of Road Statistics Approximately 0.0022\
  \ million km of arterial roads are mapped in OSM in this region. - Paved roads:\
  \ 0.0021 million km (96.0112%) - Unpaved roads: 0.0 million km (0.7797%) - Missing\
  \ OSM surface tags: 0.0 million km (0.5861%) - PlanetScope predictions cover: 0.0022\
  \ million km (16514.8993%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/montenegro-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Montenegro. Deep learning models trained on PlanetScope satellite imagery (2020
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/montenegro-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Montenegro: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Montenegro)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_ME_planet_roadsurface_lines.geojson
  format: null
  id: resource_6d5abd17
  ...
  title: Montenegro GeoJSON heigit_ME_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Montenegro: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Montenegro)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_ME_planet_roadsurface_lines.gpkg
  format: null
  id: resource_71671249
  ...
  temporal: null
  temporal_resolution: null
  title: Montenegro GPKG heigit_ME_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mne_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Montenegro: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
