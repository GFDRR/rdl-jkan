...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/npl-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/npl-rainfall-subnational
dataset_id: rdls_hzd-npl_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/npl-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from Climate Hazards Group InfraRed Precipitation
    (CHIRPS) satellite imagery merged with in-situ rain gauge observations, processed
    into dekadal indicators (10-day, 1-month, 3-month rolling aggregations) and compared
    against long-term averages, aggregated by subnational administrative units in
    Nepal for meteorological drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/npl-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135645337338_665eeedc'
  download_url: https://data.humdata.org/dataset/ef3ae2e6-1302-4fac-b183-92ff5e78e10d/resource/7fdfce1e-b6df-403b-be59-9065b3cac549/download/npl-rainfall-subnat-full.csv
  format: null
  id: resource_7fdfce1e
  media_type: text/csv
  spatial: null
  ...
  title: npl-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135645337338_665eeedc'
  download_url: https://data.humdata.org/dataset/ef3ae2e6-1302-4fac-b183-92ff5e78e10d/resource/a9d3caaa-cbd9-4a94-8d76-5b3c6d2574b3/download/npl-rainfall-subnat-5ytd.csv
  format: null
  id: resource_a9d3caaa
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: npl-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-npl_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Nepal: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
