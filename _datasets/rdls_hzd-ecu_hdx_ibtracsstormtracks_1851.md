...
- entity:
    ...
    url: https://data.humdata.org/dataset/ecu-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ecu-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ecu_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ecu-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone data from multiple
    national meteorological agencies into a unified best-track dataset. The Ecuador
    subset contains observed storm track positions (latitude, longitude, ISO timestamp),
    basin/sub-basin classification, wind speed (WMO standard), and central pressure
    measurements for all tropical cyclones affecting the country.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ecu-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Ecuador.
  download_url: https://data.humdata.org/dataset/b8567a2e-d9fa-4ff5-af8c-362749528468/resource/c846da95-ecf5-481a-b719-8c2f04acd19f/download/ibtracs_all_list_v04r01_ecu.csv
  format: null
  id: resource_c846da95
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ECU.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Ecuador.
  download_url: https://data.humdata.org/dataset/b8567a2e-d9fa-4ff5-af8c-362749528468/resource/c25edb2e-a16c-42cc-8a08-2690facf0b29/download/ibtracs_all_list_v04r01_lines_ecu.geojson
  format: null
  id: resource_c25edb2e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ECU.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ecu_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-11-04'
temporal_resolution: null
title: 'Ecuador: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
