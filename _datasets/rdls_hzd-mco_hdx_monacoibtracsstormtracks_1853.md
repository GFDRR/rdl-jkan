...
- entity:
    ...
    url: https://data.humdata.org/dataset/mco-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mco-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mco_hdx_monacoibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mco-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    at regular time intervals and filtered for Monaco's geographic region. The dataset
    provides observed hazard characteristics for tropical cyclones affecting or passing
    near Monaco.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mco-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Monaco.
  download_url: https://data.humdata.org/dataset/262e2170-adb8-45da-9325-80836a72255c/resource/93e91119-1eeb-4c1c-b19f-2569ce3d084d/download/ibtracs_all_list_v04r01_mco.csv
  format: null
  id: resource_93e91119
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MCO.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Monaco.
  download_url: https://data.humdata.org/dataset/262e2170-adb8-45da-9325-80836a72255c/resource/b4d64ccc-a606-41c0-bc1e-f3cd8dd2fbe2/download/ibtracs_all_list_v04r01_lines_mco.geojson
  format: null
  id: resource_b4d64ccc
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MCO.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mco_hdx_monacoibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Monaco: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
