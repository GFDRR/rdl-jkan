...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/png-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/png-rainfall-subnational
dataset_id: rdls_hzd-png_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/png-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with in-situ rain gauge measurements, then aggregated by subnational administrative
    units. Dekadal rainfall totals, 1-month and 3-month rolling aggregations, and
    long-term climatological averages were computed to enable drought monitoring and
    early warning through comparison of observed rainfall against historical norms.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/png-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135715567458_72c40149'
  download_url: https://data.humdata.org/dataset/2f9f1437-2d1f-4c41-ad1c-f47c8c9d4624/resource/ba393e1b-8790-40ea-b4bf-1047fc142063/download/png-rainfall-subnat-full.csv
  format: null
  id: resource_ba393e1b
  media_type: text/csv
  spatial: null
  ...
  title: png-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135715567458_72c40149'
  download_url: https://data.humdata.org/dataset/2f9f1437-2d1f-4c41-ad1c-f47c8c9d4624/resource/f1ce9151-5927-4b6f-afb7-dc9215411fee/download/png-rainfall-subnat-5ytd.csv
  format: null
  id: resource_f1ce9151
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: png-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-png_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Papua New Guinea: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
