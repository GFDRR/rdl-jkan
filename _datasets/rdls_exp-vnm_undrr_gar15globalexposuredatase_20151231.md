...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-viet-nam
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-viet-nam
dataset_id: rdls_exp-vnm_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-viet-nam]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Vietnam were spatially disaggregated using a top-down approach onto 5x5 km
    and 1x1 km grids, with geographic population distribution and GDP as spatial proxies.
    The dataset was developed collaboratively by UNEP-GRID, WAPMERR, JRC, and Kokusai
    Kogyo as part of the GAR15 global exposure assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-viet-nam
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Viet Nam.zip
  download_url: https://data.humdata.org/dataset/871ab1cc-a0b8-4734-8789-04383847f681/resource/55069c44-2749-4caf-8e81-cb76e9539da0/download/vnm.zip
  format: null
  id: resource_55069c44
  ...
  title: GAR15 Global Exposure Dataset for Viet Nam.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vnm_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Viet Nam
version: null
vulnerability: null
---
