...
- entity:
    ...
    url: https://data.humdata.org/dataset/burkina-faso-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
    email: null
    name: HeiGIT deep learning classification model
    url: https://data.humdata.org/dataset/burkina-faso-road-surface-data
  id: attribution_2
  role: collaborator
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/burkina-faso-road-surface-data
dataset_id: rdls_exp-bfa_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2023 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0064 and 0.0705
  (in million kms), corressponding to 3.1756% and 34.8496% respectively of the total
  road length in the dataset region. 0.1254 million km or 61.9748% of road surface
  ...
  to 0.0419% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/burkina-faso-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The resulting dataset provides spatial inventory of ~0.2023 million km of mapped
    roads with predicted surface type classifications, supporting humanitarian access
    and infrastructure planning assessments.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/burkina-faso-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Burkina Faso: Road Surface Data (GeoJSON data for Burkina faso.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bfa_roadsurface_lines.geojson
  format: null
  id: resource_2ab50301
  ...
  title: Burkina faso GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Burkina Faso: Road Surface Data (Geopackage data for Burkina faso.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bfa_roadsurface_lines.gpkg
  format: null
  id: resource_ac1ad839
  ...
  temporal: null
  temporal_resolution: null
  title: Burkina faso GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bfa_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Burkina Faso: Road Surface Data'
version: null
vulnerability: null
---
