...
- entity:
    ...
    url: https://data.humdata.org/dataset/msr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/msr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-msr_hdx_montserratibtracsstormtra_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/msr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    recorded at regular time intervals in ISO format, providing observed hazard characteristics
    for tropical cyclones affecting Montserrat.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/msr-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Montserrat.
  download_url: https://data.humdata.org/dataset/46f5173b-7dfc-488d-9280-b902abbc79fd/resource/507fbf5e-1d45-4911-8456-e8546d8c3b0d/download/ibtracs_all_list_v04r01_msr.csv
  format: null
  id: resource_507fbf5e
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MSR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Montserrat.
  download_url: https://data.humdata.org/dataset/46f5173b-7dfc-488d-9280-b902abbc79fd/resource/4e3ef63f-7ebe-4399-9041-13fe7e276ab8/download/ibtracs_all_list_v04r01_lines_msr.geojson
  format: null
  id: resource_4e3ef63f
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MSR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-msr_hdx_montserratibtracsstormtra_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Montserrat: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
