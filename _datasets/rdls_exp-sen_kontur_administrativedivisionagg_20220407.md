...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-senegal
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-senegal
dataset_id: rdls_exp-sen_kontur_administrativedivisionagg_20220407
description: 'Senegal administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-senegal]'
...
lineage:
  description: Administrative boundaries for Senegal were extracted from OpenStreetMap
    and enhanced with proprietary methods. Population counts were derived by aggregating
    Kontur's global 400m H3 hexagon population density grid to each administrative
    division. HASC codes for regions were enriched from Wikidata.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-senegal
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Senegal: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_SN_20220407.gpkg.gz
  format: null
  id: resource_c8a86f49
  ...
  title: kontur_boundaries_SN_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Senegal: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_SN_20230628.gpkg.gz
  format: null
  id: resource_3e02e7da
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_SN_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Senegal: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_SN_20230628.gpkg.gz
  format: null
  id: resource_fe9ebe12
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_SN_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sen_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Senegal: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
