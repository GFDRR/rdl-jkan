...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/sle-rainfall-subnational
dataset_id: rdls_hzd-sle_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/sle-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from Climate Hazards Group InfraRed Precipitation
    ...
    10-day, 1-month, and 3-month rolling aggregations with climatological comparisons
    for meteorological drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sle-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135828685364_fd9200bb'
  download_url: https://data.humdata.org/dataset/f6924cfa-5649-476a-8cd2-b77b6298a5ba/resource/cc5d9228-3b85-430e-a929-8953edade690/download/sle-rainfall-subnat-full.csv
  format: null
  id: resource_cc5d9228
  media_type: text/csv
  spatial: null
  ...
  title: sle-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135828685364_fd9200bb'
  download_url: https://data.humdata.org/dataset/f6924cfa-5649-476a-8cd2-b77b6298a5ba/resource/de3572eb-c1b3-411e-b190-211e9337bd5c/download/sle-rainfall-subnat-5ytd.csv
  format: null
  id: resource_de3572eb
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: sle-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-sle_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
