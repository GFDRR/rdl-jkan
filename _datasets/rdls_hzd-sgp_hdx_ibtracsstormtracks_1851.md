...
- entity:
    ...
    url: https://data.humdata.org/dataset/sgp-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/sgp-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-sgp_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sgp-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Singapore subset contains observed storm track positions (latitude, longitude,
    time) with associated wind speed (wmo_wind) and pressure (wmo_pres) measurements.
    Data is provided as both tabular (CSV) and spatial (GeoJSON line) formats for
    analysis of tropical cyclone hazards.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sgp-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Singapore.
  download_url: https://data.humdata.org/dataset/17170725-155a-466a-bb37-f6cd3b1a96cf/resource/4893767e-f333-42eb-984f-eb6ccfad568f/download/ibtracs_all_list_v04r01_sgp.csv
  format: null
  id: resource_4893767e
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SGP.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Singapore.
  download_url: https://data.humdata.org/dataset/17170725-155a-466a-bb37-f6cd3b1a96cf/resource/22522be5-dd65-4ff6-adb4-ddde72a7bbe5/download/ibtracs_all_list_v04r01_lines_sgp.geojson
  format: null
  id: resource_22522be5
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SGP.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-sgp_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-11-01'
temporal_resolution: null
title: 'Singapore: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
