...
- entity:
    ...
    url: https://data.humdata.org/dataset/ecu-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/ecu-ghsl
dataset_id: rdls_exp-ecu_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ecu-ghsl]'
...
lineage:
  description: 'The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    classification) and GHS Population Grid (population density estimation) at consistent
    spatial resolution.'
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ecu-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/8811ba0b-0f0e-4a45-8dc7-c2fd02c7d1d6/resource/4e2fe3a5-1d93-408e-88bc-e7b48bf83751/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_ecu.tif
  format: null
  id: resource_4e2fe3a5
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Ecuador: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/8811ba0b-0f0e-4a45-8dc7-c2fd02c7d1d6/resource/53ebb38b-508b-4bd7-9cee-d2ee449f357d/download/ghs_pop_e2025_r2023a_54009_100_v1_0_ecu.tif
  format: null
  id: resource_53ebb38b
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-ecu_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Ecuador: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
