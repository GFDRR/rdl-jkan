...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-madagascar
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-madagascar
dataset_id: rdls_exp-mdg_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-madagascar]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    in collaboration with WAPMERR, EU JRC, and Kokusai Kogyo for the Global Assessment
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-madagascar
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Madagascar.zip
  download_url: https://data.humdata.org/dataset/21f1c198-dcca-4e53-a1f6-9a1e92daf446/resource/40cceccf-0bfd-4273-8ea2-479c0e97f13a/download/mdg.zip
  format: null
  id: resource_40cceccf
  ...
  title: GAR15 Global Exposure Dataset for Madagascar.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mdg_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Madagascar
version: null
vulnerability: null
---
