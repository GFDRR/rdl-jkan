...
- entity:
    ...
    url: https://data.humdata.org/dataset/che-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/che-ghsl
dataset_id: rdls_exp-che_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/che-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    distribution at global scale. The Switzerland subset represents national-level
    exposure data derived from this multi-source integration methodology.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/che-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/2c321980-9574-428a-b1b8-accdaf8e63d6/resource/04b5f89f-4d6c-4112-9d89-07c4dbce9838/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_che.tif
  format: null
  id: resource_04b5f89f
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Switzerland: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/2c321980-9574-428a-b1b8-accdaf8e63d6/resource/2282cd95-853e-4c41-8de3-c4f3b8607f37/download/ghs_pop_e2025_r2023a_54009_100_v1_0_che.tif
  format: null
  id: resource_2282cd95
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-che_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Switzerland: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
