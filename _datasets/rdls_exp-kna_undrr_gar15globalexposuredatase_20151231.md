...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-kitts-and-nevis
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-kitts-and-nevis
dataset_id: rdls_exp-kna_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-kitts-and-nevis]'
...
lineage:
  description: The GAR15 global exposure database was developed using a top-down approach
    ...
    value of exposed assets for Saint Kitts and Nevis.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Saint Kitts and Nevis.zip
  download_url: https://data.humdata.org/dataset/ab55f5c2-7c43-4597-a8c4-a81a47c13a56/resource/b33028c9-c7fe-43f9-9cf3-df454d563f00/download/kna.zip
  format: null
  id: resource_b33028c9
  ...
  title: GAR15 Global Exposure Dataset for Saint Kitts and Nevis.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kna_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Saint Kitts and Nevis
version: null
vulnerability: null
---
