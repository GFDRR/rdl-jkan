...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-slv_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for El Salvador. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796645
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796645
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    El Salvador, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/10796645/files/SLV.zip
  format: null
  id: resource_sdkicra_slv
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - El Salvador
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-slv_nismod_sdkicra
spatial:
  bbox:
  - -90.11
  - 13.16
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3585968/el-salvador.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for El Salvador
version: 0.1.0
vulnerability: null
---
