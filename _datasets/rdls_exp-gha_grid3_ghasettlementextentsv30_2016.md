...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-gha-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-gha-settlement-extents-v3-0
dataset_id: rdls_exp-gha_grid3_ghasettlementextentsv30_2016
description: 'The GRID3 GHA - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Ghana, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Ghana Settlement Extents,
  ...
  2024. GRID3 GHA - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-gha-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents were derived using a new open-data methodology to
    identify built-up areas and estimate building counts and population distributions.
    The dataset includes settlement polygons and 100-meter grid cell centroids with
    probability values, representing the spatial distribution of human settlements
    and structures across Ghana for exposure assessment.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-gha-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Ghana - GRID3 GHA - Settlement Extents v3.0 (Contains information on
    data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/eb99843a-5757-487f-a18c-7f77e70fdb3e/resource/c7b91b7b-3811-4227-ad5f-32b34ac6f0d5/download/grid3-gha-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_c7b91b7b
  ...
  title: GRID3 GHA - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Ghana - GRID3 GHA - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/eb99843a-5757-487f-a18c-7f77e70fdb3e/resource/2fb27b6e-2653-4c8b-a408-da88335a460c/download/grid3_gha_settlement_extents_v3_0.zip
  format: null
  id: resource_2fb27b6e
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_GHA_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/eb99843a-5757-487f-a18c-7f77e70fdb3e/resource/4b3bfe56-bafd-46ec-97ab-c994ce5428e1/download/grid3_gha_settlement_grid_v3_0.zip
  format: null
  id: resource_4b3bfe56
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_GHA_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gha_grid3_ghasettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Ghana - GRID3 GHA - Settlement Extents v3.0
version: null
vulnerability: null
---
