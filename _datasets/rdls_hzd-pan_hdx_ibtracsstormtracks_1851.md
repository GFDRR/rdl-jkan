...
- entity:
    ...
    url: https://data.humdata.org/dataset/pan-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/pan-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-pan_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/pan-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Panama subset contains observed storm positions, wind speeds (wmo_wind), central
    pressures (wmo_pres), and storm classification (nature) at regular time intervals,
    filtered geographically for the Panama region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pan-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Panama.
  download_url: https://data.humdata.org/dataset/07069782-0949-446e-a6ff-5ea8ecc5d9e5/resource/52697c6c-fcae-43d6-a0d4-eaedf19a12d2/download/ibtracs_all_list_v04r01_pan.csv
  format: null
  id: resource_52697c6c
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PAN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Panama.
  download_url: https://data.humdata.org/dataset/07069782-0949-446e-a6ff-5ea8ecc5d9e5/resource/16096209-9929-49c2-8e39-a7fc6b668843/download/ibtracs_all_list_v04r01_lines_pan.geojson
  format: null
  id: resource_16096209
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PAN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-pan_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-29'
temporal_resolution: null
title: 'Panama: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
