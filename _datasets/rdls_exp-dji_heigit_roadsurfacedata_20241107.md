...
- entity:
    ...
    url: https://data.humdata.org/dataset/djibouti-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/djibouti-road-surface-data
dataset_id: rdls_exp-dji_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0082 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0016 and 0.0021
  (in million kms), corressponding to 19.2541% and 26.1252% respectively of the total
  road length in the dataset region. 0.0045 million km or 54.6206% of road surface
  ...
  to 1.3384% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/djibouti-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model predictions were integrated with existing OSM surface attributes to
    create a comprehensive road surface dataset with both observed and predicted classifications
    across Djibouti.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/djibouti-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Djibouti: Road Surface Data (GeoJSON data for Djibouti.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_dji_roadsurface_lines.geojson
  format: null
  id: resource_bb063d50
  ...
  title: Djibouti GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Djibouti: Road Surface Data (Geopackage data for Djibouti.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_dji_roadsurface_lines.gpkg
  format: null
  id: resource_ae9c39c9
  ...
  temporal: null
  temporal_resolution: null
  title: Djibouti GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dji_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Djibouti: Road Surface Data'
version: null
vulnerability: null
---
