...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-svalbard-and-jan-mayen-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-svalbard-and-jan-mayen-islands
dataset_id: rdls_exp-sjm_kontur_svalbardjanmayenislandspo_2023
description: 'Svalbard and Jan Mayen Islands population density for 400m H3 hexagons.
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-svalbard-and-jan-mayen-islands]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    overlay and interpolation methods. The resulting dataset provides baseline population
    exposure at high spatial resolution for Svalbard and Jan Mayen Islands.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-svalbard-and-jan-mayen-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Svalbard and Jan Mayen Islands: Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_SJ_20220630.gpkg.gz
  format: null
  id: resource_d5857f37
  ...
  title: kontur_population_SJ_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Svalbard and Jan Mayen Islands: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_SJ_20231101.gpkg.gz
  format: null
  id: resource_aa626f06
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_SJ_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sjm_kontur_svalbardjanmayenislandspo_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Svalbard and Jan Mayen Islands: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
