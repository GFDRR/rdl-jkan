...
- entity:
    ...
    url: https://data.humdata.org/dataset/tcd-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/tcd-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-tcd_hdx_ibtracsstormtracks_201805
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tcd-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Chad subset contains observed storm positions, timestamps, basin/sub-basin classifications,
    wind speeds (WMO standard), and central pressure measurements extracted from the
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tcd-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Chad: IBTrACS Storm Tracks (IBTrACS storm tracks from 2018 to date
    that pass within 2000 kilometers of Chad.)'
  download_url: https://data.humdata.org/dataset/83490408-22f5-4dd9-b86d-7ba1d8b94e09/resource/00544fdc-b242-40e1-884b-dc9e698dc575/download/ibtracs_all_list_v04r01_tcd.csv
  format: null
  id: resource_00544fdc
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_TCD.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Chad: IBTrACS Storm Tracks (IBTrACS storm tracks from 2018 to date
    that pass within 2000 kilometers of Chad.)'
  download_url: https://data.humdata.org/dataset/83490408-22f5-4dd9-b86d-7ba1d8b94e09/resource/baaa231b-7198-42e6-ac33-a9512afd6d70/download/ibtracs_all_list_v04r01_lines_tcd.geojson
  format: null
  id: resource_baaa231b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_TCD.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tcd_hdx_ibtracsstormtracks_201805
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2018-05-15'
temporal_resolution: null
title: 'Chad: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
