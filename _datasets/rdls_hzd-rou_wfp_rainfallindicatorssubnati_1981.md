...
- entity:
    ...
    url: https://data.humdata.org/dataset/rou-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/rou-rainfall-subnational
dataset_id: rdls_hzd-rou_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/rou-rainfall-subnational]'
...
lineage:
  description: Rainfall estimates are derived by merging CHIRPS v2 satellite infrared
    precipitation retrievals with in-situ rain gauge observations to produce dekadal
    (10-day) precipitation fields. Short-term forecasts are generated by blending
    CHIRPS climatology with GEFS ensemble output. Both observed and forecast fields
    are spatially aggregated over subnational administrative units in Romania to compute
    rolling accumulations (1-month, 3-month) and anomaly quantiles relative to long-term
    averages, supporting drought and food security monitoring.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) v2 -
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/rou-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135657861551_b5a64dd8'
  download_url: https://data.humdata.org/dataset/01d1e748-875f-49ad-97e2-165c6020617f/resource/d0c4578a-8e12-4195-828c-f57790c75b90/download/rou-rainfall-subnat-full.csv
  format: null
  id: resource_d0c4578a
  media_type: text/csv
  spatial: null
  ...
  title: rou-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135657861551_b5a64dd8'
  download_url: https://data.humdata.org/dataset/01d1e748-875f-49ad-97e2-165c6020617f/resource/d6040621-27ae-410b-ace8-ef1515bcebee/download/rou-rainfall-subnat-5ytd.csv
  format: null
  id: resource_d6040621
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: rou-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-rou_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Romania: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
