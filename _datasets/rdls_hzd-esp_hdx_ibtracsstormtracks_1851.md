...
- entity:
    ...
    url: https://data.humdata.org/dataset/esp-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/esp-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-esp_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/esp-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates historical tropical cyclone observations from multiple
    national meteorological agencies into a unified best-track dataset. The Spain
    subset contains observed storm tracks with ISO-formatted timestamps, basin/subbasin
    classifications, wind speeds (wmo_wind), and central pressure (wmo_pres) measurements,
    provided as both tabular CSV and geospatial GeoJSON formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/esp-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Spain.
  download_url: https://data.humdata.org/dataset/0b82bc8c-b652-4326-986d-809993b8f833/resource/ee9d1012-2cfd-4ce6-beb5-f8b0f54e5d14/download/ibtracs_all_list_v04r01_esp.csv
  format: null
  id: resource_ee9d1012
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ESP.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Spain.
  download_url: https://data.humdata.org/dataset/0b82bc8c-b652-4326-986d-809993b8f833/resource/be358b06-837d-4fc9-ac23-5e09d2e14474/download/ibtracs_all_list_v04r01_lines_esp.geojson
  format: null
  id: resource_be358b06
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ESP.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-esp_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-11-04'
temporal_resolution: null
title: 'Spain: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
