...
- entity:
    ...
    url: https://data.humdata.org/dataset/dma-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/dma-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-dma_hdx_dominicaibtracsstormtrack_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/dma-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Dominica subset
    contains historical and recent cyclone tracks with ISO-timestamped positions,
    wind speeds (wmo_wind in m/s), and central pressure measurements, processed and
    standardized by NOAA/NCEI according to IBTrACS v4r01 technical specifications.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dma-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Dominica.
  download_url: https://data.humdata.org/dataset/e83d65d6-11fa-4488-b351-3b9186302c5b/resource/47dfc740-96be-4e22-a7b6-3b87a2f21984/download/ibtracs_all_list_v04r01_dma.csv
  format: null
  id: resource_47dfc740
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_DMA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Dominica.
  download_url: https://data.humdata.org/dataset/e83d65d6-11fa-4488-b351-3b9186302c5b/resource/57215a8e-a3fd-4e8a-9975-4140f5f98c0a/download/ibtracs_all_list_v04r01_lines_dma.geojson
  format: null
  id: resource_57215a8e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_DMA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-dma_hdx_dominicaibtracsstormtrack_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Dominica: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
