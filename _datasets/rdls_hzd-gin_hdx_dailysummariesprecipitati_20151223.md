...
- entity:
    ...
    url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-guinea
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Centers for Environmental Information (NCEI / NOAA)
  url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-guinea
dataset_id: rdls_hzd-gin_hdx_dailysummariesprecipitati_20151223
description: 'This dataset contains the daily summaries on base stations across Guinea
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-guinea]'
...
lineage:
  description: Daily precipitation and snow observations were collected from meteorological
    base stations across Guinea by NOAA's National Centers for Environmental Information.
    Stations were filtered to include only those with 30+ years of continuous records
    with >182 complete days per year. Four indicators (total precipitation, maximum
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-guinea
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: Daily Summaries of Precipitation Indicators for Guinea (CSV)
  download_url: https://data.humdata.org/dataset/c3f15254-021d-44c9-bd41-22b37d927fcf/resource/986394e1-fcb6-44f5-9860-22fa817ea517/download/precipitation_gin.csv
  format: null
  id: resource_986394e1
  media_type: text/csv
  spatial: null
  ...
  title: precipitation_gin.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gin_hdx_dailysummariesprecipitati_20151223
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-23'
temporal_resolution: null
title: Daily Summaries of Precipitation Indicators for Guinea
version: null
vulnerability: null
---
