...
- entity:
    ...
    url: https://data.humdata.org/dataset/icpac-geonode-ethiopia-flood-inundation-100-year-return-period
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: IGAD Climate Prediction and Applications Center (ICPAC)
  url: https://data.humdata.org/dataset/icpac-geonode-ethiopia-flood-inundation-100-year-return-period
dataset_id: rdls_hzd-eth_icpac_floodinundation100yearret_20250328
description: 'This dataset is the output from the Global Flood Model intercomparison
  ...
  https://data.humdata.org/dataset/icpac-geonode-ethiopia-flood-inundation-100-year-return-period]'
  ...
  - analysis_type: probabilistic
    ...
    - calculation_method: simulated
      description: Probabilistic fluvial flood hazard model showing inundation extent
        at 100-year return period from multi-model ensemble agreement
...
lineage:
  description: Six global flood models were run for the Global Flood Partnership intercomparison
    ...
    outputs were harmonized to WGS84 at ~90m resolution and aggregated as a consensus
    raster indicating the number of models (0-6) agreeing each cell is inundated,
    following methodology described in Trigg et al. (2016).
  sources:
  - id: source_1
    license: null
    name: Global Flood Model intercomparison project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/icpac-geonode-ethiopia-flood-inundation-100-year-return-period
  rel: source
loss: null
project: null
publisher:
...
referenced_by: []
resources:
- access_url: https://geoportal.icpac.net/geoserver/ows?service=WCS&request=GetCoverage&coverageid=geonode__Ethiopia_flood_inundation&format=image%2Ftiff&version=2.0.1&compression=DEFLATE&tileWidth=512&tileHeight=512
  ...
  title: Ethiopia Flood Inundation (100 year return period) GeoTIFF
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-eth_icpac_floodinundation100yearret_20250328
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-03-28'
temporal_resolution: null
title: Ethiopia Flood Inundation (100 year return period)
version: null
vulnerability: null
---
