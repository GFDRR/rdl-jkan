...
- entity:
    ...
    url: https://data.humdata.org/dataset/svk-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/svk-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-svk_hdx_ibtracsstormtracks_1865
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/svk-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Slovakia subset contains observed storm track positions (latitude, longitude,
    ISO timestamp), basin/sub-basin classification, storm nature classification, and
    physical parameters (WMO wind speed and pressure) extracted for the national domain.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/svk-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Slovakia.
  download_url: https://data.humdata.org/dataset/7937463c-9e95-436b-8dec-336d36d9c6bf/resource/a884376f-6b68-4e93-89a3-1bad1736c640/download/ibtracs_all_list_v04r01_svk.csv
  format: null
  id: resource_a884376f
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SVK.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Slovakia.
  download_url: https://data.humdata.org/dataset/7937463c-9e95-436b-8dec-336d36d9c6bf/resource/f1a1a174-f573-441d-b2d2-14e0c04c8a5f/download/ibtracs_all_list_v04r01_lines_svk.geojson
  format: null
  id: resource_f1a1a174
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SVK.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-svk_hdx_ibtracsstormtracks_1865
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1865-10-24'
temporal_resolution: null
title: 'Slovakia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
