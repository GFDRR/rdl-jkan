...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-lbr-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-lbr-settlement-extents-v3-0
dataset_id: rdls_exp-lbr_grid3_lbrsettlementextentsv30_2016
description: 'The GRID3 LBR - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Liberia, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Liberia Settlement Extents,
  ...
  2024. GRID3 LBR - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-lbr-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents were derived using a new open-data methodology to
    identify built-up areas and estimate building counts across Liberia. The dataset
    includes settlement polygons and gridded centroids at 3-arc second (~100 meter)
    resolution with associated building and population attributes, enabling spatial
    representation of human settlements and infrastructure exposure.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-lbr-settlement-extents-v3-0
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: Liberia - GRID3 LBR - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/e480f5fd-d029-4708-9cbd-a16dba4b4194/resource/b0a9080e-5189-4bf1-8c5d-3ce75ebbc521/download/grid3-lbr-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_b0a9080e
  ...
  title: GRID3 LBR - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Liberia - GRID3 LBR - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/e480f5fd-d029-4708-9cbd-a16dba4b4194/resource/dba2a98d-0294-4eff-89ff-1da270fe33ca/download/grid3_lbr_settlement_extents_v3_0.zip
  format: null
  id: resource_dba2a98d
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_LBR_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/e480f5fd-d029-4708-9cbd-a16dba4b4194/resource/0e71ad7a-8d11-438d-be2e-b66de8204966/download/grid3_lbr_settlement_grid_v3_0.zip
  format: null
  id: resource_0e71ad7a
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_LBR_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lbr_grid3_lbrsettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Liberia - GRID3 LBR - Settlement Extents v3.0
version: null
vulnerability: null
---
