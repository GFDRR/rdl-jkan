...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/nga-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/nga-iom-dtm-from-api
dataset_id: rdls_lss-nga_iom_displacementtrackingmatri_2014
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/nga-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments across Nigeria to enumerate internally displaced persons.
    Data is aggregated at country, Admin 1 (state), and Admin 2 (local government
    area) levels and published via the DTM API as non-sensitive displacement figures
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nga-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Nigeria IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/2bec769a-7326-4a5c-83ca-7d32ffabcf5e/resource/54650b1f-d409-4ba0-b171-9206d92eded5/download/nga-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_54650b1f
  media_type: text/csv
  spatial: null
  ...
  title: Nigeria IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-nga_iom_displacementtrackingmatri_2014
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2014-12-01'
temporal_resolution: null
title: Nigeria IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
