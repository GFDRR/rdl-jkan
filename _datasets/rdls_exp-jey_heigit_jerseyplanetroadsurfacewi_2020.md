...
- entity:
    ...
    url: https://data.humdata.org/dataset/jersey-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/jersey-planet-road-surface-data
dataset_id: rdls_exp-jey_heigit_jerseyplanetroadsurfacewi_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0002 million km (73.6777%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (18.2161%) - PlanetScope predictions cover: 0.0002\
  \ million km (404.4639%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/jersey-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
license: CC-BY-4.0
lineage:
  description: 'Road network data from OpenStreetMap (arterial highways: motorway,
    trunk, primary, secondary and link classes) was analyzed using deep learning models
    ...
    Humanitarian Passability Index (HPI) based on passability risk scores.'
  sources:
  - id: source_1
    license: null
    name: PlanetScope Satellite Imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/jersey-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Jersey: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Jersey)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_JE_planet_roadsurface_lines.gpkg
  format: null
  id: resource_c373b4f7
  ...
  title: Jersey GPKG heigit_JE_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Jersey: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Jersey)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_JE_planet_roadsurface_lines.geojson
  format: null
  id: resource_4ee722e7
  ...
  temporal: null
  temporal_resolution: null
  title: Jersey GeoJSON heigit_JE_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-jey_heigit_jerseyplanetroadsurfacewi_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Jersey: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
