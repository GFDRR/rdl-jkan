...
- entity:
    ...
    url: https://data.humdata.org/dataset/lesotho-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/lesotho-planet-road-surface-data
dataset_id: rdls_exp-lso_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ surface conditions in many regions. Summary of Road Statistics Approximately 0.0021\
  \ million km of arterial roads are mapped in OSM in this region. - Paved roads:\
  \ 0.0017 million km (77.8627%) - Unpaved roads: 0.0004 million km (18.8104%) - Missing\
  \ OSM surface tags: 0.0 million km (0.0067%) - PlanetScope predictions cover: 0.0021\
  \ million km (1437459.0603%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lesotho-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lesotho-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Lesotho: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Lesotho)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_LS_planet_roadsurface_lines.gpkg
  format: null
  id: resource_d89a3364
  ...
  title: Lesotho GPKG heigit_LS_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Lesotho: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Lesotho)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_LS_planet_roadsurface_lines.geojson
  format: null
  id: resource_28f78630
  ...
  temporal: null
  temporal_resolution: null
  title: Lesotho GeoJSON heigit_LS_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lso_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Lesotho: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
