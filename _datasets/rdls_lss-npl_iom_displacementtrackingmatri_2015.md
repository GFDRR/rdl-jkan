...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/npl-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/npl-iom-dtm-from-api
dataset_id: rdls_lss-npl_iom_displacementtrackingmatri_2015
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/npl-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced populations across Nepal
    at Admin 0-2 levels. Data is aggregated and published via the DTM API with demographic
    disaggregation (sex) and displacement reason classification to support humanitarian
    response monitoring.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/npl-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Nepal IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/6ea2b42d-4d10-4379-8f97-fcc705ee4062/resource/374d7f2e-584f-49f3-be90-f71c1fd2efc2/download/npl-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_374d7f2e
  media_type: text/csv
  spatial: null
  ...
  title: Nepal IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-npl_iom_displacementtrackingmatri_2015
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-04-30'
temporal_resolution: null
title: Nepal IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
