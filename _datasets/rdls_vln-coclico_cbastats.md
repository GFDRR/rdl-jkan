...
creator:
  ...
  name: Global Climate Forum
  url: https://globalclimateforum.org/
dataset_id: rdls_vln-coclico_cbastats
description: 'We determine efficient coastal adaptation pathways for each coastal
  ...
  year x). [Source: This metadata record was automatically extracted from the STAC
...
- author_names: null
  ...
  url: https://storage.googleapis.com/coclico-data-public/coclico/coclico-stac/cba_stats/collection.json
resources:
- access_url: https://storage.googleapis.com/coclico-data-public/coclico/coclico-stac/cba_stats/collection.json
  ...
  title: 'STAC Collection: CoCliCo - Cost Benefit Analysis - statistics [cba_stats]'
- access_url: https://storage.googleapis.com/download/storage/v1/b/coclico-data-public/o/coclico%2Fassets%2Fthumbnails%2Fcba_stats.png?alt=media
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: CoCliCo - Cost Benefit Analysis - statistics
  download_url: null
  format: null
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: CoCliCo - Cost Benefit Analysis - statistics (Snapshot of the collection's
...
- vulnerability
schema: rdls-10
slug: rdls_vln-coclico_cbastats
spatial:
  bbox:
  - -90.23528381409483
  - -29.857082115784582
...
temporal:
  ...
  start: '2020'
temporal_resolution: null
title: CoCliCo - Cost Benefit Analysis - statistics
version: null
vulnerability: null
---
