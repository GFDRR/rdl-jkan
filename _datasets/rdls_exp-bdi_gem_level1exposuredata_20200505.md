...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/burundi-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/burundi-level-1-exposure-data
dataset_id: rdls_exp-bdi_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/burundi-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    Earth observation routines combined with minimal country-specific data collection.
    The dataset estimates building counts, areas, and rebuilding values at 15-arcsecond
    grid resolution (approximately 500 meters at the equator) across Burundi, intended
    for catastrophe modeling and disaster risk assessment applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Burundi produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/6f3373ab-1ae7-48bf-aa70-7ddb66d7e7f1/resource/9c7854dd-20ee-4cc5-90ac-3c9c9f94de4f/download/bdi_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_9c7854dd
  ...
  title: BDI_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bdi_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Burundi: Level 1 Exposure Data'
version: null
vulnerability: null
---
