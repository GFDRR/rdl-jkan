...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-nld_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Netherlands. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539771
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539771
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Netherlands, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16539771/files/NLD.zip
  format: null
  id: resource_sdkicra_nld
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Netherlands
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-nld_nismod_sdkicra
spatial:
  bbox:
  - -68.42
  - 12.02
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2750405/the-netherlands.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Netherlands
version: 0.1.0
vulnerability: null
---
