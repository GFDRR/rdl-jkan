...
- entity:
    affiliation: null
    email: null
    name: European Commission, Joint Research Centre (JRC) - Global Human Settlement
      Layer (GHSL)
    url: https://data.humdata.org/dataset/isr-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/isr-ghsl
dataset_id: rdls_exp-isr_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/isr-ghsl]'
...
exposure:
- asset_type:
    description: Built-up surface area derived from satellite imagery via the GHS
      Built-up Surface layer for Israel
    id: buildings
    scheme: null
    title: null
    uri: null
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Gridded population distribution for Israel derived from the GHS Population
      Grid
    id: population
    scheme: null
    title: null
...
lineage:
  description: The GHSL dataset is generated by the JRC through automated processing
    of large volumes of heterogeneous geospatial data, including global fine-scale
    satellite image streams, census data, and crowdsourced geographic information.
    Spatial data processing technologies extract built-up surface extent and population
    distribution at global scale, which are then subsetted here for Israel. The resulting
    raster layers serve as exposure inputs for disaster risk assessments by characterizing
    the spatial distribution of human settlements and population.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC) - Global Human Settlement
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/isr-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/015a84cb-365e-45b2-819b-c3169c96c6eb/resource/f13250a9-f1a9-4142-9f0b-33785bf992d9/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_isr.tif
  format: null
  id: resource_f13250a9
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Israel: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/015a84cb-365e-45b2-819b-c3169c96c6eb/resource/26a2819d-5bce-4f7a-b8ea-c79c89ea61bd/download/ghs_pop_e2025_r2023a_54009_100_v1_0_isr.tif
  format: null
  id: resource_26a2819d
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-isr_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Israel: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
