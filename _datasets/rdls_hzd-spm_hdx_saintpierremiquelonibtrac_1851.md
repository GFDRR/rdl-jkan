...
- entity:
    ...
    url: https://data.humdata.org/dataset/spm-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/spm-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-spm_hdx_saintpierremiquelonibtrac_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/spm-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The data for Saint
    Pierre and Miquelon includes historical and recent storm tracks with ISO-timestamped
    positions, basin classifications, wind speeds (wmo_wind), and central pressure
    (wmo_pres) measurements, provided in both tabular and geospatial formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/spm-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/30354759-2a81-4f15-8f8b-f266543a2e45/resource/d01db5f8-d9dd-457a-b0d8-54598ae99c2c/download/ibtracs_all_list_v04r01_spm.csv
  format: null
  id: resource_d01db5f8
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SPM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Saint Pierre and Miquelon.
  download_url: https://data.humdata.org/dataset/30354759-2a81-4f15-8f8b-f266543a2e45/resource/4d0649a6-e1ac-45fc-8060-ba010d8e1e29/download/ibtracs_all_list_v04r01_lines_spm.geojson
  format: null
  id: resource_4d0649a6
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SPM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-spm_hdx_saintpierremiquelonibtrac_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-08-16'
temporal_resolution: null
title: 'Saint Pierre and Miquelon: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
