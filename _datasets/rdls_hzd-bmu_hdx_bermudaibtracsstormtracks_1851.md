...
- entity:
    ...
    url: https://data.humdata.org/dataset/bmu-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bmu-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bmu_hdx_bermudaibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bmu-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Bermuda subset contains observed storm positions, times, wind speeds (WMO standard),
    and central pressures extracted from the global archive and filtered for the Atlantic
    basin region affecting Bermuda.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bmu-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Bermuda.
  download_url: https://data.humdata.org/dataset/3fabeb18-11a1-42ac-9137-a4ac9f4e783b/resource/b78b5c31-edb6-410a-aea9-f5424dcc0e0f/download/ibtracs_all_list_v04r01_bmu.csv
  format: null
  id: resource_b78b5c31
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BMU.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Bermuda.
  download_url: https://data.humdata.org/dataset/3fabeb18-11a1-42ac-9137-a4ac9f4e783b/resource/59282bf3-c68d-4a6b-85b4-5b0f25841234/download/ibtracs_all_list_v04r01_lines_bmu.geojson
  format: null
  id: resource_59282bf3
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BMU.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bmu_hdx_bermudaibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-08-01'
temporal_resolution: null
title: 'Bermuda: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
