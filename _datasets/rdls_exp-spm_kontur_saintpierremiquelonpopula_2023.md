...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-saint-pierre-and-miquelon
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-saint-pierre-and-miquelon
dataset_id: rdls_exp-spm_kontur_saintpierremiquelonpopula_2023
description: 'Saint Pierre and Miquelon population density for 400m H3 hexagons. Built
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-saint-pierre-and-miquelon]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    HRSL, Microsoft Buildings, Copernicus Land Cover, LINZ, and OpenStreetMap) to
    create a harmonized settlement layer. Population counts were then aggregated into
    H3 hexagonal grid cells at 400m resolution using spatial overlay techniques. The
    resulting dataset provides gridded population exposure at sub-kilometer scale
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-saint-pierre-and-miquelon
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Saint Pierre and Miquelon: Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PM_20220630.gpkg.gz
  format: null
  id: resource_074ffec4
  ...
  title: kontur_population_PM_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Saint Pierre and Miquelon: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PM_20231101.gpkg.gz
  format: null
  id: resource_ae3e6901
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_PM_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-spm_kontur_saintpierremiquelonpopula_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Saint Pierre and Miquelon: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
