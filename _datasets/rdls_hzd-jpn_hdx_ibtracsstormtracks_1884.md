...
- entity:
    ...
    url: https://data.humdata.org/dataset/jpn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/jpn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-jpn_hdx_ibtracsstormtracks_1884
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/jpn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Japan subset contains observed storm positions (latitude/longitude), ISO timestamps,
    basin/sub-basin classifications, wind speeds (wmo_wind), and central pressure
    (wmo_pres) for all tropical cyclones affecting the region, provided in both tabular
    CSV and GeoJSON line geometry formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/jpn-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1884 to date that pass within 2000 kilometers
    of Japan.
  download_url: https://data.humdata.org/dataset/8a7fbcda-7177-42bc-a9db-d85f79e087da/resource/2e17f6bb-06ad-4bfa-9e86-d7e929cf986c/download/ibtracs_all_list_v04r01_jpn.csv
  format: null
  id: resource_2e17f6bb
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_JPN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1884 to date that pass within 2000 kilometers
    of Japan.
  download_url: https://data.humdata.org/dataset/8a7fbcda-7177-42bc-a9db-d85f79e087da/resource/aa9c4ea8-d736-41d8-bac3-dbf28e6aff47/download/ibtracs_all_list_v04r01_lines_jpn.geojson
  format: null
  id: resource_aa9c4ea8
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_JPN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-jpn_hdx_ibtracsstormtracks_1884
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1884-06-24'
temporal_resolution: null
title: 'Japan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
