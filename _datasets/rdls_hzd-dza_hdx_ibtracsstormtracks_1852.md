...
- entity:
    ...
    url: https://data.humdata.org/dataset/dza-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/dza-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-dza_hdx_ibtracsstormtracks_1852
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/dza-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The Algeria subset contains observed
    storm tracks with ISO-formatted timestamps, basin/subbasin classifications, wind
    speed (wmo_wind), and pressure (wmo_pres) measurements at point locations and
    as linestrings, representing actual historical cyclone positions and intensities.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dza-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Algeria.
  download_url: https://data.humdata.org/dataset/62e62596-a119-4f55-a4d0-1847a5a79b00/resource/04d61bf7-6b98-4e9d-82e6-ddba2811ada3/download/ibtracs_all_list_v04r01_dza.csv
  format: null
  id: resource_04d61bf7
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_DZA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Algeria.
  download_url: https://data.humdata.org/dataset/62e62596-a119-4f55-a4d0-1847a5a79b00/resource/f1d1e25c-692b-42ea-872e-37b6002c9fa1/download/ibtracs_all_list_v04r01_lines_dza.geojson
  format: null
  id: resource_f1d1e25c
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_DZA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-dza_hdx_ibtracsstormtracks_1852
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1852-09-03'
temporal_resolution: null
title: 'Algeria: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
