...
- entity:
    ...
    url: https://data.humdata.org/dataset/pyf-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/pyf-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-pyf_hdx_frenchpolynesiaibtracssto_1919
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/pyf-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    recorded at regular time intervals and spatially referenced as point and line
    geometries for French Polynesia.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pyf-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1919 to date that pass within 2000 kilometers
    of French Polynesia.
  download_url: https://data.humdata.org/dataset/16055169-7c84-43a1-a1b2-92ff606287a2/resource/ab6894de-0678-49ea-b638-f4eb2a478838/download/ibtracs_all_list_v04r01_pyf.csv
  format: null
  id: resource_ab6894de
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PYF.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1919 to date that pass within 2000 kilometers
    of French Polynesia.
  download_url: https://data.humdata.org/dataset/16055169-7c84-43a1-a1b2-92ff606287a2/resource/16a58834-ffb4-4830-bc79-0aa6084cb968/download/ibtracs_all_list_v04r01_lines_pyf.geojson
  format: null
  id: resource_16a58834
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PYF.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-pyf_hdx_frenchpolynesiaibtracssto_1919
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1919-05-14'
temporal_resolution: null
title: 'French Polynesia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
