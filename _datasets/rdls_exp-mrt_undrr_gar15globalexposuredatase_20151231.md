...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mauritania
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mauritania
dataset_id: rdls_exp-mrt_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mauritania]'
...
- asset_type:
    description: Population distribution used as geographic proxy for spatial allocation
      of national socio-economic data
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Mauritania were transposed onto 5x5 km and 1x1 km spatial grids using gridded
    population distribution and GDP data as geographic proxies. The GAR15 global exposure
    database was developed by UNEP-GRID in collaboration with WAPMERR, EU JRC, and
    Kokusai Kogyo to create a spatially-explicit inventory of economic assets and
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mauritania
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Mauritania.zip
  download_url: https://data.humdata.org/dataset/1eacd34d-94ab-4177-8343-c43fd979ae3c/resource/396c44f1-1287-4472-a4a9-4e2fb7d80af5/download/mrt.zip
  format: null
  id: resource_396c44f1
  ...
  title: GAR15 Global Exposure Dataset for Mauritania.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mrt_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Mauritania
version: null
vulnerability: null
---
