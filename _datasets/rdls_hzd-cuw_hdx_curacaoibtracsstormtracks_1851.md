...
- entity:
    ...
    url: https://data.humdata.org/dataset/cuw-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/cuw-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-cuw_hdx_curacaoibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cuw-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: "IBTrACS merges historical and recent tropical cyclone observations\
    ...
    \ standardized and quality-controlled. The Cura\xE7ao subset contains all cyclone\
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cuw-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: "IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers\
    \ of Cura\xE7ao."
  download_url: https://data.humdata.org/dataset/6b3c7899-270d-4f17-88e6-448c96ad636b/resource/5433b36a-4c00-458c-b175-3af751c26571/download/ibtracs_all_list_v04r01_cuw.csv
  format: null
  id: resource_5433b36a
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CUW.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: "IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers\
    \ of Cura\xE7ao."
  download_url: https://data.humdata.org/dataset/6b3c7899-270d-4f17-88e6-448c96ad636b/resource/e653fb6b-c3c7-4194-8bc8-e706c9d41108/download/ibtracs_all_list_v04r01_lines_cuw.geojson
  format: null
  id: resource_e653fb6b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CUW.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cuw_hdx_curacaoibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-29'
temporal_resolution: null
title: "Cura\xE7ao: IBTrACS Storm Tracks"
version: null
vulnerability: null
---
