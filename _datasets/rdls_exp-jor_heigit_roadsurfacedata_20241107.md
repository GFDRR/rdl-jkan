...
- entity:
    ...
    url: https://data.humdata.org/dataset/jordan-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/jordan-road-surface-data
dataset_id: rdls_exp-jor_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0812 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0201 and 0.0049
  (in million kms), corressponding to 24.8049% and 6.0959% respectively of the total
  road length in the dataset region. 0.0561 million km or 69.0992% of road surface
  ...
  to 0.3268% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/jordan-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    classification using a hybrid deep learning approach. The model predicted paved/unpaved
    surface types for roads across Jordan, generating estimates of ~0.0201 million
    km paved and ~0.0049 million km unpaved roads. Results are provided as GeoJSON
    and GeoPackage formats with original OSM attributes plus predicted surface classifications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/jordan-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Jordan: Road Surface Data (GeoJSON data for Jordan.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_jor_roadsurface_lines.geojson
  format: null
  id: resource_67b30ae3
  ...
  title: Jordan GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Jordan: Road Surface Data (Geopackage data for Jordan.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_jor_roadsurface_lines.gpkg
  format: null
  id: resource_7c588257
  ...
  temporal: null
  temporal_resolution: null
  title: Jordan GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-jor_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Jordan: Road Surface Data'
version: null
vulnerability: null
---
