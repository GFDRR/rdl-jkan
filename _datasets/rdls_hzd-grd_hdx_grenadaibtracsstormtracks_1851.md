...
- entity:
    ...
    url: https://data.humdata.org/dataset/grd-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/grd-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-grd_hdx_grenadaibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grd-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Grenada subset contains observed storm track positions with ISO-formatted
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grd-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Grenada.
  download_url: https://data.humdata.org/dataset/ad4a93d6-50ed-40f0-aac2-83937fad93bf/resource/fbab59f0-b6aa-4735-9458-202b4a577e7b/download/ibtracs_all_list_v04r01_grd.csv
  format: null
  id: resource_fbab59f0
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GRD.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Grenada.
  download_url: https://data.humdata.org/dataset/ad4a93d6-50ed-40f0-aac2-83937fad93bf/resource/849a5ae2-aee4-4606-ae02-8759814881c6/download/ibtracs_all_list_v04r01_lines_grd.geojson
  format: null
  id: resource_849a5ae2
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GRD.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-grd_hdx_grenadaibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Grenada: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
