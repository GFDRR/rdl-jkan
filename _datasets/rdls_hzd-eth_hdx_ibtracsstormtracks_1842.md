...
- entity:
    ...
    url: https://data.humdata.org/dataset/eth-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/eth-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-eth_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/eth-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Ethiopia subset contains observed storm track positions (latitude, longitude,
    time) with associated wind speed (wmo_wind) and pressure (wmo_pres) measurements
    extracted for the Ethiopian region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/eth-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Ethiopia.
  download_url: https://data.humdata.org/dataset/5d8b5214-9bb0-4959-a638-87df7645e549/resource/6aa633d9-d2e4-4d74-b095-80f70f8586c3/download/ibtracs_all_list_v04r01_eth.csv
  format: null
  id: resource_6aa633d9
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ETH.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Ethiopia.
  download_url: https://data.humdata.org/dataset/5d8b5214-9bb0-4959-a638-87df7645e549/resource/452a8c88-1b13-409f-8662-2e95c5f66e6d/download/ibtracs_all_list_v04r01_lines_eth.geojson
  format: null
  id: resource_452a8c88
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ETH.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-eth_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Ethiopia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
