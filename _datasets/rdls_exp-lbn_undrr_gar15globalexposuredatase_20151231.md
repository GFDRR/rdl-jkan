...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lebanon
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lebanon
dataset_id: rdls_exp-lbn_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lebanon]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    density and GDP as spatial distribution proxies. The dataset was developed by
    UNEP-GRID in collaboration with WAPMERR, EU JRC, and Kokusai Kogyo as part of
    the GAR15 global exposure assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lebanon
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Lebanon.zip
  download_url: https://data.humdata.org/dataset/ddbcd1da-c937-46d7-bbc0-bb205c987b67/resource/ac249247-4a27-4e71-98d4-9f92aec761de/download/lbn.zip
  format: null
  id: resource_ac249247
  ...
  title: GAR15 Global Exposure Dataset for Lebanon.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lbn_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Lebanon
version: null
vulnerability: null
---
