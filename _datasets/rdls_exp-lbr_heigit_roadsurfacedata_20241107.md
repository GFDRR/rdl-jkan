...
- entity:
    ...
    url: https://data.humdata.org/dataset/liberia-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/liberia-road-surface-data
dataset_id: rdls_exp-lbr_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/liberia-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    ...
    from unpaved roads. The resulting dataset combines OSM-mapped road geometry with
    predicted surface classes and confidence metrics, providing a comprehensive infrastructure
    inventory for humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/liberia-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Liberia: Road Surface Data (GeoJSON data for Liberia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lbr_roadsurface_lines.geojson
  format: null
  id: resource_c8f33121
  ...
  title: Liberia GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Liberia: Road Surface Data (Geopackage data for Liberia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lbr_roadsurface_lines.gpkg
  format: null
  id: resource_75797c56
  ...
  temporal: null
  temporal_resolution: null
  title: Liberia GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lbr_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Liberia: Road Surface Data'
version: null
vulnerability: null
---
