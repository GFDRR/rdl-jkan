...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-canada
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-canada
dataset_id: rdls_exp-can_kontur_populationdensity400mh3he_2023
description: 'Canada population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-canada]'
...
license: CC-BY-4.0
lineage:
  description: Population density dataset created by fusing multiple global and regional
    data sources (GHSL, HRSL, Microsoft Buildings, Copernicus Land Cover, LINZ, and
    OpenStreetMap) and aggregating population counts to 400m H3 hexagonal grid cells
    using the H3 hierarchical spatial indexing system. The dataset provides baseline
    population distribution for Canada at high spatial resolution for disaster risk
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-canada
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Canada: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CA_20220630.gpkg.gz
  format: null
  id: resource_6fcda7f3
  ...
  title: kontur_population_CA_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Canada: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CA_20231101.gpkg.gz
  format: null
  id: resource_06947e34
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_CA_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-can_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Canada: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
