...
- entity:
    ...
    url: https://data.humdata.org/dataset/guinea-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/guinea-level-1-exposure-data
dataset_id: rdls_exp-gin_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/guinea-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was generated through the METEOR project methodology
    ...
    resolution (~500m) across Guinea, designed specifically for catastrophe modeling
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guinea-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Guinea produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/d5840650-0238-4fe2-88f2-37822fe8e148/resource/edf882ca-18ed-438d-9b6c-80bd23618878/download/gin_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_edf882ca
  ...
  title: GIN_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gin_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Guinea: Level 1 Exposure Data'
version: null
vulnerability: null
---
