...
- entity:
    ...
    url: https://data.humdata.org/dataset/and-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/and-ghsl
dataset_id: rdls_exp-and_copernicus_andorraglobalhumansettlem_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/and-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    distribution at global scale, with national-level extraction for Andorra.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/and-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/7df02608-1f14-45cb-82c9-946c847308e1/resource/5d188e37-4b89-499b-9f77-52f9eb874dd5/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_and.tif
  format: null
  id: resource_5d188e37
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Andorra: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/7df02608-1f14-45cb-82c9-946c847308e1/resource/546e5e86-6462-4166-800f-83db0fc1cceb/download/ghs_pop_e2025_r2023a_54009_100_v1_0_and.tif
  format: null
  id: resource_546e5e86
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-and_copernicus_andorraglobalhumansettlem_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Andorra: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
