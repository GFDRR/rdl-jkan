...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-china
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-china
dataset_id: rdls_exp-chn_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-china]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    and GDP as spatial proxies. The top-down approach integrated inputs from multiple
    international agencies to estimate economic value and distribution of exposed
    assets across China for the GAR15 global risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-china
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for China.zip
  download_url: https://data.humdata.org/dataset/799343cf-e317-4c2e-8f18-eb1b13c44a10/resource/37ef103a-a531-4bda-9a82-1ac9122c9c5e/download/chn.zip
  format: null
  id: resource_37ef103a
  ...
  title: GAR15 Global Exposure Dataset for China.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-chn_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for China
version: null
vulnerability: null
---
