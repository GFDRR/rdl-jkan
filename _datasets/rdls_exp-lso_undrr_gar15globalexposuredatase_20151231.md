...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lesotho
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lesotho
dataset_id: rdls_exp-lso_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lesotho]'
...
exposure:
- asset_type:
    description: Economic value of building stock by type, distributed spatially using
      GDP and population proxies
    id: buildings
    scheme: null
    title: null
    uri: null
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Population distribution at 5x5 km and 1x1 km grid resolution
    id: population
    scheme: null
    title: null
    uri: null
  ...
  - dimension: population
    ...
    measurement:
      ...
      unit: count
- asset_type:
    description: Capital stock and gross domestic product distributed spatially at
      grid level
...
lineage:
  description: The GAR15 global exposure database for Lesotho was developed using
    a top-down approach where national-level socio-economic, building type, and capital
    stock statistics were spatially distributed onto 5x5 km and 1x1 km grids using
    geographic population distribution and GDP as spatial proxies. The dataset integrates
    inputs from multiple international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai
    Kogyo) to create a comprehensive spatial inventory of economic assets and population
    exposure.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lesotho
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Lesotho.zip
  download_url: https://data.humdata.org/dataset/4beb72e7-ac64-4f2d-b59e-6610c6c70d1c/resource/13bf5601-9ef5-4533-b0a0-7326e02e0c19/download/lso.zip
  format: null
  id: resource_13bf5601
  ...
  title: GAR15 Global Exposure Dataset for Lesotho.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lso_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Lesotho
version: null
vulnerability: null
---
