...
- entity:
    ...
    url: https://data.humdata.org/dataset/btn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/btn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-btn_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/btn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Bhutan
    subset contains observed storm track positions, timestamps, basin/subbasin classifications,
    wind speeds (wmo_wind), and central pressure (wmo_pres) for cyclones affecting
    or passing near Bhutan.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/btn-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Bhutan.
  download_url: https://data.humdata.org/dataset/bbd0ab65-7ec5-462f-9e99-8fa533d17b11/resource/f49052ad-c144-4e9d-8030-e7f99db2473e/download/ibtracs_all_list_v04r01_btn.csv
  format: null
  id: resource_f49052ad
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BTN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Bhutan.
  download_url: https://data.humdata.org/dataset/bbd0ab65-7ec5-462f-9e99-8fa533d17b11/resource/5bbad93d-5e77-461e-85ce-18d43e23cc7e/download/ibtracs_all_list_v04r01_lines_btn.geojson
  format: null
  id: resource_5bbad93d
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BTN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-btn_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Bhutan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
