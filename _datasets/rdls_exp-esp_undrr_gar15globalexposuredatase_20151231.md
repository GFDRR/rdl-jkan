...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-spain
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-spain
dataset_id: rdls_exp-esp_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-spain]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure database for Spain was developed using a
    top-down approach where national-level statistical data on socio-economic indicators,
    building types, and capital stock were spatially distributed onto 5x5 km and 1x1
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-spain
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Spain.zip
  download_url: https://data.humdata.org/dataset/a593e2d1-0e3b-416d-8084-1168762834aa/resource/3f95c0d8-164b-441d-adfd-5be23a9e9568/download/esp.zip
  format: null
  id: resource_3f95c0d8
  ...
  title: GAR15 Global Exposure Dataset for Spain.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-esp_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Spain
version: null
vulnerability: null
---
