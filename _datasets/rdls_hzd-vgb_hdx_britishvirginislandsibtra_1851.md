...
- entity:
    ...
    url: https://data.humdata.org/dataset/vgb-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/vgb-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-vgb_hdx_britishvirginislandsibtra_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/vgb-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The data includes storm
    positions (latitude/longitude), observation times, wind speeds (wmo_wind), and
    central pressure (wmo_pres) recorded at regular intervals along each cyclone track.
    This empirical observational dataset provides the most complete global collection
    of historical and recent tropical cyclone tracks.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vgb-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/d542c057-af71-4014-9683-f8faa2147f6d/resource/8ae30451-50b9-4cee-8e36-f4d08360d4d3/download/ibtracs_all_list_v04r01_vgb.csv
  format: null
  id: resource_8ae30451
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_VGB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of British Virgin Islands.
  download_url: https://data.humdata.org/dataset/d542c057-af71-4014-9683-f8faa2147f6d/resource/28ba1890-bfdb-402e-a9d4-8158f3d92ba7/download/ibtracs_all_list_v04r01_lines_vgb.geojson
  format: null
  id: resource_28ba1890
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_VGB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-vgb_hdx_britishvirginislandsibtra_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-29'
temporal_resolution: null
title: 'British Virgin Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
