...
- entity:
    ...
    url: https://data.humdata.org/dataset/plw-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/plw-ghsl
dataset_id: rdls_exp-plw_copernicus_palauglobalhumansettlemen_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/plw-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    and population distribution. The resulting GeoTIFF rasters represent spatially
    explicit exposure inventories of human settlements and infrastructure for Palau.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/plw-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/d00669c3-4bf4-4335-8297-d5e11471b784/resource/4493b4b0-786c-4241-b037-430c0928735f/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_plw.tif
  format: null
  id: resource_4493b4b0
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Palau: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/d00669c3-4bf4-4335-8297-d5e11471b784/resource/31c0773e-47a1-40dd-8ef4-341c0bd4fa6e/download/ghs_pop_e2025_r2023a_54009_100_v1_0_plw.tif
  format: null
  id: resource_31c0773e
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-plw_copernicus_palauglobalhumansettlemen_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Palau: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
