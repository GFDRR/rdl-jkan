...
- entity:
    ...
    url: https://data.humdata.org/dataset/atg-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/atg-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-atg_hdx_antiguabarbudaibtracsstor_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/atg-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The data
    for Antigua and Barbuda includes storm identifiers, observation times, basin/sub-basin
    classifications, track positions (latitude/longitude), and physical parameters
    (WMO wind speed and pressure) representing observed cyclone characteristics.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/atg-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/edc25557-0649-4804-aa46-c70eb368f3c6/resource/d064d78d-d3bb-46e7-8ce2-7c13c37e02d1/download/ibtracs_all_list_v04r01_atg.csv
  format: null
  id: resource_d064d78d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ATG.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Antigua and Barbuda.
  download_url: https://data.humdata.org/dataset/edc25557-0649-4804-aa46-c70eb368f3c6/resource/1066d079-921d-427b-b759-224642633faa/download/ibtracs_all_list_v04r01_lines_atg.geojson
  format: null
  id: resource_1066d079
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ATG.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-atg_hdx_antiguabarbudaibtracsstor_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Antigua and Barbuda: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
