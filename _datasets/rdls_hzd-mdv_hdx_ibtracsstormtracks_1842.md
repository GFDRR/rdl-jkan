...
- entity:
    ...
    url: https://data.humdata.org/dataset/mdv-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mdv-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mdv_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mdv-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    Track data for Maldives includes storm identifiers, observation times, basin/sub-basin
    classifications, nature of the system, and physical parameters (WMO wind speed
    and pressure) at each track point, provided in both tabular and geospatial formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mdv-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Maldives.
  download_url: https://data.humdata.org/dataset/8b1cd781-01cc-4534-8259-a497360d4899/resource/fbdab744-1c6d-46dd-8cbe-cb2a8680dc58/download/ibtracs_all_list_v04r01_mdv.csv
  format: null
  id: resource_fbdab744
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MDV.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Maldives.
  download_url: https://data.humdata.org/dataset/8b1cd781-01cc-4534-8259-a497360d4899/resource/170ef79d-bd26-4be0-be27-0a27de72e7e3/download/ibtracs_all_list_v04r01_lines_mdv.geojson
  format: null
  id: resource_170ef79d
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MDV.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mdv_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Maldives: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
