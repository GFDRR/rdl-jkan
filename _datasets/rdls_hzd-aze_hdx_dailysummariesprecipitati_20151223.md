...
- entity:
    ...
    url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-azerbaijan
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Centers for Environmental Information (NCEI / NOAA)
  url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-azerbaijan
dataset_id: rdls_hzd-aze_hdx_dailysummariesprecipitati_20151223
description: 'This dataset contains the daily summaries on base stations across Azerbaijan
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-azerbaijan]'
...
lineage:
  description: Daily precipitation data were collected from meteorological base stations
    across Azerbaijan by NOAA's National Centers for Environmental Information. Stations
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-azerbaijan
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Daily Summaries of Precipitation Indicators for Azerbaijan (CSV)
  download_url: https://data.humdata.org/dataset/eb95c89f-231b-4810-b8f4-c7ae335afe27/resource/6a02c1dd-fc98-419d-8e17-90332f178f53/download/precipitation_aze.csv
  format: null
  id: resource_6a02c1dd
  media_type: text/csv
  spatial: null
  ...
  title: precipitation_aze.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-aze_hdx_dailysummariesprecipitati_20151223
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-23'
temporal_resolution: null
title: Daily Summaries of Precipitation Indicators for Azerbaijan
version: null
vulnerability: null
---
