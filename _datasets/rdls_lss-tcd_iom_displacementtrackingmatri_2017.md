...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/tcd-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/tcd-iom-dtm-from-api
dataset_id: rdls_lss-tcd_iom_displacementtrackingmatri_2017
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/tcd-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced persons across Chad at
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tcd-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Chad IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/d2afab27-d6e8-4adc-8351-f95f0cf4cf2b/resource/191879b1-b11c-4a6d-857a-e8e9b634992b/download/tcd-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_191879b1
  media_type: text/csv
  spatial: null
  ...
  title: Chad IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-tcd_iom_displacementtrackingmatri_2017
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2017-09-30'
temporal_resolution: null
title: Chad IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
