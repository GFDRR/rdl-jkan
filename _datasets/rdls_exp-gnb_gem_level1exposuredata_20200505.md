...
- entity:
    ...
    url: https://data.humdata.org/dataset/guinea-bissau-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/guinea-bissau-level-1-exposure-data
dataset_id: rdls_exp-gnb_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/guinea-bissau-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was generated through the METEOR project's global-quality
    ...
    value at 15-arcsecond resolution (~500m) across Guinea-Bissau, designed for catastrophe
    modeling and disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: METEOR Project (Modelling Exposure Through Earth Observation Routines)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guinea-bissau-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Guinea-Bissau produced by
    ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/16853597-57e3-4088-a5dc-64e4ec33ca42/resource/3d1c8d3b-2d50-4181-a20d-d8a0c1286234/download/gnb_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_3d1c8d3b
  ...
  title: GNB_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gnb_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Guinea-Bissau: Level 1 Exposure Data'
version: null
vulnerability: null
---
