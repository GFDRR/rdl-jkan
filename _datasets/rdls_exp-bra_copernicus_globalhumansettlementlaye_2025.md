...
- entity:
    ...
    url: https://data.humdata.org/dataset/bra-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bra-ghsl
dataset_id: rdls_exp-bra_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bra-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    datasets provide spatially explicit evidence of human presence and settlement
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bra-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/fd8ea938-500e-46e4-8cb2-95e1d5c8ab2b/resource/69634250-ed5a-4c19-8b04-0161cd02a016/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bra.tif
  format: null
  id: resource_69634250
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Brazil: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/fd8ea938-500e-46e4-8cb2-95e1d5c8ab2b/resource/5d341b6a-5f54-4ad2-a148-e97de5ea2efd/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bra.tif
  format: null
  id: resource_5d341b6a
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-bra_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Brazil: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
