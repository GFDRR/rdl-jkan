...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-reunion
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-reunion
dataset_id: rdls_exp-reu_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-reunion]'
...
lineage:
  description: "The GAR15 exposure dataset for R\xE9union was developed using a top-down\
    ...
    \ population density and GDP as spatial proxies. The database integrates inputs\
    \ from multiple international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai Kogyo)\
    \ to create a comprehensive multi-sector exposure inventory for disaster risk\
    \ assessment."
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-reunion
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: "GAR15 Global Exposure Dataset for R\xE9union.zip"
  download_url: https://data.humdata.org/dataset/2b35a022-2f17-4961-8cc1-71cc17c29bdb/resource/0df780bf-d727-4362-a5e8-dd5be145ed0c/download/reu.zip
  format: null
  id: resource_0df780bf
  ...
  title: "GAR15 Global Exposure Dataset for R\xE9union.zip"
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-reu_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: "GAR15 Global Exposure Dataset for R\xE9union"
version: null
vulnerability: null
---
