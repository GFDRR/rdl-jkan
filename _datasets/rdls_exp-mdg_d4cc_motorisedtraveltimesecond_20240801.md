...
- entity:
    ...
    url: https://data.humdata.org/dataset/madagascar-motorised-travel-time-in-seconds-to-nearest-health-centre
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Data for Children Collaborative
  url: https://data.humdata.org/dataset/madagascar-motorised-travel-time-in-seconds-to-nearest-health-centre
dataset_id: rdls_exp-mdg_d4cc_motorisedtraveltimesecond_20240801
description: 'A 100 m spatial resolution geotiff of motorised travel time in seconds
  to nearest health facility in Madagascar. The data was generated using the Child
  ...
  the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/madagascar-motorised-travel-time-in-seconds-to-nearest-health-centre]'
...
exposure:
- asset_type:
    description: Health facility accessibility measured as motorised travel time to
...
lineage:
  description: Travel time surface generated using least cost path methodology applied
    ...
    road network and terrain. The friction surface incorporates driving speeds on
    all-weather/asphalt roads and walking speeds on other roads, tracks, paths and
    land cover types. Output is a 100 m resolution geotiff of cumulative travel time
    in seconds to the nearest health facility.
  sources:
  - id: source_1
    license: null
    name: Child Poverty and Access to Services (CPAS) software
...
- access_url: null
  ...
  download_url: https://s3.eidf.ac.uk/eidf158-motorised-travel-time-maps/service_area_Madagascar_motorised.tif
  format: null
  id: resource_d24e1ece
  ...
  title: service-area-madagascar-motorised.tif
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mdg_d4cc_motorisedtraveltimesecond_20240801
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-08-01'
temporal_resolution: null
title: Madagascar Motorised Travel Time (in seconds) to nearest health centre
version: null
vulnerability: null
---
