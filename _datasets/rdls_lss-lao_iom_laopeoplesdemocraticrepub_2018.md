...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/lao-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/lao-iom-dtm-from-api
dataset_id: rdls_lss-lao_iom_laopeoplesdemocraticrepub_2018
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/lao-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced persons across Lao PDR
    at admin 0-2 levels. Data are aggregated by displacement reason, sex, and origin
    location, then published via the DTM API for humanitarian and research use.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lao-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Lao People's Democratic Republic IOM displacement tracking matrix data
    at admin levels 0-2, sourced from the DTM API
  download_url: https://data.humdata.org/dataset/ea2b0620-10ed-456d-9cb0-bed6a2b9f5e6/resource/77530ef7-82b5-4092-b1a7-e20831c6adaf/download/lao-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_77530ef7
  media_type: text/csv
  spatial: null
  ...
  title: Lao People's Democratic Republic IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-lao_iom_laopeoplesdemocraticrepub_2018
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2018-07-30'
temporal_resolution: null
title: Lao People's Democratic Republic IOM Displacement Tracking Matrix (DTM) from
  API
version: null
vulnerability: null
---
