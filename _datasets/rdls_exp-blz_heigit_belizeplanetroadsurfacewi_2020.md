...
- entity:
    ...
    url: https://data.humdata.org/dataset/belize-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/belize-planet-road-surface-data
dataset_id: rdls_exp-blz_heigit_belizeplanetroadsurfacewi_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0011 million km (93.5843%) - Unpaved roads: 0.0001 million km (5.3298%) - Missing\
  \ OSM surface tags: 0.0 million km (0.0269%) - PlanetScope predictions cover: 0.0012\
  \ million km (367192.2014%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/belize-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road surface type, width, and passability were derived by applying
    ...
    2024. The analysis focused on OSM-defined arterial roads (motorway, trunk, primary,
    secondary and associated link classes) in Belize. A Humanitarian Passability Index
    was computed from the classified road characteristics to support logistics planning
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/belize-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Belize: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Belize)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_BZ_planet_roadsurface_lines.gpkg
  format: null
  id: resource_dab8dc7c
  ...
  title: Belize GPKG heigit_BZ_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Belize: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Belize)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_BZ_planet_roadsurface_lines.geojson
  format: null
  id: resource_9ccc956d
  ...
  temporal: null
  temporal_resolution: null
  title: Belize GeoJSON heigit_BZ_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-blz_heigit_belizeplanetroadsurfacewi_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Belize: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
