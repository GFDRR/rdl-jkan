...
- entity:
    ...
    url: https://data.humdata.org/dataset/chn-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/chn-ghsl
dataset_id: rdls_exp-chn_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/chn-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: The GHSL dataset integrates global fine-scale satellite imagery, census
    data, and volunteered geographic information through automated spatial data processing
    technologies to extract built-up surface extent and gridded population distribution.
    The resulting geospatial layers characterize human settlement patterns and infrastructure
    presence at high spatial resolution for disaster risk exposure assessment.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/chn-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/959b5983-b02a-4507-a6b8-fb28c67e245b/resource/56957c19-0a4d-4ced-bd4f-18ef4520027c/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_chn.tif
  format: null
  id: resource_56957c19
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'China: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/959b5983-b02a-4507-a6b8-fb28c67e245b/resource/e07217b6-b85a-4bf7-b1c2-6785b5229402/download/ghs_pop_e2025_r2023a_54009_100_v1_0_chn.tif
  format: null
  id: resource_e07217b6
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-chn_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'China: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
