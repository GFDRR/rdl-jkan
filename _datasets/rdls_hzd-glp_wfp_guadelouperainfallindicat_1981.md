...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/glp-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/glp-rainfall-subnational
dataset_id: rdls_hzd-glp_wfp_guadelouperainfallindicat_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/glp-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    ...
    sums and anomalies) at subnational administrative units in Guadeloupe for drought
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/glp-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135529072166_b6310ce4'
  download_url: https://data.humdata.org/dataset/2522b1ab-6147-4371-9857-3bb560d0a3dd/resource/50bb3280-234b-49b4-b5e8-983f993f425a/download/glp-rainfall-subnat-full.csv
  format: null
  id: resource_50bb3280
  media_type: text/csv
  spatial: null
  ...
  title: glp-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135529072166_b6310ce4'
  download_url: https://data.humdata.org/dataset/2522b1ab-6147-4371-9857-3bb560d0a3dd/resource/2beecd80-45bb-418c-bd07-e70e91724cac/download/glp-rainfall-subnat-5ytd.csv
  format: null
  id: resource_2beecd80
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: glp-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-glp_wfp_guadelouperainfallindicat_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Guadeloupe: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
