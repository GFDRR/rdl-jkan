...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/eth-rainfall-subnational
dataset_id: rdls_hzd-eth_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/eth-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with rain gauge measurements and aggregated by dekad (10-day period) at subnational
    administrative units. Rolling 1-month and 3-month aggregations were computed alongside
    long-term climatological averages to generate standardized anomaly indices (rfq,
    r1q, r3q) for drought monitoring.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/eth-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135518849044_ace2e48b'
  download_url: https://data.humdata.org/dataset/423143be-315f-48d7-9e90-ae23738da564/resource/49e3a707-d153-423e-b22b-30484d678dd7/download/eth-rainfall-subnat-full.csv
  format: null
  id: resource_49e3a707
  media_type: text/csv
  spatial: null
  ...
  title: eth-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135518849044_ace2e48b'
  download_url: https://data.humdata.org/dataset/423143be-315f-48d7-9e90-ae23738da564/resource/45ca4594-766c-4e31-b429-d888959cdeb0/download/eth-rainfall-subnat-5ytd.csv
  format: null
  id: resource_45ca4594
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: eth-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-eth_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Ethiopia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
