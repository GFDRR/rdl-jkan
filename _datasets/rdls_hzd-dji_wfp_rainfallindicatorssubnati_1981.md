...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/dji-rainfall-subnational
dataset_id: rdls_hzd-dji_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/dji-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with ground-based rain gauge measurements, then aggregated into dekadal (10-day)
    indicators at subnational administrative units. Rolling 1-month and 3-month aggregations
    were computed alongside long-term climatological averages to enable drought monitoring
    and early warning through rainfall anomaly detection.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dji-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135519641014_c16d54de'
  download_url: https://data.humdata.org/dataset/4a8ca7c3-054f-4acf-91e9-85bc1a93b11b/resource/767b7ae4-45da-47ef-a90c-f5110a2ea9ce/download/dji-rainfall-subnat-full.csv
  format: null
  id: resource_767b7ae4
  media_type: text/csv
  spatial: null
  ...
  title: dji-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135519641014_c16d54de'
  download_url: https://data.humdata.org/dataset/4a8ca7c3-054f-4acf-91e9-85bc1a93b11b/resource/abe224a7-fb56-48d8-ae9c-7377794dd65c/download/dji-rainfall-subnat-5ytd.csv
  format: null
  id: resource_abe224a7
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: dji-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-dji_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Djibouti: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
