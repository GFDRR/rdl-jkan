...
- entity:
    ...
    url: https://data.humdata.org/dataset/cze-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/cze-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-cze_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cze-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Czechia subset contains observed storm track positions, timestamps, basin
    classifications, wind speeds (wmo_wind), and central pressure (wmo_pres) for tropical
    cyclones affecting or passing through the region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cze-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Czechia.
  download_url: https://data.humdata.org/dataset/2ce03da9-d574-41e6-b554-b3afeb2114e6/resource/2eac60ce-573f-48cd-8e65-119962bb218a/download/ibtracs_all_list_v04r01_cze.csv
  format: null
  id: resource_2eac60ce
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CZE.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Czechia.
  download_url: https://data.humdata.org/dataset/2ce03da9-d574-41e6-b554-b3afeb2114e6/resource/4a42a7d2-7360-414a-b480-43174bfd6067/download/ibtracs_all_list_v04r01_lines_cze.geojson
  format: null
  id: resource_4a42a7d2
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CZE.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cze_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Czechia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
