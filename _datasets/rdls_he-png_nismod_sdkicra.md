...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-png_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Papua New Guinea. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539741
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539741
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Papua New Guinea, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16539741/files/PNG.zip
  format: null
  id: resource_sdkicra_png
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Papua
    New Guinea
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-png_nismod_sdkicra
spatial:
  bbox:
  - 140.85
  - -11.64
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2088628/papua-new-guinea.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Papua New
  Guinea
version: 0.1.0
vulnerability: null
---
