...
- entity:
    ...
    url: https://data.humdata.org/dataset/taiwan-province-of-china-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
    email: null
    name: HeiGIT hybrid deep learning road surface classification model
    url: https://data.humdata.org/dataset/taiwan-province-of-china-road-surface-data
  id: attribution_2
  role: collaborator
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/taiwan-province-of-china-road-surface-data
dataset_id: rdls_exp-twn_heigit_provincechinaroadsurfaced_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2292 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0622 and 0.0047
  (in million kms), corressponding to 27.1242% and 2.0314% respectively of the total
  road length in the dataset region. 0.1624 million km or 70.8444% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0085 million km of information (corressponding
  to 5.2655% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/taiwan-province-of-china-road-surface-data]'
details: null
exposure:
- asset_type:
    description: Road network in Taiwan classified by surface type (paved vs unpaved)
      derived from OSM data using AI-based deep learning prediction
    id: infrastructure
    scheme: null
    title: null
    uri: null
...
lineage:
  description: OSM road network data for Taiwan was processed using a hybrid deep
    learning approach developed by HeiGIT to predict road surface types (paved vs
    unpaved) where explicit surface tags are absent. The resulting dataset provides
    AI-estimated surface classifications for approximately 0.2292 million km of roads,
    enabling infrastructure exposure assessments relevant to humanitarian access and
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/taiwan-province-of-china-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Taiwan (Province of China): Road Surface Data (GeoJSON data for Taiwan
    (province of china).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_twn_roadsurface_lines.geojson
  format: null
  id: resource_49666ab9
  ...
  title: Taiwan (province of china) GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Taiwan (Province of China): Road Surface Data (Geopackage data for
    Taiwan (province of china).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_twn_roadsurface_lines.gpkg
  format: null
  id: resource_dbc1ced5
  ...
  temporal: null
  temporal_resolution: null
  title: Taiwan (province of china) GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-twn_heigit_provincechinaroadsurfaced_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Taiwan (Province of China): Road Surface Data'
version: null
vulnerability: null
---
