...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-hong-kong
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-hong-kong
dataset_id: rdls_exp-hkg_kontur_hongkongadministrativediv_20220407
description: 'Hong Kong administrative division with aggregated population. Built
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-hong-kong]'
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    proprietary enhancements and filtered to Hong Kong. Population counts were aggregated
    from the Kontur Population dataset (400m H3 hexagons) to each administrative division.
    HASC codes were enriched from Wikidata to provide standardized regional identifiers.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-hong-kong
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Hong Kong: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_HK_20220407.gpkg.gz
  format: null
  id: resource_90aaf8fa
  ...
  title: kontur_boundaries_HK_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Hong Kong: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_HK_20230628.gpkg.gz
  format: null
  id: resource_7f0c6770
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_HK_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Hong Kong: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_HK_20230628.gpkg.gz
  format: null
  id: resource_9d012438
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_HK_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-hkg_kontur_hongkongadministrativediv_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Hong Kong: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
