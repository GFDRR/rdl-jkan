...
- entity:
    ...
    url: https://data.humdata.org/dataset/cri-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/cri-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-cri_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cri-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Costa Rica subset
    contains historical and recent storm tracks with ISO-formatted timestamps, geographic
    coordinates, wind speed (wmo_wind), and pressure (wmo_pres) measurements for all
    cyclones affecting the region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cri-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Costa Rica.
  download_url: https://data.humdata.org/dataset/ae429fdb-b58f-47f0-9119-a81baeaaba22/resource/e2ee6868-2846-4afa-99d9-ea39cc93b48d/download/ibtracs_all_list_v04r01_cri.csv
  format: null
  id: resource_e2ee6868
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CRI.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Costa Rica.
  download_url: https://data.humdata.org/dataset/ae429fdb-b58f-47f0-9119-a81baeaaba22/resource/929e106a-f30d-4632-9cc8-a0828b29d526/download/ibtracs_all_list_v04r01_lines_cri.geojson
  format: null
  id: resource_929e106a
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CRI.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cri_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Costa Rica: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
