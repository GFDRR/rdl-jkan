...
- entity:
    ...
    url: https://data.humdata.org/dataset/el-salvador-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
    email: null
    name: Deep learning road surface classification model
    url: https://data.humdata.org/dataset/el-salvador-road-surface-data
  id: attribution_2
  role: collaborator
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/el-salvador-road-surface-data
dataset_id: rdls_exp-slv_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0458 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0096 and 0.0087
  (in million kms), corressponding to 20.9447% and 18.978% respectively of the total
  road length in the dataset region. 0.0275 million km or 60.0773% of road surface
  ...
  to 0.4483% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/el-salvador-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    learning model to classify road surfaces into paved and unpaved categories. The
    model generated predictions for approximately 0.0458 million km of mapped roads
    in El Salvador, with results provided in both GeoJSON and GeoPackage formats including
    surface classification, smoothness, and geometric attributes.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/el-salvador-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'El Salvador: Road Surface Data (GeoJSON data for El salvador.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_slv_roadsurface_lines.geojson
  format: null
  id: resource_13cb3db7
  ...
  title: El salvador GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'El Salvador: Road Surface Data (Geopackage data for El salvador.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_slv_roadsurface_lines.gpkg
  format: null
  id: resource_13aa8d25
  ...
  temporal: null
  temporal_resolution: null
  title: El salvador GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-slv_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'El Salvador: Road Surface Data'
version: null
vulnerability: null
---
