...
- entity:
    ...
    url: https://data.humdata.org/dataset/chn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/chn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-chn_hdx_ibtracsstormtracks_1845
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/chn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    multiple national meteorological agencies into a unified best-track dataset. Source
    observations are standardized and integrated using the IBTrACS algorithm to create
    consistent storm identifiers, positions, and physical parameters (wind speed,
    pressure) across the global archive. The China subset contains all tropical cyclones
    affecting or originating in the Western Pacific basin region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/chn-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1845 to date that pass within 2000 kilometers
    of China.
  download_url: https://data.humdata.org/dataset/599e790b-1a0c-4228-bd58-579c97e5486f/resource/935e0b07-ff92-4538-b5f0-04e79163801a/download/ibtracs_all_list_v04r01_chn.csv
  format: null
  id: resource_935e0b07
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CHN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1845 to date that pass within 2000 kilometers
    of China.
  download_url: https://data.humdata.org/dataset/599e790b-1a0c-4228-bd58-579c97e5486f/resource/f7cfb16f-b534-4e6d-b50d-1fcab29027c2/download/ibtracs_all_list_v04r01_lines_chn.geojson
  format: null
  id: resource_f7cfb16f
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CHN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-chn_hdx_ibtracsstormtracks_1845
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1845-12-02'
temporal_resolution: null
title: 'China: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
