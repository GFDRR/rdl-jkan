...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/mkd-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mkd-rainfall-subnational
dataset_id: rdls_hzd-mkd_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/mkd-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    units. Long-term climatological averages and anomaly indices (quintiles) were
    calculated to support drought monitoring and early warning in North Macedonia.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mkd-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135603140331_ce64b6b6'
  download_url: https://data.humdata.org/dataset/8457f6bd-14d7-4452-94a2-b0c8a264b10d/resource/96f96470-9014-4d4e-8b5e-4c2d5c16f84b/download/mkd-rainfall-subnat-full.csv
  format: null
  id: resource_96f96470
  media_type: text/csv
  spatial: null
  ...
  title: mkd-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135603140331_ce64b6b6'
  download_url: https://data.humdata.org/dataset/8457f6bd-14d7-4452-94a2-b0c8a264b10d/resource/ced4b41f-350b-4a10-b289-6ba964f9f0a4/download/mkd-rainfall-subnat-5ytd.csv
  format: null
  id: resource_ced4b41f
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mkd-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mkd_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'North Macedonia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
