...
- entity:
    ...
    url: https://data.humdata.org/dataset/vnm-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/vnm-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-vnm_hdx_ibtracsstormtracks_1870
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/vnm-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Vietnam subset
    ...
    into CSV and GeoJSON formats for spatial analysis.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vnm-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1870 to date that pass within 2000 kilometers
    of Viet Nam.
  download_url: https://data.humdata.org/dataset/0ed261a8-cee1-4d25-bf58-ed3de1f5f840/resource/c9f7ef7a-4365-491c-8aaa-d9db55ba55c5/download/ibtracs_all_list_v04r01_vnm.csv
  format: null
  id: resource_c9f7ef7a
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_VNM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1870 to date that pass within 2000 kilometers
    of Viet Nam.
  download_url: https://data.humdata.org/dataset/0ed261a8-cee1-4d25-bf58-ed3de1f5f840/resource/9db9265c-9633-4979-8485-0080ec8d5e63/download/ibtracs_all_list_v04r01_lines_vnm.geojson
  format: null
  id: resource_9db9265c
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_VNM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-vnm_hdx_ibtracsstormtracks_1870
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1870-04-10'
temporal_resolution: null
title: 'Viet Nam: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
