...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-arab-emirates
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-arab-emirates
dataset_id: rdls_exp-are_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-arab-emirates]'
...
lineage:
  description: National-level socio-economic and building stock statistics were transposed
    ...
    WAPMERR, JRC, and Kokusai Kogyo for the GAR15 global risk assessment framework
    to provide spatially-explicit exposure inventories for disaster risk analysis.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for United Arab Emirates.zip
  download_url: https://data.humdata.org/dataset/eb4f033b-71c2-4ee7-b3a6-c4c339437e56/resource/be871c0a-f89c-4ac8-8d96-8489fd8d29e8/download/are.zip
  format: null
  id: resource_be871c0a
  ...
  title: GAR15 Global Exposure Dataset for United Arab Emirates.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-are_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for United Arab Emirates
version: null
vulnerability: null
---
