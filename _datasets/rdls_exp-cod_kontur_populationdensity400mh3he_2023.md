...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-democratic-republic-of-the-congo
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-democratic-republic-of-the-congo
dataset_id: rdls_exp-cod_kontur_populationdensity400mh3he_2023
description: 'Democratic Republic of the Congo population density for 400m H3 hexagons.
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-democratic-republic-of-the-congo]'
...
lineage:
  description: Population density was derived by fusing multiple geospatial datasets
    ...
    allocating population counts to 400m H3 hexagonal grid cells using spatial overlay
    and density estimation techniques. The resulting dataset provides gridded population
    exposure at high spatial resolution for disaster risk assessment in the Democratic
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-democratic-republic-of-the-congo
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Democratic Republic of the Congo: Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CD_20220630.gpkg.gz
  format: null
  id: resource_ea94ec13
  ...
  title: kontur_population_CD_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Democratic Republic of the Congo: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CD_20231101.gpkg.gz
  format: null
  id: resource_c13e5b21
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_CD_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cod_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Democratic Republic of the Congo: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
