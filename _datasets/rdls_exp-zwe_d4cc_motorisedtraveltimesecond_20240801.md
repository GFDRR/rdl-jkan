...
- entity:
    ...
    url: https://data.humdata.org/dataset/zimbabwe-motorised-travel-time-in-seconds-to-nearest-health-centre
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Data for Children Collaborative
  url: https://data.humdata.org/dataset/zimbabwe-motorised-travel-time-in-seconds-to-nearest-health-centre
dataset_id: rdls_exp-zwe_d4cc_motorisedtraveltimesecond_20240801
description: 'A 100 m spatial resolution geotiff of motorised travel time in seconds
  to nearest health facility in Zimbabwe. The data was generated using the Child Poverty
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/zimbabwe-motorised-travel-time-in-seconds-to-nearest-health-centre]'
...
lineage:
  description: Travel time surface generated using the CPAS least cost path method,
    which combines a friction surface representing motorised travel speeds on all-weather/asphalt
    roads and walking speeds on other terrain types, applied to Zimbabwe at 100 m
    spatial resolution to quantify accessibility to health infrastructure.
  sources:
  - id: source_1
    license: null
    name: Child Poverty and Access to Services (CPAS) software
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zimbabwe-motorised-travel-time-in-seconds-to-nearest-health-centre
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  download_url: https://s3.eidf.ac.uk/eidf158-motorised-travel-time-maps/service_area_Zimbabwe_mot.tif
  format: null
  id: resource_22b32b93
  ...
  title: service-area-zimbabwe-motorised.tif
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-zwe_d4cc_motorisedtraveltimesecond_20240801
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-08-01'
temporal_resolution: null
title: Zimbabwe Motorised Travel Time (in seconds) to nearest health centre
version: null
vulnerability: null
---
