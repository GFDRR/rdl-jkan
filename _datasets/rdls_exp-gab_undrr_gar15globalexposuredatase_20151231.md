...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-gabon
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-gabon
dataset_id: rdls_exp-gab_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-gabon]'
...
exposure:
- asset_type:
    description: Economic value of building stock by type and location, derived from
      national capital stock data
    id: buildings
    scheme: null
    title: null
    uri: null
...
- asset_type:
  ...
  - dimension: population
    ...
    measurement:
      ...
      unit: count
- asset_type:
    description: Gross domestic product (GDP) spatially distributed as proxy for economic
      exposure
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Gabon were spatially disaggregated onto 5x5 km and 1x1 km grids using gridded
    population distribution and GDP as spatial proxies. The dataset was developed
    by UNEP-GRID in collaboration with WAPMERR, EU-JRC, and Kokusai Kogyo as part
    of the GAR15 global exposure assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-gabon
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Gabon.zip
  download_url: https://data.humdata.org/dataset/bcc3d20f-4294-4245-b746-adf4f67dc241/resource/083c766c-8472-46df-bbb4-7a090624a00c/download/gab.zip
  format: null
  id: resource_083c766c
  ...
  title: GAR15 Global Exposure Dataset for Gabon.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gab_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Gabon
version: null
vulnerability: null
---
