...
- entity:
    ...
    url: https://data.humdata.org/dataset/mtq-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mtq-rainfall-subnational
dataset_id: rdls_hzd-mtq_wfp_martiniquerainfallindicat_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/mtq-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from Climate Hazards Group InfraRed Precipitation
    satellite imagery integrated with in-situ station observations (CHIRPS v2) and
    supplemented with CHIRPS-GEFS short-term forecasts. Dekadal rainfall indicators
    including 10-day totals, 1-month and 3-month rolling aggregations, and long-term
    averages were computed and aggregated by subnational administrative units in Martinique
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mtq-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135550465438_5d24fad0'
  download_url: https://data.humdata.org/dataset/1b69ef37-10b3-475a-ae50-215ad3ce851e/resource/721f90a9-0e1f-4cc6-8880-22cedf257fab/download/mtq-rainfall-subnat-full.csv
  format: null
  id: resource_721f90a9
  media_type: text/csv
  spatial: null
  ...
  title: mtq-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135550465438_5d24fad0'
  download_url: https://data.humdata.org/dataset/1b69ef37-10b3-475a-ae50-215ad3ce851e/resource/ee323fb2-9fbe-42bf-9c6e-1458a3a00f65/download/mtq-rainfall-subnat-5ytd.csv
  format: null
  id: resource_ee323fb2
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mtq-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mtq_wfp_martiniquerainfallindicat_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Martinique: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
