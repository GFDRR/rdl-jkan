...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/sierra-leone-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/sierra-leone-level-1-exposure-data
dataset_id: rdls_exp-sle_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sierra-leone-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Exposure data was developed through the METEOR project using Earth
    observation routines with minimal country-specific data collection. Building counts,
    areas, and rebuilding values were estimated and gridded at 15-arcsecond resolution
    (approximately 500 meters) to create a Level 1 global-quality exposure dataset
    suitable for catastrophe modeling and risk assessment.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sierra-leone-level-1-exposure-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Sierra Leone produced by
    ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/b471520f-a9d2-49b7-89e0-5c62a041e653/resource/751e8d91-4125-48a2-ab0a-d0c38d8b99c8/download/sle_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_751e8d91
  ...
  title: SLE_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sle_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Sierra Leone: Level 1 Exposure Data'
version: null
vulnerability: null
---
