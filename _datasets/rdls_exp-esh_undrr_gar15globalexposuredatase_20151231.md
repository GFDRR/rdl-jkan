...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-western-sahara
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-western-sahara
dataset_id: rdls_exp-esh_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-western-sahara]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    and GDP as spatial distribution proxies. The dataset was developed collaboratively
    by UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo for the Global Assessment Report
    on Disaster Risk Reduction (GAR15).
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-western-sahara
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Western Sahara.zip
  download_url: https://data.humdata.org/dataset/8ae02e11-be6a-4114-8350-65345f198d41/resource/702e264d-ec36-4892-a55d-a94a3ff8e53a/download/esh.zip
  format: null
  id: resource_702e264d
  ...
  title: GAR15 Global Exposure Dataset for Western Sahara.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-esh_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Western Sahara
version: null
vulnerability: null
---
