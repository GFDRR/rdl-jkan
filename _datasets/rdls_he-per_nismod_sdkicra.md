...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-per_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Peru. Derived from global datasets clipped
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10410892
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10410892
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Peru, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/10410892/files/PER.zip
  format: null
  id: resource_sdkicra_per
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Peru
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-per_nismod_sdkicra
spatial:
  bbox:
  - -81.34
  - -18.34
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3932488/peru.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Peru
version: 0.1.0
vulnerability: null
---
