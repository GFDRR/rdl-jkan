...
creator:
  ...
  name: Chiara Scaini
  url: null
dataset_id: rdls_exp-gfdrr_sfrarrresidential
description: Residential building exposure for Central Asia (Kazakhstan, Kyrgyz Republic,
  Tajikistan, Turkmenistan, Uzbekistan), developed under the SFRARR program as a regionally
  consistent inventory with replacement-cost values for multi-country risk assessment.
...
- asset_type: null
  category: buildings
  id: rdls_exp-gfdrr_sfrarrresidential_exp
  metrics:
  - dimension: structure
    id: rdls_exp-gfdrr_sfrarrresidential_m1
    measurement:
...
resources:
- access_url: https://datacatalog.worldbank.org/search/dataset/0064251
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Central Asia exposure layers - Residential buildings. Files: RESIDENTIAL_[OBLAST].csv,
    RESIDENTIAL_[OBLAST].shp'
  download_url: null
  format: csv
  id: rdls_exp-gfdrr_sfrarrresidential_r1
  media_type: text/csv
  spatial: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gfdrr_sfrarrresidential
spatial:
  bbox:
  - 46.0
  - 34.0
...
temporal: null
temporal_resolution: null
title: Central Asia Exposure - Residential Buildings (SFRARR)
version: '2022'
vulnerability: null
---
