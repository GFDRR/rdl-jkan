...
- entity:
    ...
    url: https://data.humdata.org/dataset/msr-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/msr-ghsl
dataset_id: rdls_exp-msr_copernicus_montserratglobalhumansett_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/msr-ghsl]'
...
lineage:
  description: The GHSL dataset for Montserrat integrates fine-scale satellite imagery
    from Copernicus, census data, and volunteered geographic information through automated
    spatial data processing technologies to produce gridded estimates of built-up
    surfaces and population distribution at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/msr-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/6e6e0f0b-e130-4db1-b366-724be1ec54a8/resource/35c9434c-0678-46d6-b516-bb9457c89ee7/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_msr.tif
  format: null
  id: resource_35c9434c
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Montserrat: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/6e6e0f0b-e130-4db1-b366-724be1ec54a8/resource/51996548-2e93-4775-acf0-6ef670f603f3/download/ghs_pop_e2025_r2023a_54009_100_v1_0_msr.tif
  format: null
  id: resource_51996548
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-msr_copernicus_montserratglobalhumansett_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Montserrat: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
