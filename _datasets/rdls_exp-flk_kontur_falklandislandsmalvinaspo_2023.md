...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-falkland-islands-malvinas
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-falkland-islands-malvinas
dataset_id: rdls_exp-flk_kontur_falklandislandsmalvinaspo_2023
description: 'Falkland Islands (Malvinas) population density for 400m H3 hexagons.
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-falkland-islands-malvinas]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    Kontur Population dataset provides baseline population inventories suitable for
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-falkland-islands-malvinas
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Falkland Islands (Malvinas): Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_FK_20220630.gpkg.gz
  format: null
  id: resource_092eb935
  ...
  title: kontur_population_FK_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Falkland Islands (Malvinas): Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_FK_20231101.gpkg.gz
  format: null
  id: resource_09253915
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_FK_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-flk_kontur_falklandislandsmalvinaspo_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Falkland Islands (Malvinas): Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
