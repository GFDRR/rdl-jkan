...
- entity:
    ...
    url: https://data.humdata.org/dataset/swe-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/swe-ghsl
dataset_id: rdls_exp-swe_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/swe-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution at global scale. The Sweden subset represents the application of
    these global methodologies to national-level human settlement mapping.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/swe-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/8e81a617-2efd-4eea-a28b-d9b304209d21/resource/16ed865e-9778-4511-8d7e-3b0b4610cd34/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_swe.tif
  format: null
  id: resource_16ed865e
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Sweden: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/8e81a617-2efd-4eea-a28b-d9b304209d21/resource/44274e12-e10d-4ba2-a952-ffb361e43df2/download/ghs_pop_e2025_r2023a_54009_100_v1_0_swe.tif
  format: null
  id: resource_44274e12
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-swe_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Sweden: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
