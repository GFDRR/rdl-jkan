...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-maldives
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-maldives
dataset_id: rdls_exp-mdv_kontur_administrativedivisionagg_20220407
description: 'Maldives administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-maldives]'
...
lineage:
  description: Administrative boundaries for Maldives were extracted from OpenStreetMap
    and enriched with aggregated population counts derived from the Kontur Population
    dataset at 400m H3 hexagon resolution. The dataset provides baseline population
    exposure data at administrative division levels, enriched with HASC codes from
    Wikidata.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-maldives
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Maldives: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_MV_20220407.gpkg.gz
  format: null
  id: resource_921f8154
  ...
  title: kontur_boundaries_MV_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Maldives: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_MV_20230628.gpkg.gz
  format: null
  id: resource_4b622160
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_MV_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Maldives: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_MV_20230628.gpkg.gz
  format: null
  id: resource_e0dddd0b
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_MV_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mdv_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Maldives: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
