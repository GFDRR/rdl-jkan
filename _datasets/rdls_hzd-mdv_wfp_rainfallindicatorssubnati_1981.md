...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/mdv-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mdv-rainfall-subnational
dataset_id: rdls_hzd-mdv_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/mdv-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery integrated with
    in-situ station observations, processed into dekadal indicators (10-day rainfall,
    1-month and 3-month rolling aggregations) and compared against long-term averages,
    then aggregated by subnational administrative units in Maldives to support drought
    monitoring.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mdv-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135606596515_ee4687e3'
  download_url: https://data.humdata.org/dataset/6aeb685c-d641-4fe6-af9f-e55f21e33758/resource/8619f899-f128-44f4-93f9-3632eae93567/download/mdv-rainfall-subnat-full.csv
  format: null
  id: resource_8619f899
  media_type: text/csv
  spatial: null
  ...
  title: mdv-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135606596515_ee4687e3'
  download_url: https://data.humdata.org/dataset/6aeb685c-d641-4fe6-af9f-e55f21e33758/resource/51b505bf-d8ea-4482-a187-aa95488630d9/download/mdv-rainfall-subnat-5ytd.csv
  format: null
  id: resource_51b505bf
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mdv-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mdv_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Maldives: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
