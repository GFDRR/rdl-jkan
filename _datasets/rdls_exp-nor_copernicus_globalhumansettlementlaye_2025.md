...
- entity:
    ...
    url: https://data.humdata.org/dataset/nor-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/nor-ghsl
dataset_id: rdls_exp-nor_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/nor-ghsl]'
...
lineage:
  description: The GHSL dataset integrates multi-source geospatial data including
    ...
    of built-up surface area and population distribution at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nor-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/0d3caede-f43d-4f7e-9c04-93248fb17596/resource/e22efb4a-dbdf-42b7-b276-f1df90a3c156/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_nor.tif
  format: null
  id: resource_e22efb4a
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Norway: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/0d3caede-f43d-4f7e-9c04-93248fb17596/resource/3dc1f623-0871-49b3-a068-1a461c321ee6/download/ghs_pop_e2025_r2023a_54009_100_v1_0_nor.tif
  format: null
  id: resource_3dc1f623
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-nor_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Norway: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
