...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-mrt-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-mrt-settlement-extents-v3-0
dataset_id: rdls_exp-mrt_grid3_mrtsettlementextentsv30_2016
description: 'The GRID3 MRT - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Mauritania, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Mauritania Settlement Extents,
  ...
  2024. GRID3 MRT - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-mrt-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents and building counts were derived from open data
    ...
    inventories. The dataset represents settlements as both polygon boundaries and
    3-arc second (~100 meter) grid cell centroids, providing a spatial inventory of
    built-up areas and structures across Mauritania for exposure assessment.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-mrt-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Mauritania - GRID3 MRT - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/f6c4cda0-4fdf-4537-8d39-610f86c13a9e/resource/55f66aed-6bc0-4b59-95c5-5681aa2e3cbe/download/grid3-mrt-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_55f66aed
  ...
  title: GRID3 MRT - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Mauritania - GRID3 MRT - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/f6c4cda0-4fdf-4537-8d39-610f86c13a9e/resource/a6e3ac67-e76e-46ee-a0d3-cbe753be8656/download/grid3_mrt_settlement_extents_v3_0.zip
  format: null
  id: resource_a6e3ac67
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_MRT_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/f6c4cda0-4fdf-4537-8d39-610f86c13a9e/resource/51eeffc3-39c7-429e-946d-dc56203674a6/download/grid3_mrt_settlement_grid_v3_0.zip
  format: null
  id: resource_51eeffc3
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_MRT_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mrt_grid3_mrtsettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Mauritania - GRID3 MRT - Settlement Extents v3.0
version: null
vulnerability: null
---
