...
creator:
  ...
  name: IGAD DRM Team
  url: https://geoportal.icpac.net/api/v2/users/1001
dataset_id: rdls_exp-gha_icpac_ghahospitals
description: 'Shows Hospitals in the East Africa Region Healthsites.io (The Global
...
referenced_by: []
resources:
- access_url: https://geoportal.icpac.net/datasets/geonode:geonode:GHA_HOSPITALS
  baseline_period: null
  climate: null
  conforms_to: http://www.opengis.net/def/serviceType/ogc/wms
  coordinate_system: EPSG:4326
  description: 'GHA_HOSPITALS (OGC WMS: geonode Service)'
  download_url: https://geoportal.icpac.net/geoserver/ows?service=WMS&version=1.1.1&request=GetMap&layers=geonode:geonode:GHA_HOSPITALS&format=image%2Fpng
  format: null
  id: resource_0
...
- access_url: https://geoportal.icpac.net/datasets/geonode:geonode:GHA_HOSPITALS
  ...
  coordinate_system: EPSG:4326
  description: 'GHA_HOSPITALS (OGC WFS: geonode Service)'
  download_url: https://geoportal.icpac.net/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=geonode:geonode:GHA_HOSPITALS&outputFormat=application%2Fjson
  format: null
  id: resource_1
...
- exposure
schema: rdls-10
slug: rdls_exp-gha_icpac_ghahospitals
spatial:
  bbox:
  - 22.1589333
  - -11.289713
