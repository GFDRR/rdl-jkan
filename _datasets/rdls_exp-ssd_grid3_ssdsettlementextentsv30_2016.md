...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-ssd-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-ssd-settlement-extents-v3-0
dataset_id: rdls_exp-ssd_grid3_ssdsettlementextentsv30_2016
description: 'The GRID3 SSD - Settlement Extents v3.0 consists of a geographic representation
  of settlements in South Sudan, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 South Sudan Settlement Extents,
  ...
  2024. GRID3 SSD - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-ssd-settlement-extents-v3-0]'
...
lineage:
  description: 'Settlement extents and building counts were derived from open data
    ...
    at 100-meter resolution. The dataset provides spatial representation of settlements
    in two forms: polygon boundaries and grid cell centroids, with associated building
    count and population attributes for disaster risk exposure assessment.'
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-ssd-settlement-extents-v3-0
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: South Sudan - GRID3 SSD - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/f6d44037-0398-41ad-9a35-e0d6e2d7a27f/resource/4193263c-954b-4a34-b6fa-17b368c0dda6/download/grid3-ssd-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_4193263c
  ...
  title: GRID3 SSD - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: South Sudan - GRID3 SSD - Settlement Extents v3.0 (A spatial layer
    representing settlement polygons)
  download_url: https://data.humdata.org/dataset/f6d44037-0398-41ad-9a35-e0d6e2d7a27f/resource/15cf0b50-ac83-4cd1-b0d5-2559d41f1da8/download/grid3_ssd_settlement_extents_v3_0.zip
  format: null
  id: resource_15cf0b50
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_SSD_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/f6d44037-0398-41ad-9a35-e0d6e2d7a27f/resource/e42048d5-5ab1-4697-9c75-1383c8c8e4ed/download/grid3_ssd_settlement_grid_v3_0.zip
  format: null
  id: resource_e42048d5
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_SSD_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ssd_grid3_ssdsettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: South Sudan - GRID3 SSD - Settlement Extents v3.0
version: null
vulnerability: null
---
