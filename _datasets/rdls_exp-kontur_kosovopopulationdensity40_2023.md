...
- entity:
    ...
    url: https://data.humdata.org/dataset/kosovo-population-density-for-400m-h3-hexagons
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kosovo-population-density-for-400m-h3-hexagons
dataset_id: rdls_exp-kontur_kosovopopulationdensity40_2023
description: 'Kosovo population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kosovo-population-density-for-400m-h3-hexagons]'
...
lineage:
  description: Population density estimates were generated by fusing multiple global
    ...
    counts suitable for baseline risk assessment.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- access_url: null
  ...
  description: 'Serbia - Kosovo: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_XK_20231101.gpkg.gz
  format: null
  id: resource_fe4be8d4
  ...
  title: kontur_population_XK_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kontur_kosovopopulationdensity40_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Serbia - Kosovo: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
