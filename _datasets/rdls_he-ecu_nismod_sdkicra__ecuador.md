...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-ecu_nismod_sdkicra__ecuador
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Ecuador. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540132
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540132
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Ecuador, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540132/files/ECU.zip
  format: null
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Ecuador
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-ecu_nismod_sdkicra__ecuador
spatial:
  bbox:
  - -92.01
  - -5.01
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Ecuador
version: 0.1.0
vulnerability: null
---
