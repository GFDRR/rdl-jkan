...
- entity:
    ...
    url: https://data.humdata.org/dataset/lebanon-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/lebanon-road-surface-data
dataset_id: rdls_exp-lbn_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0517 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0099 and 0.002
  (in million kms), corressponding to 19.1793% and 3.8679% respectively of the total
  road length in the dataset region. 0.0398 million km or 76.9528% of road surface
  ...
  to 0.2769% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lebanon-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    classification using a hybrid deep learning approach to predict paved versus unpaved
    road surfaces. The resulting dataset provides geometric road features with predicted
    surface classes across Lebanon, supporting humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lebanon-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Lebanon: Road Surface Data (GeoJSON data for Lebanon.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lbn_roadsurface_lines.geojson
  format: null
  id: resource_8a852a46
  ...
  title: Lebanon GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Lebanon: Road Surface Data (Geopackage data for Lebanon.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lbn_roadsurface_lines.gpkg
  format: null
  id: resource_fc4097f6
  ...
  temporal: null
  temporal_resolution: null
  title: Lebanon GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lbn_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Lebanon: Road Surface Data'
version: null
vulnerability: null
---
