...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-mmr_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Myanmar. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540127
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540127
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Myanmar, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540127/files/MMR.zip
  format: null
  id: resource_sdkicra_mmr
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Myanmar
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-mmr_nismod_sdkicra
spatial:
  bbox:
  - 92.17
  - 9.79
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/1327865/myanmar.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Myanmar
version: 0.1.0
vulnerability: null
---
