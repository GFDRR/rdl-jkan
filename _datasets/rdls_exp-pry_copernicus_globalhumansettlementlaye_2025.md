...
- entity:
    ...
    url: https://data.humdata.org/dataset/pry-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/pry-ghsl
dataset_id: rdls_exp-pry_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/pry-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distributions. For Paraguay,
    this methodology generates rasterized exposure data representing human settlements
    and population density without hazard or impact components.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pry-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/7bba37fe-0a1b-4e77-9e05-bb9bc8e1cdcb/resource/dda410c7-e11d-4ebf-bf8d-011d4f2a020e/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_pry.tif
  format: null
  id: resource_dda410c7
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Paraguay: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/7bba37fe-0a1b-4e77-9e05-bb9bc8e1cdcb/resource/4ee16b3f-18c7-4edd-8f3d-f2ae1793bb53/download/ghs_pop_e2025_r2023a_54009_100_v1_0_pry.tif
  format: null
  id: resource_4ee16b3f
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-pry_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Paraguay: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
