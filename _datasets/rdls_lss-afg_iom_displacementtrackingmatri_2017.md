...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/afg-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/afg-iom-dtm-from-api
dataset_id: rdls_lss-afg_iom_displacementtrackingmatri_2017
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/afg-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline, emergency event, and site assessments
    ...
    at admin 0, 1, and 2 levels and made publicly available through the DTM API. The
    dataset provides displacement counts disaggregated by sex, displacement reason,
    and origin location.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/afg-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Afghanistan IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/dc1eb6e9-0741-4fb2-98ec-b42da84a409a/resource/bc3fe8eb-af75-4b4c-ac96-9ca9c96e05de/download/afg-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_bc3fe8eb
  media_type: text/csv
  spatial: null
  ...
  title: Afghanistan IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-afg_iom_displacementtrackingmatri_2017
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2017-03-30'
temporal_resolution: null
title: Afghanistan IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
