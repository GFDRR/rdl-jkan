...
- entity:
    ...
    url: https://data.humdata.org/dataset/mrt-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mrt-ndvi-subnational
dataset_id: rdls_hzd-mrt_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mrt-ndvi-subnational]'
...
lineage:
  description: MODIS Aqua and Terra 16-day composite NDVI products (MYD13C1 and MOD13C1)
    ...
    and percentage anomalies (viq) were computed for each administrative unit to support
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mrt-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135652520024_7f20668e'
  download_url: https://data.humdata.org/dataset/3bf3db2e-522c-4ab6-b3dc-4a446195de03/resource/7845385a-0af4-4b15-9ea2-b8291ecf8b63/download/mrt-ndvi-subnat-full.csv
  format: null
  id: resource_7845385a
  media_type: text/csv
  spatial: null
  ...
  title: mrt-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135652520024_7f20668e'
  download_url: https://data.humdata.org/dataset/3bf3db2e-522c-4ab6-b3dc-4a446195de03/resource/fdc4b3e3-d148-4fad-859b-6fa8304e2369/download/mrt-ndvi-subnat-5ytd.csv
  format: null
  id: resource_fdc4b3e3
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mrt-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mrt_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Mauritania: NDVI at Subnational Level'
version: null
vulnerability: null
---
