...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/bra-rainfall-subnational
dataset_id: rdls_hzd-bra_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/bra-rainfall-subnational]'
...
lineage:
  description: Dekadal precipitation estimates are derived by blending CHIRPS v2 satellite
    infrared imagery with in-situ rain gauge observations, then spatially aggregated
    over subnational administrative polygons using pixel-count weighting. Short-term
    forecast indicators are generated from CHIRPS-GEFS ensemble output using the same
    aggregation framework. The resulting dataset provides rolling rainfall totals,
    long-term averages, and anomaly percentiles to support drought monitoring and
    early warning in Brazil.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) v2
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bra-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135426636705_5b8446c2'
  download_url: https://data.humdata.org/dataset/040221b1-3c81-4821-b82c-92326e7eaa65/resource/373e773f-58e3-487e-b219-f566ece64d5e/download/bra-rainfall-subnat-full.csv
  format: null
  id: resource_373e773f
  media_type: text/csv
  spatial: null
  ...
  title: bra-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135426636705_5b8446c2'
  download_url: https://data.humdata.org/dataset/040221b1-3c81-4821-b82c-92326e7eaa65/resource/cf38b7fe-5a02-46de-9689-af88fcdea1a8/download/bra-rainfall-subnat-5ytd.csv
  format: null
  id: resource_cf38b7fe
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: bra-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bra_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
