...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-mwi-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-mwi-settlement-extents-v3-0
dataset_id: rdls_exp-ago_grid3_mwisettlementextentsv30_2016
description: 'The GRID3 MWI - Settlement Extents v3.0 consists of a geographic representation
  ...
  in the codebooks. The current version supersedes GRID3 Malawi Settlement Extents,
  ...
  2024. GRID3 MWI - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-mwi-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents were derived from open data using a new methodology
    ...
    centroids of settled grid cells at 3-arc seconds (~100 meters) resolution within
    settlement boundaries, with probability values and attribute codebooks provided
    for both polygon and grid representations.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-mwi-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Angola - GRID3 MWI - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/fa119d22-fd45-4a9e-9677-6b6e6ff3706c/resource/5f381ac5-3096-443b-ae3b-9609f93e33c0/download/grid3-mwi-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_5f381ac5
  ...
  title: GRID3 MWI - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Angola - GRID3 MWI - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/fa119d22-fd45-4a9e-9677-6b6e6ff3706c/resource/bf820cf8-60e6-477a-b23b-c100f6bfdf51/download/grid3_mwi_settlement_extents_v3_0.zip
  format: null
  id: resource_bf820cf8
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_MWI_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/fa119d22-fd45-4a9e-9677-6b6e6ff3706c/resource/36961edd-61d1-4338-a3d6-da27b7f70790/download/grid3_mwi_settlement_grid_v3_0.zip
  format: null
  id: resource_36961edd
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_MWI_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ago_grid3_mwisettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Angola - GRID3 MWI - Settlement Extents v3.0
version: null
vulnerability: null
---
