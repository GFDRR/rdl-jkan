...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/eth-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/eth-iom-dtm-from-api
dataset_id: rdls_lss-eth_iom_displacementtrackingmatri_2017
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/eth-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced populations across Ethiopia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/eth-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Ethiopia IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/c5f4bf99-63e3-44e5-8847-296751c667e9/resource/0431906c-0476-491f-9938-e047db8c6ea4/download/eth-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_0431906c
  media_type: text/csv
  spatial: null
  ...
  title: Ethiopia IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-eth_iom_displacementtrackingmatri_2017
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2017-12-31'
temporal_resolution: null
title: Ethiopia IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
