...
- entity:
    ...
    url: https://data.humdata.org/dataset/cok-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/cok-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-cok_hdx_cookislandsibtracsstormtr_1919
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cok-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    standardized and quality-controlled. The Cook Islands subset contains all cyclone
    tracks affecting or passing through the region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cok-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1919 to date that pass within 2000 kilometers
    of Cook Islands.
  download_url: https://data.humdata.org/dataset/8b603d84-8e87-42f0-b2d2-883a35563c4e/resource/203fe7ad-6516-4c38-b5a1-13a42341d08a/download/ibtracs_all_list_v04r01_cok.csv
  format: null
  id: resource_203fe7ad
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_COK.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1919 to date that pass within 2000 kilometers
    of Cook Islands.
  download_url: https://data.humdata.org/dataset/8b603d84-8e87-42f0-b2d2-883a35563c4e/resource/86840e14-4059-4590-9385-cab244a7c776/download/ibtracs_all_list_v04r01_lines_cok.geojson
  format: null
  id: resource_86840e14
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_COK.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cok_hdx_cookislandsibtracsstormtr_1919
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1919-05-14'
temporal_resolution: null
title: 'Cook Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
