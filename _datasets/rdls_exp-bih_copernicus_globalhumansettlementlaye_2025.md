...
- entity:
    ...
    url: https://data.humdata.org/dataset/bih-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bih-ghsl
dataset_id: rdls_exp-bih_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bih-ghsl]'
...
lineage:
  description: The GHSL dataset integrates multi-source geospatial data including
    Copernicus satellite imagery, census records, and crowdsourced geographic information
    through automated spatial data processing technologies to produce fine-scale gridded
    estimates of built-up surfaces and population distribution across Bosnia and Herzegovina.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bih-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/8b2f4de5-21a2-4e58-829d-04ba753479c5/resource/76c6cc59-b23d-49e0-95d1-f0246ec30b82/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bih.tif
  format: null
  id: resource_76c6cc59
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Bosnia and Herzegovina: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/8b2f4de5-21a2-4e58-829d-04ba753479c5/resource/617f83c8-e3b4-4c22-bd17-fe060b458656/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bih.tif
  format: null
  id: resource_617f83c8
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-bih_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Bosnia and Herzegovina: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
