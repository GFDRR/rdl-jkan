...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/tun-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/tun-rainfall-subnational
dataset_id: rdls_hzd-tun_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/tun-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    units in Tunisia. Long-term rainfall averages were calculated to enable anomaly
    detection for drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tun-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135801748656_64a34991'
  download_url: https://data.humdata.org/dataset/13ca023e-eb08-48e8-bc3b-ce5844230f57/resource/04f221ff-e326-4b2a-83d3-6280bdf37c9c/download/tun-rainfall-subnat-full.csv
  format: null
  id: resource_04f221ff
  media_type: text/csv
  spatial: null
  ...
  title: tun-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135801748656_64a34991'
  download_url: https://data.humdata.org/dataset/13ca023e-eb08-48e8-bc3b-ce5844230f57/resource/a82e0728-d067-43b5-b51e-4842d44bef05/download/tun-rainfall-subnat-5ytd.csv
  format: null
  id: resource_a82e0728
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: tun-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tun_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Tunisia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
