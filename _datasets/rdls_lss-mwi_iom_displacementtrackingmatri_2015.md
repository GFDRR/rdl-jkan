...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/mwi-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/mwi-iom-dtm-from-api
dataset_id: rdls_lss-mwi_iom_displacementtrackingmatri_2015
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mwi-iom-dtm-from-api]'
...
lineage:
  description: IDP data collected through IOM's DTM assessment framework (Baseline
    Assessment, Emergency Tracking Tool, and Site Assessment methodologies) and aggregated
    via the publicly accessible DTM API at admin 0-2 levels, providing post-displacement
    impact records disaggregated by sex, displacement reason, and origin location.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mwi-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Malawi IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/25b13d96-3a74-4127-9c32-a78503f5b78b/resource/530269ce-bd7e-4f99-b855-11d77abd0310/download/mwi-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_530269ce
  media_type: text/csv
  spatial: null
  ...
  title: Malawi IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-mwi_iom_displacementtrackingmatri_2015
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-03-01'
temporal_resolution: null
title: Malawi IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
