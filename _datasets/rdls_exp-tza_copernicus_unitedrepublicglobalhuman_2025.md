...
- entity:
    ...
    url: https://data.humdata.org/dataset/tza-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/tza-ghsl
dataset_id: rdls_exp-tza_copernicus_unitedrepublicglobalhuman_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/tza-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale, with Tanzania-specific extraction
    provided here.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tza-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/2ce7a024-2bb7-44e5-80d1-3fc9a8174d1d/resource/ff48e8ee-2076-4423-bf14-7af310f9b62d/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_tza.tif
  format: null
  id: resource_ff48e8ee
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'United Republic of Tanzania: Copernicus Global Human Settlement Layer
    (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/2ce7a024-2bb7-44e5-80d1-3fc9a8174d1d/resource/6d726268-cdef-4ab2-8a0f-5062e59d687d/download/ghs_pop_e2025_r2023a_54009_100_v1_0_tza.tif
  format: null
  id: resource_6d726268
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-tza_copernicus_unitedrepublicglobalhuman_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'United Republic of Tanzania: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
