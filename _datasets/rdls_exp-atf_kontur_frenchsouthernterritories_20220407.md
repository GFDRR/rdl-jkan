...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-french-southern-territories
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-french-southern-territories
dataset_id: rdls_exp-atf_kontur_frenchsouthernterritories_20220407
description: 'French Southern Territories administrative division with aggregated
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-french-southern-territories]'
...
exposure:
- asset_type:
    description: Aggregated population counts within administrative divisions derived
      from Kontur Population dataset at 400m H3 hexagon resolution
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Administrative boundaries for French Southern Territories were extracted
    from OpenStreetMap and enriched with aggregated population data from the Kontur
    Population dataset (400m H3 hexagons). The resulting dataset provides administrative
    divisions with integrated population counts, enriched with HASC codes from Wikidata,
    and represents a regional subset of the global Kontur Boundaries dataset.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-french-southern-territories
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'French Southern Territories: Administrative Division with Aggregated
    Population (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_TF_20220407.gpkg.gz
  format: null
  id: resource_5c5d581c
  ...
  title: kontur_boundaries_TF_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'French Southern Territories: Administrative Division with Aggregated
    Population (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_TF_20230628.gpkg.gz
  format: null
  id: resource_07748be2
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_TF_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'French Southern Territories: Administrative Division with Aggregated
    Population (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_TF_20230628.gpkg.gz
  format: null
  id: resource_81268d30
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_TF_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-atf_kontur_frenchsouthernterritories_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'French Southern Territories: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
