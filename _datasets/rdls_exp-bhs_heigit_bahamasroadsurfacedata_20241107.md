...
- entity:
    ...
    url: https://data.humdata.org/dataset/bahamas-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/bahamas-road-surface-data
dataset_id: rdls_exp-bhs_heigit_bahamasroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0133 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0026 and 0.0009
  (in million kms), corressponding to 19.7324% and 6.8144% respectively of the total
  road length in the dataset region. 0.0098 million km or 73.4531% of road surface
  ...
  to 0.5125% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bahamas-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries and attributes were extracted from OpenStreetMap
    for the Bahamas. A hybrid deep learning model was applied to classify road surfaces
    as paved or unpaved, generating predictions for unmapped or uncertain segments.
    The final dataset combines OSM-tagged and AI-predicted surface classifications
    with road attributes (width, lanes, smoothness) to provide comprehensive infrastructure
    exposure data for humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bahamas-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Bahamas: Road Surface Data (GeoJSON data for Bahamas.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bhs_roadsurface_lines.geojson
  format: null
  id: resource_7b3d3387
  ...
  title: Bahamas GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Bahamas: Road Surface Data (Geopackage data for Bahamas.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bhs_roadsurface_lines.gpkg
  format: null
  id: resource_9d932a77
  ...
  temporal: null
  temporal_resolution: null
  title: Bahamas GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bhs_heigit_bahamasroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Bahamas: Road Surface Data'
version: null
vulnerability: null
---
