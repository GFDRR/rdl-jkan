...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-esp_nismod_sdkicra__canary-islands
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Canary Islands. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540028
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540028
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Canary Islands, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16540028/files/ESP.zip
  format: null
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Canary
    Islands
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-esp_nismod_sdkicra__canary-islands
spatial:
  bbox:
  - -18.17
  - 27.64
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Canary Islands
version: 0.1.0
vulnerability: null
---
