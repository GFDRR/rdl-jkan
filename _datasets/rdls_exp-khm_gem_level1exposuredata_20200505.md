...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/cambodia-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/cambodia-level-1-exposure-data
dataset_id: rdls_exp-khm_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cambodia-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    Earth observation routines with minimal country-specific data collection to create
    a global-quality Level 1 exposure dataset. The data was processed and gridded
    at 15-arcsecond resolution (approximately 500 meters) to estimate building counts,
    areas, and rebuilding values for CAT modeling and loss estimation applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cambodia-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Cambodia produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/2e25109f-c9ee-478f-90eb-3e596db5d40d/resource/a9ecb5b7-5814-4b5b-960f-455a92fc5845/download/khm_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_a9ecb5b7
  ...
  title: KHM_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-khm_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Cambodia: Level 1 Exposure Data'
version: null
vulnerability: null
---
