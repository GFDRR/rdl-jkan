...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-mrt_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Mauritania. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540101
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540101
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Mauritania, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16540101/files/MRT.zip
  format: null
  id: resource_sdkicra_mrt
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Mauritania
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-mrt_nismod_sdkicra
spatial:
  bbox:
  - -17.08
  - 14.73
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2378080/mauritania.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Mauritania
version: 0.1.0
vulnerability: null
---
