...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/hti-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/hti-rainfall-subnational
dataset_id: rdls_hzd-hti_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/hti-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    observations, processed into dekadal aggregations and rolling 1-month and 3-month
    accumulations, then aggregated by subnational administrative units with anomalies
    computed relative to long-term climatological averages to characterize meteorological
    drought conditions.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hti-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135538125783_706f84f0'
  download_url: https://data.humdata.org/dataset/d55d711c-d2f9-4eb7-af35-235f3ec5ad27/resource/1ac4ef3c-8ed4-4c4b-8a82-57d567e0665e/download/hti-rainfall-subnat-full.csv
  format: null
  id: resource_1ac4ef3c
  media_type: text/csv
  spatial: null
  ...
  title: hti-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135538125783_706f84f0'
  download_url: https://data.humdata.org/dataset/d55d711c-d2f9-4eb7-af35-235f3ec5ad27/resource/9571f877-cabc-4a6d-ab52-738b04c1d557/download/hti-rainfall-subnat-5ytd.csv
  format: null
  id: resource_9571f877
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: hti-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-hti_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Haiti: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
