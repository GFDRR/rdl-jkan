...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-maldives
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-maldives
dataset_id: rdls_exp-mdv_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-maldives]'
...
exposure:
- asset_type:
    description: Economic value of building stock by type, distributed spatially at
      5x5 km and 1x1 km grid resolution
    id: buildings
    scheme: null
    title: null
    uri: null
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Maldives were transposed onto 5x5 km and 1x1 km gridded layers using geographic
    population distribution and GDP as spatial proxies. The dataset was developed
    collaboratively by UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo as part of the GAR15
    global exposure database initiative.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-maldives
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Maldives.zip
  download_url: https://data.humdata.org/dataset/57073352-d08c-4ea8-b68f-9f08b0cf3d01/resource/86bae5af-7e9a-4a40-87bf-d104a138e9df/download/mdv.zip
  format: null
  id: resource_86bae5af
  ...
  title: GAR15 Global Exposure Dataset for Maldives.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mdv_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Maldives
version: null
vulnerability: null
---
