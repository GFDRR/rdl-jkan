...
- entity:
    ...
    url: https://data.humdata.org/dataset/swz-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/swz-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-swz_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/swz-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Eswatini subset contains observed storm positions,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/swz-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Eswatini.
  download_url: https://data.humdata.org/dataset/30ec8845-f3e1-4c0f-a353-8cd1b2621a0d/resource/ecaaae7d-f546-450f-bfdf-f668357e25bb/download/ibtracs_all_list_v04r01_swz.csv
  format: null
  id: resource_ecaaae7d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SWZ.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Eswatini.
  download_url: https://data.humdata.org/dataset/30ec8845-f3e1-4c0f-a353-8cd1b2621a0d/resource/d1162eec-e1a9-4845-92bb-e60524ff13df/download/ibtracs_all_list_v04r01_lines_swz.geojson
  format: null
  id: resource_d1162eec
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SWZ.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-swz_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'Eswatini: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
