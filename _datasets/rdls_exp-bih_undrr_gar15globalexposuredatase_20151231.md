...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bosnia-and-herzegovina
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bosnia-and-herzegovina
dataset_id: rdls_exp-bih_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bosnia-and-herzegovina]'
...
lineage:
  description: The GAR15 global exposure database applies a top-down approach where
    national-level socio-economic, building type, and capital stock statistics are
    transposed onto 5x5 km and 1x1 km grids using geographic population distribution
    and GDP as spatial proxies. The dataset was developed by UNEP-GRID in collaboration
    with WAPMERR, EU JRC, and Kokusai Kogyo to create a standardized global exposure
    inventory for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bosnia-and-herzegovina
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Bosnia and Herzegovina.zip
  download_url: https://data.humdata.org/dataset/361f71c1-456d-4043-8f97-36844e659617/resource/70d08247-2bb5-42be-855b-004aa4f4b6e5/download/bih.zip
  format: null
  id: resource_70d08247
  ...
  title: GAR15 Global Exposure Dataset for Bosnia and Herzegovina.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bih_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Bosnia and Herzegovina
version: null
vulnerability: null
---
