...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-christmas-island
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-christmas-island
dataset_id: rdls_exp-cxr_kontur_christmasislandadministra_20220407
description: 'Christmas Island administrative division with aggregated population.
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-christmas-island]'
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries for Christmas Island were extracted from
    OpenStreetMap and enhanced with proprietary methods. Population counts were aggregated
    from the Kontur Population dataset (400m H3 hexagons) to administrative division
    level, and enriched with HASC codes from Wikidata.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-christmas-island
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Christmas Island: Administrative Division with Aggregated Population
    (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_CX_20220407.gpkg.gz
  format: null
  id: resource_cf32e5d6
  ...
  title: kontur_boundaries_CX_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Christmas Island: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_CX_20230628.gpkg.gz
  format: null
  id: resource_25f65d86
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_CX_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Christmas Island: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_CX_20230628.gpkg.gz
  format: null
  id: resource_68501d6c
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_CX_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cxr_kontur_christmasislandadministra_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Christmas Island: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
