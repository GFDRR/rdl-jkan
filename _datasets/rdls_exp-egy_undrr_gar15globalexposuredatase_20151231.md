...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-egypt
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-egypt
dataset_id: rdls_exp-egy_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-egypt]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure database for Egypt was developed using a
    top-down approach where national-level socio-economic, building type, and capital
    stock statistics were transposed onto 5x5 km and 1x1 km grids using geographic
    population distribution and GDP as spatial proxies. The dataset integrates inputs
    from multiple international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai Kogyo)
    to estimate economic value and spatial distribution of exposed assets.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-egypt
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Egypt.zip
  download_url: https://data.humdata.org/dataset/f2931a0f-200b-4bbf-8ee3-522f1811409d/resource/fa195ad6-430f-4b50-981d-2a401c9512d8/download/egy.zip
  format: null
  id: resource_fa195ad6
  ...
  title: GAR15 Global Exposure Dataset for Egypt.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-egy_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Egypt
version: null
vulnerability: null
---
