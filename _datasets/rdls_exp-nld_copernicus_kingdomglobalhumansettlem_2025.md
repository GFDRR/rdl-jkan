...
- entity:
    ...
    url: https://data.humdata.org/dataset/nld-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/nld-ghsl
dataset_id: rdls_exp-nld_copernicus_kingdomglobalhumansettlem_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/nld-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distributions. The resulting
    datasets provide spatially explicit exposure information on human settlements
    and infrastructure at national and global scales.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nld-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/8a9f9506-24dd-4bb0-92ca-0287e1aea9c1/resource/95dfe63d-e8f2-4a23-9669-983fd196b5db/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_nld.tif
  format: null
  id: resource_95dfe63d
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Netherlands (Kingdom of the): Copernicus Global Human Settlement Layer
    (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/8a9f9506-24dd-4bb0-92ca-0287e1aea9c1/resource/24636c78-afbb-42c2-ab6a-2efefdcce004/download/ghs_pop_e2025_r2023a_54009_100_v1_0_nld.tif
  format: null
  id: resource_24636c78
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-nld_copernicus_kingdomglobalhumansettlem_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Netherlands (Kingdom of the): Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
