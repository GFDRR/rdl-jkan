...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-french-southern-and-antarctic-territories
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-french-southern-and-antarctic-territories
dataset_id: rdls_exp-atf_kontur_frenchsouthernantarcticte_2023
description: 'French Southern and Antarctic Territories population density for 400m
  H3 hexagons. Built from Kontur Population: Global Population Density for 400m H3
  Hexagons Vector H3 hexagons with population counts at 400m resolution. Fixed up
  fusion of GHSL, Facebook, Microsoft Buildings, Copernicus Global Land Service Land
  Cover, Land Information New Zealand, and OpenStreetMap data.. [Source: This metadata
  record was automatically extracted from the Humanitarian Data Exchange (HDX); Original
  dataset: https://data.humdata.org/dataset/kontur-population-french-southern-and-antarctic-territories]'
...
- asset_type:
    description: Population counts distributed across 400m H3 hexagonal grid cells
      for French Southern and Antarctic Territories
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    and OpenStreetMap) and aggregating the results into 400m H3 hexagonal grid cells
    using the H3 hierarchical spatial indexing system. The methodology integrates
    satellite-derived settlement layers with building footprints and land cover data
    to produce consistent population counts at sub-kilometer resolution for disaster
    risk assessment.
  sources:
  - id: source_1
    license: null
...
- access_url: null
  ...
  description: 'French Southern Territories - French Southern and Antarctic Territories:
    Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TF_20220630.gpkg.gz
  format: null
  id: resource_b49e206f
  ...
  title: kontur_population_TF_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'French Southern Territories - French Southern and Antarctic Territories:
    Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TF_20231101.gpkg.gz
  format: null
  id: resource_bd73dbd6
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_TF_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-atf_kontur_frenchsouthernantarcticte_2023
spatial:
  bbox: null
  centroid: null
  countries:
