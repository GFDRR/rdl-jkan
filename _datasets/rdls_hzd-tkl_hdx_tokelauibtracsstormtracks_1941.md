...
- entity:
    ...
    url: https://data.humdata.org/dataset/tkl-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/tkl-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-tkl_hdx_tokelauibtracsstormtracks_1941
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tkl-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates historical and recent tropical cyclone observations
    ...
    quality-controlled and standardized. The Tokelau subset contains all cyclone tracks
    affecting or passing through the Tokelau region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tkl-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1941 to date that pass within 2000 kilometers
    of Tokelau.
  download_url: https://data.humdata.org/dataset/0fa04e31-aa45-49d4-942e-d8c94925e63d/resource/88409bd9-3f55-4ce6-821f-00c6d7cb06be/download/ibtracs_all_list_v04r01_tkl.csv
  format: null
  id: resource_88409bd9
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_TKL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1941 to date that pass within 2000 kilometers
    of Tokelau.
  download_url: https://data.humdata.org/dataset/0fa04e31-aa45-49d4-942e-d8c94925e63d/resource/72f882d7-ac1d-4d95-a347-ce7338bb645b/download/ibtracs_all_list_v04r01_lines_tkl.geojson
  format: null
  id: resource_72f882d7
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_TKL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tkl_hdx_tokelauibtracsstormtracks_1941
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1941-01-13'
temporal_resolution: null
title: 'Tokelau: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
