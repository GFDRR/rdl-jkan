...
- entity:
    ...
    url: https://data.humdata.org/dataset/fsm-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/fsm-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-fsm_hdx_micronesiafederatedstates_1884
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/fsm-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Micronesia subset
    contains historical and recent storm tracks with ISO-formatted timestamps, basin/subbasin
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fsm-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1884 to date that pass within 2000 kilometers
    of Micronesia (Federated States of).
  download_url: https://data.humdata.org/dataset/48680168-2cfb-4fdf-8004-867c3b49612b/resource/ef146eb7-8dde-4fa9-a9bb-1707d90c75da/download/ibtracs_all_list_v04r01_fsm.csv
  format: null
  id: resource_ef146eb7
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_FSM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1884 to date that pass within 2000 kilometers
    of Micronesia (Federated States of).
  download_url: https://data.humdata.org/dataset/48680168-2cfb-4fdf-8004-867c3b49612b/resource/2fffa88e-50fd-4a46-bfa3-61375a425333/download/ibtracs_all_list_v04r01_lines_fsm.geojson
  format: null
  id: resource_2fffa88e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_FSM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-fsm_hdx_micronesiafederatedstates_1884
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1884-06-24'
temporal_resolution: null
title: 'Micronesia (Federated States of): IBTrACS Storm Tracks'
version: null
vulnerability: null
---
