...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/ssd-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/ssd-iom-dtm-from-api
dataset_id: rdls_lss-ssd_iom_displacementtrackingmatri_2014
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ssd-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline, emergency event, and site assessments
    to track internally displaced populations across South Sudan. Data is aggregated
    at admin 0-2 levels with demographic disaggregation (male/female) and displacement
    reason classification, then published via the DTM API for humanitarian and research
    use.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ssd-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: South Sudan IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/ebf32c89-3f27-445d-9ed1-248dca3c348a/resource/bf8fa617-99c8-498d-a5f6-e4e00176ad20/download/ssd-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_bf8fa617
  media_type: text/csv
  spatial: null
  ...
  title: South Sudan IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-ssd_iom_displacementtrackingmatri_2014
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2014-02-28'
temporal_resolution: null
title: South Sudan IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
