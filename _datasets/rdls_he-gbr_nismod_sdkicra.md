...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-gbr_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for United Kingdom. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540052
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540052
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    United Kingdom, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16540052/files/GBR.zip
  format: null
  id: resource_sdkicra_gbr
...
- exposure
schema: rdls-10
slug: rdls_he-gbr_nismod_sdkicra
spatial:
  bbox:
  - -13.69
  - 49.91
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2635167/united-kingdom.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for United Kingdom
version: 0.1.0
vulnerability: null
---
