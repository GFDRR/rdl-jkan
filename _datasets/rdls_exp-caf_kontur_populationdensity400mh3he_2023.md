...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-central-african-republic
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-central-african-republic
dataset_id: rdls_exp-caf_kontur_populationdensity400mh3he_2023
description: 'Central African Republic population density for 400m H3 hexagons. Built
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-central-african-republic]'
...
lineage:
  description: Population density was estimated by fusing multiple satellite-derived
    settlement layers (GHSL, HRSL, Microsoft Buildings) with land cover data and OpenStreetMap
    features, then aggregated to 400m H3 hexagonal grid cells using a fixed methodology
    to create consistent global population distribution estimates.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-central-african-republic
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Central African Republic: Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CF_20220630.gpkg.gz
  format: null
  id: resource_abd2e03e
  ...
  title: kontur_population_CF_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Central African Republic: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CF_20231101.gpkg.gz
  format: null
  id: resource_52cf866a
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_CF_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-caf_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Central African Republic: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
