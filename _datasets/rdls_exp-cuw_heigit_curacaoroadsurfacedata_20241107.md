...
- entity:
    ...
    url: https://data.humdata.org/dataset/curacao-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/curacao-road-surface-data
dataset_id: rdls_exp-cuw_heigit_curacaoroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/curacao-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    ...
    vs unpaved road surfaces, generating predicted surface classes and lengths for
    each road segment. Results are provided in GeoJSON and GeoPackage formats with
    both OSM-derived and predicted attributes.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/curacao-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: "Cura\xE7ao: Road Surface Data (GeoJSON data for Cura\xE7ao.)"
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_cuw_roadsurface_lines.geojson
  format: null
  id: resource_abbec673
  ...
  title: "Cura\xE7ao GeoJSON Resource"
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: "Cura\xE7ao: Road Surface Data (Geopackage data for Cura\xE7ao.)"
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_cuw_roadsurface_lines.gpkg
  format: null
  id: resource_1e2acb2e
  ...
  temporal: null
  temporal_resolution: null
  title: "Cura\xE7ao GeoPackage Resource"
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cuw_heigit_curacaoroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: "Cura\xE7ao: Road Surface Data"
version: null
vulnerability: null
---
