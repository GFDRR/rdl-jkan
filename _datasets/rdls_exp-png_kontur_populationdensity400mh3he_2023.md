...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-papua-new-guinea
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-papua-new-guinea
dataset_id: rdls_exp-png_kontur_populationdensity400mh3he_2023
description: 'Papua New Guinea population density for 400m H3 hexagons. Built from
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-papua-new-guinea]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    building footprints and land cover data to estimate population counts per hexagon,
    providing a baseline population exposure dataset for Papua New Guinea.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-papua-new-guinea
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Papua New Guinea: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PG_20220630.gpkg.gz
  format: null
  id: resource_cecb4f32
  ...
  title: kontur_population_PG_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Papua New Guinea: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PG_20231101.gpkg.gz
  format: null
  id: resource_d04f7abc
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_PG_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-png_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Papua New Guinea: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
