...
- entity:
    ...
    url: https://data.humdata.org/dataset/abw-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/abw-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-abw_hdx_arubaibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/abw-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    Track positions, wind speeds (WMO 10-minute sustained), and central pressures
    are recorded at regular time intervals. Data for Aruba (ABW) is extracted from
    the global IBTrACS archive as point and line geometries.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/abw-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Aruba.
  download_url: https://data.humdata.org/dataset/d13979c0-1d78-45fb-a6bb-504a6b1b5e0a/resource/809cac2f-1698-40cb-9210-621da5bd54ef/download/ibtracs_all_list_v04r01_abw.csv
  format: null
  id: resource_809cac2f
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ABW.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Aruba.
  download_url: https://data.humdata.org/dataset/d13979c0-1d78-45fb-a6bb-504a6b1b5e0a/resource/e9407d71-2ce8-447e-ad65-55d3d4d7341c/download/ibtracs_all_list_v04r01_lines_abw.geojson
  format: null
  id: resource_e9407d71
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ABW.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-abw_hdx_arubaibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-29'
temporal_resolution: null
title: 'Aruba: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
