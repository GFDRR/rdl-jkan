...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/fji-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/fji-iom-dtm-from-api
dataset_id: rdls_lss-fji_iom_displacementtrackingmatri_2016
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/fji-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through field assessments and tracking
    mechanisms at baseline, emergency event, and site assessment levels. Data is aggregated
    at country, Admin 1, and Admin 2 levels and made available through a public API
    for humanitarian analysis of internally displaced populations.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fji-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Fiji IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/fd7a8e93-0924-4002-8401-16a7ea862da2/resource/556c6591-126a-4977-9866-6b94d4a20691/download/fji-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_556c6591
  media_type: text/csv
  spatial: null
  ...
  title: Fiji IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-fji_iom_displacementtrackingmatri_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-03-01'
temporal_resolution: null
title: Fiji IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
