...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-iraq
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-iraq
dataset_id: rdls_exp-irq_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-iraq]'
...
lineage:
  description: The GAR15 global exposure database for Iraq was developed using a top-down
    approach where national-level statistical data on socio-economic indicators, building
    types, and capital stock were spatially distributed onto 5x5 km and 1x1 km grids
    using geographic population density and GDP as spatial proxies. The dataset integrates
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-iraq
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Iraq.zip
  download_url: https://data.humdata.org/dataset/5c4c57da-bfe0-43f2-8d0c-16a43257778c/resource/3fcd63a1-ac0f-4608-90dc-984c49c12368/download/irq.zip
  format: null
  id: resource_3fcd63a1
  ...
  title: GAR15 Global Exposure Dataset for Iraq.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-irq_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Iraq
version: null
vulnerability: null
---
