...
- entity:
    ...
    url: https://data.humdata.org/dataset/zambia-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/zambia-level-1-exposure-data
dataset_id: rdls_exp-zmb_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/zambia-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was derived through the METEOR project using
    earth observation routines to estimate building inventories, areas, and reconstruction
    costs at 15-arcsecond grid resolution (~500m). The dataset was developed with
    minimal country-specific data collection and is intended for catastrophe modeling
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zambia-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Zambia produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/6dd5716d-b4d1-489c-800c-65b0dcb93b46/resource/e7f76c1c-6449-4e62-b238-cdc16ce23bec/download/zmb_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_e7f76c1c
  ...
  title: ZMB_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-zmb_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Zambia: Level 1 Exposure Data'
version: null
vulnerability: null
---
