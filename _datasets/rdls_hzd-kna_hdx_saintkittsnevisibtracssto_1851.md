...
- entity:
    ...
    url: https://data.humdata.org/dataset/kna-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/kna-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-kna_hdx_saintkittsnevisibtracssto_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kna-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. For Saint Kitts and Nevis, track points are georeferenced
    with ISO timestamps, wind speeds (wmo_wind in m/s), and central pressure (wmo_pres)
    to characterize cyclone hazard exposure.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kna-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/250f4887-00f8-48b4-8c99-44c6541c5105/resource/adb37270-d788-4269-869b-683208227e71/download/ibtracs_all_list_v04r01_kna.csv
  format: null
  id: resource_adb37270
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_KNA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Saint Kitts and Nevis.
  download_url: https://data.humdata.org/dataset/250f4887-00f8-48b4-8c99-44c6541c5105/resource/19a40d6e-a615-419d-bf4e-f6856e1fe1a0/download/ibtracs_all_list_v04r01_lines_kna.geojson
  format: null
  id: resource_19a40d6e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_KNA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-kna_hdx_saintkittsnevisibtracssto_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Saint Kitts and Nevis: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
