...
- entity:
    ...
    url: https://data.humdata.org/dataset/pri-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/pri-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-pri_hdx_puertoricoibtracsstormtra_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/pri-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    standardized and quality-controlled. The Puerto Rico subset contains all cyclone
    tracks affecting or passing through the region with temporal resolution at observation
    times.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pri-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Puerto Rico.
  download_url: https://data.humdata.org/dataset/e8b610c6-b1f5-468a-a5e2-89a5b2d84f4f/resource/aca41995-a59c-438b-a048-ea4f0263044d/download/ibtracs_all_list_v04r01_pri.csv
  format: null
  id: resource_aca41995
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PRI.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Puerto Rico.
  download_url: https://data.humdata.org/dataset/e8b610c6-b1f5-468a-a5e2-89a5b2d84f4f/resource/ae0fd0c4-ece1-4745-a2a4-9a8268b04388/download/ibtracs_all_list_v04r01_lines_pri.geojson
  format: null
  id: resource_ae0fd0c4
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PRI.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-pri_hdx_puertoricoibtracsstormtra_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-29'
temporal_resolution: null
title: 'Puerto Rico: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
