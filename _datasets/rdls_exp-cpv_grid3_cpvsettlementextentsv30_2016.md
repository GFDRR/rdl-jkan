...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-cpv-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-cpv-settlement-extents-v3-0
dataset_id: rdls_exp-cpv_grid3_cpvsettlementextentsv30_2016
description: 'The GRID3 CPV - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Cabo Verde, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Cabo Verde Settlement Extents,
  ...
  2024. GRID3 CPV - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-cpv-settlement-extents-v3-0]'
...
- asset_type:
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: count
- asset_type:
    description: Spatial distribution of settled population represented as grid cell
      centroids within settlement extents
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Settlement extents and building counts were derived from open data
    ...
    densities at 3-arc second (~100 meter) grid resolution. Spatial points represent
    centroids of settled grid cells within validated settlement polygons, providing
    a geographic inventory of human settlements and structures across Cabo Verde.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-cpv-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Cabo Verde - GRID3 CPV - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/1050251a-7369-42a3-9534-c60ff992b9c8/resource/055b4b5d-43a1-4317-aae1-40485d337521/download/grid3-cpv-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_055b4b5d
  ...
  title: GRID3 CPV - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Cabo Verde - GRID3 CPV - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/1050251a-7369-42a3-9534-c60ff992b9c8/resource/d2ff8f36-428a-4567-bf65-ac28c1608c8c/download/grid3_cpv_settlement_extents_v3_0.zip
  format: null
  id: resource_d2ff8f36
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_CPV_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/1050251a-7369-42a3-9534-c60ff992b9c8/resource/a974ce9c-3ea4-4216-9d00-2005d988af1f/download/grid3_cpv_settlement_grid_v3_0.zip
  format: null
  id: resource_a974ce9c
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_CPV_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cpv_grid3_cpvsettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Cabo Verde - GRID3 CPV - Settlement Extents v3.0
version: null
vulnerability: null
---
