...
- entity:
    ...
    url: https://data.humdata.org/dataset/guyana-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/guyana-road-surface-data
dataset_id: rdls_exp-guy_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0157 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0013 and 0.0039
  (in million kms), corressponding to 8.1637% and 25.1713% respectively of the total
  road length in the dataset region. 0.0105 million km or 66.665% of road surface
  ...
  to 0.4934% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/guyana-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model predictions were integrated with OSM attributes to create a comprehensive
    road surface inventory for Guyana, enabling assessment of infrastructure accessibility
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guyana-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Guyana: Road Surface Data (GeoJSON data for Guyana.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_guy_roadsurface_lines.geojson
  format: null
  id: resource_2982b1c3
  ...
  title: Guyana GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Guyana: Road Surface Data (Geopackage data for Guyana.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_guy_roadsurface_lines.gpkg
  format: null
  id: resource_925de3e5
  ...
  temporal: null
  temporal_resolution: null
  title: Guyana GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-guy_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Guyana: Road Surface Data'
version: null
vulnerability: null
---
