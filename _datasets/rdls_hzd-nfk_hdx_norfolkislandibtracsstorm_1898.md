...
- entity:
    ...
    url: https://data.humdata.org/dataset/nfk-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/nfk-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-nfk_hdx_norfolkislandibtracsstorm_1898
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nfk-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. Track positions, wind
    speeds (wmo_wind), and central pressures (wmo_pres) are recorded at regular time
    intervals in ISO format. The dataset provides observed hazard characteristics
    for Norfolk Island tropical cyclones.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nfk-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1898 to date that pass within 2000 kilometers
    of Norfolk Island.
  download_url: https://data.humdata.org/dataset/d9870584-9821-456c-8314-7be6779df5fa/resource/d229b647-a562-492b-bb25-6f433bc2d9af/download/ibtracs_all_list_v04r01_nfk.csv
  format: null
  id: resource_d229b647
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NFK.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1898 to date that pass within 2000 kilometers
    of Norfolk Island.
  download_url: https://data.humdata.org/dataset/d9870584-9821-456c-8314-7be6779df5fa/resource/be31e492-3f17-41fd-a202-9df8de52c4bb/download/ibtracs_all_list_v04r01_lines_nfk.geojson
  format: null
  id: resource_be31e492
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NFK.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nfk_hdx_norfolkislandibtracsstorm_1898
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1898-02-02'
temporal_resolution: null
title: 'Norfolk Island: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
