...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-col_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Colombia. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10410814
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10410814
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Colombia, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/10410814/files/COL.zip
  format: null
  id: resource_sdkicra_col
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Colombia
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-col_nismod_sdkicra
spatial:
  bbox:
  - -81.72
  - -4.24
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Colombia
version: 0.1.0
vulnerability: null
---
