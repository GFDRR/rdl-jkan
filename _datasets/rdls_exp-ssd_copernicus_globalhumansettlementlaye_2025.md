...
- entity:
    ...
    url: https://data.humdata.org/dataset/ssd-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/ssd-ghsl
dataset_id: rdls_exp-ssd_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ssd-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite image data streams with
    ...
    area and population distribution at global scale, applied here to South Sudan.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ssd-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/f021ca57-fedb-49af-9ceb-bba054bd3a32/resource/6ae6d8da-ce48-474b-878f-46d687b6db17/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_ssd.tif
  format: null
  id: resource_6ae6d8da
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'South Sudan: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/f021ca57-fedb-49af-9ceb-bba054bd3a32/resource/40238f41-9038-4e23-b1ff-c23c40474bb3/download/ghs_pop_e2025_r2023a_54009_100_v1_0_ssd.tif
  format: null
  id: resource_40238f41
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-ssd_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'South Sudan: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
