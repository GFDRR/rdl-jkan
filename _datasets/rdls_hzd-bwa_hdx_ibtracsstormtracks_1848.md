...
- entity:
    ...
    url: https://data.humdata.org/dataset/bwa-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bwa-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bwa_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bwa-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Botswana
    ...
    geographically for the country.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bwa-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Botswana.
  download_url: https://data.humdata.org/dataset/545360ab-772d-4e76-9ac0-d6a89e977c9c/resource/f94efc3f-0961-4b27-84d5-a588c6ab2667/download/ibtracs_all_list_v04r01_bwa.csv
  format: null
  id: resource_f94efc3f
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BWA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Botswana.
  download_url: https://data.humdata.org/dataset/545360ab-772d-4e76-9ac0-d6a89e977c9c/resource/5d8ab832-f54a-42e9-bb48-cbe0be91bf13/download/ibtracs_all_list_v04r01_lines_bwa.geojson
  format: null
  id: resource_5d8ab832
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BWA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bwa_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'Botswana: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
