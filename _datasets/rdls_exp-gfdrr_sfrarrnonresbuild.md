...
creator:
  ...
  name: Chiara Scaini
  url: null
dataset_id: rdls_exp-gfdrr_sfrarrnonresbuild
description: Non-residential building exposure (education, healthcare, industrial
  and commercial) for Central Asia (Kazakhstan, Kyrgyz Republic, Tajikistan, Turkmenistan,
  Uzbekistan), developed under the SFRARR program as a regionally consistent inventory
  with replacement-cost values for multi-country risk assessment.
...
- asset_type: null
  category: buildings
  id: rdls_exp-gfdrr_sfrarrnonresbuild_exp
  metrics:
  - dimension: structure
    id: rdls_exp-gfdrr_sfrarrnonresbuild_m1
    measurement:
...
- exposure
schema: rdls-10
slug: rdls_exp-gfdrr_sfrarrnonresbuild
spatial:
  bbox:
  - 46.0
  - 34.0
...
temporal: null
temporal_resolution: null
title: Central Asia Exposure - Non-Residential Buildings (SFRARR)
version: '2022'
vulnerability: null
---
