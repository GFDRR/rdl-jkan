...
- entity:
    ...
    url: https://data.humdata.org/dataset/and-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/and-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-and_hdx_andorraibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/and-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Andorra subset contains observed storm positions, wind speeds (wmo_wind), and
    central pressure (wmo_pres) recorded at regular time intervals in ISO format,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/and-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Andorra.
  download_url: https://data.humdata.org/dataset/e474dd46-e807-4051-b299-08630a17d91f/resource/bc706500-4190-463d-b47c-f22aff44b530/download/ibtracs_all_list_v04r01_and.csv
  format: null
  id: resource_bc706500
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_AND.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Andorra.
  download_url: https://data.humdata.org/dataset/e474dd46-e807-4051-b299-08630a17d91f/resource/aaff396a-3a30-4453-a09f-ef445e5822b6/download/ibtracs_all_list_v04r01_lines_and.geojson
  format: null
  id: resource_aaff396a
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_AND.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-and_hdx_andorraibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Andorra: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
