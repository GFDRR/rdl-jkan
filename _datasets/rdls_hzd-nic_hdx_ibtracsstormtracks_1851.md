...
- entity:
    ...
    url: https://data.humdata.org/dataset/nic-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/nic-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-nic_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nic-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Nicaragua subset
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nic-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Nicaragua.
  download_url: https://data.humdata.org/dataset/6a34e292-8ba6-41cb-ae02-062d1da6d8e6/resource/458131fd-0020-486f-a3ef-40da2ca7e8f2/download/ibtracs_all_list_v04r01_nic.csv
  format: null
  id: resource_458131fd
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NIC.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Nicaragua.
  download_url: https://data.humdata.org/dataset/6a34e292-8ba6-41cb-ae02-062d1da6d8e6/resource/5d192c53-1f76-431b-a5a1-651086b587a2/download/ibtracs_all_list_v04r01_lines_nic.geojson
  format: null
  id: resource_5d192c53
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NIC.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nic_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Nicaragua: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
