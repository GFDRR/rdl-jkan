...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lao-peoples-democratic-republic
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lao-peoples-democratic-republic
dataset_id: rdls_exp-lao_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lao-peoples-democratic-republic]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    were transposed onto 5x5 km and 1x1 km gridded layers using gridded population
    data and GDP as spatial proxies. The dataset was developed by UNEP-GRID for the
    Global Assessment Report 2015 (GAR15) with multi-agency collaboration to create
    a spatially-distributed exposure inventory for Lao PDR.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-lao-peoples-democratic-republic
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Lao People's Democratic Republic.zip
  download_url: https://data.humdata.org/dataset/fd3bf436-cf2e-4c82-bbc9-c05b428aa78d/resource/10cee4e3-7882-479d-a54b-7e6fb3eee487/download/lao.zip
  format: null
  id: resource_10cee4e3
  ...
  title: GAR15 Global Exposure Dataset for Lao People's Democratic Republic.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lao_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Lao People's Democratic Republic
version: null
vulnerability: null
---
