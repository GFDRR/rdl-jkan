...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-monaco
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-monaco
dataset_id: rdls_exp-mco_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-monaco]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    on Disaster Risk Reduction (GAR15) to create a globally consistent exposure inventory
    for risk assessment.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-monaco
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Monaco.zip
  download_url: https://data.humdata.org/dataset/ba98a5f2-a5ea-4475-ae70-83fe81bdeb4b/resource/039f8495-c46f-4c45-8b55-5f8d2b8f7392/download/mco.zip
  format: null
  id: resource_039f8495
  ...
  title: GAR15 Global Exposure Dataset for Monaco.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mco_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Monaco
version: null
vulnerability: null
---
