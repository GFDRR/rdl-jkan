...
creator:
  ...
  name: German Aerospace Center (DLR)
  url: www.dlr.de/eoc/en/desktopdefault.aspx/tabid-9628/16557_read-40454/
dataset_id: rdls_exp-crstac_globalurbanfootprintguf_04arcseconds
description: 'Binary settlement mask at 0.4 arc seconds resolution [Source: This metadata
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/exposure-vulnerability/land-use/global-urban-footprint-guf/04-arc-seconds/04-arc-seconds.json
  ...
  title: 'STAC Item: Global Urban Footprint (GUF) - 0.4 arc seconds'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Global Urban Footprint (GUF) - 0.4 arc seconds (www.dlr.de/eoc/en/desktopdefault.aspx/tabid-9628/16557_read-40454/)
...
- access_url: https://doi.org/10.1016/j.isprsjprs.2017.10.012
  ...
  conforms_to: null
  coordinate_system: null
  description: Global Urban Footprint (GUF) - 0.4 arc seconds (Web reference)
  download_url: null
...
- exposure
schema: rdls-10
slug: rdls_exp-crstac_globalurbanfootprintguf_04arcseconds
spatial:
  bbox:
  - -180.0
  - -90.0
...
temporal:
  ...
  start: '2012'
temporal_resolution: null
title: Global Urban Footprint (GUF) - 0.4 arc seconds
version: null
vulnerability: null
---
