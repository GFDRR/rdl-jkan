...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-viet-nam
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-viet-nam
dataset_id: rdls_exp-vnm_kontur_administrativedivisionagg_20220407
description: 'Viet Nam administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-viet-nam]'
...
lineage:
  description: Administrative boundaries for Vietnam were extracted from OpenStreetMap
    and enriched with aggregated population data from the Kontur Population dataset
    (400m H3 hexagons). Population values were spatially aggregated to each administrative
    division boundary, and HASC codes were added from Wikidata to create a baseline
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-viet-nam
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Viet Nam: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_VN_20220407.gpkg.gz
  format: null
  id: resource_507adbbb
  ...
  title: kontur_boundaries_VN_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Viet Nam: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_VN_20230628.gpkg.gz
  format: null
  id: resource_4afdf61f
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_VN_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Viet Nam: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_VN_20230628.gpkg.gz
  format: null
  id: resource_df265f90
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_VN_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vnm_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Viet Nam: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
