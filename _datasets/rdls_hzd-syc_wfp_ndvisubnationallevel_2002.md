...
- entity:
    ...
    url: https://data.humdata.org/dataset/syc-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/syc-ndvi-subnational
dataset_id: rdls_hzd-syc_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/syc-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    were integrated into 8-day synthetic NDVI products, then aggregated by WFP sub-national
    administrative units to produce dekadal NDVI indicators including 10-day NDVI
    values, long-term averages, and percentage anomalies for agricultural drought
    monitoring in Seychelles.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS) Collection 6.1
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/syc-ndvi-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135606472198_0b379a13'
  download_url: https://data.humdata.org/dataset/c5791b35-c767-4641-b781-04215a241525/resource/590a8acb-a572-4d0a-9c26-691b0dbe7565/download/syc-ndvi-subnat-full.csv
  format: null
  id: resource_590a8acb
  media_type: text/csv
  spatial: null
  ...
  title: syc-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135606472198_0b379a13'
  download_url: https://data.humdata.org/dataset/c5791b35-c767-4641-b781-04215a241525/resource/bd782a85-4ab9-40c4-ba08-8ff8a7d9d2c6/download/syc-ndvi-subnat-5ytd.csv
  format: null
  id: resource_bd782a85
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: syc-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-syc_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Seychelles: NDVI at Subnational Level'
version: null
vulnerability: null
---
