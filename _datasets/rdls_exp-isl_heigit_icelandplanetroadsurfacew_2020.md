...
- entity:
    ...
    url: https://data.humdata.org/dataset/iceland-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/iceland-planet-road-surface-data
dataset_id: rdls_exp-isl_heigit_icelandplanetroadsurfacew_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ surface conditions in many regions. Summary of Road Statistics Approximately 0.009\
  \ million km of arterial roads are mapped in OSM in this region. - Paved roads:\
  \ 0.0079 million km (87.8621%) - Unpaved roads: 0.0001 million km (0.776%) - Missing\
  \ OSM surface tags: 0.0 million km (0.4626%) - PlanetScope predictions cover: 0.008\
  \ million km (19162.691%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/iceland-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Iceland. Deep learning models were applied to PlanetScope satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/iceland-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Iceland: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Iceland)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_IS_planet_roadsurface_lines.geojson
  format: null
  id: resource_3d02c878
  ...
  title: Iceland GeoJSON heigit_IS_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Iceland: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Iceland)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_IS_planet_roadsurface_lines.gpkg
  format: null
  id: resource_6848f576
  ...
  temporal: null
  temporal_resolution: null
  title: Iceland GPKG heigit_IS_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-isl_heigit_icelandplanetroadsurfacew_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Iceland: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
