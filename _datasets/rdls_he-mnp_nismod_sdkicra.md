...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-mnp_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Northern Mariana Islands. Derived from
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796564
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796564
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Northern Mariana Islands, clipped from global sources. Contents: (1) Hazard -
  ...
  download_url: https://zenodo.org/records/10796564/files/MNP.zip
  format: null
  id: resource_sdkicra_mnp
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Northern
    Mariana Islands
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-mnp_nismod_sdkicra
spatial:
  bbox:
  - 144.9
  - 14.11
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/4041468/northern-mariana-islands.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Northern
  Mariana Islands
version: 0.1.0
vulnerability: null
---
