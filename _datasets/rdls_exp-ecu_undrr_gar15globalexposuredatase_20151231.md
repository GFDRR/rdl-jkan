...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ecuador
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ecuador
dataset_id: rdls_exp-ecu_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ecuador]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    and GDP as spatial distribution proxies. The dataset was developed by UNEP-GRID
    for the Global Assessment Report on Disaster Risk Reduction (GAR15) through multi-agency
    collaboration to create a globally consistent exposure database for Ecuador.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ecuador
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Ecuador.zip
  download_url: https://data.humdata.org/dataset/fa22e310-a99e-455d-856e-720956279a09/resource/fad2c429-7b20-4920-adce-1b5c52acfbbd/download/ecu.zip
  format: null
  id: resource_fad2c429
  ...
  title: GAR15 Global Exposure Dataset for Ecuador.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ecu_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Ecuador
version: null
vulnerability: null
---
