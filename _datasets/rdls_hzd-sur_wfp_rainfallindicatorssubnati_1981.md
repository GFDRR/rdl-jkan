...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/sur-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/sur-rainfall-subnational
dataset_id: rdls_hzd-sur_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/sur-rainfall-subnational]'
...
lineage:
  description: Rainfall data are derived from CHIRPS satellite observations merged
    ...
    Long-term climatological averages and quantile-based anomalies are computed to
    enable drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sur-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135738134276_bb120004'
  download_url: https://data.humdata.org/dataset/837e1b62-9006-4662-8835-67f766f8ac79/resource/cf97d75f-b2b2-4011-93a1-0bda43213b9b/download/sur-rainfall-subnat-full.csv
  format: null
  id: resource_cf97d75f
  media_type: text/csv
  spatial: null
  ...
  title: sur-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135738134276_bb120004'
  download_url: https://data.humdata.org/dataset/837e1b62-9006-4662-8835-67f766f8ac79/resource/45d91a28-fa2f-4696-8956-8fa65f498640/download/sur-rainfall-subnat-5ytd.csv
  format: null
  id: resource_45d91a28
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: sur-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-sur_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Suriname: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
