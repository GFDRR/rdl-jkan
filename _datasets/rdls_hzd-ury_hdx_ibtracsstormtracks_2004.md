...
- entity:
    ...
    url: https://data.humdata.org/dataset/ury-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ury-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ury_hdx_ibtracsstormtracks_2004
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ury-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    at regular time intervals and filtered for Uruguay's geographic domain. The dataset
    provides observed storm characteristics suitable for hazard characterization.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ury-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 2004 to date that pass within 2000 kilometers
    of Uruguay.
  download_url: https://data.humdata.org/dataset/e63719bb-066d-4b66-8e20-ecacb3437c47/resource/ecb6f137-d339-43b1-9c8c-a444f665eb79/download/ibtracs_all_list_v04r01_ury.csv
  format: null
  id: resource_ecb6f137
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_URY.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 2004 to date that pass within 2000 kilometers
    of Uruguay.
  download_url: https://data.humdata.org/dataset/e63719bb-066d-4b66-8e20-ecacb3437c47/resource/8ec742e4-e365-47b4-9224-c28843bf9fc6/download/ibtracs_all_list_v04r01_lines_ury.geojson
  format: null
  id: resource_8ec742e4
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_URY.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ury_hdx_ibtracsstormtracks_2004
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2004-03-25'
temporal_resolution: null
title: 'Uruguay: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
