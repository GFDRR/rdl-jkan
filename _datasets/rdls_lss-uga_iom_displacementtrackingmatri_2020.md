...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/uga-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/uga-iom-dtm-from-api
dataset_id: rdls_lss-uga_iom_displacementtrackingmatri_2020
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/uga-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced persons across Uganda at
    admin 0-2 levels. Data is aggregated by displacement reason, demographics (sex),
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/uga-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Uganda IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/609b8a84-08e4-45c9-ab55-cb725ae7ad90/resource/ef23f957-6bdc-44dc-a6d6-af4198a97810/download/uga-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_ef23f957
  media_type: text/csv
  spatial: null
  ...
  title: Uganda IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-uga_iom_displacementtrackingmatri_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-30'
temporal_resolution: null
title: Uganda IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
