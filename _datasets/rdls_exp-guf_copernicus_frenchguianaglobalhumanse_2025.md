...
- entity:
    ...
    url: https://data.humdata.org/dataset/guf-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/guf-ghsl
dataset_id: rdls_exp-guf_copernicus_frenchguianaglobalhumanse_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/guf-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    distribution at global scale. The resulting GeoTIFF layers represent spatially
    explicit exposure of human settlements and infrastructure.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guf-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/af141806-3bbc-4af6-9de8-a1c2f48c345d/resource/6da62714-2646-43fc-becb-11e96bd827ea/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_guf.tif
  format: null
  id: resource_6da62714
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'French Guiana: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/af141806-3bbc-4af6-9de8-a1c2f48c345d/resource/1a95a94b-1a08-4e37-80c3-bc27a9289867/download/ghs_pop_e2025_r2023a_54009_100_v1_0_guf.tif
  format: null
  id: resource_1a95a94b
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-guf_copernicus_frenchguianaglobalhumanse_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'French Guiana: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
