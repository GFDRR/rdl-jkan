...
- entity:
    ...
    url: https://data.humdata.org/dataset/bvt-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bvt-ghsl
dataset_id: rdls_exp-copernicus_bouvetislandglobalhumanse_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bvt-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams,
    ...
    data processing technologies to produce global gridded estimates of built-up surface
    area and population distribution. The resulting GeoTIFF rasters represent the
    spatial distribution of human settlements and population at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bvt-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/deb9e388-a7dc-4b3c-91e5-8f39c72cef6f/resource/c9b28a67-df68-46ec-bbee-6e1cecfe450f/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bvt.tif
  format: null
  id: resource_c9b28a67
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Bouvet Island: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/deb9e388-a7dc-4b3c-91e5-8f39c72cef6f/resource/4cd8d230-5b5d-412d-9627-3a36ce73ed7c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bvt.tif
  format: null
  id: resource_4cd8d230
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-copernicus_bouvetislandglobalhumanse_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Bouvet Island: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
