...
- entity:
    ...
    url: https://data.humdata.org/dataset/nam-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/nam-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-nam_hdx_ibtracsstormtracks_1858
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nam-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Namibia subset contains observed storm positions,
    wind speeds (wmo_wind), central pressures (wmo_pres), and storm classification
    (nature) extracted for the region of interest.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nam-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1858 to date that pass within 2000 kilometers
    of Namibia.
  download_url: https://data.humdata.org/dataset/74ad7b3e-a28d-41cf-8aac-4b759c5cb0d6/resource/cdd75ad7-e4ae-41fd-bc81-c5554a600e0e/download/ibtracs_all_list_v04r01_nam.csv
  format: null
  id: resource_cdd75ad7
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NAM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1858 to date that pass within 2000 kilometers
    of Namibia.
  download_url: https://data.humdata.org/dataset/74ad7b3e-a28d-41cf-8aac-4b759c5cb0d6/resource/3111efba-a310-43c7-83ab-a9a2d56f0b96/download/ibtracs_all_list_v04r01_lines_nam.geojson
  format: null
  id: resource_3111efba
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NAM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nam_hdx_ibtracsstormtracks_1858
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1858-03-31'
temporal_resolution: null
title: 'Namibia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
