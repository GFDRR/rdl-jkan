...
- entity:
    ...
    url: https://data.humdata.org/dataset/hrv-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/hrv-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-hrv_hdx_ibtracsstormtracks_1865
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/hrv-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Croatia subset
    contains observed cyclone track positions, timestamps, basin classifications,
    wind speeds (wmo_wind), and central pressure (wmo_pres) for all storms affecting
    or passing through the region, provided in both tabular CSV and geospatial GeoJSON
    formats.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hrv-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Croatia.
  download_url: https://data.humdata.org/dataset/9626d546-f00a-486d-9af0-a525f8603199/resource/445c62ff-3791-4181-8866-8572226523a2/download/ibtracs_all_list_v04r01_hrv.csv
  format: null
  id: resource_445c62ff
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_HRV.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Croatia.
  download_url: https://data.humdata.org/dataset/9626d546-f00a-486d-9af0-a525f8603199/resource/4f192745-a2fe-4c21-95a8-d533faf02050/download/ibtracs_all_list_v04r01_lines_hrv.geojson
  format: null
  id: resource_4f192745
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_HRV.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-hrv_hdx_ibtracsstormtracks_1865
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1865-10-24'
temporal_resolution: null
title: 'Croatia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
