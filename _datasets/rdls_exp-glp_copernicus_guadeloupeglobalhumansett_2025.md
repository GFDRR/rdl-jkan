...
- entity:
    ...
    url: https://data.humdata.org/dataset/glp-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/glp-ghsl
dataset_id: rdls_exp-glp_copernicus_guadeloupeglobalhumansett_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/glp-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    The resulting GeoTIFF layers represent human settlement patterns and infrastructure
    presence at the national scale for Guadeloupe.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/glp-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/ab7b271b-bb36-46ab-a398-e6a769fd9abc/resource/864d77c6-67d0-495b-8017-2db3e3516c85/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_glp.tif
  format: null
  id: resource_864d77c6
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Guadeloupe: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/ab7b271b-bb36-46ab-a398-e6a769fd9abc/resource/8818b999-a33d-4dd1-ab08-a2e1bcf5c81f/download/ghs_pop_e2025_r2023a_54009_100_v1_0_glp.tif
  format: null
  id: resource_8818b999
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-glp_copernicus_guadeloupeglobalhumansett_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Guadeloupe: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
