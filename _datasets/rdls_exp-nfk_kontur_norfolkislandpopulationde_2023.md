...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-norfolk-island
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-norfolk-island
dataset_id: rdls_exp-nfk_kontur_norfolkislandpopulationde_2023
description: 'Norfolk Island population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-norfolk-island]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    data, and OpenStreetMap) and aggregating the results into H3 hexagonal grid cells
    at 400m resolution using a hierarchical spatial indexing approach. The dataset
    provides baseline population exposure data for Norfolk Island suitable for disaster
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-norfolk-island
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Norfolk Island: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_NF_20220630.gpkg.gz
  format: null
  id: resource_cfa8aba5
  ...
  title: kontur_population_NF_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Norfolk Island: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_NF_20231101.gpkg.gz
  format: null
  id: resource_535c566e
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_NF_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nfk_kontur_norfolkislandpopulationde_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Norfolk Island: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
