...
- entity:
    ...
    url: https://data.humdata.org/dataset/nauru-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/nauru-road-surface-data
dataset_id: rdls_exp-nru_heigit_naururoadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nauru-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    road surface inventory with geometric and classification metadata for Nauru.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nauru-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Nauru: Road Surface Data (GeoJSON data for Nauru.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_nru_roadsurface_lines.geojson
  format: null
  id: resource_413600db
  ...
  title: Nauru GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Nauru: Road Surface Data (Geopackage data for Nauru.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_nru_roadsurface_lines.gpkg
  format: null
  id: resource_100f8709
  ...
  temporal: null
  temporal_resolution: null
  title: Nauru GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nru_heigit_naururoadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
