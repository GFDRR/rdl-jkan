...
- entity:
    ...
    url: https://data.humdata.org/dataset/omn-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/omn-ndvi-subnational
dataset_id: rdls_hzd-omn_wfp_omanndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/omn-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1
    ...
    NDVI values were computed for each dekad and aggregated by WFP subnational administrative
    units. Long-term averages and percentage anomalies were calculated to provide
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/omn-ndvi-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135628771480_ceaa148d'
  download_url: https://data.humdata.org/dataset/caba5ec8-3170-4226-81cd-150a26880b0d/resource/a69d4181-0bde-4e80-bd78-b1b530e5ce89/download/omn-ndvi-subnat-full.csv
  format: null
  id: resource_a69d4181
  media_type: text/csv
  spatial: null
  ...
  title: omn-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135628771480_ceaa148d'
  download_url: https://data.humdata.org/dataset/caba5ec8-3170-4226-81cd-150a26880b0d/resource/8075c7f7-0f46-45c6-8fce-edd31409154d/download/omn-ndvi-subnat-5ytd.csv
  format: null
  id: resource_8075c7f7
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: omn-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-omn_wfp_omanndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Oman: NDVI at Subnational Level'
version: null
vulnerability: null
---
