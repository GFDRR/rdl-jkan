...
- entity:
    ...
    url: https://data.humdata.org/dataset/isl-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/isl-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-isl_hdx_icelandibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/isl-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    and standardized. The Iceland subset contains all tropical cyclone tracks affecting
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/isl-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Iceland.
  download_url: https://data.humdata.org/dataset/56d8e362-a765-49ae-b116-47d2293c278c/resource/6444c7ca-4a9d-4431-a99b-8575a97b4b90/download/ibtracs_all_list_v04r01_isl.csv
  format: null
  id: resource_6444c7ca
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ISL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Iceland.
  download_url: https://data.humdata.org/dataset/56d8e362-a765-49ae-b116-47d2293c278c/resource/dd8a71bc-5a91-4ccb-af6e-541e2718b9f2/download/ibtracs_all_list_v04r01_lines_isl.geojson
  format: null
  id: resource_dd8a71bc
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ISL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-isl_hdx_icelandibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Iceland: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
