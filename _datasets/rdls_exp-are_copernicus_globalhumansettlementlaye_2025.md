...
- entity:
    ...
    url: https://data.humdata.org/dataset/are-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/are-ghsl
dataset_id: rdls_exp-are_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/are-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. The resulting GeoTIFF rasters represent the spatial extent and density
    of human settlements at global scale, with country-specific extracts provided
    for the UAE.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/are-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/f689c07d-22a2-4082-a409-406dfc517f04/resource/8784e76e-d49e-4782-9cf2-bd267668ee11/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_are.tif
  format: null
  id: resource_8784e76e
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'United Arab Emirates: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/f689c07d-22a2-4082-a409-406dfc517f04/resource/d94a3ed5-1b18-4c31-87c8-bc05f458d38b/download/ghs_pop_e2025_r2023a_54009_100_v1_0_are.tif
  format: null
  id: resource_d94a3ed5
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-are_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'United Arab Emirates: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
