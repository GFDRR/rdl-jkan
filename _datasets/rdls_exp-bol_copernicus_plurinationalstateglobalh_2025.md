...
- entity:
    ...
    url: https://data.humdata.org/dataset/bol-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bol-ghsl
dataset_id: rdls_exp-bol_copernicus_plurinationalstateglobalh_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bol-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: The GHSL project processes multi-source geospatial data including fine-scale
    satellite imagery, census records, and crowdsourced geographic information through
    automated spatial data analytics to produce gridded estimates of built-up surfaces
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bol-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/22f291f8-d01e-48c4-964f-4561fc14799c/resource/42b452ab-398e-4cac-882f-069144aa8192/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bol.tif
  format: null
  id: resource_42b452ab
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Bolivia (Plurinational State of): Copernicus Global Human Settlement
    Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system:
    Mollweide)'
  download_url: https://data.humdata.org/dataset/22f291f8-d01e-48c4-964f-4561fc14799c/resource/c14949bd-60e8-433f-9ee5-449fe47f77bb/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bol.tif
  format: null
  id: resource_c14949bd
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-bol_copernicus_plurinationalstateglobalh_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Bolivia (Plurinational State of): Copernicus Global Human Settlement Layer
  (GHSL)'
version: null
vulnerability: null
---
