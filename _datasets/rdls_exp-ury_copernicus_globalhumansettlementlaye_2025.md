...
- entity:
    ...
    url: https://data.humdata.org/dataset/ury-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/ury-ghsl
dataset_id: rdls_exp-ury_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ury-ghsl]'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ury-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/1710b681-4358-4d7b-877f-a874670c5a20/resource/584dfc4d-76e0-478b-8dec-1676da21ff61/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_ury.tif
  format: null
  id: resource_584dfc4d
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Uruguay: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/1710b681-4358-4d7b-877f-a874670c5a20/resource/ed28a658-0d97-46d0-b954-50bfd047c087/download/ghs_pop_e2025_r2023a_54009_100_v1_0_ury.tif
  format: null
  id: resource_ed28a658
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-ury_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Uruguay: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
