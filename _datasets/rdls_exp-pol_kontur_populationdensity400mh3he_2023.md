...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-poland
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-poland
dataset_id: rdls_exp-pol_kontur_populationdensity400mh3he_2023
description: 'Poland population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-poland]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    spatial indexing system. The resulting dataset provides baseline population counts
    at high spatial resolution for Poland.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-poland
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Poland: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PL_20220630.gpkg.gz
  format: null
  id: resource_3f1b84a0
  ...
  title: kontur_population_PL_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Poland: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PL_20231101.gpkg.gz
  format: null
  id: resource_90f3c8d8
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_PL_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pol_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Poland: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
