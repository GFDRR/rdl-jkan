...
- entity:
    ...
    url: https://data.humdata.org/dataset/cyp-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cyp-ghsl
dataset_id: rdls_exp-cyp_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cyp-ghsl]'
...
lineage:
  description: 'The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. Two primary outputs are provided: GHS Built-up Surface (classified
    built environment extent) and GHS Population Grid (gridded population counts),
    both representing the human presence and settlement patterns at national scale.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cyp-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/0719f682-c2be-4e68-bf71-454f223ed39b/resource/ab9ff313-4fbe-4e59-b91f-8347b364a13b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cyp.tif
  format: null
  id: resource_ab9ff313
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Cyprus: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/0719f682-c2be-4e68-bf71-454f223ed39b/resource/4bf06965-90d2-47ac-b8ca-554282814ac9/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cyp.tif
  format: null
  id: resource_4bf06965
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cyp_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Cyprus: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
