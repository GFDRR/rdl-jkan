...
creator:
  ...
  name: Utrecht University
  url: https://doi.org/10.24416/UU01-XUTQN5
dataset_id: rdls_exp-crstac_historydatabaseoftheglobalenvironmenthyde32_landuse
description: 'Categories include cropland, with a new distinction into irrigated and
  rain fed crops (other than rice) and irrigated and rain fed rice. Also grazing lands
  are provided, divided into more intensively used pasture, converted rangeland and
  non-converted natural (less intensively used) rangeland [Source: This metadata record
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/exposure-vulnerability/land-use/history-database-of-the-global-environment-hyde32/land-use/land-use.json
  ...
  title: 'STAC Item: History Database of the Global Environment (HYDE3.2) - land use'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: History Database of the Global Environment (HYDE3.2) - land use - data
    file
  ...
  temporal: null
  temporal_resolution: null
  title: History Database of the Global Environment (HYDE3.2) - land use - data file
- access_url: https://doi.org/10.5194/essd-9-927-2017
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: History Database of the Global Environment (HYDE3.2) - land use (Web
    reference)
  download_url: null
...
- exposure
schema: rdls-10
slug: rdls_exp-crstac_historydatabaseoftheglobalenvironmenthyde32_landuse
spatial:
  bbox:
  - -180.0
  - -90.0
...
temporal:
  ...
  start: '9999'
temporal_resolution: null
title: History Database of the Global Environment (HYDE3.2) - land use
version: null
vulnerability: null
---
