...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/bol-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/bol-rainfall-subnational
dataset_id: rdls_hzd-bol_wfp_plurinationalstaterainfal_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/bol-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery integrated with
    ...
    1-month and 3-month rolling aggregations) and aggregated by subnational administrative
    units to monitor meteorological drought conditions.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135442695569_4fd4c84f'
  download_url: https://data.humdata.org/dataset/6bdf6f70-aee9-4892-a6ff-e5110277e10a/resource/52aa57a7-29ce-4e63-8b84-5e667acaa02d/download/bol-rainfall-subnat-full.csv
  format: null
  id: resource_52aa57a7
  media_type: text/csv
  spatial: null
  ...
  title: bol-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135442695569_4fd4c84f'
  download_url: https://data.humdata.org/dataset/6bdf6f70-aee9-4892-a6ff-e5110277e10a/resource/84e53007-fbf2-4234-a2d1-520dfa933133/download/bol-rainfall-subnat-5ytd.csv
  format: null
  id: resource_84e53007
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: bol-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bol_wfp_plurinationalstaterainfal_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Bolivia (Plurinational State of): Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
