...
- entity:
    ...
    url: https://data.humdata.org/dataset/puerto-rico-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/puerto-rico-road-surface-data
dataset_id: rdls_exp-pri_heigit_puertoricoroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/puerto-rico-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    ...
    surface attributes to create a comprehensive road surface dataset with both observed
    and predicted classifications across Puerto Rico.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/puerto-rico-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Puerto Rico: Road Surface Data (GeoJSON data for Puerto rico.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_pri_roadsurface_lines.geojson
  format: null
  id: resource_c2a46886
  ...
  title: Puerto rico GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Puerto Rico: Road Surface Data (Geopackage data for Puerto rico.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_pri_roadsurface_lines.gpkg
  format: null
  id: resource_c1f2bc0f
  ...
  temporal: null
  temporal_resolution: null
  title: Puerto rico GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pri_heigit_puertoricoroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Puerto Rico: Road Surface Data'
version: null
vulnerability: null
---
