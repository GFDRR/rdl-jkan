...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/slv-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/slv-iom-dtm-from-api
dataset_id: rdls_lss-slv_iom_displacementtrackingmatri_20200630
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/slv-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through baseline assessments, emergency
    tracking tools, and site assessments at multiple administrative levels in El Salvador.
    Data is aggregated by displacement reason, demographic breakdown (males/females),
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/slv-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: El Salvador IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/efa0604a-96a2-4f4b-b48d-df90460dfed5/resource/8119ced1-f2cd-4b84-9c7f-03b093eddd17/download/slv-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_8119ced1
  media_type: text/csv
  spatial: null
  ...
  title: El Salvador IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-slv_iom_displacementtrackingmatri_20200630
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-30'
temporal_resolution: null
title: El Salvador IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
