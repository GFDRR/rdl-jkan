...
- entity:
    ...
    url: https://data.humdata.org/dataset/ind-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ind-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ind_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ind-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    multiple national meteorological agencies into a unified best-track dataset. Observations
    include storm position (latitude/longitude), time, basin/sub-basin classification,
    nature of system, and physical parameters (WMO wind speed and pressure). Data
    is provided as point observations (CSV) and linestring geometries (GeoJSON) for
    India region.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ind-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of India.
  download_url: https://data.humdata.org/dataset/9bc88226-8747-499a-b100-d7968da6d9d6/resource/a127656e-7ef8-4b09-9d17-31ce61d199d9/download/ibtracs_all_list_v04r01_ind.csv
  format: null
  id: resource_a127656e
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_IND.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of India.
  download_url: https://data.humdata.org/dataset/9bc88226-8747-499a-b100-d7968da6d9d6/resource/a2bf34cb-01ae-47ae-b7a7-07eb58d9f656/download/ibtracs_all_list_v04r01_lines_ind.geojson
  format: null
  id: resource_a2bf34cb
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_IND.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ind_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'India: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
