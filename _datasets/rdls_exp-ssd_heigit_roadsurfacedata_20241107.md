...
- entity:
    ...
    url: https://data.humdata.org/dataset/south-sudan-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/south-sudan-road-surface-data
dataset_id: rdls_exp-ssd_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/south-sudan-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for South Sudan. A hybrid deep learning model was applied to classify road surfaces
    as paved or unpaved, generating predictions for approximately 0.1612 million km
    of mapped roads. The dataset integrates OSM-documented surface classifications
    with AI-predicted surface types to provide comprehensive road infrastructure exposure
    data for humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- access_url: null
  ...
  description: 'South Sudan: Road Surface Data (GeoJSON data for South sudan.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ssd_roadsurface_lines.geojson
  format: null
  id: resource_2b9fdfca
  ...
  title: South sudan GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'South Sudan: Road Surface Data (Geopackage data for South sudan.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ssd_roadsurface_lines.gpkg
  format: null
  id: resource_391a37ff
  ...
  temporal: null
  temporal_resolution: null
  title: South sudan GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ssd_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'South Sudan: Road Surface Data'
version: null
vulnerability: null
---
