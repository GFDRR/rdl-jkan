...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-panama
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-panama
dataset_id: rdls_exp-pan_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-panama]'
...
lineage:
  description: National-level socio-economic data, building type distributions, and
    ...
    and Kokusai Kogyo for the GAR15 global risk assessment framework.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-panama
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Panama.zip
  download_url: https://data.humdata.org/dataset/8edf340c-298c-44a1-ab48-16c2b8970a20/resource/d6d68e02-797f-4d51-9c09-3333b05e2c47/download/pan.zip
  format: null
  id: resource_d6d68e02
  ...
  title: GAR15 Global Exposure Dataset for Panama.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pan_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Panama
version: null
vulnerability: null
---
