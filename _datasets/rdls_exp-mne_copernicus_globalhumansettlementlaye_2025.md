...
- entity:
    ...
    url: https://data.humdata.org/dataset/mne-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mne-ghsl
dataset_id: rdls_exp-mne_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mne-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    the spatial distribution of human settlements and population density across Montenegro.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mne-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/da63b992-f594-420f-aaf0-2d11b6df8672/resource/d34b6a26-bb4f-4bfa-9ff8-32578f9c4d1c/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mne.tif
  format: null
  id: resource_d34b6a26
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Montenegro: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/da63b992-f594-420f-aaf0-2d11b6df8672/resource/7b5c42cb-bab3-42b7-aab6-cc4f9330da05/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mne.tif
  format: null
  id: resource_7b5c42cb
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mne_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Montenegro: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
