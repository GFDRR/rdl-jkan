...
- entity:
    ...
    url: https://data.humdata.org/dataset/nor-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/nor-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-nor_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nor-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The data for Norway includes storm
    track positions (latitude, longitude), timing (ISO_TIME), basin/sub-basin classification,
    storm nature, and physical parameters (WMO wind speed and pressure) recorded at
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nor-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Norway.
  download_url: https://data.humdata.org/dataset/b615ef6c-1350-40bf-8aaf-ec73884874a2/resource/59534434-04b5-4539-8e71-aec63c0fdf71/download/ibtracs_all_list_v04r01_nor.csv
  format: null
  id: resource_59534434
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NOR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Norway.
  download_url: https://data.humdata.org/dataset/b615ef6c-1350-40bf-8aaf-ec73884874a2/resource/b109152f-5d34-4ba0-98de-c4cc5d1a5796/download/ibtracs_all_list_v04r01_lines_nor.geojson
  format: null
  id: resource_b109152f
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NOR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nor_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Norway: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
