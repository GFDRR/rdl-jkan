...
- entity:
    ...
    url: https://data.humdata.org/dataset/reunion-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/reunion-planet-road-surface-data
dataset_id: rdls_exp-reu_heigit_reunionplanetroadsurfacew_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ surface conditions in many regions. Summary of Road Statistics Approximately 0.0013\
  \ million km of arterial roads are mapped in OSM in this region. - Paved roads:\
  \ 0.0012 million km (91.0203%) - Unpaved roads: 0.0 million km (0.0076%) - Missing\
  \ OSM surface tags: 0.0 million km (0.735%) - PlanetScope predictions cover: 0.0012\
  \ million km (12384.8361%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ 5 Unpaved, Light Vehicle (< 3.5 m) - High-Risk Track: Dry season only, 4\xD74\
  \ required. High risk of impassability. Codes: U1 / UNP_LIGHT / Score: 6 Included\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/reunion-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries from OpenStreetMap were extracted for arterial
    ...
    multi-temporal road infrastructure exposure data with humanitarian logistics and
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/reunion-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: "R\xE9union: Planet Road Surface, Width, and Passability Data (GeoJSON\
    \ file for R\xE9union)"
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_RE_planet_roadsurface_lines.geojson
  format: null
  id: resource_fe6eafcb
  ...
  title: "R\xE9union GeoJSON heigit_RE_planet_roadsurface_lines.geojson"
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: "R\xE9union: Planet Road Surface, Width, and Passability Data (Geopackage\
    \ file for R\xE9union)"
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_RE_planet_roadsurface_lines.gpkg
  format: null
  id: resource_efefb25e
  ...
  temporal: null
  temporal_resolution: null
  title: "R\xE9union GPKG heigit_RE_planet_roadsurface_lines.gpkg"
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-reu_heigit_reunionplanetroadsurfacew_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: "R\xE9union: Planet Road Surface, Width, and Passability Data"
version: null
vulnerability: null
---
