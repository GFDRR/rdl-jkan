...
dataset_id: rdls_hzd-Cooling_degree_hours_ZAF
description: "Annual number of hours during which the temperatures rises over 25\xB0\
  ...
  \ use. The baseline is calculated for 2001\u20132020, with projections for 2021\u2013\
...
- coordinate_system: EPSG:4326
  description: "Annual number of hours during which the temperature rises above 25\xB0\
    C, multiplied by the number of degrees above 25\xB0C for 2001-2020. This is used\
    \ to estimate the energy demand for air conditioning."
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '0'
  spatial_resolution: null
  title: Cooling Degree Hours - Johannebsurg & Ekurhuleni (2001-2020)
- coordinate_system: EPSG:4326
  description: "Projected annual number of hours during which the temperature rises\
    \ above 25\xB0C under RCP 4.5 and 8.5 scenario for 2021-2040."
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '1'
  spatial_resolution: null
  title: Cooling Degree Hours - Johannebsurg & Ekurhuleni (2021-2040, RCP4.5 & RCP8.5)
- coordinate_system: EPSG:4326
  description: "Projected annual number of hours during which the temperature rises\
    \ above 25\xB0C under RCP 4.5 and 8.5 scenario for 2041-2060."
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '2'
  spatial_resolution: null
  title: Cooling Degree Hours - Johannebsurg & Ekurhuleni (2041-2060, RCP4.5 & RCP8.5)
risk_data_type:
- hazard
schema: rdl-02
slug: rdls_hzd-Cooling_degree_hours_ZAF
spatial:
  bbox:
  - 27.676831894273278
  - -26.580113703331147
