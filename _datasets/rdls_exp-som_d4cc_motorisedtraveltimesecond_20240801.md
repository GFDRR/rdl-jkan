...
- entity:
    ...
    url: https://data.humdata.org/dataset/somalia-motorised-travel-time-in-seconds-to-nearest-health-centre
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Data for Children Collaborative
  url: https://data.humdata.org/dataset/somalia-motorised-travel-time-in-seconds-to-nearest-health-centre
dataset_id: rdls_exp-som_d4cc_motorisedtraveltimesecond_20240801
description: 'A 100 m spatial resolution geotiff of motorised travel time in seconds
  to nearest health facility in Somalia. The data was generated using the Child Poverty
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/somalia-motorised-travel-time-in-seconds-to-nearest-health-centre]'
...
lineage:
  description: Travel time surface generated using the CPAS least cost path method
    at 100 m resolution, which creates a friction/cost allocation surface representing
    effort to travel across different pixel types (roads, tracks, land cover), then
    calculates minimum travel time to nearest health facility assuming motorised transport
    on all-weather roads and walking on other surfaces.
  sources:
  - id: source_1
    license: null
    name: Child Poverty and Access to Services (CPAS) software
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/somalia-motorised-travel-time-in-seconds-to-nearest-health-centre
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://s3.eidf.ac.uk/eidf158-motorised-travel-time-maps/service_area_Somalia_motorised.tif
  format: null
  id: resource_1dc49f6f
  ...
  title: service-area-somalia-motorised.tif
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-som_d4cc_motorisedtraveltimesecond_20240801
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-08-01'
temporal_resolution: null
title: Somalia Motorised Travel Time (in seconds) to nearest health centre
version: null
vulnerability: null
---
