...
- entity:
    ...
    url: https://data.humdata.org/dataset/alb-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/alb-ghsl
dataset_id: rdls_exp-alb_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/alb-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    of human settlements at global scale, with Albania-specific extracts provided
    here.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/alb-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/b8ac015a-8495-4542-bdb3-63625dc30d5c/resource/dda088d0-1190-43f7-98cb-b931c0bfacbe/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_alb.tif
  format: null
  id: resource_dda088d0
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Albania: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/b8ac015a-8495-4542-bdb3-63625dc30d5c/resource/ff47ff8b-489d-4925-87e0-9151178106f3/download/ghs_pop_e2025_r2023a_54009_100_v1_0_alb.tif
  format: null
  id: resource_ff47ff8b
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-alb_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Albania: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
