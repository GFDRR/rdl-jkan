...
- entity:
    ...
    url: https://data.humdata.org/dataset/angola-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/angola-level-1-exposure-data
dataset_id: rdls_exp-ago_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/angola-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was generated through the METEOR project methodology
    ...
    provides gridded estimates of building counts, building area, and rebuilding value
    at 15-arcsecond resolution (~500m) across Angola, designed for catastrophe modeling
    and disaster risk assessment applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project (Modelling Exposure Through Earth Observation Routines)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/angola-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Angola produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/07ce1506-a199-4500-b8b4-16c6289e8a0f/resource/f4e4e24e-f58a-448a-ac31-e12053a2f61b/download/ago_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_f4e4e24e
  ...
  title: AGO_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ago_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Angola: Level 1 Exposure Data'
version: null
vulnerability: null
---
