...
- entity:
    ...
    url: https://data.humdata.org/dataset/curacao-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/curacao-planet-road-surface-data
dataset_id: rdls_exp-cuw_heigit_curacaoplanetroadsurfacew_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0003 million km (95.5843%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (5.7598%) - PlanetScope predictions cover: 0.0003\
  \ million km (1659.5114%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/curacao-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries and attributes were extracted from OpenStreetMap
    for arterial highways (motorway, trunk, primary, secondary and link classes).
    Deep learning models trained on PlanetScope satellite imagery from 2020 and 2024
    were applied to classify road surface type, width, and surface change. A Humanitarian
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/curacao-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: "Cura\xE7ao: Planet Road Surface, Width, and Passability Data (GeoJSON\
    \ file for Cura\xE7ao)"
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_CW_planet_roadsurface_lines.geojson
  format: null
  id: resource_3dbd8c46
  ...
  title: "Cura\xE7ao GeoJSON heigit_CW_planet_roadsurface_lines.geojson"
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: "Cura\xE7ao: Planet Road Surface, Width, and Passability Data (Geopackage\
    \ file for Cura\xE7ao)"
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_CW_planet_roadsurface_lines.gpkg
  format: null
  id: resource_f52e25a2
  ...
  temporal: null
  temporal_resolution: null
  title: "Cura\xE7ao GPKG heigit_CW_planet_roadsurface_lines.gpkg"
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cuw_heigit_curacaoplanetroadsurfacew_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: "Cura\xE7ao: Planet Road Surface, Width, and Passability Data"
version: null
vulnerability: null
---
