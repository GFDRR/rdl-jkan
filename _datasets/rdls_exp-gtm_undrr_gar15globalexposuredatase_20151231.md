...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-guatemala
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-guatemala
dataset_id: rdls_exp-gtm_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-guatemala]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    approach combining multiple data sources and expert inputs to create a spatially-distributed
    exposure inventory for Guatemala.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-guatemala
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Guatemala.zip
  download_url: https://data.humdata.org/dataset/2526a609-0b78-45fc-b1df-600381a79e1d/resource/81221e19-c945-4b07-82ae-f466d5d0a5bf/download/gtm.zip
  format: null
  id: resource_81221e19
  ...
  title: GAR15 Global Exposure Dataset for Guatemala.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gtm_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Guatemala
version: null
vulnerability: null
---
