...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-pse_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Palestine. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540131
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540131
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Palestine, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540131/files/PSE.zip
  format: null
  id: resource_sdkicra_pse
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Palestine
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-pse_nismod_sdkicra
spatial:
  bbox:
  - 34.2
  - 31.21
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Palestine
version: 0.1.0
vulnerability: null
---
