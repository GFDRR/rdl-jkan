...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/lbr-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/lbr-rainfall-subnational
dataset_id: rdls_hzd-lbr_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/lbr-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery integrated with
    ...
    1-month and 3-month rolling aggregations, and long-term averages) and aggregated
    by subnational administrative units in Liberia to support drought monitoring and
    early warning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lbr-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135559007029_270155a4'
  download_url: https://data.humdata.org/dataset/a1f60b8a-51ff-4ee7-87ab-897983714595/resource/87f76c2a-8a50-4386-ae91-edc90fc5eced/download/lbr-rainfall-subnat-full.csv
  format: null
  id: resource_87f76c2a
  media_type: text/csv
  spatial: null
  ...
  title: lbr-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135559007029_270155a4'
  download_url: https://data.humdata.org/dataset/a1f60b8a-51ff-4ee7-87ab-897983714595/resource/df8db96b-4dbf-44df-a145-ea93fc64b6a5/download/lbr-rainfall-subnat-5ytd.csv
  format: null
  id: resource_df8db96b
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: lbr-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lbr_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Liberia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
