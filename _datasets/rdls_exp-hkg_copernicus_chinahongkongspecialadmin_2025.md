...
- entity:
    ...
    url: https://data.humdata.org/dataset/hkg-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/hkg-ghsl
dataset_id: rdls_exp-hkg_copernicus_chinahongkongspecialadmin_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/hkg-ghsl]'
...
lineage:
  description: The GHSL dataset integrates multi-source geospatial data including
    Copernicus satellite imagery, census records, and volunteered geographic information
    through automated spatial data processing technologies to produce gridded estimates
    of built-up surface area and population distribution at fine spatial resolution.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hkg-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/e6eeb7ac-4994-4d02-a03b-fcd9d750acdc/resource/cf3271d2-8dce-4419-b188-47d96b1dca85/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_hkg.tif
  format: null
  id: resource_cf3271d2
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'China, Hong Kong Special Administrative Region: Copernicus Global
    Human Settlement Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m,
    Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/e6eeb7ac-4994-4d02-a03b-fcd9d750acdc/resource/21a99726-a63c-4ddd-a550-6914ffa56991/download/ghs_pop_e2025_r2023a_54009_100_v1_0_hkg.tif
  format: null
  id: resource_21a99726
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-hkg_copernicus_chinahongkongspecialadmin_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'China, Hong Kong Special Administrative Region: Copernicus Global Human Settlement
  Layer (GHSL)'
version: null
vulnerability: null
---
