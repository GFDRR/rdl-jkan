...
- entity:
    ...
    url: https://data.humdata.org/dataset/anguilla-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/anguilla-planet-road-surface-data
dataset_id: rdls_exp-aia_heigit_anguillaplanetroadsurface_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (99.1342%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (0.0839%) - PlanetScope predictions cover: 0.0001\
  \ million km (118222.0238%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/anguilla-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road surface type, width, and passability were derived by applying
    deep learning algorithms to PlanetScope satellite imagery (2020 and 2024) of Anguilla's
    arterial road network extracted from OpenStreetMap. The analysis produced a Humanitarian
    Passability Index (HPI) and surface change detection (unpaved to paved transitions)
    to support humanitarian logistics and transportation planning.
  sources:
  - id: source_1
    license: null
    name: PlanetScope Satellite Imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/anguilla-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Anguilla: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Anguilla)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AI_planet_roadsurface_lines.gpkg
  format: null
  id: resource_ea500827
  ...
  title: Anguilla GPKG heigit_AI_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Anguilla: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Anguilla)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AI_planet_roadsurface_lines.geojson
  format: null
  id: resource_8e00f835
  ...
  temporal: null
  temporal_resolution: null
  title: Anguilla GeoJSON heigit_AI_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-aia_heigit_anguillaplanetroadsurface_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Anguilla: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
