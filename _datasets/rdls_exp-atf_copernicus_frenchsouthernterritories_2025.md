...
- entity:
    ...
    url: https://data.humdata.org/dataset/atf-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/atf-ghsl
dataset_id: rdls_exp-atf_copernicus_frenchsouthernterritories_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/atf-ghsl]'
...
lineage:
  description: The GHSL dataset integrates global fine-scale satellite image data
    ...
    surface area and population distribution at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/atf-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/399d204f-f727-4dfd-8eab-fd39ddf9649b/resource/9c310f68-23c9-4406-a7ad-bb99d088a7da/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_atf.tif
  format: null
  id: resource_9c310f68
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'French Southern Territories: Copernicus Global Human Settlement Layer
    (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/399d204f-f727-4dfd-8eab-fd39ddf9649b/resource/d81c655a-570c-45bf-ab3f-2e7acc0bd0fe/download/ghs_pop_e2025_r2023a_54009_100_v1_0_atf.tif
  format: null
  id: resource_d81c655a
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-atf_copernicus_frenchsouthernterritories_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'French Southern Territories: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
