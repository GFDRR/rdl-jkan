...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/senegal-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/senegal-level-1-exposure-data
dataset_id: rdls_exp-sen_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/senegal-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    resolution, ~500m) estimates of building counts, areas, and rebuilding values
    in point shapefile format, designed for catastrophe modeling and disaster risk
    assessment.
  sources:
  - id: source_1
    license: null
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Senegal produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/903634a2-0aaa-4906-9ce1-796c9b114161/resource/4c58a644-1d7f-4020-9138-fcbf6e5cfcb9/download/sen_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_4c58a644
  ...
  title: SEN_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sen_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Senegal: Level 1 Exposure Data'
version: null
vulnerability: null
---
