...
- entity:
    ...
    url: https://data.humdata.org/dataset/china-macao-special-administrative-region-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/china-macao-special-administrative-region-planet-road-surface-data
dataset_id: rdls_exp-mac_heigit_chinamacaospecialadminist_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0002 million km (88.2353%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (9.1032%) - PlanetScope predictions cover: 0.0002\
  \ million km (969.2757%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/china-macao-special-administrative-region-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Macao SAR. Deep learning models were applied to PlanetScope satellite imagery
    ...
    based on road condition and accessibility metrics.
  sources:
  - id: source_1
    license: null
    name: PlanetScope satellite imagery
...
- access_url: null
  ...
  description: 'China, Macao Special Administrative Region: Planet Road Surface, Width,
    and Passability Data (GeoJSON file for China, macao special administrative region)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MO_planet_roadsurface_lines.geojson
  format: null
  id: resource_d6043831
  ...
  title: China, macao special administrative region GeoJSON heigit_MO_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'China, Macao Special Administrative Region: Planet Road Surface, Width,
    and Passability Data (Geopackage file for China, macao special administrative
    region)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MO_planet_roadsurface_lines.gpkg
  format: null
  id: resource_1ce3b176
  ...
  temporal: null
  temporal_resolution: null
  title: China, macao special administrative region GPKG heigit_MO_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mac_heigit_chinamacaospecialadminist_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'China, Macao Special Administrative Region: Planet Road Surface, Width, and
  Passability Data'
version: null
vulnerability: null
---
