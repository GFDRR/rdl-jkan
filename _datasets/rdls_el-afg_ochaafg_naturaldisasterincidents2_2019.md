...
- entity:
    ...
    email: null
    name: OCHA
    url: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-2019
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: OCHA Afghanistan
  url: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-2019
dataset_id: rdls_el-afg_ochaafg_naturaldisasterincidents2_2019
description: '1) Natural disaster events include avalanches, earthquakes, flooding,
  ...
  dataset: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-2019]'
...
lineage:
  description: Post-event natural disaster incident data compiled from field assessments
    ...
    NGOs, and ERM across Afghanistan during 2019. Affected population counts and building
    damage figures were extracted from incident reports received from multiple humanitarian
    and government sources. The dataset represents observed impacts from avalanches,
    earthquakes, flooding, heavy rainfall and snowfall, and landslides and mudflows.
  sources:
  - id: source_1
    license: null
    name: OCHA
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-2019
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/c9627ffb-1033-4573-a2eb-af823af0c821/resource/5cd35d5b-f09c-400d-b680-055783fd9b51/download/afghanistan-natural-disaster-incidents-from-january-to-december-2019.xlsx
  format: null
  id: resource_5cd35d5b
  ...
  title: afghanistan-natural-disaster-incidents-from-january-to-december-2019.xlsx
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: Natural disaster events include avalanches, earthquakes, flooding,
    heavy rainfall & snowfall, and landslides & mudflows as recorded by OCHA field
    offices based on assessments in the field.
  download_url: https://data.humdata.org/dataset/c9627ffb-1033-4573-a2eb-af823af0c821/resource/24e2fec0-e27c-4794-8a9e-98d6666cefe1/download/afghanistan-natural-disaster-incidents-from-january-to-december-2019.csv
  format: null
  id: resource_24e2fec0
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: afghanistan-natural-disaster-incidents-from-january-to-december-2019.csv
risk_data_type:
- exposure
- loss
schema: rdls-10
slug: rdls_el-afg_ochaafg_naturaldisasterincidents2_2019
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2019-01-01'
temporal_resolution: null
title: Afghanistan - Natural Disaster Incidents in 2019
version: null
vulnerability: null
---
