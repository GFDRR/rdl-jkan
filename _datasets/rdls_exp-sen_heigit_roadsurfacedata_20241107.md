...
- entity:
    ...
    url: https://data.humdata.org/dataset/senegal-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/senegal-road-surface-data
dataset_id: rdls_exp-sen_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2436 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0161 and 0.0944
  (in million kms), corressponding to 6.6041% and 38.7656% respectively of the total
  road length in the dataset region. 0.1331 million km or 54.6302% of road surface
  ...
  to 0.0694% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/senegal-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated surface type predictions for approximately 0.2436 million
    km of mapped roads in Senegal, with quantified areal estimates for each surface
    class.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/senegal-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Senegal: Road Surface Data (GeoJSON data for Senegal.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_sen_roadsurface_lines.geojson
  format: null
  id: resource_ec59a4cc
  ...
  title: Senegal GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Senegal: Road Surface Data (Geopackage data for Senegal.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_sen_roadsurface_lines.gpkg
  format: null
  id: resource_900bdb1a
  ...
  temporal: null
  temporal_resolution: null
  title: Senegal GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sen_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Senegal: Road Surface Data'
version: null
vulnerability: null
---
