...
- entity:
    ...
    url: https://data.humdata.org/dataset/smr-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/smr-ghsl
dataset_id: rdls_exp-smr_copernicus_sanmarinoglobalhumansettl_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/smr-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    The resulting GeoTIFF layers represent the spatial extent and density of human
    settlements at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/smr-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/69d3643e-de51-486b-8123-9dceb219e71d/resource/10b275d2-e461-4c4a-b4ff-0377f750d9aa/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_smr.tif
  format: null
  id: resource_10b275d2
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'San Marino: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/69d3643e-de51-486b-8123-9dceb219e71d/resource/9d9aeda4-1660-4032-9886-7262651dfd7e/download/ghs_pop_e2025_r2023a_54009_100_v1_0_smr.tif
  format: null
  id: resource_9d9aeda4
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-smr_copernicus_sanmarinoglobalhumansettl_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'San Marino: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
