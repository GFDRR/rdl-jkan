...
- entity:
    ...
    url: https://data.humdata.org/dataset/glp-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/glp-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-glp_hdx_guadeloupeibtracsstormtra_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/glp-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Guadeloupe subset
    contains historical and recent cyclone tracks with ISO-formatted timestamps, basin/subbasin
    classifications, wind speed (wmo_wind), and pressure (wmo_pres) measurements at
    observation points, enabling hazard characterization for strong wind and storm
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/glp-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Guadeloupe.
  download_url: https://data.humdata.org/dataset/c02a8104-0026-4b3d-9ee0-369b8f1742a8/resource/beee0974-12e7-4233-be1f-3c944131784c/download/ibtracs_all_list_v04r01_glp.csv
  format: null
  id: resource_beee0974
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GLP.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Guadeloupe.
  download_url: https://data.humdata.org/dataset/c02a8104-0026-4b3d-9ee0-369b8f1742a8/resource/b83fb8d7-b2c2-4c46-b95d-7466022473f5/download/ibtracs_all_list_v04r01_lines_glp.geojson
  format: null
  id: resource_b83fb8d7
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GLP.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-glp_hdx_guadeloupeibtracsstormtra_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Guadeloupe: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
