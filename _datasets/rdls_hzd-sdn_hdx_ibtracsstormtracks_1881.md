...
- entity:
    ...
    url: https://data.humdata.org/dataset/sdn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/sdn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-sdn_hdx_ibtracsstormtracks_1881
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sdn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Sudan subset contains observed storm positions, timestamps, basin classifications,
    wind speeds (wmo_wind), and central pressure (wmo_pres) for all tropical cyclones
    affecting or passing through the region, provided in both tabular CSV and geospatial
    GeoJSON formats.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sdn-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1881 to date that pass within 2000 kilometers
    of Sudan.
  download_url: https://data.humdata.org/dataset/673f8113-d423-4b2f-8d68-78408050bffc/resource/9dcbff4a-b0ac-4364-aaba-012bed51df93/download/ibtracs_all_list_v04r01_sdn.csv
  format: null
  id: resource_9dcbff4a
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SDN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1881 to date that pass within 2000 kilometers
    of Sudan.
  download_url: https://data.humdata.org/dataset/673f8113-d423-4b2f-8d68-78408050bffc/resource/2d4023ee-56cf-429c-b3b2-ebd6d41adce3/download/ibtracs_all_list_v04r01_lines_sdn.geojson
  format: null
  id: resource_2d4023ee
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SDN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-sdn_hdx_ibtracsstormtracks_1881
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1881-05-26'
temporal_resolution: null
title: 'Sudan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
