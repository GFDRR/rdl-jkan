...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-morocco
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-morocco
dataset_id: rdls_exp-mar_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-morocco]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    and GDP as spatial proxies. The dataset represents a top-down exposure modeling
    approach developed collaboratively by UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo
    for the GAR15 global risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-morocco
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Morocco.zip
  download_url: https://data.humdata.org/dataset/444ced19-b019-4591-92a0-9dadd8f89380/resource/ac1625f2-7ecc-4ffe-84bf-9fb4c11390c1/download/mar.zip
  format: null
  id: resource_ac1625f2
  ...
  title: GAR15 Global Exposure Dataset for Morocco.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mar_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Morocco
version: null
vulnerability: null
---
