...
- entity:
    ...
    url: https://data.humdata.org/dataset/grc-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/grc-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-grc_hdx_ibtracsstormtracks_1887
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grc-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Greece subset contains
    observed storm tracks with ISO timestamps, basin/subbasin classifications, wind
    speed (wmo_wind), and central pressure (wmo_pres) measurements, filtered geographically
    for the Greece region and provided in both tabular CSV and GeoJSON line geometry
    formats.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grc-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of Greece.
  download_url: https://data.humdata.org/dataset/526e6722-c674-49ed-b461-2dc5e1c14b9e/resource/318f365f-7773-4e3f-ac3d-12808646e091/download/ibtracs_all_list_v04r01_grc.csv
  format: null
  id: resource_318f365f
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GRC.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of Greece.
  download_url: https://data.humdata.org/dataset/526e6722-c674-49ed-b461-2dc5e1c14b9e/resource/1c2fa913-5665-483f-97df-55d8f26bd307/download/ibtracs_all_list_v04r01_lines_grc.geojson
  format: null
  id: resource_1c2fa913
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GRC.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-grc_hdx_ibtracsstormtracks_1887
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1887-10-29'
temporal_resolution: null
title: 'Greece: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
