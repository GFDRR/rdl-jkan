...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/comoros-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/comoros-level-1-exposure-data
dataset_id: rdls_exp-com_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/comoros-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    Level 1 global-quality exposure estimates. The dataset presents gridded estimates
    of building count, area, and rebuilding value at 15-arcsecond resolution (approximately
    500 meters) intended for catastrophe modeling and disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/comoros-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Comoros produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/2067b905-9603-40b9-998f-482bbe56c615/resource/c68a0379-4e5d-4701-aab2-f7fba711d5d6/download/com_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_c68a0379
  ...
  title: COM_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-com_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Comoros: Level 1 Exposure Data'
version: null
vulnerability: null
---
