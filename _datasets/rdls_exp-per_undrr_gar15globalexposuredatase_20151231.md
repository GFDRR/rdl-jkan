...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-peru
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-peru
dataset_id: rdls_exp-per_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-peru]'
...
lineage:
  description: National socio-economic, building type, and capital stock statistics
    were transposed onto 5x5 km and 1x1 km grids using geographic population distribution
    and GDP as spatial proxies. The dataset was developed by UNEP-GRID for the Global
    Assessment Report on Disaster Risk Reduction (GAR15) through multi-agency collaboration
    to create a standardized global exposure database.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-peru
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Peru.zip
  download_url: https://data.humdata.org/dataset/ad9a496e-1a37-4f42-a5a7-5d8accd67ad3/resource/5de62199-78a6-4b88-91f4-bfcc4aeb66e3/download/per.zip
  format: null
  id: resource_5de62199
  ...
  title: GAR15 Global Exposure Dataset for Peru.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-per_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Peru
version: null
vulnerability: null
---
