...
- entity:
    ...
    url: https://data.humdata.org/dataset/bhr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bhr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bhr_hdx_bahrainibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bhr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Bahrain subset contains observed storm track positions with associated wind
    speed (wmo_wind) and pressure (wmo_pres) measurements at specific times and locations,
    representing empirical hazard characterization for tropical cyclones affecting
    the region.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bhr-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Bahrain.
  download_url: https://data.humdata.org/dataset/efb84b7a-b918-4c11-9241-95c073603ac3/resource/96dd34d0-cc90-4173-a6d4-48f80e083f2e/download/ibtracs_all_list_v04r01_bhr.csv
  format: null
  id: resource_96dd34d0
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BHR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Bahrain.
  download_url: https://data.humdata.org/dataset/efb84b7a-b918-4c11-9241-95c073603ac3/resource/a0e91a2d-cd7a-43f6-b728-4d40966c9bba/download/ibtracs_all_list_v04r01_lines_bhr.geojson
  format: null
  id: resource_a0e91a2d
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BHR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bhr_hdx_bahrainibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Bahrain: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
