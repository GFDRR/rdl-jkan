...
- entity:
    ...
    url: https://data.humdata.org/dataset/guy-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/guy-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-guy_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/guy-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The data for Guyana
    includes storm identifiers, temporal observations in ISO format, basin/sub-basin
    classifications, storm nature, geographic coordinates, and physical parameters
    (WMO wind speed and pressure) for each track point.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guy-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Guyana.
  download_url: https://data.humdata.org/dataset/409439d0-32e4-4fa6-b7a3-d5c910befaec/resource/168d6583-5418-4909-aadf-c15ffb207854/download/ibtracs_all_list_v04r01_guy.csv
  format: null
  id: resource_168d6583
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GUY.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Guyana.
  download_url: https://data.humdata.org/dataset/409439d0-32e4-4fa6-b7a3-d5c910befaec/resource/dfec99e1-ef57-434e-a6e4-7b929faf6fe3/download/ibtracs_all_list_v04r01_lines_guy.geojson
  format: null
  id: resource_dfec99e1
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GUY.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-guy_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Guyana: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
