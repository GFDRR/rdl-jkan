...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-turks-and-caicos-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-turks-and-caicos-islands
dataset_id: rdls_exp-tca_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-turks-and-caicos-islands]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    and GDP as spatial proxies. The dataset was developed through collaborative effort
    by UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo for the GAR15 global exposure assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Turks and Caicos Islands.zip
  download_url: https://data.humdata.org/dataset/55e490e7-913f-46f0-8b5f-411a66070585/resource/423e4891-cee4-4063-b61b-e31244dbee81/download/tca.zip
  format: null
  id: resource_423e4891
  ...
  title: GAR15 Global Exposure Dataset for Turks and Caicos Islands.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tca_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Turks and Caicos Islands
version: null
vulnerability: null
---
