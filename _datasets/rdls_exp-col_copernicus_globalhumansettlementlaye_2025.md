...
- entity:
    ...
    url: https://data.humdata.org/dataset/col-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/col-ghsl
dataset_id: rdls_exp-col_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/col-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    and population distribution. The Colombia subset represents national-scale exposure
    data derived from this global processing pipeline.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/col-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/7ec6dfd1-0c08-4467-8694-94cc45d6dcde/resource/dbfbb58d-26bc-428d-8aa2-e307d66f497b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_col.tif
  format: null
  id: resource_dbfbb58d
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Colombia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/7ec6dfd1-0c08-4467-8694-94cc45d6dcde/resource/ac9bec33-c33c-4348-b772-d998d5679c89/download/ghs_pop_e2025_r2023a_54009_100_v1_0_col.tif
  format: null
  id: resource_ac9bec33
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-col_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Colombia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
