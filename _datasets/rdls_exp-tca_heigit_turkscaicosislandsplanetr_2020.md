...
- entity:
    ...
    url: https://data.humdata.org/dataset/turks-and-caicos-islands-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/turks-and-caicos-islands-planet-road-surface-data
dataset_id: rdls_exp-tca_heigit_turkscaicosislandsplanetr_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (98.8689%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (21.6055%) - PlanetScope predictions cover: 0.0001\
  \ million km (457.6109%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/turks-and-caicos-islands-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Turks and Caicos Islands. Deep learning models were applied to PlanetScope
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/turks-and-caicos-islands-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Turks and Caicos Islands: Planet Road Surface, Width, and Passability
    Data (GeoJSON file for Turks and caicos islands)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_TC_planet_roadsurface_lines.geojson
  format: null
  id: resource_489cfbf6
  ...
  title: Turks and caicos islands GeoJSON heigit_TC_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Turks and Caicos Islands: Planet Road Surface, Width, and Passability
    Data (Geopackage file for Turks and caicos islands)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_TC_planet_roadsurface_lines.gpkg
  format: null
  id: resource_2c21b9b7
  ...
  temporal: null
  temporal_resolution: null
  title: Turks and caicos islands GPKG heigit_TC_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tca_heigit_turkscaicosislandsplanetr_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Turks and Caicos Islands: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
