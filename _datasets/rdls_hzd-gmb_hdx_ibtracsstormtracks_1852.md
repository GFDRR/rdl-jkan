...
- entity:
    ...
    url: https://data.humdata.org/dataset/gmb-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/gmb-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-gmb_hdx_ibtracsstormtracks_1852
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/gmb-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Gambia subset contains
    historical and recent cyclone tracks with ISO-formatted timestamps, basin/sub-basin
    classifications, wind speed (WMO), and central pressure measurements, processed
    to geographic point and line geometries.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gmb-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Gambia.
  download_url: https://data.humdata.org/dataset/e5e7b878-b7cf-485c-a375-385dbdb62afb/resource/e98f710e-7c89-40e9-ae86-e3b30953a1ff/download/ibtracs_all_list_v04r01_gmb.csv
  format: null
  id: resource_e98f710e
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GMB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Gambia.
  download_url: https://data.humdata.org/dataset/e5e7b878-b7cf-485c-a375-385dbdb62afb/resource/8f71ff52-197b-4e5a-ac9e-f13c4f0a176c/download/ibtracs_all_list_v04r01_lines_gmb.geojson
  format: null
  id: resource_8f71ff52
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GMB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gmb_hdx_ibtracsstormtracks_1852
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1852-09-26'
temporal_resolution: null
title: 'Gambia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
