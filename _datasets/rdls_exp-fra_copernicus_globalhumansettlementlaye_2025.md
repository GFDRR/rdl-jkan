...
- entity:
    ...
    url: https://data.humdata.org/dataset/fra-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/fra-ghsl
dataset_id: rdls_exp-fra_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/fra-ghsl]'
...
lineage:
  description: 'The GHSL dataset integrates fine-scale satellite image data streams
    ...
    and population distribution. Two primary outputs are provided: GHS Built-up Surface
    (derived from satellite classification) and GHS Population Grid (estimated from
    census and satellite data integration).'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fra-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/216cd275-ef00-41e0-81f9-0309e3491ae8/resource/81f77452-d8ae-4509-8d0e-0924a9b18559/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_fra.tif
  format: null
  id: resource_81f77452
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'France: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/216cd275-ef00-41e0-81f9-0309e3491ae8/resource/fabd2a3a-16c9-457d-a57e-37fe953cbfb1/download/ghs_pop_e2025_r2023a_54009_100_v1_0_fra.tif
  format: null
  id: resource_fabd2a3a
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-fra_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'France: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
