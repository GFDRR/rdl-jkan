...
- entity:
    ...
    url: https://data.humdata.org/dataset/panama-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/panama-road-surface-data
dataset_id: rdls_exp-pan_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0497 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0117 and 0.0111
  (in million kms), corressponding to 23.4856% and 22.3095% respectively of the total
  road length in the dataset region. 0.0269 million km or 54.2049% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0008 million km of information (corressponding
  to 3.0011% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/panama-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for Panama. A hybrid deep learning model was applied to classify road surfaces
    as paved or unpaved, generating predictions for ~0.0228 million km of roads (23.5%
    paved, 22.3% unpaved). The dataset integrates OSM-tagged surface information with
    AI-predicted classifications to provide comprehensive road surface coverage for
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/panama-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Panama: Road Surface Data (GeoJSON data for Panama.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_pan_roadsurface_lines.geojson
  format: null
  id: resource_74dcf6de
  ...
  title: Panama GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Panama: Road Surface Data (Geopackage data for Panama.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_pan_roadsurface_lines.gpkg
  format: null
  id: resource_38b71016
  ...
  temporal: null
  temporal_resolution: null
  title: Panama GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pan_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Panama: Road Surface Data'
version: null
vulnerability: null
---
