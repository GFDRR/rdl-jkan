...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-bes_nismod_sdkicra__saint-eustatius
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Saint-Eustatius. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796805
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796805
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Saint-Eustatius, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/10796805/files/BES.zip
  format: null
  id: resource_sdkicra_bes
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Saint-Eustatius
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-bes_nismod_sdkicra__saint-eustatius
spatial:
  bbox:
  - -68.42
  - 12.02
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/7626844/bonaire-saint-eustatius-and-saba.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Saint-Eustatius
version: 0.1.0
vulnerability: null
---
