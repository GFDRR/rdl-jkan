...
- entity:
    ...
    url: https://data.humdata.org/dataset/guadeloupe-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/guadeloupe-road-surface-data
dataset_id: rdls_exp-glp_heigit_guadelouperoadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/guadeloupe-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for Guadeloupe. A hybrid deep learning model was applied to classify road surfaces
    as paved or unpaved, generating predictions with confidence metrics. The dataset
    combines OSM-tagged surface information with AI-predicted surface classifications
    to create a comprehensive road surface inventory for humanitarian access and infrastructure
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guadeloupe-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Guadeloupe: Road Surface Data (GeoJSON data for Guadeloupe.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_glp_roadsurface_lines.geojson
  format: null
  id: resource_a2bacac9
  ...
  title: Guadeloupe GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Guadeloupe: Road Surface Data (Geopackage data for Guadeloupe.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_glp_roadsurface_lines.gpkg
  format: null
  id: resource_34893e94
  ...
  temporal: null
  temporal_resolution: null
  title: Guadeloupe GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-glp_heigit_guadelouperoadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Guadeloupe: Road Surface Data'
version: null
vulnerability: null
---
