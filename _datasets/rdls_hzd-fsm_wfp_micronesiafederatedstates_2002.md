...
- entity:
    ...
    url: https://data.humdata.org/dataset/fsm-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/fsm-ndvi-subnational
dataset_id: rdls_hzd-fsm_wfp_micronesiafederatedstates_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/fsm-ndvi-subnational]'
...
lineage:
  description: MODIS Aqua and Terra 16-day composite NDVI products (MYD13C1 and MOD13C1)
    were synthesized into 8-day dekadal composites and aggregated to WFP-defined sub-national
    administrative units. Dekadal NDVI values (vim), long-term averages (vim_lta),
    and percentage anomalies (viq) were computed for each administrative unit with
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fsm-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135507789699_d88b627b'
  download_url: https://data.humdata.org/dataset/73624304-fd3d-41dd-9c8d-0994a2a46bcf/resource/ce5a9804-8bcc-4323-99f8-9839f083643a/download/fsm-ndvi-subnat-full.csv
  format: null
  id: resource_ce5a9804
  media_type: text/csv
  spatial: null
  ...
  title: fsm-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135507789699_d88b627b'
  download_url: https://data.humdata.org/dataset/73624304-fd3d-41dd-9c8d-0994a2a46bcf/resource/ae1bf2e6-3fb5-4543-9a0b-a212c92724d0/download/fsm-ndvi-subnat-5ytd.csv
  format: null
  id: resource_ae1bf2e6
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: fsm-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-fsm_wfp_micronesiafederatedstates_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Micronesia (Federated States of): NDVI at Subnational Level'
version: null
vulnerability: null
---
