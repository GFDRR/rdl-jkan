...
- entity:
    ...
    url: https://data.humdata.org/dataset/per-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/per-ghsl
dataset_id: rdls_exp-per_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/per-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. The Peru subset represents national-scale exposure data derived
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/per-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/8c310726-cf90-4da2-b33e-10df550a029a/resource/6cd11970-e002-496d-85a9-ca1b27290c0d/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_per.tif
  format: null
  id: resource_6cd11970
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Peru: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/8c310726-cf90-4da2-b33e-10df550a029a/resource/18af13cb-7d8b-4093-9f22-5e077c01badf/download/ghs_pop_e2025_r2023a_54009_100_v1_0_per.tif
  format: null
  id: resource_18af13cb
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-per_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Peru: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
