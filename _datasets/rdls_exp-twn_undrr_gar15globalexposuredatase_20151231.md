...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-taiwan-province-of-china
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-taiwan-province-of-china
dataset_id: rdls_exp-twn_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-taiwan-province-of-china]'
...
lineage:
  description: National-level socio-economic and building type statistics were transposed
    onto 5x5 km and 1x1 km geographic grids using population distribution and GDP
    as spatial proxies. The dataset was developed collaboratively by UNEP-GRID, WAPMERR,
    JRC, and Kokusai Kogyo for the GAR15 global exposure database to support disaster
    risk assessment.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-taiwan-province-of-china
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Taiwan, Province of China.zip
  download_url: https://data.humdata.org/dataset/a2c90e81-c67c-4ee2-8318-3d7453c0943a/resource/64fc9084-907a-424b-b359-06dd058df204/download/twn.zip
  format: null
  id: resource_64fc9084
  ...
  title: GAR15 Global Exposure Dataset for Taiwan, Province of China.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-twn_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Taiwan, Province of China
version: null
vulnerability: null
---
