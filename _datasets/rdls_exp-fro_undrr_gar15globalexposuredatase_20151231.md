...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-faroe-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-faroe-islands
dataset_id: rdls_exp-fro_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-faroe-islands]'
...
lineage:
  description: The GAR15 global exposure database was developed using a top-down approach
    ...
    density and GDP as spatial proxies. The dataset for Faroe Islands represents a
    subset of this global compilation, integrating inputs from multiple international
    agencies (UNEP-GRID, WAPMERR, JRC, Kokusai Kogyo) to estimate spatially-explicit
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-faroe-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Faroe Islands.zip
  download_url: https://data.humdata.org/dataset/d8e0436c-0b17-46b3-96a2-d094bf6e728c/resource/eda95244-f31a-425e-9886-b1d6a0454e06/download/fro.zip
  format: null
  id: resource_eda95244
  ...
  title: GAR15 Global Exposure Dataset for Faroe Islands.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-fro_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Faroe Islands
version: null
vulnerability: null
---
