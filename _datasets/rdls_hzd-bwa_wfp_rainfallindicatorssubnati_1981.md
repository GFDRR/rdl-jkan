...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/bwa-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/bwa-rainfall-subnational
dataset_id: rdls_hzd-bwa_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/bwa-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    administrative units. These indicators serve as meteorological drought monitoring
    metrics for early warning and food security assessment.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bwa-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135720023130_542409c7'
  download_url: https://data.humdata.org/dataset/fc2db06a-9595-407b-b13b-25686a927915/resource/99aad529-242a-4d76-894f-9f8f6c1238d3/download/bwa-rainfall-subnat-full.csv
  format: null
  id: resource_99aad529
  media_type: text/csv
  spatial: null
  ...
  title: bwa-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135720023130_542409c7'
  download_url: https://data.humdata.org/dataset/fc2db06a-9595-407b-b13b-25686a927915/resource/6c123bcc-0f8e-4a8e-bc75-aa183d2a62f0/download/bwa-rainfall-subnat-5ytd.csv
  format: null
  id: resource_6c123bcc
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: bwa-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bwa_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Botswana: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
