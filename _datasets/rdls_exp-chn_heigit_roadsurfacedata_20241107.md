...
- entity:
    ...
    url: https://data.humdata.org/dataset/china-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/china-road-surface-data
dataset_id: rdls_exp-chn_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 6.1163 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.6539 and 0.0775
  (in million kms), corressponding to 10.6909% and 1.2663% respectively of the total
  road length in the dataset region. 5.385 million km or 88.0428% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.012 million km of information (corressponding
  to 0.2231% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/china-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The resulting dataset provides 6.1163 million km of mapped roads with surface
    type predictions, enabling infrastructure exposure assessment for humanitarian
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/china-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'China: Road Surface Data (GeoJSON data for China.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_chn_roadsurface_lines.geojson
  format: null
  id: resource_45d3af6b
  ...
  title: China GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'China: Road Surface Data (Geopackage data for China.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_chn_roadsurface_lines.gpkg
  format: null
  id: resource_f88419e7
  ...
  temporal: null
  temporal_resolution: null
  title: China GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-chn_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
