...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-netherlands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-netherlands
dataset_id: rdls_exp-nld_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-netherlands]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    a spatially-explicit inventory of economic and population assets for the Netherlands.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-netherlands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Netherlands.zip
  download_url: https://data.humdata.org/dataset/d976e15f-1659-4739-8d6b-5ab1d8ac2d99/resource/7fdaca19-861f-469f-a588-e6164243b976/download/nld.zip
  format: null
  id: resource_7fdaca19
  ...
  title: GAR15 Global Exposure Dataset for Netherlands.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nld_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Netherlands
version: null
vulnerability: null
---
