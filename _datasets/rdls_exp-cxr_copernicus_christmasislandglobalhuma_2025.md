...
- entity:
    ...
    url: https://data.humdata.org/dataset/cxr-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cxr-ghsl
dataset_id: rdls_exp-cxr_copernicus_christmasislandglobalhuma_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cxr-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    For Christmas Island, this produces rasterized exposure layers representing building
    infrastructure and human settlement patterns.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cxr-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/0ee551b2-c097-44ed-ad27-8fad8be41b1b/resource/d5167430-f441-4e3a-a0ad-f7255668b2a7/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cxr.tif
  format: null
  id: resource_d5167430
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Christmas Island: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/0ee551b2-c097-44ed-ad27-8fad8be41b1b/resource/09df83f0-471a-4666-97b5-7eaabb97c5f9/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cxr.tif
  format: null
  id: resource_09df83f0
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cxr_copernicus_christmasislandglobalhuma_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Christmas Island: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
