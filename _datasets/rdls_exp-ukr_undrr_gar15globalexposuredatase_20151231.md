...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ukraine
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ukraine
dataset_id: rdls_exp-ukr_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ukraine]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    for the Global Assessment Report 2015 (GAR15) with multi-agency collaboration
    to create a standardized global exposure inventory for Ukraine.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ukraine
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Ukraine.zip
  download_url: https://data.humdata.org/dataset/7f41b463-9022-4c70-a92d-48197c9f6d38/resource/f057b2d3-04bd-468c-a561-529580613957/download/gar_exp_ukr.zip
  format: null
  id: resource_f057b2d3
  ...
  title: GAR15 Global Exposure Dataset for Ukraine.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ukr_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Ukraine
version: null
vulnerability: null
---
