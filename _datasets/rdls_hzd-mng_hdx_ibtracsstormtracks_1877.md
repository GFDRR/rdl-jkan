...
- entity:
    ...
    url: https://data.humdata.org/dataset/mng-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mng-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mng_hdx_ibtracsstormtracks_1877
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mng-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Mongolia subset contains observed cyclone positions,
    timestamps, basin classifications, wind speeds (wmo_wind), and central pressure
    (wmo_pres) for all storms affecting or passing through the country, provided in
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mng-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1877 to date that pass within 2000 kilometers
    of Mongolia.
  download_url: https://data.humdata.org/dataset/4b58ed26-e978-4b24-95d6-8159ebed554b/resource/76d3f931-6de3-4414-a512-d940828432fd/download/ibtracs_all_list_v04r01_mng.csv
  format: null
  id: resource_76d3f931
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MNG.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1877 to date that pass within 2000 kilometers
    of Mongolia.
  download_url: https://data.humdata.org/dataset/4b58ed26-e978-4b24-95d6-8159ebed554b/resource/4a0f28cc-60a0-4a4d-98e2-c026159657ce/download/ibtracs_all_list_v04r01_lines_mng.geojson
  format: null
  id: resource_4a0f28cc
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MNG.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mng_hdx_ibtracsstormtracks_1877
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1877-05-15'
temporal_resolution: null
title: 'Mongolia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
