...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-united-republic-of-tanzania
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-united-republic-of-tanzania
dataset_id: rdls_exp-tza_kontur_unitedrepublicadministrat_20220407
description: 'United Republic of Tanzania administrative division with aggregated
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-united-republic-of-tanzania]'
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries for Tanzania were extracted from OpenStreetMap
    and enriched with aggregated population data from the Kontur Population dataset
    (400m H3 hexagons). Population counts were aggregated to administrative division
    level and supplemented with HASC codes from Wikidata to create a baseline population
    exposure dataset.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-united-republic-of-tanzania
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_TZ_20220407.gpkg.gz
  format: null
  id: resource_cd879b8b
  ...
  title: kontur_boundaries_TZ_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_TZ_20230628.gpkg.gz
  format: null
  id: resource_fe26ba56
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_TZ_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'United Republic of Tanzania: Administrative Division with Aggregated
    Population (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_TZ_20230628.gpkg.gz
  format: null
  id: resource_894346d3
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_TZ_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tza_kontur_unitedrepublicadministrat_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'United Republic of Tanzania: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
