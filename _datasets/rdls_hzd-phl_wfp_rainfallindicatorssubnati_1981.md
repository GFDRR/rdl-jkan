...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/phl-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/phl-rainfall-subnational
dataset_id: rdls_hzd-phl_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    ...
    averages computed to support drought monitoring and early warning at the provincial
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/phl-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135601988934_726e3bb4'
  download_url: https://data.humdata.org/dataset/275e3ada-0b7d-4e10-9159-ec09970ff9e5/resource/671b718c-5fa8-45e9-801a-02212e21e809/download/phl-rainfall-subnat-full.csv
  format: null
  id: resource_671b718c
  media_type: text/csv
  spatial: null
  ...
  title: phl-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135601988934_726e3bb4'
  download_url: https://data.humdata.org/dataset/275e3ada-0b7d-4e10-9159-ec09970ff9e5/resource/31bcceed-793a-4d02-861c-d227485253fc/download/phl-rainfall-subnat-5ytd.csv
  format: null
  id: resource_31bcceed
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: phl-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-phl_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Philippines: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
