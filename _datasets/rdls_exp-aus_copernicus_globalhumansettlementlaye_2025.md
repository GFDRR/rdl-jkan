...
- entity:
    ...
    url: https://data.humdata.org/dataset/aus-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/aus-ghsl
dataset_id: rdls_exp-aus_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/aus-ghsl]'
...
lineage:
  description: The GHSL dataset integrates multi-source geospatial data including
    ...
    information through automated spatial data processing technologies to extract
    built-up surface extent and gridded population distribution at high resolution.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/aus-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/56b5d4f8-a9bd-4436-bc6d-a2c797c099b3/resource/9fdf964a-7950-4516-ba32-b035908e98ba/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_aus.tif
  format: null
  id: resource_9fdf964a
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Australia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/56b5d4f8-a9bd-4436-bc6d-a2c797c099b3/resource/746f4216-95e6-4137-8892-453882088ec0/download/ghs_pop_e2025_r2023a_54009_100_v1_0_aus.tif
  format: null
  id: resource_746f4216
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-aus_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Australia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
