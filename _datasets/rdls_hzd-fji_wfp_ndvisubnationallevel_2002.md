...
- entity:
    ...
    url: https://data.humdata.org/dataset/fji-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/fji-ndvi-subnational
dataset_id: rdls_hzd-fji_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/fji-ndvi-subnational]'
...
lineage:
  description: Raw MODIS Aqua and Terra 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI indicators at sub-national administrative units defined by WFP boundaries.
    Derived metrics include raw NDVI (vim), long-term average (vim_lta), and percentage
    anomaly (viq) to characterize vegetation health and drought conditions.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fji-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135501144741_52b8442a'
  download_url: https://data.humdata.org/dataset/f04044e8-0e74-4466-b81b-0b6e8e263059/resource/a74fea57-63fa-4d22-8daa-b5f5a16cb0b7/download/fji-ndvi-subnat-full.csv
  format: null
  id: resource_a74fea57
  media_type: text/csv
  spatial: null
  ...
  title: fji-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135501144741_52b8442a'
  download_url: https://data.humdata.org/dataset/f04044e8-0e74-4466-b81b-0b6e8e263059/resource/a6cdf170-6174-4b0d-9911-3ff78214b205/download/fji-ndvi-subnat-5ytd.csv
  format: null
  id: resource_a6cdf170
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: fji-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-fji_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Fiji: NDVI at Subnational Level'
version: null
vulnerability: null
---
