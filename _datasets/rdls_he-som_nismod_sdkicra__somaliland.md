...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-som_nismod_sdkicra__somaliland
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Somaliland. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10410911
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10410911
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Somaliland, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/10410911/files/SOM.zip
  format: null
  id: resource_sdkicra_som
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Somaliland
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-som_nismod_sdkicra__somaliland
spatial:
  bbox:
  - 40.97
  - -1.7
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/51537/somalia.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Somaliland
version: 0.1.0
vulnerability: null
---
