...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-new-zealand
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-new-zealand
dataset_id: rdls_exp-nzl_kontur_populationdensity400mh3he_2023
description: 'New Zealand population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-new-zealand]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    and national datasets (GHSL, HRSL, Microsoft Buildings, Copernicus Land Cover,
    LINZ, and OpenStreetMap) and aggregating the results to 400m H3 hexagonal grid
    cells using the H3 hierarchical spatial indexing system. The dataset provides
    baseline population exposure at sub-kilometer resolution for New Zealand.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-new-zealand
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'New Zealand: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_NZ_20220630.gpkg.gz
  format: null
  id: resource_699e6ddf
  ...
  title: kontur_population_NZ_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'New Zealand: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_NZ_20231101.gpkg.gz
  format: null
  id: resource_285f4227
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_NZ_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nzl_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'New Zealand: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
