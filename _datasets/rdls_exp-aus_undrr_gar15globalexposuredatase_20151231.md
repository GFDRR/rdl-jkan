...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-australia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-australia
dataset_id: rdls_exp-aus_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-australia]'
...
- asset_type:
    description: Economic value of building stock distributed across 5x5 km and 1x1
      km grids using top-down approach
    id: buildings
    scheme: null
    title: null
    uri: null
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    were transposed onto 5x5 km and 1x1 km geographic grids using gridded population
    data and GDP as spatial proxies. The dataset was developed by UNEP-GRID for the
    GAR15 global exposure database with multi-agency collaboration to estimate economic
    value and distribution of exposed assets across Australia.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-australia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Australia.zip
  download_url: https://data.humdata.org/dataset/7009ca53-1552-4436-b726-8176c15b8ad2/resource/07786b64-c52a-4846-bc13-6e04801db4d4/download/aus.zip
  format: null
  id: resource_07786b64
  ...
  title: GAR15 Global Exposure Dataset for Australia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-aus_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Australia
version: null
vulnerability: null
---
