...
- entity:
    ...
    url: https://data.humdata.org/dataset/mtq-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mtq-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mtq_hdx_martiniqueibtracsstormtra_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mtq-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone track data from multiple national
    ...
    observed storm positions, wind speeds (wmo_wind), and central pressure (wmo_pres)
    at regular time intervals, providing the most complete global collection of tropical
    cyclone observations for Martinique.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mtq-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Martinique.
  download_url: https://data.humdata.org/dataset/ae46d46c-02d3-4c91-92fb-c477882f3260/resource/0cdea9b9-d3ad-4520-a8f3-de719ca40bae/download/ibtracs_all_list_v04r01_mtq.csv
  format: null
  id: resource_0cdea9b9
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MTQ.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Martinique.
  download_url: https://data.humdata.org/dataset/ae46d46c-02d3-4c91-92fb-c477882f3260/resource/4f083ac3-f2b8-435e-a0f9-81f96d1ed50a/download/ibtracs_all_list_v04r01_lines_mtq.geojson
  format: null
  id: resource_4f083ac3
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MTQ.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mtq_hdx_martiniqueibtracsstormtra_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Martinique: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
