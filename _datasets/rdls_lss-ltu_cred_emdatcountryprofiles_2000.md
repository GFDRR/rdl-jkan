...
- entity:
    ...
    url: https://data.humdata.org/dataset/emdat-country-profiles-ltu
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Centre for Research on the Epidemiology of Disasters
  url: https://data.humdata.org/dataset/emdat-country-profiles-ltu
dataset_id: rdls_lss-ltu_cred_emdatcountryprofiles_2000
description: 'Aggregated figures for natural hazard related events in EM-DAT: Lithuania
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/emdat-country-profiles-ltu]'
details: null
exposure: []
hazard: null
...
lineage:
  description: EM-DAT aggregates historical natural disaster event records from multiple
    sources into a standardized registry. This country profile for Lithuania compiles
    event-level data into annual summaries of total affected populations, deaths,
    and economic damages across all disaster types and subtypes.
  sources:
  - id: source_1
    license: null
    name: EM-DAT (Emergency Events Database)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/emdat-country-profiles-ltu
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: 'EM-DAT - Country Profiles, Lithuania (Version: 2026-01-30)'
  download_url: https://data.humdata.org/dataset/5e4cb152-b8e8-49dd-b546-795e864f8d30/resource/b21dd5c0-9fac-411b-bd20-4afaa642e2f0/download/emdat-country-profiles_ltu_2026_01_30.xlsx
  format: null
  id: resource_b21dd5c0
  ...
  title: EMDAT-country-profiles_LTU_2026_01_30.xlsx
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-ltu_cred_emdatcountryprofiles_2000
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2000-01-01'
temporal_resolution: null
title: EM-DAT - Country Profiles, Lithuania
version: null
vulnerability: null
---
