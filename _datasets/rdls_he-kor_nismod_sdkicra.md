...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-kor_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for South Korea. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796591
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796591
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    South Korea, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/10796591/files/KOR.zip
  format: null
  id: resource_sdkicra_kor
...
- exposure
schema: rdls-10
slug: rdls_he-kor_nismod_sdkicra
spatial:
  bbox:
  - 124.61
  - 33.2
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/1835841/south-korea.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for South Korea
version: 0.1.0
vulnerability: null
---
