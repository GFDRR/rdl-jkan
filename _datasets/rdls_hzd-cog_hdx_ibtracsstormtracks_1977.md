...
- entity:
    ...
    url: https://data.humdata.org/dataset/cog-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/cog-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-cog_hdx_ibtracsstormtracks_1977
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cog-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    ...
    are quality-controlled and merged using standardized algorithms to create consistent
    track geometries with associated wind speed (wmo_wind) and pressure (wmo_pres)
    measurements at 6-hourly intervals.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cog-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1977 to date that pass within 2000 kilometers
    of Congo.
  download_url: https://data.humdata.org/dataset/1b6134d4-e3cf-45b6-bcf8-2cc7fdb627b2/resource/5d761c70-343c-43b6-aa9d-036b4ca5190d/download/ibtracs_all_list_v04r01_cog.csv
  format: null
  id: resource_5d761c70
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_COG.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1977 to date that pass within 2000 kilometers
    of Congo.
  download_url: https://data.humdata.org/dataset/1b6134d4-e3cf-45b6-bcf8-2cc7fdb627b2/resource/cfa05b5b-c857-460a-8ad5-b37796d46bfa/download/ibtracs_all_list_v04r01_lines_cog.geojson
  format: null
  id: resource_cfa05b5b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_COG.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cog_hdx_ibtracsstormtracks_1977
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1977-01-25'
temporal_resolution: null
title: 'Congo: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
