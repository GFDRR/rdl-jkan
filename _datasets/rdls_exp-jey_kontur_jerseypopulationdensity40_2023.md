...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-jersey
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-jersey
dataset_id: rdls_exp-jey_kontur_jerseypopulationdensity40_2023
description: 'Jersey population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-jersey]'
...
lineage:
  description: Population density estimates were derived by fusing multiple satellite-based
    settlement layers (GHSL, HRSL), building footprints (Microsoft), land cover data
    (Copernicus), and OpenStreetMap features into a unified H3 hexagonal grid at 400m
    resolution. The multi-source fusion approach integrates complementary datasets
    to improve accuracy of population distribution across Jersey, with results aggregated
    to standardized hexagonal spatial units for disaster risk assessment applications.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-jersey
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Jersey: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_JE_20220630.gpkg.gz
  format: null
  id: resource_1617db31
  ...
  title: kontur_population_JE_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Jersey: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_JE_20231101.gpkg.gz
  format: null
  id: resource_1cf830d1
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_JE_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-jey_kontur_jerseypopulationdensity40_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Jersey: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
