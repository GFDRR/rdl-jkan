...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-solomon-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-solomon-islands
dataset_id: rdls_exp-slb_kontur_administrativedivisionagg_20220407
description: 'Solomon Islands administrative division with aggregated population.
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-solomon-islands]'
...
lineage:
  description: Administrative boundaries for Solomon Islands were extracted from OpenStreetMap
    and enriched with aggregated population data from the Kontur Population dataset
    (400m H3 hexagons). The resulting dataset provides baseline population exposure
    at administrative division levels, enriched with HASC codes from Wikidata.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-solomon-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Solomon Islands: Administrative Division with Aggregated Population
    (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_SB_20220407.gpkg.gz
  format: null
  id: resource_2fdf2620
  ...
  title: kontur_boundaries_SB_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Solomon Islands: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_SB_20230628.gpkg.gz
  format: null
  id: resource_2e374047
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_SB_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Solomon Islands: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_SB_20230628.gpkg.gz
  format: null
  id: resource_70bd0680
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_SB_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-slb_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Solomon Islands: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
