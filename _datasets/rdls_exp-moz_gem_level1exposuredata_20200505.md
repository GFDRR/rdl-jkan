...
- entity:
    ...
    url: https://data.humdata.org/dataset/mozambique-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/mozambique-level-1-exposure-data
dataset_id: rdls_exp-moz_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mozambique-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was generated through the METEOR project using
    Earth observation routines to estimate building stock characteristics (count,
    area, rebuilding value) at 15-arcsecond grid resolution (~500m). The dataset represents
    Level 1 global-quality exposure data with minimal country-specific calibration,
    designed for catastrophe modeling and loss estimation applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project (Modelling Exposure Through Earth Observation Routines)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mozambique-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Mozambique produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/953403ad-5a0e-4129-b237-d95490f9f455/resource/48542fd7-fbc5-4c61-999e-af3dce566f2f/download/moz_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_48542fd7
  ...
  title: MOZ_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-moz_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Mozambique: Level 1 Exposure Data'
version: null
vulnerability: null
---
