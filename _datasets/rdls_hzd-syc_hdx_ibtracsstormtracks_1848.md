...
- entity:
    ...
    url: https://data.humdata.org/dataset/syc-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/syc-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-syc_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/syc-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Seychelles subset contains track points with ISO timestamps, basin/subbasin
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/syc-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Seychelles.
  download_url: https://data.humdata.org/dataset/8247e60c-cd9a-42f8-9642-adc7c3c4ee6b/resource/be4ac975-4728-42f3-9b5d-4fce8ccc3f63/download/ibtracs_all_list_v04r01_syc.csv
  format: null
  id: resource_be4ac975
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SYC.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Seychelles.
  download_url: https://data.humdata.org/dataset/8247e60c-cd9a-42f8-9642-adc7c3c4ee6b/resource/8913624b-367b-4dfc-8373-aa3b74078f41/download/ibtracs_all_list_v04r01_lines_syc.geojson
  format: null
  id: resource_8913624b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SYC.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-syc_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'Seychelles: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
