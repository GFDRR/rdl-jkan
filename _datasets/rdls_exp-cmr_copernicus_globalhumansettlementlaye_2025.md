...
- entity:
    ...
    url: https://data.humdata.org/dataset/cmr-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cmr-ghsl
dataset_id: rdls_exp-cmr_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cmr-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distribution. The Cameroon
    dataset represents the national application of this global methodology, producing
    rasterized exposure layers of human settlements and population density.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cmr-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/262d05b8-058e-423a-ae8a-3096f51250e8/resource/de5329a8-ac6e-4c0b-a369-47561f62ebff/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cmr.tif
  format: null
  id: resource_de5329a8
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Cameroon: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/262d05b8-058e-423a-ae8a-3096f51250e8/resource/6f6062aa-1ff4-4bc0-960b-14d589217e7d/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cmr.tif
  format: null
  id: resource_6f6062aa
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cmr_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Cameroon: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
