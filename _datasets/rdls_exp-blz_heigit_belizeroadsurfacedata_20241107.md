...
- entity:
    ...
    url: https://data.humdata.org/dataset/belize-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/belize-road-surface-data
dataset_id: rdls_exp-blz_heigit_belizeroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/belize-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    ...
    The model generated predictions for roads with missing or uncertain surface information,
    producing a comprehensive inventory of road infrastructure with predicted surface
    classifications across Belize.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/belize-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Belize: Road Surface Data (GeoJSON data for Belize.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_blz_roadsurface_lines.geojson
  format: null
  id: resource_3dc2525c
  ...
  title: Belize GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Belize: Road Surface Data (Geopackage data for Belize.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_blz_roadsurface_lines.gpkg
  format: null
  id: resource_3aecdb33
  ...
  temporal: null
  temporal_resolution: null
  title: Belize GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-blz_heigit_belizeroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Belize: Road Surface Data'
version: null
vulnerability: null
---
