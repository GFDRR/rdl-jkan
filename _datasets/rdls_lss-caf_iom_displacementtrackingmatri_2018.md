...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/caf-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/caf-iom-dtm-from-api
dataset_id: rdls_lss-caf_iom_displacementtrackingmatri_2018
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/caf-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced persons across Central
    African Republic at admin 0-2 levels. Data is aggregated by displacement reason,
    demographics (sex), and origin location, then published via the DTM API for humanitarian
    and research use.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/caf-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Central African Republic IOM displacement tracking matrix data at admin
    levels 0-2, sourced from the DTM API
  download_url: https://data.humdata.org/dataset/5f25b399-2026-405b-8ee7-1889ba5dc7b9/resource/1f9a407e-eda8-48f9-9eea-0389a8c55bf7/download/caf-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_1f9a407e
  media_type: text/csv
  spatial: null
  ...
  title: Central African Republic IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-caf_iom_displacementtrackingmatri_2018
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2018-01-31'
temporal_resolution: null
title: Central African Republic IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
