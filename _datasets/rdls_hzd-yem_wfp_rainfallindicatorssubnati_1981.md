...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/yem-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/yem-rainfall-subnational
dataset_id: rdls_hzd-yem_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/yem-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery integrated with
    in-situ station observations, aggregated into dekadal indicators (10-day, 1-month,
    and 3-month rolling aggregations) at subnational administrative units in Yemen.
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/yem-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135818477746_427d2198'
  download_url: https://data.humdata.org/dataset/902bd76c-3f3c-42ad-8547-f9c31deb7937/resource/5d91232a-96a2-442b-8e7e-223aad7f8dad/download/yem-rainfall-subnat-full.csv
  format: null
  id: resource_5d91232a
  media_type: text/csv
  spatial: null
  ...
  title: yem-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135818477746_427d2198'
  download_url: https://data.humdata.org/dataset/902bd76c-3f3c-42ad-8547-f9c31deb7937/resource/d268db20-e38e-4dc2-a262-3fbefd73e0e4/download/yem-rainfall-subnat-5ytd.csv
  format: null
  id: resource_d268db20
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: yem-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-yem_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Yemen: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
