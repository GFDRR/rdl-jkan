...
dataset_id: rdls_hzd-T2M_dayover25_duetourban_ZAF
...
purpose: 'This dataset is part of the scientific paper: Souverijns, N., De Ridder,
  ...
  and vulnerability analysis. Urban Climate, 46, 101331. https://doi.org/10.1016/j.uclim.2022.101338'
resources:
- coordinate_system: EPSG:4326
  ...
  title: "Days with Maximum Temperature > 25\xB0C Due to Urban Canopy - Johannebsurg\
    \ & Ekurhuleni (2001-2020)"
- coordinate_system: EPSG:4326
  description: "Projected number of days when the maximum temperature exceeds 25\xB0\
...
- coordinate_system: EPSG:4326
  description: "Projected number of days when the maximum temperature exceeds 25\xB0\
    C due to urban canopy effects under theRCP 4.5 and 8.5 scenario for 2041-2060."
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '2'
  spatial_resolution: null
...
- hazard
schema: rdl-02
slug: rdls_hzd-T2M_dayover25_duetourban_ZAF
spatial:
  bbox:
  - 27.676831894273278
  - -26.580113703331147
  ...
  - description: City of Ekurhuleni, Gauteng Province
    ...
    scheme: ISO 3166-2
  scale: sub-national
title: "Days with Maximum Temperature > 25\xB0C Due to Urban Canopy"
