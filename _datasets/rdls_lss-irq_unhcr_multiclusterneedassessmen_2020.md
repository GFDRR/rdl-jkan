...
- entity:
    ...
    email: null
    name: REACH
    url: https://data.humdata.org/dataset/unhcr-irq-2020-mcna-v2-1
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: UNHCR - The UN Refugee Agency
  url: https://data.humdata.org/dataset/unhcr-irq-2020-mcna-v2-1
dataset_id: rdls_lss-irq_unhcr_multiclusterneedassessmen_2020
description: 'The Multi Cluster Needs Assessment (MCNA) is an iterative cluster-led
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/unhcr-irq-2020-mcna-v2-1]'
...
lineage:
  description: Household-level needs data collected via computer-assisted personal
    ...
    health, livelihoods, protection, shelter) to provide quantitative evidence of
    multi-sectoral needs among conflict-affected populations for humanitarian planning
    and prioritization.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/unhcr-irq-2020-mcna-v2-1
  rel: source
loss:
  losses:
  ...
  - asset_category: buildings
    ...
    description: Shelter and infrastructure needs assessment for affected households
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_earthquake
  ...
  - asset_category: agriculture
    ...
    description: Food security and livelihood needs of conflict-affected populations
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_earthquake
...
referenced_by: []
resources:
- access_url: https://microdata.unhcr.org/index.php/auth/login/?destination=catalog/912/get-microdata
  ...
  title: Iraq - Iraq Multi Cluster Need Assessment, 2020
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Iraq - Iraq Multi Cluster Need Assessment, 2020 (Contains information
    about the dataset's metadata and data)
  download_url: https://microdata.unhcr.org/index.php/catalog/912/pdf-documentation
  format: null
  id: resource_a9343331
...
- loss
schema: rdls-10
slug: rdls_lss-irq_unhcr_multiclusterneedassessmen_2020
spatial:
  bbox: null
  centroid: null
  countries:
