...
- entity:
    ...
    url: https://data.humdata.org/dataset/lesotho-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/lesotho-road-surface-data
dataset_id: rdls_exp-lso_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.067 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0053 and 0.0131
  (in million kms), corressponding to 7.9664% and 19.589% respectively of the total
  road length in the dataset region. 0.0486 million km or 72.4446% of road surface
  ...
  to 0.2764% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lesotho-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    ...
    which are then integrated with existing OSM data to create a comprehensive road
    surface inventory for Lesotho.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lesotho-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Lesotho: Road Surface Data (GeoJSON data for Lesotho.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lso_roadsurface_lines.geojson
  format: null
  id: resource_1e1881b9
  ...
  title: Lesotho GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Lesotho: Road Surface Data (Geopackage data for Lesotho.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lso_roadsurface_lines.gpkg
  format: null
  id: resource_919fdbd3
  ...
  temporal: null
  temporal_resolution: null
  title: Lesotho GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lso_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Lesotho: Road Surface Data'
version: null
vulnerability: null
---
