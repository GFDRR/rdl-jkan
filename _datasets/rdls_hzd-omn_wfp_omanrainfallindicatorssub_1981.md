...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/omn-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/omn-rainfall-subnational
dataset_id: rdls_hzd-omn_wfp_omanrainfallindicatorssub_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/omn-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    1-month, and 3-month rolling sums) at subnational administrative units in Oman.
    Long-term climatological averages and anomaly indices were computed to support
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/omn-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135624909327_c983d11c'
  download_url: https://data.humdata.org/dataset/f802cb20-54a5-4393-95fe-7584ce347fa9/resource/f1e5a5d2-a079-4fc3-8a7a-dae236d27c05/download/omn-rainfall-subnat-full.csv
  format: null
  id: resource_f1e5a5d2
  media_type: text/csv
  spatial: null
  ...
  title: omn-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135624909327_c983d11c'
  download_url: https://data.humdata.org/dataset/f802cb20-54a5-4393-95fe-7584ce347fa9/resource/86cbc19b-11f6-42ef-8c93-09a2781cb01a/download/omn-rainfall-subnat-5ytd.csv
  format: null
  id: resource_86cbc19b
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: omn-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-omn_wfp_omanrainfallindicatorssub_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Oman: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
