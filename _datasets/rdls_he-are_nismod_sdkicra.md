...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-are_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for United Arab Emirates. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539701
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539701
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    United Arab Emirates, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16539701/files/ARE.zip
  format: null
  id: resource_sdkicra_are
...
- exposure
schema: rdls-10
slug: rdls_he-are_nismod_sdkicra
spatial:
  bbox:
  - 51.57
  - 22.62
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/290557/united-arab-emirates.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for United Arab
  Emirates
version: 0.2.1
vulnerability: null
---
