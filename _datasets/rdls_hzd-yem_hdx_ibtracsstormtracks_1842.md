...
- entity:
    ...
    url: https://data.humdata.org/dataset/yem-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/yem-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-yem_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/yem-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Yemen subset contains observed storm track positions (latitude, longitude,
    time), basin/sub-basin classifications, wind speed (wmo_wind), and central pressure
    (wmo_pres) measurements. Data is provided in both tabular (CSV) and geospatial
    (GeoJSON line) formats for analysis of tropical cyclone hazards.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/yem-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Yemen.
  download_url: https://data.humdata.org/dataset/c6ba5816-257f-4613-a308-bdfad0fdf2e0/resource/bb69112e-f021-4739-9c3f-c8a0b3b2d8fc/download/ibtracs_all_list_v04r01_yem.csv
  format: null
  id: resource_bb69112e
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_YEM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Yemen.
  download_url: https://data.humdata.org/dataset/c6ba5816-257f-4613-a308-bdfad0fdf2e0/resource/4900d2aa-e9f8-40a1-baa9-1311ed0acf19/download/ibtracs_all_list_v04r01_lines_yem.geojson
  format: null
  id: resource_4900d2aa
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_YEM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-yem_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Yemen: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
