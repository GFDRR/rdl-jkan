...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-botswana
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-botswana
dataset_id: rdls_exp-bwa_kontur_administrativedivisionagg_20220407
description: 'Botswana administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-botswana]'
...
lineage:
  description: Administrative boundaries for Botswana were extracted from OpenStreetMap
    data using proprietary filtering and enhancement methods. Population counts were
    aggregated from the Kontur Population dataset (400m H3 hexagon resolution) and
    joined to administrative divisions. Boundaries were enriched with HASC codes from
    Wikidata to create a baseline exposure dataset of population distribution across
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-botswana
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Botswana: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_BW_20220407.gpkg.gz
  format: null
  id: resource_f9501457
  ...
  title: kontur_boundaries_BW_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Botswana: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_BW_20230628.gpkg.gz
  format: null
  id: resource_9fec06d6
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_BW_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Botswana: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_BW_20230628.gpkg.gz
  format: null
  id: resource_e88cdba5
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_BW_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bwa_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Botswana: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
