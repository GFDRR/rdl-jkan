...
- entity:
    ...
    url: https://data.humdata.org/dataset/uzb-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/uzb-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-uzb_hdx_ibtracsstormtracks_1877
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/uzb-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple international
    agencies into a unified best-track archive. The Uzbekistan subset contains observed
    storm track positions, timestamps, basin classifications, wind speeds (wmo_wind),
    and central pressures (wmo_pres) for cyclones affecting or passing through the
    region, provided in both tabular and geospatial formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/uzb-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1877 to date that pass within 2000 kilometers
    of Uzbekistan.
  download_url: https://data.humdata.org/dataset/bf8b3d09-3e93-4b0e-be7e-595de298cb91/resource/baa021b5-dca0-4459-ae10-dc6367a85177/download/ibtracs_all_list_v04r01_uzb.csv
  format: null
  id: resource_baa021b5
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_UZB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1877 to date that pass within 2000 kilometers
    of Uzbekistan.
  download_url: https://data.humdata.org/dataset/bf8b3d09-3e93-4b0e-be7e-595de298cb91/resource/d456ca6e-3cb9-45da-9e5e-176bfc321ef3/download/ibtracs_all_list_v04r01_lines_uzb.geojson
  format: null
  id: resource_d456ca6e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_UZB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-uzb_hdx_ibtracsstormtracks_1877
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1877-07-11'
temporal_resolution: null
title: 'Uzbekistan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
