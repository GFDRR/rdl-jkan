...
- entity:
    ...
    url: https://data.humdata.org/dataset/libya-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/libya-road-surface-data
dataset_id: rdls_exp-lby_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/libya-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated surface type predictions for approximately 0.2478 million
    km of mapped roads in Libya, with results provided in GeoJSON and GeoPackage formats
    for spatial analysis and humanitarian logistics applications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/libya-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Libya: Road Surface Data (GeoJSON data for Libya.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lby_roadsurface_lines.geojson
  format: null
  id: resource_d4e0eb91
  ...
  title: Libya GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Libya: Road Surface Data (Geopackage data for Libya.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lby_roadsurface_lines.gpkg
  format: null
  id: resource_824d2612
  ...
  temporal: null
  temporal_resolution: null
  title: Libya GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lby_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
