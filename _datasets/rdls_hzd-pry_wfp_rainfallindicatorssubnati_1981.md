...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/pry-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/pry-rainfall-subnational
dataset_id: rdls_hzd-pry_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/pry-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    ...
    sums and anomalies) at subnational administrative units in Paraguay to support
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pry-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135614576486_33d89e1c'
  download_url: https://data.humdata.org/dataset/2335685f-8e34-4061-ab12-341cff520110/resource/d45e6456-14a4-405e-831d-af92ed31a749/download/pry-rainfall-subnat-full.csv
  format: null
  id: resource_d45e6456
  media_type: text/csv
  spatial: null
  ...
  title: pry-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135614576486_33d89e1c'
  download_url: https://data.humdata.org/dataset/2335685f-8e34-4061-ab12-341cff520110/resource/2a51d923-abf5-4e26-92cd-a2a911c657f6/download/pry-rainfall-subnat-5ytd.csv
  format: null
  id: resource_2a51d923
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: pry-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-pry_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Paraguay: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
