...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-trinidad-and-tobago
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-trinidad-and-tobago
dataset_id: rdls_exp-tto_kontur_populationdensity400mh3he_2023
description: 'Trinidad and Tobago population density for 400m H3 hexagons. Built from
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-trinidad-and-tobago]'
...
lineage:
  description: Population density estimates were generated by fusing multiple global
    ...
    OpenStreetMap) and aggregating results into H3 hexagonal grid cells at 400m resolution.
    The methodology overlays satellite-derived settlement layers with building footprints
    and land cover data to produce spatially consistent population counts suitable
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-trinidad-and-tobago
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Trinidad and Tobago: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TT_20220630.gpkg.gz
  format: null
  id: resource_a7feda71
  ...
  title: kontur_population_TT_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Trinidad and Tobago: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TT_20231101.gpkg.gz
  format: null
  id: resource_cf933cf0
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_TT_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tto_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Trinidad and Tobago: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
