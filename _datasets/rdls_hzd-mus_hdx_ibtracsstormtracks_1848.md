...
- entity:
    ...
    url: https://data.humdata.org/dataset/mus-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mus-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mus_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mus-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Mauritius subset contains observed storm positions,
    wind speeds (wmo_wind), central pressures (wmo_pres), and storm classification
    (nature) for all cyclones affecting or passing near Mauritius.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mus-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Mauritius.
  download_url: https://data.humdata.org/dataset/5217488b-2bbb-41f1-a0b7-ee1ec592b534/resource/3f3f12ec-b7e7-43cc-8737-e351d89173a4/download/ibtracs_all_list_v04r01_mus.csv
  format: null
  id: resource_3f3f12ec
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MUS.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Mauritius.
  download_url: https://data.humdata.org/dataset/5217488b-2bbb-41f1-a0b7-ee1ec592b534/resource/05ce2eaf-4255-4582-a76b-c478595f32e8/download/ibtracs_all_list_v04r01_lines_mus.geojson
  format: null
  id: resource_05ce2eaf
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MUS.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mus_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'Mauritius: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
