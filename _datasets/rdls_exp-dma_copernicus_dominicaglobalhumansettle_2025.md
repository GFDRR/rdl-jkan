...
- entity:
    ...
    url: https://data.humdata.org/dataset/dma-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/dma-ghsl
dataset_id: rdls_exp-dma_copernicus_dominicaglobalhumansettle_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/dma-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: The GHSL dataset for Dominica was generated through automated spatial
    ...
    to extract human settlement patterns and infrastructure presence at high spatial
    resolution.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dma-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/b470e1c7-0fe0-48fe-8274-659994ef6e74/resource/5ecdf66e-0faf-49b4-8552-fb7e6941781c/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_dma.tif
  format: null
  id: resource_5ecdf66e
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Dominica: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/b470e1c7-0fe0-48fe-8274-659994ef6e74/resource/420fcca7-21c8-4505-b919-0cfffeb52f89/download/ghs_pop_e2025_r2023a_54009_100_v1_0_dma.tif
  format: null
  id: resource_420fcca7
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-dma_copernicus_dominicaglobalhumansettle_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Dominica: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
