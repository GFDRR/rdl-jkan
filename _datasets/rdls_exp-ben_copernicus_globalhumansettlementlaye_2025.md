...
- entity:
    ...
    url: https://data.humdata.org/dataset/ben-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/ben-ghsl
dataset_id: rdls_exp-ben_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ben-ghsl]'
...
lineage:
  description: The GHSL dataset combines multi-temporal satellite imagery, census
    data, and crowdsourced geographic information processed through automated spatial
    data analytics to generate gridded estimates of built-up surface area and population
    distribution at fine resolution across Benin.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ben-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/9983e58f-20c0-4685-801b-dc293afdadb5/resource/3deb8d6f-9d59-4df8-acfc-2a8b6ad2be04/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_ben.tif
  format: null
  id: resource_3deb8d6f
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Benin: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/9983e58f-20c0-4685-801b-dc293afdadb5/resource/ce75a20b-9180-4fd6-9d35-0169bf1745f5/download/ghs_pop_e2025_r2023a_54009_100_v1_0_ben.tif
  format: null
  id: resource_ce75a20b
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-ben_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Benin: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
