...
- entity:
    ...
    url: https://data.humdata.org/dataset/ghana-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/ghana-road-surface-data
dataset_id: rdls_exp-gha_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2043 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0251 and 0.035
  (in million kms), corressponding to 12.2772% and 17.1205% respectively of the total
  road length in the dataset region. 0.1443 million km or 70.6023% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0012 million km of information (corressponding
  to 0.83% of total missing information on road surface) It is intended for use in
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ghana-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    type classification across Ghana, supporting humanitarian access and logistics
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ghana-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Ghana: Road Surface Data (GeoJSON data for Ghana.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_gha_roadsurface_lines.geojson
  format: null
  id: resource_cb00decd
  ...
  title: Ghana GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Ghana: Road Surface Data (Geopackage data for Ghana.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_gha_roadsurface_lines.gpkg
  format: null
  id: resource_0af4ce23
  ...
  temporal: null
  temporal_resolution: null
  title: Ghana GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gha_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
