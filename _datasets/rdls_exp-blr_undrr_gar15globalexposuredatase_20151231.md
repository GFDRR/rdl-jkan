...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-belarus
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-belarus
dataset_id: rdls_exp-blr_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-belarus]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    collaboration to create a globally consistent exposure inventory for Belarus.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-belarus
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Belarus.zip
  download_url: https://data.humdata.org/dataset/14e56a99-3a7e-461e-a59a-8c3dc585d999/resource/e8c83a60-8d91-4d4e-935f-9d418c6ca401/download/blr.zip
  format: null
  id: resource_e8c83a60
  ...
  title: GAR15 Global Exposure Dataset for Belarus.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-blr_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Belarus
version: null
vulnerability: null
---
