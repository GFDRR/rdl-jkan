...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-gab-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-gab-settlement-extents-v3-0
dataset_id: rdls_exp-gab_grid3_gabsettlementextentsv30_2016
description: 'The GRID3 GAB - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Gabon, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Gabon Settlement Extents,
  ...
  2024. GRID3 GAB - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-gab-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents and building counts were derived from open data
    using a new GRID3 methodology to generate settlement polygons and estimate building
    inventories. Spatial points at 100-meter resolution represent centroids of settled
    grid cells within settlement boundaries, with probability values assigned to characterize
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-gab-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Gabon - GRID3 GAB - Settlement Extents v3.0 (Contains information on
    data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/8f588399-744c-4120-a684-6a5c5a8f010f/resource/d0a87ac5-2ca9-4d3a-a6ce-068e666ecd9a/download/grid3-gab-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_d0a87ac5
  ...
  title: GRID3 GAB - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Gabon - GRID3 GAB - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/8f588399-744c-4120-a684-6a5c5a8f010f/resource/76a39929-ccf5-4590-bf3a-d69f05beda3b/download/grid3_gab_settlement_extents_v3_0.zip
  format: null
  id: resource_76a39929
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_GAB_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/8f588399-744c-4120-a684-6a5c5a8f010f/resource/71ef0012-f1df-42c8-9f03-08ba99bf66be/download/grid3_gab_settlement_grid_v3_0.zip
  format: null
  id: resource_71ef0012
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_GAB_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gab_grid3_gabsettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Gabon - GRID3 GAB - Settlement Extents v3.0
version: null
vulnerability: null
---
