...
contact_point:
  ...
  email: null
  name: WorldPop
  url: https://data.humdata.org/dataset/worldpop-population-counts-for-netherlands-kingdom-of-the
creator:
  affiliation: null
  email: null
  name: WorldPop
  url: https://data.humdata.org/dataset/worldpop-population-counts-for-netherlands-kingdom-of-the
dataset_id: rdls_exp-nld_worldpop_kingdompopulationcounts_2000
description: 'WorldPop produces different types of gridded population count datasets,
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/worldpop-population-counts-for-netherlands-kingdom-of-the]'
details: null
exposure:
- asset_type:
    description: Gridded population counts at 1km resolution for the Netherlands,
      estimated from census and ancillary data
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: WorldPop produced gridded population estimates by integrating census
    data with settlement maps and ancillary geospatial variables using customized
    country-specific methods. Population counts were aggregated to 1km grid cells
    and adjusted to match official national population totals. Multiple versions are
    provided including UN-adjusted and constrained variants for different analytical
    applications.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/worldpop-population-counts-for-netherlands-kingdom-of-the
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: Netherlands (Kingdom of the) - Population Counts (The spatial distribution
    of population in 2020, Netherlands)
  download_url: https://data.worldpop.org/GIS/Population/Global_2000_2020/2020/NLD/nld_ppp_2020.tif
  format: null
  id: resource_085cc095
...
- exposure
schema: rdls-10
slug: rdls_exp-nld_worldpop_kingdompopulationcounts_2000
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2000-01-01'
temporal_resolution: null
title: Netherlands (Kingdom of the) - Population Counts
version: null
vulnerability: null
---
