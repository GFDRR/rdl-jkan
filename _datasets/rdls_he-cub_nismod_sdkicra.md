...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-cub_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Cuba. Derived from global datasets clipped
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796627
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796627
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Cuba, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/10796627/files/CUB.zip
  format: null
  id: resource_sdkicra_cub
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Cuba
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-cub_nismod_sdkicra
spatial:
  bbox:
  - -84.95
  - 19.83
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3562981/cuba.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Cuba
version: 0.1.0
vulnerability: null
---
