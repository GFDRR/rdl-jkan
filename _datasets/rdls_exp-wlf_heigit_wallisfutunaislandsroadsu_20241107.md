...
- entity:
    ...
    url: https://data.humdata.org/dataset/wallis-and-futuna-islands-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/wallis-and-futuna-islands-road-surface-data
dataset_id: rdls_exp-wlf_heigit_wallisfutunaislandsroadsu_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/wallis-and-futuna-islands-road-surface-data]'
details: null
exposure:
- asset_type:
...
license: ODbL-1.0/
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-predicted
    surface classifications using a hybrid deep learning approach trained to distinguish
    paved from unpaved surfaces. The resulting dataset combines OSM geometry with
    predicted surface attributes to support humanitarian access and infrastructure
...
- access_url: null
  ...
  description: 'Wallis and Futuna Islands: Road Surface Data (GeoJSON data for Wallis
    and futuna islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_wlf_roadsurface_lines.geojson
  format: null
  id: resource_c99a0b3f
  ...
  title: Wallis and futuna islands GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Wallis and Futuna Islands: Road Surface Data (Geopackage data for
    Wallis and futuna islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_wlf_roadsurface_lines.gpkg
  format: null
  id: resource_f24dc74e
  ...
  temporal: null
  temporal_resolution: null
  title: Wallis and futuna islands GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-wlf_heigit_wallisfutunaislandsroadsu_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Wallis and Futuna Islands: Road Surface Data'
version: null
vulnerability: null
---
