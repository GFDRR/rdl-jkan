...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-saint-kitts-and-nevis
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-saint-kitts-and-nevis
dataset_id: rdls_exp-kontur_saintkittsnevispopulation_2023
description: 'Saint Kitts and Nevis population density for 400m H3 hexagons. Built
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-saint-kitts-and-nevis]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    and OpenStreetMap) and aggregating population counts into H3 hexagonal grid cells
    at 400m resolution using hierarchical spatial indexing. The dataset provides baseline
    population exposure data for Saint Kitts and Nevis at sub-kilometer spatial resolution.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- access_url: null
  ...
  description: 'Saint Kitts and Nevis: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_KN_20220630.gpkg.gz
  format: null
  id: resource_9a71c9ca
  ...
  title: kontur_population_KN_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Saint Kitts and Nevis: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_KN_20231101.gpkg.gz
  format: null
  id: resource_ee91084d
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_KN_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kontur_saintkittsnevispopulation_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Saint Kitts and Nevis: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
