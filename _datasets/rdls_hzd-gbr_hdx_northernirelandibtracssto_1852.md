...
- entity:
    ...
    url: https://data.humdata.org/dataset/gbr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/gbr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-gbr_hdx_northernirelandibtracssto_1852
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/gbr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    data includes observed storm positions (latitude/longitude), wind speeds (wmo_wind),
    central pressure (wmo_pres), and temporal information (iso_time) for all tropical
    cyclones affecting the United Kingdom region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gbr-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/662536c5-7fd7-48b5-9c03-09f0477e8e1a/resource/0f22fb71-5ff5-409f-b8a7-5618fe6a84bc/download/ibtracs_all_list_v04r01_gbr.csv
  format: null
  id: resource_0f22fb71
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GBR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of United Kingdom of Great Britain and Northern Ireland.
  download_url: https://data.humdata.org/dataset/662536c5-7fd7-48b5-9c03-09f0477e8e1a/resource/398f2a7e-5c52-4087-af29-97448a0bb6bb/download/ibtracs_all_list_v04r01_lines_gbr.geojson
  format: null
  id: resource_398f2a7e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GBR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gbr_hdx_northernirelandibtracssto_1852
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1852-09-02'
temporal_resolution: null
title: 'United Kingdom of Great Britain and Northern Ireland: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
