...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-malaysia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-malaysia
dataset_id: rdls_exp-mys_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-malaysia]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure database for Malaysia was developed using
    a top-down approach where national-level statistical data on socio-economic indicators,
    building types, and capital stock were transposed onto 5x5 km and 1x1 km grid
    cells using geographic distribution of population density and GDP as spatial proxies.
    The dataset integrates inputs from multiple international agencies (UNEP-GRID,
    WAPMERR, JRC, Kokusai Kogyo) to estimate the economic value and spatial distribution
    of exposed assets across the country.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-malaysia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Malaysia.zip
  download_url: https://data.humdata.org/dataset/4c063989-f312-4ec7-b108-65c65d7eed95/resource/25711307-cb1c-4d6d-8830-f05cf90b611c/download/mys.zip
  format: null
  id: resource_25711307
  ...
  title: GAR15 Global Exposure Dataset for Malaysia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mys_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Malaysia
version: null
vulnerability: null
---
