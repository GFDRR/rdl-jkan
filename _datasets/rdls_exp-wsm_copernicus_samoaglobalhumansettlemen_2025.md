...
- entity:
    ...
    url: https://data.humdata.org/dataset/wsm-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/wsm-ghsl
dataset_id: rdls_exp-wsm_copernicus_samoaglobalhumansettlemen_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/wsm-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite image data streams,
    ...
    of human settlements and population density across Samoa.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/wsm-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/6509e3a0-466a-48b7-b82e-c1f3eea24389/resource/11596ec6-9c6b-4238-91e3-95e712939d75/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_wsm.tif
  format: null
  id: resource_11596ec6
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Samoa: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/6509e3a0-466a-48b7-b82e-c1f3eea24389/resource/8782cccd-c3a6-49f3-86c5-06b00ab45aae/download/ghs_pop_e2025_r2023a_54009_100_v1_0_wsm.tif
  format: null
  id: resource_8782cccd
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-wsm_copernicus_samoaglobalhumansettlemen_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Samoa: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
