...
- entity:
    ...
    url: https://data.humdata.org/dataset/bfa-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bfa-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bfa_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bfa-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Burkina Faso subset contains observed storm positions,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bfa-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Burkina Faso.
  download_url: https://data.humdata.org/dataset/0f340fd3-4cda-4572-94c0-0bfec97741de/resource/0f255efe-eb53-4ef7-8a16-c633c7145a16/download/ibtracs_all_list_v04r01_bfa.csv
  format: null
  id: resource_0f255efe
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BFA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Burkina Faso.
  download_url: https://data.humdata.org/dataset/0f340fd3-4cda-4572-94c0-0bfec97741de/resource/e49be977-9c4a-4d95-9115-85f62903e326/download/ibtracs_all_list_v04r01_lines_bfa.geojson
  format: null
  id: resource_e49be977
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BFA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bfa_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Burkina Faso: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
