...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-belize
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-belize
dataset_id: rdls_exp-blz_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-belize]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    and GDP as spatial proxies. The dataset was developed collaboratively by UNEP-GRID,
    WAPMERR, JRC, and Kokusai Kogyo for the Global Assessment Report on Disaster Risk
    Reduction (GAR15) to create a spatially-explicit global exposure inventory for
    risk assessment.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-belize
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Belize.zip
  download_url: https://data.humdata.org/dataset/24b0adf6-f015-4483-bf1d-bd9399b41c87/resource/69be29f2-96f4-4bf9-8723-22b57d6fbfb9/download/blz.zip
  format: null
  id: resource_69be29f2
  ...
  title: GAR15 Global Exposure Dataset for Belize.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-blz_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Belize
version: null
vulnerability: null
---
