...
- entity:
    ...
    url: https://data.humdata.org/dataset/nru-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/nru-ghsl
dataset_id: rdls_exp-nru_copernicus_nauruglobalhumansettlemen_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/nru-ghsl]'
...
lineage:
  description: 'The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    and population distribution at global scale. For Nauru, two raster products are
    provided: built-up surface area classification and population density grid.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nru-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/e4ac9c84-97c3-4de2-a8f8-71a603b0d5ef/resource/253d0cd4-76ea-4496-86cd-3e96e5fbcb46/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_nru.tif
  format: null
  id: resource_253d0cd4
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Nauru: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/e4ac9c84-97c3-4de2-a8f8-71a603b0d5ef/resource/51cfadb3-b6c6-41c2-83cf-219bb4fb5ec1/download/ghs_pop_e2025_r2023a_54009_100_v1_0_nru.tif
  format: null
  id: resource_51cfadb3
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-nru_copernicus_nauruglobalhumansettlemen_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Nauru: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
