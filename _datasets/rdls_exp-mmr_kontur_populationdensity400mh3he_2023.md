...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-myanmar
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-myanmar
dataset_id: rdls_exp-mmr_kontur_populationdensity400mh3he_2023
description: 'Myanmar population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-myanmar]'
...
- asset_type:
    description: Population counts at 400m H3 hexagon resolution derived from multi-source
      settlement and building data fusion
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Population density estimates were generated by fusing multiple satellite-derived
    datasets (GHSL, HRSL, Microsoft Buildings) with land cover and OpenStreetMap data
    to allocate population counts to 400m H3 hexagonal grid cells. The methodology
    overlays settlement layers and building footprints to distribute population spatially
    at high resolution for baseline exposure assessment.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-myanmar
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Myanmar: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MM_20220630.gpkg.gz
  format: null
  id: resource_91fd1b88
  ...
  title: kontur_population_MM_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Myanmar: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MM_20231101.gpkg.gz
  format: null
  id: resource_0b70202e
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_MM_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mmr_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Myanmar: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
