...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-kir_nismod_sdkicra__west
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Kiribati (West). Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540144
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540144
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Kiribati (West), clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16540144/files/KIR.zip
  format: null
...
- exposure
schema: rdls-10
slug: rdls_he-kir_nismod_sdkicra__west
spatial:
  bbox:
  - -174.54
  - -11.46
