...
- entity:
    ...
    url: https://data.humdata.org/dataset/saint-kitts-and-nevis-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/saint-kitts-and-nevis-road-surface-data
dataset_id: rdls_exp-kna_heigit_saintkittsnevisroadsurfac_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/saint-kitts-and-nevis-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated predictions for road segments, with results integrated with
    existing OSM attributes to create a comprehensive road surface inventory for humanitarian
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/saint-kitts-and-nevis-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Saint Kitts and Nevis: Road Surface Data (GeoJSON data for Saint kitts
    and nevis.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_kna_roadsurface_lines.geojson
  format: null
  id: resource_34666063
  ...
  title: Saint kitts and nevis GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Saint Kitts and Nevis: Road Surface Data (Geopackage data for Saint
    kitts and nevis.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_kna_roadsurface_lines.gpkg
  format: null
  id: resource_9a297db1
  ...
  temporal: null
  temporal_resolution: null
  title: Saint kitts and nevis GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kna_heigit_saintkittsnevisroadsurfac_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Saint Kitts and Nevis: Road Surface Data'
version: null
vulnerability: null
---
