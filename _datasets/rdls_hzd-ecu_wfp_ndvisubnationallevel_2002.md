...
- entity:
    ...
    url: https://data.humdata.org/dataset/ecu-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ecu-ndvi-subnational
dataset_id: rdls_hzd-ecu_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ecu-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    anomaly) were aggregated by WFP-defined subnational administrative units with
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ecu-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135834342689_658a4ce4'
  download_url: https://data.humdata.org/dataset/f211feed-94f8-440e-a47f-4b3ceecd45f1/resource/1fa91453-1796-42eb-811b-7ba8a9405998/download/ecu-ndvi-subnat-full.csv
  format: null
  id: resource_1fa91453
  media_type: text/csv
  spatial: null
  ...
  title: ecu-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135834342689_658a4ce4'
  download_url: https://data.humdata.org/dataset/f211feed-94f8-440e-a47f-4b3ceecd45f1/resource/de9ecfb6-c3b5-4969-ad24-64c9a19e9e5e/download/ecu-ndvi-subnat-5ytd.csv
  format: null
  id: resource_de9ecfb6
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ecu-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ecu_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Ecuador: NDVI at Subnational Level'
version: null
vulnerability: null
---
