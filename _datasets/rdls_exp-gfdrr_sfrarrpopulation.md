...
creator:
  ...
  name: Chiara Scaini
  url: null
dataset_id: rdls_exp-gfdrr_sfrarrpopulation
description: Regional population distribution layer for Central Asia (Kazakhstan,
  Kyrgyz Republic, Tajikistan, Turkmenistan, Uzbekistan), developed under the SFRARR
  program as part of a regionally consistent exposure database for multi-country risk
  assessment.
...
- asset_type:
    ...
    uri: null
  category: population
  id: rdls_exp-gfdrr_sfrarrpopulation_exp
  metrics:
  - dimension: population
    id: rdls_exp-gfdrr_sfrarrpopulation_m1
    measurement:
      quantity_kind: count
      unit: null
hazard: null
...
resources:
- access_url: https://datacatalog.worldbank.org/search/dataset/0064250
  ...
  download_url: null
  format: csv
  id: rdls_exp-gfdrr_sfrarrpopulation_r1
  media_type: text/csv
  spatial: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gfdrr_sfrarrpopulation
spatial:
  bbox:
  - 46.0
  - 34.0
...
temporal: null
temporal_resolution: null
title: Central Asia Exposure - Population (SFRARR)
version: '2022'
vulnerability: null
---
