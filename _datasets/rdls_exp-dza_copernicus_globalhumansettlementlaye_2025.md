...
- entity:
    ...
    url: https://data.humdata.org/dataset/dza-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/dza-ghsl
dataset_id: rdls_exp-dza_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/dza-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale, with country-specific extracts
    provided for Algeria.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dza-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/51bacc5e-9a6d-46c0-a08e-d82d4007de21/resource/f8faabfd-9b79-4366-83d7-bf53086e39bc/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_dza.tif
  format: null
  id: resource_f8faabfd
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Algeria: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/51bacc5e-9a6d-46c0-a08e-d82d4007de21/resource/afce12fc-fdc2-458e-9370-e5f472763fa6/download/ghs_pop_e2025_r2023a_54009_100_v1_0_dza.tif
  format: null
  id: resource_afce12fc
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-dza_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Algeria: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
