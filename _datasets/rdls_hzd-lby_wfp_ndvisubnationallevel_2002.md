...
- entity:
    ...
    url: https://data.humdata.org/dataset/lby-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/lby-ndvi-subnational
dataset_id: rdls_hzd-lby_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lby-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI indicators by sub-national administrative units. NDVI anomalies were calculated
    as percentage deviations from long-term averages to characterize agricultural
    drought conditions.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lby-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135554477352_13b1949d'
  download_url: https://data.humdata.org/dataset/b9b3d556-b549-4aaa-94e4-ba96708df190/resource/c9006d25-7ac0-40d0-aeec-884263bd221a/download/lby-ndvi-subnat-full.csv
  format: null
  id: resource_c9006d25
  media_type: text/csv
  spatial: null
  ...
  title: lby-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135554477352_13b1949d'
  download_url: https://data.humdata.org/dataset/b9b3d556-b549-4aaa-94e4-ba96708df190/resource/1d81ccaf-fa0b-4604-8f7b-eeaae3762517/download/lby-ndvi-subnat-5ytd.csv
  format: null
  id: resource_1d81ccaf
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: lby-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lby_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Libya: NDVI at Subnational Level'
version: null
vulnerability: null
---
