...
- entity:
    ...
    url: https://data.humdata.org/dataset/tonga-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/tonga-road-surface-data
dataset_id: rdls_exp-ton_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tonga-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated predictions for road segments, with results integrated into
    a combined surface classification prioritizing either OSM or deep learning predictions.
    The final dataset provides road infrastructure inventory with surface type classifications
    across Tonga.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tonga-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Tonga: Road Surface Data (GeoJSON data for Tonga.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ton_roadsurface_lines.geojson
  format: null
  id: resource_f33608b4
  ...
  title: Tonga GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Tonga: Road Surface Data (Geopackage data for Tonga.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ton_roadsurface_lines.gpkg
  format: null
  id: resource_72df66dd
  ...
  temporal: null
  temporal_resolution: null
  title: Tonga GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ton_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
