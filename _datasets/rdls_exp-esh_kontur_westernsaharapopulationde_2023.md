...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-western-sahara
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-western-sahara
dataset_id: rdls_exp-esh_kontur_westernsaharapopulationde_2023
description: 'Western Sahara population density for 400m H3 hexagons. Built from Kontur
  ...
  ( LINZ Data Service ) NZ Building Outlines and OpenStreetMap data. Gobal version
  of population dataset: Kontur Population: Global Population Density for 400m H3
  Hexagons. [Source: This metadata record was automatically extracted from the Humanitarian
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-western-sahara]'
...
- asset_type:
    description: Population counts aggregated to 400m H3 hexagonal grid cells derived
      from multiple settlement datasets
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Population density was derived by fusing multiple global settlement
    ...
    population counts to 400m H3 hexagonal grid cells using a fixed methodology. The
    resulting gridded population product provides baseline exposure data at high spatial
    resolution for Western Sahara.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-western-sahara
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Western Sahara: Population Density for 400m H3 Hexagons (Release 20230420)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_EH_20230420.gpkg.gz
  format: null
  id: resource_669b549c
  ...
  title: kontur_population_EH_20230420.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Western Sahara: Population Density for 400m H3 Hexagons (Release 20230212)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_EH_20230212.gpkg.gz
  format: null
  id: resource_a803dde2
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_EH_20230212.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Western Sahara: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_EH_20231101.gpkg.gz
  format: null
  id: resource_296237b0
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_EH_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-esh_kontur_westernsaharapopulationde_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Western Sahara: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
