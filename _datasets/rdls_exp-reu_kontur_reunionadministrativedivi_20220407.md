...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-reunion
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-reunion
dataset_id: rdls_exp-reu_kontur_reunionadministrativedivi_20220407
description: 'Reunion administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-reunion]'
details: "**Dataset codebook (may be different for previous versions)**: **fid**:\
  ...
  \ Settlement Layer: Dataset: Schiavina, Marcello; Freire, Sergio; MacManus, Kytt\
  \ (2019): GHS population grid multitemporal (1975, 1990, 2000, 2015) R2019A. European\
  \ Commission, Joint Research Centre (JRC) DOI: 10.2905/42E8BE89-54FF-464E-BE7B-BF9E64DA5218\
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap using proprietary
    enhancements and filtered to Reunion. Population counts were aggregated from the
    Kontur Population dataset (400m H3 hexagons) to each administrative division.
    HASC codes for regions were enriched from Wikidata.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-reunion
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: "R\xE9union - Reunion: Administrative Division with Aggregated Population\
    \ (Release 2022-04-07)"
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_RE_20220407.gpkg.gz
  format: null
  id: resource_da3f1fbf
  ...
  title: kontur_boundaries_RE_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: "R\xE9union - Reunion: Administrative Division with Aggregated Population\
    \ (Release 2023-06-28)"
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_RE_20230628.gpkg.gz
  format: null
  id: resource_e1c17d58
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_RE_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: "R\xE9union - Reunion: Administrative Division with Aggregated Population\
    \ (Release 2023-06-28)"
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_RE_20230628.gpkg.gz
  format: null
  id: resource_1d5c698e
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_RE_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-reu_kontur_reunionadministrativedivi_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: "R\xE9union - Reunion: Administrative Division with Aggregated Population"
version: null
vulnerability: null
---
