...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/rwanda-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/rwanda-level-1-exposure-data
dataset_id: rdls_exp-rwa_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/rwanda-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    dataset estimates building counts, areas, and rebuilding values at 15-arcsecond
    grid resolution (approximately 500 meters) across Rwanda, intended for catastrophe
    modeling and disaster risk assessment applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/rwanda-level-1-exposure-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Rwanda produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/0cbf91a8-3dbe-402b-8592-3fca9b052633/resource/223e53f9-94fa-4ddd-990a-292b35cc3d01/download/rwa_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_223e53f9
  ...
  title: RWA_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-rwa_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Rwanda: Level 1 Exposure Data'
version: null
vulnerability: null
---
