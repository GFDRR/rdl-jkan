...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/chn-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/chn-rainfall-subnational
dataset_id: rdls_hzd-chn_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/chn-rainfall-subnational]'
...
lineage:
  description: Rainfall data are derived from CHIRPS satellite observations merged
    ...
    1-month, and 3-month rolling totals) and normalized against long-term averages
    at subnational administrative units to produce meteorological drought indicators.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/chn-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135436458665_802397a8'
  download_url: https://data.humdata.org/dataset/a3268325-027e-4749-bee8-b7f16973c67a/resource/8758de9f-c980-42fd-83b9-9c20726bf341/download/chn-rainfall-subnat-full.csv
  format: null
  id: resource_8758de9f
  media_type: text/csv
  spatial: null
  ...
  title: chn-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135436458665_802397a8'
  download_url: https://data.humdata.org/dataset/a3268325-027e-4749-bee8-b7f16973c67a/resource/56ec9aeb-ceee-4724-b8c1-9339724c7dbd/download/chn-rainfall-subnat-5ytd.csv
  format: null
  id: resource_56ec9aeb
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: chn-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-chn_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'China: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
