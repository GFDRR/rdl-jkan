...
- entity:
    ...
    url: https://data.humdata.org/dataset/nga-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/nga-ghsl
dataset_id: rdls_exp-nga_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/nga-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale, with Nigeria-specific extraction
    provided here.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nga-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/602ed5a2-244d-4f51-bdb4-27c48373db8a/resource/e74b095f-9201-4fd7-9c3b-d9040d857a7d/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_nga.tif
  format: null
  id: resource_e74b095f
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Nigeria: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/602ed5a2-244d-4f51-bdb4-27c48373db8a/resource/2ac6cfda-1c7e-49e3-8a82-de9b4c48f7f8/download/ghs_pop_e2025_r2023a_54009_100_v1_0_nga.tif
  format: null
  id: resource_2ac6cfda
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-nga_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Nigeria: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
