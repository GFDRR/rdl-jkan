...
- entity:
    ...
    url: https://data.humdata.org/dataset/gmb-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/gmb-ghsl
dataset_id: rdls_exp-gmb_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gmb-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    and population distribution at fine spatial resolution.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gmb-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/3c645a55-48b7-45a0-a299-9347d06fe097/resource/90059ad7-97cd-4e70-a6ca-435e6167bdec/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_gmb.tif
  format: null
  id: resource_90059ad7
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Gambia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/3c645a55-48b7-45a0-a299-9347d06fe097/resource/88f3f0f0-c4c9-42fe-898a-ee8e2ad1c700/download/ghs_pop_e2025_r2023a_54009_100_v1_0_gmb.tif
  format: null
  id: resource_88f3f0f0
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gmb_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Gambia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
