...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/com-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-com_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/com-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Comoros subset
    ...
    provided as both tabular CSV and geospatial GeoJSON line geometries.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/com-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Comoros.
  download_url: https://data.humdata.org/dataset/9c78441c-5046-4723-90e5-e32cbcfb4f8f/resource/d80c4897-291a-45a9-ac70-bd097735f87f/download/ibtracs_all_list_v04r01_com.csv
  format: null
  id: resource_d80c4897
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_COM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Comoros.
  download_url: https://data.humdata.org/dataset/9c78441c-5046-4723-90e5-e32cbcfb4f8f/resource/7dab77c8-feae-4e6d-8b4d-233d41204e75/download/ibtracs_all_list_v04r01_lines_com.geojson
  format: null
  id: resource_7dab77c8
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_COM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-com_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
