...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-antarctica
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-antarctica
dataset_id: rdls_exp-ata_kontur_antarcticapopulationdensi_2023
description: 'Antarctica population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-antarctica]'
...
exposure:
- asset_type:
    description: Population density at 400m H3 hexagon resolution derived from multi-source
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    Facebook HRSL, Microsoft Buildings, Copernicus land cover, LINZ, and OpenStreetMap)
    into a unified H3 hexagonal grid at 400m resolution. The multi-source fusion approach
    integrates satellite imagery, connectivity data, and crowdsourced geographic information
    to produce consistent population estimates across Antarctica.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-antarctica
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Antarctica: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AQ_20220630.gpkg.gz
  format: null
  id: resource_d05dbe72
  ...
  title: kontur_population_AQ_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Antarctica: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AQ_20231101.gpkg.gz
  format: null
  id: resource_b5ec2ecf
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_AQ_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ata_kontur_antarcticapopulationdensi_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Antarctica: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
