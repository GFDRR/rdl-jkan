...
- entity:
    ...
    url: https://data.humdata.org/dataset/ecuador-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/ecuador-road-surface-data
dataset_id: rdls_exp-ecu_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2421 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0415 and 0.0592
  (in million kms), corressponding to 17.1237% and 24.4697% respectively of the total
  road length in the dataset region. 0.1414 million km or 58.4066% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0013 million km of information (corressponding
  to 0.9017% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ecuador-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated surface type predictions for approximately 0.2421 million
    km of mapped roads in Ecuador, producing geospatial outputs in GeoJSON and GeoPackage
    formats for humanitarian access and infrastructure planning applications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ecuador-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Ecuador: Road Surface Data (GeoJSON data for Ecuador.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ecu_roadsurface_lines.geojson
  format: null
  id: resource_16ec41a0
  ...
  title: Ecuador GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Ecuador: Road Surface Data (Geopackage data for Ecuador.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ecu_roadsurface_lines.gpkg
  format: null
  id: resource_0296e0e4
  ...
  temporal: null
  temporal_resolution: null
  title: Ecuador GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ecu_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Ecuador: Road Surface Data'
version: null
vulnerability: null
---
