...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-taiwan-province-of-china
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-taiwan-province-of-china
dataset_id: rdls_exp-twn_kontur_provincechinapopulationde_2023
description: 'Taiwan (Province of China) population density for 400m H3 hexagons.
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-taiwan-province-of-china]'
...
- asset_type:
    description: Population counts aggregated to 400m H3 hexagonal grid cells derived
      from GHSL, Facebook HRSL, and Microsoft Buildings data
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Population density was estimated by fusing multiple global datasets
    ...
    high spatial resolution for Taiwan.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-taiwan-province-of-china
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Taiwan (Province of China): Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TW_20220630.gpkg.gz
  format: null
  id: resource_0259c496
  ...
  title: kontur_population_TW_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Taiwan (Province of China): Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TW_20231101.gpkg.gz
  format: null
  id: resource_8d2139e3
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_TW_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-twn_kontur_provincechinapopulationde_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Taiwan (Province of China): Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
