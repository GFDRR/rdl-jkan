...
- entity:
    ...
    url: https://data.humdata.org/dataset/nzl-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/nzl-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-nzl_hdx_ibtracsstormtracks_1897
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nzl-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    recorded at regular time intervals and provided as point and line geometries for
    New Zealand region.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nzl-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1897 to date that pass within 2000 kilometers
    of New Zealand.
  download_url: https://data.humdata.org/dataset/a965e45f-3a2d-4e6a-84d8-937cc2f8a2bf/resource/6977d65a-0d32-4afc-ba76-b5db3f15db56/download/ibtracs_all_list_v04r01_nzl.csv
  format: null
  id: resource_6977d65a
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NZL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1897 to date that pass within 2000 kilometers
    of New Zealand.
  download_url: https://data.humdata.org/dataset/a965e45f-3a2d-4e6a-84d8-937cc2f8a2bf/resource/628bfaec-9b36-435f-855d-90cd81cb7133/download/ibtracs_all_list_v04r01_lines_nzl.geojson
  format: null
  id: resource_628bfaec
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NZL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nzl_hdx_ibtracsstormtracks_1897
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1897-01-25'
temporal_resolution: null
title: 'New Zealand: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
