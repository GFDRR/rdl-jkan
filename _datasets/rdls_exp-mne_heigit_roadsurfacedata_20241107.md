...
- entity:
    ...
    url: https://data.humdata.org/dataset/montenegro-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/montenegro-road-surface-data
dataset_id: rdls_exp-mne_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/montenegro-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    classification using a hybrid deep learning approach. The model predicted paved
    and unpaved road surface types across Montenegro, with results integrated into
    a unified dataset containing both OSM-derived and predicted surface classifications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/montenegro-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Montenegro: Road Surface Data (GeoJSON data for Montenegro.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_mne_roadsurface_lines.geojson
  format: null
  id: resource_1a831ad9
  ...
  title: Montenegro GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Montenegro: Road Surface Data (Geopackage data for Montenegro.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_mne_roadsurface_lines.gpkg
  format: null
  id: resource_88eb8ced
  ...
  temporal: null
  temporal_resolution: null
  title: Montenegro GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mne_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Montenegro: Road Surface Data'
version: null
vulnerability: null
---
