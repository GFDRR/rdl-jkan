...
- entity:
    ...
    url: https://data.humdata.org/dataset/estonia-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/estonia-planet-road-surface-data
dataset_id: rdls_exp-est_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.005 million km (98.8274%) - Unpaved roads: 0.0 million km (0.1481%) - Missing\
  \ OSM surface tags: 0.0 million km (0.5529%) - PlanetScope predictions cover: 0.005\
  \ million km (17901.9179%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/estonia-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Estonia. Deep learning models were applied to PlanetScope satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/estonia-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Estonia: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Estonia)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_EE_planet_roadsurface_lines.geojson
  format: null
  id: resource_7b8fde37
  ...
  title: Estonia GeoJSON heigit_EE_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Estonia: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Estonia)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_EE_planet_roadsurface_lines.gpkg
  format: null
  id: resource_c7a66a24
  ...
  temporal: null
  temporal_resolution: null
  title: Estonia GPKG heigit_EE_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-est_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Estonia: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
