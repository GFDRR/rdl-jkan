...
- entity:
    ...
    url: https://data.humdata.org/dataset/falkland-islands-malvinas-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/falkland-islands-malvinas-planet-road-surface-data
dataset_id: rdls_exp-flk_heigit_falklandislandsmalvinaspl_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0004 million km (79.1143%) - Unpaved roads: 0.0001 million km (19.0551%) - Missing\
  \ OSM surface tags: 0.0 million km (0.1344%) - PlanetScope predictions cover: 0.0004\
  \ million km (73038.6551%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/falkland-islands-malvinas-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries from OpenStreetMap were extracted for arterial
    highways in the Falkland Islands. Deep learning models trained on PlanetScope
    satellite imagery from 2020 and 2024 classified road surface type (paved/unpaved),
    measured road width, detected surface changes, and derived a Humanitarian Passability
    Index (HPI) based on surface and width characteristics. The resulting dataset
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/falkland-islands-malvinas-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Falkland Islands (Malvinas): Planet Road Surface, Width, and Passability
    Data (GeoJSON file for Falkland islands (malvinas))'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_FK_planet_roadsurface_lines.geojson
  format: null
  id: resource_61b66807
  ...
  title: Falkland islands (malvinas) GeoJSON heigit_FK_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Falkland Islands (Malvinas): Planet Road Surface, Width, and Passability
    Data (Geopackage file for Falkland islands (malvinas))'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_FK_planet_roadsurface_lines.gpkg
  format: null
  id: resource_57e6cec0
  ...
  temporal: null
  temporal_resolution: null
  title: Falkland islands (malvinas) GPKG heigit_FK_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-flk_heigit_falklandislandsmalvinaspl_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Falkland Islands (Malvinas): Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
