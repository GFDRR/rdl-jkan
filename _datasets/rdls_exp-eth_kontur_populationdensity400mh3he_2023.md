...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-ethiopia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-ethiopia
dataset_id: rdls_exp-eth_kontur_populationdensity400mh3he_2023
description: 'Ethiopia population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-ethiopia]'
...
lineage:
  description: Population density estimates were generated by fusing multiple global
    datasets (GHSL, HRSL, Microsoft Buildings, Copernicus Land Cover, and OpenStreetMap)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-ethiopia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Ethiopia: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_ET_20220630.gpkg.gz
  format: null
  id: resource_36b9c5e9
  ...
  title: kontur_population_ET_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Ethiopia: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_ET_20231101.gpkg.gz
  format: null
  id: resource_e27c3d8d
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_ET_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-eth_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Ethiopia: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
