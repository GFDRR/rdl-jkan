...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-nauru
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-nauru
dataset_id: rdls_exp-nru_kontur_nauruadministrativedivisi_20220407
description: 'Nauru administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-nauru]'
...
lineage:
  description: Administrative boundaries for Nauru were extracted from OpenStreetMap
    and enriched with aggregated population counts derived from the Kontur Population
    dataset at 400m H3 hexagon resolution. The resulting dataset provides baseline
    population exposure at administrative division level, enriched with HASC codes
    from Wikidata.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-nauru
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Nauru: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_NR_20220407.gpkg.gz
  format: null
  id: resource_bf4c84a3
  ...
  title: kontur_boundaries_NR_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Nauru: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_NR_20230628.gpkg.gz
  format: null
  id: resource_57f998f0
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_NR_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Nauru: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_NR_20230628.gpkg.gz
  format: null
  id: resource_be1ff214
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_NR_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nru_kontur_nauruadministrativedivisi_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Nauru: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
