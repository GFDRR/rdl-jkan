...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/kir-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/kir-rainfall-subnational
dataset_id: rdls_hzd-kir_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/kir-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    1-month, and 3-month rolling sums) and standardized anomalies at subnational administrative
    units in Kiribati to support drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kir-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135532804654_f234a57f'
  download_url: https://data.humdata.org/dataset/b98e0610-cb5c-4542-ab37-c7df3163eb62/resource/38baaf08-aa73-4ad1-b5bd-ffe8c0d1c00e/download/kir-rainfall-subnat-full.csv
  format: null
  id: resource_38baaf08
  media_type: text/csv
  spatial: null
  ...
  title: kir-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135532804654_f234a57f'
  download_url: https://data.humdata.org/dataset/b98e0610-cb5c-4542-ab37-c7df3163eb62/resource/cb77dc29-8b76-4976-94d2-0ef611fdce90/download/kir-rainfall-subnat-5ytd.csv
  format: null
  id: resource_cb77dc29
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kir-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-kir_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Kiribati: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
