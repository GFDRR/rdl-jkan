...
- entity:
    ...
    url: https://data.humdata.org/dataset/lbn-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/lbn-ghsl
dataset_id: rdls_exp-lbn_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/lbn-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    and population distribution at global scale, applied here to Lebanon.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lbn-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/8541897f-b556-4fa8-b993-f1308585300b/resource/42ebf6ac-55ef-4077-a5f8-5358938f224e/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_lbn.tif
  format: null
  id: resource_42ebf6ac
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Lebanon: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/8541897f-b556-4fa8-b993-f1308585300b/resource/aae7bb50-a2f3-4887-84ab-4c12bfc9dd92/download/ghs_pop_e2025_r2023a_54009_100_v1_0_lbn.tif
  format: null
  id: resource_aae7bb50
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-lbn_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Lebanon: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
