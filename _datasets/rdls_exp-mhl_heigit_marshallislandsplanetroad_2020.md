...
- entity:
    ...
    url: https://data.humdata.org/dataset/marshall-islands-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/marshall-islands-planet-road-surface-data
dataset_id: rdls_exp-mhl_heigit_marshallislandsplanetroad_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0 million km (84.4549%) - Unpaved roads: 0.0 million km (1.7104%) - Missing\
  \ OSM surface tags: 0.0 million km (73.5939%) - PlanetScope predictions cover: 0.0001\
  \ million km (117.0821%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/marshall-islands-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Marshall Islands. Deep learning models were applied to PlanetScope satellite
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/marshall-islands-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Marshall Islands: Planet Road Surface, Width, and Passability Data
    (GeoJSON file for Marshall islands)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MH_planet_roadsurface_lines.geojson
  format: null
  id: resource_c9ac9f80
  ...
  title: Marshall islands GeoJSON heigit_MH_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Marshall Islands: Planet Road Surface, Width, and Passability Data
    (Geopackage file for Marshall islands)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MH_planet_roadsurface_lines.gpkg
  format: null
  id: resource_006b7863
  ...
  temporal: null
  temporal_resolution: null
  title: Marshall islands GPKG heigit_MH_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mhl_heigit_marshallislandsplanetroad_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Marshall Islands: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
