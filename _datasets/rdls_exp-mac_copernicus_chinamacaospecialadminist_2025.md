...
- entity:
    ...
    url: https://data.humdata.org/dataset/mac-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mac-ghsl
dataset_id: rdls_exp-mac_copernicus_chinamacaospecialadminist_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mac-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to produce gridded datasets of built-up surfaces and population distribution.
    The resulting GeoTIFF rasters represent human settlement patterns and infrastructure
    presence at sub-national scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mac-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/3e93ff5d-946a-40af-89b4-8fde2e995258/resource/9daf6321-4b9f-48fc-9a34-ecdcf40d5270/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mac.tif
  format: null
  id: resource_9daf6321
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'China, Macao Special Administrative Region: Copernicus Global Human
    Settlement Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate
    system: Mollweide)'
  download_url: https://data.humdata.org/dataset/3e93ff5d-946a-40af-89b4-8fde2e995258/resource/9809d879-9469-4825-9a1b-b1c5e83d1e7b/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mac.tif
  format: null
  id: resource_9809d879
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mac_copernicus_chinamacaospecialadminist_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'China, Macao Special Administrative Region: Copernicus Global Human Settlement
  Layer (GHSL)'
version: null
vulnerability: null
---
