...
- entity:
    ...
    url: https://data.humdata.org/dataset/prk-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/prk-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-prk_hdx_democraticpeoplesrepublic_1884
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/prk-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Democratic People's Republic of Korea subset contains observed storm positions,
    times, wind speeds (wmo_wind), and central pressures (wmo_pres) for all tropical
    cyclones affecting or passing through the region, provided in both tabular CSV
    and geospatial GeoJSON formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/prk-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/94983594-9bf4-4424-9116-e9ec18bad764/resource/c0318808-cbaf-49b4-a2d6-c5ac8ffaf8d6/download/ibtracs_all_list_v04r01_prk.csv
  format: null
  id: resource_c0318808
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PRK.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1884 to date that pass within 2000 kilometers
    of Democratic People's Republic of Korea.
  download_url: https://data.humdata.org/dataset/94983594-9bf4-4424-9116-e9ec18bad764/resource/cc1148f6-7505-4311-90f0-aedaee088292/download/ibtracs_all_list_v04r01_lines_prk.geojson
  format: null
  id: resource_cc1148f6
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PRK.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-prk_hdx_democraticpeoplesrepublic_1884
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1884-06-24'
temporal_resolution: null
title: 'Democratic People''s Republic of Korea: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
