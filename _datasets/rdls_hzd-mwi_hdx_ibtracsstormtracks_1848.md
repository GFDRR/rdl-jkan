...
- entity:
    ...
    url: https://data.humdata.org/dataset/mwi-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mwi-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mwi_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mwi-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Malawi
    subset contains observed storm track positions, timestamps, basin/sub-basin classifications,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mwi-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Malawi.
  download_url: https://data.humdata.org/dataset/5f5776cf-783b-4fd4-861b-fd5007e84c11/resource/4a61b64d-18ee-46c6-afe8-3279442d8ac5/download/ibtracs_all_list_v04r01_mwi.csv
  format: null
  id: resource_4a61b64d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MWI.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Malawi.
  download_url: https://data.humdata.org/dataset/5f5776cf-783b-4fd4-861b-fd5007e84c11/resource/4fc2723f-eb7b-4f62-a83a-c7c48c02ef9e/download/ibtracs_all_list_v04r01_lines_mwi.geojson
  format: null
  id: resource_4fc2723f
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MWI.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mwi_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'Malawi: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
