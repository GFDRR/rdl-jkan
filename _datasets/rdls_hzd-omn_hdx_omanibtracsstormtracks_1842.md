...
- entity:
    ...
    url: https://data.humdata.org/dataset/omn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/omn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-omn_hdx_omanibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/omn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates historical and recent tropical cyclone observations
    ...
    at regular intervals for all cyclones affecting the Oman region, providing the
    most complete observational record of tropical cyclone hazards.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/omn-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Oman: IBTrACS Storm Tracks (IBTrACS storm tracks from 1842 to date
    that pass within 2000 kilometers of Oman.)'
  download_url: https://data.humdata.org/dataset/df349307-db44-4702-93ec-f10243bd7c4f/resource/6f181763-dbb2-4508-8f39-925a2518e185/download/ibtracs_all_list_v04r01_omn.csv
  format: null
  id: resource_6f181763
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_OMN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Oman: IBTrACS Storm Tracks (IBTrACS storm tracks from 1842 to date
    that pass within 2000 kilometers of Oman.)'
  download_url: https://data.humdata.org/dataset/df349307-db44-4702-93ec-f10243bd7c4f/resource/c60167f7-101c-49f3-a138-54a020d08c2f/download/ibtracs_all_list_v04r01_lines_omn.geojson
  format: null
  id: resource_c60167f7
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_OMN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-omn_hdx_omanibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Oman: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
