...
- entity:
    ...
    url: https://data.humdata.org/dataset/sri-lanka-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/sri-lanka-road-surface-data
dataset_id: rdls_exp-lka_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.1637 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0282 and 0.0193
  (in million kms), corressponding to 17.2064% and 11.8088% respectively of the total
  road length in the dataset region. 0.1162 million km or 70.9848% of road surface
  ...
  to 0.5756% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sri-lanka-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    type attributes across Sri Lanka, enabling assessment of transportation network
    accessibility and humanitarian logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sri-lanka-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Sri Lanka: Road Surface Data (GeoJSON data for Sri lanka.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lka_roadsurface_lines.geojson
  format: null
  id: resource_5d34a8a9
  ...
  title: Sri lanka GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Sri Lanka: Road Surface Data (Geopackage data for Sri lanka.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lka_roadsurface_lines.gpkg
  format: null
  id: resource_fa8b4e78
  ...
  temporal: null
  temporal_resolution: null
  title: Sri lanka GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lka_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Sri Lanka: Road Surface Data'
version: null
vulnerability: null
---
