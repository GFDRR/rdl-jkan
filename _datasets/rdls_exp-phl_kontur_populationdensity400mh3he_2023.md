...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-philippines
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-philippines
dataset_id: rdls_exp-phl_kontur_populationdensity400mh3he_2023
description: 'Philippines population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-philippines]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    and allocating population counts to H3 hexagons at 400m resolution using spatial
    overlay and calibration methods. The resulting gridded population dataset provides
    baseline exposure data for disaster risk assessment at sub-kilometer scale across
    the Philippines.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-philippines
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Philippines: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PH_20220630.gpkg.gz
  format: null
  id: resource_13fbba7e
  ...
  title: kontur_population_PH_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Philippines: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PH_20231101.gpkg.gz
  format: null
  id: resource_1b9ec865
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_PH_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-phl_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Philippines: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
