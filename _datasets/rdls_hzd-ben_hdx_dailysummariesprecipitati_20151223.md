...
- entity:
    ...
    url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-benin
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Centers for Environmental Information (NCEI / NOAA)
  url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-benin
dataset_id: rdls_hzd-ben_hdx_dailysummariesprecipitati_20151223
description: 'This dataset contains the daily summaries on base stations across Benin
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-benin]'
...
lineage:
  description: Daily precipitation and snow measurements were collected from meteorological
    base stations across Benin by NOAA/NCEI. Data underwent quality control filtering
    requiring stations to have minimum 30 years of service with >182 complete days
    per year. Four indicators (total precipitation, maximum snow depth, total snowfall,
    extreme maximum daily precipitation) were extracted and compiled into daily summaries
    for disaster risk assessment and climate monitoring.
  sources:
  - id: source_1
    license: null
    name: National Centers for Environmental Information (NCEI / NOAA)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-benin
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Daily Summaries of Precipitation Indicators for Benin (CSV)
  download_url: https://data.humdata.org/dataset/7c6b9cd4-e2e7-4273-966a-a2ea25cc8c98/resource/a4f1de0b-f79a-4c8d-8d92-7a6fc3960bfc/download/precipitation_ben.csv
  format: null
  id: resource_a4f1de0b
  media_type: text/csv
  spatial: null
  ...
  title: precipitation_ben.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ben_hdx_dailysummariesprecipitati_20151223
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-23'
temporal_resolution: null
title: Daily Summaries of Precipitation Indicators for Benin
version: null
vulnerability: null
---
