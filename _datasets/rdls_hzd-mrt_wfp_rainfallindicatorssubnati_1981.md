...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/mrt-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mrt-rainfall-subnational
dataset_id: rdls_hzd-mrt_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/mrt-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    long-term climatological averages to generate drought-relevant indicators including
    rainfall anomalies and quintiles.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mrt-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135644998987_9c047e6c'
  download_url: https://data.humdata.org/dataset/7680b3f0-aa0a-45b3-8fc7-ddc29efdccc7/resource/ebc25750-7082-4b85-bef7-83601c7fb64d/download/mrt-rainfall-subnat-full.csv
  format: null
  id: resource_ebc25750
  media_type: text/csv
  spatial: null
  ...
  title: mrt-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135644998987_9c047e6c'
  download_url: https://data.humdata.org/dataset/7680b3f0-aa0a-45b3-8fc7-ddc29efdccc7/resource/ac09e01b-66af-45f7-8728-33fa90faea24/download/mrt-rainfall-subnat-5ytd.csv
  format: null
  id: resource_ac09e01b
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mrt-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mrt_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Mauritania: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
