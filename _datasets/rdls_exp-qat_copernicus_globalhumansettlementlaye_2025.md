...
- entity:
    ...
    url: https://data.humdata.org/dataset/qat-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/qat-ghsl
dataset_id: rdls_exp-qat_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/qat-ghsl]'
...
lineage:
  description: The GHSL dataset integrates multi-source geospatial data including
    global fine-scale satellite imagery, census records, and volunteered geographic
    information through automated spatial data processing technologies to produce
    gridded estimates of built-up surface extent and population distribution at high
    spatial resolution.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/qat-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/4ea0b0dc-f2c8-49a6-9488-c078b03e702a/resource/3a3315d9-6d24-4981-9429-e57324ad4918/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_qat.tif
  format: null
  id: resource_3a3315d9
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Qatar: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/4ea0b0dc-f2c8-49a6-9488-c078b03e702a/resource/a2dfafbe-7d8c-4f9b-8db8-7a8adcddd038/download/ghs_pop_e2025_r2023a_54009_100_v1_0_qat.tif
  format: null
  id: resource_a2dfafbe
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-qat_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Qatar: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
