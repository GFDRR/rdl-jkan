...
- entity:
    affiliation: null
    email: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) v2 -
      Climate Hazards Center UC Santa Barbara
    url: https://data.humdata.org/dataset/arm-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
    email: null
    name: CHIRPS-GEFS short-term rainfall forecasts - Climate Hazards Center UC Santa
      Barbara
    url: https://data.humdata.org/dataset/arm-rainfall-subnational
  id: attribution_2
  role: collaborator
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/arm-rainfall-subnational
dataset_id: rdls_hzd-arm_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/arm-rainfall-subnational]'
...
license: CC-BY-4.0
lineage:
  description: Dekadal rainfall estimates are derived from CHIRPS v2, which merges
    satellite infrared cold cloud duration observations with quality-controlled rain
    gauge records to produce gridded precipitation fields. Pixel-level values are
    spatially aggregated to subnational administrative boundaries in Armenia by WFP,
    computing 10-day totals, 1- and 3-month rolling sums, long-term averages, and
    anomaly percentiles. CHIRPS-GEFS forecasts are incorporated to extend indicators
    into near-real-time, supporting drought and food security early warning monitoring.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) v2 -
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/arm-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135547363298_0dc83864'
  download_url: https://data.humdata.org/dataset/06b5227a-f6d2-450f-903e-aff35f740e1b/resource/40d2bfd4-9ba9-422e-8276-09f620e7c34d/download/arm-rainfall-subnat-full.csv
  format: null
  id: resource_40d2bfd4
  media_type: text/csv
  spatial: null
  ...
  title: arm-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135547363298_0dc83864'
  download_url: https://data.humdata.org/dataset/06b5227a-f6d2-450f-903e-aff35f740e1b/resource/274c79ba-5b50-41cf-845e-2be048f69b1f/download/arm-rainfall-subnat-5ytd.csv
  format: null
  id: resource_274c79ba
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: arm-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-arm_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Armenia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
