...
- entity:
    ...
    url: https://data.humdata.org/dataset/gin-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/gin-ndvi-subnational
dataset_id: rdls_hzd-gin_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/gin-ndvi-subnational]'
...
lineage:
  description: MODIS Aqua and Terra 16-day composite reflectance products (MYD13C1
    ...
    Indicators include raw NDVI (vim), long-term average NDVI (vim_lta), and percentage
    anomaly (viq) to support agricultural drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gin-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135528110955_0df8ef2f'
  download_url: https://data.humdata.org/dataset/44dca4cf-3ad9-45d0-a2c5-6c6f51aa156b/resource/c59ca88a-5697-480b-805c-7b6cc05541f2/download/gin-ndvi-subnat-full.csv
  format: null
  id: resource_c59ca88a
  media_type: text/csv
  spatial: null
  ...
  title: gin-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135528110955_0df8ef2f'
  download_url: https://data.humdata.org/dataset/44dca4cf-3ad9-45d0-a2c5-6c6f51aa156b/resource/af0f384e-3f1c-4281-97eb-e8a8b3eda460/download/gin-ndvi-subnat-5ytd.csv
  format: null
  id: resource_af0f384e
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: gin-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gin_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Guinea: NDVI at Subnational Level'
version: null
vulnerability: null
---
