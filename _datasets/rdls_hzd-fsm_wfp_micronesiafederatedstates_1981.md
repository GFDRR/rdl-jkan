...
- entity:
    ...
    url: https://data.humdata.org/dataset/fsm-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/fsm-rainfall-subnational
dataset_id: rdls_hzd-fsm_wfp_micronesiafederatedstates_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/fsm-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite observations merged with
    station measurements, aggregated into dekadal indicators (10-day, 1-month, and
    3-month rolling totals) and compared against long-term averages at subnational
    administrative units to generate drought-relevant meteorological indices.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fsm-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135507081919_7ba884a3'
  download_url: https://data.humdata.org/dataset/bb414c17-af92-4d84-a141-fd705249e1d6/resource/079136da-b422-430b-98c6-0059a4a3c90d/download/fsm-rainfall-subnat-full.csv
  format: null
  id: resource_079136da
  media_type: text/csv
  spatial: null
  ...
  title: fsm-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135507081919_7ba884a3'
  download_url: https://data.humdata.org/dataset/bb414c17-af92-4d84-a141-fd705249e1d6/resource/29973eca-852e-43c2-b5d5-7c734b5c54ab/download/fsm-rainfall-subnat-5ytd.csv
  format: null
  id: resource_29973eca
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: fsm-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-fsm_wfp_micronesiafederatedstates_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Micronesia (Federated States of): Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
