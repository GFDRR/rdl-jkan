...
- entity:
    ...
    url: https://data.humdata.org/dataset/png-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/png-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-png_hdx_ibtracsstormtracks_1885
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/png-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Papua New Guinea subset contains observed storm positions, times, wind speeds
    (wmo_wind), and central pressures (wmo_pres) for all cyclones affecting the region,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/png-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1885 to date that pass within 2000 kilometers
    of Papua New Guinea.
  download_url: https://data.humdata.org/dataset/ad3bddf9-152d-43d2-8da7-af2b88382910/resource/7f0b01a6-9e26-4f19-9dcd-b5466c13a5e5/download/ibtracs_all_list_v04r01_png.csv
  format: null
  id: resource_7f0b01a6
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PNG.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1885 to date that pass within 2000 kilometers
    of Papua New Guinea.
  download_url: https://data.humdata.org/dataset/ad3bddf9-152d-43d2-8da7-af2b88382910/resource/c346a869-b14d-437c-875a-94ad18c2e834/download/ibtracs_all_list_v04r01_lines_png.geojson
  format: null
  id: resource_c346a869
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PNG.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-png_hdx_ibtracsstormtracks_1885
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1885-07-10'
temporal_resolution: null
title: 'Papua New Guinea: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
