...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-norway
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-norway
dataset_id: rdls_exp-nor_kontur_populationdensity400mh3he_2023
description: 'Norway population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-norway]'
...
lineage:
  description: Population density was derived by fusing multiple global and regional
    ...
    satellite-derived settlement patterns with building footprints and land cover
    data to produce gridded population counts at high spatial resolution for baseline
    risk assessment.
  sources:
  - id: source_1
    license: null
...
- access_url: null
  ...
  description: 'Norway: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_NO_20220630.gpkg.gz
  format: null
  id: resource_3bb26422
  ...
  title: kontur_population_NO_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Norway: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_NO_20231101.gpkg.gz
  format: null
  id: resource_3d30536f
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_NO_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nor_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Norway: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
