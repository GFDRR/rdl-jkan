...
- entity:
    ...
    url: https://data.humdata.org/dataset/togo-motorised-travel-time-in-seconds-to-nearest-health-centre
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Data for Children Collaborative
  url: https://data.humdata.org/dataset/togo-motorised-travel-time-in-seconds-to-nearest-health-centre
dataset_id: rdls_exp-tgo_d4cc_motorisedtraveltimesecond_20240801
description: 'A 100 m spatial resolution geotiff of motorised travel time in seconds
  to nearest health facility in Togo. The data was generated using the Child Poverty
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/togo-motorised-travel-time-in-seconds-to-nearest-health-centre]'
...
license: CC-BY-4.0
lineage:
  description: Travel time surface generated using least cost path analysis on a friction
    surface representing motorised transport speeds on all-weather roads and walking
    speeds on other terrain types. The 100 m resolution raster was created by calculating
    minimum travel time from every pixel to the nearest health facility in Togo, assuming
    realistic transport mode speeds for public transport and pedestrian movement.
  sources:
  - id: source_1
    license: null
    name: Child Poverty and Access to Services (CPAS) software
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/togo-motorised-travel-time-in-seconds-to-nearest-health-centre
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://s3.eidf.ac.uk/eidf158-motorised-travel-time-maps/service_area_Togo_motorised.tif
  format: null
  id: resource_fccf7683
  ...
  title: service-area-togo-motorised.tif
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tgo_d4cc_motorisedtraveltimesecond_20240801
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-08-01'
temporal_resolution: null
title: Togo Motorised Travel Time (in seconds) to nearest health centre
version: null
vulnerability: null
---
