...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-norfolk-island
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-norfolk-island
dataset_id: rdls_exp-nfk_kontur_norfolkislandadministrati_20220407
description: 'Norfolk Island administrative division with aggregated population. Built
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-norfolk-island]'
...
lineage:
  description: Administrative boundaries for Norfolk Island were extracted from OpenStreetMap
    and enriched with aggregated population counts derived from the Kontur global
    population density dataset at 400m H3 hexagon resolution. The dataset was further
    enhanced with HASC codes from Wikidata to provide standardized administrative
    identifiers.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-norfolk-island
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Norfolk Island: Administrative Division with Aggregated Population
    (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_NF_20220407.gpkg.gz
  format: null
  id: resource_82995146
  ...
  title: kontur_boundaries_NF_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Norfolk Island: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_NF_20230628.gpkg.gz
  format: null
  id: resource_963ac5d0
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_NF_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Norfolk Island: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_NF_20230628.gpkg.gz
  format: null
  id: resource_bd765bf7
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_NF_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nfk_kontur_norfolkislandadministrati_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Norfolk Island: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
