...
- entity:
    ...
    url: https://data.humdata.org/dataset/asm-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/asm-ghsl
dataset_id: rdls_exp-asm_copernicus_americansamoaglobalhumans_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/asm-ghsl]'
...
lineage:
  description: 'The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distribution. For American
    Samoa, two raster products are provided: a built-up surface layer identifying
    constructed areas and a population grid estimating human density.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/asm-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/9f97ea1d-3153-48ea-b874-1b017465c82f/resource/d8556d0c-eb9d-41f4-a2d8-62c656cd9e60/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_asm.tif
  format: null
  id: resource_d8556d0c
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'American Samoa: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/9f97ea1d-3153-48ea-b874-1b017465c82f/resource/42fa1db1-b8e2-4a6e-9118-872683d2ea87/download/ghs_pop_e2025_r2023a_54009_100_v1_0_asm.tif
  format: null
  id: resource_42fa1db1
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-asm_copernicus_americansamoaglobalhumans_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'American Samoa: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
