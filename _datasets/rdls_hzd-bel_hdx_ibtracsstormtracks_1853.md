...
- entity:
    ...
    url: https://data.humdata.org/dataset/bel-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bel-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bel_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bel-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Belgium subset
    contains observed storm tracks with ISO-formatted timestamps, basin/subbasin classifications,
    wind speed (wmo_wind), and pressure (wmo_pres) measurements. Data is provided
    as both tabular CSV and geospatial GeoJSON formats with point and line geometries.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bel-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Belgium.
  download_url: https://data.humdata.org/dataset/21936ba6-dfce-4b97-b37c-001d80cd16ce/resource/e5dfad19-3961-4038-8b29-c446e9f2b9b4/download/ibtracs_all_list_v04r01_bel.csv
  format: null
  id: resource_e5dfad19
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BEL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Belgium.
  download_url: https://data.humdata.org/dataset/21936ba6-dfce-4b97-b37c-001d80cd16ce/resource/e7f5f2cb-4f71-4334-87c9-326c542cc791/download/ibtracs_all_list_v04r01_lines_bel.geojson
  format: null
  id: resource_e7f5f2cb
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BEL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bel_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Belgium: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
