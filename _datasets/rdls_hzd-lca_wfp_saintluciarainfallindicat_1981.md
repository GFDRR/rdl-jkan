...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/lca-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/lca-rainfall-subnational
dataset_id: rdls_hzd-lca_wfp_saintluciarainfallindicat_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/lca-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery integrated
    ...
    units to compute dekadal rainfall indicators including 10-day totals, 1-month
    and 3-month rolling aggregations, and long-term averages for drought monitoring
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lca-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135551670912_54b26901'
  download_url: https://data.humdata.org/dataset/78c99416-d7e2-465d-bb44-c8df7298651c/resource/a63bf6aa-a049-4d15-8aa3-35f39f3116b7/download/lca-rainfall-subnat-full.csv
  format: null
  id: resource_a63bf6aa
  media_type: text/csv
  spatial: null
  ...
  title: lca-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135551670912_54b26901'
  download_url: https://data.humdata.org/dataset/78c99416-d7e2-465d-bb44-c8df7298651c/resource/98bedb1b-84f7-468f-8ebf-b95c2a6a8979/download/lca-rainfall-subnat-5ytd.csv
  format: null
  id: resource_98bedb1b
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: lca-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lca_wfp_saintluciarainfallindicat_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Saint Lucia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
