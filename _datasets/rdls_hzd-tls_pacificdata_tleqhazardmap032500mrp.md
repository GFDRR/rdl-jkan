...
contact_point:
  ...
  url: https://geonode.pacificdata.org/catalogue/#/dataset/66
creator:
  affiliation: null
  email: null
  name: Earth and Oceans Observations Team Pacific Community
  url: https://geonode.pacificdata.org/catalogue/#/dataset/66
dataset_id: rdls_hzd-tls_pacificdata_tleqhazardmap032500mrp
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://geonode.pacificdata.org/catalogue/#/dataset/66
  rel: source
loss: null
project: null
publisher:
...
referenced_by: []
resources:
- access_url: https://geonode.pacificdata.org/datasets/geonode:tim_03_2500t
  baseline_period: null
  climate: null
  conforms_to: http://www.opengis.net/def/serviceType/ogc/wms
  coordinate_system: EPSG:4326
  description: 'Timor-Leste Earthquake Hazard Map, 0.3s Spectral Acceleration, 2500-year
    Return Period (OGC WMS: geonode Service)'
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WMS&version=1.1.1&request=GetMap&layers=geonode:tim_03_2500t&format=image%2Fpng
  format: null
  id: resource_0
...
- access_url: https://geonode.pacificdata.org/datasets/geonode:tim_03_2500t
  ...
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WCS&version=2.0.1&request=DescribeCoverage&CoverageId=geonode__tim_03_2500t
  format: null
  id: resource_1
...
- access_url: null
  ...
  description: Timor-Leste Earthquake Hazard Map, 0.3s Spectral Acceleration, 2500-year
    Return Period
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WCS&request=GetCoverage&coverageid=geonode__tim_03_2500t&format=image%2Ftiff&version=2.0.1&compression=DEFLATE&tileWidth=512&tileHeight=512
  format: null
  id: resource_2
  media_type: image/tiff;application=geotiff
  spatial: null
...
- hazard
schema: rdls-10
slug: rdls_hzd-tls_pacificdata_tleqhazardmap032500mrp
spatial:
  bbox:
  - 124.04464721679689
  - -9.499
...
temporal:
  ...
  start: null
temporal_resolution: null
title: Timor-Leste Earthquake Hazard Map, 0.3s Spectral Acceleration, 2500-year Return
  Period
version: null
vulnerability: null
---
