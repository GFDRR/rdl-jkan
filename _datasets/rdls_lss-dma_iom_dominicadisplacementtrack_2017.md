...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/dma-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/dma-iom-dtm-from-api
dataset_id: rdls_lss-dma_iom_dominicadisplacementtrack_2017
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/dma-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through baseline assessments, site
    assessments, and emergency tracking tools at multiple administrative levels in
    Dominica. Data is aggregated by displacement reason, demographic breakdown (males/females),
    and origin location, then published via the DTM API for humanitarian and research
    use.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dma-iom-dtm-from-api
  rel: source
loss:
  losses:
  - asset_category: population
    asset_dimension: population
    description: Internally displaced persons tracked by displacement reason and demographic
      breakdown
...
- access_url: null
  ...
  description: Dominica IOM displacement tracking matrix data at admin levels 0-1,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/f4e7175d-25ab-431c-9935-d81fb9f18f25/resource/0257dfde-d1f9-44ec-9f74-622120d48413/download/dma-iom-dtm-from-api-admin-0-to-1.csv
  format: null
  id: resource_0257dfde
  media_type: text/csv
  spatial: null
  ...
  title: Dominica IOM DTM data for admin levels 0-1
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-dma_iom_dominicadisplacementtrack_2017
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2017-10-15'
temporal_resolution: null
title: Dominica IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
