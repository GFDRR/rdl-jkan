...
- entity:
    ...
    url: https://data.humdata.org/dataset/iran-islamic-republic-of-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/iran-islamic-republic-of-road-surface-data
dataset_id: rdls_exp-irn_heigit_islamicrepublicroadsurfac_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.8963 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.1451 and 0.0683
  (in million kms), corressponding to 16.1911% and 7.6254% respectively of the total
  road length in the dataset region. 0.6828 million km or 76.1835% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0015 million km of information (corressponding
  to 0.2179% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/iran-islamic-republic-of-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated surface type predictions for approximately 0.8963 million
    km of mapped roads in Iran, with quantified estimates of paved (0.1451 million
    km) and unpaved (0.0683 million km) road lengths.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/iran-islamic-republic-of-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Iran (Islamic Republic of): Road Surface Data (GeoJSON data for Iran
    (islamic republic of).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_irn_roadsurface_lines.geojson
  format: null
  id: resource_e1dca98e
  ...
  title: Iran (islamic republic of) GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Iran (Islamic Republic of): Road Surface Data (Geopackage data for
    Iran (islamic republic of).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_irn_roadsurface_lines.gpkg
  format: null
  id: resource_6cff92e8
  ...
  temporal: null
  temporal_resolution: null
  title: Iran (islamic republic of) GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-irn_heigit_islamicrepublicroadsurfac_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Iran (Islamic Republic of): Road Surface Data'
version: null
vulnerability: null
---
