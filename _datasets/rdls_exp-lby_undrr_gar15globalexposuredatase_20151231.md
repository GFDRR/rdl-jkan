...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-libya
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-libya
dataset_id: rdls_exp-lby_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-libya]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    by UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo for the GAR15 global exposure database
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-libya
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Libya.zip
  download_url: https://data.humdata.org/dataset/f5cd2533-e088-4b3e-a676-b3672db20fa8/resource/17634faa-1be9-4ac0-834a-1bfe040a1010/download/lby.zip
  format: null
  id: resource_17634faa
  ...
  title: GAR15 Global Exposure Dataset for Libya.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lby_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Libya
version: null
vulnerability: null
---
