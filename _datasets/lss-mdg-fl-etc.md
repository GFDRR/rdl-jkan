---
schema: rdl
title: Madagascar Flood (extra-tropical cyclones) loss scenarios
organization: GFDRR
filename: lss-mdg-fl-etc
resources:
  - name: Madagascar flood (extra-tropical cyclone) loss scenarios
    ...
    epsg: 4326 (WGS84)
    url: >-
      https://rdl-jkan-datasets.s3-ap-southeast-2.amazonaws.com/loss/lss-mdg-etc.gpkg
category:
  - Loss
abstract: >-
...
val_unit: USD
hazard_link: 'http://jkan.riskdatalibrary.org/datasets/hzd-mdg-fl-etc/'
