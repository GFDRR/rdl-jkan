...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/tha-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/tha-rainfall-subnational
dataset_id: rdls_hzd-tha_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/tha-rainfall-subnational]'
...
license: CC-BY-4.0
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery merged with
    in-situ station observations, then aggregated by subnational administrative units
    to compute dekadal rainfall totals, rolling 1-month and 3-month accumulations,
    and anomalies relative to long-term climatological averages. This processing pipeline
    generates meteorological drought indicators for early warning and monitoring purposes.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tha-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135739667789_66d82839'
  download_url: https://data.humdata.org/dataset/76a5bb85-9a55-4cda-afcb-6cb4fa2739cc/resource/08ab5e75-c082-4d08-beb6-55383d712ea2/download/tha-rainfall-subnat-full.csv
  format: null
  id: resource_08ab5e75
  media_type: text/csv
  spatial: null
  ...
  title: tha-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135739667789_66d82839'
  download_url: https://data.humdata.org/dataset/76a5bb85-9a55-4cda-afcb-6cb4fa2739cc/resource/f2c5ea73-b33e-4bf2-8ac1-800e0173cdae/download/tha-rainfall-subnat-5ytd.csv
  format: null
  id: resource_f2c5ea73
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: tha-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tha_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Thailand: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
