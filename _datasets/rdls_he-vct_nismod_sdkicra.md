...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-vct_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Saint Vincent and the Grenadines. Derived
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796659
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796659
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Saint Vincent and the Grenadines, clipped from global sources. Contents: (1) Hazard
  ...
  download_url: https://zenodo.org/records/10796659/files/VCT.zip
  format: null
  id: resource_sdkicra_vct
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Saint
    Vincent and the Grenadines
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-vct_nismod_sdkicra
spatial:
  bbox:
  - -61.46
  - 12.59
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3577815/saint-vincent-and-the-grenadines.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Saint Vincent
  and the Grenadines
version: 0.1.0
vulnerability: null
---
