...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-french-polynesia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-french-polynesia
dataset_id: rdls_exp-pyf_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-french-polynesia]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    were transposed onto 5x5 km and 1x1 km geographic grids using population density
    and GDP distribution as spatial proxies. The dataset was developed through a top-down
    approach by UNEP-GRID in collaboration with WAPMERR, EU JRC, and Kokusai Kogyo
    for the GAR15 global exposure assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-french-polynesia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for French Polynesia.zip
  download_url: https://data.humdata.org/dataset/a4aaa119-8cc3-4161-8a8e-aab70617548f/resource/16d6e5dc-72c6-40dc-9c99-841ae1c326b7/download/pyf.zip
  format: null
  id: resource_16d6e5dc
  ...
  title: GAR15 Global Exposure Dataset for French Polynesia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pyf_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for French Polynesia
version: null
vulnerability: null
---
