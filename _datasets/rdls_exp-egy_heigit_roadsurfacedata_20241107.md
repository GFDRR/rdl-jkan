...
- entity:
    ...
    url: https://data.humdata.org/dataset/egypt-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/egypt-road-surface-data
dataset_id: rdls_exp-egy_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.6438 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0602 and 0.0169
  (in million kms), corressponding to 9.344% and 2.6252% respectively of the total
  road length in the dataset region. 0.5667 million km or 88.0308% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0022 million km of information (corressponding
  to 0.3924% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/egypt-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated surface type predictions for approximately 0.6438 million
    km of mapped roads in Egypt, with results provided in GeoJSON and GeoPackage formats
    for spatial analysis and humanitarian access planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/egypt-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Egypt: Road Surface Data (GeoJSON data for Egypt.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_egy_roadsurface_lines.geojson
  format: null
  id: resource_628d3464
  ...
  title: Egypt GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Egypt: Road Surface Data (Geopackage data for Egypt.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_egy_roadsurface_lines.gpkg
  format: null
  id: resource_a6f71b5a
  ...
  temporal: null
  temporal_resolution: null
  title: Egypt GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-egy_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
