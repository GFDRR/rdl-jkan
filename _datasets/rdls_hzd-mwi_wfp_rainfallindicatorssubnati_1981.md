...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/mwi-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mwi-rainfall-subnational
dataset_id: rdls_hzd-mwi_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/mwi-rainfall-subnational]'
...
lineage:
  description: Dekadal rainfall data were derived from CHIRPS satellite imagery merged
    ...
    units. Rolling 1-month and 3-month aggregations and long-term climatological averages
    were computed to generate drought monitoring indicators including rainfall anomalies
    and quintiles.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mwi-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135548637066_10297ab1'
  download_url: https://data.humdata.org/dataset/7ba59686-437a-4b5f-b387-c446aae335b4/resource/74894bda-6b97-4478-b6a2-a419a20ff414/download/mwi-rainfall-subnat-full.csv
  format: null
  id: resource_74894bda
  media_type: text/csv
  spatial: null
  ...
  title: mwi-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135548637066_10297ab1'
  download_url: https://data.humdata.org/dataset/7ba59686-437a-4b5f-b387-c446aae335b4/resource/e264c5ce-745f-4264-bb29-10f9c01db3a5/download/mwi-rainfall-subnat-5ytd.csv
  format: null
  id: resource_e264c5ce
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mwi-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mwi_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Malawi: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
