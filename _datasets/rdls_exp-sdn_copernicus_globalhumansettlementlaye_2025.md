...
- entity:
    ...
    url: https://data.humdata.org/dataset/sdn-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/sdn-ghsl
dataset_id: rdls_exp-sdn_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/sdn-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    datasets provide spatially explicit exposure information for Sudan at high resolution.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sdn-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/bc1a4fdf-abc0-4aa1-b302-9aad04baebe0/resource/d53b85df-3477-4cfe-8cb3-551a761044a3/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_sdn.tif
  format: null
  id: resource_d53b85df
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Sudan: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/bc1a4fdf-abc0-4aa1-b302-9aad04baebe0/resource/939c741e-b95e-4307-b74b-b70dbc01d67c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_sdn.tif
  format: null
  id: resource_939c741e
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-sdn_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Sudan: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
