...
- entity:
    ...
    url: https://data.humdata.org/dataset/water-extents-in-vangaindrano-district-atsimo-atsinanana-region-madagascar-as-of-24-februa
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Satellite Centre (UNOSAT)
  url: https://data.humdata.org/dataset/water-extents-in-vangaindrano-district-atsimo-atsinanana-region-madagascar-as-of-24-februa
dataset_id: rdls_he-mdg_unosat_detectedwaterextentsvanga_20220225
description: 'UNOSAT code: TC20220221MDG This map illustrates satellite-detected surface
  ...
  the analyzed cloud free zones of about 300km2, a total of about 56 km2 of lands
  appear to be flooded. Based on Worldpop population data and the detected surface
  waters, about 12,500 people are potentially exposed or living close to flooded areas.
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/water-extents-in-vangaindrano-district-atsimo-atsinanana-region-madagascar-as-of-24-februa]'
...
lineage:
  description: "Satellite imagery from Sentinel-2 acquired on 24 February 2022 was\
    \ analyzed by UNOSAT analysts through visual interpretation and comparison to\
    \ detect surface water extents. Detected flooded areas (~56 km\xC2\xB2) were intersected\
    \ with WorldPop gridded population data to estimate approximately 12,500 people\
    \ potentially exposed to flooding in the study area."
  sources:
  - id: source_1
    license: null
    name: Sentinel-2 satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/water-extents-in-vangaindrano-district-atsimo-atsinanana-region-madagascar-as-of-24-februa
  rel: source
loss: null
project: null
publisher:
...
- exposure
schema: rdls-10
slug: rdls_he-mdg_unosat_detectedwaterextentsvanga_20220225
spatial:
  bbox: null
  centroid: null
  countries:
