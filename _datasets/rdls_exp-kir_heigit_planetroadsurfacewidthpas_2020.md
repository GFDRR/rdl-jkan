...
- entity:
    ...
    url: https://data.humdata.org/dataset/kiribati-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/kiribati-planet-road-surface-data
dataset_id: rdls_exp-kir_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (83.872%) - Unpaved roads: 0.0 million km (0.0%) - Missing OSM\
  \ surface tags: 0.0001 million km (65.1447%) - PlanetScope predictions cover: 0.0001\
  \ million km (128.7473%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kiribati-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries from OpenStreetMap were extracted for arterial
    highways in Kiribati. Deep learning models trained on PlanetScope satellite imagery
    from 2020 and 2024 classified road surface type (paved/unpaved), measured road
    width, detected surface changes, and computed a Humanitarian Passability Index
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kiribati-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Kiribati: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Kiribati)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_KI_planet_roadsurface_lines.gpkg
  format: null
  id: resource_0fbb579c
  ...
  title: Kiribati GPKG heigit_KI_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Kiribati: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Kiribati)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_KI_planet_roadsurface_lines.geojson
  format: null
  id: resource_7f11c188
  ...
  temporal: null
  temporal_resolution: null
  title: Kiribati GeoJSON heigit_KI_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kir_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Kiribati: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
