...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-republic-of-north-macedonia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-republic-of-north-macedonia
dataset_id: rdls_exp-mkd_kontur_republicpopulationdensity_2023
description: 'North Macedonia population density for 400m H3 hexagons. Built from
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-republic-of-north-macedonia]'
...
lineage:
  description: Population density estimates were derived by fusing multiple satellite-based
    settlement layers (GHSL, HRSL), building footprint data (Microsoft), land cover
    classification (Copernicus), and OpenStreetMap reference data. Population counts
    were aggregated into 400m H3 hexagonal grid cells using hierarchical spatial indexing.
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-republic-of-north-macedonia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Republic of North Macedonia: Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MK_20220630.gpkg.gz
  format: null
  id: resource_d847319a
  ...
  title: kontur_population_MK_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Republic of North Macedonia: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MK_20231101.gpkg.gz
  format: null
  id: resource_466c63ba
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_MK_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mkd_kontur_republicpopulationdensity_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Republic of North Macedonia: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
