...
- entity:
    ...
    url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-botswana
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Centers for Environmental Information (NCEI / NOAA)
  url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-botswana
dataset_id: rdls_hzd-bwa_hdx_dailysummariesprecipitati_20151223
description: 'This dataset contains the daily summaries on base stations across Botswana
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-botswana]'
...
lineage:
  description: Daily precipitation and snow observations were collected from meteorological
    base stations across Botswana by NOAA's National Centers for Environmental Information.
    Stations were selected based on a 30-year minimum record requirement with >182
    days of annual data completeness. Four indicators (total precipitation, maximum
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-botswana
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Daily Summaries of Precipitation Indicators for Botswana (CSV)
  download_url: https://data.humdata.org/dataset/65d63014-7be0-4910-aba5-0b1da82cb9b5/resource/3f2cea29-9be5-43c0-bc04-695a8e9fbf8e/download/precipitation_bwa.csv
  format: null
  id: resource_3f2cea29
  media_type: text/csv
  spatial: null
  ...
  title: precipitation_bwa.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bwa_hdx_dailysummariesprecipitati_20151223
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-23'
temporal_resolution: null
title: Daily Summaries of Precipitation Indicators for Botswana
version: null
vulnerability: null
---
