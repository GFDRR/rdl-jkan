...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/ecu-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/ecu-iom-dtm-from-api
dataset_id: rdls_lss-ecu_iom_displacementtrackingmatri_2016
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ecu-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through baseline assessments, emergency
    tracking tools, and site assessments across Ecuador. Data is aggregated at national
    (Admin 0), provincial (Admin 1), and municipal (Admin 2) administrative levels
    and made publicly available via API for humanitarian analysis and monitoring of
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ecu-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Ecuador IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/7c28297d-7c10-45ab-beb3-3c6c271228cd/resource/b59ffbf5-405f-4f8d-b7e3-8f642d61a7c7/download/ecu-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_b59ffbf5
  media_type: text/csv
  spatial: null
  ...
  title: Ecuador IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-ecu_iom_displacementtrackingmatri_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-04-01'
temporal_resolution: null
title: Ecuador IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
