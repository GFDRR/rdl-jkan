...
- entity:
    ...
    url: https://data.humdata.org/dataset/lca-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/lca-ghsl
dataset_id: rdls_exp-lca_copernicus_saintluciaglobalhumansett_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/lca-ghsl]'
...
exposure:
- asset_type:
    description: Built-up surface area derived from satellite imagery for Saint Lucia,
      representing the spatial extent of human-made structures
    id: buildings
    scheme: null
    title: null
    uri: null
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Gridded population distribution for Saint Lucia derived from census
...
lineage:
  description: The GHSL dataset is produced by the JRC using automated spatial data
    ...
    data, and crowdsourced geographic information. Processing involves machine learning-based
    classification of satellite imagery to extract built-up surface extents and dasymetric
    disaggregation of census population data onto the built-up grid. The resulting
    products provide spatially explicit inventories of built-up area and population
    distribution for Saint Lucia, suitable for use as exposure layers in disaster
    risk assessments.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lca-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/01475ae2-3fa8-4ff4-9d43-7c2562e035f8/resource/b1785e01-304d-433c-be18-e739e615b544/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_lca.tif
  format: null
  id: resource_b1785e01
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Saint Lucia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/01475ae2-3fa8-4ff4-9d43-7c2562e035f8/resource/54210881-765a-4681-ac24-255329f45ad9/download/ghs_pop_e2025_r2023a_54009_100_v1_0_lca.tif
  format: null
  id: resource_54210881
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-lca_copernicus_saintluciaglobalhumansett_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Saint Lucia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
