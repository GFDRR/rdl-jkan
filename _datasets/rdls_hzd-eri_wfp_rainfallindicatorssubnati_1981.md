...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/eri-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/eri-rainfall-subnational
dataset_id: rdls_hzd-eri_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/eri-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery integrated with
    in-situ station observations, aggregated by dekad (10-day period) and computed
    into rolling 1-month and 3-month aggregations with long-term climatological averages
    at subnational administrative units for drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/eri-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135510445799_e951002c'
  download_url: https://data.humdata.org/dataset/b107ccda-5896-4013-a704-25d1800ad9fb/resource/213002d5-98d4-4330-a1b1-01a6bb81cfdb/download/eri-rainfall-subnat-full.csv
  format: null
  id: resource_213002d5
  media_type: text/csv
  spatial: null
  ...
  title: eri-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135510445799_e951002c'
  download_url: https://data.humdata.org/dataset/b107ccda-5896-4013-a704-25d1800ad9fb/resource/1888230c-f174-48c1-b341-0c9db5a9b0e4/download/eri-rainfall-subnat-5ytd.csv
  format: null
  id: resource_1888230c
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: eri-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-eri_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Eritrea: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
