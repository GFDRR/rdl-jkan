...
- entity:
    ...
    url: https://data.humdata.org/dataset/sau-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/sau-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-sau_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sau-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Saudi Arabia subset contains observed storm track positions (latitude, longitude,
    ISO timestamp), basin/sub-basin classification, storm nature classification, and
    physical parameters (WMO wind speed and pressure) extracted from the global IBTrACS
    v4r01 archive.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sau-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Saudi Arabia.
  download_url: https://data.humdata.org/dataset/576b2f67-72c1-43a8-827b-748b1ff9cb96/resource/954c3030-4196-45e8-9a92-e1ef01e9367e/download/ibtracs_all_list_v04r01_sau.csv
  format: null
  id: resource_954c3030
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SAU.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Saudi Arabia.
  download_url: https://data.humdata.org/dataset/576b2f67-72c1-43a8-827b-748b1ff9cb96/resource/192774e1-65fc-464f-b084-51d000341b1b/download/ibtracs_all_list_v04r01_lines_sau.geojson
  format: null
  id: resource_192774e1
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SAU.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-sau_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Saudi Arabia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
