...
creator:
  ...
  name: Zenodo
  url: https://doi.org/10.5281/zenodo.10396451
dataset_id: rdls_vln-crstac_globalbuildingmorphologydatasetforurbanhydroclimat_buildingheightdata
description: 'The BH_100m contains the building height files where each file is named
  as BH_{lon_start}_{lon_end}_{lat_start}_{lat_end}.tif [Source: This metadata record
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/exposure-vulnerability/buildings/global-building-morphology-dataset-for-urban-hydroclimate-modelling-glamour/building-height-data/building-height-data.json
...
- access_url: null
  ...
  description: GLobAl building MOrphology dataset for URban hydroclimate modelling
    (GLAMOUR) - Building height data - data file
  download_url: https://zenodo.org/records/10396451/files/BH_100m.zip?download=1
  format: null
  ...
  title: GLobAl building MOrphology dataset for URban hydroclimate modelling (GLAMOUR)
    - Building height data - data file
- access_url: https://doi.org/10.1038/s41597-024-03446-2
  ...
  coordinate_system: null
  description: GLobAl building MOrphology dataset for URban hydroclimate modelling
    (GLAMOUR) - Building height data (Web reference)
  download_url: null
...
- access_url: https://doi.org/10.5281/zenodo.10396450
  ...
  coordinate_system: null
  description: GLobAl building MOrphology dataset for URban hydroclimate modelling
    (GLAMOUR) - Building height data (Code link)
  download_url: null
  format: Web reference
...
- vulnerability
schema: rdls-10
slug: rdls_vln-crstac_globalbuildingmorphologydatasetforurbanhydroclimat_buildingheightdata
spatial:
  bbox:
  - -180.0
  - -90.0
