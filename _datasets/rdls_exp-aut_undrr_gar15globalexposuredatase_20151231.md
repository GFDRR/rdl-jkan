...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-austria
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-austria
dataset_id: rdls_exp-aut_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-austria]'
...
lineage:
  description: National socio-economic, building type, and capital stock statistics
    ...
    and GDP as spatial proxies. The dataset was developed through a top-down approach
    by UNEP-GRID in collaboration with WAPMERR, JRC, and Kokusai Kogyo for the GAR15
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-austria
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Austria.zip
  download_url: https://data.humdata.org/dataset/0c9f45dd-d964-48e8-80c7-17083b3c2c4b/resource/1dc27dd8-8f7f-42e5-a028-d0adfb4a53b4/download/aut.zip
  format: null
  id: resource_1dc27dd8
  ...
  title: GAR15 Global Exposure Dataset for Austria.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-aut_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Austria
version: null
vulnerability: null
---
