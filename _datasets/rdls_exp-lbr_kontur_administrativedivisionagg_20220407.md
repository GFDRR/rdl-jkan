...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-liberia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-liberia
dataset_id: rdls_exp-lbr_kontur_administrativedivisionagg_20220407
description: 'Liberia administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-liberia]'
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries for Liberia were extracted from OpenStreetMap
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-liberia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Liberia: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_LR_20220407.gpkg.gz
  format: null
  id: resource_28f3513c
  ...
  title: kontur_boundaries_LR_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Liberia: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_LR_20230628.gpkg.gz
  format: null
  id: resource_86bad9f4
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_LR_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Liberia: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_LR_20230628.gpkg.gz
  format: null
  id: resource_fd686393
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_LR_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lbr_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Liberia: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
