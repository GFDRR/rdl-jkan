...
- entity:
    ...
    url: https://data.humdata.org/dataset/mdg-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mdg-ghsl
dataset_id: rdls_exp-mdg_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mdg-ghsl]'
...
lineage:
  description: 'The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    technologies to produce gridded estimates of built-up surface area and population
    distribution. Two primary outputs are provided: GHS Built-up Surface (structure
    dimension) and GHS Population Grid (population dimension), both representing the
    spatial distribution of human presence and infrastructure.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mdg-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/f7c3d5f3-8fc6-4d62-ba0b-3336a09177d8/resource/152a60a9-69af-4504-9886-153a9914fd8b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mdg.tif
  format: null
  id: resource_152a60a9
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Madagascar: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/f7c3d5f3-8fc6-4d62-ba0b-3336a09177d8/resource/14d6ca35-2064-4e96-9422-7c05ba5e7d3e/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mdg.tif
  format: null
  id: resource_14d6ca35
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mdg_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Madagascar: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
