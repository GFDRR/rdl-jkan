...
- entity:
    ...
    url: https://data.humdata.org/dataset/egy-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/egy-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-egy_hdx_ibtracsstormtracks_1885
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/egy-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Egypt subset contains
    historical and recent storm tracks with ISO-formatted timestamps, basin/sub-basin
    classifications, wind speed (WMO), and pressure measurements. Data is provided
    as both tabular (CSV) and spatial (GeoJSON line) formats for track geometry and
    temporal analysis.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/egy-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1885 to date that pass within 2000 kilometers
    of Egypt.
  download_url: https://data.humdata.org/dataset/f08f9a8d-f880-4788-bc23-56cf1abf28a0/resource/86baeeee-0a18-43ad-b92d-916eff8672d7/download/ibtracs_all_list_v04r01_egy.csv
  format: null
  id: resource_86baeeee
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_EGY.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1885 to date that pass within 2000 kilometers
    of Egypt.
  download_url: https://data.humdata.org/dataset/f08f9a8d-f880-4788-bc23-56cf1abf28a0/resource/89c187b4-b38d-4f3b-bc21-b9b80282aeb1/download/ibtracs_all_list_v04r01_lines_egy.geojson
  format: null
  id: resource_89c187b4
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_EGY.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-egy_hdx_ibtracsstormtracks_1885
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1885-05-30'
temporal_resolution: null
title: 'Egypt: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
