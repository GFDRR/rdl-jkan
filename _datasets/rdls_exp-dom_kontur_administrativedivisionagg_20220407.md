...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-dominican-republic
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-dominican-republic
dataset_id: rdls_exp-dom_kontur_administrativedivisionagg_20220407
description: 'Dominican Republic administrative division with aggregated population.
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-dominican-republic]'
...
- asset_type:
    description: Aggregated population counts at administrative division level derived
      from Kontur 400m H3 hexagon population density data
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Administrative boundaries for Dominican Republic were extracted from
    OpenStreetMap and enriched with aggregated population data from the Kontur Population
    dataset (400m H3 hexagons). Population counts were spatially aggregated to administrative
    division polygons and supplemented with HASC codes from Wikidata to create a baseline
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-dominican-republic
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Dominican Republic: Administrative Division with Aggregated Population
    (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_DO_20220407.gpkg.gz
  format: null
  id: resource_ae9f1ed8
  ...
  title: kontur_boundaries_DO_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Dominican Republic: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_DO_20230628.gpkg.gz
  format: null
  id: resource_8bef47d1
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_DO_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Dominican Republic: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_DO_20230628.gpkg.gz
  format: null
  id: resource_e2a5cb2c
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_DO_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dom_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Dominican Republic: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
