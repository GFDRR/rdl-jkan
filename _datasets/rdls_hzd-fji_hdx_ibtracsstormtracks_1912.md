...
- entity:
    ...
    url: https://data.humdata.org/dataset/fji-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/fji-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-fji_hdx_ibtracsstormtracks_1912
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/fji-ibtracs-tropical-storm-tracks]'
...
license: CC-BY-4.0
lineage:
  description: IBTrACS aggregates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Fiji subset contains
    historical and recent cyclone tracks with ISO-timestamped positions, wind speeds
    (wmo_wind in m/s), and central pressure measurements, filtered geographically
    for the Fiji region and provided as both tabular CSV and GeoJSON line geometry
    formats.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fji-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Fiji: IBTrACS Storm Tracks (IBTrACS storm tracks from 1912 to date
    that pass within 2000 kilometers of Fiji.)'
  download_url: https://data.humdata.org/dataset/74525f7f-2806-4ece-8880-db784e660246/resource/d699b8aa-0f61-4a91-9aaa-9939709c1899/download/ibtracs_all_list_v04r01_fji.csv
  format: null
  id: resource_d699b8aa
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_FJI.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Fiji: IBTrACS Storm Tracks (IBTrACS storm tracks from 1912 to date
    that pass within 2000 kilometers of Fiji.)'
  download_url: https://data.humdata.org/dataset/74525f7f-2806-4ece-8880-db784e660246/resource/4c88a2df-c84f-4e56-88b8-cd4899a7692a/download/ibtracs_all_list_v04r01_lines_fji.geojson
  format: null
  id: resource_4c88a2df
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_FJI.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-fji_hdx_ibtracsstormtracks_1912
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1912-05-05'
temporal_resolution: null
title: 'Fiji: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
