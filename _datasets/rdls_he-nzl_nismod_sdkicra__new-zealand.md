...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-nzl_nismod_sdkicra__new-zealand
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for New Zealand. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539767
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539767
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    New Zealand, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16539767/files/NZL.zip
  format: null
...
- exposure
schema: rdls-10
slug: rdls_he-nzl_nismod_sdkicra__new-zealand
spatial:
  bbox:
  - -177.96
  - -52.6
