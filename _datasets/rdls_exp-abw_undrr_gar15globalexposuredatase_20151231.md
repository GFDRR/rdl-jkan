...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-aruba
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-aruba
dataset_id: rdls_exp-abw_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-aruba]'
...
lineage:
  description: National-level socio-economic data, building type distributions, and
    capital stock were spatially disaggregated using a top-down approach with gridded
    population density and GDP as geographic proxies to create 5x5 km and 1x1 km resolution
    exposure layers. The dataset was developed collaboratively by UNEP-GRID, WAPMERR,
    JRC, and Kokusai Kogyo as part of the GAR15 global risk assessment initiative.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-aruba
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Aruba.zip
  download_url: https://data.humdata.org/dataset/8732d950-9bca-4250-8457-f76368f418e3/resource/a2ef6d85-284c-4275-9c48-09ffeb3e0369/download/abw.zip
  format: null
  id: resource_a2ef6d85
  ...
  title: GAR15 Global Exposure Dataset for Aruba.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-abw_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Aruba
version: null
vulnerability: null
---
