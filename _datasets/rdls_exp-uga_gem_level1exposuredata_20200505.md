...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/uganda-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/uganda-level-1-exposure-data
dataset_id: rdls_exp-uga_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/uganda-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    a global-quality Level 1 exposure dataset. The data was processed to estimate
    building counts, areas, and rebuilding values at 15-arcsecond grid resolution
    (approximately 500 meters) for use in catastrophe modeling and loss estimation.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/uganda-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Uganda produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/688b1af3-e6a2-4762-9cb9-f278dd7edd62/resource/3ae24dab-7047-46b6-9436-5f6e11eea883/download/uga_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_3ae24dab
  ...
  title: UGA_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-uga_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Uganda: Level 1 Exposure Data'
version: null
vulnerability: null
---
