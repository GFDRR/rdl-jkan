...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-british-virgin-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-british-virgin-islands
dataset_id: rdls_exp-vgb_kontur_britishvirginislandspopul_2023
description: 'British Virgin Islands population density for 400m H3 hexagons. Built
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-british-virgin-islands]'
...
exposure:
- asset_type:
    description: Population counts aggregated to 400m H3 hexagonal grid cells
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    H3 hierarchical spatial indexing system. The dataset provides baseline population
    exposure at high spatial resolution for the British Virgin Islands.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-british-virgin-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'British Virgin Islands: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_VG_20220630.gpkg.gz
  format: null
  id: resource_a241a57d
  ...
  title: kontur_population_VG_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'British Virgin Islands: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_VG_20231101.gpkg.gz
  format: null
  id: resource_2314bca7
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_VG_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vgb_kontur_britishvirginislandspopul_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'British Virgin Islands: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
