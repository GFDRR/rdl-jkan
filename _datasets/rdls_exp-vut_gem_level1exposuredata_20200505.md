...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/vanuatu-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/vanuatu-level-1-exposure-data
dataset_id: rdls_exp-vut_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/vanuatu-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vanuatu-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Vanuatu produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/a746e7ae-b7bd-424f-b6d2-392c06389710/resource/b7b3db4e-9474-409e-bff3-7a412b8c1903/download/vut_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_b7b3db4e
  ...
  title: VUT_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vut_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Vanuatu: Level 1 Exposure Data'
version: null
vulnerability: null
---
