...
- entity:
    ...
    url: https://data.humdata.org/dataset/sur-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/sur-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-sur_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sur-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Suriname subset
    contains historical and recent cyclone tracks with ISO-timestamped positions,
    wind speed (wmo_wind in m/s), and central pressure measurements, processed and
    quality-controlled by NOAA/NCEI.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sur-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Suriname.
  download_url: https://data.humdata.org/dataset/e615a68f-13e4-47d7-9a27-512862709c2b/resource/832f3e46-38bf-47ab-a414-1ae1756a2d11/download/ibtracs_all_list_v04r01_sur.csv
  format: null
  id: resource_832f3e46
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SUR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Suriname.
  download_url: https://data.humdata.org/dataset/e615a68f-13e4-47d7-9a27-512862709c2b/resource/05707b74-2890-4cc7-8f67-94d8d61bb017/download/ibtracs_all_list_v04r01_lines_sur.geojson
  format: null
  id: resource_05707b74
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SUR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-sur_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Suriname: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
