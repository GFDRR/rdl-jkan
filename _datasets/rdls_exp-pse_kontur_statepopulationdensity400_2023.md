...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-state-of-palestine
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-state-of-palestine
dataset_id: rdls_exp-pse_kontur_statepopulationdensity400_2023
description: 'State of Palestine population density for 400m H3 hexagons. Built from
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-state-of-palestine]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    to create high-resolution population estimates. Population counts were aggregated
    into H3 hexagonal grid cells at 400m resolution using spatial overlay and allocation
    methods. The resulting dataset provides baseline population exposure data for
    State of Palestine at sub-kilometer spatial resolution.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-state-of-palestine
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'State of Palestine: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PS_20220630.gpkg.gz
  format: null
  id: resource_83e47015
  ...
  title: kontur_population_PS_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'State of Palestine: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PS_20231101.gpkg.gz
  format: null
  id: resource_926023fa
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_PS_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pse_kontur_statepopulationdensity400_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'State of Palestine: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
