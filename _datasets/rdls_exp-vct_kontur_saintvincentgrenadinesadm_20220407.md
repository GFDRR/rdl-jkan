...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-saint-vincent-and-the-grenadines
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-saint-vincent-and-the-grenadines
dataset_id: rdls_exp-vct_kontur_saintvincentgrenadinesadm_20220407
description: 'Saint Vincent And The Grenadines administrative division with aggregated
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-saint-vincent-and-the-grenadines]'
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    proprietary processing methods, then enriched with aggregated population counts
    derived from the Kontur Population global 400m H3 hexagon density dataset. HASC
    codes for regions were added from Wikidata to create a baseline population exposure
    dataset at the administrative division level for Saint Vincent and the Grenadines.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-saint-vincent-and-the-grenadines
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_VC_20220407.gpkg.gz
  format: null
  id: resource_7cd423dd
  ...
  title: kontur_boundaries_VC_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_VC_20230628.gpkg.gz
  format: null
  id: resource_95b0ca76
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_VC_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Saint Vincent And The Grenadines: Administrative Division with Aggregated
    Population (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_VC_20230628.gpkg.gz
  format: null
  id: resource_373c600b
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_VC_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vct_kontur_saintvincentgrenadinesadm_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Saint Vincent And The Grenadines: Administrative Division with Aggregated
  Population'
version: null
vulnerability: null
---
