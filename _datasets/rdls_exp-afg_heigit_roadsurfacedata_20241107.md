...
- entity:
    ...
    url: https://data.humdata.org/dataset/afghanistan-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/afghanistan-road-surface-data
dataset_id: rdls_exp-afg_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2602 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0143 and 0.1565
  (in million kms), corressponding to 5.491% and 60.1302% respectively of the total
  road length in the dataset region. 0.0895 million km or 34.3788% of road surface
  ...
  to 0.0708% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/afghanistan-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated surface type predictions for approximately 0.26 million km
    of mapped roads in Afghanistan, producing geospatial datasets in GeoJSON and GeoPackage
    formats.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/afghanistan-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Afghanistan: Road Surface Data (GeoJSON data for Afghanistan.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_afg_roadsurface_lines.geojson
  format: null
  id: resource_fa66491e
  ...
  title: Afghanistan GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Afghanistan: Road Surface Data (Geopackage data for Afghanistan.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_afg_roadsurface_lines.gpkg
  format: null
  id: resource_c317bb62
  ...
  temporal: null
  temporal_resolution: null
  title: Afghanistan GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-afg_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Afghanistan: Road Surface Data'
version: null
vulnerability: null
---
