...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-kingdom-of-great-britain-and-northern-ireland
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-kingdom-of-great-britain-and-northern-ireland
dataset_id: rdls_exp-gbr_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-kingdom-of-great-britain-and-northern-ireland]'
...
lineage:
  description: The GAR15 exposure dataset was developed using a top-down approach
    ...
    density and GDP as spatial proxies. The database integrates inputs from multiple
    international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai Kogyo) to estimate economic
    value of exposed assets across the United Kingdom.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-united-kingdom-of-great-britain-and-northern-ireland
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for United Kingdom of Great Britain and
    Northern Ireland.zip
  download_url: https://data.humdata.org/dataset/a18499e6-7c6a-4305-8e2c-0de351fc7e03/resource/dafcbc94-5604-44c3-83aa-596411d76787/download/gbr.zip
  format: null
  id: resource_dafcbc94
  ...
  title: GAR15 Global Exposure Dataset for United Kingdom of Great Britain and Northern
    Ireland.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gbr_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
