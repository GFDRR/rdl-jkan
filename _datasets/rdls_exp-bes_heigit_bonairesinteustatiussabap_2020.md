...
- entity:
    ...
    url: https://data.humdata.org/dataset/bonaire-sint-eustatius-and-saba-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/bonaire-sint-eustatius-and-saba-planet-road-surface-data
dataset_id: rdls_exp-bes_heigit_bonairesinteustatiussabap_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (96.4477%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (1.8682%) - PlanetScope predictions cover: 0.0001\
  \ million km (5162.6966%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bonaire-sint-eustatius-and-saba-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Bonaire, Sint Eustatius, and Saba. Deep learning models trained on PlanetScope
    satellite imagery from 2020 and 2024 classified road surface type (paved/unpaved),
    measured road width, and derived a Humanitarian Passability Index (HPI) with alphanumeric
    and numerical risk scores. The resulting dataset integrates AI-derived road characteristics
    with OSM geometry to support humanitarian logistics and transportation planning.
  sources:
  - id: source_1
    license: null
    name: PlanetScope satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bonaire-sint-eustatius-and-saba-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Bonaire, Sint Eustatius and Saba: Planet Road Surface, Width, and
    Passability Data (GeoJSON file for Bonaire, sint eustatius and saba)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_BQ_planet_roadsurface_lines.geojson
  format: null
  id: resource_42a6ef79
  ...
  title: Bonaire, sint eustatius and saba GeoJSON heigit_BQ_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Bonaire, Sint Eustatius and Saba: Planet Road Surface, Width, and
    Passability Data (Geopackage file for Bonaire, sint eustatius and saba)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_BQ_planet_roadsurface_lines.gpkg
  format: null
  id: resource_c5220cec
  ...
  temporal: null
  temporal_resolution: null
  title: Bonaire, sint eustatius and saba GPKG heigit_BQ_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bes_heigit_bonairesinteustatiussabap_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Bonaire, Sint Eustatius and Saba: Planet Road Surface, Width, and Passability
  Data'
version: null
vulnerability: null
---
