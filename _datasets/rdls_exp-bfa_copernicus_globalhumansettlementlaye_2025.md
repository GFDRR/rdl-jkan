...
- entity:
    ...
    url: https://data.humdata.org/dataset/bfa-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bfa-ghsl
dataset_id: rdls_exp-bfa_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bfa-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    the spatial distribution of human settlements and population density across Burkina
    Faso.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bfa-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/4207991f-2f97-4e4c-991c-33d627701c97/resource/5cb065d0-4ad0-4cd2-8286-ac6d25a390ce/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bfa.tif
  format: null
  id: resource_5cb065d0
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Burkina Faso: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/4207991f-2f97-4e4c-991c-33d627701c97/resource/32c2ae36-e703-4275-9095-8b44181a27f7/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bfa.tif
  format: null
  id: resource_32c2ae36
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-bfa_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Burkina Faso: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
