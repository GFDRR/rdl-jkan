...
creator:
  ...
  name: Copernicus Climate Data Store
  url: https://doi.org/10.24381/cds.776e08bd
dataset_id: rdls_hzd-crstac_cmip6heatstressindicatorshis_wetbulbtemperatureindexhistori
description: 'The wet-bulb temperature index is a heat stress indicator that indicates
  ...
  ratio (calculated from daily mean specific humidity and surface pressure) [Source:
...
- author_names: null
  ...
  url: https://doi.org/10.24381/cds.776e08bd
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/hazard/temperature-related/cmip6-heat-stress-indicators-his/wet-bulb-temperature-index-historical/wet-bulb-temperature-index-historical.json
...
- access_url: null
  ...
  description: CMIP6 heat stress indicators (HIS) - Wet-bulb temperature index historical
    - data file
  ...
  temporal: null
  temporal_resolution: null
  title: CMIP6 heat stress indicators (HIS) - Wet-bulb temperature index historical
    - data file
...
- hazard
schema: rdls-10
slug: rdls_hzd-crstac_cmip6heatstressindicatorshis_wetbulbtemperatureindexhistori
spatial:
  bbox:
  - -180.0
  - -60.0
