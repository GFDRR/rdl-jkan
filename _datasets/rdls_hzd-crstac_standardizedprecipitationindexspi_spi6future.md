...
creator:
  ...
  name: Copernicus Climate Data Store
  url: https://doi.org/10.24381/cds.5292a2b0
dataset_id: rdls_hzd-crstac_standardizedprecipitationindexspi_spi6future
description: '6-Month Standardized Precipitation Index 2006-2100. Climate scenarios
...
- author_names: null
  ...
  url: https://doi.org/10.24381/cds.5292a2b0
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/hazard/precipitation-related/standardized-precipitation-index-spi/spi6-future/spi6-future.json
  ...
  title: 'STAC Item: Standardized precipitation index (SPI) - SPI6 Future'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Standardized precipitation index (SPI) - SPI6 Future - data file
  ...
  temporal: null
  temporal_resolution: null
  title: Standardized precipitation index (SPI) - SPI6 Future - data file
- access_url: https://github.com/IPCC-WG1/Atlas/blob/main/datasets-interactive-atlas/01_index_calculation_SPI.R
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Standardized precipitation index (SPI) - SPI6 Future (Code link)
  download_url: null
...
- hazard
schema: rdls-10
slug: rdls_hzd-crstac_standardizedprecipitationindexspi_spi6future
spatial:
  bbox:
  - -180.0
  - -60.0
...
title: Standardized precipitation index (SPI) - SPI6 Future
version: null
vulnerability: null
---
