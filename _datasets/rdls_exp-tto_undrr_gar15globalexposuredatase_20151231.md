...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-trinidad-and-tobago
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-trinidad-and-tobago
dataset_id: rdls_exp-tto_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-trinidad-and-tobago]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    using gridded population density and GDP distribution as spatial proxies. The
    GAR15 global exposure database was developed through collaborative integration
    of data from UNEP-GRID, WAPMERR, EU-JRC, and Kokusai Kogyo to create a consistent
    global exposure inventory for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-trinidad-and-tobago
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Trinidad and Tobago.zip
  download_url: https://data.humdata.org/dataset/45172151-5a43-47f2-b6b8-acfb164837d4/resource/a4392d5a-b918-4152-a95d-35145400243f/download/tto.zip
  format: null
  id: resource_a4392d5a
  ...
  title: GAR15 Global Exposure Dataset for Trinidad and Tobago.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tto_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Trinidad and Tobago
version: null
vulnerability: null
---
