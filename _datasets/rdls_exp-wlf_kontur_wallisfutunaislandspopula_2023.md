...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-wallis-and-futuna-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-wallis-and-futuna-islands
dataset_id: rdls_exp-wlf_kontur_wallisfutunaislandspopula_2023
description: 'Wallis and Futuna Islands population density for 400m H3 hexagons. Built
  ...
  New Zealand ( LINZ Data Service ) NZ Building Outlines and OpenStreetMap data. Gobal
  version of population dataset: Kontur Population: Global Population Density for
  400m H3 Hexagons. [Source: This metadata record was automatically extracted from
  the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-wallis-and-futuna-islands]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    HRSL, Microsoft Buildings, Copernicus Land Cover) and allocating population counts
    to 400m H3 hexagonal grid cells using the H3 hierarchical spatial indexing system.
    The Kontur Population dataset methodology overlays these sources to produce consistent,
    gridded population estimates at high spatial resolution.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- access_url: null
  ...
  description: 'Wallis and Futuna Islands: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_WF_20231101.gpkg.gz
  format: null
  id: resource_091ed989
  ...
  title: kontur_population_WF_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-wlf_kontur_wallisfutunaislandspopula_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Wallis and Futuna Islands: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
