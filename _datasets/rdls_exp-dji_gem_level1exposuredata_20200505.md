...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/djibouti-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/djibouti-level-1-exposure-data
dataset_id: rdls_exp-dji_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/djibouti-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    in catastrophe modeling and disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/djibouti-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Djibouti produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/82a094d9-59a8-4f83-833b-837858518870/resource/1e32f023-3ca7-4bd8-b80d-04f42944e591/download/dji_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_1e32f023
  ...
  title: DJI_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dji_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Djibouti: Level 1 Exposure Data'
version: null
vulnerability: null
---
