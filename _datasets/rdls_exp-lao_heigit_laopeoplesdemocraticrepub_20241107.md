...
- entity:
    ...
    url: https://data.humdata.org/dataset/lao-peoples-democratic-republic-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/lao-peoples-democratic-republic-road-surface-data
dataset_id: rdls_exp-lao_heigit_laopeoplesdemocraticrepub_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.1092 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0081 and 0.0378
  (in million kms), corressponding to 7.4564% and 34.6378% respectively of the total
  road length in the dataset region. 0.0632 million km or 57.9058% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0004 million km of information (corressponding
  to 0.6281% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lao-peoples-democratic-republic-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for Laos. A hybrid deep learning model was applied to classify road surfaces as
    paved or unpaved, generating predictions with associated confidence metrics. Multiple
    surface classification schemes (OSM-priority and deep learning-priority) were
    combined to produce the final dataset with ~0.0081 million km paved and ~0.0378
    million km unpaved roads.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lao-peoples-democratic-republic-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Lao People''s Democratic Republic: Road Surface Data (GeoJSON data
    for Lao people''s democratic republic.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lao_roadsurface_lines.geojson
  format: null
  id: resource_be56976e
  ...
  title: Lao people's democratic republic GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Lao People''s Democratic Republic: Road Surface Data (Geopackage data
    for Lao people''s democratic republic.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lao_roadsurface_lines.gpkg
  format: null
  id: resource_0e6408ea
  ...
  temporal: null
  temporal_resolution: null
  title: Lao people's democratic republic GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lao_heigit_laopeoplesdemocraticrepub_20241107
spatial:
  bbox: null
  centroid: null
  countries:
