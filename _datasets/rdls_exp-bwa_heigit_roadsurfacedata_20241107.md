...
- entity:
    ...
    url: https://data.humdata.org/dataset/botswana-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/botswana-road-surface-data
dataset_id: rdls_exp-bwa_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.1982 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0191 and 0.0621
  (in million kms), corressponding to 9.6392% and 31.3427% respectively of the total
  road length in the dataset region. 0.117 million km or 59.0181% of road surface
  ...
  to 0.0742% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/botswana-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    learning approach to classify road surfaces into paved and unpaved categories.
    The model processes satellite imagery and OSM attributes to generate surface predictions,
    which are then integrated with existing OSM data to produce a comprehensive road
    surface inventory for Botswana with both observed and predicted surface classifications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/botswana-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Botswana: Road Surface Data (GeoJSON data for Botswana.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bwa_roadsurface_lines.geojson
  format: null
  id: resource_6a31a146
  ...
  title: Botswana GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Botswana: Road Surface Data (Geopackage data for Botswana.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bwa_roadsurface_lines.gpkg
  format: null
  id: resource_c157f3e8
  ...
  temporal: null
  temporal_resolution: null
  title: Botswana GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bwa_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Botswana: Road Surface Data'
version: null
vulnerability: null
---
