...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-atg_nismod_sdkicra__antigua
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Antigua. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796759
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796759
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Antigua, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/10796759/files/ACA.zip
  format: null
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Antigua
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-atg_nismod_sdkicra__antigua
spatial:
  bbox:
  - -62.35
  - 16.93
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Antigua
version: 0.1.0
vulnerability: null
---
