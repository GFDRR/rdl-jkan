...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cayman-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cayman-islands
dataset_id: rdls_exp-cym_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cayman-islands]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock data
    for Cayman Islands were transposed onto 5x5 km and 1x1 km spatial grids using
    geographic distribution of population density and GDP as spatial proxies. The
    dataset was developed for the Global Assessment Report on Disaster Risk Reduction
    (GAR15) by UNEP-GRID in collaboration with international agencies to create a
    spatially-explicit global exposure database for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cayman-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Cayman Islands.zip
  download_url: https://data.humdata.org/dataset/6d58414d-55a5-4ee5-870a-359f353ecc4d/resource/f56a86d9-4914-495d-bb59-c2258018d979/download/cym.zip
  format: null
  id: resource_f56a86d9
  ...
  title: GAR15 Global Exposure Dataset for Cayman Islands.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cym_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Cayman Islands
version: null
vulnerability: null
---
