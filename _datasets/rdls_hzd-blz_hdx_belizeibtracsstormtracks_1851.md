...
- entity:
    ...
    url: https://data.humdata.org/dataset/blz-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/blz-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-blz_hdx_belizeibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/blz-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone data from multiple
    national meteorological agencies into a unified best-track dataset. The Belize
    subset contains observed storm track positions with ISO timestamps, basin/subbasin
    classifications, wind speed (WMO), and pressure measurements extracted for the
    geographic region of Belize.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/blz-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Belize.
  download_url: https://data.humdata.org/dataset/296d26b6-9cad-4723-ac3d-3277b33b260a/resource/f8e0537a-887d-484d-8d8a-458d80da3518/download/ibtracs_all_list_v04r01_blz.csv
  format: null
  id: resource_f8e0537a
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BLZ.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Belize.
  download_url: https://data.humdata.org/dataset/296d26b6-9cad-4723-ac3d-3277b33b260a/resource/1c738f41-2347-42c8-bd30-5b60db3b1bea/download/ibtracs_all_list_v04r01_lines_blz.geojson
  format: null
  id: resource_1c738f41
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BLZ.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-blz_hdx_belizeibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Belize: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
