...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/gnq-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/gnq-rainfall-subnational
dataset_id: rdls_hzd-gnq_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/gnq-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    1-month, and 3-month rolling sums) at subnational administrative units. Long-term
    climatological averages and anomaly indices were computed to support drought monitoring
    and early warning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gnq-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135450191484_6aa3f80d'
  download_url: https://data.humdata.org/dataset/972ef3f6-6fe8-45d6-ab24-dead4f81378f/resource/ed5c441c-a9d8-4b4e-8b4a-f7e76d44a371/download/gnq-rainfall-subnat-full.csv
  format: null
  id: resource_ed5c441c
  media_type: text/csv
  spatial: null
  ...
  title: gnq-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135450191484_6aa3f80d'
  download_url: https://data.humdata.org/dataset/972ef3f6-6fe8-45d6-ab24-dead4f81378f/resource/818fde13-155d-4f5e-95c6-698facf8b730/download/gnq-rainfall-subnat-5ytd.csv
  format: null
  id: resource_818fde13
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: gnq-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gnq_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Equatorial Guinea: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
