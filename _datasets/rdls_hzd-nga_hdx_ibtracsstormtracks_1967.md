...
- entity:
    ...
    url: https://data.humdata.org/dataset/nga-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/nga-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-nga_hdx_ibtracsstormtracks_1967
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nga-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: Historical and recent tropical cyclone observations from multiple agencies
    ...
    data for Nigeria includes storm identifiers, observation times, basin/sub-basin
    classifications, nature of the storm, and physical parameters (wind speed and
    pressure) at each track point.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nga-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1967 to date that pass within 2000 kilometers
    of Nigeria.
  download_url: https://data.humdata.org/dataset/eeccf4e6-f1e3-4bdb-93c3-5e9b90692073/resource/74f3df2b-ca6f-4b52-abec-36ae2f322d01/download/ibtracs_all_list_v04r01_nga.csv
  format: null
  id: resource_74f3df2b
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NGA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1967 to date that pass within 2000 kilometers
    of Nigeria.
  download_url: https://data.humdata.org/dataset/eeccf4e6-f1e3-4bdb-93c3-5e9b90692073/resource/07a59f9b-eaad-408e-aeaf-76b31decabb7/download/ibtracs_all_list_v04r01_lines_nga.geojson
  format: null
  id: resource_07a59f9b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NGA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nga_hdx_ibtracsstormtracks_1967
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1967-07-05'
temporal_resolution: null
title: 'Nigeria: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
