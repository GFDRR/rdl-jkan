...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-uga-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-uga-settlement-extents-v3-0
dataset_id: rdls_exp-uga_grid3_ugasettlementextentsv30_2016
description: 'The GRID3 UGA - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Uganda, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Uganda Settlement Extents,
  ...
  2024. GRID3 UGA - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-uga-settlement-extents-v3-0]'
...
- asset_type:
    description: Settled population distribution represented as grid cell centroids
      at 100-meter resolution within settlement extents
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Settlement extents and building counts were derived from open data
    ...
    densities. Spatial points represent settled grid cell centroids at 3-arc seconds
    (~100 meters) resolution within identified settlement polygons, providing a geographic
    inventory of human settlements and structures across Uganda.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-uga-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Uganda - GRID3 UGA - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/d5903d33-b0e4-4795-a2e9-9425f816f6a8/resource/dc7269d0-2ec4-46d6-9a77-cbeaf40a9bd9/download/grid3-uga-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_dc7269d0
  ...
  title: GRID3 UGA - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Uganda - GRID3 UGA - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/d5903d33-b0e4-4795-a2e9-9425f816f6a8/resource/25784bd5-c90e-4a2d-b791-b3e4b92cda1b/download/grid3_uga_settlement_extents_v3_0.zip
  format: null
  id: resource_25784bd5
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_UGA_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/d5903d33-b0e4-4795-a2e9-9425f816f6a8/resource/c364c56d-c6a4-4b8e-9ea3-347a0293b542/download/grid3_uga_settlement_grid_v3_0.zip
  format: null
  id: resource_c364c56d
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_UGA_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-uga_grid3_ugasettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Uganda - GRID3 UGA - Settlement Extents v3.0
version: null
vulnerability: null
---
