...
- entity:
    ...
    url: https://data.humdata.org/dataset/kgz-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/kgz-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-kgz_hdx_ibtracsstormtracks_1878
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kgz-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Kyrgyzstan
    subset contains observed storm track positions with associated wind speed (wmo_wind)
    and pressure (wmo_pres) measurements at discrete time intervals, filtered geographically
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kgz-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1878 to date that pass within 2000 kilometers
    of Kyrgyzstan.
  download_url: https://data.humdata.org/dataset/9297293b-5b2a-4a71-972f-d03cfefec347/resource/20f69bc1-986c-42cd-8d66-c5e645299214/download/ibtracs_all_list_v04r01_kgz.csv
  format: null
  id: resource_20f69bc1
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_KGZ.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1878 to date that pass within 2000 kilometers
    of Kyrgyzstan.
  download_url: https://data.humdata.org/dataset/9297293b-5b2a-4a71-972f-d03cfefec347/resource/b659c867-537c-4891-bd95-277f66f4a0c4/download/ibtracs_all_list_v04r01_lines_kgz.geojson
  format: null
  id: resource_b659c867
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_KGZ.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-kgz_hdx_ibtracsstormtracks_1878
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1878-07-21'
temporal_resolution: null
title: 'Kyrgyzstan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
