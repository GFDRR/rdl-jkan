...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-comoros
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-comoros
dataset_id: rdls_exp-com_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-comoros]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    were transposed onto 5x5 km and 1x1 km gridded layers using spatially-distributed
    population and GDP data as geographic proxies. The dataset integrates multi-source
    inputs from UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo to create a comprehensive
    exposure inventory for Comoros.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-comoros
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Comoros.zip
  download_url: https://data.humdata.org/dataset/174a4f4c-cbae-4612-8332-3adb5d63844e/resource/4127ebd3-682a-40ec-9926-a9defa17ac0c/download/com.zip
  format: null
  id: resource_4127ebd3
  ...
  title: GAR15 Global Exposure Dataset for Comoros.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-com_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Comoros
version: null
vulnerability: null
---
