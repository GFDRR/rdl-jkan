...
- entity:
    ...
    url: https://data.humdata.org/dataset/yemen-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/yemen-road-surface-data
dataset_id: rdls_exp-yem_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.1225 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0274 and 0.0489
  (in million kms), corressponding to 22.3404% and 39.9742% respectively of the total
  road length in the dataset region. 0.0461 million km or 37.6854% of road surface
  ...
  to 0.2331% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/yemen-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    ...
    model generated predictions for approximately 0.1225 million km of mapped roads
    in Yemen, with results prioritized by either OSM or deep learning classifications
    to create a unified surface classification dataset.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/yemen-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Yemen: Road Surface Data (GeoJSON data for Yemen.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_yem_roadsurface_lines.geojson
  format: null
  id: resource_35be9837
  ...
  title: Yemen GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Yemen: Road Surface Data (Geopackage data for Yemen.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_yem_roadsurface_lines.gpkg
  format: null
  id: resource_e59cfca2
  ...
  temporal: null
  temporal_resolution: null
  title: Yemen GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-yem_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
