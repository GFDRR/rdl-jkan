...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-egypt
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-egypt
dataset_id: rdls_exp-egy_kontur_populationdensity400mh3he_2023
description: 'Egypt population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-egypt]'
...
lineage:
  description: Population density estimates were derived by fusing multiple satellite-based
    ...
    creating a consistent baseline population exposure dataset for Egypt at sub-kilometer
    resolution.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-egypt
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Egypt: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_EG_20220630.gpkg.gz
  format: null
  id: resource_bb4f4a99
  ...
  title: kontur_population_EG_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Egypt: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_EG_20231101.gpkg.gz
  format: null
  id: resource_28804c95
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_EG_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-egy_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Egypt: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
