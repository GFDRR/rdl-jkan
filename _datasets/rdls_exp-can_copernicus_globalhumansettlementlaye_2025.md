...
- entity:
    ...
    url: https://data.humdata.org/dataset/can-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/can-ghsl
dataset_id: rdls_exp-can_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/can-ghsl]'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/can-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/187c5a92-1076-45e4-b90c-1873df84b800/resource/f7096c40-5cde-4483-87da-cd2cd64c3bdd/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_can.tif
  format: null
  id: resource_f7096c40
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Canada: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/187c5a92-1076-45e4-b90c-1873df84b800/resource/9fbea5ab-e628-47d5-b7fc-24373a2983cc/download/ghs_pop_e2025_r2023a_54009_100_v1_0_can.tif
  format: null
  id: resource_9fbea5ab
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-can_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Canada: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
