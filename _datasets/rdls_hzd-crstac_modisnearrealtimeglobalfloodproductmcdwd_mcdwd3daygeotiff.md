...
creator:
  ...
  name: NASA
  url: https://search.earthdata.nasa.gov/search?portal=idn&p=C2018623526-LANCEMODIS&pg%5B0%5D%5Bv%5D=f&pg%5B0%5D%5Bgsk%5D=-start_date&q=MCDWD
dataset_id: rdls_hzd-crstac_modisnearrealtimeglobalfloodproductmcdwd_mcdwd3daygeotiff
description: 'The MODIS/Aqua+Terra Global Flood Product L3 Near Real Time (NRT) 250m
  ...
  (the best composite will depend on the cloudiness for a particular event). The MCDWD_L3_F3_NRT
  is 3-day product which is generated from current and previous two day''s data. Also
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/hazard/flood/modis-near-real-time-global-flood-product-mcdwd/mcdwd-3-day-geotiff/mcdwd-3-day-geotiff.json
  ...
  title: 'STAC Item: MODIS Near Real-Time Global Flood Product (MCDWD) - MCDWD 3-day
    GeoTIFF'
- access_url: null
  baseline_period: null
  climate: null
  ...
  description: MODIS Near Real-Time Global Flood Product (MCDWD) - MCDWD 3-day GeoTIFF
    - data file
  download_url: https://dx.doi.org/10.5067/MODIS/MCDWD_L3_F3_NRT.061
  format: null
  ...
  temporal: null
  temporal_resolution: null
  title: MODIS Near Real-Time Global Flood Product (MCDWD) - MCDWD 3-day GeoTIFF -
    data file
...
- hazard
schema: rdls-10
slug: rdls_hzd-crstac_modisnearrealtimeglobalfloodproductmcdwd_mcdwd3daygeotiff
spatial:
  bbox:
  - -180.0
  - -50.0
