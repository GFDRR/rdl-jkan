...
- entity:
    ...
    url: https://data.humdata.org/dataset/tur-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/tur-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-tur_hdx_ibtracsstormtracks_1948
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tur-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: "Historical tropical cyclone observations for T\u7AEFrkiye were extracted\
    \ from the IBTrACS v4r01 global best-track archive, which integrates data from\
    \ multiple meteorological agencies. The dataset contains observed storm positions,\
    \ intensities (wind speed and pressure), and classifications at regular time intervals,\
    \ provided as both tabular and geospatial formats."
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tur-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: "IBTrACS storm tracks from 1948 to date that pass within 2000 kilometers\
    \ of T\u7AEFrkiye."
  download_url: https://data.humdata.org/dataset/1f969693-60dd-4bb6-873b-a3dad7c5254b/resource/c2b1bed8-e6eb-4e6d-9792-a9a01a85cc33/download/ibtracs_all_list_v04r01_tur.csv
  format: null
  id: resource_c2b1bed8
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_TUR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: "IBTrACS storm tracks from 1948 to date that pass within 2000 kilometers\
    \ of T\u7AEFrkiye."
  download_url: https://data.humdata.org/dataset/1f969693-60dd-4bb6-873b-a3dad7c5254b/resource/5f94ead4-14e7-4c43-89bb-35851031dbdd/download/ibtracs_all_list_v04r01_lines_tur.geojson
  format: null
  id: resource_5f94ead4
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_TUR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tur_hdx_ibtracsstormtracks_1948
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1948-10-19'
temporal_resolution: null
title: "T\u7AEFrkiye: IBTrACS Storm Tracks"
version: null
vulnerability: null
---
