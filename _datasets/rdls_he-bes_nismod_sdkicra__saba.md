...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-bes_nismod_sdkicra__saba
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Saba. Derived from global datasets clipped
  to national boundaries to support climate risk analysis and infrastructure resilience
  assessment.
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540091
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540091
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Saba, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540091/files/BES.zip
  format: null
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Saba
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-bes_nismod_sdkicra__saba
spatial:
  bbox:
  - -68.42
  - 12.02
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Saba
version: 0.1.0
vulnerability: null
---
