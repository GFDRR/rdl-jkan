...
- entity:
    affiliation: null
    email: null
    name: Climate Hazards Group InfraRed Precipitation with Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/vir-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/vir-rainfall-subnational
dataset_id: rdls_hzd-vir_wfp_unitedstatesvirginislands_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/vir-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from Climate Hazards Group InfraRed Precipitation
    satellite imagery (CHIRPS v2) integrated with in-situ station observations, then
    aggregated by subnational administrative units to compute dekadal rainfall indicators
    including 10-day totals, 1-month and 3-month rolling aggregations, and long-term
    averages for drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vir-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135835491627_4cd8a86b'
  download_url: https://data.humdata.org/dataset/7ad4ddb5-bef4-4816-9231-44650a0e9931/resource/5b4559fa-c0a4-4edf-a70b-062a832ba38a/download/vir-rainfall-subnat-full.csv
  format: null
  id: resource_5b4559fa
  media_type: text/csv
  spatial: null
  ...
  title: vir-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135835491627_4cd8a86b'
  download_url: https://data.humdata.org/dataset/7ad4ddb5-bef4-4816-9231-44650a0e9931/resource/6d555491-e8a1-4ff1-a5ea-04ce4a3b9574/download/vir-rainfall-subnat-5ytd.csv
  format: null
  id: resource_6d555491
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: vir-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-vir_wfp_unitedstatesvirginislands_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'United States Virgin Islands: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
