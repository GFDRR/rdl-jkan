...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/cmr-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/cmr-rainfall-subnational
dataset_id: rdls_hzd-cmr_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/cmr-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery integrated with
    in-situ rain gauge observations, aggregated into dekadal indicators (10-day, 1-month,
    3-month rolling aggregations) and long-term averages at subnational administrative
    units in Cameroon. Indicators include rainfall quantiles and anomalies to support
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cmr-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135458320196_3dc96b83'
  download_url: https://data.humdata.org/dataset/18589fad-1821-482f-8c75-145387b2e00a/resource/999dacd6-054a-4101-8544-d1b8d73b9ddf/download/cmr-rainfall-subnat-full.csv
  format: null
  id: resource_999dacd6
  media_type: text/csv
  spatial: null
  ...
  title: cmr-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135458320196_3dc96b83'
  download_url: https://data.humdata.org/dataset/18589fad-1821-482f-8c75-145387b2e00a/resource/8853940f-5715-4ba3-9c81-89e502adb9d0/download/cmr-rainfall-subnat-5ytd.csv
  format: null
  id: resource_8853940f
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: cmr-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cmr_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Cameroon: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
