...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bahrain
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bahrain
dataset_id: rdls_exp-bhr_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bahrain]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    and GDP distribution as spatial proxies. The dataset was developed collaboratively
    by UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo for the GAR15 global risk assessment
    framework.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-bahrain
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Bahrain.zip
  download_url: https://data.humdata.org/dataset/50541929-2d03-4a58-9192-67e5ac1e3a81/resource/e887d71c-cc38-4bbf-b087-fb966f3e452f/download/bhr.zip
  format: null
  id: resource_e887d71c
  ...
  title: GAR15 Global Exposure Dataset for Bahrain.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bhr_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Bahrain
version: null
vulnerability: null
---
