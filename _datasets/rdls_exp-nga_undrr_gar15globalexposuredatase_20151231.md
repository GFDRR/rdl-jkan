...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-nigeria
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-nigeria
dataset_id: rdls_exp-nga_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-nigeria]'
...
exposure:
- asset_type:
    description: Economic value of building stock classified by type, distributed
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Gross domestic product (GDP) and capital stock distributed as proxy
  ...
  - dimension: index
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Population distribution used as geographic proxy for spatial allocation
...
lineage:
  description: The GAR15 global exposure database for Nigeria was developed using
    ...
    gridded population data and GDP as geographic proxies. The dataset integrates
    inputs from multiple international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai
    Kogyo) to estimate the economic value of exposed assets across the country.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-nigeria
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Nigeria.zip
  download_url: https://data.humdata.org/dataset/4db2f4b2-0388-423f-a037-640722642d17/resource/c4f1175a-d00d-41ab-b115-4c5a6a68831b/download/nga.zip
  format: null
  id: resource_c4f1175a
  ...
  title: GAR15 Global Exposure Dataset for Nigeria.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nga_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Nigeria
version: null
vulnerability: null
---
