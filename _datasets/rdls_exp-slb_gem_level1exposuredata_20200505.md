...
- entity:
    ...
    url: https://data.humdata.org/dataset/solomon-islands-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/solomon-islands-level-1-exposure-data
dataset_id: rdls_exp-slb_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/solomon-islands-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was generated through the METEOR project methodology
    using Earth observation and minimal country-specific data collection to produce
    Level 1 global-quality exposure estimates. The dataset provides gridded (15-arcsecond
    resolution) estimates of building count, area, and rebuilding value across Solomon
    Islands, designed specifically for catastrophe modeling and loss estimation applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project (Modelling Exposure Through Earth Observation Routines)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/solomon-islands-level-1-exposure-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Solomon Islands produced
    by ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/753e17a8-a1fe-4d1b-8395-b53feef91bc9/resource/0a25d39c-630d-44c5-badb-d914c76e8360/download/slb_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_0a25d39c
  ...
  title: SLB_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-slb_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Solomon Islands: Level 1 Exposure Data'
version: null
vulnerability: null
---
