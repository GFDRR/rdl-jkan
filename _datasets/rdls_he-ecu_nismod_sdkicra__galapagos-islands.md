...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-ecu_nismod_sdkicra__galapagos-islands
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Galapagos Islands. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540119
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540119
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Galapagos Islands, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16540119/files/ECU.zip
  format: null
  id: resource_sdkicra_ecu
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Galapagos
    Islands
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-ecu_nismod_sdkicra__galapagos-islands
spatial:
  bbox:
  - -92.01
  - -5.01
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Galapagos
  Islands
version: 0.1.0
vulnerability: null
---
