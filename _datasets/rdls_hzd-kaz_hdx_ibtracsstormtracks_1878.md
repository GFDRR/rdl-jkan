...
- entity:
    ...
    url: https://data.humdata.org/dataset/kaz-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/kaz-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-kaz_hdx_ibtracsstormtracks_1878
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kaz-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Kazakhstan
    subset contains observed storm track positions with associated wind speed (wmo_wind)
    and pressure (wmo_pres) measurements at specific times and locations, filtered
    geographically for the Kazakhstan region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kaz-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1878 to date that pass within 2000 kilometers
    of Kazakhstan.
  download_url: https://data.humdata.org/dataset/3b58ceb2-c492-4014-adab-dd622aecc19e/resource/dc6ea268-9e9e-449f-ad70-e99def7d32d2/download/ibtracs_all_list_v04r01_kaz.csv
  format: null
  id: resource_dc6ea268
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_KAZ.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1878 to date that pass within 2000 kilometers
    of Kazakhstan.
  download_url: https://data.humdata.org/dataset/3b58ceb2-c492-4014-adab-dd622aecc19e/resource/125a6a1e-8ecd-4b0a-bfaf-1e5a1c76d48e/download/ibtracs_all_list_v04r01_lines_kaz.geojson
  format: null
  id: resource_125a6a1e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_KAZ.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-kaz_hdx_ibtracsstormtracks_1878
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1878-07-21'
temporal_resolution: null
title: 'Kazakhstan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
