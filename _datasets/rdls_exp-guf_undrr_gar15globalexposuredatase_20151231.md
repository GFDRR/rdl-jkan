...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-french-guiana
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-french-guiana
dataset_id: rdls_exp-guf_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-french-guiana]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    for the Global Assessment Report on Disaster Risk Reduction (GAR15) through collaborative
    inputs from multiple international agencies.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-french-guiana
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for French Guiana.zip
  download_url: https://data.humdata.org/dataset/375e7dfc-e912-43af-b543-d99200a01cb5/resource/b2733cef-eac6-4dd1-a4d5-bd56db5be0ec/download/guf.zip
  format: null
  id: resource_b2733cef
  ...
  title: GAR15 Global Exposure Dataset for French Guiana.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-guf_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for French Guiana
version: null
vulnerability: null
---
