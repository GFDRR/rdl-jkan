...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mayotte
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mayotte
dataset_id: rdls_exp-myt_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mayotte]'
...
exposure:
- asset_type:
    description: Economic value of building stock classified by type and construction
      characteristics
    id: buildings
    scheme: null
    title: null
...
lineage:
  description: The GAR15 global exposure dataset for Mayotte was developed using a
    ...
    gridded population data and GDP as geographic proxies. The methodology was developed
    by UNEP-GRID in collaboration with WAPMERR, EU JRC, and Kokusai Kogyo to create
    a comprehensive spatial inventory of exposed assets for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mayotte
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Mayotte.zip
  download_url: https://data.humdata.org/dataset/af63e950-a740-4639-83ef-b367812039aa/resource/fed75e29-4730-445a-bac2-843c8a42ed0f/download/myt.zip
  format: null
  id: resource_fed75e29
  ...
  title: GAR15 Global Exposure Dataset for Mayotte.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-myt_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Mayotte
version: null
vulnerability: null
---
