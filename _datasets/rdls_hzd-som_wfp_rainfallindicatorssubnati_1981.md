...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/som-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/som-rainfall-subnational
dataset_id: rdls_hzd-som_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    administrative units. Rolling aggregations (1-month, 3-month) and anomaly indices
    relative to long-term climatological averages were computed to characterize meteorological
    drought conditions across Somalia.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/som-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135846959379_124ca818'
  download_url: https://data.humdata.org/dataset/ed6e1b4b-8094-47e6-bdf7-f6d56fa7abb9/resource/8b333d58-d69e-418c-b5e3-dd86f12eee05/download/som-rainfall-subnat-full.csv
  format: null
  id: resource_8b333d58
  media_type: text/csv
  spatial: null
  ...
  title: som-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135846959379_124ca818'
  download_url: https://data.humdata.org/dataset/ed6e1b4b-8094-47e6-bdf7-f6d56fa7abb9/resource/60b799a6-fe0a-4fa8-918f-5a5b6256eb7c/download/som-rainfall-subnat-5ytd.csv
  format: null
  id: resource_60b799a6
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: som-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-som_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Somalia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
