...
dataset_id: rdls_lss-cok_pacificdata_annualaveragelosselectora
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://geonode.pacificdata.org/catalogue/#/dataset/382
  rel: source
loss:
  losses:
...
publisher:
  ...
  url: https://geonode.pacificdata.org/catalogue/#/dataset/382
purpose: null
referenced_by: []
resources:
- access_url: null
  ...
  description: Annual Average Loss at electoral boundary level for Cook Islands (Zipped
    Shapefile)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Ack_electoralboundary_aal&outputFormat=SHAPE-ZIP&srs=EPSG%3A4326&format_options=charset%3AUTF-8
  format: null
  id: resource_0
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Annual Average Loss at electoral boundary level for Cook Islands (GML
    2.0)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Ack_electoralboundary_aal&outputFormat=gml2&srs=EPSG%3A4326
  format: null
  id: resource_1
...
- access_url: null
  ...
  description: Annual Average Loss at electoral boundary level for Cook Islands (GML
    3.1.1)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Ack_electoralboundary_aal&outputFormat=text%2Fxml%3B+subtype%3Dgml%2F3.1.1&srs=EPSG%3A4326
  format: null
  id: resource_2
  media_type: application/gml+xml
  spatial: null
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Annual Average Loss at electoral boundary level for Cook Islands (CSV)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Ack_electoralboundary_aal&outputFormat=csv&srs=EPSG%3A4326
  format: null
  id: resource_3
  media_type: text/csv
  spatial: null
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Annual Average Loss at electoral boundary level for Cook Islands (Excel)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Ack_electoralboundary_aal&outputFormat=excel&srs=EPSG%3A4326
  format: null
  id: resource_4
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Annual Average Loss at electoral boundary level for Cook Islands (JSON)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Ack_electoralboundary_aal&outputFormat=json&srs=EPSG%3A4326&srsName=EPSG%3A4326
  format: null
  id: resource_5
  ...
  temporal_resolution: null
  title: GeoJSON
- access_url: https://geonode.pacificdata.org/datasets/geonode:ck_electoralboundary_aal
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Annual Average Loss at electoral boundary level for Cook Islands (OGC
    WMS: geonode Service)'
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WMS&version=1.1.1&request=GetMap&layers=geonode:ck_electoralboundary_aal&format=image%2Fpng
  format: null
  id: resource_6
...
- access_url: https://geonode.pacificdata.org/datasets/geonode:ck_electoralboundary_aal
  ...
  description: 'Annual Average Loss at electoral boundary level for Cook Islands (OGC
    WFS: geonode Service)'
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=geonode:ck_electoralboundary_aal&outputFormat=application%2Fjson
  format: null
  id: resource_7
  media_type: application/geo+json
  spatial: null
...
- loss
schema: rdls-10
slug: rdls_lss-cok_pacificdata_annualaveragelosselectora
spatial:
  bbox:
  - -165.8849143419279
  - -21.95951342781214
...
temporal: null
temporal_resolution: null
title: Annual Average Loss at electoral boundary level for Cook Islands
version: null
vulnerability: null
---
