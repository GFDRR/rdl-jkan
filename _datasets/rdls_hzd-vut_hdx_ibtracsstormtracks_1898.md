...
- entity:
    ...
    url: https://data.humdata.org/dataset/vut-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/vut-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-vut_hdx_ibtracsstormtracks_1898
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/vut-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Vanuatu subset contains observed storm track positions (latitude, longitude,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vut-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1898 to date that pass within 2000 kilometers
    of Vanuatu.
  download_url: https://data.humdata.org/dataset/5e05b8b6-eb41-4f08-81f6-932b4cb80ba4/resource/ab8af69d-7401-403d-9345-22892072cab1/download/ibtracs_all_list_v04r01_vut.csv
  format: null
  id: resource_ab8af69d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_VUT.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1898 to date that pass within 2000 kilometers
    of Vanuatu.
  download_url: https://data.humdata.org/dataset/5e05b8b6-eb41-4f08-81f6-932b4cb80ba4/resource/f9a69031-202b-49d7-b7dc-13c5bd4e552d/download/ibtracs_all_list_v04r01_lines_vut.geojson
  format: null
  id: resource_f9a69031
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_VUT.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-vut_hdx_ibtracsstormtracks_1898
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1898-02-02'
temporal_resolution: null
title: 'Vanuatu: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
