...
- entity:
    ...
    url: https://data.humdata.org/dataset/grc-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/grc-ghsl
dataset_id: rdls_exp-grc_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/grc-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    distribution at global scale. The Greece subset represents national-level exposure
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grc-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/a26e5aa3-1d72-4a26-80ef-fc926b5d352a/resource/3131c938-f377-4fe8-a43e-d9a876bfcbd7/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_grc.tif
  format: null
  id: resource_3131c938
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Greece: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/a26e5aa3-1d72-4a26-80ef-fc926b5d352a/resource/145198d6-f019-4ecc-b01c-90c4dbd53805/download/ghs_pop_e2025_r2023a_54009_100_v1_0_grc.tif
  format: null
  id: resource_145198d6
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-grc_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Greece: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
