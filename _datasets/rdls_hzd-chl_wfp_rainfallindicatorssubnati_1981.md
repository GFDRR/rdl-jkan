...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/chl-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/chl-rainfall-subnational
dataset_id: rdls_hzd-chl_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/chl-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    1-month, and 3-month rolling aggregations) at subnational administrative units.
    Indicators include absolute rainfall amounts and anomalies relative to long-term
    averages, serving as meteorological drought monitoring metrics.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/chl-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135459655756_a778048d'
  download_url: https://data.humdata.org/dataset/cb894926-763d-4912-8498-5d79a3510f60/resource/15d42ef4-193e-4b24-8a29-9ec3f3ef8928/download/chl-rainfall-subnat-full.csv
  format: null
  id: resource_15d42ef4
  media_type: text/csv
  spatial: null
  ...
  title: chl-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135459655756_a778048d'
  download_url: https://data.humdata.org/dataset/cb894926-763d-4912-8498-5d79a3510f60/resource/5f466f4f-87a0-42ae-8169-1406c8474dac/download/chl-rainfall-subnat-5ytd.csv
  format: null
  id: resource_5f466f4f
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: chl-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-chl_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Chile: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
