...
- entity:
    ...
    url: https://data.humdata.org/dataset/gha-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/gha-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-gha_hdx_ibtracsstormtracks_1864
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/gha-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS aggregates tropical cyclone observations from multiple meteorological
    agencies into a unified best-track dataset. The Ghana subset contains historical
    and recent storm tracks with ISO-formatted timestamps, basin/subbasin classifications,
    wind speed (wmo_wind), and central pressure (wmo_pres) measurements, provided
    as both tabular CSV and geospatial GeoJSON line geometries.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gha-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1864 to date that pass within 2000 kilometers
    of Ghana.
  download_url: https://data.humdata.org/dataset/f35ec140-4f8e-4f63-9160-2e10d37b1daf/resource/9f802716-193a-4be6-bdfc-bb431f4e2c20/download/ibtracs_all_list_v04r01_gha.csv
  format: null
  id: resource_9f802716
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GHA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1864 to date that pass within 2000 kilometers
    of Ghana.
  download_url: https://data.humdata.org/dataset/f35ec140-4f8e-4f63-9160-2e10d37b1daf/resource/8e5c716e-4ce3-48f5-8d00-fc68f3df7443/download/ibtracs_all_list_v04r01_lines_gha.geojson
  format: null
  id: resource_8e5c716e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GHA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gha_hdx_ibtracsstormtracks_1864
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1864-08-29'
temporal_resolution: null
title: 'Ghana: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
