...
- entity:
    ...
    url: https://data.humdata.org/dataset/yemen-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/yemen-level-1-exposure-data
dataset_id: rdls_exp-yem_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/yemen-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was generated through the METEOR project methodology
    ...
    provides gridded estimates of building counts, areas, and rebuilding values at
    15-arcsecond resolution (~500m) across Yemen, designed specifically for catastrophe
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/yemen-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Yemen produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/6b034cfe-edec-4506-8f54-3c92817dc1eb/resource/044eb96d-ffc8-42f7-bb2b-8507da38858c/download/yem_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_044eb96d
  ...
  title: YEM_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-yem_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Yemen: Level 1 Exposure Data'
version: null
vulnerability: null
---
