...
- entity:
    ...
    url: https://data.humdata.org/dataset/venezuela-bolivarian-republic-of-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/venezuela-bolivarian-republic-of-road-surface-data
dataset_id: rdls_exp-ven_heigit_bolivarianrepublicroadsur_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/venezuela-bolivarian-republic-of-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model-derived classifications were applied to approximately 0.3 million km
    of mapped roads in Venezuela, producing spatial estimates of surface type distribution
    for humanitarian access and infrastructure planning applications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/venezuela-bolivarian-republic-of-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Venezuela (Bolivarian Republic of): Road Surface Data (GeoJSON data
    for Venezuela (bolivarian republic of).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ven_roadsurface_lines.geojson
  format: null
  id: resource_36c24227
  ...
  title: Venezuela (bolivarian republic of) GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Venezuela (Bolivarian Republic of): Road Surface Data (Geopackage
    data for Venezuela (bolivarian republic of).)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ven_roadsurface_lines.gpkg
  format: null
  id: resource_6617d8d8
  ...
  temporal: null
  temporal_resolution: null
  title: Venezuela (bolivarian republic of) GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ven_heigit_bolivarianrepublicroadsur_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Venezuela (Bolivarian Republic of): Road Surface Data'
version: null
vulnerability: null
---
