...
- entity:
    ...
    url: https://data.humdata.org/dataset/american-samoa-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/american-samoa-planet-road-surface-data
dataset_id: rdls_exp-asm_heigit_americansamoaplanetroadsu_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0 million km (32.9792%) - Unpaved roads: 0.0 million km (15.5643%) - Missing\
  \ OSM surface tags: 0.0 million km (46.5635%) - PlanetScope predictions cover: 0.0\
  \ million km (104.2524%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/american-samoa-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in American Samoa. Deep learning models were applied to PlanetScope satellite
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/american-samoa-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'American Samoa: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for American samoa)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AS_planet_roadsurface_lines.geojson
  format: null
  id: resource_3733c27f
  ...
  title: American samoa GeoJSON heigit_AS_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'American Samoa: Planet Road Surface, Width, and Passability Data (Geopackage
    file for American samoa)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AS_planet_roadsurface_lines.gpkg
  format: null
  id: resource_8ddd1f0f
  ...
  temporal: null
  temporal_resolution: null
  title: American samoa GPKG heigit_AS_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-asm_heigit_americansamoaplanetroadsu_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'American Samoa: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
