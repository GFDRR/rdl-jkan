...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/zmb-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-zmb_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/zmb-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track archive. The Zambia subset contains
    observed storm track positions, wind speeds (wmo_wind), central pressures (wmo_pres),
    and storm classifications (nature) for cyclones affecting or passing through the
    country, with temporal resolution at observation intervals.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zmb-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Zambia.
  download_url: https://data.humdata.org/dataset/c7a4109b-34d6-41ca-bc38-58875a8c8fc0/resource/b483b7d0-a15e-4baf-a923-9475d8130ed9/download/ibtracs_all_list_v04r01_zmb.csv
  format: null
  id: resource_b483b7d0
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ZMB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Zambia.
  download_url: https://data.humdata.org/dataset/c7a4109b-34d6-41ca-bc38-58875a8c8fc0/resource/b24b63a6-856a-47ea-a244-408b61733a60/download/ibtracs_all_list_v04r01_lines_zmb.geojson
  format: null
  id: resource_b24b63a6
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ZMB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-zmb_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
