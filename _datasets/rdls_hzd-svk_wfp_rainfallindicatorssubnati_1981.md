...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/svk-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/svk-rainfall-subnational
dataset_id: rdls_hzd-svk_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/svk-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    ...
    sums and anomalies) at subnational administrative units in Slovakia for drought
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/svk-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135719810675_7c7b9b33'
  download_url: https://data.humdata.org/dataset/4d85e854-401e-4451-931f-e51ba68c6832/resource/3ea0c9fc-89e0-4038-b46a-b481e0977c47/download/svk-rainfall-subnat-full.csv
  format: null
  id: resource_3ea0c9fc
  media_type: text/csv
  spatial: null
  ...
  title: svk-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135719810675_7c7b9b33'
  download_url: https://data.humdata.org/dataset/4d85e854-401e-4451-931f-e51ba68c6832/resource/f00aaa74-dde9-497f-9c44-8b672267830a/download/svk-rainfall-subnat-5ytd.csv
  format: null
  id: resource_f00aaa74
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: svk-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-svk_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Slovakia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
