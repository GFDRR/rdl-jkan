...
creator:
  ...
  url: https://cimne.com/
dataset_id: rdls_hzd-undrr_glb_seismic
...
- coordinate_system: EPSG:4326
  description: 'The dataset download page includes:


    - Peak Ground Acceleration (PGA)

    - Spectral acceleration 0.2/0.5/1 sec


    Each are provided for return period scenarios 250, 475, 975, 1500, 2475 years.'
  download_url: https://risk.preventionweb.net/
  format: GRID (grd)
...
- hazard
schema: rdl-03
slug: rdls_hzd-undrr_glb_seismic
spatial:
  countries:
  - GLO
  scale: global
