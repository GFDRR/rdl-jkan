...
- entity:
    ...
    url: https://data.humdata.org/dataset/guinea-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/guinea-road-surface-data
dataset_id: rdls_exp-gin_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.1897 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.005 and 0.0516
  (in million kms), corressponding to 2.6108% and 27.2021% respectively of the total
  road length in the dataset region. 0.1331 million km or 70.1871% of road surface
  ...
  to 0.1506% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/guinea-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    type classification across Guinea, supporting humanitarian access and logistics
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guinea-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Guinea: Road Surface Data (GeoJSON data for Guinea.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_gin_roadsurface_lines.geojson
  format: null
  id: resource_1da0b28c
  ...
  title: Guinea GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Guinea: Road Surface Data (Geopackage data for Guinea.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_gin_roadsurface_lines.gpkg
  format: null
  id: resource_b99e227b
  ...
  temporal: null
  temporal_resolution: null
  title: Guinea GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gin_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Guinea: Road Surface Data'
version: null
vulnerability: null
---
