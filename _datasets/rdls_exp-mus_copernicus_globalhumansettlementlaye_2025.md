...
- entity:
    ...
    url: https://data.humdata.org/dataset/mus-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mus-ghsl
dataset_id: rdls_exp-mus_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mus-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    and population distribution at fine spatial resolution for Mauritius.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mus-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/58e3dc39-d417-432f-8e3f-ced7dcbf8ccf/resource/f3518153-2781-45ee-9a1d-f858098795bd/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mus.tif
  format: null
  id: resource_f3518153
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Mauritius: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/58e3dc39-d417-432f-8e3f-ced7dcbf8ccf/resource/5defa377-cbb4-4af3-aca9-e91bd4f18361/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mus.tif
  format: null
  id: resource_5defa377
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mus_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Mauritius: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
