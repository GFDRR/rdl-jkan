...
- entity:
    ...
    url: https://data.humdata.org/dataset/bih-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bih-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bih_hdx_ibtracsstormtracks_1883
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bih-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Bosnia
    and Herzegovina subset contains observed storm track positions (latitude, longitude,
    ISO timestamp), basin/subbasin classification, wind speed (WMO standard), and
    central pressure measurements for all tropical cyclones affecting or passing through
    the region.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bih-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Bosnia and Herzegovina.
  download_url: https://data.humdata.org/dataset/44f29e99-f3a4-4013-8fb5-fd1e1bb125af/resource/2975026e-4ef8-46b1-a2b5-86bed5af2639/download/ibtracs_all_list_v04r01_bih.csv
  format: null
  id: resource_2975026e
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BIH.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Bosnia and Herzegovina.
  download_url: https://data.humdata.org/dataset/44f29e99-f3a4-4013-8fb5-fd1e1bb125af/resource/c117e8dd-b3e5-477b-a7f2-51483b13af1a/download/ibtracs_all_list_v04r01_lines_bih.geojson
  format: null
  id: resource_c117e8dd
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BIH.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bih_hdx_ibtracsstormtracks_1883
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1883-08-20'
temporal_resolution: null
title: 'Bosnia and Herzegovina: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
