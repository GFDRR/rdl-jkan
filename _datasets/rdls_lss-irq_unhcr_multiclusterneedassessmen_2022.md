...
- entity:
    ...
    email: null
    name: REACH
    url: https://data.humdata.org/dataset/unhcr-irq-2022-mcna-v2-1
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: UNHCR - The UN Refugee Agency
  url: https://data.humdata.org/dataset/unhcr-irq-2022-mcna-v2-1
dataset_id: rdls_lss-irq_unhcr_multiclusterneedassessmen_2022
description: 'The Multi Cluster Needs Assessment (MCNA) is an iterative cluster-led
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/unhcr-irq-2022-mcna-v2-1]'
details: The data must be requested via the resource download link
exposure: []
hazard: null
license: CC-BY-4.0
lineage:
  description: Household-level survey data collected through computer-assisted personal
    interviews (CAPI) across Iraq, aggregated to provide quantitative evidence on
    multi-sectoral humanitarian needs of conflict-affected populations for humanitarian
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/unhcr-irq-2022-mcna-v2-1
  rel: source
loss:
  losses:
  - asset_category: population
    ...
    description: Multi-sectoral humanitarian needs of conflict-affected populations
      including shelter, food security, health, and protection needs
...
referenced_by: []
resources:
- access_url: https://microdata.unhcr.org/index.php/auth/login/?destination=catalog/914/get-microdata
  ...
  title: Iraq - Iraq Multi Cluster Need Assessment, 2022
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Iraq - Iraq Multi Cluster Need Assessment, 2022 (Contains information
    about the dataset's metadata and data)
  download_url: https://microdata.unhcr.org/index.php/catalog/914/pdf-documentation
  format: null
  id: resource_fa99903e
...
- loss
schema: rdls-10
slug: rdls_lss-irq_unhcr_multiclusterneedassessmen_2022
spatial:
  bbox: null
  centroid: null
  countries:
