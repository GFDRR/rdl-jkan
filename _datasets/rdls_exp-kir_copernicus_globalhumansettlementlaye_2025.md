...
- entity:
    ...
    url: https://data.humdata.org/dataset/kir-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/kir-ghsl
dataset_id: rdls_exp-kir_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/kir-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    The resulting GeoTIFF layers represent spatial inventories of human settlements
    and population presence without hazard or impact components.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kir-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/101576ad-a5f1-492b-b137-1c3df93137fa/resource/dd65a0d1-38ae-4887-b526-e0a39a636637/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_kir.tif
  format: null
  id: resource_dd65a0d1
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Kiribati: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/101576ad-a5f1-492b-b137-1c3df93137fa/resource/7f1d1265-9e66-465c-ab66-e591e3d7b3bc/download/ghs_pop_e2025_r2023a_54009_100_v1_0_kir.tif
  format: null
  id: resource_7f1d1265
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-kir_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Kiribati: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
