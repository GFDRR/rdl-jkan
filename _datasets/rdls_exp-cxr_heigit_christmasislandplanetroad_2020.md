...
- entity:
    ...
    url: https://data.humdata.org/dataset/christmas-island-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/christmas-island-planet-road-surface-data
dataset_id: rdls_exp-cxr_heigit_christmasislandplanetroad_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0 million km (70.211%) - Unpaved roads: 0.0 million km (15.1252%) - Missing\
  \ OSM surface tags: 0.0 million km (0.5082%) - PlanetScope predictions cover: 0.0\
  \ million km (16792.2304%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/christmas-island-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    on Christmas Island. Deep learning models were applied to PlanetScope satellite
    ...
    (HPI) based on road condition and accessibility metrics.
  sources:
  - id: source_1
    license: null
    name: PlanetScope Satellite Imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/christmas-island-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Christmas Island: Planet Road Surface, Width, and Passability Data
    (GeoJSON file for Christmas island)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_CX_planet_roadsurface_lines.geojson
  format: null
  id: resource_6fcc091e
  ...
  title: Christmas island GeoJSON heigit_CX_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Christmas Island: Planet Road Surface, Width, and Passability Data
    (Geopackage file for Christmas island)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_CX_planet_roadsurface_lines.gpkg
  format: null
  id: resource_2e8b5707
  ...
  temporal: null
  temporal_resolution: null
  title: Christmas island GPKG heigit_CX_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cxr_heigit_christmasislandplanetroad_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Christmas Island: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
