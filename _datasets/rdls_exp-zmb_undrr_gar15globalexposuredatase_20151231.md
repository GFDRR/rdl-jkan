...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-zambia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-zambia
dataset_id: rdls_exp-zmb_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-zambia]'
...
lineage:
  description: National-level socio-economic data, building type distributions, and
    capital stock for Zambia were spatially disaggregated using a top-down approach
    onto 5x5 km and 1x1 km grids, with geographic population density and GDP serving
    as spatial proxies for distribution. The dataset was developed by UNEP-GRID in
    collaboration with WAPMERR, EU JRC, and Kokusai Kogyo as part of the GAR15 global
    exposure database initiative.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-zambia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Zambia.zip
  download_url: https://data.humdata.org/dataset/81e6f5eb-5855-47e5-ac9e-9771c1469c80/resource/a105e7ef-6d5c-4511-bc09-2796f226868f/download/zmb.zip
  format: null
  id: resource_a105e7ef
  ...
  title: GAR15 Global Exposure Dataset for Zambia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-zmb_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Zambia
version: null
vulnerability: null
---
