...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/rus-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/rus-rainfall-subnational
dataset_id: rdls_hzd-rus_wfp_federationrainfallindicat_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/rus-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with in-situ
    station observations, aggregated into dekadal (10-day) indicators at subnational
    administrative units. Rolling aggregations (1-month, 3-month) and standardized
    anomalies computed relative to long-term averages to support drought monitoring
    and early warning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/rus-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135824742443_f1c4180d'
  download_url: https://data.humdata.org/dataset/94c21706-ff44-4273-a45b-2fb4cd098981/resource/b0a5e37c-35dd-4719-968a-7f9d6b0e773e/download/rus-rainfall-subnat-full.csv
  format: null
  id: resource_b0a5e37c
  media_type: text/csv
  spatial: null
  ...
  title: rus-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135824742443_f1c4180d'
  download_url: https://data.humdata.org/dataset/94c21706-ff44-4273-a45b-2fb4cd098981/resource/2eca0966-b0e5-4806-a753-fd11d7defa8b/download/rus-rainfall-subnat-5ytd.csv
  format: null
  id: resource_2eca0966
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: rus-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-rus_wfp_federationrainfallindicat_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Russian Federation: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
