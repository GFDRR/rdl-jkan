...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-luxemburg
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-luxemburg
dataset_id: rdls_exp-lux_kontur_luxemburgadministrativedi_20220407
description: 'Luxemburg administrative division with aggregated population. Built
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-luxemburg]'
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    ...
    derived from the Kontur Population dataset at 400m H3 hexagon resolution. The
    resulting dataset provides baseline population exposure by administrative division
    for Luxembourg.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-luxemburg
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Luxembourg - Luxemburg: Administrative Division with Aggregated Population
    (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_LU_20220407.gpkg.gz
  format: null
  id: resource_7c9b8c74
  ...
  title: kontur_boundaries_LU_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Luxembourg - Luxemburg: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_LU_20230628.gpkg.gz
  format: null
  id: resource_87a15aac
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_LU_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Luxembourg - Luxemburg: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_LU_20230628.gpkg.gz
  format: null
  id: resource_0f97876a
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_LU_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lux_kontur_luxemburgadministrativedi_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Luxembourg - Luxemburg: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
