...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-afg_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Afghanistan. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540004
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540004
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Afghanistan, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16540004/files/AFG.zip
  format: null
  id: resource_sdkicra_afg
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Afghanistan
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-afg_nismod_sdkicra
spatial:
  bbox:
  - 60.49
  - 29.39
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/1149361/afghanistan.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Afghanistan
version: 0.2.1
vulnerability: null
---
