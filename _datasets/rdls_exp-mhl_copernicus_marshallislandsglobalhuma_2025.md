...
- entity:
    ...
    url: https://data.humdata.org/dataset/mhl-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mhl-ghsl
dataset_id: rdls_exp-mhl_copernicus_marshallislandsglobalhuma_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mhl-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite image data streams,
    census data, and volunteered geographic information processed through automated
    spatial data analytics to produce gridded estimates of built-up surfaces and population
    distribution. The resulting GeoTIFF layers represent the spatial distribution
    of human settlements and population density across the Marshall Islands.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mhl-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/a170b3ff-1f6e-4a55-8d46-1a2a7515e8e4/resource/a10cd26a-90a2-4d76-8a05-df34e1d7444e/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mhl.tif
  format: null
  id: resource_a10cd26a
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Marshall Islands: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/a170b3ff-1f6e-4a55-8d46-1a2a7515e8e4/resource/9cde105d-f0dd-4378-ab79-e820f348225e/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mhl.tif
  format: null
  id: resource_9cde105d
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mhl_copernicus_marshallislandsglobalhuma_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Marshall Islands: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
