...
creator:
  ...
  name: World Resources Institute
  url: https://www.wri.org/data/aqueduct-floods-hazard-maps
dataset_id: rdls_hzd-crstac_floodhazardmapsaqueduct_riverfloodscurrentday
description: 'River flood maps of flood extent and water depth for current day [Source:
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/hazard/flood/flood-hazard-maps-aqueduct/river-floods-current-day/river-floods-current-day.json
  ...
  title: 'STAC Item: Flood hazard maps (Aqueduct) - River floods current day'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Flood hazard maps (Aqueduct) - River floods current day - data file
  ...
  temporal: null
  temporal_resolution: null
  title: Flood hazard maps (Aqueduct) - River floods current day - data file
- access_url: https://doi.org/10.5194/hess-17-1871-2013
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Flood hazard maps (Aqueduct) - River floods current day (Web reference)
  download_url: null
...
- hazard
schema: rdls-10
slug: rdls_hzd-crstac_floodhazardmapsaqueduct_riverfloodscurrentday
spatial:
  bbox:
  - -180.0
  - -90.0
...
temporal:
  ...
  start: '1980'
temporal_resolution: null
title: Flood hazard maps (Aqueduct) - River floods current day
version: null
vulnerability: null
---
