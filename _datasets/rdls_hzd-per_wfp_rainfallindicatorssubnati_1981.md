...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/per-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/per-rainfall-subnational
dataset_id: rdls_hzd-per_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/per-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with in-situ
    station observations, processed into dekadal indicators (10-day rainfall, 1-month
    and 3-month rolling aggregations, and long-term averages) and aggregated by subnational
    administrative units to support drought monitoring and early warning in Peru.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/per-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135636818474_590b2313'
  download_url: https://data.humdata.org/dataset/f5442ac6-4a5a-45a5-9763-ac60e5203bb1/resource/ff3173de-c016-46f5-96a0-2027f6d071cc/download/per-rainfall-subnat-full.csv
  format: null
  id: resource_ff3173de
  media_type: text/csv
  spatial: null
  ...
  title: per-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135636818474_590b2313'
  download_url: https://data.humdata.org/dataset/f5442ac6-4a5a-45a5-9763-ac60e5203bb1/resource/71758c06-7968-4190-a3fd-582361d60e1f/download/per-rainfall-subnat-5ytd.csv
  format: null
  id: resource_71758c06
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: per-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-per_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Peru: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
