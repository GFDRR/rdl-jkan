...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/togo-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/togo-level-1-exposure-data
dataset_id: rdls_exp-tgo_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/togo-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/togo-level-1-exposure-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Togo produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/12f1ee0d-209d-4b90-b1c3-71e879bba085/resource/ec02b6af-a852-4c3a-aced-998168c6ffa0/download/tgo_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_ec02b6af
  ...
  title: TGO_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tgo_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Togo: Level 1 Exposure Data'
version: null
vulnerability: null
---
