...
- entity:
    ...
    url: https://data.humdata.org/dataset/ven-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ven-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ven_hdx_bolivarianrepublicibtracs_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ven-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS aggregates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Venezuela subset
    contains observed storm track positions (latitude, longitude, ISO timestamp),
    basin/sub-basin classification, storm nature classification, and physical parameters
    (WMO wind speed and pressure) extracted from the global IBTrACS archive.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ven-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/42ee0288-dde3-44cb-baa7-9bcdb07e3a98/resource/29decf65-36bc-45f1-a313-0e35266b2df5/download/ibtracs_all_list_v04r01_ven.csv
  format: null
  id: resource_29decf65
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_VEN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Venezuela (Bolivarian Republic of).
  download_url: https://data.humdata.org/dataset/42ee0288-dde3-44cb-baa7-9bcdb07e3a98/resource/406e1c49-9496-4b26-9e72-c055b544e260/download/ibtracs_all_list_v04r01_lines_ven.geojson
  format: null
  id: resource_406e1c49
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_VEN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ven_hdx_bolivarianrepublicibtracs_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-29'
temporal_resolution: null
title: 'Venezuela (Bolivarian Republic of): IBTrACS Storm Tracks'
version: null
vulnerability: null
---
