...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/vut-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/vut-rainfall-subnational
dataset_id: rdls_hzd-vut_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/vut-rainfall-subnational]'
...
lineage:
  description: Rainfall data are derived from Climate Hazards Group InfraRed Precipitation
    ...
    by subnational administrative units in Vanuatu. Multiple rolling aggregation windows
    (10-day, 1-month, 3-month) and long-term climatological averages are computed
    to generate drought indicators for monitoring and early warning purposes.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vut-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135753939042_b6acc07a'
  download_url: https://data.humdata.org/dataset/db628e52-632f-4981-97f1-b1db3cc5f294/resource/9d897ed0-6e39-4f52-89c3-d736062cd7d6/download/vut-rainfall-subnat-full.csv
  format: null
  id: resource_9d897ed0
  media_type: text/csv
  spatial: null
  ...
  title: vut-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135753939042_b6acc07a'
  download_url: https://data.humdata.org/dataset/db628e52-632f-4981-97f1-b1db3cc5f294/resource/301e7736-1243-4b78-9b89-c836eaa1f34f/download/vut-rainfall-subnat-5ytd.csv
  format: null
  id: resource_301e7736
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: vut-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-vut_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Vanuatu: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
