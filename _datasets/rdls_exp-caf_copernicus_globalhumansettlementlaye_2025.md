...
- entity:
    ...
    url: https://data.humdata.org/dataset/caf-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/caf-ghsl
dataset_id: rdls_exp-caf_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/caf-ghsl]'
...
exposure:
- asset_type:
    description: Built-up surface area derived from satellite imagery for Central
      African Republic using the GHS Built-up Surface layer
    id: buildings
    scheme: null
    title: null
    uri: null
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Gridded population distribution for Central African Republic derived
      from the GHS Population Grid
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: The GHSL is produced by the JRC using automated spatial data processing
    technologies applied to large volumes of heterogeneous geospatial data, including
    fine-scale satellite imagery, census data, and crowdsourced geographic information.
    The pipeline extracts built-up surface extent and population distribution at global
    scale, with national subsets prepared for HDX. The resulting gridded datasets
    serve as exposure layers for disaster risk assessment and human settlement analysis.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/caf-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/04b08447-bb65-4319-965c-6c199152e56f/resource/aefea468-2a01-4100-a586-db898bc091da/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_caf.tif
  format: null
  id: resource_aefea468
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Central African Republic: Copernicus Global Human Settlement Layer
    (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/04b08447-bb65-4319-965c-6c199152e56f/resource/7f8683ab-8699-4c37-9871-e5192f219dbb/download/ghs_pop_e2025_r2023a_54009_100_v1_0_caf.tif
  format: null
  id: resource_7f8683ab
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-caf_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Central African Republic: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
