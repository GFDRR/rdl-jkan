...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-iran-islamic-republic-of
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-iran-islamic-republic-of
dataset_id: rdls_exp-irn_kontur_islamicrepublicadministra_20220407
description: 'Iran (Islamic Republic Of) administrative division with aggregated population.
  ...
  regions taken from Wikidata. Global version of boundaries dataset: Kontur Boundaries:
  Global administrative division with aggregated population. [Source: This metadata
  record was automatically extracted from the Humanitarian Data Exchange (HDX); Original
  dataset: https://data.humdata.org/dataset/kontur-boundaries-iran-islamic-republic-of]'
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap and enhanced
    using proprietary methods. Population counts were aggregated from the Kontur Population
    dataset (400m H3 hexagons) to administrative division polygons. HASC codes were
    enriched from Wikidata to provide standardized regional identifiers.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-iran-islamic-republic-of
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Iran (Islamic Republic Of): Administrative Division with Aggregated
    Population (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_IR_20220407.gpkg.gz
  format: null
  id: resource_29b604f5
  ...
  title: kontur_boundaries_IR_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_IR_20230628.gpkg.gz
  format: null
  id: resource_f945071c
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_IR_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Iran (Islamic Republic Of): Administrative Division with Aggregated
    Population (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_IR_20230628.gpkg.gz
  format: null
  id: resource_691cfc7f
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_IR_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-irn_kontur_islamicrepublicadministra_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Iran (Islamic Republic Of): Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
