...
- entity:
    ...
    url: https://data.humdata.org/dataset/umi-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/umi-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-umi_hdx_unitedstatesminoroutlying_1941
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/umi-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    Track positions, timestamps, wind speeds, and central pressures are recorded at
    regular intervals along each storm's path. The dataset provides observed hazard
    characteristics for tropical cyclones affecting the United States Minor Outlying
    Islands region.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/umi-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/fd93f31d-37b1-4f01-b2e0-bc874c41b4af/resource/70158a5d-dcd0-4fe3-b1c1-e4f87c526df5/download/ibtracs_all_list_v04r01_umi.csv
  format: null
  id: resource_70158a5d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_UMI.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1941 to date that pass within 2000 kilometers
    of United States Minor Outlying Islands.
  download_url: https://data.humdata.org/dataset/fd93f31d-37b1-4f01-b2e0-bc874c41b4af/resource/d9d03178-ef79-4190-a731-89516527e8a5/download/ibtracs_all_list_v04r01_lines_umi.geojson
  format: null
  id: resource_d9d03178
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_UMI.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-umi_hdx_unitedstatesminoroutlying_1941
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1941-02-16'
temporal_resolution: null
title: 'United States Minor Outlying Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
