...
- entity:
    ...
    url: https://data.humdata.org/dataset/irl-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/irl-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-irl_hdx_ibtracsstormtracks_1852
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/irl-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Ireland subset
    ...
    observation points along each cyclone's path.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/irl-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Ireland.
  download_url: https://data.humdata.org/dataset/f0f26671-8272-4c85-9749-382a5c47274f/resource/9741dbc1-4f3b-4a99-8194-8032a726262c/download/ibtracs_all_list_v04r01_irl.csv
  format: null
  id: resource_9741dbc1
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_IRL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Ireland.
  download_url: https://data.humdata.org/dataset/f0f26671-8272-4c85-9749-382a5c47274f/resource/a00aecab-d0c6-446a-a745-a13455364455/download/ibtracs_all_list_v04r01_lines_irl.geojson
  format: null
  id: resource_a00aecab
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_IRL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-irl_hdx_ibtracsstormtracks_1852
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1852-09-02'
temporal_resolution: null
title: 'Ireland: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
