...
- entity:
    ...
    url: https://data.humdata.org/dataset/icpac-geonode-tanzania-flood-inundation-100-year-return-period
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: IGAD Climate Prediction and Applications Center (ICPAC)
  url: https://data.humdata.org/dataset/icpac-geonode-tanzania-flood-inundation-100-year-return-period
dataset_id: rdls_hzd-tza_icpac_floodinundation100yearret_20250328
description: 'This dataset is the output from the Global Flood Model intercomparison
  ...
  https://data.humdata.org/dataset/icpac-geonode-tanzania-flood-inundation-100-year-return-period]'
...
hazard:
  ...
  - analysis_type: probabilistic
    ...
    events:
    - calculation_method: simulated
      description: Probabilistic fluvial flood hazard model for Tanzania at 100-year
...
lineage:
  description: Fluvial flood inundation depths were simulated using an ensemble of
    6 global flood models as part of the Global Flood Partnership intercomparison
    project (Trigg et al., 2016). Model outputs were harmonized to WGS84 at ~90m resolution
    and classified by the number of models agreeing on inundation presence, providing
    a probabilistic representation of flood hazard at the 100-year return period.
  sources:
  - id: source_1
    license: null
    name: Global Flood Model intercomparison project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/icpac-geonode-tanzania-flood-inundation-100-year-return-period
  rel: source
loss: null
project: null
publisher:
...
referenced_by: []
resources:
- access_url: https://geoportal.icpac.net/geoserver/ows?service=WCS&request=GetCoverage&coverageid=geonode__Tanzania_flood_inundation&format=image%2Ftiff&version=2.0.1&compression=DEFLATE&tileWidth=512&tileHeight=512
  ...
  title: Tanzania Flood Inundation (100 year return period) GeoTIFF
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tza_icpac_floodinundation100yearret_20250328
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-03-28'
temporal_resolution: null
title: Tanzania Flood Inundation (100 year return period)
version: null
vulnerability: null
---
