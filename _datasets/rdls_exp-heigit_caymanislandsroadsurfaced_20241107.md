...
- entity:
    ...
    url: https://data.humdata.org/dataset/cayman-islands-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/cayman-islands-road-surface-data
dataset_id: rdls_exp-heigit_caymanislandsroadsurfaced_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cayman-islands-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for Cayman Islands. A hybrid deep learning model was applied to classify road
    surfaces as paved or unpaved, generating predictions for roads with missing or
    uncertain surface data in OSM. The final dataset combines OSM-mapped roads with
    AI-predicted surface classifications to provide comprehensive road surface coverage
    across the region.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cayman-islands-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Cayman Islands: Road Surface Data (GeoJSON data for Cayman islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_cym_roadsurface_lines.geojson
  format: null
  id: resource_436fd5c7
  ...
  title: Cayman islands GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Cayman Islands: Road Surface Data (Geopackage data for Cayman islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_cym_roadsurface_lines.gpkg
  format: null
  id: resource_193e13af
  ...
  temporal: null
  temporal_resolution: null
  title: Cayman islands GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-heigit_caymanislandsroadsurfaced_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Cayman Islands: Road Surface Data'
version: null
vulnerability: null
---
