...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/tza-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/tza-rainfall-subnational
dataset_id: rdls_hzd-tza_wfp_unitedrepublicrainfallind_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/tza-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with in-situ station measurements, then aggregated by subnational administrative
    units in Tanzania. Dekadal (10-day) rainfall totals, 1-month and 3-month rolling
    aggregations, and long-term averages were computed to enable drought monitoring
    and early warning through comparison of current rainfall against historical norms.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tza-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135712395730_4ad17933'
  download_url: https://data.humdata.org/dataset/6887105f-3bc0-48d6-b06c-ae706c4dba22/resource/ac71b7fb-ea85-4444-a84c-e135d2a7341e/download/tza-rainfall-subnat-full.csv
  format: null
  id: resource_ac71b7fb
  media_type: text/csv
  spatial: null
  ...
  title: tza-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135712395730_4ad17933'
  download_url: https://data.humdata.org/dataset/6887105f-3bc0-48d6-b06c-ae706c4dba22/resource/88ab0e54-4df5-400d-9ab0-675aa98dee45/download/tza-rainfall-subnat-5ytd.csv
  format: null
  id: resource_88ab0e54
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: tza-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tza_wfp_unitedrepublicrainfallind_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'United Republic of Tanzania: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
