...
- entity:
    ...
    url: https://data.humdata.org/dataset/rou-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/rou-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-rou_hdx_ibtracsstormtracks_1883
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/rou-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Romania subset contains observed storm positions,
    wind speeds (wmo_wind), central pressures (wmo_pres), and storm classification
    (nature) at 6-hourly intervals, filtered geographically for the Romanian region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/rou-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Romania.
  download_url: https://data.humdata.org/dataset/f5b02897-d5e4-40cf-849e-ea3d48f9ba77/resource/75417974-1aa8-4b34-9f4a-41cb6bfd2f5b/download/ibtracs_all_list_v04r01_rou.csv
  format: null
  id: resource_75417974
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ROU.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Romania.
  download_url: https://data.humdata.org/dataset/f5b02897-d5e4-40cf-849e-ea3d48f9ba77/resource/fa5e0b96-5343-4853-8120-f03f4c8c3fc7/download/ibtracs_all_list_v04r01_lines_rou.geojson
  format: null
  id: resource_fa5e0b96
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ROU.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-rou_hdx_ibtracsstormtracks_1883
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1883-08-20'
temporal_resolution: null
title: 'Romania: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
