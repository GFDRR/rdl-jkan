...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-mozambique
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-mozambique
dataset_id: rdls_exp-moz_kontur_administrativedivisionagg_20220407
description: 'Mozambique administrative division with aggregated population. Built
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-mozambique]'
...
- asset_type:
    description: Aggregated population counts at administrative division level derived
      from Kontur 400m H3 hexagon population density grid
    id: population
    scheme: null
    title: null
    uri: null
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries for Mozambique were extracted from OpenStreetMap
    and enriched with aggregated population data from the Kontur Population dataset
    (400m H3 hexagons). Population counts were spatially aggregated to each administrative
    division, and HASC codes were added from Wikidata to create a baseline population
    exposure dataset at multiple administrative levels.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-mozambique
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Mozambique: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_MZ_20220407.gpkg.gz
  format: null
  id: resource_7243e021
  ...
  title: kontur_boundaries_MZ_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Mozambique: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_MZ_20230628.gpkg.gz
  format: null
  id: resource_d023c0e9
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_MZ_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Mozambique: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_MZ_20230628.gpkg.gz
  format: null
  id: resource_62802d46
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_MZ_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-moz_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Mozambique: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
