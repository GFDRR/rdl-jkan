...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-lso-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-lso-settlement-extents-v3-0
dataset_id: rdls_exp-lso_grid3_lsosettlementextentsv30_2016
description: 'The GRID3 LSO - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Lesotho, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Lesotho Settlement Extents,
  ...
  2024. GRID3 LSO - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-lso-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents and gridded settlement data were derived from open
    data sources using a new methodology to estimate building counts and generate
    settlement polygons at 3-arc second (~100 meter) resolution. The dataset includes
    both polygon representations of settlements and spatial grid points marking settled
    cell centroids, with attributes describing building and population characteristics.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- access_url: null
  ...
  description: Lesotho - GRID3 LSO - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/db129bdb-00b1-46f8-b2ca-942b4e6e23ef/resource/dbe606fa-c6b2-480c-adc8-e4260eb32b60/download/grid3-lso-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_dbe606fa
  ...
  title: GRID3 LSO - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Lesotho - GRID3 LSO - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/db129bdb-00b1-46f8-b2ca-942b4e6e23ef/resource/8787b454-4a2f-4332-8c78-8d1f919cdce5/download/grid3_lso_settlement_extents_v3_0.zip
  format: null
  id: resource_8787b454
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_LSO_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/db129bdb-00b1-46f8-b2ca-942b4e6e23ef/resource/9c6bd49e-75e3-438e-b708-47e2307f9c99/download/grid3_lso_settlement_grid_v3_0.zip
  format: null
  id: resource_9c6bd49e
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_LSO_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lso_grid3_lsosettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Lesotho - GRID3 LSO - Settlement Extents v3.0
version: null
vulnerability: null
---
