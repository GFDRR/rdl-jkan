...
- entity:
    ...
    url: https://data.humdata.org/dataset/myt-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/myt-ghsl
dataset_id: rdls_exp-myt_copernicus_mayotteglobalhumansettlem_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/myt-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    surfaces and population distribution. For Mayotte, these global methodologies
    were applied to generate raster layers representing settlement patterns and human
    presence.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/myt-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/f6b17ba6-6168-4eb6-858c-f0ecccea58bb/resource/0a888fce-4331-431c-8999-10ed7e841998/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_myt.tif
  format: null
  id: resource_0a888fce
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Mayotte: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/f6b17ba6-6168-4eb6-858c-f0ecccea58bb/resource/c676b25d-71dc-4cd7-818c-fada8aed1dfc/download/ghs_pop_e2025_r2023a_54009_100_v1_0_myt.tif
  format: null
  id: resource_c676b25d
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-myt_copernicus_mayotteglobalhumansettlem_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Mayotte: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
