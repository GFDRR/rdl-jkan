...
- entity:
    ...
    url: https://data.humdata.org/dataset/mhl-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mhl-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mhl_hdx_marshallislandsibtracssto_1890
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mhl-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates historical and recent tropical cyclone observations
    ...
    quality-controlled and standardized. The Marshall Islands subset contains all
    cyclone tracks affecting or passing through the Marshall Islands region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mhl-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1890 to date that pass within 2000 kilometers
    of Marshall Islands.
  download_url: https://data.humdata.org/dataset/e2375fa5-df62-4e4d-a5a3-7b85091badd7/resource/0c90eece-865f-444b-ad1a-e21c8b768c12/download/ibtracs_all_list_v04r01_mhl.csv
  format: null
  id: resource_0c90eece
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MHL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1890 to date that pass within 2000 kilometers
    of Marshall Islands.
  download_url: https://data.humdata.org/dataset/e2375fa5-df62-4e4d-a5a3-7b85091badd7/resource/fb856e09-09e8-4f16-83a1-193501491821/download/ibtracs_all_list_v04r01_lines_mhl.geojson
  format: null
  id: resource_fb856e09
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MHL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mhl_hdx_marshallislandsibtracssto_1890
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1890-10-29'
temporal_resolution: null
title: 'Marshall Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
