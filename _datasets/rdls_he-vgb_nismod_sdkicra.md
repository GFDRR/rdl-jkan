...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-vgb_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for British Virgin Islands. Derived from
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540148
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540148
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    British Virgin Islands, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16540148/files/VGB.zip
  format: null
  id: resource_sdkicra_vgb
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - British
    Virgin Islands
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-vgb_nismod_sdkicra
spatial:
  bbox:
  - -64.77
  - 18.33
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3577718/british-virgin-islands.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for British Virgin
  Islands
version: 0.1.0
vulnerability: null
---
