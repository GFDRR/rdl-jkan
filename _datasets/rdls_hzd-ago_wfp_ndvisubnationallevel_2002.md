...
- entity:
    ...
    url: https://data.humdata.org/dataset/ago-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ago-ndvi-subnational
dataset_id: rdls_hzd-ago_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ago-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    were integrated into 8-day synthetic products and processed to derive dekadal
    NDVI values. NDVI indicators (10-day index, long-term average, and percentage
    anomaly) were computed and aggregated by WFP-defined subnational administrative
    units with Pcode references, enabling vegetation stress monitoring for agricultural
    drought assessment.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ago-ndvi-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135418879754_3e752b43'
  download_url: https://data.humdata.org/dataset/3ca138a8-0832-47be-8908-5f9a95c330d9/resource/2284c6e2-d80c-49ab-9931-b8a04236df46/download/ago-ndvi-subnat-full.csv
  format: null
  id: resource_2284c6e2
  media_type: text/csv
  spatial: null
  ...
  title: ago-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135418879754_3e752b43'
  download_url: https://data.humdata.org/dataset/3ca138a8-0832-47be-8908-5f9a95c330d9/resource/7ebc56a7-1cbf-401b-8574-5b801ee6ecfc/download/ago-ndvi-subnat-5ytd.csv
  format: null
  id: resource_7ebc56a7
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ago-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ago_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Angola: NDVI at Subnational Level'
version: null
vulnerability: null
---
