...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-united-states-minor-outlying-islands-the
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-united-states-minor-outlying-islands-the
dataset_id: rdls_exp-umi_kontur_unitedstatesminoroutlying_2023
description: 'United States Minor Outlying Islands population density for 400m H3
  ...
  dataset: https://data.humdata.org/dataset/kontur-population-united-states-minor-outlying-islands-the]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    high spatial resolution for the United States Minor Outlying Islands.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-united-states-minor-outlying-islands-the
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'United States Minor Outlying Islands (the): Population Density for
    400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_UM_20220630.gpkg.gz
  format: null
  id: resource_f7e2368e
  ...
  title: kontur_population_UM_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_UM_20231101.gpkg.gz
  format: null
  id: resource_ca122dc1
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_UM_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-umi_kontur_unitedstatesminoroutlying_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'United States Minor Outlying Islands (the): Population Density for 400m H3
  Hexagons'
version: null
vulnerability: null
---
