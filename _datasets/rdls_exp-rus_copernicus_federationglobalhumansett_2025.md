...
- entity:
    ...
    url: https://data.humdata.org/dataset/rus-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/rus-ghsl
dataset_id: rdls_exp-rus_copernicus_federationglobalhumansett_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/rus-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. The resulting GeoTIFF layers represent the spatial extent and density
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/rus-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/9bc967b1-06aa-44ba-a620-462cec8e9da0/resource/07c392c7-c536-4880-9423-f9d9307c72f5/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_rus.tif
  format: null
  id: resource_07c392c7
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Russian Federation: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/9bc967b1-06aa-44ba-a620-462cec8e9da0/resource/c25eacfe-9a50-4ed9-8573-7ac7cf27f490/download/ghs_pop_e2025_r2023a_54009_100_v1_0_rus.tif
  format: null
  id: resource_c25eacfe
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-rus_copernicus_federationglobalhumansett_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Russian Federation: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
