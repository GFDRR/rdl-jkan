...
- entity:
    ...
    url: https://data.humdata.org/dataset/pol-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/pol-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-pol_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/pol-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Poland subset contains observed storm track positions (latitude, longitude,
    time) with associated wind speed (wmo_wind) and pressure (wmo_pres) measurements
    extracted from the global archive and filtered for the Polish region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pol-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Poland.
  download_url: https://data.humdata.org/dataset/329e5e3b-ecd2-4937-83d9-15bab432db10/resource/e937dbc2-3d49-444d-ad0d-1c219cd89e19/download/ibtracs_all_list_v04r01_pol.csv
  format: null
  id: resource_e937dbc2
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_POL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Poland.
  download_url: https://data.humdata.org/dataset/329e5e3b-ecd2-4937-83d9-15bab432db10/resource/0f972059-d155-4247-bca9-48acae2bbca0/download/ibtracs_all_list_v04r01_lines_pol.geojson
  format: null
  id: resource_0f972059
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_POL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-pol_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Poland: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
