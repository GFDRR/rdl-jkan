...
- entity:
    ...
    url: https://data.humdata.org/dataset/asm-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/asm-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-asm_hdx_americansamoaibtracsstorm_1941
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/asm-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    positions, wind speeds (WMO standard), and central pressure are recorded at regular
    time intervals and provided as point and line geometries for American Samoa.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/asm-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1941 to date that pass within 2000 kilometers
    of American Samoa.
  download_url: https://data.humdata.org/dataset/4a4da261-46e8-4f14-b438-d02ac5b8387a/resource/14a4a2a0-d243-43fd-92e6-c355c4670d4d/download/ibtracs_all_list_v04r01_asm.csv
  format: null
  id: resource_14a4a2a0
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ASM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1941 to date that pass within 2000 kilometers
    of American Samoa.
  download_url: https://data.humdata.org/dataset/4a4da261-46e8-4f14-b438-d02ac5b8387a/resource/4148ec42-456c-4fb3-b171-ca07a14b385c/download/ibtracs_all_list_v04r01_lines_asm.geojson
  format: null
  id: resource_4148ec42
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ASM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-asm_hdx_americansamoaibtracsstorm_1941
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1941-01-13'
temporal_resolution: null
title: 'American Samoa: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
