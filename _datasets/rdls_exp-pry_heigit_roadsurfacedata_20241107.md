...
- entity:
    ...
    url: https://data.humdata.org/dataset/paraguay-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/paraguay-road-surface-data
dataset_id: rdls_exp-pry_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2413 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0293 and 0.0902
  (in million kms), corressponding to 12.1439% and 37.3725% respectively of the total
  road length in the dataset region. 0.1218 million km or 50.4836% of road surface
  ...
  to 0.3177% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/paraguay-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    type attributes across Paraguay, supporting humanitarian access and logistics
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/paraguay-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Paraguay: Road Surface Data (GeoJSON data for Paraguay.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_pry_roadsurface_lines.geojson
  format: null
  id: resource_2b169ccf
  ...
  title: Paraguay GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Paraguay: Road Surface Data (Geopackage data for Paraguay.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_pry_roadsurface_lines.gpkg
  format: null
  id: resource_60358829
  ...
  temporal: null
  temporal_resolution: null
  title: Paraguay GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pry_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Paraguay: Road Surface Data'
version: null
vulnerability: null
---
