...
- entity:
    ...
    url: https://data.humdata.org/dataset/tza-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/tza-ndvi-subnational
dataset_id: rdls_hzd-tza_wfp_unitedrepublicndvisubnati_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tza-ndvi-subnational]'
...
lineage:
  description: MODIS Aqua and Terra 16-day composite products (MYD13C1 and MOD13C1)
    ...
    Raw NDVI values (vim), long-term averages (vim_lta), and percentage anomalies
    (viq) were computed and aggregated by WFP-defined sub-national administrative
    units with Pcode references to create a time-series vegetation monitoring dataset
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tza-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135714852190_4af92aad'
  download_url: https://data.humdata.org/dataset/a327a55f-0a68-4755-b8f8-237317908b24/resource/eb595260-32de-4c51-a259-4b8c077cf95a/download/tza-ndvi-subnat-full.csv
  format: null
  id: resource_eb595260
  media_type: text/csv
  spatial: null
  ...
  title: tza-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135714852190_4af92aad'
  download_url: https://data.humdata.org/dataset/a327a55f-0a68-4755-b8f8-237317908b24/resource/5bec6dca-1771-430e-b2ce-12340234f421/download/tza-ndvi-subnat-5ytd.csv
  format: null
  id: resource_5bec6dca
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: tza-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tza_wfp_unitedrepublicndvisubnati_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'United Republic of Tanzania: NDVI at Subnational Level'
version: null
vulnerability: null
---
