...
- entity:
    ...
    url: https://data.humdata.org/dataset/ken-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ken-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ken_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ken-ibtracs-tropical-storm-tracks]'
...
license: CC-BY-4.0
lineage:
  description: IBTrACS integrates tropical cyclone track data from multiple national
    meteorological agencies into a unified best-track archive. The dataset contains
    observed storm positions (latitude/longitude), ISO timestamps, wind speeds (wmo_wind),
    central pressure (wmo_pres), and storm classification (nature) for all cyclones
    affecting Kenya, providing the most complete global collection of tropical cyclone
    observations.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ken-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Kenya.
  download_url: https://data.humdata.org/dataset/209ed798-afe3-494b-b937-c1bb4d7da402/resource/9673c917-73b8-4aed-83b7-17325e72a7ec/download/ibtracs_all_list_v04r01_ken.csv
  format: null
  id: resource_9673c917
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_KEN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Kenya.
  download_url: https://data.humdata.org/dataset/209ed798-afe3-494b-b937-c1bb4d7da402/resource/20e3496b-9255-4294-a3b6-0647368aebc4/download/ibtracs_all_list_v04r01_lines_ken.geojson
  format: null
  id: resource_20e3496b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_KEN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ken_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-03-20'
temporal_resolution: null
title: 'Kenya: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
