...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-prt_nismod_sdkicra__madeira
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Madeira. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540115
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540115
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Madeira, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540115/files/PRT.zip
  format: null
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Madeira
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-prt_nismod_sdkicra__madeira
spatial:
  bbox:
  - -31.28
  - 30.03
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Madeira
version: 0.1.0
vulnerability: null
---
