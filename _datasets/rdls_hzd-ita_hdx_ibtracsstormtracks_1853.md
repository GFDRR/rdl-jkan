...
- entity:
    ...
    url: https://data.humdata.org/dataset/ita-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ita-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ita_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ita-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Italy subset contains observed storm track positions (latitude, longitude,
    ISO timestamp), basin/sub-basin classification, wind speed (wmo_wind), and central
    pressure (wmo_pres) for all tropical cyclones affecting or passing through Italian
    territory.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ita-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Italy.
  download_url: https://data.humdata.org/dataset/2f304903-fbcd-4c85-a189-1d6bf320310a/resource/13f944c5-7bf5-435a-920f-e4b6fa328ae6/download/ibtracs_all_list_v04r01_ita.csv
  format: null
  id: resource_13f944c5
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ITA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Italy.
  download_url: https://data.humdata.org/dataset/2f304903-fbcd-4c85-a189-1d6bf320310a/resource/0bca6b6d-5cb7-41be-8360-a06fc09dc581/download/ibtracs_all_list_v04r01_lines_ita.geojson
  format: null
  id: resource_0bca6b6d
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ITA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ita_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Italy: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
