...
- entity:
    ...
    url: https://data.humdata.org/dataset/ago-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ago-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ago_hdx_ibtracsstormtracks_1858
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ago-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Angola subset contains observed storm track positions with associated wind
    speed (wmo_wind) and pressure (wmo_pres) measurements at 6-hourly intervals, filtered
    geographically for the Angola region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ago-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1858 to date that pass within 2000 kilometers
    of Angola.
  download_url: https://data.humdata.org/dataset/0f791222-a2f8-4f07-86db-69055a5c7982/resource/1a208620-31bf-4c8e-a8c6-62f32b9f0fdc/download/ibtracs_all_list_v04r01_ago.csv
  format: null
  id: resource_1a208620
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_AGO.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1858 to date that pass within 2000 kilometers
    of Angola.
  download_url: https://data.humdata.org/dataset/0f791222-a2f8-4f07-86db-69055a5c7982/resource/d44dd8cb-f106-4de7-9293-1726ee31d0d9/download/ibtracs_all_list_v04r01_lines_ago.geojson
  format: null
  id: resource_d44dd8cb
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_AGO.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ago_hdx_ibtracsstormtracks_1858
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1858-03-31'
temporal_resolution: null
title: 'Angola: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
