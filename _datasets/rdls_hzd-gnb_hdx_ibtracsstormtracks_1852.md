...
- entity:
    ...
    url: https://data.humdata.org/dataset/gnb-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/gnb-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-gnb_hdx_ibtracsstormtracks_1852
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/gnb-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies (WMO, regional meteorological centers) into
    a unified best-track dataset. Track positions, wind speeds (wmo_wind), and central
    pressures (wmo_pres) are standardized and quality-controlled. The Guinea-Bissau
    subset contains all cyclone tracks affecting or passing through the country's
    basin.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gnb-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Guinea-Bissau.
  download_url: https://data.humdata.org/dataset/57a96ce1-e5dc-4c81-981f-51d0a11e0503/resource/da484042-8cff-429d-a48a-72901ae1dca0/download/ibtracs_all_list_v04r01_gnb.csv
  format: null
  id: resource_da484042
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GNB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Guinea-Bissau.
  download_url: https://data.humdata.org/dataset/57a96ce1-e5dc-4c81-981f-51d0a11e0503/resource/179e3ce3-daf2-499b-a9ae-e80b164155dd/download/ibtracs_all_list_v04r01_lines_gnb.geojson
  format: null
  id: resource_179e3ce3
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GNB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gnb_hdx_ibtracsstormtracks_1852
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1852-09-26'
temporal_resolution: null
title: 'Guinea-Bissau: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
