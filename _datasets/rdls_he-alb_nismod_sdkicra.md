...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-alb_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Albania. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539702
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539702
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Albania, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16539702/files/ALB.zip
  format: null
  id: resource_sdkicra_alb
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Albania
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-alb_nismod_sdkicra
spatial:
  bbox:
  - 19.27
  - 39.64
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Albania
version: 0.2.1
vulnerability: null
---
