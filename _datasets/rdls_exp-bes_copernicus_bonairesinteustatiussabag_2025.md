...
- entity:
    ...
    url: https://data.humdata.org/dataset/bes-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bes-ghsl
dataset_id: rdls_exp-bes_copernicus_bonairesinteustatiussabag_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bes-ghsl]'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bes-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/316c45af-23c5-4912-b563-0b9a53161d4d/resource/bfd9e051-556d-446a-b1a1-44990d5c9000/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bes.tif
  format: null
  id: resource_bfd9e051
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Bonaire, Sint Eustatius and Saba: Copernicus Global Human Settlement
    Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system:
    Mollweide)'
  download_url: https://data.humdata.org/dataset/316c45af-23c5-4912-b563-0b9a53161d4d/resource/e3a76e4e-ec20-4bbf-8f9d-bd5a893dc5f8/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bes.tif
  format: null
  id: resource_e3a76e4e
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-bes_copernicus_bonairesinteustatiussabag_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Bonaire, Sint Eustatius and Saba: Copernicus Global Human Settlement Layer
  (GHSL)'
version: null
vulnerability: null
---
