...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-venezuela-bolivarian-republic-of
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-venezuela-bolivarian-republic-of
dataset_id: rdls_exp-ven_kontur_bolivarianrepublicpopulat_2023
description: 'Venezuela (Bolivarian Republic of) population density for 400m H3 hexagons.
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-venezuela-bolivarian-republic-of]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    to create a refined population distribution model. Population counts were aggregated
    into 400m H3 hexagonal grid cells using the H3 hierarchical spatial indexing system.
    The resulting dataset provides baseline population exposure at high spatial resolution
    for Venezuela.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-venezuela-bolivarian-republic-of
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Venezuela (Bolivarian Republic of): Population Density for 400m H3
    Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_VE_20220630.gpkg.gz
  format: null
  id: resource_7b2c1a77
  ...
  title: kontur_population_VE_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_VE_20231101.gpkg.gz
  format: null
  id: resource_049f9c99
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_VE_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ven_kontur_bolivarianrepublicpopulat_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Venezuela (Bolivarian Republic of): Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
