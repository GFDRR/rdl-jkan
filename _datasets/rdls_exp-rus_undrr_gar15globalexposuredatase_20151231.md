...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-russian-federation
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-russian-federation
dataset_id: rdls_exp-rus_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-russian-federation]'
...
- asset_type:
  ...
  - dimension: population
    ...
    measurement:
      ...
      unit: count
- asset_type:
    description: Gross domestic product (GDP) distributed as proxy for economic exposure
...
lineage:
  description: The GAR15 global exposure database for Russian Federation was developed
    using a top-down approach where national-level socio-economic, building type,
    and capital stock statistics were spatially distributed onto 5x5 km and 1x1 km
    grids using geographic population density and GDP as spatial proxies. The dataset
    integrates inputs from multiple international agencies (UNEP-GRID, WAPMERR, JRC,
    Kokusai Kogyo) to estimate economic value of exposed assets across the country.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-russian-federation
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Russian Federation.zip
  download_url: https://data.humdata.org/dataset/c88a7ca1-5369-4e87-a2bc-b423e14bfd97/resource/ee1aa232-b80f-49d1-afb8-883e73b67d8c/download/rus.zip
  format: null
  id: resource_ee1aa232
  ...
  title: GAR15 Global Exposure Dataset for Russian Federation.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-rus_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Russian Federation
version: null
vulnerability: null
---
