...
- entity:
    ...
    url: https://data.humdata.org/dataset/guf-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/guf-ndvi-subnational
dataset_id: rdls_hzd-guf_wfp_frenchguianandvisubnation_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/guf-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI values at subnational administrative units. NDVI anomalies were calculated
    as percentage deviations from long-term averages to characterize vegetation stress
    patterns indicative of agricultural drought conditions.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guf-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135525401216_96f6b05f'
  download_url: https://data.humdata.org/dataset/45ef9bfe-3fab-4ce9-90bf-9b09b569270f/resource/93df6bd2-133e-4ec6-984d-b03600e053d6/download/guf-ndvi-subnat-full.csv
  format: null
  id: resource_93df6bd2
  media_type: text/csv
  spatial: null
  ...
  title: guf-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135525401216_96f6b05f'
  download_url: https://data.humdata.org/dataset/45ef9bfe-3fab-4ce9-90bf-9b09b569270f/resource/d0fdc290-b8ce-433a-8aa2-fa25e70dfeab/download/guf-ndvi-subnat-5ytd.csv
  format: null
  id: resource_d0fdc290
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: guf-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-guf_wfp_frenchguianandvisubnation_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'French Guiana: NDVI at Subnational Level'
version: null
vulnerability: null
---
