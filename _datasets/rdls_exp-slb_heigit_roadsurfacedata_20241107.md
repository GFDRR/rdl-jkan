...
- entity:
    ...
    url: https://data.humdata.org/dataset/solomon-islands-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/solomon-islands-road-surface-data
dataset_id: rdls_exp-slb_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.017 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0004 and 0.0034
  (in million kms), corressponding to 2.3805% and 20.1517% respectively of the total
  road length in the dataset region. 0.0132 million km or 77.4678% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0003 million km of information (corressponding
  to 2.0322% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/solomon-islands-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model predictions were integrated with existing OSM surface attributes, with
    both OSM-priority and deep-learning-priority combined classifications provided.
    The resulting dataset contains ~0.017 million km of mapped roads with surface
    type predictions and geometric attributes.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/solomon-islands-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Solomon Islands: Road Surface Data (GeoJSON data for Solomon islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_slb_roadsurface_lines.geojson
  format: null
  id: resource_323d7c5a
  ...
  title: Solomon islands GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Solomon Islands: Road Surface Data (Geopackage data for Solomon islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_slb_roadsurface_lines.gpkg
  format: null
  id: resource_a9b3d584
  ...
  temporal: null
  temporal_resolution: null
  title: Solomon islands GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-slb_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Solomon Islands: Road Surface Data'
version: null
vulnerability: null
---
