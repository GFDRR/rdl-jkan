...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-grc_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Greece. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540006
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540006
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Greece, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540006/files/GRC.zip
  format: null
  id: resource_sdkicra_grc
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Greece
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-grc_nismod_sdkicra
spatial:
  bbox:
  - 19.63
  - 34.82
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/390903/greece.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Greece
version: 0.1.0
vulnerability: null
---
