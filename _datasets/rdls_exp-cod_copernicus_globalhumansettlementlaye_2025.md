...
- entity:
    ...
    url: https://data.humdata.org/dataset/cod-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cod-ghsl
dataset_id: rdls_exp-cod_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cod-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    For DRC, these layers provide baseline exposure data for human settlements and
    infrastructure without hazard or impact components.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cod-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/17dd5006-86a9-4e59-aaf8-a91fe9d38141/resource/adb465cc-e2c4-4df8-969e-452aee211f8d/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cod.tif
  format: null
  id: resource_adb465cc
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Democratic Republic of the Congo: Copernicus Global Human Settlement
    Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system:
    Mollweide)'
  download_url: https://data.humdata.org/dataset/17dd5006-86a9-4e59-aaf8-a91fe9d38141/resource/c0469c2c-9803-4862-bbcc-dcc3e05d853d/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cod.tif
  format: null
  id: resource_c0469c2c
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cod_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Democratic Republic of the Congo: Copernicus Global Human Settlement Layer
  (GHSL)'
version: null
vulnerability: null
---
