...
- entity:
    ...
    url: https://data.humdata.org/dataset/blm-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/blm-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-blm_hdx_saintbarthelemyibtracssto_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/blm-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: "IBTrACS merges historical and recent tropical cyclone observations\
    ...
    \ Track positions, timestamps, wind speeds, and central pressures are recorded\
    \ at regular intervals along each storm's path. The dataset provides observed\
    \ hazard characteristics for Saint Barth\xE9lemy tropical cyclone exposure."
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/blm-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: "IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers\
    \ of Saint Barth\xE9lemy."
  download_url: https://data.humdata.org/dataset/94b7ca3c-09f4-490f-a4a7-fe787cc5ae67/resource/2de49dbf-d712-4b95-a985-b8bc198a06fe/download/ibtracs_all_list_v04r01_blm.csv
  format: null
  id: resource_2de49dbf
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BLM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: "IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers\
    \ of Saint Barth\xE9lemy."
  download_url: https://data.humdata.org/dataset/94b7ca3c-09f4-490f-a4a7-fe787cc5ae67/resource/6b47f256-1c40-4635-b31d-35fa214fa471/download/ibtracs_all_list_v04r01_lines_blm.geojson
  format: null
  id: resource_6b47f256
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BLM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-blm_hdx_saintbarthelemyibtracssto_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: "Saint Barth\xE9lemy: IBTrACS Storm Tracks"
version: null
vulnerability: null
---
