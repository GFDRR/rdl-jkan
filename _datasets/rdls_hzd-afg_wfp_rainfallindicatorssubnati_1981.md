...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/afg-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/afg-rainfall-subnational
dataset_id: rdls_hzd-afg_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery integrated with
    ...
    1-month and 3-month rolling aggregations) and aggregated by Afghan subnational
    administrative units to monitor meteorological drought conditions.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/afg-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135420507080_66c1643c'
  download_url: https://data.humdata.org/dataset/3b5e8a5c-e4e0-4c58-9c58-d87e33520e08/resource/0e6fe8ce-f7c5-4320-bc57-bc95ed7fcd7b/download/afg-rainfall-subnat-full.csv
  format: null
  id: resource_0e6fe8ce
  media_type: text/csv
  spatial: null
  ...
  title: afg-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135420507080_66c1643c'
  download_url: https://data.humdata.org/dataset/3b5e8a5c-e4e0-4c58-9c58-d87e33520e08/resource/e6c0b120-6e2e-43f2-bf18-ef51f5fa9c20/download/afg-rainfall-subnat-5ytd.csv
  format: null
  id: resource_e6c0b120
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: afg-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-afg_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Afghanistan: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
