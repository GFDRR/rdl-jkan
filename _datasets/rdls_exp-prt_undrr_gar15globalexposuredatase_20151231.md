...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-portugal
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-portugal
dataset_id: rdls_exp-prt_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-portugal]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    and GDP as spatial proxies. The dataset was developed by UNEP-GRID for the GAR15
    global exposure database through multi-agency collaboration to create a spatially-explicit
    inventory of economic and population exposure for Portugal.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-portugal
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Portugal.zip
  download_url: https://data.humdata.org/dataset/b6a009de-33f1-4429-a4b8-c4930626e7c2/resource/f1dfaea8-bbd2-4c08-b337-eb62718d27ad/download/prt.zip
  format: null
  id: resource_f1dfaea8
  ...
  title: GAR15 Global Exposure Dataset for Portugal.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-prt_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Portugal
version: null
vulnerability: null
---
