...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-south-georgia-and-south-s-s
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-south-georgia-and-south-s-s
dataset_id: rdls_exp-sgs_kontur_southgeorgiasouthssadmini_20220407
description: 'South Georgia And South S.S. administrative division with aggregated
  population. Built from Kontur Population: Global Population Density for 400m H3
  Hexagons on top of OpenStreetMap administrative boundaries data. Enriched with HASC
  codes for regions taken from Wikidata. Global version of boundaries dataset: Kontur
  Boundaries: Global administrative division with aggregated population. [Source:
  This metadata record was automatically extracted from the Humanitarian Data Exchange
  (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-south-georgia-and-south-s-s]'
...
- asset_type:
    description: Aggregated population counts at administrative division level derived
      from 400m H3 hexagon population density data
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    proprietary processing methods, then enriched with aggregated population statistics
    derived from the Kontur Population dataset (400m H3 hexagon resolution). HASC
    codes for regions were added from Wikidata to create a baseline population exposure
    dataset at the administrative division level.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-south-georgia-and-south-s-s
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'South Georgia and the South Sandwich Islands - South Georgia And South
    S.S.: Administrative Division with Aggregated Population (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_GS_20220407.gpkg.gz
  format: null
  id: resource_9711dba6
  ...
  title: kontur_boundaries_GS_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'South Georgia and the South Sandwich Islands - South Georgia And South
    S.S.: Administrative Division with Aggregated Population (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_GS_20230628.gpkg.gz
  format: null
  id: resource_ef7a3a30
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_GS_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'South Georgia and the South Sandwich Islands - South Georgia And South
    S.S.: Administrative Division with Aggregated Population (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_GS_20230628.gpkg.gz
  format: null
  id: resource_f74e9d4f
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_GS_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sgs_kontur_southgeorgiasouthssadmini_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'South Georgia and the South Sandwich Islands - South Georgia And South S.S.:
  Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
