...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-cmr-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-cmr-settlement-extents-v3-0
dataset_id: rdls_exp-cmr_grid3_cmrsettlementextentsv30_2016
description: 'The GRID3 CMR - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Cameroon, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Cameroon Settlement Extents,
  ...
  2024. GRID3 CMR - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-cmr-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents and building counts were derived from open data
    ...
    densities. The dataset represents settlements as both polygon boundaries and 3-arc
    second (~100 meter) grid cell centroids with associated building count and population
    attributes across Cameroon.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-cmr-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Cameroon - GRID3 CMR - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/32082e7c-b6fe-4863-ae96-623be7b9e5d3/resource/fe6f15fd-b3d5-46b9-a9a5-67203b1885ab/download/grid3-cmr-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_fe6f15fd
  ...
  title: GRID3 CMR - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Cameroon - GRID3 CMR - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/32082e7c-b6fe-4863-ae96-623be7b9e5d3/resource/ea3e6e88-5645-4f73-9fe1-7257fc56b2ff/download/grid3_cmr_settlement_extents_v3_0.zip
  format: null
  id: resource_ea3e6e88
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_CMR_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/32082e7c-b6fe-4863-ae96-623be7b9e5d3/resource/7caac21a-224c-4c4e-96fd-54565fd80b1d/download/grid3_cmr_settlement_grid_v3_0.zip
  format: null
  id: resource_7caac21a
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_CMR_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cmr_grid3_cmrsettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Cameroon - GRID3 CMR - Settlement Extents v3.0
version: null
vulnerability: null
---
