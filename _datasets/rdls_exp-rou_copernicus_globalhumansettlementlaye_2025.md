...
- entity:
    ...
    url: https://data.humdata.org/dataset/rou-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/rou-ghsl
dataset_id: rdls_exp-rou_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/rou-ghsl]'
...
lineage:
  description: 'The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. Two primary outputs are provided: GHS Built-up Surface (built environment
    extent and density) and GHS Population Grid (gridded population counts), both
    at global coverage with Romania as the focus area.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/rou-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/80fd530e-eb0d-455a-a9b7-c0bbce18fef7/resource/1a9bd430-d749-452d-bcb6-824c57f3845f/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_rou.tif
  format: null
  id: resource_1a9bd430
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Romania: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/80fd530e-eb0d-455a-a9b7-c0bbce18fef7/resource/9453b46e-9ede-468b-a027-cd218b10dffc/download/ghs_pop_e2025_r2023a_54009_100_v1_0_rou.tif
  format: null
  id: resource_9453b46e
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-rou_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Romania: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
