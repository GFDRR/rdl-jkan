...
- entity:
    ...
    url: https://data.humdata.org/dataset/vir-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/vir-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-vir_hdx_unitedstatesvirginislands_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/vir-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    dataset contains observed storm positions, wind speeds (wmo_wind), and central
    pressure (wmo_pres) recorded at regular time intervals in ISO format, providing
    the most complete global collection of tropical cyclone observations.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vir-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/4955ab98-939e-4f41-93b7-fd96c0697e67/resource/393d7063-17a7-4df5-825d-c5dade7b392d/download/ibtracs_all_list_v04r01_vir.csv
  format: null
  id: resource_393d7063
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_VIR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of United States Virgin Islands.
  download_url: https://data.humdata.org/dataset/4955ab98-939e-4f41-93b7-fd96c0697e67/resource/b49ecadb-ee3e-423f-ac8e-f204ea68dcd1/download/ibtracs_all_list_v04r01_lines_vir.geojson
  format: null
  id: resource_b49ecadb
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_VIR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-vir_hdx_unitedstatesvirginislands_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-29'
temporal_resolution: null
title: 'United States Virgin Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
