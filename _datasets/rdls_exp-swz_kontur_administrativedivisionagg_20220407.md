...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-eswatini
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-eswatini
dataset_id: rdls_exp-swz_kontur_administrativedivisionagg_20220407
description: 'Eswatini administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-eswatini]'
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    proprietary enhancements and filtered to Eswatini. Population counts were aggregated
    from the Kontur Population dataset (400m H3 hexagons) to each administrative division.
    HASC codes were enriched from Wikidata to provide standardized administrative
    identifiers.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-eswatini
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Eswatini: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_SZ_20220407.gpkg.gz
  format: null
  id: resource_5a59bfb3
  ...
  title: kontur_boundaries_SZ_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Eswatini: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_SZ_20230628.gpkg.gz
  format: null
  id: resource_9d92403b
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_SZ_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Eswatini: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_SZ_20230628.gpkg.gz
  format: null
  id: resource_aabeadea
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_SZ_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-swz_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Eswatini: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
