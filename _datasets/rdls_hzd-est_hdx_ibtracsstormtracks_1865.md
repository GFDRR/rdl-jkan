...
- entity:
    ...
    url: https://data.humdata.org/dataset/est-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/est-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-est_hdx_ibtracsstormtracks_1865
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/est-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Estonia subset contains observed cyclone positions,
    timestamps, basin classifications, wind speeds (wmo_wind), and central pressure
    (wmo_pres) for all tropical cyclones affecting or passing through the region,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/est-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Estonia.
  download_url: https://data.humdata.org/dataset/e8fbb652-e56e-4c48-84fd-63cf70bd6cc9/resource/7a6f0338-87e1-4040-ad15-a9b444d7779d/download/ibtracs_all_list_v04r01_est.csv
  format: null
  id: resource_7a6f0338
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_EST.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Estonia.
  download_url: https://data.humdata.org/dataset/e8fbb652-e56e-4c48-84fd-63cf70bd6cc9/resource/16204297-f9ed-4e87-8dac-3bbd919df60c/download/ibtracs_all_list_v04r01_lines_est.geojson
  format: null
  id: resource_16204297
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_EST.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-est_hdx_ibtracsstormtracks_1865
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1865-10-24'
temporal_resolution: null
title: 'Estonia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
