...
- entity:
    ...
    url: https://data.humdata.org/dataset/caf-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/caf-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-caf_hdx_ibtracsstormtracks_1944
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/caf-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple international
    agencies into a unified best-track archive. The dataset provides observed storm
    track positions, timing, wind speeds (wmo_wind), and central pressure (wmo_pres)
    for all cyclones affecting the Central African Republic region, with data standardized
    through the IBTrACS algorithm.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/caf-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1944 to date that pass within 2000 kilometers
    of Central African Republic.
  download_url: https://data.humdata.org/dataset/ce233cc6-9d4b-4431-8c84-4634bbb31a1c/resource/a9f69a45-31ff-42d5-ba12-ea419d3b6102/download/ibtracs_all_list_v04r01_caf.csv
  format: null
  id: resource_a9f69a45
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CAF.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1944 to date that pass within 2000 kilometers
    of Central African Republic.
  download_url: https://data.humdata.org/dataset/ce233cc6-9d4b-4431-8c84-4634bbb31a1c/resource/adb5889d-352b-4350-913c-39ee170cda76/download/ibtracs_all_list_v04r01_lines_caf.geojson
  format: null
  id: resource_adb5889d
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CAF.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-caf_hdx_ibtracsstormtracks_1944
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1944-10-21'
temporal_resolution: null
title: 'Central African Republic: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
