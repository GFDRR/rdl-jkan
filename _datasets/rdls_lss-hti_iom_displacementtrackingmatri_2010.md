...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/hti-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/hti-iom-dtm-from-api
dataset_id: rdls_lss-hti_iom_displacementtrackingmatri_2010
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/hti-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through field assessments (baseline,
    emergency tracking, and site assessments) aggregated at country and subnational
    administrative levels. Data is compiled into a publicly accessible API providing
    non-sensitive IDP figures disaggregated by gender, displacement reason, and origin
    location to support humanitarian response and analysis.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hti-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Haiti IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/230d6112-6379-4078-ab85-10ea7013e246/resource/f6a2b764-648d-400b-8eb9-2471dc8a219f/download/hti-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_f6a2b764
  media_type: text/csv
  spatial: null
  ...
  title: Haiti IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-hti_iom_displacementtrackingmatri_2010
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2010-11-30'
temporal_resolution: null
title: Haiti IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
