...
- entity:
    ...
    url: https://data.humdata.org/dataset/nigeria-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/nigeria-road-surface-data
dataset_id: rdls_exp-nga_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 1.0944 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.1326 and 0.3908
  (in million kms), corressponding to 12.119% and 35.7111% respectively of the total
  road length in the dataset region. 0.571 million km or 52.1699% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0016 million km of information (corressponding
  to 0.2766% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nigeria-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The resulting dataset provides spatial inventory of approximately 1.09 million
    km of mapped roads in Nigeria with surface type classification, supporting humanitarian
    access and infrastructure planning applications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nigeria-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Nigeria: Road Surface Data (GeoJSON data for Nigeria.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_nga_roadsurface_lines.geojson
  format: null
  id: resource_751f36f9
  ...
  title: Nigeria GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Nigeria: Road Surface Data (Geopackage data for Nigeria.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_nga_roadsurface_lines.gpkg
  format: null
  id: resource_1b89196f
  ...
  temporal: null
  temporal_resolution: null
  title: Nigeria GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nga_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Nigeria: Road Surface Data'
version: null
vulnerability: null
---
