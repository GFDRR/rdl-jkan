...
- entity:
    ...
    url: https://data.humdata.org/dataset/jpn-ghsl
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/jpn-ghsl
dataset_id: rdls_exp-jpn_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/jpn-ghsl]'
...
- asset_type:
    description: Built-up surface area derived from satellite imagery representing
      the spatial extent of human-made structures across Japan
    id: buildings
    scheme: null
    title: null
    uri: null
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Gridded population distribution across Japan derived from census
...
lineage:
  description: The GHSL dataset is produced by the JRC using automated spatial data
    ...
    and crowdsourced geographic information. Machine learning and image classification
    algorithms are applied to extract built-up surface extents and estimate population
    distributions at global scale. The resulting gridded products (GeoTIFF) provide
    spatially explicit exposure layers for Japan suitable for disaster risk assessment
    and urban analysis.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/jpn-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/055fe050-23ba-4e24-8aca-45589cce2a31/resource/5cc32815-8991-4f29-a132-f9ca348a2a02/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_jpn.tif
  format: null
  id: resource_5cc32815
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Japan: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/055fe050-23ba-4e24-8aca-45589cce2a31/resource/bbb9afda-8659-456b-96ad-058f3144e60c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_jpn.tif
  format: null
  id: resource_bbb9afda
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-jpn_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Japan: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
