...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-grenada
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-grenada
dataset_id: rdls_exp-grd_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-grenada]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    distribution and GDP as spatial proxies. The dataset represents a top-down exposure
    modeling approach developed collaboratively by UNEP-GRID, WAPMERR, JRC, and Kokusai
    Kogyo for the GAR15 global risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-grenada
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Grenada.zip
  download_url: https://data.humdata.org/dataset/63ad8e2d-09a7-4bab-bb67-c8da894c59f2/resource/9592ca50-146f-4050-861b-c53fddfaee67/download/grd.zip
  format: null
  id: resource_9592ca50
  ...
  title: GAR15 Global Exposure Dataset for Grenada.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-grd_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Grenada
version: null
vulnerability: null
---
