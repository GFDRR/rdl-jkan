...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-heard-island-and-mcdonald-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-heard-island-and-mcdonald-islands
dataset_id: rdls_exp-hmd_kontur_heardislandmcdonaldisland_2023
description: 'Heard Island and McDonald Islands population density for 400m H3 hexagons.
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-heard-island-and-mcdonald-islands]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    using the H3 hierarchical spatial indexing system. The dataset provides baseline
    population exposure data for Heard Island and McDonald Islands at high spatial
    resolution.
  sources:
  - id: source_1
    license: null
...
- access_url: null
  ...
  description: 'Heard Island and McDonald Islands: Population Density for 400m H3
    Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_HM_20220630.gpkg.gz
  format: null
  id: resource_5d90256f
  ...
  title: kontur_population_HM_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_HM_20231101.gpkg.gz
  format: null
  id: resource_34cc4c08
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_HM_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-hmd_kontur_heardislandmcdonaldisland_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Heard Island and McDonald Islands: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
