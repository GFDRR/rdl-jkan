...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/mali-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/mali-level-1-exposure-data
dataset_id: rdls_exp-mli_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mali-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Exposure data was developed through the METEOR project using Earth
    ...
    (approximately 500 meters at the equator) in point shapefile format for use in
    catastrophe modeling and disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mali-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Mali produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/dafa5639-d31d-4c7e-b3d9-d3ebdb676e56/resource/54d500a0-84d5-4dc7-a81e-d71ec10b7b4f/download/mli_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_54d500a0
  ...
  title: MLI_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mli_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Mali: Level 1 Exposure Data'
version: null
vulnerability: null
---
