...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-azerbaijan
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-azerbaijan
dataset_id: rdls_exp-aze_kontur_populationdensity400mh3he_2023
description: 'Azerbaijan population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-azerbaijan]'
...
lineage:
  description: Population density was calculated by fusing multiple global datasets
    ...
    using H3 hexagonal hierarchical spatial indexing at 400m resolution. The multi-source
    fusion approach integrates satellite-derived settlement layers with building footprints
    and land cover data to produce gridded population counts for Azerbaijan.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-azerbaijan
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Azerbaijan: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AZ_20220630.gpkg.gz
  format: null
  id: resource_87a9e0e5
  ...
  title: kontur_population_AZ_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Azerbaijan: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AZ_20231101.gpkg.gz
  format: null
  id: resource_0b8de1e0
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_AZ_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-aze_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Azerbaijan: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
