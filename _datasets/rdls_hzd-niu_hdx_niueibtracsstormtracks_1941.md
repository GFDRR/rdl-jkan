...
- entity:
    ...
    url: https://data.humdata.org/dataset/niu-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/niu-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-niu_hdx_niueibtracsstormtracks_1941
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/niu-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The Niue subset contains historical
    and recent cyclone tracks with ISO-formatted timestamps, basin/subbasin classification,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/niu-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Niue: IBTrACS Storm Tracks (IBTrACS storm tracks from 1941 to date
    that pass within 2000 kilometers of Niue.)'
  download_url: https://data.humdata.org/dataset/7957afbc-44c2-4003-9989-285b15642d3d/resource/b7996c3d-a256-4735-8361-5fb839c5a349/download/ibtracs_all_list_v04r01_niu.csv
  format: null
  id: resource_b7996c3d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NIU.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Niue: IBTrACS Storm Tracks (IBTrACS storm tracks from 1941 to date
    that pass within 2000 kilometers of Niue.)'
  download_url: https://data.humdata.org/dataset/7957afbc-44c2-4003-9989-285b15642d3d/resource/3ab477a2-7606-486c-827b-f87fd80b2936/download/ibtracs_all_list_v04r01_lines_niu.geojson
  format: null
  id: resource_3ab477a2
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NIU.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-niu_hdx_niueibtracsstormtracks_1941
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1941-01-13'
temporal_resolution: null
title: 'Niue: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
