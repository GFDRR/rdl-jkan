...
- entity:
    ...
    email: null
    name: OCHA
    url: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-in-2020
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: OCHA Afghanistan
  url: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-in-2020
dataset_id: rdls_el-afg_ochaafg_naturaldisasterincidents2_2020
description: '1) Natural disaster events include avalanches, earthquakes, flooding,
  ...
  dataset: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-in-2020]'
...
lineage:
  description: Post-event natural disaster incident data compiled from direct field
    ...
    international NGOs, and ERM throughout 2020. Affected population counts and building
    damage figures were extracted from incident reports and field assessments documenting
    avalanches, earthquakes, flooding, heavy rainfall and snowfall, and landslides/mudflows
    across Afghanistan.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-in-2020
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/adddb5b1-77cc-4e50-8508-08eaf0900f84/resource/2ac59f11-9bcc-4d61-bad9-a47560b1557d/download/afghanistan-natural-disaster-incidents-from-january-to-december-2020.xlsx
  format: null
  id: resource_2ac59f11
  ...
  title: afghanistan-natural-disaster-incidents-from-january-to-december-2020.xlsx
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: Natural disaster events include avalanches, earthquakes, flooding,
    heavy rainfall & snowfall, and landslides & mudflows as recorded by OCHA field
    offices based on assessments in the field.
  download_url: https://data.humdata.org/dataset/adddb5b1-77cc-4e50-8508-08eaf0900f84/resource/5deffbf5-a3c3-46ee-8c6c-0fd610cb3df9/download/afghanistan-natural-disaster-incidents-from-january-to-december-2020.csv
  format: null
  id: resource_5deffbf5
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: afghanistan-natural-disaster-incidents-from-january-to-december-2020.csv
risk_data_type:
- exposure
- loss
schema: rdls-10
slug: rdls_el-afg_ochaafg_naturaldisasterincidents2_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-01-01'
temporal_resolution: null
title: Afghanistan - Natural Disaster Incidents in 2020
version: null
vulnerability: null
---
