...
- entity:
    ...
    url: https://data.humdata.org/dataset/mys-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mys-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mys_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mys-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Malaysia subset contains observed storm track positions (latitude, longitude,
    ISO timestamp), basin/sub-basin classification, wind speed (WMO), and central
    pressure measurements for all tropical cyclones affecting the region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mys-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Malaysia.
  download_url: https://data.humdata.org/dataset/fd28d645-76a3-4899-8b07-0c5e59f503e5/resource/48173cbf-a5c7-46e7-9eb8-e25c0a15861e/download/ibtracs_all_list_v04r01_mys.csv
  format: null
  id: resource_48173cbf
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MYS.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Malaysia.
  download_url: https://data.humdata.org/dataset/fd28d645-76a3-4899-8b07-0c5e59f503e5/resource/b1a69f96-b38b-4148-bc9d-599bf3203ed3/download/ibtracs_all_list_v04r01_lines_mys.geojson
  format: null
  id: resource_b1a69f96
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MYS.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mys_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-11-01'
temporal_resolution: null
title: 'Malaysia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
