...
- entity:
    ...
    url: https://data.humdata.org/dataset/svalbard-and-jan-mayen-islands-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
    email: null
    name: HeiGIT hybrid deep learning road surface prediction model
    url: https://data.humdata.org/dataset/svalbard-and-jan-mayen-islands-road-surface-data
  id: attribution_2
  role: collaborator
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/svalbard-and-jan-mayen-islands-road-surface-data
dataset_id: rdls_exp-sjm_heigit_svalbardjanmayenislandsro_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/svalbard-and-jan-mayen-islands-road-surface-data]'
details: null
exposure:
- asset_type:
    description: Road network lines classified by surface type (paved/unpaved) using
      AI-based deep learning prediction from OpenStreetMap data
    id: infrastructure
    scheme: null
    title: null
    uri: null
...
license: ODbL-1.0/
lineage:
  description: Road network geometries were extracted from OpenStreetMap and processed
    through a hybrid deep learning model (arxiv:2410.19874) developed by HeiGIT to
    predict road surface types (paved vs. unpaved) at the segment level. The resulting
    dataset combines OSM-tagged surface information with AI-predicted classifications,
    providing a comprehensive road surface inventory relevant for humanitarian access
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/svalbard-and-jan-mayen-islands-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Svalbard and Jan Mayen Islands: Road Surface Data (GeoJSON data for
    Svalbard and jan mayen islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_sjm_roadsurface_lines.geojson
  format: null
  id: resource_c3b29395
  ...
  title: Svalbard and jan mayen islands GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Svalbard and Jan Mayen Islands: Road Surface Data (Geopackage data
    for Svalbard and jan mayen islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_sjm_roadsurface_lines.gpkg
  format: null
  id: resource_8b0989ac
  ...
  temporal: null
  temporal_resolution: null
  title: Svalbard and jan mayen islands GeoPackage Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Svalbard and Jan Mayen Islands: Road Surface Data (GeoJSON file for
    Svalbard and jan mayen islands)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/test_planet_road_data/heigit_SJ_planet_roadsurface_lines.geojson
  format: null
  id: resource_d9ba51b7
  media_type: application/geo+json
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-sjm_heigit_svalbardjanmayenislandsro_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Svalbard and Jan Mayen Islands: Road Surface Data'
version: null
vulnerability: null
---
