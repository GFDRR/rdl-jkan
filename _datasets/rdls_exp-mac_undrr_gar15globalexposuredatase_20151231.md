...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-macao
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-macao
dataset_id: rdls_exp-mac_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-macao]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure database for Macao was developed using a
    ...
    Kogyo) to create a comprehensive gridded exposure inventory for disaster risk
    assessment.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-macao
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Macao.zip
  download_url: https://data.humdata.org/dataset/fe52d7b7-bf10-4599-911e-e7b6a47194e6/resource/62e20de4-bd6e-4248-8506-c7fe2bf34929/download/mac.zip
  format: null
  id: resource_62e20de4
  ...
  title: GAR15 Global Exposure Dataset for Macao.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mac_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Macao
version: null
vulnerability: null
---
