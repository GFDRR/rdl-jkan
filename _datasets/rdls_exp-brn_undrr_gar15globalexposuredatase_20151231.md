...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-brunei-darussalam
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-brunei-darussalam
dataset_id: rdls_exp-brn_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-brunei-darussalam]'
...
lineage:
  description: The GAR15 global exposure database for Brunei Darussalam was developed
    using a top-down approach where national-level socio-economic data, building type
    distributions, and capital stock information were spatially disaggregated onto
    5x5 km and 1x1 km grids using geographic population density and GDP as spatial
    proxies. The dataset integrates inputs from multiple international agencies (UNEP-GRID,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-brunei-darussalam
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Brunei Darussalam.zip
  download_url: https://data.humdata.org/dataset/a8b0b626-9de4-453d-8acc-f98717e36914/resource/94b2606c-b9ad-43b3-891f-a0658001dccc/download/brn.zip
  format: null
  id: resource_94b2606c
  ...
  title: GAR15 Global Exposure Dataset for Brunei Darussalam.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-brn_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Brunei Darussalam
version: null
vulnerability: null
---
