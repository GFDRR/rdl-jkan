...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-nam-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-nam-settlement-extents-v3-0
dataset_id: rdls_exp-nam_grid3_namsettlementextentsv30_2016
description: 'The GRID3 NAM - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Namibia, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Namibia Settlement Extents,
  ...
  2024. GRID3 NAM - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-nam-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents were derived from open data using a new methodology
    ...
    polygon representations of settlements and 3-arc-second (~100 meter) gridded spatial
    points depicting settled grid cell centroids with associated building and population
    attributes.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-nam-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Namibia - GRID3 NAM - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/d77bab7f-3f03-41f3-9ccd-bbe8a91de65f/resource/b89c543e-4c39-4b9b-bd9c-41f6857aa9a3/download/grid3-nam-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_b89c543e
  ...
  title: GRID3 NAM - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Namibia - GRID3 NAM - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/d77bab7f-3f03-41f3-9ccd-bbe8a91de65f/resource/11b52d95-a0a8-4eb8-960f-8ea21e79dbcd/download/grid3_nam_settlement_extents_v3_0.zip
  format: null
  id: resource_11b52d95
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_NAM_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/d77bab7f-3f03-41f3-9ccd-bbe8a91de65f/resource/5e2701dc-d6d3-46a2-afa4-36771c8e9cd5/download/grid3_nam_settlement_grid_v3_0.zip
  format: null
  id: resource_5e2701dc
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_NAM_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nam_grid3_namsettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Namibia - GRID3 NAM - Settlement Extents v3.0
version: null
vulnerability: null
---
