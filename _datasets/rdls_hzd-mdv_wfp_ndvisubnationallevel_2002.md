...
- entity:
    ...
    url: https://data.humdata.org/dataset/mdv-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mdv-ndvi-subnational
dataset_id: rdls_hzd-mdv_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mdv-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    Computed indicators include raw NDVI (vim), long-term average (vim_lta), and percentage
    anomaly (viq) to support agricultural drought monitoring.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mdv-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135607463838_12f4e24a'
  download_url: https://data.humdata.org/dataset/b4e22e97-61c3-41f5-af42-09f1b98d493b/resource/5a252679-eb56-49b3-b2e4-5ef18324e31f/download/mdv-ndvi-subnat-full.csv
  format: null
  id: resource_5a252679
  media_type: text/csv
  spatial: null
  ...
  title: mdv-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135607463838_12f4e24a'
  download_url: https://data.humdata.org/dataset/b4e22e97-61c3-41f5-af42-09f1b98d493b/resource/32d6ae0a-e68c-41cd-91bc-fccb24178d4f/download/mdv-ndvi-subnat-5ytd.csv
  format: null
  id: resource_32d6ae0a
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mdv-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mdv_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Maldives: NDVI at Subnational Level'
version: null
vulnerability: null
---
