...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/benin-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/benin-level-1-exposure-data
dataset_id: rdls_exp-ben_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/benin-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    resolution) estimates of building counts, building areas, and rebuilding values
    intended for catastrophe modeling and loss estimation applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/benin-level-1-exposure-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Benin produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/7f215f23-3cd8-4322-b6bd-016bdc3fba5e/resource/f990e213-c665-4a36-bc44-66be08eb9986/download/ben_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_f990e213
  ...
  title: BEN_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ben_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Benin: Level 1 Exposure Data'
version: null
vulnerability: null
---
