...
- entity:
    ...
    url: https://data.humdata.org/dataset/ton-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ton-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ton_hdx_ibtracsstormtracks_1919
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ton-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Tonga subset contains observed storm positions, times, wind speeds (wmo_wind),
    and central pressures (wmo_pres) extracted from the global archive and provided
    in both tabular (CSV) and spatial (GeoJSON) formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ton-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- hazard
schema: rdls-10
slug: rdls_hzd-ton_hdx_ibtracsstormtracks_1919
spatial:
  bbox: null
  centroid: null
  countries:
