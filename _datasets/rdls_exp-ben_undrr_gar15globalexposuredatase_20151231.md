...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-benin
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-benin
dataset_id: rdls_exp-ben_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-benin]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Benin were transposed onto 5x5 km and 1x1 km gridded geographic distributions
    using gridded population data and GDP as spatial proxies. The dataset was developed
    by UNEP-GRID for the Global Assessment Report on Disaster Risk Reduction (GAR15)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-benin
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Benin.zip
  download_url: https://data.humdata.org/dataset/f9a652b4-a43a-4360-a315-67b0a69727f3/resource/4e934878-ecbf-4a01-8c12-5d25f9b88777/download/ben.zip
  format: null
  id: resource_4e934878
  ...
  title: GAR15 Global Exposure Dataset for Benin.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ben_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Benin
version: null
vulnerability: null
---
