...
- entity:
    ...
    url: https://data.humdata.org/dataset/costa-rica-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/costa-rica-road-surface-data
dataset_id: rdls_exp-cri_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.068 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0129 and 0.0136
  (in million kms), corressponding to 18.9713% and 19.989% respectively of the total
  road length in the dataset region. 0.0415 million km or 61.0397% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0006 million km of information (corressponding
  to 1.361% of total missing information on road surface) It is intended for use in
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/costa-rica-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for Costa Rica. A hybrid deep learning model was applied to classify road surfaces
    as paved or unpaved, generating predictions with associated confidence metrics
    (n_of_predictions_used). Results were integrated with OSM data using priority-based
    combination logic to produce final surface classifications across the road network.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/costa-rica-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Costa Rica: Road Surface Data (GeoJSON data for Costa rica.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_cri_roadsurface_lines.geojson
  format: null
  id: resource_f4139356
  ...
  title: Costa rica GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Costa Rica: Road Surface Data (Geopackage data for Costa rica.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_cri_roadsurface_lines.gpkg
  format: null
  id: resource_5ef2ef86
  ...
  temporal: null
  temporal_resolution: null
  title: Costa rica GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cri_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Costa Rica: Road Surface Data'
version: null
vulnerability: null
---
