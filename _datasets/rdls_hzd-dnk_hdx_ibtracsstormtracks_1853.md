...
- entity:
    ...
    url: https://data.humdata.org/dataset/dnk-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/dnk-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-dnk_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/dnk-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates historical and recent tropical cyclone observations
    ...
    at regular time intervals and quality-controlled to create the most complete global
    collection of tropical cyclone hazard data.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dnk-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Denmark.
  download_url: https://data.humdata.org/dataset/5b46e7f1-212e-40e5-a0b3-22fd8ce39196/resource/c9edda4d-c289-4c96-826a-eb38ac79ab09/download/ibtracs_all_list_v04r01_dnk.csv
  format: null
  id: resource_c9edda4d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_DNK.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Denmark.
  download_url: https://data.humdata.org/dataset/5b46e7f1-212e-40e5-a0b3-22fd8ce39196/resource/61521a1c-0a23-446d-bb2d-5193c9407630/download/ibtracs_all_list_v04r01_lines_dnk.geojson
  format: null
  id: resource_61521a1c
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_DNK.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-dnk_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Denmark: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
