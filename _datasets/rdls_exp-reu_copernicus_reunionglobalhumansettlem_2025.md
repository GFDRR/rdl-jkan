...
- entity:
    ...
    url: https://data.humdata.org/dataset/reu-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/reu-ghsl
dataset_id: rdls_exp-reu_copernicus_reunionglobalhumansettlem_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/reu-ghsl]'
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/56e45fd0-d24e-4a2f-9cca-b65baf563db6/resource/a90c4106-7599-4b5c-845f-870c35830541/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_reu.tif
  format: null
  id: resource_a90c4106
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: "R\xE9union: Copernicus Global Human Settlement Layer (GHSL) (Product:\
    \ GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)"
  download_url: https://data.humdata.org/dataset/56e45fd0-d24e-4a2f-9cca-b65baf563db6/resource/8fe134a3-c4a8-4e40-93fd-f6518093b4ac/download/ghs_pop_e2025_r2023a_54009_100_v1_0_reu.tif
  format: null
  id: resource_8fe134a3
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-reu_copernicus_reunionglobalhumansettlem_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: "R\xE9union: Copernicus Global Human Settlement Layer (GHSL)"
version: null
vulnerability: null
---
