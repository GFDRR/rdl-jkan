...
- entity:
    ...
    url: https://data.humdata.org/dataset/cpv-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/cpv-rainfall-subnational
dataset_id: rdls_hzd-cpv_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/cpv-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with rain gauge measurements and aggregated by subnational administrative units.
    Dekadal rainfall totals and rolling 1-month and 3-month aggregations were computed,
    along with anomalies relative to long-term climatological averages, to produce
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cpv-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135427429298_c5da6e0e'
  download_url: https://data.humdata.org/dataset/ccd43313-efba-4dfe-b269-7fe2a739276a/resource/c2c656f1-505c-42b7-93d5-0de6dd5bd2d3/download/cpv-rainfall-subnat-full.csv
  format: null
  id: resource_c2c656f1
  media_type: text/csv
  spatial: null
  ...
  title: cpv-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135427429298_c5da6e0e'
  download_url: https://data.humdata.org/dataset/ccd43313-efba-4dfe-b269-7fe2a739276a/resource/f89a90d4-e54f-4eb5-af2a-afa41b6136bc/download/cpv-rainfall-subnat-5ytd.csv
  format: null
  id: resource_f89a90d4
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: cpv-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cpv_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Cabo Verde: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
