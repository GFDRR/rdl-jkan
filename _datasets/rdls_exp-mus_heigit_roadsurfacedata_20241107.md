...
- entity:
    ...
    url: https://data.humdata.org/dataset/mauritius-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/mauritius-road-surface-data
dataset_id: rdls_exp-mus_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mauritius-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated predictions for approximately 0.0137 million km of mapped
    roads in Mauritius, with results provided in both GeoJSON and GeoPackage formats
    containing original OSM attributes, predicted surface classifications, and confidence
    metrics.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mauritius-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Mauritius: Road Surface Data (GeoJSON data for Mauritius.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_mus_roadsurface_lines.geojson
  format: null
  id: resource_21c96170
  ...
  title: Mauritius GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Mauritius: Road Surface Data (Geopackage data for Mauritius.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_mus_roadsurface_lines.gpkg
  format: null
  id: resource_f95dcdbf
  ...
  temporal: null
  temporal_resolution: null
  title: Mauritius GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mus_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Mauritius: Road Surface Data'
version: null
vulnerability: null
---
