...
- entity:
    ...
    url: https://data.humdata.org/dataset/prk-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/prk-ghsl
dataset_id: rdls_exp-prk_copernicus_democraticpeoplesrepublic_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/prk-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: The GHSL dataset integrates global fine-scale satellite image data
    streams with census data and crowdsourced geographic information through automated
    spatial data processing technologies to produce gridded estimates of built-up
    surfaces and population distribution. The resulting GeoTIFF rasters represent
    spatially explicit exposure of human settlements and infrastructure across the
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/prk-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/9bddd411-7077-4a4a-b4f5-1e804dd8fca3/resource/a1b1d306-3bc8-4894-80ee-66256273ead2/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_prk.tif
  format: null
  id: resource_a1b1d306
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Democratic People''s Republic of Korea: Copernicus Global Human Settlement
    Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system:
    Mollweide)'
  download_url: https://data.humdata.org/dataset/9bddd411-7077-4a4a-b4f5-1e804dd8fca3/resource/91242b43-3321-4a4c-a201-5a6cc2ca8856/download/ghs_pop_e2025_r2023a_54009_100_v1_0_prk.tif
  format: null
  id: resource_91242b43
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-prk_copernicus_democraticpeoplesrepublic_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Democratic People''s Republic of Korea: Copernicus Global Human Settlement
  Layer (GHSL)'
version: null
vulnerability: null
---
