...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/ago-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ago-rainfall-subnational
dataset_id: rdls_hzd-ago_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/ago-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite observations merged with
    ground station measurements, aggregated into dekadal indicators at subnational
    administrative units. Rolling 1-month and 3-month aggregations computed alongside
    long-term climatological averages to enable drought monitoring and early warning
    through rainfall anomaly detection.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ago-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135417130077_2963fbdb'
  download_url: https://data.humdata.org/dataset/84dbf78f-3d9c-43d4-8a69-64debbd9e582/resource/fac00c49-12ca-4a13-9bed-75e829c879ea/download/ago-rainfall-subnat-full.csv
  format: null
  id: resource_fac00c49
  media_type: text/csv
  spatial: null
  ...
  title: ago-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135417130077_2963fbdb'
  download_url: https://data.humdata.org/dataset/84dbf78f-3d9c-43d4-8a69-64debbd9e582/resource/2add38d1-cf81-473d-ae7a-08d8787119fe/download/ago-rainfall-subnat-5ytd.csv
  format: null
  id: resource_2add38d1
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ago-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ago_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Angola: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
