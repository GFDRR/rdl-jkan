...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-anguilla
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-anguilla
dataset_id: rdls_exp-aia_kontur_anguillapopulationdensity_2023
description: 'Anguilla population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-anguilla]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    overlay and density estimation techniques. The resulting gridded population product
    provides baseline exposure data for disaster risk assessment at sub-kilometer
    resolution.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-anguilla
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Anguilla: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AI_20220630.gpkg.gz
  format: null
  id: resource_aeb0f2c9
  ...
  title: kontur_population_AI_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Anguilla: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AI_20231101.gpkg.gz
  format: null
  id: resource_ebdf6221
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_AI_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-aia_kontur_anguillapopulationdensity_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Anguilla: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
