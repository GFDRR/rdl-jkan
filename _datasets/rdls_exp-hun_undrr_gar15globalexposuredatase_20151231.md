...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-hungary
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-hungary
dataset_id: rdls_exp-hun_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-hungary]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    global exposure database with multi-agency collaboration to estimate economic
    value and spatial distribution of exposed assets in Hungary.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-hungary
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Hungary.zip
  download_url: https://data.humdata.org/dataset/ed60ef20-1921-49a2-8e15-40ccb0505357/resource/91da001f-e979-43ff-880d-7de135043769/download/hun.zip
  format: null
  id: resource_91da001f
  ...
  title: GAR15 Global Exposure Dataset for Hungary.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-hun_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Hungary
version: null
vulnerability: null
---
