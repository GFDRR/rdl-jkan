...
- entity:
    ...
    url: https://data.humdata.org/dataset/brb-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/brb-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-brb_hdx_barbadosibtracsstormtrack_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/brb-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    standardized and quality-controlled. The Barbados subset filters global IBTrACS
    records to storms affecting the national domain.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/brb-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Barbados.
  download_url: https://data.humdata.org/dataset/aed9c96a-02eb-4edf-ab0d-cbbe17e72890/resource/7ffe6393-9f59-47d1-8c81-79b1831b35f6/download/ibtracs_all_list_v04r01_brb.csv
  format: null
  id: resource_7ffe6393
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BRB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Barbados.
  download_url: https://data.humdata.org/dataset/aed9c96a-02eb-4edf-ab0d-cbbe17e72890/resource/bc325837-a780-4852-974f-a2a50e55bdb7/download/ibtracs_all_list_v04r01_lines_brb.geojson
  format: null
  id: resource_bc325837
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BRB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-brb_hdx_barbadosibtracsstormtrack_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Barbados: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
