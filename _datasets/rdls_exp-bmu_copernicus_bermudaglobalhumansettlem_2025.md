...
- entity:
    ...
    url: https://data.humdata.org/dataset/bmu-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bmu-ghsl
dataset_id: rdls_exp-bmu_copernicus_bermudaglobalhumansettlem_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bmu-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    and population distribution at global scale. For Bermuda, this produces rasterized
    representations of human settlement patterns and infrastructure footprints.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bmu-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/68a90627-e37b-421a-86bf-7b9981721019/resource/46aaaaf2-a67e-431a-956b-9343bdf2090b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bmu.tif
  format: null
  id: resource_46aaaaf2
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Bermuda: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/68a90627-e37b-421a-86bf-7b9981721019/resource/c7291347-bf03-4d98-9496-8f22451afaa3/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bmu.tif
  format: null
  id: resource_c7291347
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-bmu_copernicus_bermudaglobalhumansettlem_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Bermuda: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
