...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-bih_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Bosnia and Herzegovina. Derived from
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540013
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540013
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Bosnia and Herzegovina, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16540013/files/BIH.zip
  format: null
  id: resource_sdkicra_bih
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Bosnia
    and Herzegovina
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-bih_nismod_sdkicra
spatial:
  bbox:
  - 15.72
  - 42.56
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3277605/bosnia-and-herzegovina.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Bosnia and
  Herzegovina
version: 0.1.0
vulnerability: null
---
