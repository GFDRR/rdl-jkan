...
creator:
  ...
  name: "Universidad de Cantabria, Instituto de Hidr\uCE58ulica Ambiental de la Universidad\
    \ de Cantabria 'IHCantabria'"
  url: www.ihcantabria.com
dataset_id: rdls_hzd-coclico_twlslrrp
description: 'Total Water Level Return Periods represents the combination of storm
  ...
  an indication of the maximum water levels expected at different storms for different
  times and emission scenarios. Spatial coverage: European coastline at coastal target
...
lineage:
  description: 'Total Water Level Return Periods represents the combination of storm
    ...
    provides an indication of the maximum water levels expected at different storms
    for different times and emission scenarios. Spatial coverage: European coastline
...
referenced_by: []
resources:
- access_url: https://storage.googleapis.com/coclico-data-public/coclico/coclico-stac/twl_SLR_RP/collection.json
  ...
  title: 'STAC Collection: CoCliCo - Total Water Level Return Periods [twl_SLR_RP]'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
...
- access_url: https://storage.googleapis.com/download/storage/v1/b/coclico-data-public/o/coclico%2Fassets%2Fthumbnails%2Ftwl_SLR_RP.png?alt=media
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: CoCliCo - Total Water Level Return Periods
  download_url: null
  format: null
...
- hazard
schema: rdls-10
slug: rdls_hzd-coclico_twlslrrp
spatial:
  bbox:
  - -180.0
  - -90.0
...
temporal: null
temporal_resolution: null
title: CoCliCo - Total Water Level Return Periods
version: null
vulnerability: null
---
