...
- entity:
    ...
    url: https://data.humdata.org/dataset/luxembourg-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/luxembourg-planet-road-surface-data
dataset_id: rdls_exp-lux_heigit_luxembourgplanetroadsurfa_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0031 million km (94.173%) - Unpaved roads: 0.0 million km (0.0%) - Missing OSM\
  \ surface tags: 0.0 million km (0.274%) - PlanetScope predictions cover: 0.0031\
  \ million km (34369.2904%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/luxembourg-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries from OpenStreetMap were extracted for arterial
    ...
    (HPI) with alphanumeric and numerical risk scores. The resulting dataset integrates
    AI-derived road characteristics with OSM baseline attributes to support humanitarian
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/luxembourg-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Luxembourg: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Luxembourg)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_LU_planet_roadsurface_lines.geojson
  format: null
  id: resource_d88a1e25
  ...
  title: Luxembourg GeoJSON heigit_LU_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Luxembourg: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Luxembourg)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_LU_planet_roadsurface_lines.gpkg
  format: null
  id: resource_5310cc4c
  ...
  temporal: null
  temporal_resolution: null
  title: Luxembourg GPKG heigit_LU_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lux_heigit_luxembourgplanetroadsurfa_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Luxembourg: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
