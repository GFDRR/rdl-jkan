...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-uganda
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-uganda
dataset_id: rdls_exp-uga_kontur_populationdensity400mh3he_2023
description: 'Uganda population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-uganda]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    to create a unified settlement layer. Population counts were then allocated to
    400m H3 hexagonal grid cells using the H3 hierarchical spatial indexing system.
    The resulting dataset provides baseline gridded population estimates at high spatial
    resolution for Uganda.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-uganda
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Uganda: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_UG_20220630.gpkg.gz
  format: null
  id: resource_7ecd4185
  ...
  title: kontur_population_UG_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Uganda: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_UG_20231101.gpkg.gz
  format: null
  id: resource_df5bab3f
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_UG_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-uga_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Uganda: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
