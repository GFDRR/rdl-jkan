...
- entity:
    ...
    url: https://data.humdata.org/dataset/british-virgin-islands-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/british-virgin-islands-road-surface-data
dataset_id: rdls_exp-vgb_heigit_britishvirginislandsroads_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/british-virgin-islands-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    classification using a hybrid deep learning approach. The model predicts paved
    versus unpaved road surfaces, with predictions validated against OSM surface tags.
    Output includes both OSM-priority and deep learning-priority surface classifications
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/british-virgin-islands-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'British Virgin Islands: Road Surface Data (GeoJSON data for British
    virgin islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_vgb_roadsurface_lines.geojson
  format: null
  id: resource_8fd7eb80
  ...
  title: British virgin islands GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'British Virgin Islands: Road Surface Data (Geopackage data for British
    virgin islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_vgb_roadsurface_lines.gpkg
  format: null
  id: resource_de566d73
  ...
  temporal: null
  temporal_resolution: null
  title: British virgin islands GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vgb_heigit_britishvirginislandsroads_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'British Virgin Islands: Road Surface Data'
version: null
vulnerability: null
---
