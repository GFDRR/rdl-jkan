...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-equatorial-guinea
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-equatorial-guinea
dataset_id: rdls_exp-gnq_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-equatorial-guinea]'
...
exposure:
- asset_type:
    description: Economic value of building stock by type and location
    id: buildings
    scheme: null
    title: null
    uri: null
...
lineage:
  description: The GAR15 global exposure database was developed using a top-down approach
    ...
    were spatially disaggregated onto 5x5 km and 1x1 km grids using gridded population
    data and GDP as geographic distribution proxies. The dataset integrates inputs
    from multiple international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai Kogyo)
    to create a comprehensive spatial inventory of economic and population exposure
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-equatorial-guinea
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Equatorial Guinea.zip
  download_url: https://data.humdata.org/dataset/7c04dd9b-6d50-4e45-adad-5fd984d1a42e/resource/3de51741-b1d7-4792-a0e7-5903278c6bd9/download/gnq.zip
  format: null
  id: resource_3de51741
  ...
  title: GAR15 Global Exposure Dataset for Equatorial Guinea.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gnq_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Equatorial Guinea
version: null
vulnerability: null
---
