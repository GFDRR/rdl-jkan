...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/bmu-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/bmu-rainfall-subnational
dataset_id: rdls_hzd-bmu_wfp_bermudarainfallindicators_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/bmu-rainfall-subnational]'
...
lineage:
  description: Rainfall data are derived from Climate Hazards Group InfraRed Precipitation
    satellite imagery (CHIRPS v2) integrated with in-situ rain gauge observations,
    then aggregated by subnational administrative units to compute dekadal rainfall
    indicators including 10-day totals, 1-month and 3-month rolling aggregations,
    and long-term averages for meteorological drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bmu-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135602792799_6b36ea92'
  download_url: https://data.humdata.org/dataset/45335df0-39fd-432f-a410-f11fa5754122/resource/fab9d448-1b01-46c3-942c-5fa6e3b7505d/download/bmu-rainfall-subnat-full.csv
  format: null
  id: resource_fab9d448
  media_type: text/csv
  spatial: null
  ...
  title: bmu-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135602792799_6b36ea92'
  download_url: https://data.humdata.org/dataset/45335df0-39fd-432f-a410-f11fa5754122/resource/89f087e8-65ef-43ba-9581-bb811dd2de54/download/bmu-rainfall-subnat-5ytd.csv
  format: null
  id: resource_89f087e8
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: bmu-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bmu_wfp_bermudarainfallindicators_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Bermuda: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
