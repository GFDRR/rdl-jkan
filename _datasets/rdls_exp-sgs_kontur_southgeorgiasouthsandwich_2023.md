...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-south-georgia-and-the-south-sandwich-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-south-georgia-and-the-south-sandwich-islands
dataset_id: rdls_exp-sgs_kontur_southgeorgiasouthsandwich_2023
description: 'South Georgia and the South Sandwich Islands population density for
  400m H3 hexagons. Built from Kontur Population: Global Population Density for 400m
  H3 Hexagons Vector H3 hexagons with population counts at 400m resolution. Fixed
  up fusion of GHSL, Facebook, Microsoft Buildings, Copernicus Global Land Service
  Land Cover, Land Information New Zealand, and OpenStreetMap data.. [Source: This
  metadata record was automatically extracted from the Humanitarian Data Exchange
  (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-south-georgia-and-the-south-sandwich-islands]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    H3 hierarchical spatial index provides consistent geographic binning for population
    counts across South Georgia and the South Sandwich Islands.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-south-georgia-and-the-south-sandwich-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_GS_20220630.gpkg.gz
  format: null
  id: resource_d9a0071b
  ...
  title: kontur_population_GS_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_GS_20231101.gpkg.gz
  format: null
  id: resource_d21addb3
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_GS_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sgs_kontur_southgeorgiasouthsandwich_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'South Georgia and the South Sandwich Islands: Population Density for 400m
  H3 Hexagons'
version: null
vulnerability: null
---
