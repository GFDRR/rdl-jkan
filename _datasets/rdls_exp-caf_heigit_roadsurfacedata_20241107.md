...
- entity:
    ...
    url: https://data.humdata.org/dataset/central-african-republic-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/central-african-republic-road-surface-data
dataset_id: rdls_exp-caf_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/central-african-republic-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for Central African Republic. A hybrid deep learning model was applied to classify
    road surfaces as paved or unpaved, generating predictions for approximately 0.1236
    million km of mapped roads. The dataset integrates OSM-tagged surface data with
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/central-african-republic-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Central African Republic: Road Surface Data (GeoJSON data for Central
    african republic.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_caf_roadsurface_lines.geojson
  format: null
  id: resource_89e321d6
  ...
  title: Central african republic GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Central African Republic: Road Surface Data (Geopackage data for Central
    african republic.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_caf_roadsurface_lines.gpkg
  format: null
  id: resource_daf43eb0
  ...
  temporal: null
  temporal_resolution: null
  title: Central african republic GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-caf_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Central African Republic: Road Surface Data'
version: null
vulnerability: null
---
