...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-albania
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-albania
dataset_id: rdls_exp-alb_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-albania]'
...
lineage:
  description: The GAR15 exposure dataset for Albania was developed using a top-down
    ...
    spatial inventory of economic and population exposure.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-albania
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Albania.zip
  download_url: https://data.humdata.org/dataset/5d781d89-1bca-4761-abd5-b891343046b9/resource/aa0a6595-0071-4862-98ff-ef2a301d3a33/download/alb.zip
  format: null
  id: resource_aa0a6595
  ...
  title: GAR15 Global Exposure Dataset for Albania.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-alb_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Albania
version: null
vulnerability: null
---
