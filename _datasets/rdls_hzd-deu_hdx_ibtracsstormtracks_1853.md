...
- entity:
    ...
    url: https://data.humdata.org/dataset/deu-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/deu-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-deu_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/deu-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    Track data includes ISO-timestamped positions, basin/subbasin classification,
    wind speed (wmo_wind), and pressure (wmo_pres) measurements. Data is provided
    as both tabular CSV and geospatial GeoJSON formats for Germany.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/deu-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Germany.
  download_url: https://data.humdata.org/dataset/31c5d3aa-e3bb-42ff-8ba7-9bdb4c363d71/resource/5c100651-5ce6-4a80-ad09-52868f0aff71/download/ibtracs_all_list_v04r01_deu.csv
  format: null
  id: resource_5c100651
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_DEU.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Germany.
  download_url: https://data.humdata.org/dataset/31c5d3aa-e3bb-42ff-8ba7-9bdb4c363d71/resource/d12a2199-0217-49f9-a35a-9c4ce5490bdc/download/ibtracs_all_list_v04r01_lines_deu.geojson
  format: null
  id: resource_d12a2199
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_DEU.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-deu_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Germany: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
