...
- entity:
    ...
    url: https://data.humdata.org/dataset/som-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/som-ndvi-subnational
dataset_id: rdls_hzd-som_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/som-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI values by subnational administrative units. Long-term averages and percentage
    anomalies were computed for each dekad to enable drought monitoring and early
    warning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/som-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135850643618_3b640674'
  download_url: https://data.humdata.org/dataset/f1e50c5b-304e-4e42-862b-cdc3d9016014/resource/3ecf339e-c53c-4726-8172-9a777baa5857/download/som-ndvi-subnat-full.csv
  format: null
  id: resource_3ecf339e
  media_type: text/csv
  spatial: null
  ...
  title: som-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135850643618_3b640674'
  download_url: https://data.humdata.org/dataset/f1e50c5b-304e-4e42-862b-cdc3d9016014/resource/a1198654-9b82-4035-a00b-13384f45a28e/download/som-ndvi-subnat-5ytd.csv
  format: null
  id: resource_a1198654
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: som-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-som_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Somalia: NDVI at Subnational Level'
version: null
vulnerability: null
---
