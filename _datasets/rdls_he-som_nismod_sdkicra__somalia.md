...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-som_nismod_sdkicra__somalia
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Somalia. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540098
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540098
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Somalia, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540098/files/SOM.zip
  format: null
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Somalia
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-som_nismod_sdkicra__somalia
spatial:
  bbox:
  - 40.97
  - -1.7
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Somalia
version: 0.1.0
vulnerability: null
---
