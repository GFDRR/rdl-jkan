...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-new-zealand
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-new-zealand
dataset_id: rdls_exp-nzl_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-new-zealand]'
...
lineage:
  description: The GAR15 global exposure database for New Zealand was developed using
    ...
    economic value of exposed assets across the country.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-new-zealand
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for New Zealand.zip
  download_url: https://data.humdata.org/dataset/965c7fd3-fdea-4531-be12-0478b4bca3be/resource/289a39a0-b287-4a8a-b747-e08ec4f47b18/download/nzl.zip
  format: null
  id: resource_289a39a0
  ...
  title: GAR15 Global Exposure Dataset for New Zealand.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nzl_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for New Zealand
version: null
vulnerability: null
---
