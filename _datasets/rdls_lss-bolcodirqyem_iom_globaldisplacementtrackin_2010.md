...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/global-iom-dtm-from-api
dataset_id: rdls_lss-bolcodirqyem_iom_globaldisplacementtrackin_2010
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/global-iom-dtm-from-api]'
...
license: CC-BY-4.0
lineage:
  description: IOM DTM collects IDP figures through field assessments (baseline, emergency
    tracking, and site-based) across multiple operations and countries. Data is aggregated
    at admin 0, 1, and 2 levels with displacement reason and demographic breakdowns
    (males/females), then published via public API for humanitarian and research use.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/global-iom-dtm-from-api
  rel: source
loss:
  losses:
  - asset_category: population
    asset_dimension: population
    description: Internally displaced persons (IDPs) from conflict and violence, tracked
      by displacement reason and origin location
...
- access_url: null
  ...
  description: Global IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/32d0365c-d513-4721-8d66-1b19b12c4b08/resource/80911e9b-7527-469a-a545-4074860e1288/download/global-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_80911e9b
  media_type: text/csv
  spatial: null
  ...
  title: Global IOM DTM data for admin levels 0-2
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Global IOM Displacement Tracking Matrix (DTM) from API (Filtered and
    aggregated data used to create QuickCharts)
  download_url: https://data.humdata.org/dataset/32d0365c-d513-4721-8d66-1b19b12c4b08/resource/8e836a9d-2d00-44db-b28b-8c4e4df45dcc/download/data_for_quickcharts.csv
  format: null
  id: resource_8e836a9d
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: Data for QuickCharts
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-bolcodirqyem_iom_globaldisplacementtrackin_2010
spatial:
  bbox: null
  centroid: null
  countries:
