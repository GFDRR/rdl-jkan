...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-vincent-and-the-grenadines
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-vincent-and-the-grenadines
dataset_id: rdls_exp-vct_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-vincent-and-the-grenadines]'
...
lineage:
  description: The GAR15 global exposure database was developed using a top-down approach
    where national-level socio-economic, building type, and capital stock statistics
    were spatially distributed onto 5x5 km and 1x1 km grids using geographic population
    density and GDP as spatial proxies. The dataset integrates inputs from multiple
    international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai Kogyo) to estimate economic
    value of exposed assets for Saint Vincent and the Grenadines.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-vincent-and-the-grenadines
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Saint Vincent and the Grenadines.zip
  download_url: https://data.humdata.org/dataset/75e3f55f-cb87-4936-b25e-64c8fa67e5e9/resource/42fddfee-0bde-4d47-b4f8-85013e79acc4/download/vct.zip
  format: null
  id: resource_42fddfee
  ...
  title: GAR15 Global Exposure Dataset for Saint Vincent and the Grenadines.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vct_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Saint Vincent and the Grenadines
version: null
vulnerability: null
---
