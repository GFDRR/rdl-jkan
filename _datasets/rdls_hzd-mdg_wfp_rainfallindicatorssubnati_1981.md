...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/mdg-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mdg-rainfall-subnational
dataset_id: rdls_hzd-mdg_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/mdg-rainfall-subnational]'
...
lineage:
  description: Rainfall data are derived from CHIRPS satellite observations merged
    ...
    1-month and 3-month accumulations, then aggregated by subnational administrative
    units with anomalies computed relative to long-term climatological averages to
    produce meteorological drought indicators.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mdg-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135613095552_cc0864cc'
  download_url: https://data.humdata.org/dataset/26f9206c-5768-47ef-9cfa-bb9991b47d97/resource/62cce374-8d80-4a34-9480-be0b53469471/download/mdg-rainfall-subnat-full.csv
  format: null
  id: resource_62cce374
  media_type: text/csv
  spatial: null
  ...
  title: mdg-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135613095552_cc0864cc'
  download_url: https://data.humdata.org/dataset/26f9206c-5768-47ef-9cfa-bb9991b47d97/resource/933030ad-8a95-4e2e-91fb-f36ec3967645/download/mdg-rainfall-subnat-5ytd.csv
  format: null
  id: resource_933030ad
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mdg-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mdg_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Madagascar: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
