...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-atg_nismod_sdkicra__barbuda
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Barbuda. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539786
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539786
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Barbuda, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16539786/files/ACB.zip
  format: null
  id: resource_sdkicra_atg
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Barbuda
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-atg_nismod_sdkicra__barbuda
spatial:
  bbox:
  - -62.35
  - 16.93
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3576396/antigua-and-barbuda.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Barbuda
version: 0.2.1
vulnerability: null
---
