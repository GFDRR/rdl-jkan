...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-uzbekistan
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-uzbekistan
dataset_id: rdls_exp-uzb_kontur_administrativedivisionagg_20220407
description: 'Uzbekistan administrative division with aggregated population. Built
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-uzbekistan]'
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries for Uzbekistan were extracted from OpenStreetMap
    and enhanced using proprietary methods. Population counts were aggregated from
    the Kontur Population global density dataset (400m H3 hexagons) to administrative
    division polygons. HASC codes were enriched from Wikidata to provide standardized
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-uzbekistan
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Uzbekistan: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_UZ_20220407.gpkg.gz
  format: null
  id: resource_f43dfc99
  ...
  title: kontur_boundaries_UZ_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Uzbekistan: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_UZ_20230628.gpkg.gz
  format: null
  id: resource_f4d80b81
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_UZ_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Uzbekistan: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_UZ_20230628.gpkg.gz
  format: null
  id: resource_ab5a4be9
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_UZ_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-uzb_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Uzbekistan: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
