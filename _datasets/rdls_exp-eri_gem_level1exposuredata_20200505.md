...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/eritrea-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/eritrea-level-1-exposure-data
dataset_id: rdls_exp-eri_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/eritrea-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/eritrea-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Eritrea produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/6687fef3-b189-4354-a02a-f5f64c0bc4d9/resource/2bee8145-0b6e-4cfc-9cec-9671a50e01cb/download/eri_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_2bee8145
  ...
  title: ERI_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-eri_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Eritrea: Level 1 Exposure Data'
version: null
vulnerability: null
---
