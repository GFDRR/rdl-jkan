...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/tur-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/tur-rainfall-subnational
dataset_id: rdls_hzd-tur_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/tur-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    ...
    sums and anomalies) at subnational administrative boundaries to support drought
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tur-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135720408192_6c9b688b'
  download_url: https://data.humdata.org/dataset/8d25d57f-e960-4eee-b949-c68ac67a7aa7/resource/7c399ee0-3efd-4dd2-aed9-4906a0844c2e/download/tur-rainfall-subnat-full.csv
  format: null
  id: resource_7c399ee0
  media_type: text/csv
  spatial: null
  ...
  title: tur-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135720408192_6c9b688b'
  download_url: https://data.humdata.org/dataset/8d25d57f-e960-4eee-b949-c68ac67a7aa7/resource/38554339-e01d-4820-a1c9-fe7ffebf82b0/download/tur-rainfall-subnat-5ytd.csv
  format: null
  id: resource_38554339
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: tur-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tur_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: "T\xC3\xBCrkiye: Rainfall Indicators at Subnational Level"
version: null
vulnerability: null
---
