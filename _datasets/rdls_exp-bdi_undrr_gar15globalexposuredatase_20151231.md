...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-burundi
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-burundi
dataset_id: rdls_exp-bdi_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-burundi]'
...
- asset_type:
    description: Population distribution used as geographic proxy for transposing
      national socio-economic data onto gridded exposure
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    distribution and GDP as geographic proxies. The dataset was developed collaboratively
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-burundi
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Burundi.zip
  download_url: https://data.humdata.org/dataset/fc516454-fc2c-4482-b6d4-d4b9c611440b/resource/874a9d0e-3e0a-478c-a61f-4d25123ee7d3/download/bdi.zip
  format: null
  id: resource_874a9d0e
  ...
  title: GAR15 Global Exposure Dataset for Burundi.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bdi_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Burundi
version: null
vulnerability: null
---
