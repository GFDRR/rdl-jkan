...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-czech-republic
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-czech-republic
dataset_id: rdls_exp-cze_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-czech-republic]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Czech Republic were transposed onto 5x5 km and 1x1 km spatial grids using
    geographic population distribution and GDP as spatial proxies. The dataset was
    developed by UNEP-GRID for the Global Assessment Report on Disaster Risk Reduction
    (GAR15) in collaboration with international agencies to create a globally consistent
    exposure database for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-czech-republic
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Czechia - GAR15 Global Exposure Dataset for Czech Republic (GAR15 Global
    Exposure Dataset for Czech Republic.zip)
  download_url: https://data.humdata.org/dataset/94dfaf72-bc0e-4779-81e7-3bd2d5a1ef8f/resource/cbd6099f-7e4d-4ecd-97f7-e89caf7d9387/download/cze.zip
  format: null
  id: resource_cbd6099f
  ...
  title: GAR15 Global Exposure Dataset for Czech Republic.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cze_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: Czechia - GAR15 Global Exposure Dataset for Czech Republic
version: null
vulnerability: null
---
