...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/bgd-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/bgd-rainfall-subnational
dataset_id: rdls_hzd-bgd_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/bgd-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery integrated
    with in-situ station observations, then aggregated by dekad (10-day period) and
    subnational administrative units. Multiple rolling aggregations (1-month and 3-month)
    and long-term climatological averages were computed to generate drought monitoring
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bgd-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135613633754_eae759e4'
  download_url: https://data.humdata.org/dataset/4b4650bf-6faa-4659-adf5-521a8be17bf6/resource/ae3bcbdc-bd38-4f0b-bb9f-55ffefb11c38/download/bgd-rainfall-subnat-full.csv
  format: null
  id: resource_ae3bcbdc
  media_type: text/csv
  spatial: null
  ...
  title: bgd-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135613633754_eae759e4'
  download_url: https://data.humdata.org/dataset/4b4650bf-6faa-4659-adf5-521a8be17bf6/resource/ab818c50-2d55-4d9c-9953-a3f333d6b533/download/bgd-rainfall-subnat-5ytd.csv
  format: null
  id: resource_ab818c50
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: bgd-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bgd_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Bangladesh: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
