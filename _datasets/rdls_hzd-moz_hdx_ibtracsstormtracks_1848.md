...
- entity:
    ...
    url: https://data.humdata.org/dataset/moz-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/moz-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-moz_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/moz-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS aggregates tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The Mozambique subset contains observed
    storm track points with ISO timestamps, basin/sub-basin classifications, wind
    speed (WMO), and central pressure measurements, representing the most complete
    global collection of historical and recent tropical cyclone data.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/moz-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Mozambique.
  download_url: https://data.humdata.org/dataset/8617b2a1-ea6f-42e6-81d0-b7db9e25bacb/resource/b11c90af-a1f6-4f68-b6ac-f89c545034f0/download/ibtracs_all_list_v04r01_moz.csv
  format: null
  id: resource_b11c90af
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MOZ.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Mozambique.
  download_url: https://data.humdata.org/dataset/8617b2a1-ea6f-42e6-81d0-b7db9e25bacb/resource/a2ab9a0b-b306-44e9-9c8a-d7b9d407df30/download/ibtracs_all_list_v04r01_lines_moz.geojson
  format: null
  id: resource_a2ab9a0b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MOZ.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-moz_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'Mozambique: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
