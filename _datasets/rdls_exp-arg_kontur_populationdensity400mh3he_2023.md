...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-argentina
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-argentina
dataset_id: rdls_exp-arg_kontur_populationdensity400mh3he_2023
description: 'Argentina population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-argentina]'
...
lineage:
  description: Population density was calculated by overlaying and fusing multiple
    global datasets (GHSL, Facebook HRSL, Microsoft Buildings, Copernicus Land Cover,
    and OpenStreetMap) to create a unified population count estimate. Data was aggregated
    into H3 hexagonal grid cells at 400m resolution using hierarchical spatial indexing.
    The resulting dataset provides baseline population exposure at sub-kilometer scale
    for Argentina.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-argentina
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Argentina: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AR_20220630.gpkg.gz
  format: null
  id: resource_f271c6b2
  ...
  title: kontur_population_AR_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Argentina: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AR_20231101.gpkg.gz
  format: null
  id: resource_0a858fd8
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_AR_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-arg_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Argentina: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
