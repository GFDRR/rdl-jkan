...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-kna_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Saint Kitts and Nevis. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540229
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540229
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Saint Kitts and Nevis, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16540229/files/KNA.zip
  format: null
  id: resource_sdkicra_kna
...
- exposure
schema: rdls-10
slug: rdls_he-kna_nismod_sdkicra
spatial:
  bbox:
  - -62.86
  - 17.1
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3575174/saint-kitts-and-nevis.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Saint Kitts
  and Nevis
version: 0.1.0
vulnerability: null
---
