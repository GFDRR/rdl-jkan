...
- entity:
    ...
    url: https://data.humdata.org/dataset/mkd-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mkd-ghsl
dataset_id: rdls_exp-mkd_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mkd-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    the spatial distribution of human settlements and population density across North
    Macedonia.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mkd-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/710d2ece-3419-4388-80f2-c1945eed8ac6/resource/176650ff-42c5-45c5-a05a-0c87d8e313e4/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mkd.tif
  format: null
  id: resource_176650ff
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'North Macedonia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/710d2ece-3419-4388-80f2-c1945eed8ac6/resource/38389ebf-4aa3-4432-b50d-331d5fafeca6/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mkd.tif
  format: null
  id: resource_38389ebf
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mkd_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'North Macedonia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
