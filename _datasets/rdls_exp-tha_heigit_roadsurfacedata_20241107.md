...
- entity:
    ...
    url: https://data.humdata.org/dataset/thailand-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/thailand-road-surface-data
dataset_id: rdls_exp-tha_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 1.086 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.1802 and 0.2861
  (in million kms), corressponding to 16.5914% and 26.3481% respectively of the total
  road length in the dataset region. 0.6197 million km or 57.0604% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0105 million km of information (corressponding
  to 1.6994% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/thailand-road-surface-data]'
details: null
exposure:
- asset_type:
    description: Road network in Thailand classified by surface type (paved vs. unpaved)
...
lineage:
  description: OSM road network data for Thailand was processed using a hybrid deep
    learning approach developed by HeiGIT to classify road surfaces as paved or unpaved
    where explicit surface tags are absent. The model generates AI-based surface predictions
    across the full road network, resulting in a geospatial dataset (GeoJSON/GeoPackage)
    quantifying the share and extent of paved and unpaved roads. This dataset supports
    humanitarian access, logistics planning, and infrastructure exposure assessments
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/thailand-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Thailand: Road Surface Data (GeoJSON data for Thailand.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tha_roadsurface_lines.geojson
  format: null
  id: resource_a01da094
  ...
  title: Thailand GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Thailand: Road Surface Data (Geopackage data for Thailand.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tha_roadsurface_lines.gpkg
  format: null
  id: resource_484add45
  ...
  temporal: null
  temporal_resolution: null
  title: Thailand GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tha_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Thailand: Road Surface Data'
version: null
vulnerability: null
---
