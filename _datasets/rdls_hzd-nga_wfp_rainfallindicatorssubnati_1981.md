...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/nga-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/nga-rainfall-subnational
dataset_id: rdls_hzd-nga_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall estimates were derived from Climate Hazards Group InfraRed
    Precipitation (CHIRPS) satellite imagery integrated with in-situ station data,
    then aggregated by subnational administrative units in Nigeria. Dekadal indicators
    including 10-day rainfall, 1-month and 3-month rolling aggregations, and long-term
    averages were computed to support drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nga-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135658199581_7c88aa89'
  download_url: https://data.humdata.org/dataset/ff5dba07-397b-44fb-b04f-bbca782ce793/resource/114874de-df99-4102-b4c8-b44e2db44a5e/download/nga-rainfall-subnat-full.csv
  format: null
  id: resource_114874de
  media_type: text/csv
  spatial: null
  ...
  title: nga-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135658199581_7c88aa89'
  download_url: https://data.humdata.org/dataset/ff5dba07-397b-44fb-b04f-bbca782ce793/resource/2670aa7f-21c1-4ebc-88d6-8d99683e5a60/download/nga-rainfall-subnat-5ytd.csv
  format: null
  id: resource_2670aa7f
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: nga-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nga_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
