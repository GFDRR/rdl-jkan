...
- entity:
    ...
    url: https://data.humdata.org/dataset/uruguay-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/uruguay-road-surface-data
dataset_id: rdls_exp-ury_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.1122 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0208 and 0.0317
  (in million kms), corressponding to 18.5333% and 28.2815% respectively of the total
  road length in the dataset region. 0.0597 million km or 53.1852% of road surface
  ...
  to 0.629% of total missing information on road surface) It is intended for use in
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/uruguay-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    across Uruguay. The model outputs include predicted surface classifications, prediction
    counts, and combined surface classifications prioritizing either OSM or deep learning
    predictions, enabling humanitarian access and logistics planning applications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/uruguay-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Uruguay: Road Surface Data (GeoJSON data for Uruguay.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ury_roadsurface_lines.geojson
  format: null
  id: resource_f93c1a1a
  ...
  title: Uruguay GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Uruguay: Road Surface Data (Geopackage data for Uruguay.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ury_roadsurface_lines.gpkg
  format: null
  id: resource_01da3e9d
  ...
  temporal: null
  temporal_resolution: null
  title: Uruguay GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ury_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Uruguay: Road Surface Data'
version: null
vulnerability: null
---
