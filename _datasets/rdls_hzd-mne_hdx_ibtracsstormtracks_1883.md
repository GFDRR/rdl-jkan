...
- entity:
    ...
    url: https://data.humdata.org/dataset/mne-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mne-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mne_hdx_ibtracsstormtracks_1883
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mne-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Montenegro
    subset contains observed storm track positions, timestamps, basin/subbasin classifications,
    wind speeds (wmo_wind), and central pressure (wmo_pres) for all tropical cyclones
    affecting or passing through the country's region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mne-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Montenegro.
  download_url: https://data.humdata.org/dataset/90ca66cc-ab94-43f6-b173-ae9a0f8d9301/resource/a0841a18-7e2d-417a-b58a-4e6ca451ce17/download/ibtracs_all_list_v04r01_mne.csv
  format: null
  id: resource_a0841a18
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MNE.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Montenegro.
  download_url: https://data.humdata.org/dataset/90ca66cc-ab94-43f6-b173-ae9a0f8d9301/resource/358deffd-8d65-4251-864d-134911add6f9/download/ibtracs_all_list_v04r01_lines_mne.geojson
  format: null
  id: resource_358deffd
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MNE.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mne_hdx_ibtracsstormtracks_1883
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1883-08-20'
temporal_resolution: null
title: 'Montenegro: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
