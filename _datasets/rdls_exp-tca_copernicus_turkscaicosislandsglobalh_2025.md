...
- entity:
    ...
    url: https://data.humdata.org/dataset/tca-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/tca-ghsl
dataset_id: rdls_exp-tca_copernicus_turkscaicosislandsglobalh_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/tca-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    analytics to produce gridded estimates of built-up surfaces and population distribution.
    Two GeoTIFF resources provide built-up surface area and population density grids
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tca-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/31138bd8-35ae-401c-9253-bb23ca916236/resource/3d72dcee-b2c1-4a69-b86e-0d06f2d15f22/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_tca.tif
  format: null
  id: resource_3d72dcee
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Turks and Caicos Islands: Copernicus Global Human Settlement Layer
    (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/31138bd8-35ae-401c-9253-bb23ca916236/resource/34c9d2d3-9504-49dc-957f-91799d7dec7e/download/ghs_pop_e2025_r2023a_54009_100_v1_0_tca.tif
  format: null
  id: resource_34c9d2d3
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-tca_copernicus_turkscaicosislandsglobalh_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Turks and Caicos Islands: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
