...
- entity:
    ...
    url: https://data.humdata.org/dataset/gtm-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/gtm-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-gtm_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/gtm-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Guatemala subset contains observed storm positions, wind speeds (wmo_wind in m/s),
    and central pressure measurements extracted from the global IBTrACS archive and
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gtm-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Guatemala.
  download_url: https://data.humdata.org/dataset/21f393b9-c8a2-4433-b43f-8e9b0e602b5a/resource/7d9dcb8f-1042-49bb-9581-b9c3a70291ee/download/ibtracs_all_list_v04r01_gtm.csv
  format: null
  id: resource_7d9dcb8f
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GTM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Guatemala.
  download_url: https://data.humdata.org/dataset/21f393b9-c8a2-4433-b43f-8e9b0e602b5a/resource/ec003433-dda8-4cc6-a6a3-ee27375a1963/download/ibtracs_all_list_v04r01_lines_gtm.geojson
  format: null
  id: resource_ec003433
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GTM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gtm_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Guatemala: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
