...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-hong-kong
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-hong-kong
dataset_id: rdls_exp-hkg_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-hong-kong]'
...
lineage:
  description: The GAR15 global exposure database for Hong Kong was developed using
    a top-down approach where national-level socio-economic data, building type classifications,
    and capital stock information were transposed onto 5x5 km and 1x1 km grid cells
    using geographic population distribution and GDP as spatial proxies. The dataset
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-hong-kong
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Hong Kong.zip
  download_url: https://data.humdata.org/dataset/c3cc93de-d0d2-4bac-8126-6c856364f7a5/resource/e5381973-ff06-4bc9-b269-185e5d3d6bde/download/hkg.zip
  format: null
  id: resource_e5381973
  ...
  title: GAR15 Global Exposure Dataset for Hong Kong.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-hkg_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Hong Kong
version: null
vulnerability: null
---
