...
dataset_id: rdls_lss-sen_undrr_desinventar_b
...
loss:
  ...
  - asset_category: population
    ...
    description: 'Observed persons indirectly affected (disruption to services, commerce,
      ...
      data out of 149 total flood events (2008-2010).'
  ...
  - asset_category: buildings
    ...
    description: 'Observed homes with non-structural damage, still habitable from
      ...
      of 149 total flood events (2008-2010).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_flood
  ...
  - asset_category: population
    ...
    description: 'Observed deaths directly caused by disaster events from strong wind
      ...
      total strong wind events (2013-2014).'
    disaster_identifiers: []
    hazard:
      classification: null
  ...
  - asset_category: population
    ...
    description: 'Observed persons temporarily evacuated from homes or workplaces
      ...
      data out of 13 total strong wind events (2013-2014).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_strong_wind
  ...
  - asset_category: population
    ...
    description: 'Observed persons indirectly affected (disruption to services, commerce,
      ...
      with data out of 580 total wildfire events (2010-2014).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_wildfire
  ...
  - asset_category: population
    ...
    description: 'Observed persons injured or made sick directly by disaster events
      ...
      data out of 580 total wildfire events (2010-2014).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_wildfire
  ...
  - asset_category: agriculture
    ...
    description: 'Observed livestock lost from wildfire (FIRE) events in Senegal.
      DesInventar records: 5 events with data out of 580 total wildfire events (2010-2014).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_wildfire
...
- access_url: https://data.humdata.org/dataset/34f077f2-7270-45db-8f95-da5e4bfd5c9a
  ...
  description: DesInventar Disaster Loss and Damage Dataset for Senegal (Disaster
    data for Senegal)
...
- loss
schema: rdls-10
slug: rdls_lss-sen_undrr_desinventar_b
spatial:
  bbox:
  - -17.54
  - 12.31
