...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-iot_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Chagos Archipelago. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796601
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796601
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Chagos Archipelago, clipped from global sources. Contents: (1) Hazard - Coastal
    flood inundation maps (90 GeoTIFF, Aqueduct Floods, ~1km resolution, return periods
  ...
  download_url: https://zenodo.org/records/10796601/files/IOT.zip
  format: null
  id: resource_sdkicra_iot
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Chagos
    Archipelago
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-iot_nismod_sdkicra
spatial:
  bbox:
  - 71.26
  - -7.43
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/1282588/british-indian-ocean-territory.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Chagos Archipelago
version: 0.1.0
vulnerability: null
---
