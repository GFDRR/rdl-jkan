...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/mli-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/mli-iom-dtm-from-api
dataset_id: rdls_lss-mli_iom_displacementtrackingmatri_2014
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mli-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments across Mali to enumerate internally displaced persons by
    location, demographics, and displacement reason. Data is aggregated at admin 0,
    1, and 2 levels and published via the DTM API as non-sensitive IDP counts with
    reporting dates and assessment metadata.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mli-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Mali IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/206928d8-704f-4d89-a4f5-acd48a7e85ad/resource/16e24c6c-23ba-489a-a7db-6ee00ea47fcb/download/mli-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_16e24c6c
  media_type: text/csv
  spatial: null
  ...
  title: Mali IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-mli_iom_displacementtrackingmatri_2014
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2014-01-13'
temporal_resolution: null
title: Mali IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
