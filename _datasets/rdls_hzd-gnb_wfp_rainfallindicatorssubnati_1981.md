...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/gnb-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/gnb-rainfall-subnational
dataset_id: rdls_hzd-gnb_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/gnb-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with rain gauge station data, then aggregated into dekadal, 1-month rolling, and
    3-month rolling indicators at subnational administrative units. Long-term rainfall
    averages were computed as reference climatology to enable anomaly detection for
    drought monitoring.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gnb-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135559906418_202a23a1'
  download_url: https://data.humdata.org/dataset/248d852e-6ea0-4902-803c-9cc8641f6340/resource/ac661d86-c6a3-4f1a-a841-9fd4d1db04d7/download/gnb-rainfall-subnat-full.csv
  format: null
  id: resource_ac661d86
  media_type: text/csv
  spatial: null
  ...
  title: gnb-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135559906418_202a23a1'
  download_url: https://data.humdata.org/dataset/248d852e-6ea0-4902-803c-9cc8641f6340/resource/f6af8032-d4dc-47cb-ada5-8ef156449753/download/gnb-rainfall-subnat-5ytd.csv
  format: null
  id: resource_f6af8032
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: gnb-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gnb_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Guinea-Bissau: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
