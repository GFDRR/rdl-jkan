...
creator:
  ...
  name: Chiara Scaini
  url: null
dataset_id: rdls_exp-gfdrr_sfrarrinfrastructure
description: Regional layer of power and communications supply infrastructure for
  Central Asia (Kazakhstan, Kyrgyz Republic, Tajikistan, Turkmenistan, Uzbekistan),
  developed under the SFRARR program from official and global infrastructure data
  harmonized for multi-country risk assessment.
...
- asset_type: null
  ...
  id: rdls_exp-gfdrr_sfrarrinfrastructure_exp
  metrics:
  - dimension: structure
    id: rdls_exp-gfdrr_sfrarrinfrastructure_m1
    measurement:
...
resources:
- access_url: https://datacatalog.worldbank.org/search/dataset/0064253
  ...
  description: 'Regional layer of power and communications infrastructure in Central
    ...
    global/regional layers and based on local data. The layers contain point infrastructure
    (extraction sites and mines, power plants, dams and reservoirs) and lines infrastructure
    (oil, gas and water pipelines, electricity and communication network). Application
    of this information should on smaller scales should be done with care and taking
    into account the limitations of the approach. Files: Infrastructure_lines.shp;
    Infrastructure_lines.csv: Infrastructure_points.shp; Infrastructure_points.csv'
  download_url: null
  format: csv
  id: rdls_exp-gfdrr_sfrarrinfrastructure_r1
  media_type: text/csv
  spatial: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gfdrr_sfrarrinfrastructure
spatial:
  bbox:
  - 46.0
  - 34.0
...
temporal: null
temporal_resolution: null
title: Central Asia Exposure - Supply Infrastructure (SFRARR)
version: '2022'
vulnerability: null
---
