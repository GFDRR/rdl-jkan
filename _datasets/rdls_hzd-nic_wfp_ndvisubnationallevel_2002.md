...
- entity:
    ...
    url: https://data.humdata.org/dataset/nic-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/nic-ndvi-subnational
dataset_id: rdls_hzd-nic_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nic-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI values by WFP subnational administrative units. NDVI anomalies were computed
    as percentage deviations from long-term averages to characterize vegetation stress
    indicative of agricultural drought conditions.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nic-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135628202373_6f2ca36b'
  download_url: https://data.humdata.org/dataset/16eee418-3a7e-456c-af57-61ef6cc59ef3/resource/3bbf1e3f-bccd-4290-9cdf-621581e544fc/download/nic-ndvi-subnat-full.csv
  format: null
  id: resource_3bbf1e3f
  media_type: text/csv
  spatial: null
  ...
  title: nic-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135628202373_6f2ca36b'
  download_url: https://data.humdata.org/dataset/16eee418-3a7e-456c-af57-61ef6cc59ef3/resource/313af294-40c4-442e-a93d-7dfe41216a5a/download/nic-ndvi-subnat-5ytd.csv
  format: null
  id: resource_313af294
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: nic-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nic_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Nicaragua: NDVI at Subnational Level'
version: null
vulnerability: null
---
