...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/zmb-rainfall-subnational
dataset_id: rdls_hzd-zmb_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/zmb-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite observations merged with
    rain gauge station data, aggregated by dekad and subnational administrative units.
    Rolling 1-month and 3-month aggregations computed alongside long-term climatological
    averages to enable drought indicator calculation and anomaly detection for early
    warning purposes.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zmb-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135735450892_fae9c923'
  download_url: https://data.humdata.org/dataset/829bc9ac-8542-4f18-a940-f15d63462113/resource/b959707b-0c8a-49a3-b2b2-a63ca523deb4/download/zmb-rainfall-subnat-full.csv
  format: null
  id: resource_b959707b
  media_type: text/csv
  spatial: null
  ...
  title: zmb-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135735450892_fae9c923'
  download_url: https://data.humdata.org/dataset/829bc9ac-8542-4f18-a940-f15d63462113/resource/e867d21b-e0a9-4d8e-9576-442db622723e/download/zmb-rainfall-subnat-5ytd.csv
  format: null
  id: resource_e867d21b
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: zmb-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-zmb_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
