...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/uzb-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/uzb-rainfall-subnational
dataset_id: rdls_hzd-uzb_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/uzb-rainfall-subnational]'
...
license: CC-BY-4.0
lineage:
  description: Dekadal rainfall data were derived from CHIRPS satellite imagery merged
    with in-situ station observations, then aggregated by subnational administrative
    units. Rolling 1-month and 3-month aggregations and long-term averages were computed
    to generate drought indicators (rainfall anomalies and quintiles) for meteorological
    drought monitoring.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/uzb-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135820001845_7bc3970e'
  download_url: https://data.humdata.org/dataset/4cd10ee7-ca54-4cd1-8742-e742a527902a/resource/0045eb90-64ed-45eb-9475-97dc148aa4f8/download/uzb-rainfall-subnat-full.csv
  format: null
  id: resource_0045eb90
  media_type: text/csv
  spatial: null
  ...
  title: uzb-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135820001845_7bc3970e'
  download_url: https://data.humdata.org/dataset/4cd10ee7-ca54-4cd1-8742-e742a527902a/resource/fb6a15ec-12b0-4b81-b32a-e5d29f85298d/download/uzb-rainfall-subnat-5ytd.csv
  format: null
  id: resource_fb6a15ec
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: uzb-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-uzb_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Uzbekistan: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
