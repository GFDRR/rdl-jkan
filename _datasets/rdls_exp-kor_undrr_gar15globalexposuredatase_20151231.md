...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-korea-republic-of
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-korea-republic-of
dataset_id: rdls_exp-kor_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-korea-republic-of]'
...
lineage:
  description: The GAR15 global exposure database for Korea was developed using a
    top-down approach where national-level socio-economic data, building type distributions,
    and capital stock information were spatially disaggregated onto 5x5 km and 1x1
    km grids using geographic population distribution and GDP as spatial proxies.
    The dataset integrates inputs from multiple international agencies (UNEP-GRID,
    WAPMERR, JRC, Kokusai Kogyo) to create a comprehensive gridded exposure inventory
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-korea-republic-of
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Korea (Republic of).zip
  download_url: https://data.humdata.org/dataset/c7752374-fad3-4736-8f16-eda2d19b5f68/resource/3441b682-c927-4156-b0d8-d2eafb89df35/download/kor.zip
  format: null
  id: resource_3441b682
  ...
  title: GAR15 Global Exposure Dataset for Korea (Republic of).zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kor_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Korea (Republic of)
version: null
vulnerability: null
---
