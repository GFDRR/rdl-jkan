...
- entity:
    ...
    url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-bangladesh
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Centers for Environmental Information (NCEI / NOAA)
  url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-bangladesh
dataset_id: rdls_hzd-bgd_hdx_dailysummariesprecipitati_20151223
description: 'This dataset contains the daily summaries on base stations across Bangladesh
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-bangladesh]'
...
lineage:
  description: Daily precipitation and snow measurements were collected from meteorological
    base stations across Bangladesh by NOAA's National Centers for Environmental Information.
    Stations were filtered to meet a 30-year record requirement with minimum 182 days
    of complete data annually. Four indicators (total precipitation, maximum snow
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-bangladesh
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: Daily Summaries of Precipitation Indicators for Bangladesh (CSV)
  download_url: https://data.humdata.org/dataset/ce0ea3a3-e6a0-4ceb-bba4-cbe7a15e3afc/resource/9e4e345b-09bf-4d4f-8ae1-a0b1ee0953d0/download/precipitation_bgd.csv
  format: null
  id: resource_9e4e345b
  media_type: text/csv
  spatial: null
  ...
  title: precipitation_bgd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bgd_hdx_dailysummariesprecipitati_20151223
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-23'
temporal_resolution: null
title: Daily Summaries of Precipitation Indicators for Bangladesh
version: null
vulnerability: null
---
