...
- entity:
    ...
    url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-ethiopia
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Centers for Environmental Information (NCEI / NOAA)
  url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-ethiopia
dataset_id: rdls_hzd-eth_hdx_dailysummariesprecipitati_20151223
description: 'This dataset contains the daily summaries on base stations across Ethiopia
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-ethiopia]'
...
lineage:
  description: Daily precipitation and snow observations were collected from meteorological
    base stations across Ethiopia by NOAA's National Centers for Environmental Information.
    Stations were filtered to include only those with minimum 30 years of data and
    ...
    compiled into daily summaries for drought and extreme precipitation hazard characterization.
  sources:
  - id: source_1
    license: null
    name: National Centers for Environmental Information (NCEI / NOAA)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-ethiopia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Daily Summaries of Precipitation Indicators for Ethiopia (CSV)
  download_url: https://data.humdata.org/dataset/79e7f151-a98e-42f1-a0b2-b9a48526f4cb/resource/f79e6893-0a79-4400-b25b-826df520931f/download/precipitation_eth.csv
  format: null
  id: resource_f79e6893
  media_type: text/csv
  spatial: null
  ...
  title: precipitation_eth.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-eth_hdx_dailysummariesprecipitati_20151223
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-23'
temporal_resolution: null
title: Daily Summaries of Precipitation Indicators for Ethiopia
version: null
vulnerability: null
---
