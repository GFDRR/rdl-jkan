...
- entity:
    ...
    url: https://data.humdata.org/dataset/new-caledonia-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/new-caledonia-road-surface-data
dataset_id: rdls_exp-ncl_heigit_newcaledoniaroadsurfaceda_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/new-caledonia-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    comprehensive road surface dataset for New Caledonia, supporting humanitarian
...
- access_url: null
  ...
  description: 'New Caledonia: Road Surface Data (GeoJSON data for New caledonia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ncl_roadsurface_lines.geojson
  format: null
  id: resource_6c19327c
  ...
  title: New caledonia GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'New Caledonia: Road Surface Data (Geopackage data for New caledonia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ncl_roadsurface_lines.gpkg
  format: null
  id: resource_61b40bd6
  ...
  temporal: null
  temporal_resolution: null
  title: New caledonia GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ncl_heigit_newcaledoniaroadsurfaceda_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'New Caledonia: Road Surface Data'
version: null
vulnerability: null
---
