...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/stp-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/stp-rainfall-subnational
dataset_id: rdls_hzd-stp_wfp_saotomeprinciperainfallin_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/stp-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    1-month, and 3-month rolling totals) and standardized anomalies at subnational
    administrative units in Sao Tome and Principe to support drought monitoring and
    early warning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/stp-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135638602103_1c0c487e'
  download_url: https://data.humdata.org/dataset/86abab12-975e-453a-8e48-fa75b167d339/resource/6d666535-83cf-47ee-a205-bf999ad64ad2/download/stp-rainfall-subnat-full.csv
  format: null
  id: resource_6d666535
  media_type: text/csv
  spatial: null
  ...
  title: stp-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135638602103_1c0c487e'
  download_url: https://data.humdata.org/dataset/86abab12-975e-453a-8e48-fa75b167d339/resource/648a278b-23e9-4261-a43e-143aec4b8896/download/stp-rainfall-subnat-5ytd.csv
  format: null
  id: resource_648a278b
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: stp-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-stp_wfp_saotomeprinciperainfallin_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Sao Tome and Principe: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
