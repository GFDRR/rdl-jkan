...
- entity:
    ...
    url: https://data.humdata.org/dataset/tuvalu-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/tuvalu-level-1-exposure-data
dataset_id: rdls_exp-tuv_gem_tuvalulevel1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tuvalu-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
license: CC-BY-4.0
lineage:
  description: Building exposure data for Tuvalu was developed through the METEOR
    project using Earth observation routines to estimate building stock characteristics
    at 15-arcsecond grid resolution (~500m). The dataset provides counts, areas, and
    rebuilding values of buildings intended for catastrophe modeling and disaster
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tuvalu-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Tuvalu produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/e5a97e66-0efe-44e4-b57b-adfd84df6939/resource/69caddc4-a668-4a13-87a7-396481b11181/download/tuv_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_69caddc4
  ...
  title: TUV_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tuv_gem_tuvalulevel1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Tuvalu: Level 1 Exposure Data'
version: null
vulnerability: null
---
