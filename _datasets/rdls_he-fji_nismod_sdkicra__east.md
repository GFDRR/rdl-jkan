...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-fji_nismod_sdkicra__east
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Fiji (East). Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539778
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539778
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Fiji (East), clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16539778/files/FJI.zip
  format: null
  id: resource_sdkicra_fji
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Fiji
    (East)
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-fji_nismod_sdkicra__east
spatial:
  bbox:
  - -180.0
  - -21.71
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2205218/fiji.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Fiji (East)
version: 0.1.0
vulnerability: null
---
