...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/zwe-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/zwe-iom-dtm-from-api
dataset_id: rdls_lss-zwe_iom_displacementtrackingmatri_2018
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/zwe-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced persons across Zimbabwe
    at admin 0-2 levels. Data is aggregated by displacement reason, demographics (sex),
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zwe-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Zimbabwe IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/4186cda1-11e0-4825-a71b-a069316a34a8/resource/25abc1de-3a82-49eb-b1a7-adc8f1f80ee9/download/zwe-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_25abc1de
  media_type: text/csv
  spatial: null
  ...
  title: Zimbabwe IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-zwe_iom_displacementtrackingmatri_2018
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2018-11-30'
temporal_resolution: null
title: Zimbabwe IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
