...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-lucia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-lucia
dataset_id: rdls_exp-lca_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-lucia]'
...
lineage:
  description: The GAR15 global exposure database for Saint Lucia was developed using
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saint-lucia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Saint Lucia.zip
  download_url: https://data.humdata.org/dataset/5b79a1b4-1af4-44c3-b244-72c46caed718/resource/8e74c538-4107-4b50-b83f-11e6f66bc4bd/download/lca.zip
  format: null
  id: resource_8e74c538
  ...
  title: GAR15 Global Exposure Dataset for Saint Lucia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lca_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Saint Lucia
version: null
vulnerability: null
---
