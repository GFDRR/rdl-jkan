...
- entity:
    ...
    url: https://data.humdata.org/dataset/kiribati-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/kiribati-road-surface-data
dataset_id: rdls_exp-kir_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kiribati-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated predictions for road surface types, with results integrated
    into a combined classification prioritizing either OSM or deep learning predictions.
    The resulting dataset provides spatial inventory of road infrastructure with surface
    type attributes for humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kiribati-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Kiribati: Road Surface Data (GeoJSON data for Kiribati.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_kir_roadsurface_lines.geojson
  format: null
  id: resource_1b7df961
  ...
  title: Kiribati GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Kiribati: Road Surface Data (Geopackage data for Kiribati.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_kir_roadsurface_lines.gpkg
  format: null
  id: resource_018f4545
  ...
  temporal: null
  temporal_resolution: null
  title: Kiribati GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kir_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Kiribati: Road Surface Data'
version: null
vulnerability: null
---
