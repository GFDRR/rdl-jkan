...
- entity:
    ...
    url: https://data.humdata.org/dataset/lso-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/lso-ndvi-subnational
dataset_id: rdls_hzd-lso_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lso-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI values by WFP subnational administrative units. NDVI anomalies were calculated
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lso-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135821797248_7660b03c'
  download_url: https://data.humdata.org/dataset/ec2e7247-7cb6-4daf-9cfb-b0be1d4ed50a/resource/3ebfd0ec-fcbd-41ed-a6b9-7a52d4935a30/download/lso-ndvi-subnat-full.csv
  format: null
  id: resource_3ebfd0ec
  media_type: text/csv
  spatial: null
  ...
  title: lso-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135821797248_7660b03c'
  download_url: https://data.humdata.org/dataset/ec2e7247-7cb6-4daf-9cfb-b0be1d4ed50a/resource/26ecbdc8-f7a6-4677-9735-7a4d4c444277/download/lso-ndvi-subnat-5ytd.csv
  format: null
  id: resource_26ecbdc8
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: lso-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lso_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Lesotho: NDVI at Subnational Level'
version: null
vulnerability: null
---
