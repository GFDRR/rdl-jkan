...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-azerbaijan
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-azerbaijan
dataset_id: rdls_exp-aze_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-azerbaijan]'
...
lineage:
  description: The GAR15 global exposure database for Azerbaijan was developed using
    a top-down approach where national-level socio-economic, building type, and capital
    stock statistics were transposed onto 5x5 km and 1x1 km grid cells using geographic
    distribution of population density and GDP as spatial proxies. The methodology
    was developed by UNEP-GRID in collaboration with WAPMERR, EU JRC, and Kokusai
    Kogyo to create a spatially-explicit exposure inventory for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-azerbaijan
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Azerbaijan.zip
  download_url: https://data.humdata.org/dataset/f39f16fe-f2b0-4e97-9696-d73b666597e7/resource/007892f9-6733-4087-b94c-2eeb812001d2/download/aze.zip
  format: null
  id: resource_007892f9
  ...
  title: GAR15 Global Exposure Dataset for Azerbaijan.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-aze_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Azerbaijan
version: null
vulnerability: null
---
