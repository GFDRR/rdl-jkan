...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-djibouti
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-djibouti
dataset_id: rdls_exp-dji_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-djibouti]'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-djibouti
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Djibouti.zip
  download_url: https://data.humdata.org/dataset/6d370fa7-74ef-43d2-a702-a40b955f9c2c/resource/40e1aee4-96c4-4c31-ab2d-856ff5654af1/download/dji.zip
  format: null
  id: resource_40e1aee4
  ...
  title: GAR15 Global Exposure Dataset for Djibouti.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dji_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Djibouti
version: null
vulnerability: null
---
