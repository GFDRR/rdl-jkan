...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-caf_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Central African Republic. Derived from
  global datasets clipped to national boundaries to support climate risk analysis
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540092
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540092
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Central African Republic, clipped from global sources. Contents: (1) Hazard -
    Coastal flood inundation maps (90 GeoTIFF, Aqueduct Floods, ~1km resolution, return
    periods 2-1000yr, scenarios: historical/RCP4.5/RCP8.5, periods: 2030/2050/2080);
  ...
  download_url: https://zenodo.org/records/16540092/files/CAF.zip
  format: null
  id: resource_sdkicra_caf
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Central
    African Republic
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-caf_nismod_sdkicra
spatial:
  bbox:
  - 14.39
  - 2.24
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/239880/central-african-republic.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Central African
  Republic
version: 0.1.0
vulnerability: null
---
