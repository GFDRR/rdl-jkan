...
- entity:
    ...
    url: https://data.humdata.org/dataset/sen-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/sen-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-sen_hdx_ibtracsstormtracks_1852
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sen-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Senegal subset contains observed storm positions,
    wind speeds (wmo_wind), central pressures (wmo_pres), and storm classification
    (nature) for all cyclones affecting or passing through the region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sen-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Senegal.
  download_url: https://data.humdata.org/dataset/726f7e97-6a8b-410e-a4a4-fb033261d581/resource/0ba4629a-7246-4b2c-a5cc-a04402540e6a/download/ibtracs_all_list_v04r01_sen.csv
  format: null
  id: resource_0ba4629a
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SEN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1852 to date that pass within 2000 kilometers
    of Senegal.
  download_url: https://data.humdata.org/dataset/726f7e97-6a8b-410e-a4a4-fb033261d581/resource/e4dccaf6-bf6b-4314-a95c-c397868b46b9/download/ibtracs_all_list_v04r01_lines_sen.geojson
  format: null
  id: resource_e4dccaf6
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SEN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-sen_hdx_ibtracsstormtracks_1852
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1852-09-26'
temporal_resolution: null
title: 'Senegal: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
