...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-mauritania
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-mauritania
dataset_id: rdls_exp-mrt_kontur_populationdensity400mh3he_2023
description: 'Mauritania population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-mauritania]'
...
lineage:
  description: Population density data was derived by fusing multiple global datasets
    ...
    population exposure at high spatial resolution for Mauritania.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- access_url: null
  ...
  description: 'Mauritania: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MR_20220630.gpkg.gz
  format: null
  id: resource_387f74a9
  ...
  title: kontur_population_MR_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Mauritania: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MR_20231101.gpkg.gz
  format: null
  id: resource_fc548156
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_MR_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mrt_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Mauritania: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
