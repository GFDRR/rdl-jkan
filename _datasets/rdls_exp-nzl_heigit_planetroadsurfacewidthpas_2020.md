...
- entity:
    ...
    url: https://data.humdata.org/dataset/new-zealand-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/new-zealand-planet-road-surface-data
dataset_id: rdls_exp-nzl_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ surface conditions in many regions. Summary of Road Statistics Approximately 0.019\
  \ million km of arterial roads are mapped in OSM in this region. - Paved roads:\
  \ 0.0177 million km (93.0291%) - Unpaved roads: 0.0 million km (0.106%) - Missing\
  \ OSM surface tags: 0.0 million km (0.1416%) - PlanetScope predictions cover: 0.0177\
  \ million km (65775.5904%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/new-zealand-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries from OpenStreetMap were extracted for arterial
    highways in New Zealand. Deep learning models were applied to PlanetScope satellite
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/new-zealand-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'New Zealand: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for New zealand)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_NZ_planet_roadsurface_lines.geojson
  format: null
  id: resource_eceb2ca6
  ...
  title: New zealand GeoJSON heigit_NZ_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'New Zealand: Planet Road Surface, Width, and Passability Data (Geopackage
    file for New zealand)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_NZ_planet_roadsurface_lines.gpkg
  format: null
  id: resource_e6a1b5f6
  ...
  temporal: null
  temporal_resolution: null
  title: New zealand GPKG heigit_NZ_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nzl_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'New Zealand: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
