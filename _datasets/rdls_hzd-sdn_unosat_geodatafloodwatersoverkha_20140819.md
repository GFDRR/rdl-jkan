...
contact_point:
  ...
  url: https://data.humdata.org/dataset/geodata-of-flood-waters-over-khartoum-state-sudan-august-19-2014
creator:
  affiliation: null
  email: null
  name: United Nations Satellite Centre (UNOSAT)
  url: https://data.humdata.org/dataset/geodata-of-flood-waters-over-khartoum-state-sudan-august-19-2014
dataset_id: rdls_hzd-sdn_unosat_geodatafloodwatersoverkha_20140819
description: 'This map illustrates satellite-detected areas of flood affected land
  as detected in satellite imagery acquired by the Pleiades satellite on 14 August
  ...
  over Khartoum has decreased slightly in some areas, however the higher resolution
  of the Pleiades shows more smaller standing bodies of water that were likely overlooked
  by previous sensors. It is likely that flood waters have been systematically underestimated
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/geodata-of-flood-waters-over-khartoum-state-sudan-august-19-2014]'
...
lineage:
  description: Pleiades satellite imagery acquired on 14 August 2014 was analyzed
    ...
    to delineate flood-affected areas in vector format. The resulting geodata represents
    observed flood extent with area measurements in hectares and square meters.
  sources:
  - id: source_1
    license: null
    name: United Nations Satellite Centre (UNOSAT)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/geodata-of-flood-waters-over-khartoum-state-sudan-august-19-2014
  rel: source
loss:
  losses: []
project: null
...
- hazard
schema: rdls-10
slug: rdls_hzd-sdn_unosat_geodatafloodwatersoverkha_20140819
spatial:
  bbox: null
  centroid: null
  countries:
