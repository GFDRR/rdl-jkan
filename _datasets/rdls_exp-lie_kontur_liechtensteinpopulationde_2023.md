...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-liechtenstein
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-liechtenstein
dataset_id: rdls_exp-lie_kontur_liechtensteinpopulationde_2023
description: 'Liechtenstein population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-liechtenstein]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    and OpenStreetMap) and aggregating the results to 400m H3 hexagonal grid cells
    using the H3 hierarchical spatial indexing system. The dataset provides baseline
    population distribution for Liechtenstein at high spatial resolution suitable
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-liechtenstein
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Liechtenstein: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_LI_20220630.gpkg.gz
  format: null
  id: resource_2a66d8de
  ...
  title: kontur_population_LI_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Liechtenstein: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_LI_20231101.gpkg.gz
  format: null
  id: resource_af72df52
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_LI_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lie_kontur_liechtensteinpopulationde_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Liechtenstein: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
