...
- entity:
    ...
    url: https://data.humdata.org/dataset/ltu-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ltu-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ltu_hdx_ibtracsstormtracks_1865
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ltu-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple meteorological
    agencies into a unified best-track dataset. The Lithuania subset contains historical
    and recent cyclone tracks with ISO-formatted timestamps, basin/subbasin classifications,
    wind speed (wmo_wind), and central pressure (wmo_pres) measurements. Data is provided
    as both tabular CSV and geospatial GeoJSON line geometries representing storm
    track trajectories.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ltu-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Lithuania.
  download_url: https://data.humdata.org/dataset/9b191d33-ba1f-4a65-af40-6e69bbca7770/resource/56a7bba7-97cb-4c32-8900-5239d2696bc6/download/ibtracs_all_list_v04r01_ltu.csv
  format: null
  id: resource_56a7bba7
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_LTU.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Lithuania.
  download_url: https://data.humdata.org/dataset/9b191d33-ba1f-4a65-af40-6e69bbca7770/resource/1277b6c9-34b6-4b88-a053-ebfec73c2d66/download/ibtracs_all_list_v04r01_lines_ltu.geojson
  format: null
  id: resource_1277b6c9
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_LTU.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ltu_hdx_ibtracsstormtracks_1865
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1865-10-24'
temporal_resolution: null
title: 'Lithuania: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
