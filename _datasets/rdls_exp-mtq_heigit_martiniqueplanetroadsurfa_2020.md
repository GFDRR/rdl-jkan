...
- entity:
    ...
    url: https://data.humdata.org/dataset/martinique-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/martinique-planet-road-surface-data
dataset_id: rdls_exp-mtq_heigit_martiniqueplanetroadsurfa_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0005 million km (71.4841%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (4.0195%) - PlanetScope predictions cover: 0.0005\
  \ million km (1778.4455%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/martinique-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road surface type, width, and passability were derived by applying
    ...
    (HPI) to support logistics planning and infrastructure assessment.
  sources:
  - id: source_1
    license: null
    name: PlanetScope Satellite Imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/martinique-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Martinique: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Martinique)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MQ_planet_roadsurface_lines.gpkg
  format: null
  id: resource_18c880b9
  ...
  title: Martinique GPKG heigit_MQ_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Martinique: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Martinique)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_MQ_planet_roadsurface_lines.geojson
  format: null
  id: resource_912e86cc
  ...
  temporal: null
  temporal_resolution: null
  title: Martinique GeoJSON heigit_MQ_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mtq_heigit_martiniqueplanetroadsurfa_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Martinique: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
