...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-aland-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-aland-islands
dataset_id: rdls_exp-ala_kontur_alandislandspopulationden_2023
description: "\xC5land Islands population density for 400m H3 hexagons. Built from\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-aland-islands]"
...
lineage:
  description: "Population density estimates were derived by fusing multiple global\
    \ datasets (GHSL, Facebook HRSL, Microsoft Buildings, Copernicus Land Cover, LINZ,\
    \ and OpenStreetMap) and allocating population counts to H3 hexagonal grid cells\
    \ at 400m resolution using spatial overlay and hierarchical indexing methods.\
    \ The dataset provides baseline population exposure data for \xC5land Islands\
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-aland-islands
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: "\xC5land Islands: Population Density for 400m H3 Hexagons (Release\
    \ 2022-06-30)"
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AX_20220630.gpkg.gz
  format: null
  id: resource_3e46c354
  ...
  title: kontur_population_AX_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: "\xC5land Islands: Population Density for 400m H3 Hexagons (Release\
    \ 2023-11-01)"
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AX_20231101.gpkg.gz
  format: null
  id: resource_3f3b7556
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_AX_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ala_kontur_alandislandspopulationden_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: "\xC5land Islands: Population Density for 400m H3 Hexagons"
version: null
vulnerability: null
---
