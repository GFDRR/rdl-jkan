...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-algeria
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-algeria
dataset_id: rdls_exp-dza_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-algeria]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Algeria were spatially disaggregated using a top-down approach onto 5x5 km
    and 1x1 km grids, with geographic population distribution and GDP serving as spatial
    proxies for allocation. The dataset was developed collaboratively by UNEP-GRID,
    WAPMERR, JRC, and Kokusai Kogyo as part of the GAR15 global exposure assessment
    initiative.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-algeria
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Algeria.zip
  download_url: https://data.humdata.org/dataset/8cf116bb-8aa0-4d7a-9f34-7d2aab5b0bfc/resource/b332fc92-af18-411a-b8fc-b3e6b309e5ca/download/dza.zip
  format: null
  id: resource_b332fc92
  ...
  title: GAR15 Global Exposure Dataset for Algeria.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dza_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Algeria
version: null
vulnerability: null
---
