...
- entity:
    ...
    url: https://data.humdata.org/dataset/esp-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/esp-ghsl
dataset_id: rdls_exp-esp_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/esp-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    distribution at global scale, with Spain-specific outputs provided as GeoTIFF
    rasters.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/esp-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/9597785a-919f-4314-a1cb-8ea4581209cd/resource/5505305d-3874-4c0d-88d0-445dcb4273de/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_esp.tif
  format: null
  id: resource_5505305d
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Spain: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/9597785a-919f-4314-a1cb-8ea4581209cd/resource/96f4cb6b-3ebf-43b1-9174-6ea220f6e960/download/ghs_pop_e2025_r2023a_54009_100_v1_0_esp.tif
  format: null
  id: resource_96f4cb6b
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-esp_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Spain: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
