...
- entity:
    ...
    url: https://data.humdata.org/dataset/pcn-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/pcn-ghsl
dataset_id: rdls_exp-copernicus_pitcairnglobalhumansettle_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/pcn-ghsl]'
...
lineage:
  description: The GHSL dataset integrates global fine-scale satellite imagery, census
    data, and crowdsourced geographic information through automated spatial data processing
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pcn-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/def6ff3e-c1dc-4bed-801d-6c98e39a44f4/resource/a5e29e7e-c7ec-4c55-b8ca-d53095683517/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_pcn.tif
  format: null
  id: resource_a5e29e7e
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Pitcairn: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/def6ff3e-c1dc-4bed-801d-6c98e39a44f4/resource/c2d8d6c6-8626-41a0-938f-aea6672d4c39/download/ghs_pop_e2025_r2023a_54009_100_v1_0_pcn.tif
  format: null
  id: resource_c2d8d6c6
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-copernicus_pitcairnglobalhumansettle_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Pitcairn: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
