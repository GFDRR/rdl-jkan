...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-syrian-arab-republic
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-syrian-arab-republic
dataset_id: rdls_exp-syr_kontur_arabrepublicpopulationden_2023
description: 'Syrian Arab Republic population density for 400m H3 hexagons. Built
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-syrian-arab-republic]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    OpenStreetMap) and aggregating the results into 400m H3 hexagonal grid cells using
    the H3 hierarchical spatial indexing system. The methodology integrates satellite
    imagery, machine learning-based settlement detection, and crowdsourced geospatial
    data to produce consistent population counts at sub-kilometer resolution for baseline
    exposure assessment.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-syrian-arab-republic
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Syrian Arab Republic: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_SY_20220630.gpkg.gz
  format: null
  id: resource_18644f31
  ...
  title: kontur_population_SY_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Syrian Arab Republic: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_SY_20231101.gpkg.gz
  format: null
  id: resource_7199fcbd
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_SY_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-syr_kontur_arabrepublicpopulationden_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Syrian Arab Republic: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
