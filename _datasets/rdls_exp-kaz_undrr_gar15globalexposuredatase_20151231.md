...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kazakhstan
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kazakhstan
dataset_id: rdls_exp-kaz_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kazakhstan]'
...
- asset_type:
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Population distribution across grids derived from geographic population
      density data
    id: population
    scheme: null
    title: null
...
lineage:
  description: The GAR15 global exposure dataset for Kazakhstan was developed using
    ...
    multi-source inputs from UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo to estimate
    the economic value and spatial distribution of exposed assets.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kazakhstan
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Kazakhstan.zip
  download_url: https://data.humdata.org/dataset/11908092-a07c-4db1-bba2-51b673bdbc1a/resource/4f9c5bb1-0edc-412f-b5f0-c89511f7589c/download/kaz.zip
  format: null
  id: resource_4f9c5bb1
  ...
  title: GAR15 Global Exposure Dataset for Kazakhstan.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kaz_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Kazakhstan
version: null
vulnerability: null
---
