...
creator:
  ...
  name: Aqueduct
  url: https://www.wri.org/data/aqueduct-global-maps-40-data
dataset_id: rdls_exp-crstac_currentandfutureglobalmapsdataaqueduct40_waterstresshistoric
description: 'Aqueduct Baseline Water Stress from 1979-2019, provided at sub-basin
  scale [Source: This metadata record was automatically extracted from the STAC catalog
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/exposure-vulnerability/land-use/current-and-future-global-maps-data-aqueduct-40/water-stress-historic/water-stress-historic.json
...
- access_url: null
  ...
  description: Current and Future Global Maps Data (Aqueduct 4.0) - Water Stress historic
    - data file
  ...
  temporal: null
  temporal_resolution: null
  title: Current and Future Global Maps Data (Aqueduct 4.0) - Water Stress historic
    - data file
...
- exposure
schema: rdls-10
slug: rdls_exp-crstac_currentandfutureglobalmapsdataaqueduct40_waterstresshistoric
spatial:
  bbox:
  - -180.0
  - -90.0
