...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saudi-arabia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saudi-arabia
dataset_id: rdls_exp-sau_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saudi-arabia]'
...
lineage:
  description: The GAR15 global exposure database for Saudi Arabia was developed using
    a top-down approach where national-level socio-economic data, building type distributions,
    and capital stock information were spatially disaggregated onto 5x5 km and 1x1
    km grids using geographic population density and GDP as spatial proxies. The dataset
    integrates inputs from multiple international agencies (UNEP-GRID, WAPMERR, JRC,
    Kokusai Kogyo) to estimate the economic value and spatial distribution of exposed
    assets.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-saudi-arabia
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Saudi Arabia.zip
  download_url: https://data.humdata.org/dataset/f2d1ac61-55b0-4e1e-822a-7d933043223f/resource/cde11c3f-f06f-4d06-b004-503c8e8e6779/download/sau.zip
  format: null
  id: resource_cde11c3f
  ...
  title: GAR15 Global Exposure Dataset for Saudi Arabia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sau_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Saudi Arabia
version: null
vulnerability: null
---
