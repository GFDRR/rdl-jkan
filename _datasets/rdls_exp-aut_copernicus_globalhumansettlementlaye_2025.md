...
- entity:
    ...
    url: https://data.humdata.org/dataset/aut-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/aut-ghsl
dataset_id: rdls_exp-aut_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/aut-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distributions. For Austria,
    this produces rasterized layers of building footprints and population density
    derived from multi-source geospatial data integration.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/aut-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/3248d6fe-f1a8-4652-9b27-6cde48357ee9/resource/6c506528-2cc5-4bd5-a436-a6a9d3ae3a69/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_aut.tif
  format: null
  id: resource_6c506528
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Austria: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/3248d6fe-f1a8-4652-9b27-6cde48357ee9/resource/5bf605ba-20ea-4bbf-a263-3fb419164afa/download/ghs_pop_e2025_r2023a_54009_100_v1_0_aut.tif
  format: null
  id: resource_5bf605ba
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-aut_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Austria: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
