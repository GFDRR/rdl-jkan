...
- entity:
    ...
    url: https://data.humdata.org/dataset/saint-lucia-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/saint-lucia-road-surface-data
dataset_id: rdls_exp-lca_heigit_saintluciaroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/saint-lucia-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    ...
    from unpaved surfaces. The resulting dataset combines OSM-mapped attributes with
    predicted surface classes to provide comprehensive road infrastructure inventory
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/saint-lucia-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Saint Lucia: Road Surface Data (GeoJSON data for Saint lucia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lca_roadsurface_lines.geojson
  format: null
  id: resource_5205576b
  ...
  title: Saint lucia GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Saint Lucia: Road Surface Data (Geopackage data for Saint lucia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_lca_roadsurface_lines.gpkg
  format: null
  id: resource_c6c4cb71
  ...
  temporal: null
  temporal_resolution: null
  title: Saint lucia GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lca_heigit_saintluciaroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Saint Lucia: Road Surface Data'
version: null
vulnerability: null
---
