...
- entity:
    ...
    url: https://data.humdata.org/dataset/united-states-virgin-islands-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/united-states-virgin-islands-road-surface-data
dataset_id: rdls_exp-vir_heigit_unitedstatesvirginislands_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/united-states-virgin-islands-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    enabling assessment of infrastructure accessibility and humanitarian logistics
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/united-states-virgin-islands-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'United States Virgin Islands: Road Surface Data (GeoJSON data for
    United states virgin islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_vir_roadsurface_lines.geojson
  format: null
  id: resource_02c50526
  ...
  title: United states virgin islands GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'United States Virgin Islands: Road Surface Data (Geopackage data for
    United states virgin islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_vir_roadsurface_lines.gpkg
  format: null
  id: resource_55b044ff
  ...
  temporal: null
  temporal_resolution: null
  title: United states virgin islands GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vir_heigit_unitedstatesvirginislands_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'United States Virgin Islands: Road Surface Data'
version: null
vulnerability: null
---
