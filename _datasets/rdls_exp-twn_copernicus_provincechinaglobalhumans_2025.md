...
- entity:
    ...
    url: https://data.humdata.org/dataset/twn-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/twn-ghsl
dataset_id: rdls_exp-twn_copernicus_provincechinaglobalhumans_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/twn-ghsl]'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/twn-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/d713bc11-fdca-415a-bf1f-3a87355b149a/resource/e728b6db-6c68-4a11-8f02-90b9a454b110/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_twn.tif
  format: null
  id: resource_e728b6db
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Taiwan (Province of China): Copernicus Global Human Settlement Layer
    (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/d713bc11-fdca-415a-bf1f-3a87355b149a/resource/84d9b582-0ab2-4028-84df-a1a097a5c7dd/download/ghs_pop_e2025_r2023a_54009_100_v1_0_twn.tif
  format: null
  id: resource_84d9b582
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-twn_copernicus_provincechinaglobalhumans_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Taiwan (Province of China): Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
