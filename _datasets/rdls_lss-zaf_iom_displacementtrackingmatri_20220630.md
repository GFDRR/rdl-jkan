...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/zaf-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/zaf-iom-dtm-from-api
dataset_id: rdls_lss-zaf_iom_displacementtrackingmatri_20220630
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/zaf-iom-dtm-from-api]'
...
lineage:
  description: IDP data collected through IOM's DTM framework using baseline assessments,
    ...
    with demographic disaggregation (male/female) and displacement reason classification.
    The dataset represents post-displacement impact records tracking population displacement
    across South Africa.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zaf-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: South Africa IOM displacement tracking matrix data at admin levels
    0-2, sourced from the DTM API
  download_url: https://data.humdata.org/dataset/f0e0895a-187e-46e3-9f23-ffb1eec4f39d/resource/dcfbd613-f353-48e8-a512-d70835f3798c/download/zaf-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_dcfbd613
  media_type: text/csv
  spatial: null
  ...
  title: South Africa IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-zaf_iom_displacementtrackingmatri_20220630
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-06-30'
temporal_resolution: null
title: South Africa IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
