...
- entity:
    ...
    url: https://data.humdata.org/dataset/georgia-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/georgia-road-surface-data
dataset_id: rdls_exp-geo_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.1136 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0147 and 0.0225
  (in million kms), corressponding to 12.9047% and 19.8241% respectively of the total
  road length in the dataset region. 0.0764 million km or 67.2712% of road surface
  ...
  to 0.2226% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/georgia-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    type classification across Georgia, supporting humanitarian access and logistics
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/georgia-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Georgia: Road Surface Data (GeoJSON data for Georgia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_geo_roadsurface_lines.geojson
  format: null
  id: resource_c892d74f
  ...
  title: Georgia GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Georgia: Road Surface Data (Geopackage data for Georgia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_geo_roadsurface_lines.gpkg
  format: null
  id: resource_c64defcf
  ...
  temporal: null
  temporal_resolution: null
  title: Georgia GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-geo_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Georgia: Road Surface Data'
version: null
vulnerability: null
---
