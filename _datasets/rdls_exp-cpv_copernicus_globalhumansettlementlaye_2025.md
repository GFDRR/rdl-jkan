...
- entity:
    ...
    url: https://data.humdata.org/dataset/cpv-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cpv-ghsl
dataset_id: rdls_exp-cpv_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cpv-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    Cabo Verde, this methodology produces rasterized exposure data representing human
    settlements and population presence without hazard or impact components.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cpv-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/30af3db9-6305-48d1-9942-0b020411a78f/resource/e0391b10-314a-4a53-b43f-98eb8eff8d2b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cpv.tif
  format: null
  id: resource_e0391b10
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Cabo Verde: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/30af3db9-6305-48d1-9942-0b020411a78f/resource/1cbbc924-0dab-46ad-a2b4-8d216afb9be2/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cpv.tif
  format: null
  id: resource_1cbbc924
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cpv_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Cabo Verde: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
