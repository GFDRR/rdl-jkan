...
- entity:
    ...
    url: https://data.humdata.org/dataset/wlf-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/wlf-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-wlf_hdx_wallisfutunaislandsibtrac_1941
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/wlf-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The data for Wallis
    and Futuna Islands is extracted from the global IBTrACS archive, providing observed
    storm positions, wind speeds (wmo_wind), and central pressures (wmo_pres) at regular
    time intervals in ISO format.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/wlf-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/dfb99512-730e-40c0-ba97-14cff81e48c0/resource/2c49500c-1fa3-4ce0-a7cf-97da70a3eba4/download/ibtracs_all_list_v04r01_wlf.csv
  format: null
  id: resource_2c49500c
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_WLF.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1941 to date that pass within 2000 kilometers
    of Wallis and Futuna Islands.
  download_url: https://data.humdata.org/dataset/dfb99512-730e-40c0-ba97-14cff81e48c0/resource/01c64a4e-1749-4978-8c5e-8ae282f3df7b/download/ibtracs_all_list_v04r01_lines_wlf.geojson
  format: null
  id: resource_01c64a4e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_WLF.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-wlf_hdx_wallisfutunaislandsibtrac_1941
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1941-01-13'
temporal_resolution: null
title: 'Wallis and Futuna Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
