...
- entity:
    ...
    url: https://data.humdata.org/dataset/jamaica-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/jamaica-road-surface-data
dataset_id: rdls_exp-jam_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/jamaica-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    across Jamaica. The model outputs were integrated with OSM attributes to create
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/jamaica-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Jamaica: Road Surface Data (GeoJSON data for Jamaica.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_jam_roadsurface_lines.geojson
  format: null
  id: resource_aa334e3f
  ...
  title: Jamaica GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Jamaica: Road Surface Data (Geopackage data for Jamaica.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_jam_roadsurface_lines.gpkg
  format: null
  id: resource_97987a24
  ...
  temporal: null
  temporal_resolution: null
  title: Jamaica GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-jam_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Jamaica: Road Surface Data'
version: null
vulnerability: null
---
