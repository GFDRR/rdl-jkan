...
- entity:
    ...
    url: https://data.humdata.org/dataset/bgr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bgr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bgr_hdx_bulgariaibtracsstormtrack_1887
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bgr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Bulgaria subset
    contains observed cyclone tracks with ISO-formatted timestamps, basin/subbasin
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bgr-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of Bulgaria.
  download_url: https://data.humdata.org/dataset/2e7f5384-2d54-4d64-b50e-ba997cd7d7cb/resource/5686e28c-0cf6-4cdb-9b79-98c80bb42c3b/download/ibtracs_all_list_v04r01_bgr.csv
  format: null
  id: resource_5686e28c
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BGR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of Bulgaria.
  download_url: https://data.humdata.org/dataset/2e7f5384-2d54-4d64-b50e-ba997cd7d7cb/resource/fe2ace71-d676-4e49-b603-7578a52f2274/download/ibtracs_all_list_v04r01_lines_bgr.geojson
  format: null
  id: resource_fe2ace71
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BGR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bgr_hdx_bulgariaibtracsstormtrack_1887
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1887-10-29'
temporal_resolution: null
title: 'Bulgaria: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
