...
- entity:
    ...
    url: https://data.humdata.org/dataset/cayman-islands-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/cayman-islands-planet-road-surface-data
dataset_id: rdls_exp-heigit_caymanislandsplanetroadsu_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (94.9268%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (12.9267%) - PlanetScope predictions cover: 0.0001\
  \ million km (734.3444%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cayman-islands-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road surface type, width, and passability were derived using deep learning
    ...
    A Humanitarian Passability Index was calculated from surface classification and
    width measurements to support humanitarian logistics and transportation planning.
  sources:
  - id: source_1
    license: null
    name: PlanetScope satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cayman-islands-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Cayman Islands: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Cayman islands)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_KY_planet_roadsurface_lines.gpkg
  format: null
  id: resource_fab144fa
  ...
  title: Cayman islands GPKG heigit_KY_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Cayman Islands: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Cayman islands)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_KY_planet_roadsurface_lines.geojson
  format: null
  id: resource_52b9c197
  ...
  temporal: null
  temporal_resolution: null
  title: Cayman islands GeoJSON heigit_KY_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-heigit_caymanislandsplanetroadsu_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Cayman Islands: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
