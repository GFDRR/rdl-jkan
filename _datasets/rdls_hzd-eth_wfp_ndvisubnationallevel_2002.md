...
- entity:
    ...
    url: https://data.humdata.org/dataset/eth-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/eth-ndvi-subnational
dataset_id: rdls_hzd-eth_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/eth-ndvi-subnational]'
...
lineage:
  description: 'Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    Data were aggregated by WFP-defined subnational administrative units to produce
    three indicators: 10-day NDVI (vim), long-term average NDVI (vim_lta), and NDVI
    anomaly percentage (viq), with pixel count metadata for quality assessment.'
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/eth-ndvi-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135520263194_2692de9e'
  download_url: https://data.humdata.org/dataset/f7956713-9cce-4784-a1b9-bca5a60f4729/resource/4d430d98-3dd3-4b27-b917-3c7eae559d1a/download/eth-ndvi-subnat-full.csv
  format: null
  id: resource_4d430d98
  media_type: text/csv
  spatial: null
  ...
  title: eth-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135520263194_2692de9e'
  download_url: https://data.humdata.org/dataset/f7956713-9cce-4784-a1b9-bca5a60f4729/resource/8eceaacf-f331-4e11-bef7-6d036f3a13ce/download/eth-ndvi-subnat-5ytd.csv
  format: null
  id: resource_8eceaacf
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: eth-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-eth_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Ethiopia: NDVI at Subnational Level'
version: null
vulnerability: null
---
