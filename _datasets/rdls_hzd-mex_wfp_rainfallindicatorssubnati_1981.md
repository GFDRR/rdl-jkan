...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/mex-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mex-rainfall-subnational
dataset_id: rdls_hzd-mex_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery merged with
    in-situ station observations and aggregated by subnational administrative units.
    Dekadal rainfall totals and rolling 1-month and 3-month accumulations were computed,
    along with anomalies relative to long-term climatological averages, to characterize
    meteorological drought conditions at the subnational level.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mex-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135629911359_45a300a5'
  download_url: https://data.humdata.org/dataset/2bfc60f8-7660-490e-9998-1597f4cad374/resource/65cbe609-8b58-4c26-9d63-f7d41ca32d5f/download/mex-rainfall-subnat-full.csv
  format: null
  id: resource_65cbe609
  media_type: text/csv
  spatial: null
  ...
  title: mex-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135629911359_45a300a5'
  download_url: https://data.humdata.org/dataset/2bfc60f8-7660-490e-9998-1597f4cad374/resource/8f7273c6-c302-42b7-ae8d-6b95ab19b2a8/download/mex-rainfall-subnat-5ytd.csv
  format: null
  id: resource_8f7273c6
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mex-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mex_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Mexico: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
