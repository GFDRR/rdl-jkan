...
dataset_id: rdls_hzd-TX_min_ZAF
description: "Annual maximum daytime coolest temperature. The baseline is calculated\
  \ for 2001\u20132020, with projections for 2021\u20132040 and 2041\u20132060 under\
  \ two climate scenarios: RCP 4.5 (moderate emissions) and RCP 8.5 (high emissions)."
...
purpose: 'This dataset is part of the scientific paper: Souverijns, N., De Ridder,
  ...
  and vulnerability analysis. Urban Climate, 46, 101331. https://doi.org/10.1016/j.uclim.2022.101351'
resources:
- coordinate_system: EPSG:4326
  description: Annual maximum daytime coolest temperature for the period 2001-2020.
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '0'
  spatial_resolution: null
  title: Annual Maximum Daytime Coolest Temperature - Johannebsurg & Ekurhuleni (2001-2020)
- coordinate_system: EPSG:4326
  description: Projected annual maximum daytime coolest temperature under the RCP
    4.5 and 8.5 scenario for 2021-2040.
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '1'
  spatial_resolution: null
  title: Annual Maximum Daytime Coolest Temperature - Johannebsurg & Ekurhuleni (2021-2040,
    RCP4.5 & RCP8.5)
- coordinate_system: EPSG:4326
  description: Projected annual maximum daytime coolest temperature under the RCP
    4.5 and 8.5 scenario for 2041-2060.
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '2'
  spatial_resolution: null
  title: Annual Maximum Daytime Coolest Temperature - Johannebsurg & Ekurhuleni (2041-2060,
    RCP4.5 & RCP8.5)
risk_data_type:
- hazard
schema: rdl-02
slug: rdls_hzd-TX_min_ZAF
spatial:
  bbox:
  - 27.676831894273278
  - -26.580113703331147
  ...
  - description: City of Ekurhuleni, Gauteng Province
    ...
    scheme: ISO 3166-2
  scale: sub-national
title: Annual Maximum Daytime Coolest Temperature
