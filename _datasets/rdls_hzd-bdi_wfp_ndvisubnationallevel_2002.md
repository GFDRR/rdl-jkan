...
- entity:
    ...
    url: https://data.humdata.org/dataset/bdi-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/bdi-ndvi-subnational
dataset_id: rdls_hzd-bdi_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bdi-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI values by sub-national administrative units defined by WFP boundaries. NDVI
    anomalies were calculated as percentage deviations from long-term averages to
    characterize agricultural drought conditions.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bdi-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135424622720_e6c480ff'
  download_url: https://data.humdata.org/dataset/9aa5dc77-f562-427a-9465-3ec84ab5f4c9/resource/e49b0140-42ec-4784-82ba-270adb275b4c/download/bdi-ndvi-subnat-full.csv
  format: null
  id: resource_e49b0140
  media_type: text/csv
  spatial: null
  ...
  title: bdi-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135424622720_e6c480ff'
  download_url: https://data.humdata.org/dataset/9aa5dc77-f562-427a-9465-3ec84ab5f4c9/resource/56490ae6-8375-4c82-984a-a59007c027b0/download/bdi-ndvi-subnat-5ytd.csv
  format: null
  id: resource_56490ae6
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: bdi-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bdi_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Burundi: NDVI at Subnational Level'
version: null
vulnerability: null
---
