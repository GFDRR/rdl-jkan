...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-mauritania
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-mauritania
dataset_id: rdls_exp-mrt_kontur_administrativedivisionagg_20220407
description: 'Mauritania administrative division with aggregated population. Built
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-mauritania]'
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries for Mauritania were extracted from OpenStreetMap
    and enriched with aggregated population counts derived from the Kontur Population
    global density dataset at 400m H3 hexagon resolution. HASC codes for regions were
    added from Wikidata. The dataset provides baseline population exposure data at
    administrative division levels for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- access_url: null
  ...
  description: 'Mauritania: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_MR_20220407.gpkg.gz
  format: null
  id: resource_281d5fe1
  ...
  title: kontur_boundaries_MR_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Mauritania: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_MR_20230628.gpkg.gz
  format: null
  id: resource_f14cf348
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_MR_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Mauritania: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_MR_20230628.gpkg.gz
  format: null
  id: resource_f629b922
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_MR_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mrt_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Mauritania: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
