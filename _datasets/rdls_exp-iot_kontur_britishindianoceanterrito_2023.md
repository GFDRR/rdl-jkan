...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-british-indian-ocean-territory
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-british-indian-ocean-territory
dataset_id: rdls_exp-iot_kontur_britishindianoceanterrito_2023
description: 'British Indian Ocean Territory population density for 400m H3 hexagons.
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-british-indian-ocean-territory]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    exposure at high spatial resolution for the British Indian Ocean Territory.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- access_url: null
  ...
  description: 'British Indian Ocean Territory: Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_IO_20220630.gpkg.gz
  format: null
  id: resource_fea70975
  ...
  title: kontur_population_IO_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'British Indian Ocean Territory: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_IO_20231101.gpkg.gz
  format: null
  id: resource_f449cfef
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_IO_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-iot_kontur_britishindianoceanterrito_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'British Indian Ocean Territory: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
