...
- entity:
    ...
    url: https://data.humdata.org/dataset/aland-islands-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/aland-islands-planet-road-surface-data
dataset_id: rdls_exp-ala_heigit_alandislandsplanetroadsur_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0004 million km (96.5762%) - Unpaved roads: 0.0 million km (2.9052%) - Missing\
  \ OSM surface tags: 0.0 million km (6.1546%) - PlanetScope predictions cover: 0.0004\
  \ million km (1616.3763%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/aland-islands-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: "Road network data from OpenStreetMap was extracted for arterial highways\
    \ in \xC5land Islands. Deep learning models were applied to PlanetScope satellite\
    ...
    \ (HPI) based on passability risk scores. The resulting dataset provides multi-temporal\
    \ infrastructure exposure data supporting humanitarian logistics and transportation\
    \ planning."
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/aland-islands-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: "\xC5land Islands: Planet Road Surface, Width, and Passability Data\
    \ (Geopackage file for \xC5land islands)"
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AX_planet_roadsurface_lines.gpkg
  format: null
  id: resource_e111b3aa
  ...
  title: "\xC5land islands GPKG heigit_AX_planet_roadsurface_lines.gpkg"
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: "\xC5land Islands: Planet Road Surface, Width, and Passability Data\
    \ (GeoJSON file for \xC5land islands)"
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AX_planet_roadsurface_lines.geojson
  format: null
  id: resource_47e6f39b
  ...
  temporal: null
  temporal_resolution: null
  title: "\xC5land islands GeoJSON heigit_AX_planet_roadsurface_lines.geojson"
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ala_heigit_alandislandsplanetroadsur_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: "\xC5land Islands: Planet Road Surface, Width, and Passability Data"
version: null
vulnerability: null
---
