...
- entity:
    ...
    email: null
    name: OpenStreetMap
    url: https://data.humdata.org/dataset/andorra-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/andorra-planet-road-surface-data
dataset_id: rdls_exp-and_heigit_andorraplanetroadsurfacew_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0003 million km (91.3209%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (0.9409%) - PlanetScope predictions cover: 0.0003\
  \ million km (9705.7268%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/andorra-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: OSM arterial road network geometries were extracted and overlaid with
    ...
    to classify road surface type (paved/unpaved), road width, and detect surface
    changes over time. A Humanitarian Passability Index (HPI) was computed combining
    these attributes to support humanitarian logistics and climate resilience planning.
  sources:
  - id: source_1
    license: null
    name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/andorra-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Andorra: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Andorra)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AD_planet_roadsurface_lines.gpkg
  format: null
  id: resource_406f2ec6
  ...
  title: Andorra GPKG heigit_AD_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Andorra: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Andorra)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AD_planet_roadsurface_lines.geojson
  format: null
  id: resource_ad02be9d
  ...
  temporal: null
  temporal_resolution: null
  title: Andorra GeoJSON heigit_AD_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-and_heigit_andorraplanetroadsurfacew_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Andorra: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
