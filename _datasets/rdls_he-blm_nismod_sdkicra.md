...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-blm_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Saint Barthelemy. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796742
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796742
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Saint Barthelemy, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/10796742/files/BLM.zip
  format: null
  id: resource_sdkicra_blm
...
- exposure
schema: rdls-10
slug: rdls_he-blm_nismod_sdkicra
spatial:
  bbox:
  - -62.87
  - 17.88
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3578476/saint-barthelemy.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Saint Barthelemy
version: 0.1.0
vulnerability: null
---
