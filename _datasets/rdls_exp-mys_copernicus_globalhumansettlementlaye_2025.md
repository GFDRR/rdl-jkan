...
- entity:
    ...
    url: https://data.humdata.org/dataset/mys-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mys-ghsl
dataset_id: rdls_exp-mys_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mys-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution. The Malaysia subset represents national-scale
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mys-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/f5333d5e-012a-4639-9745-bac38743a751/resource/d22aec1f-7506-4f86-8063-d0791ed235ba/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mys.tif
  format: null
  id: resource_d22aec1f
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Malaysia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/f5333d5e-012a-4639-9745-bac38743a751/resource/c3090974-9133-449f-ac29-51ca490ebf44/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mys.tif
  format: null
  id: resource_c3090974
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mys_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Malaysia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
