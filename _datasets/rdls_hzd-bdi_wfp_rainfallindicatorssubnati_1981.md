...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/bdi-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/bdi-rainfall-subnational
dataset_id: rdls_hzd-bdi_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/bdi-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with in-situ station measurements, then aggregated by dekad (10-day period) and
    computed into rolling 1-month and 3-month aggregations at subnational administrative
    units. Long-term rainfall averages and quantile-based indicators (rfq, r1q, r3q)
    were calculated to contextualize current rainfall against historical norms, enabling
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bdi-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135423005516_5a6c6ff1'
  download_url: https://data.humdata.org/dataset/b453999a-19e6-4a3a-92ea-0fff54c82913/resource/74c6a8e5-8879-45b3-b884-8a9e58002cf4/download/bdi-rainfall-subnat-full.csv
  format: null
  id: resource_74c6a8e5
  media_type: text/csv
  spatial: null
  ...
  title: bdi-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135423005516_5a6c6ff1'
  download_url: https://data.humdata.org/dataset/b453999a-19e6-4a3a-92ea-0fff54c82913/resource/062749a6-325b-4083-9383-897d744808f1/download/bdi-rainfall-subnat-5ytd.csv
  format: null
  id: resource_062749a6
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: bdi-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bdi_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Burundi: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
