...
- entity:
    ...
    url: https://data.humdata.org/dataset/zimbabwe-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/zimbabwe-road-surface-data
dataset_id: rdls_exp-zwe_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2945 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.016 and 0.0403
  (in million kms), corressponding to 5.4466% and 13.6891% respectively of the total
  road length in the dataset region. 0.2381 million km or 80.8643% of road surface
  ...
  to 0.0321% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/zimbabwe-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    type classification across Zimbabwe, supporting humanitarian access and logistics
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zimbabwe-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Zimbabwe: Road Surface Data (GeoJSON data for Zimbabwe.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_zwe_roadsurface_lines.geojson
  format: null
  id: resource_3bc682d0
  ...
  title: Zimbabwe GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Zimbabwe: Road Surface Data (Geopackage data for Zimbabwe.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_zwe_roadsurface_lines.gpkg
  format: null
  id: resource_92a10cf1
  ...
  temporal: null
  temporal_resolution: null
  title: Zimbabwe GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-zwe_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Zimbabwe: Road Surface Data'
version: null
vulnerability: null
---
