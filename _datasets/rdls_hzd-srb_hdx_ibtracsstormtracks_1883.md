...
- entity:
    ...
    url: https://data.humdata.org/dataset/srb-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/srb-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-srb_hdx_ibtracsstormtracks_1883
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/srb-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Serbia
    subset contains observed cyclone track geometries with ISO timestamps, basin/subbasin
    classifications, wind speed (wmo_wind), and central pressure (wmo_pres) measurements
    extracted for storms affecting or passing through Serbian territory.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/srb-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Serbia.
  download_url: https://data.humdata.org/dataset/c068666b-b336-4bfc-844f-39789c5f9e4d/resource/f2e30ee6-a199-41a8-9c93-1a3c1b2b6799/download/ibtracs_all_list_v04r01_srb.csv
  format: null
  id: resource_f2e30ee6
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SRB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Serbia.
  download_url: https://data.humdata.org/dataset/c068666b-b336-4bfc-844f-39789c5f9e4d/resource/2d55b1d2-082d-4f2e-a865-f06cf3910192/download/ibtracs_all_list_v04r01_lines_srb.geojson
  format: null
  id: resource_2d55b1d2
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SRB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-srb_hdx_ibtracsstormtracks_1883
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1883-08-20'
temporal_resolution: null
title: 'Serbia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
