...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-el-salvador
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-el-salvador
dataset_id: rdls_exp-slv_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-el-salvador]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure database for El Salvador was developed using
    ...
    Kogyo) to estimate the economic value of exposed assets across different sectors.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-el-salvador
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for El Salvador.zip
  download_url: https://data.humdata.org/dataset/a4804569-f044-4a5e-885b-26065c03a9c7/resource/e1f298e5-8109-454a-90fc-ce59384223c0/download/slv.zip
  format: null
  id: resource_e1f298e5
  ...
  title: GAR15 Global Exposure Dataset for El Salvador.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-slv_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for El Salvador
version: null
vulnerability: null
---
