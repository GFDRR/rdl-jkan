...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/ton-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ton-rainfall-subnational
dataset_id: rdls_hzd-ton_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/ton-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from Climate Hazards Group InfraRed Precipitation
    ...
    by subnational administrative units in Tonga to compute dekadal rainfall indicators
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ton-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135833516471_746da71d'
  download_url: https://data.humdata.org/dataset/606de8e5-32ad-46d9-b73c-e6f04011f4fb/resource/7ac6aa74-92d4-4865-88d2-6a42c13b8596/download/ton-rainfall-subnat-full.csv
  format: null
  id: resource_7ac6aa74
  media_type: text/csv
  spatial: null
  ...
  title: ton-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135833516471_746da71d'
  download_url: https://data.humdata.org/dataset/606de8e5-32ad-46d9-b73c-e6f04011f4fb/resource/180301a3-c8e7-42c7-887b-833746e45682/download/ton-rainfall-subnat-5ytd.csv
  format: null
  id: resource_180301a3
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ton-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ton_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Tonga: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
