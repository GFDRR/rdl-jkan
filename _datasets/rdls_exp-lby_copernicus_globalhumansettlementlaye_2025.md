...
- entity:
    ...
    url: https://data.humdata.org/dataset/lby-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/lby-ghsl
dataset_id: rdls_exp-lby_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/lby-ghsl]'
...
lineage:
  description: The GHSL project processes global satellite imagery, census data, and
    crowdsourced geographic information using automated spatial data analytics to
    extract built-up surface extent and gridded population distribution. The Libya
    dataset applies these methodologies to produce fine-scale raster layers of human
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lby-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/263cc489-411d-4973-9689-37285064ebce/resource/eb408d80-cccd-466f-9194-09ea16c602e6/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_lby.tif
  format: null
  id: resource_eb408d80
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Libya: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/263cc489-411d-4973-9689-37285064ebce/resource/fd6a0f20-5e2e-4aaf-86c5-71045f0b1867/download/ghs_pop_e2025_r2023a_54009_100_v1_0_lby.tif
  format: null
  id: resource_fd6a0f20
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-lby_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Libya: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
