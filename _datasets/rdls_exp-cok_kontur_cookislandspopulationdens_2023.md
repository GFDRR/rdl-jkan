...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-cook-islands
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-cook-islands
dataset_id: rdls_exp-cok_kontur_cookislandspopulationdens_2023
description: 'Cook Islands population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-cook-islands]'
...
exposure:
- asset_type:
    description: Population density counts aggregated into 400m H3 hexagonal grid
      cells for Cook Islands, derived from fusion of multiple global and local datasets
    id: population
    scheme: null
    title: null
    uri: null
...
license: CC-BY-4.0
lineage:
  description: The Kontur Population dataset was constructed by overlapping the Global
    Human Settlement Layer (GHSL) with the Facebook High Resolution Settlement Layer
    (HRSL) and Microsoft Buildings footprints, further refined using Copernicus Global
    Land Service Land Cover, Land Information New Zealand, and OpenStreetMap data.
    Population counts were disaggregated and allocated to 400m resolution H3 hexagonal
    grid cells using the H3 Hexagonal Hierarchical Spatial Index. The resulting dataset
    provides a spatially consistent, high-resolution population density surface for
    Cook Islands suitable for exposure analysis in disaster risk assessments.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-cook-islands
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Cook Islands: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CK_20220630.gpkg.gz
  format: null
  id: resource_000ab4ee
  ...
  title: kontur_population_CK_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Cook Islands: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CK_20231101.gpkg.gz
  format: null
  id: resource_e746dc07
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_CK_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cok_kontur_cookislandspopulationdens_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Cook Islands: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
