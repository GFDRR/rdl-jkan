...
- entity:
    ...
    url: https://data.humdata.org/dataset/gnq-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/gnq-ghsl
dataset_id: rdls_exp-gnq_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gnq-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale. For Equatorial Guinea, this
    includes GHS Built-up Surface (structure extent) and GHS Population Grid (population
    density/count) products.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/25e47844-ab9a-4984-80ec-45a3a17b19e5/resource/a79fc764-b7d2-434f-ab4b-1461ca649ad9/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_gnq.tif
  format: null
  id: resource_a79fc764
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Equatorial Guinea: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/25e47844-ab9a-4984-80ec-45a3a17b19e5/resource/e91899c5-79a2-4395-a1d8-9eb3c248cc82/download/ghs_pop_e2025_r2023a_54009_100_v1_0_gnq.tif
  format: null
  id: resource_e91899c5
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gnq_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Equatorial Guinea: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
