...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-ghana
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-ghana
dataset_id: rdls_exp-gha_kontur_populationdensity400mh3he_2023
description: 'Ghana population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-ghana]'
...
lineage:
  description: Population density estimates were generated by fusing multiple satellite-derived
    settlement layers (GHSL, HRSL) with building footprints (Microsoft Buildings)
    and land cover data (Copernicus), then aggregated into 400m H3 hexagonal grid
    cells using the H3 hierarchical spatial indexing system. The resulting dataset
    provides baseline population counts at sub-kilometer resolution for Ghana.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-ghana
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Ghana: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_GH_20220630.gpkg.gz
  format: null
  id: resource_19c72f4d
  ...
  title: kontur_population_GH_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Ghana: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_GH_20231101.gpkg.gz
  format: null
  id: resource_09ed94f1
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_GH_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gha_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Ghana: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
