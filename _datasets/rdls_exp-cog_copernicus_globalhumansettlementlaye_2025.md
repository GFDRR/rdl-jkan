...
- entity:
    ...
    url: https://data.humdata.org/dataset/cog-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cog-ghsl
dataset_id: rdls_exp-cog_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cog-ghsl]'
...
lineage:
  description: 'The GHSL project processes global fine-scale satellite imagery, census
    ...
    to produce gridded estimates of built-up surfaces and population distribution.
    The Congo dataset applies this methodology to generate two raster products: built-up
    surface area and population density grids.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cog-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/dfae5224-4c80-4672-a4ea-3ebb36bf30a3/resource/63a07614-c669-4e41-9564-7e61c4540cb4/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cog.tif
  format: null
  id: resource_63a07614
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Congo: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/dfae5224-4c80-4672-a4ea-3ebb36bf30a3/resource/0bab8fac-9d11-4110-9bc1-cbb6e91e7913/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cog.tif
  format: null
  id: resource_0bab8fac
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cog_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Congo: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
