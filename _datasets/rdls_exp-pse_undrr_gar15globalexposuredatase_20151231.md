...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-palestine-state-of
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-palestine-state-of
dataset_id: rdls_exp-pse_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-palestine-state-of]'
...
lineage:
  description: The GAR15 global exposure database for Palestine was developed using
    ...
    Kogyo) to create a comprehensive spatial inventory of economic and population
    exposure.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-palestine-state-of
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Palestine, State of.zip
  download_url: https://data.humdata.org/dataset/a48cac72-edbb-482b-a894-8d9efa6a95eb/resource/8cc06274-9cd4-4faa-8788-bf26952ee5b1/download/pse.zip
  format: null
  id: resource_8cc06274
  ...
  title: GAR15 Global Exposure Dataset for Palestine, State of.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pse_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Palestine, State of
version: null
vulnerability: null
---
