...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-fra_nismod_sdkicra__corsica
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Corsica. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540017
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540017
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Corsica, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540017/files/FRA.zip
  format: null
  id: resource_sdkicra_fra
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Corsica
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-fra_nismod_sdkicra__corsica
spatial:
  bbox:
  - -109.23
  - -21.37
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3017382/france.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Corsica
version: 0.1.0
vulnerability: null
---
