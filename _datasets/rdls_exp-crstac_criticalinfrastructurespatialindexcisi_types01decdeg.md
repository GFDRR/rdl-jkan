...
creator:
  ...
  name: Zenodo
  url: https://zenodo.org/records/4957647
dataset_id: rdls_exp-crstac_criticalinfrastructurespatialindexcisi_types01decdeg
description: 'CISI infrastructure types at a spatial resolution of 0.1 decimal degrees
...
lineage:
  ...
  - id: source_code_codelink
    ...
    risk_data_type: null
    type: model
    url: https://doi.org/10.5281/zenodo.4819988
    used_in: null
links:
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/exposure-vulnerability/infrastructure/critical-infrastructure-spatial-index-cisi/types-01-dec-deg/types-01-dec-deg.json
  ...
  title: 'STAC Item: Critical Infrastructure Spatial Index (CISI) - Types 0.1 dec
    deg'
- access_url: null
  baseline_period: null
  climate: null
  ...
  description: Critical Infrastructure Spatial Index (CISI) - Types 0.1 dec deg -
    data file
  ...
  temporal: null
  temporal_resolution: null
  title: Critical Infrastructure Spatial Index (CISI) - Types 0.1 dec deg - data file
- access_url: https://doi.org/10.1038/s41597-022-01218-4%C2%A0
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Critical Infrastructure Spatial Index (CISI) - Types 0.1 dec deg (Web
    reference)
  download_url: null
  ...
  temporal_resolution: null
  title: Reference
- access_url: https://doi.org/10.5281/zenodo.4819988
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Critical Infrastructure Spatial Index (CISI) - Types 0.1 dec deg (Code
    link)
  download_url: null
  format: Web reference
...
- exposure
schema: rdls-10
slug: rdls_exp-crstac_criticalinfrastructurespatialindexcisi_types01decdeg
spatial:
  bbox:
  - -180.0
  - -90.0
...
temporal:
  ...
  start: '2021'
temporal_resolution: null
title: Critical Infrastructure Spatial Index (CISI) - Types 0.1 dec deg
version: null
vulnerability: null
---
