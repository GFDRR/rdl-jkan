...
- entity:
    ...
    url: https://data.humdata.org/dataset/nfk-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/nfk-ghsl
dataset_id: rdls_exp-nfk_copernicus_norfolkislandglobalhumans_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/nfk-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    and population distribution. The resulting GeoTIFF rasters represent human settlement
    patterns and population density at global scale with local application to Norfolk
    Island.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nfk-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/2cdbc988-98b6-4979-855a-e287f2bfda16/resource/f4f3946c-146f-4c97-b39e-1c41aba0dcfc/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_nfk.tif
  format: null
  id: resource_f4f3946c
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Norfolk Island: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/2cdbc988-98b6-4979-855a-e287f2bfda16/resource/bcef9a6e-daef-4b3e-b207-a956b7c1c6e2/download/ghs_pop_e2025_r2023a_54009_100_v1_0_nfk.tif
  format: null
  id: resource_bcef9a6e
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-nfk_copernicus_norfolkislandglobalhumans_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Norfolk Island: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
