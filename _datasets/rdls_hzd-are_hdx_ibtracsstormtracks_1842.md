...
- entity:
    ...
    url: https://data.humdata.org/dataset/are-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/are-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-are_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/are-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    UAE subset contains observed storm positions, times, wind speeds (wmo_wind), and
    central pressures (wmo_pres) extracted from the global archive and provided in
    both tabular (CSV) and spatial (GeoJSON) formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/are-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/8ac3bd37-a741-4019-ad5e-47f7edefb474/resource/b3bd6dc6-6ec2-466f-8d8b-fddb37bf8d59/download/ibtracs_all_list_v04r01_are.csv
  format: null
  id: resource_b3bd6dc6
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ARE.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of United Arab Emirates.
  download_url: https://data.humdata.org/dataset/8ac3bd37-a741-4019-ad5e-47f7edefb474/resource/2d750ee6-9844-43bc-b0ef-820df347a917/download/ibtracs_all_list_v04r01_lines_are.geojson
  format: null
  id: resource_2d750ee6
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ARE.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-are_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'United Arab Emirates: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
