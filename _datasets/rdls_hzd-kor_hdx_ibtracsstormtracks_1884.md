...
- entity:
    ...
    url: https://data.humdata.org/dataset/kor-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/kor-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-kor_hdx_ibtracsstormtracks_1884
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kor-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Korea subset contains
    historical and recent storm tracks with ISO-formatted timestamps, basin/subbasin
    classifications, wind speed (wmo_wind), and central pressure (wmo_pres) measurements.
    Data are provided as both tabular CSV and geospatial GeoJSON formats with point
    and line geometries.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kor-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/4397cf04-9cdd-43d9-88ee-825d987c768c/resource/212d5824-5680-4a18-b5ad-25c8a7a0d7a1/download/ibtracs_all_list_v04r01_kor.csv
  format: null
  id: resource_212d5824
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_KOR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1884 to date that pass within 2000 kilometers
    of Republic of Korea.
  download_url: https://data.humdata.org/dataset/4397cf04-9cdd-43d9-88ee-825d987c768c/resource/aba1429b-dec3-4878-8bc9-a93a0027104d/download/ibtracs_all_list_v04r01_lines_kor.geojson
  format: null
  id: resource_aba1429b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_KOR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-kor_hdx_ibtracsstormtracks_1884
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1884-06-24'
temporal_resolution: null
title: 'Republic of Korea: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
