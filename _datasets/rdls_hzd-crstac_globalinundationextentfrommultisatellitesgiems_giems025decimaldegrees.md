...
creator:
  ...
  name: Estellus
  url: https://lerma.obspm.fr/spip.php?article91&lang=fr
dataset_id: rdls_hzd-crstac_globalinundationextentfrommultisatellitesgiems_giems025decimaldegrees
description: 'GIEMS at 0.25 decimal degrees spatial resolution [Source: This metadata
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/hazard/flood/global-inundation-extent-from-multi-satellites-giems/giems-025-decimal-degrees/giems-025-decimal-degrees.json
  ...
  title: 'STAC Item: Global Inundation Extent from Multi-Satellites (GIEMS) - GIEMS
    0.25 decimal degrees'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Global Inundation Extent from Multi-Satellites (GIEMS) - GIEMS 0.25
    decimal degrees - data file
  ...
  temporal: null
  temporal_resolution: null
  title: Global Inundation Extent from Multi-Satellites (GIEMS) - GIEMS 0.25 decimal
    degrees - data file
...
- hazard
schema: rdls-10
slug: rdls_hzd-crstac_globalinundationextentfrommultisatellitesgiems_giems025decimaldegrees
spatial:
  bbox:
  - -180.0
  - -85.0
