...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/ukr-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ukr-rainfall-subnational
dataset_id: rdls_hzd-ukr_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/ukr-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery integrated
    ...
    computed into rolling 1-month and 3-month aggregations with long-term climatological
    averages at subnational administrative units to support drought monitoring and
    early warning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ukr-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135804383851_22b39367'
  download_url: https://data.humdata.org/dataset/0bc83cbf-d00a-48c7-94e2-f9b558385f34/resource/cbd67640-b986-4804-bdfa-cf4582af1783/download/ukr-rainfall-subnat-full.csv
  format: null
  id: resource_cbd67640
  media_type: text/csv
  spatial: null
  ...
  title: ukr-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135804383851_22b39367'
  download_url: https://data.humdata.org/dataset/0bc83cbf-d00a-48c7-94e2-f9b558385f34/resource/d6d76c38-8208-4629-bf38-fa65ad51ef75/download/ukr-rainfall-subnat-5ytd.csv
  format: null
  id: resource_d6d76c38
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ukr-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ukr_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Ukraine: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
