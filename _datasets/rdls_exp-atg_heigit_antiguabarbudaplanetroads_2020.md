...
- entity:
    ...
    url: https://data.humdata.org/dataset/antigua-and-barbuda-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/antigua-and-barbuda-planet-road-surface-data
dataset_id: rdls_exp-atg_heigit_antiguabarbudaplanetroads_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0002 million km (99.6743%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (3.5005%) - PlanetScope predictions cover: 0.0002\
  \ million km (2847.4332%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/antigua-and-barbuda-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Antigua and Barbuda. Deep learning models were applied to PlanetScope satellite
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/antigua-and-barbuda-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Antigua and Barbuda: Planet Road Surface, Width, and Passability Data
    (Geopackage file for Antigua and barbuda)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AG_planet_roadsurface_lines.gpkg
  format: null
  id: resource_ad10c590
  ...
  title: Antigua and barbuda GPKG heigit_AG_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Antigua and Barbuda: Planet Road Surface, Width, and Passability Data
    (GeoJSON file for Antigua and barbuda)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AG_planet_roadsurface_lines.geojson
  format: null
  id: resource_563e896d
  ...
  temporal: null
  temporal_resolution: null
  title: Antigua and barbuda GeoJSON heigit_AG_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-atg_heigit_antiguabarbudaplanetroads_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Antigua and Barbuda: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
