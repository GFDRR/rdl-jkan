...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-lao-people-s-democratic-republic
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-lao-people-s-democratic-republic
dataset_id: rdls_exp-lao_kontur_laopeoplesdemocraticrepub_2023
description: 'Lao People''s Democratic Republic population density for 400m H3 hexagons.
  Built from Kontur Population: Global Population Density for 400m H3 Hexagons Vector
  H3 hexagons with population counts at 400m resolution. Fixed up fusion of GHSL,
  Facebook, Microsoft Buildings, Copernicus Global Land Service Land Cover, Land Information
  New Zealand, and OpenStreetMap data.. [Source: This metadata record was automatically
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-lao-people-s-democratic-republic]'
...
- asset_type:
    description: Population counts aggregated to 400m H3 hexagonal grid cells derived
      from multi-source settlement data fusion
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: Population density was calculated by fusing multiple global datasets
    (GHSL, Facebook HRSL, Microsoft Buildings, Copernicus Land Cover, and OpenStreetMap)
    to create a consolidated settlement layer. Population counts were then aggregated
    to 400m H3 hexagonal grid cells using the H3 hierarchical spatial indexing system,
    providing fine-resolution baseline population distribution for Lao PDR.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-lao-people-s-democratic-republic
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Lao People''s Democratic Republic: Population Density for 400m H3
    Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_LA_20220630.gpkg.gz
  format: null
  id: resource_756ff4be
  ...
  title: kontur_population_LA_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Lao People''s Democratic Republic: Population Density for 400m H3
    Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_LA_20231101.gpkg.gz
  format: null
  id: resource_f2847ef4
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_LA_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lao_kontur_laopeoplesdemocraticrepub_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Lao People''s Democratic Republic: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
