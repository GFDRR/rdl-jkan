...
- entity:
    ...
    url: https://data.humdata.org/dataset/tajikistan-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/tajikistan-road-surface-data
dataset_id: rdls_exp-tjk_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tajikistan-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The resulting dataset provides spatial inventory of road infrastructure by surface
    type, supporting humanitarian access and logistics planning in Tajikistan.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tajikistan-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Tajikistan: Road Surface Data (GeoJSON data for Tajikistan.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tjk_roadsurface_lines.geojson
  format: null
  id: resource_fbfe54ed
  ...
  title: Tajikistan GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Tajikistan: Road Surface Data (Geopackage data for Tajikistan.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tjk_roadsurface_lines.gpkg
  format: null
  id: resource_0d0123a1
  ...
  temporal: null
  temporal_resolution: null
  title: Tajikistan GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tjk_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Tajikistan: Road Surface Data'
version: null
vulnerability: null
---
