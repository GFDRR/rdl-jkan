...
- entity:
    ...
    url: https://data.humdata.org/dataset/dominica-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/dominica-planet-road-surface-data
dataset_id: rdls_exp-dma_heigit_dominicaplanetroadsurface_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0002 million km (76.9388%) - Unpaved roads: 0.0 million km (0.8843%) - Missing\
  \ OSM surface tags: 0.0 million km (16.3491%) - PlanetScope predictions cover: 0.0002\
  \ million km (476.0079%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/dominica-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road surface type, width, and passability were derived by applying
    ...
    primary, secondary classes) in Dominica. A Humanitarian Passability Index was
    computed from the classified road characteristics to support logistics planning
    and humanitarian access assessment.
  sources:
  - id: source_1
    license: null
    name: PlanetScope Satellite Imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dominica-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Dominica: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Dominica)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_DM_planet_roadsurface_lines.gpkg
  format: null
  id: resource_8e0b127a
  ...
  title: Dominica GPKG heigit_DM_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Dominica: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Dominica)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_DM_planet_roadsurface_lines.geojson
  format: null
  id: resource_5bd5ea69
  ...
  temporal: null
  temporal_resolution: null
  title: Dominica GeoJSON heigit_DM_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dma_heigit_dominicaplanetroadsurface_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Dominica: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
