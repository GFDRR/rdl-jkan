...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-kiribati
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-kiribati
dataset_id: rdls_exp-kir_kontur_administrativedivisionagg_20220407
description: 'Kiribati administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-kiribati]'
...
lineage:
  description: Administrative boundaries for Kiribati were extracted from OpenStreetMap
    and enhanced with proprietary methods. Population counts were aggregated from
    the Kontur Population dataset (400m H3 hexagons) to each administrative division,
    and enriched with HASC codes from Wikidata to create a baseline population exposure
    dataset.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-kiribati
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Kiribati: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_KI_20220407.gpkg.gz
  format: null
  id: resource_0f44e64b
  ...
  title: kontur_boundaries_KI_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Kiribati: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_KI_20230628.gpkg.gz
  format: null
  id: resource_0eb7c51b
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_KI_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Kiribati: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_KI_20230628.gpkg.gz
  format: null
  id: resource_4aea7203
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_KI_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kir_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Kiribati: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
