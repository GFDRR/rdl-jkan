...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-luxembourg
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-luxembourg
dataset_id: rdls_exp-lux_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-luxembourg]'
...
lineage:
  description: National-level socio-economic and building stock statistics were transposed
    ...
    proxies. The GAR15 global exposure database was developed by UNEP-GRID in collaboration
    with WAPMERR, EU JRC, and Kokusai Kogyo to create a spatially-explicit inventory
    of economic assets and population exposure for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-luxembourg
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Luxembourg.zip
  download_url: https://data.humdata.org/dataset/c526a692-b2b1-4182-808e-629d506e2b01/resource/5a31e382-519b-4cb9-97f9-81238393f64d/download/lux.zip
  format: null
  id: resource_5a31e382
  ...
  title: GAR15 Global Exposure Dataset for Luxembourg.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lux_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Luxembourg
version: null
vulnerability: null
---
