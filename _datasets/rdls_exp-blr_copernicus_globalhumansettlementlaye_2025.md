...
- entity:
    ...
    url: https://data.humdata.org/dataset/blr-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/blr-ghsl
dataset_id: rdls_exp-blr_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/blr-ghsl]'
...
lineage:
  description: The GHSL dataset combines global fine-scale satellite imagery, census
    data, and volunteered geographic information processed through automated spatial
    data analytics to produce gridded estimates of built-up surfaces and population
    distribution at national scale for Belarus.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/blr-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/c8789e7c-7c06-4bfc-a48f-c7957cc0a1ba/resource/93883f9f-e6c2-4a59-aec6-e3abd393c2bc/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_blr.tif
  format: null
  id: resource_93883f9f
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Belarus: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/c8789e7c-7c06-4bfc-a48f-c7957cc0a1ba/resource/ea22f4fc-f071-4cf3-b4d7-e7f1bb514936/download/ghs_pop_e2025_r2023a_54009_100_v1_0_blr.tif
  format: null
  id: resource_ea22f4fc
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-blr_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Belarus: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
