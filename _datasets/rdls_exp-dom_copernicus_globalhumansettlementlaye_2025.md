...
- entity:
    ...
    url: https://data.humdata.org/dataset/dom-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/dom-ghsl
dataset_id: rdls_exp-dom_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/dom-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    data, and crowdsourced geographic information using automated spatial data analytics
    to extract built-up surface extent and gridded population distribution. The Dominican
    Republic subset provides rasterized exposure data at national scale derived from
    this multi-source integration.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dom-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/6dcfbe95-44eb-4f78-aa3d-5bd6ee9185cf/resource/51c97299-e087-42c8-bc1e-7962ff4f4fd9/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_dom.tif
  format: null
  id: resource_51c97299
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Dominican Republic: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/6dcfbe95-44eb-4f78-aa3d-5bd6ee9185cf/resource/2bad3fb0-2f03-4c5b-ad0a-245f15f73ec9/download/ghs_pop_e2025_r2023a_54009_100_v1_0_dom.tif
  format: null
  id: resource_2bad3fb0
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-dom_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Dominican Republic: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
