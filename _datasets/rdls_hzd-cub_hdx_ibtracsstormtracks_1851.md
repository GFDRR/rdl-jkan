...
- entity:
    ...
    url: https://data.humdata.org/dataset/cub-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/cub-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-cub_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cub-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Cuba subset contains observed storm tracks with ISO-formatted timestamps,
    basin/subbasin classifications, wind speed (wmo_wind), and pressure (wmo_pres)
    measurements at point locations and as line geometries.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cub-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Cuba: IBTrACS Storm Tracks (IBTrACS storm tracks from 1851 to date
    that pass within 2000 kilometers of Cuba.)'
  download_url: https://data.humdata.org/dataset/99914ca4-1d23-4212-9afd-e480bda10eb9/resource/fa61b7c3-5bfa-4702-bf37-4632aae21eec/download/ibtracs_all_list_v04r01_cub.csv
  format: null
  id: resource_fa61b7c3
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CUB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Cuba: IBTrACS Storm Tracks (IBTrACS storm tracks from 1851 to date
    that pass within 2000 kilometers of Cuba.)'
  download_url: https://data.humdata.org/dataset/99914ca4-1d23-4212-9afd-e480bda10eb9/resource/a7dda002-0644-4903-b340-1644b1efbd4c/download/ibtracs_all_list_v04r01_lines_cub.geojson
  format: null
  id: resource_a7dda002
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CUB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cub_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
