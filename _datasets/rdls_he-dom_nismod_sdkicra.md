...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-dom_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Dominican Republic. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796711
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796711
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Dominican Republic, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/10796711/files/DOM.zip
  format: null
  id: resource_sdkicra_dom
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Dominican
    Republic
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-dom_nismod_sdkicra
spatial:
  bbox:
  - -72.01
  - 17.55
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3508796/dominican-republic.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Dominican
  Republic
version: 0.1.0
vulnerability: null
---
