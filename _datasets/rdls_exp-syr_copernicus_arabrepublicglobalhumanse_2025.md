...
- entity:
    ...
    url: https://data.humdata.org/dataset/syr-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/syr-ghsl
dataset_id: rdls_exp-syr_copernicus_arabrepublicglobalhumanse_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/syr-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale. The resulting GeoTIFF rasters
    represent spatial inventories of buildings and population for exposure assessment
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/syr-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/3fa4e3c6-eef4-490d-946b-ab0ada27f773/resource/d0dd663d-e05b-4906-8f10-9197ca77be5d/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_syr.tif
  format: null
  id: resource_d0dd663d
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Syrian Arab Republic: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/3fa4e3c6-eef4-490d-946b-ab0ada27f773/resource/ca9d6888-bc5b-4f32-be7a-a2437228cee6/download/ghs_pop_e2025_r2023a_54009_100_v1_0_syr.tif
  format: null
  id: resource_ca9d6888
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-syr_copernicus_arabrepublicglobalhumanse_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Syrian Arab Republic: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
