...
- entity:
    ...
    url: https://data.humdata.org/dataset/idn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/idn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-idn_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/idn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges tropical cyclone best-track data from multiple national
    ...
    and standardized to create consistent storm track records with wind speed (wmo_wind)
    and pressure (wmo_pres) measurements at regular time intervals. The Indonesia
    subset filters global IBTrACS records to storms affecting the Indonesian basin
    and sub-basins.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/idn-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Indonesia.
  download_url: https://data.humdata.org/dataset/a7c709e5-79ae-4c7d-a663-3c9b97165fab/resource/19391783-75fc-4764-a8ca-db1404c37de6/download/ibtracs_all_list_v04r01_idn.csv
  format: null
  id: resource_19391783
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_IDN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Indonesia.
  download_url: https://data.humdata.org/dataset/a7c709e5-79ae-4c7d-a663-3c9b97165fab/resource/83e8f675-a6f4-44c4-a269-9c3299948826/download/ibtracs_all_list_v04r01_lines_idn.geojson
  format: null
  id: resource_83e8f675
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_IDN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-idn_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Indonesia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
