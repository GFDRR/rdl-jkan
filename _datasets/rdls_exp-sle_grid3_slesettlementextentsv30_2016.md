...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-sle-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-sle-settlement-extents-v3-0
dataset_id: rdls_exp-sle_grid3_slesettlementextentsv30_2016
description: 'The GRID3 SLE - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Sierra Leone, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Sierra Leone Settlement Extents,
  ...
  2024. GRID3 SLE - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-sle-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents and building counts were derived from open data
    ...
    estimates with settlement boundary delineation to provide spatial representation
    of populated areas and structures across Sierra Leone.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-sle-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Sierra Leone - GRID3 SLE - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/3722fe7f-b837-4d45-a1b8-4410e365f4ce/resource/a1353251-b415-4b28-8205-0f164c2790df/download/grid3-sle-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_a1353251
  ...
  title: GRID3 SLE - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Sierra Leone - GRID3 SLE - Settlement Extents v3.0 (A spatial layer
    representing settlement polygons)
  download_url: https://data.humdata.org/dataset/3722fe7f-b837-4d45-a1b8-4410e365f4ce/resource/2871f6f3-41e7-418c-aacb-e3ff110c1efa/download/grid3_sle_settlement_extents_v3_0.zip
  format: null
  id: resource_2871f6f3
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_SLE_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/3722fe7f-b837-4d45-a1b8-4410e365f4ce/resource/fe19d169-f1d8-42b2-8042-927f33da4f8a/download/grid3_sle_settlement_grid_v3_0.zip
  format: null
  id: resource_fe19d169
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_SLE_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sle_grid3_slesettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Sierra Leone - GRID3 SLE - Settlement Extents v3.0
version: null
vulnerability: null
---
