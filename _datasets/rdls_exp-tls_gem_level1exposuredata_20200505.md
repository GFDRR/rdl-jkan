...
- entity:
    ...
    url: https://data.humdata.org/dataset/timor-leste-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/timor-leste-level-1-exposure-data
dataset_id: rdls_exp-tls_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/timor-leste-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was generated through the METEOR project methodology
    ...
    provides gridded estimates of building count, area, and rebuilding value at 15-arcsecond
    resolution (~500m) across Timor-Leste, designed for catastrophe modeling and loss
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/timor-leste-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Timor-Leste produced by
    ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/15cbad73-fcfb-42a6-ab98-b5bcd9139fd5/resource/925441e2-9b2a-40fb-a6f8-cd7eae840532/download/tls_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_925441e2
  ...
  title: TLS_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tls_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Timor-Leste: Level 1 Exposure Data'
version: null
vulnerability: null
---
