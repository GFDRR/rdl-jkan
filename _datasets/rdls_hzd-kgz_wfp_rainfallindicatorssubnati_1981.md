...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/kgz-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/kgz-rainfall-subnational
dataset_id: rdls_hzd-kgz_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/kgz-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    units into dekadal indicators including 10-day totals, 1-month and 3-month rolling
    aggregations, and anomalies relative to long-term climatological averages to support
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kgz-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135536464894_e467f6d6'
  download_url: https://data.humdata.org/dataset/f178de8a-727e-4aa6-a1fa-9377d2456656/resource/0a4c1072-b0fb-4754-918e-3694b8b5c771/download/kgz-rainfall-subnat-full.csv
  format: null
  id: resource_0a4c1072
  media_type: text/csv
  spatial: null
  ...
  title: kgz-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135536464894_e467f6d6'
  download_url: https://data.humdata.org/dataset/f178de8a-727e-4aa6-a1fa-9377d2456656/resource/ffe5bcfd-9b4a-494b-9b4c-b7c5f644b023/download/kgz-rainfall-subnat-5ytd.csv
  format: null
  id: resource_ffe5bcfd
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kgz-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-kgz_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Kyrgyzstan: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
