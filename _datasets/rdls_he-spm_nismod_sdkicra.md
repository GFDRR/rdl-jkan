...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-spm_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Saint Pierre and Miquelon. Derived from
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796701
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796701
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Saint Pierre and Miquelon, clipped from global sources. Contents: (1) Hazard -
  ...
  download_url: https://zenodo.org/records/10796701/files/SPM.zip
  format: null
  id: resource_sdkicra_spm
...
- exposure
schema: rdls-10
slug: rdls_he-spm_nismod_sdkicra
spatial:
  bbox:
  - -56.4
  - 46.75
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3424932/saint-pierre-and-miquelon.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Saint Pierre
  and Miquelon
version: 0.1.0
vulnerability: null
---
