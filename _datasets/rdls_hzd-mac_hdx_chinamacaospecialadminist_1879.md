...
- entity:
    ...
    url: https://data.humdata.org/dataset/mac-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mac-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mac_hdx_chinamacaospecialadminist_1879
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mac-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The data for Macao SAR includes historical
    and recent storm tracks with ISO-formatted timestamps, basin/sub-basin classifications,
    wind speed (wmo_wind), and central pressure (wmo_pres) measurements, provided
    in both tabular CSV and geospatial GeoJSON formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mac-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1879 to date that pass within 2000 kilometers
    of China, Macao Special Administrative Region.
  download_url: https://data.humdata.org/dataset/5ec7f3d7-860f-4d63-9516-abc5c591e828/resource/4023842b-0e2c-4883-937c-4d52a38e8bb6/download/ibtracs_all_list_v04r01_mac.csv
  format: null
  id: resource_4023842b
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MAC.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1879 to date that pass within 2000 kilometers
    of China, Macao Special Administrative Region.
  download_url: https://data.humdata.org/dataset/5ec7f3d7-860f-4d63-9516-abc5c591e828/resource/9c048bea-594a-4d45-92e8-508d2c24614a/download/ibtracs_all_list_v04r01_lines_mac.geojson
  format: null
  id: resource_9c048bea
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MAC.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mac_hdx_chinamacaospecialadminist_1879
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1879-10-11'
temporal_resolution: null
title: 'China, Macao Special Administrative Region: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
