...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-timor-leste
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-timor-leste
dataset_id: rdls_exp-tls_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-timor-leste]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Timor-Leste were spatially disaggregated using a top-down approach onto 5x5
    km and 1x1 km grids, with geographic population density and GDP distributions
    used as spatial proxies. The dataset was developed by UNEP-GRID in collaboration
    with WAPMERR, EU JRC, and Kokusai Kogyo as part of the GAR15 global exposure database
    initiative.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-timor-leste
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Timor-Leste.zip
  download_url: https://data.humdata.org/dataset/d0b6f5d1-cd1d-404c-93bc-46bc4cd14891/resource/7a49b43f-857c-40be-8d1d-0c358a642b47/download/tls.zip
  format: null
  id: resource_7a49b43f
  ...
  title: GAR15 Global Exposure Dataset for Timor-Leste.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tls_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Timor-Leste
version: null
vulnerability: null
---
