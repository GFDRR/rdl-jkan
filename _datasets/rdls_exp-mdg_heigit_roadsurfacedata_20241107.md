...
- entity:
    ...
    url: https://data.humdata.org/dataset/madagascar-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/madagascar-road-surface-data
dataset_id: rdls_exp-mdg_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.5261 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0059 and 0.0688
  (in million kms), corressponding to 1.113% and 13.0681% respectively of the total
  road length in the dataset region. 0.4515 million km or 85.8189% of road surface
  ...
  to 0.0791% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/madagascar-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated surface type predictions for approximately 0.5261 million
    km of mapped roads in Madagascar, producing geospatial outputs in GeoJSON and
    GeoPackage formats.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/madagascar-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Madagascar: Road Surface Data (GeoJSON data for Madagascar.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_mdg_roadsurface_lines.geojson
  format: null
  id: resource_ec5b2694
  ...
  title: Madagascar GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Madagascar: Road Surface Data (Geopackage data for Madagascar.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_mdg_roadsurface_lines.gpkg
  format: null
  id: resource_40f831e0
  ...
  temporal: null
  temporal_resolution: null
  title: Madagascar GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mdg_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Madagascar: Road Surface Data'
version: null
vulnerability: null
---
