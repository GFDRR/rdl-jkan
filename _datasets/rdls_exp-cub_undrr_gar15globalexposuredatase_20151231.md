...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cuba
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cuba
dataset_id: rdls_exp-cub_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cuba]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure database for Cuba was developed using a top-down
    ...
    inputs from UNEP-GRID, WAPMERR, EU JRC, and Kokusai Kogyo to create a comprehensive
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cuba
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Cuba.zip
  download_url: https://data.humdata.org/dataset/e07002e8-8939-43a1-88a5-f2f0ac1021e3/resource/b80c6829-b999-4726-be91-e29b8aa5061c/download/cub.zip
  format: null
  id: resource_b80c6829
  ...
  title: GAR15 Global Exposure Dataset for Cuba.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cub_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Cuba
version: null
vulnerability: null
---
