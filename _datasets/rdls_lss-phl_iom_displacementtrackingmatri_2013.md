...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/phl-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/phl-iom-dtm-from-api
dataset_id: rdls_lss-phl_iom_displacementtrackingmatri_2013
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/phl-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced persons across administrative
    levels in the Philippines. Data is aggregated by displacement reason, demographics
    (sex), and origin location, then published via the DTM API for humanitarian and
    research use.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/phl-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Philippines IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/b796d2f7-2a76-4326-a37d-48a82c3761e7/resource/9fe9ea7d-e163-401f-89d5-34bd70390eae/download/phl-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_9fe9ea7d
  media_type: text/csv
  spatial: null
  ...
  title: Philippines IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-phl_iom_displacementtrackingmatri_2013
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2013-11-30'
temporal_resolution: null
title: Philippines IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
