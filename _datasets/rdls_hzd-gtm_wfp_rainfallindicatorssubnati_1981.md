...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/gtm-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/gtm-rainfall-subnational
dataset_id: rdls_hzd-gtm_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/gtm-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with in-situ rain gauge measurements, then aggregated into dekadal indicators
    (10-day, 1-month, 3-month rolling totals) at subnational administrative units
    in Guatemala. Indicators include absolute rainfall amounts and anomalies relative
    to long-term averages, supporting meteorological drought monitoring and early
    warning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gtm-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135517518281_f7fdf45a'
  download_url: https://data.humdata.org/dataset/3102d9d7-931c-498b-a957-b698fcb6be67/resource/ddb40804-da54-4967-b3ed-aec6ff61ea23/download/gtm-rainfall-subnat-full.csv
  format: null
  id: resource_ddb40804
  media_type: text/csv
  spatial: null
  ...
  title: gtm-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135517518281_f7fdf45a'
  download_url: https://data.humdata.org/dataset/3102d9d7-931c-498b-a957-b698fcb6be67/resource/0954b127-0c1f-43dd-b89c-65a70f4d76f0/download/gtm-rainfall-subnat-5ytd.csv
  format: null
  id: resource_0954b127
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: gtm-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gtm_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Guatemala: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
