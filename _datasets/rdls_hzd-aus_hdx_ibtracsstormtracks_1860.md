...
- entity:
    ...
    url: https://data.humdata.org/dataset/aus-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/aus-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-aus_hdx_ibtracsstormtracks_1860
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/aus-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges tropical cyclone best-track data from multiple national
    ...
    and standardized to create consistent storm track records with associated wind
    speed (wmo_wind) and pressure (wmo_pres) measurements for Australia region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/aus-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1860 to date that pass within 2000 kilometers
    of Australia.
  download_url: https://data.humdata.org/dataset/e0de2b39-b4af-42cd-b2bd-9e31e34b6d3c/resource/e54a3e3f-17d8-4267-a8fb-55226d8cf8ed/download/ibtracs_all_list_v04r01_aus.csv
  format: null
  id: resource_e54a3e3f
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_AUS.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1860 to date that pass within 2000 kilometers
    of Australia.
  download_url: https://data.humdata.org/dataset/e0de2b39-b4af-42cd-b2bd-9e31e34b6d3c/resource/395faccc-e854-4b3d-b415-16b4462a6cdf/download/ibtracs_all_list_v04r01_lines_aus.geojson
  format: null
  id: resource_395faccc
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_AUS.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-aus_hdx_ibtracsstormtracks_1860
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1860-02-21'
temporal_resolution: null
title: 'Australia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
