...
- entity:
    ...
    url: https://data.humdata.org/dataset/tza-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/tza-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-tza_hdx_unitedrepublicibtracsstor_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tza-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Tanzania subset contains observed storm positions,
    wind speeds (wmo_wind), central pressures (wmo_pres), and storm classification
    (nature) extracted from the global archive and filtered for geographic relevance.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tza-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/692df57c-4fb6-4155-852f-b7342ad73662/resource/45a6aa30-a34c-4076-855c-84cb9593f74f/download/ibtracs_all_list_v04r01_tza.csv
  format: null
  id: resource_45a6aa30
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_TZA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of United Republic of Tanzania.
  download_url: https://data.humdata.org/dataset/692df57c-4fb6-4155-852f-b7342ad73662/resource/f11adea9-e3ac-4333-8e58-341d48d0770a/download/ibtracs_all_list_v04r01_lines_tza.geojson
  format: null
  id: resource_f11adea9
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_TZA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tza_hdx_unitedrepublicibtracsstor_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'United Republic of Tanzania: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
