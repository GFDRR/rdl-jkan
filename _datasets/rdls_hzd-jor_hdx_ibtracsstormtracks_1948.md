...
- entity:
    ...
    url: https://data.humdata.org/dataset/jor-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/jor-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-jor_hdx_ibtracsstormtracks_1948
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/jor-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Jordan subset contains observed storm positions, times, wind speeds (wmo_wind),
    and central pressures (wmo_pres) extracted from the global archive and filtered
    for the Jordan region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/jor-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1948 to date that pass within 2000 kilometers
    of Jordan.
  download_url: https://data.humdata.org/dataset/b5a1e8e2-4086-43eb-80f4-d53d7b28f172/resource/5679211a-b077-4171-928e-936b572f7bda/download/ibtracs_all_list_v04r01_jor.csv
  format: null
  id: resource_5679211a
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_JOR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1948 to date that pass within 2000 kilometers
    of Jordan.
  download_url: https://data.humdata.org/dataset/b5a1e8e2-4086-43eb-80f4-d53d7b28f172/resource/08f810d0-dca2-43bb-a15b-3fed7d720ece/download/ibtracs_all_list_v04r01_lines_jor.geojson
  format: null
  id: resource_08f810d0
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_JOR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-jor_hdx_ibtracsstormtracks_1948
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1948-10-19'
temporal_resolution: null
title: 'Jordan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
