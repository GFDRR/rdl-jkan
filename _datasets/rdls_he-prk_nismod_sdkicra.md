...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-prk_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for North Korea. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539718
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539718
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    North Korea, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16539718/files/PRK.zip
  format: null
  id: resource_sdkicra_prk
...
- exposure
schema: rdls-10
slug: rdls_he-prk_nismod_sdkicra
spatial:
  bbox:
  - 124.21
  - 37.68
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/1873107/north-korea.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for North Korea
version: 0.1.0
vulnerability: null
---
