...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/lka-iom-dtm-from-api
dataset_id: rdls_lss-lka_iom_displacementtrackingmatri_2017
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/lka-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through baseline assessments, emergency
    tracking tools, and site assessments across administrative levels in Sri Lanka.
    Data is aggregated by displacement reason, demographics (males/females), and origin
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lka-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Sri Lanka IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/d2866c30-f544-4ba5-9539-5f07b33023d7/resource/b42ef748-b2ba-432c-931a-e514ccbba596/download/lka-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_b42ef748
  media_type: text/csv
  spatial: null
  ...
  title: Sri Lanka IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-lka_iom_displacementtrackingmatri_2017
spatial:
  bbox: null
  centroid: null
  countries:
