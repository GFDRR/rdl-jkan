...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/moz-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/moz-rainfall-subnational
dataset_id: rdls_hzd-moz_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    in Mozambique. Long-term averages and quantile-based anomalies were computed to
    characterize meteorological drought conditions.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/moz-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135806235132_b20f6140'
  download_url: https://data.humdata.org/dataset/641a9118-4488-49e7-a0c6-efe9dc567987/resource/bfcfd7af-4846-42b6-9105-851598e461d5/download/moz-rainfall-subnat-full.csv
  format: null
  id: resource_bfcfd7af
  media_type: text/csv
  spatial: null
  ...
  title: moz-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135806235132_b20f6140'
  download_url: https://data.humdata.org/dataset/641a9118-4488-49e7-a0c6-efe9dc567987/resource/225ec84e-a54f-4081-8246-5fd491fe8897/download/moz-rainfall-subnat-5ytd.csv
  format: null
  id: resource_225ec84e
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: moz-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-moz_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Mozambique: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
