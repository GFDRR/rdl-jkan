...
- entity:
    ...
    url: https://data.humdata.org/dataset/nld-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/nld-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-nld_hdx_kingdomibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nld-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The Netherlands subset contains historical
    and recent cyclone tracks with ISO-formatted timestamps, basin/subbasin classifications,
    wind speed (wmo_wind), and pressure (wmo_pres) measurements at observation points,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nld-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Netherlands (Kingdom of the).
  download_url: https://data.humdata.org/dataset/fa6802f9-69f4-4807-8d42-78dac2b0e2e6/resource/7072609e-4adc-4945-805d-5cc58ee5288a/download/ibtracs_all_list_v04r01_nld.csv
  format: null
  id: resource_7072609e
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NLD.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Netherlands (Kingdom of the).
  download_url: https://data.humdata.org/dataset/fa6802f9-69f4-4807-8d42-78dac2b0e2e6/resource/9725e886-6249-4df1-8d59-873ca31cc15b/download/ibtracs_all_list_v04r01_lines_nld.geojson
  format: null
  id: resource_9725e886
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NLD.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nld_hdx_kingdomibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Netherlands (Kingdom of the): IBTrACS Storm Tracks'
version: null
vulnerability: null
---
