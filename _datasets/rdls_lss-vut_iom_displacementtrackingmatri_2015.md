...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/vut-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/vut-iom-dtm-from-api
dataset_id: rdls_lss-vut_iom_displacementtrackingmatri_2015
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/vut-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through baseline assessments, emergency
    tracking tools, and site assessments across Vanuatu, aggregating internally displaced
    person counts by administrative level, displacement reason, and demographic characteristics
    (sex). Data is accessed via the publicly available DTM API and represents non-sensitive
    IDP figures at admin 0-2 levels.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vut-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Vanuatu IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/3a434fed-4732-48cd-b002-e5c5553f8a85/resource/81b1980c-66d7-4bb7-8632-4f66012743cd/download/vut-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_81b1980c
  media_type: text/csv
  spatial: null
  ...
  title: Vanuatu IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-vut_iom_displacementtrackingmatri_2015
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-03-01'
temporal_resolution: null
title: Vanuatu IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
