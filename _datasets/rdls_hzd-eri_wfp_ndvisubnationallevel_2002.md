...
- entity:
    ...
    url: https://data.humdata.org/dataset/eri-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/eri-ndvi-subnational
dataset_id: rdls_hzd-eri_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/eri-ndvi-subnational]'
...
lineage:
  description: MODIS Aqua and Terra 16-day composite products (MYD13C1 and MOD13C1)
    ...
    units with Pcode identifiers to create a time-series vegetation monitoring dataset
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/eri-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135513131239_10ff160b'
  download_url: https://data.humdata.org/dataset/ef661cdd-6bbc-469c-b4a0-7bc62fd23c4d/resource/c2ab78d6-7b88-4b95-a602-5d828878599f/download/eri-ndvi-subnat-full.csv
  format: null
  id: resource_c2ab78d6
  media_type: text/csv
  spatial: null
  ...
  title: eri-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135513131239_10ff160b'
  download_url: https://data.humdata.org/dataset/ef661cdd-6bbc-469c-b4a0-7bc62fd23c4d/resource/124d117f-2c79-422f-a994-fa18dc046696/download/eri-ndvi-subnat-5ytd.csv
  format: null
  id: resource_124d117f
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: eri-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-eri_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Eritrea: NDVI at Subnational Level'
version: null
vulnerability: null
---
