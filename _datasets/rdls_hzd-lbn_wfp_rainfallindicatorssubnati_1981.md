...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/lbn-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/lbn-rainfall-subnational
dataset_id: rdls_hzd-lbn_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/lbn-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    ...
    sums and anomalies) at subnational administrative units in Lebanon to support
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lbn-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135542133702_ccdddc1c'
  download_url: https://data.humdata.org/dataset/e1e43579-ea0c-4d78-8126-e798f551cce0/resource/fed0a260-0fd7-442b-9399-55f45aa3f362/download/lbn-rainfall-subnat-full.csv
  format: null
  id: resource_fed0a260
  media_type: text/csv
  spatial: null
  ...
  title: lbn-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135542133702_ccdddc1c'
  download_url: https://data.humdata.org/dataset/e1e43579-ea0c-4d78-8126-e798f551cce0/resource/eb7aac59-de02-45e6-b9de-ea37a22f9521/download/lbn-rainfall-subnat-5ytd.csv
  format: null
  id: resource_eb7aac59
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: lbn-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lbn_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Lebanon: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
