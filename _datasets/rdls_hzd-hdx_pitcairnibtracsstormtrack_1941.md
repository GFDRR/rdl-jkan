...
- entity:
    ...
    url: https://data.humdata.org/dataset/pcn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/pcn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-hdx_pitcairnibtracsstormtrack_1941
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/pcn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset using a standardized
    algorithm to assign unique storm identifiers. Track data includes ISO-timestamped
    positions, basin/sub-basin classifications, wind speed (WMO), and central pressure
    measurements for each observation point along the cyclone path.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pcn-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1941 to date that pass within 2000 kilometers
    of Pitcairn.
  download_url: https://data.humdata.org/dataset/1f265ab0-b3bd-4f4f-aff0-818d38d6caf9/resource/92b4e481-c024-48b2-828f-2e883155f2cf/download/ibtracs_all_list_v04r01_pcn.csv
  format: null
  id: resource_92b4e481
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PCN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1941 to date that pass within 2000 kilometers
    of Pitcairn.
  download_url: https://data.humdata.org/dataset/1f265ab0-b3bd-4f4f-aff0-818d38d6caf9/resource/010a3301-5978-4aca-82b4-831a64a84bfe/download/ibtracs_all_list_v04r01_lines_pcn.geojson
  format: null
  id: resource_010a3301
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PCN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-hdx_pitcairnibtracsstormtrack_1941
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1941-02-26'
temporal_resolution: null
title: 'Pitcairn: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
