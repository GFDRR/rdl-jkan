...
- entity:
    ...
    url: https://data.humdata.org/dataset/khm-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/khm-ghsl
dataset_id: rdls_exp-khm_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/khm-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale, with Cambodia-specific extraction
    provided here.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/khm-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/c1afc767-a360-4910-86c5-42b0db433514/resource/75969da0-83c9-4d5e-b22a-1a1bf26a0865/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_khm.tif
  format: null
  id: resource_75969da0
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Cambodia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/c1afc767-a360-4910-86c5-42b0db433514/resource/6fe06e84-47cc-4013-a501-92763052797c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_khm.tif
  format: null
  id: resource_6fe06e84
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-khm_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Cambodia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
