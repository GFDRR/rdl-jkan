...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-vnm_nismod_sdkicra__spratly-islands
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Spratly Islands. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796609
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796609
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Spratly Islands, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/10796609/files/VNM.zip
  format: null
  id: resource_sdkicra_vnm
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Spratly
    Islands
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-vnm_nismod_sdkicra__spratly-islands
spatial:
  bbox:
  - 102.12
  - 8.57
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/1562822/vietnam.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Spratly Islands
version: 0.1.0
vulnerability: null
---
