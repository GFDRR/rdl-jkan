...
- entity:
    ...
    url: https://data.humdata.org/dataset/egy-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/egy-ghsl
dataset_id: rdls_exp-egy_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/egy-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. The resulting GeoTIFF rasters represent human settlement patterns
    at global scale with application to disaster risk exposure assessment.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/egy-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/3991619c-8a73-4517-ad8b-a24ba0ccba82/resource/a48fa044-a56c-4f98-b36a-df7d3f6c9cbe/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_egy.tif
  format: null
  id: resource_a48fa044
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Egypt: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/3991619c-8a73-4517-ad8b-a24ba0ccba82/resource/2f1daaa0-d62a-47f4-bdc0-debf8c10fc85/download/ghs_pop_e2025_r2023a_54009_100_v1_0_egy.tif
  format: null
  id: resource_2f1daaa0
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-egy_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Egypt: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
