...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-french-polynesia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-french-polynesia
dataset_id: rdls_exp-pyf_kontur_frenchpolynesiapopulation_2023
description: 'French Polynesia population density for 400m H3 hexagons. Built from
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-french-polynesia]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    and OpenStreetMap) and aggregating the results into H3 hexagonal grid cells at
    400m resolution. The Kontur Population dataset methodology overlays these diverse
    data sources to produce harmonized population counts for French Polynesia, providing
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-french-polynesia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'French Polynesia: Population Density for 400m H3 Hexagons (Release
    2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PF_20220630.gpkg.gz
  format: null
  id: resource_445fa57a
  ...
  title: kontur_population_PF_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'French Polynesia: Population Density for 400m H3 Hexagons (Release
    2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_PF_20231101.gpkg.gz
  format: null
  id: resource_e5bae3dc
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_PF_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-pyf_kontur_frenchpolynesiapopulation_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'French Polynesia: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
