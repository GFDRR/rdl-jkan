...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ethiopia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ethiopia
dataset_id: rdls_exp-eth_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ethiopia]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    and GDP distribution as spatial proxies. The dataset was developed by UNEP-GRID
    for the Global Assessment Report on Disaster Risk Reduction (GAR15) through multi-agency
    collaboration to create a globally consistent exposure database for Ethiopia.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ethiopia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Ethiopia.zip
  download_url: https://data.humdata.org/dataset/7d14aeab-2a52-405c-b7cb-e3d7f91768b7/resource/213415eb-c4ed-46b8-901c-cc6b98af7b6d/download/eth.zip
  format: null
  id: resource_213415eb
  ...
  title: GAR15 Global Exposure Dataset for Ethiopia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-eth_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Ethiopia
version: null
vulnerability: null
---
