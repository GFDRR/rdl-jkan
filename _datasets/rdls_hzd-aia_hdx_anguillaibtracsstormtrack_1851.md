...
- entity:
    ...
    url: https://data.humdata.org/dataset/aia-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/aia-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-aia_hdx_anguillaibtracsstormtrack_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/aia-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Anguilla subset contains observed storm positions, times, basin classifications,
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/aia-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Anguilla.
  download_url: https://data.humdata.org/dataset/72b296cf-1eb7-4237-a481-3d5a0b01cbac/resource/61237a79-83d7-4afd-939d-2fab00d3e3b2/download/ibtracs_all_list_v04r01_aia.csv
  format: null
  id: resource_61237a79
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_AIA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Anguilla.
  download_url: https://data.humdata.org/dataset/72b296cf-1eb7-4237-a481-3d5a0b01cbac/resource/7d48d629-2097-427a-af44-99cbbd6e5a1f/download/ibtracs_all_list_v04r01_lines_aia.geojson
  format: null
  id: resource_7d48d629
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_AIA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-aia_hdx_anguillaibtracsstormtrack_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Anguilla: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
