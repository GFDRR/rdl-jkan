...
- entity:
    ...
    url: https://data.humdata.org/dataset/democratic-peoples-republic-of-korea-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/democratic-peoples-republic-of-korea-road-surface-data
dataset_id: rdls_exp-prk_heigit_democraticpeoplesrepublic_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/democratic-peoples-republic-of-korea-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    for Democratic People's Republic of Korea. A hybrid deep learning model was applied
    to classify road surfaces as paved or unpaved, generating predictions for approximately
    0.1183 million km of mapped roads. The resulting dataset combines OSM-derived
    and AI-predicted surface classifications to provide comprehensive infrastructure
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/democratic-peoples-republic-of-korea-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Democratic People''s Republic of Korea: Road Surface Data (GeoJSON
    data for Democratic people''s republic of korea.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_prk_roadsurface_lines.geojson
  format: null
  id: resource_86bfa80d
  ...
  title: Democratic people's republic of korea GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Democratic People''s Republic of Korea: Road Surface Data (Geopackage
    data for Democratic people''s republic of korea.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_prk_roadsurface_lines.gpkg
  format: null
  id: resource_d3fb9a19
  ...
  temporal: null
  temporal_resolution: null
  title: Democratic people's republic of korea GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-prk_heigit_democraticpeoplesrepublic_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Democratic People''s Republic of Korea: Road Surface Data'
version: null
vulnerability: null
---
