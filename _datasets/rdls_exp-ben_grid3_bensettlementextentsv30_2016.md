...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-ben-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-ben-settlement-extents-v3-0
dataset_id: rdls_exp-ben_grid3_bensettlementextentsv30_2016
description: 'The GRID3 BEN - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Benin, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Benin Settlement Extents,
  ...
  2024. GRID3 BEN - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-ben-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents were derived from open data using a new methodology
    to generate building counts and settlement polygons. Spatial points represent
    centroids of settled grid cells at 100-meter resolution with probability values
    indicating settlement confidence. The dataset provides foundational exposure data
    for spatial risk assessment in Benin.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-ben-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Benin - GRID3 BEN - Settlement Extents v3.0 (Contains information on
    data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/c374cce8-1fd3-4871-927a-df569bed1ede/resource/4d4c7bc6-4527-4fc5-8011-396afa4e4879/download/grid3-ben-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_4d4c7bc6
  ...
  title: GRID3 BEN - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Benin - GRID3 BEN - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/c374cce8-1fd3-4871-927a-df569bed1ede/resource/73439081-eab6-4085-bf93-d21ab80e4058/download/grid3_ben_settlement_extents_v3_0.zip
  format: null
  id: resource_73439081
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_BEN_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/c374cce8-1fd3-4871-927a-df569bed1ede/resource/79a81e99-233a-4e73-9d20-90a3d05790c4/download/grid3_ben_settlement_grid_v3_0.zip
  format: null
  id: resource_79a81e99
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_BEN_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ben_grid3_bensettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Benin - GRID3 BEN - Settlement Extents v3.0
version: null
vulnerability: null
---
