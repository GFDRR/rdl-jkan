...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-cck_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Cocos (Keeling) Islands. Derived from
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796793
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796793
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Cocos (Keeling) Islands, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/10796793/files/CCK.zip
  format: null
  id: resource_sdkicra_cck
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Cocos
    (Keeling) Islands
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-cck_nismod_sdkicra
spatial:
  bbox:
  - 96.82
  - -12.2
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/1547376/cocos-islands.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Cocos (Keeling)
  Islands
version: 0.1.0
vulnerability: null
---
