...
- entity:
    ...
    url: https://data.humdata.org/dataset/oman-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/oman-road-surface-data
dataset_id: rdls_exp-omn_heigit_omanroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.1164 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0311 and 0.0205
  (in million kms), corressponding to 26.6907% and 17.6311% respectively of the total
  road length in the dataset region. 0.0648 million km or 55.6781% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0011 million km of information (corressponding
  to 1.6626% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/oman-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    learning approach to predict and classify road surfaces as paved or unpaved. The
    model processed OSM road geometries and attributes, generating surface predictions
    with confidence metrics. Results were integrated with original OSM data to create
    a comprehensive road surface classification dataset covering approximately 0.1164
    million km of mapped roads in Oman.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/oman-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Oman: Road Surface Data (GeoJSON data for Oman.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_omn_roadsurface_lines.geojson
  format: null
  id: resource_b49bc4c5
  ...
  title: Oman GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Oman: Road Surface Data (Geopackage data for Oman.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_omn_roadsurface_lines.gpkg
  format: null
  id: resource_8d2722c9
  ...
  temporal: null
  temporal_resolution: null
  title: Oman GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-omn_heigit_omanroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
