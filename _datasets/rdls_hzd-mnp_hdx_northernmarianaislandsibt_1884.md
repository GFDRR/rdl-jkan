...
- entity:
    ...
    url: https://data.humdata.org/dataset/mnp-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mnp-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mnp_hdx_northernmarianaislandsibt_1884
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mnp-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The Northern Mariana Islands subset
    contains observed storm tracks with ISO-formatted timestamps, basin/sub-basin
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mnp-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/2cb5b610-4225-4c85-a9fb-d1076847ccee/resource/408dd6e7-87ae-4839-8bb3-dfa150cc0c0f/download/ibtracs_all_list_v04r01_mnp.csv
  format: null
  id: resource_408dd6e7
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MNP.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1884 to date that pass within 2000 kilometers
    of Northern Mariana Islands.
  download_url: https://data.humdata.org/dataset/2cb5b610-4225-4c85-a9fb-d1076847ccee/resource/3a8a85e5-7abd-45b5-999c-c13914d07476/download/ibtracs_all_list_v04r01_lines_mnp.geojson
  format: null
  id: resource_3a8a85e5
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MNP.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mnp_hdx_northernmarianaislandsibt_1884
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1884-06-24'
temporal_resolution: null
title: 'Northern Mariana Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
