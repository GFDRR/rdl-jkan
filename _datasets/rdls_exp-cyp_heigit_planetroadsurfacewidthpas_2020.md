...
- entity:
    ...
    url: https://data.humdata.org/dataset/cyprus-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/cyprus-planet-road-surface-data
dataset_id: rdls_exp-cyp_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ surface conditions in many regions. Summary of Road Statistics Approximately 0.0038\
  \ million km of arterial roads are mapped in OSM in this region. - Paved roads:\
  \ 0.0037 million km (97.5283%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (0.0984%) - PlanetScope predictions cover: 0.0037\
  \ million km (99112.1369%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cyprus-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Cyprus. Deep learning models trained on PlanetScope satellite imagery (2020
    and 2024) classified road surface type (paved/unpaved), measured road width, and
    detected surface changes. A Humanitarian Passability Index was derived from these
    classifications to support logistics and transportation planning applications.
  sources:
  - id: source_1
    license: null
    name: PlanetScope Satellite Imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cyprus-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Cyprus: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Cyprus)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_CY_planet_roadsurface_lines.geojson
  format: null
  id: resource_48b1a1e8
  ...
  title: Cyprus GeoJSON heigit_CY_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Cyprus: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Cyprus)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_CY_planet_roadsurface_lines.gpkg
  format: null
  id: resource_a127b6a0
  ...
  temporal: null
  temporal_resolution: null
  title: Cyprus GPKG heigit_CY_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cyp_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Cyprus: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
