...
- entity:
    ...
    url: https://data.humdata.org/dataset/per-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/per-ndvi-subnational
dataset_id: rdls_hzd-per_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/per-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1
    v6.1) were combined into 8-day synthetic products and processed to compute dekadal
    NDVI values. These were aggregated by WFP-defined subnational administrative units
    with Pcode references, and anomalies calculated relative to long-term averages
    to produce vegetation stress indicators for agricultural drought monitoring.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/per-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135638521015_c9428025'
  download_url: https://data.humdata.org/dataset/873c2962-c5ef-4b53-8954-3b861f854d07/resource/1e7f05b1-0bd2-45f1-a7da-fe45baa4aba5/download/per-ndvi-subnat-full.csv
  format: null
  id: resource_1e7f05b1
  media_type: text/csv
  spatial: null
  ...
  title: per-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135638521015_c9428025'
  download_url: https://data.humdata.org/dataset/873c2962-c5ef-4b53-8954-3b861f854d07/resource/f99884ca-7673-49cc-ba62-b4a5cd9fb99f/download/per-ndvi-subnat-5ytd.csv
  format: null
  id: resource_f99884ca
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: per-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-per_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Peru: NDVI at Subnational Level'
version: null
vulnerability: null
---
