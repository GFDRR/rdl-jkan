...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-saint-helena
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-saint-helena
dataset_id: rdls_exp-shn_kontur_sainthelenapopulationdens_2023
description: 'Saint Helena population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-saint-helena]'
...
lineage:
  description: Population density estimates were derived by fusing multiple geospatial
    datasets (GHSL, HRSL, Microsoft Buildings, Copernicus Land Cover, LINZ, and OpenStreetMap)
    to create a consistent baseline population distribution. The fused settlement
    layer was then aggregated into 400m H3 hexagonal grid cells using the H3 hierarchical
    spatial indexing system, producing population counts per hexagon for Saint Helena.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-saint-helena
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Saint Helena: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_SH_20220630.gpkg.gz
  format: null
  id: resource_4d1a9621
  ...
  title: kontur_population_SH_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Saint Helena: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_SH_20231101.gpkg.gz
  format: null
  id: resource_9df2cfa5
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_SH_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-shn_kontur_sainthelenapopulationdens_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Saint Helena: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
