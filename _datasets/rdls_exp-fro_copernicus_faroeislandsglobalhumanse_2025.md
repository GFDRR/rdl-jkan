...
- entity:
    ...
    url: https://data.humdata.org/dataset/fro-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/fro-ghsl
dataset_id: rdls_exp-fro_copernicus_faroeislandsglobalhumanse_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/fro-ghsl]'
...
lineage:
  description: 'The GHSL project processes global fine-scale satellite imagery, census
    ...
    Two raster products are provided: GHS Built-up Surface (built environment extent
    and density) and GHS Population Grid (population count per grid cell).'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fro-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/0f0cbcde-4e8e-4079-9bdf-f2bbd11b9e0a/resource/a31d8126-5e35-4c58-a669-48e8d0d5c751/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_fro.tif
  format: null
  id: resource_a31d8126
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Faroe Islands: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/0f0cbcde-4e8e-4079-9bdf-f2bbd11b9e0a/resource/f960bb02-ce4c-4b3b-b7be-2a9f919e885c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_fro.tif
  format: null
  id: resource_f960bb02
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-fro_copernicus_faroeislandsglobalhumanse_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Faroe Islands: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
