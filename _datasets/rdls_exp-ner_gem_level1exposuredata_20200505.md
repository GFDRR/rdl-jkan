...
- entity:
    ...
    url: https://data.humdata.org/dataset/niger-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/niger-level-1-exposure-data
dataset_id: rdls_exp-ner_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/niger-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
license: CC-BY-4.0
lineage:
  description: Building exposure data for Niger was generated through the METEOR project
    methodology using Earth observation and minimal country-specific data collection.
    The dataset provides gridded estimates of building counts, building areas, and
    rebuilding values at 15-arcsecond resolution (approximately 500 meters) in point
    shapefile format, designed for catastrophe modeling and loss estimation applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project (Modelling Exposure Through Earth Observation Routines)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/niger-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Niger produced by ImageCat
    and the METEOR project consortium. Updated 2023-09-15 - some people had difficulties
    opening the zip and accessing the CSV data.
  download_url: https://data.humdata.org/dataset/a6c2a041-bd8d-4812-80da-f4e8357d1a40/resource/83553271-eb6c-4eb7-9dae-afebad89282e/download/ner_oed_exposure_20200811_updated_20230915.zip
  format: null
  id: resource_83553271
  ...
  title: ner_oed_exposure_20200811_updated_20230915.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ner_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Niger: Level 1 Exposure Data'
version: null
vulnerability: null
---
