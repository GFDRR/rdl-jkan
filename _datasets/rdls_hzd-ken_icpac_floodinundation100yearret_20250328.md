...
- entity:
    ...
    url: https://data.humdata.org/dataset/icpac-geonode-kenya-flood-inundation-100-year-return-period
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: IGAD Climate Prediction and Applications Center (ICPAC)
  url: https://data.humdata.org/dataset/icpac-geonode-kenya-flood-inundation-100-year-return-period
dataset_id: rdls_hzd-ken_icpac_floodinundation100yearret_20250328
description: 'This dataset is the output from the Global Flood Model intercomparison
  ...
  https://data.humdata.org/dataset/icpac-geonode-kenya-flood-inundation-100-year-return-period]'
...
lineage:
  description: Fluvial flood inundation depths were simulated using an ensemble of
    ...
    project. Model outputs were harmonized to WGS84 at ~90m resolution and classified
    by agreement level (0-6 models agreeing a cell is wet), following the methodology
    described in Trigg et al. (2016). The dataset represents probabilistic hazard
...
referenced_by: []
resources:
- access_url: https://geoportal.icpac.net/geoserver/ows?service=WCS&request=GetCoverage&coverageid=geonode__Kenya_flood_inundation&format=image%2Ftiff&version=2.0.1&compression=DEFLATE&tileWidth=512&tileHeight=512
  ...
  title: Kenya Flood Inundation (100 year return period) GeoTIFF
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ken_icpac_floodinundation100yearret_20250328
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-03-28'
temporal_resolution: null
title: Kenya Flood Inundation (100 year return period)
version: null
vulnerability: null
---
