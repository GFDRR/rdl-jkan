...
- entity:
    ...
    url: https://data.humdata.org/dataset/bhs-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bhs-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bhs_hdx_bahamasibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bhs-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Bahamas subset
    contains historical and recent storm tracks with ISO-formatted timestamps, geographic
    coordinates, wind speed (wmo_wind), and pressure (wmo_pres) measurements for each
    observation point along the cyclone path.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bhs-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Bahamas.
  download_url: https://data.humdata.org/dataset/a5cbefed-4577-4165-baab-9335046e4edc/resource/0365dd82-4c26-4bee-b42a-35f48f61d2b1/download/ibtracs_all_list_v04r01_bhs.csv
  format: null
  id: resource_0365dd82
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BHS.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Bahamas.
  download_url: https://data.humdata.org/dataset/a5cbefed-4577-4165-baab-9335046e4edc/resource/81789327-2c58-4564-9eb4-b18b484afe4d/download/ibtracs_all_list_v04r01_lines_bhs.geojson
  format: null
  id: resource_81789327
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BHS.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bhs_hdx_bahamasibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Bahamas: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
