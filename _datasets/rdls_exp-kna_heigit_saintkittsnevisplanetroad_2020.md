...
- entity:
    ...
    url: https://data.humdata.org/dataset/saint-kitts-and-nevis-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/saint-kitts-and-nevis-planet-road-surface-data
dataset_id: rdls_exp-kna_heigit_saintkittsnevisplanetroad_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (89.559%) - Unpaved roads: 0.0 million km (0.1989%) - Missing\
  \ OSM surface tags: 0.0 million km (0.4657%) - PlanetScope predictions cover: 0.0001\
  \ million km (19273.83%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/saint-kitts-and-nevis-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Saint Kitts and Nevis. Deep learning models were applied to PlanetScope satellite
    ...
    (HPI) with risk scoring. The resulting dataset provides infrastructure exposure
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/saint-kitts-and-nevis-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Saint Kitts and Nevis: Planet Road Surface, Width, and Passability
    Data (GeoJSON file for Saint kitts and nevis)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_KN_planet_roadsurface_lines.geojson
  format: null
  id: resource_34492482
  ...
  title: Saint kitts and nevis GeoJSON heigit_KN_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Saint Kitts and Nevis: Planet Road Surface, Width, and Passability
    Data (Geopackage file for Saint kitts and nevis)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_KN_planet_roadsurface_lines.gpkg
  format: null
  id: resource_5b00ea5b
  ...
  temporal: null
  temporal_resolution: null
  title: Saint kitts and nevis GPKG heigit_KN_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kna_heigit_saintkittsnevisplanetroad_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Saint Kitts and Nevis: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
