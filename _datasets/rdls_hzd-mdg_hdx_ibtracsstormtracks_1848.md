...
- entity:
    ...
    url: https://data.humdata.org/dataset/mdg-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mdg-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mdg_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mdg-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Madagascar subset contains observed storm positions, wind speeds (wmo_wind), central
    pressure (wmo_pres), and storm classification (nature) at regular time intervals,
    filtered geographically for the Madagascar region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mdg-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Madagascar.
  download_url: https://data.humdata.org/dataset/8d94c5d9-07ac-44f0-b8bd-f7730286c917/resource/4f38946d-adbb-4221-af06-e24547be8c18/download/ibtracs_all_list_v04r01_mdg.csv
  format: null
  id: resource_4f38946d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MDG.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Madagascar.
  download_url: https://data.humdata.org/dataset/8d94c5d9-07ac-44f0-b8bd-f7730286c917/resource/021f83f0-258b-41da-ba20-d0ef1d04d9d3/download/ibtracs_all_list_v04r01_lines_mdg.geojson
  format: null
  id: resource_021f83f0
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MDG.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mdg_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'Madagascar: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
