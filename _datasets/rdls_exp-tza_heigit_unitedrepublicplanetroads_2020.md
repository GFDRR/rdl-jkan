...
- entity:
    ...
    url: https://data.humdata.org/dataset/united-republic-of-tanzania-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/united-republic-of-tanzania-planet-road-surface-data
dataset_id: rdls_exp-tza_heigit_unitedrepublicplanetroads_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ surface conditions in many regions. Summary of Road Statistics Approximately 0.0291\
  \ million km of arterial roads are mapped in OSM in this region. - Paved roads:\
  \ 0.0148 million km (50.7552%) - Unpaved roads: 0.013 million km (44.8545%) - Missing\
  \ OSM surface tags: 0.0 million km (0.106%) - PlanetScope predictions cover: 0.0278\
  \ million km (90223.2684%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/united-republic-of-tanzania-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Tanzania. Deep learning models were applied to PlanetScope satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/united-republic-of-tanzania-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'United Republic of Tanzania: Planet Road Surface, Width, and Passability
    Data (Geopackage file for United republic of tanzania)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_TZ_planet_roadsurface_lines.gpkg
  format: null
  id: resource_972007fe
  ...
  title: United republic of tanzania GPKG heigit_TZ_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'United Republic of Tanzania: Planet Road Surface, Width, and Passability
    Data (GeoJSON file for United republic of tanzania)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_TZ_planet_roadsurface_lines.geojson
  format: null
  id: resource_fc792cf3
  ...
  temporal: null
  temporal_resolution: null
  title: United republic of tanzania GeoJSON heigit_TZ_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tza_heigit_unitedrepublicplanetroads_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'United Republic of Tanzania: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
