...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/dji-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-dji_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/dji-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Djibouti subset contains observed storm positions, wind speeds (wmo_wind), central
    pressures (wmo_pres), and storm classification (nature) extracted from the global
    archive and filtered for the Djibouti region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dji-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Djibouti.
  download_url: https://data.humdata.org/dataset/efe92e02-697f-42f5-9303-533c110cdd64/resource/cdd57bce-500b-427a-926a-6b0734f0cd89/download/ibtracs_all_list_v04r01_dji.csv
  format: null
  id: resource_cdd57bce
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_DJI.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Djibouti.
  download_url: https://data.humdata.org/dataset/efe92e02-697f-42f5-9303-533c110cdd64/resource/8968ace6-c39c-4185-a9fe-230a43e08e19/download/ibtracs_all_list_v04r01_lines_dji.geojson
  format: null
  id: resource_8968ace6
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_DJI.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-dji_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
