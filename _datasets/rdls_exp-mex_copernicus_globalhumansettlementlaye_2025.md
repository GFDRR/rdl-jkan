...
- entity:
    ...
    url: https://data.humdata.org/dataset/mex-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mex-ghsl
dataset_id: rdls_exp-mex_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mex-ghsl]'
...
lineage:
  description: The GHSL dataset integrates global fine-scale satellite imagery, census
    ...
    The resulting geospatial layers represent the spatial distribution of human settlements
    and population at high resolution for Mexico.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mex-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/3511bb9b-46d9-420c-9a2b-e8934246c6dc/resource/427247e8-0b36-4fe9-9c49-fe7b6be62478/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mex.tif
  format: null
  id: resource_427247e8
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Mexico: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/3511bb9b-46d9-420c-9a2b-e8934246c6dc/resource/7db3a649-9fd6-44c0-b7ea-2ea090520588/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mex.tif
  format: null
  id: resource_7db3a649
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mex_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Mexico: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
