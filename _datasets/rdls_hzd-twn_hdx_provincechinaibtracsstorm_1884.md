...
- entity:
    ...
    url: https://data.humdata.org/dataset/twn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/twn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-twn_hdx_provincechinaibtracsstorm_1884
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/twn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    standardized and quality-controlled. The Taiwan subset contains all cyclone tracks
    affecting or passing through the region with temporal resolution at observation
    intervals.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/twn-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/2883eec0-e749-4277-b19a-a7b6e39434ae/resource/df2d3f57-8454-453c-88c9-6e76829531ef/download/ibtracs_all_list_v04r01_twn.csv
  format: null
  id: resource_df2d3f57
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_TWN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1884 to date that pass within 2000 kilometers
    of Taiwan (Province of China).
  download_url: https://data.humdata.org/dataset/2883eec0-e749-4277-b19a-a7b6e39434ae/resource/26777eb8-111f-45b9-b112-d9be40692e74/download/ibtracs_all_list_v04r01_lines_twn.geojson
  format: null
  id: resource_26777eb8
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_TWN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-twn_hdx_provincechinaibtracsstorm_1884
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1884-06-24'
temporal_resolution: null
title: 'Taiwan (Province of China): IBTrACS Storm Tracks'
version: null
vulnerability: null
---
