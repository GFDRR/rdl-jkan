...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-cri_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Costa Rica. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796695
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796695
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Costa Rica, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/10796695/files/CRI.zip
  format: null
  id: resource_sdkicra_cri
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Costa
    Rica
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-cri_nismod_sdkicra
spatial:
  bbox:
  - -87.12
  - 5.52
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Costa Rica
version: 0.1.0
vulnerability: null
---
