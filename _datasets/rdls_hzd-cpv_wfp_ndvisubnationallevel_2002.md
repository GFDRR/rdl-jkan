...
- entity:
    ...
    url: https://data.humdata.org/dataset/cpv-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/cpv-ndvi-subnational
dataset_id: rdls_hzd-cpv_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cpv-ndvi-subnational]'
...
lineage:
  description: Raw MODIS Aqua and Terra 16-day composite products (MYD13C1 and MOD13C1)
    ...
    intervals at sub-national administrative units. NDVI values, long-term averages,
    and percentage anomalies were computed for each dekad and administrative unit,
    with pixel counts recorded to indicate data quality.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cpv-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135428395946_c7ce7037'
  download_url: https://data.humdata.org/dataset/3cd85f64-2ed2-4f0f-9a72-668c4eb55e10/resource/cd4f4b02-fa91-4fe0-9cbf-80cb1ae68d1c/download/cpv-ndvi-subnat-full.csv
  format: null
  id: resource_cd4f4b02
  media_type: text/csv
  spatial: null
  ...
  title: cpv-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135428395946_c7ce7037'
  download_url: https://data.humdata.org/dataset/3cd85f64-2ed2-4f0f-9a72-668c4eb55e10/resource/f270d06e-f91e-4ddf-a0ef-c2a8fb02a379/download/cpv-ndvi-subnat-5ytd.csv
  format: null
  id: resource_f270d06e
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: cpv-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cpv_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Cabo Verde: NDVI at Subnational Level'
version: null
vulnerability: null
---
