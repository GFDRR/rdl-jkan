...
- entity:
    ...
    url: https://data.humdata.org/dataset/iot-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/iot-ghsl
dataset_id: rdls_exp-iot_copernicus_britishindianoceanterrito_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/iot-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distribution. The resulting
    GeoTIFF layers represent human settlement patterns and population density at high
    spatial resolution for disaster risk exposure assessment.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/iot-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/96076a1b-9aeb-457e-8b54-58f579109ef9/resource/3e8200a4-6def-450d-bea0-7d3989d8ce0d/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_iot.tif
  format: null
  id: resource_3e8200a4
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'British Indian Ocean Territory: Copernicus Global Human Settlement
    Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system:
    Mollweide)'
  download_url: https://data.humdata.org/dataset/96076a1b-9aeb-457e-8b54-58f579109ef9/resource/52c4f6ae-e79d-4eed-bacb-cca9932d3c5c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_iot.tif
  format: null
  id: resource_52c4f6ae
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-iot_copernicus_britishindianoceanterrito_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'British Indian Ocean Territory: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
