...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/mys-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mys-rainfall-subnational
dataset_id: rdls_hzd-mys_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/mys-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    ...
    sums and anomalies) at subnational administrative units in Malaysia to support
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mys-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135708834257_2de93b04'
  download_url: https://data.humdata.org/dataset/b6480739-2092-4082-b349-298ec29c740a/resource/6bd70944-cac7-4e60-96a1-3d1b83701648/download/mys-rainfall-subnat-full.csv
  format: null
  id: resource_6bd70944
  media_type: text/csv
  spatial: null
  ...
  title: mys-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135708834257_2de93b04'
  download_url: https://data.humdata.org/dataset/b6480739-2092-4082-b349-298ec29c740a/resource/9f67bbae-fce5-4be4-98f5-484e51535674/download/mys-rainfall-subnat-5ytd.csv
  format: null
  id: resource_9f67bbae
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mys-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mys_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
