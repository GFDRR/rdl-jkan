...
- entity:
    ...
    url: https://data.humdata.org/dataset/prt-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/prt-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-prt_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/prt-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Portugal subset contains observed storm track positions (latitude, longitude,
    ISO timestamp), basin/sub-basin classification, wind speed (wmo_wind), and central
    pressure (wmo_pres) for all tropical cyclones affecting or passing through Portuguese
    territory.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/prt-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Portugal.
  download_url: https://data.humdata.org/dataset/de3aae25-80da-41f3-82a9-ec0c01ec81d3/resource/c30d6d9d-a6b0-4a3b-ae75-99f5ce4ccbc9/download/ibtracs_all_list_v04r01_prt.csv
  format: null
  id: resource_c30d6d9d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PRT.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Portugal.
  download_url: https://data.humdata.org/dataset/de3aae25-80da-41f3-82a9-ec0c01ec81d3/resource/43e8ff5e-33a7-43a1-902d-dcb35acd1886/download/ibtracs_all_list_v04r01_lines_prt.geojson
  format: null
  id: resource_43e8ff5e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PRT.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-prt_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-08-16'
temporal_resolution: null
title: 'Portugal: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
