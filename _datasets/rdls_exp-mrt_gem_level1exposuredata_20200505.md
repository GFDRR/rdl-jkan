...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/mauritania-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/mauritania-level-1-exposure-data
dataset_id: rdls_exp-mrt_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mauritania-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    global-quality Level 1 exposure estimates. The dataset provides gridded building
    counts, areas, and rebuilding values at 15-arcsecond resolution (approximately
    500 meters) intended for catastrophe modeling and loss estimation applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mauritania-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Mauritania produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/e54a0b6f-8e27-4854-aa59-c9cd2b3d06c1/resource/cc725352-7d87-4860-abea-c1c76a82176b/download/mrt_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_cc725352
  ...
  title: MRT_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mrt_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Mauritania: Level 1 Exposure Data'
version: null
vulnerability: null
---
