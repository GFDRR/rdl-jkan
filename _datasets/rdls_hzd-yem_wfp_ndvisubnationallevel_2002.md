...
- entity:
    ...
    url: https://data.humdata.org/dataset/yem-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/yem-ndvi-subnational
dataset_id: rdls_hzd-yem_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/yem-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI indicators at subnational administrative units. NDVI anomalies were calculated
    as percentage deviations from long-term averages to detect agricultural drought
    conditions.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/yem-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135825320836_47592f34'
  download_url: https://data.humdata.org/dataset/7907439a-0138-4b8e-a4cf-4f0233e0d694/resource/5f4c188b-a41b-446f-9c34-77113297e52c/download/yem-ndvi-subnat-full.csv
  format: null
  id: resource_5f4c188b
  media_type: text/csv
  spatial: null
  ...
  title: yem-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135825320836_47592f34'
  download_url: https://data.humdata.org/dataset/7907439a-0138-4b8e-a4cf-4f0233e0d694/resource/4fe4b2f7-2897-4707-9b73-337bbcea2471/download/yem-ndvi-subnat-5ytd.csv
  format: null
  id: resource_4fe4b2f7
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: yem-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-yem_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Yemen: NDVI at Subnational Level'
version: null
vulnerability: null
---
