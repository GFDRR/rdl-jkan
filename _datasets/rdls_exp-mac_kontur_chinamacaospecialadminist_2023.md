...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-china-macao-special-administrative-region
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-china-macao-special-administrative-region
dataset_id: rdls_exp-mac_kontur_chinamacaospecialadminist_2023
description: 'China, Macao Special Administrative Region population density for 400m
  ...
  dataset: https://data.humdata.org/dataset/kontur-population-china-macao-special-administrative-region]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    OpenStreetMap) using H3 hexagonal hierarchical spatial indexing at 400m resolution.
    The fusion methodology overlaid satellite-derived settlement layers with building
    footprints and land cover data to allocate population counts to grid cells, creating
    a baseline population exposure dataset for Macao SAR.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-china-macao-special-administrative-region
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'China, Macao Special Administrative Region: Population Density for
    400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MO_20220630.gpkg.gz
  format: null
  id: resource_03bbae8b
  ...
  title: kontur_population_MO_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'China, Macao Special Administrative Region: Population Density for
    400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MO_20231101.gpkg.gz
  format: null
  id: resource_ff681808
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_MO_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mac_kontur_chinamacaospecialadminist_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'China, Macao Special Administrative Region: Population Density for 400m H3
  Hexagons'
version: null
vulnerability: null
---
