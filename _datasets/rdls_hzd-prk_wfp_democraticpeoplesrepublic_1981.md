...
- entity:
    ...
    url: https://data.humdata.org/dataset/prk-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/prk-rainfall-subnational
dataset_id: rdls_hzd-prk_wfp_democraticpeoplesrepublic_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/prk-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with in-situ station measurements, then aggregated into dekadal, 1-month rolling,
    and 3-month rolling indicators at subnational administrative units. These rainfall
    metrics serve as meteorological drought indicators for monitoring precipitation
    anomalies relative to long-term averages.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/prk-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135738928797_d8c5f43c'
  download_url: https://data.humdata.org/dataset/3212d9bf-51b1-4f52-bbc8-82aa392b8857/resource/bea5aae7-b1e4-4dbe-b126-20e5a6753fc5/download/prk-rainfall-subnat-full.csv
  format: null
  id: resource_bea5aae7
  media_type: text/csv
  spatial: null
  ...
  title: prk-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135738928797_d8c5f43c'
  download_url: https://data.humdata.org/dataset/3212d9bf-51b1-4f52-bbc8-82aa392b8857/resource/40f285ff-54b2-4544-80a5-d1a79eb70935/download/prk-rainfall-subnat-5ytd.csv
  format: null
  id: resource_40f285ff
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: prk-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-prk_wfp_democraticpeoplesrepublic_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Democratic People''s Republic of Korea: Rainfall Indicators at Subnational
  Level'
version: null
vulnerability: null
---
