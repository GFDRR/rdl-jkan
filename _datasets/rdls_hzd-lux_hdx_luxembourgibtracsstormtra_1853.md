...
- entity:
    ...
    url: https://data.humdata.org/dataset/lux-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/lux-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-lux_hdx_luxembourgibtracsstormtra_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lux-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS aggregates tropical cyclone observations from multiple international
    agencies into a unified best-track dataset. The Luxembourg subset contains historical
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lux-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Luxembourg.
  download_url: https://data.humdata.org/dataset/bee5a9b4-a1fa-462b-82d8-96ab2afbe8ef/resource/7c7723ca-b343-4e22-9392-169c33c26dfa/download/ibtracs_all_list_v04r01_lux.csv
  format: null
  id: resource_7c7723ca
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_LUX.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Luxembourg.
  download_url: https://data.humdata.org/dataset/bee5a9b4-a1fa-462b-82d8-96ab2afbe8ef/resource/5bea8acf-f7e8-4632-9b21-844637dbe25e/download/ibtracs_all_list_v04r01_lines_lux.geojson
  format: null
  id: resource_5bea8acf
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_LUX.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lux_hdx_luxembourgibtracsstormtra_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Luxembourg: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
