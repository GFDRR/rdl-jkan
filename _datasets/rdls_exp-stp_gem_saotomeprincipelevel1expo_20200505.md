...
- entity:
    ...
    url: https://data.humdata.org/dataset/sao-tome-and-principe-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/sao-tome-and-principe-level-1-exposure-data
dataset_id: rdls_exp-stp_gem_saotomeprincipelevel1expo_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sao-tome-and-principe-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
license: CC-BY-4.0
lineage:
  description: "Building exposure data was generated through the METEOR project methodology\
    \ using Earth observation and minimal country-specific data collection. The dataset\
    \ provides gridded estimates of building count, area, and rebuilding value at\
    \ 15-arcsecond resolution (~500m) across S\xE3o Tom\xE9 and Pr\xEDncipe, designed\
    \ for catastrophe modeling and loss estimation applications."
  sources:
  - id: source_1
    license: null
    name: METEOR Project (Modelling Exposure Through Earth Observation Routines)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sao-tome-and-principe-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Sao Tome and Principe produced
    by ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/c84fcf30-2c67-4744-b111-35c29a4651a9/resource/58b5df2f-badc-4657-873c-20c511201102/download/stp_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_58b5df2f
  ...
  title: STP_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-stp_gem_saotomeprincipelevel1expo_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Sao Tome and Principe: Level 1 Exposure Data'
version: null
vulnerability: null
---
