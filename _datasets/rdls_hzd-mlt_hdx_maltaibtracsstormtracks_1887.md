...
- entity:
    ...
    url: https://data.humdata.org/dataset/mlt-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mlt-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mlt_hdx_maltaibtracsstormtracks_1887
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mlt-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Malta
    subset contains observed storm track positions, timestamps, basin classifications,
    wind speeds (wmo_wind), and central pressure (wmo_pres) for all tropical cyclones
    affecting the region, provided in both tabular CSV and geospatial GeoJSON formats.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mlt-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of Malta.
  download_url: https://data.humdata.org/dataset/16f20b77-6a61-412f-b9cf-ca11721c93ab/resource/61755f67-6469-43a7-9484-197ff8379187/download/ibtracs_all_list_v04r01_mlt.csv
  format: null
  id: resource_61755f67
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MLT.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of Malta.
  download_url: https://data.humdata.org/dataset/16f20b77-6a61-412f-b9cf-ca11721c93ab/resource/597aa165-ead9-4e35-b2da-f9ee66e5befc/download/ibtracs_all_list_v04r01_lines_mlt.geojson
  format: null
  id: resource_597aa165
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MLT.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mlt_hdx_maltaibtracsstormtracks_1887
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1887-10-29'
temporal_resolution: null
title: 'Malta: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
