...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/kaz-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/kaz-rainfall-subnational
dataset_id: rdls_hzd-kaz_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/kaz-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    units in Kazakhstan. Long-term rainfall averages and quantile-based indices were
    calculated to enable drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kaz-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135557023405_7031cba5'
  download_url: https://data.humdata.org/dataset/ec9a0c5f-e524-48e5-8784-fc06094bebb7/resource/359a2cf4-7b43-44e2-8ca1-8b86d7e7fb28/download/kaz-rainfall-subnat-full.csv
  format: null
  id: resource_359a2cf4
  media_type: text/csv
  spatial: null
  ...
  title: kaz-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135557023405_7031cba5'
  download_url: https://data.humdata.org/dataset/ec9a0c5f-e524-48e5-8784-fc06094bebb7/resource/ebfbca4d-d628-4ab8-8371-0df24daf2c56/download/kaz-rainfall-subnat-5ytd.csv
  format: null
  id: resource_ebfbca4d
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kaz-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-kaz_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Kazakhstan: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
