...
- entity:
    ...
    url: https://data.humdata.org/dataset/mar-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/mar-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-mar_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mar-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Morocco subset contains observed storm positions, wind speeds (wmo_wind), and
    central pressure (wmo_pres) recorded at regular time intervals in ISO format,
    filtered geographically for the Morocco region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mar-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Morocco.
  download_url: https://data.humdata.org/dataset/83f73b3a-2a3f-4e5d-88e6-fbdd12907327/resource/03938c75-91c0-4476-9dc4-c4672c53aa0f/download/ibtracs_all_list_v04r01_mar.csv
  format: null
  id: resource_03938c75
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_MAR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Morocco.
  download_url: https://data.humdata.org/dataset/83f73b3a-2a3f-4e5d-88e6-fbdd12907327/resource/9804bdd2-64d0-4a3a-bf35-1198ed9f0cb7/download/ibtracs_all_list_v04r01_lines_mar.geojson
  format: null
  id: resource_9804bdd2
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_MAR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mar_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-11-04'
temporal_resolution: null
title: 'Morocco: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
