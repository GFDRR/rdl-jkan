...
- entity:
    ...
    url: https://data.humdata.org/dataset/peru-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/peru-road-surface-data
dataset_id: rdls_exp-per_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.4981 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0621 and 0.1696
  (in million kms), corressponding to 12.4573% and 34.0499% respectively of the total
  road length in the dataset region. 0.2665 million km or 53.4929% of road surface
  ...
  to 0.7729% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/peru-road-surface-data]'
details: null
exposure:
- asset_type:
    description: Road network in Peru classified by surface type (paved vs. unpaved)
      derived from OSM data enhanced with AI-based surface prediction
    id: infrastructure
    scheme: null
    title: null
    uri: null
...
lineage:
  description: OSM road network data for Peru was extracted and processed by HeiGIT,
    then augmented using a hybrid deep learning model to predict paved/unpaved surface
    classification for roads lacking explicit surface tags. The resulting dataset
    provides estimated surface type coverage across the national road network, supporting
    humanitarian access, logistics planning, and disaster risk assessments.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/peru-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Peru: Road Surface Data (GeoJSON data for Peru.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_per_roadsurface_lines.geojson
  format: null
  id: resource_d905ec5a
  ...
  title: Peru GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Peru: Road Surface Data (Geopackage data for Peru.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_per_roadsurface_lines.gpkg
  format: null
  id: resource_5cef473c
  ...
  temporal: null
  temporal_resolution: null
  title: Peru GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-per_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
