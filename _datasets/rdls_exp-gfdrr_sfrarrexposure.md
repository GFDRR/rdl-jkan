...
creator:
  ...
  name: Chiara Scaini
  url: null
dataset_id: rdls_exp-gfdrr_sfrarrexposure
description: Regionally consistent, multi-sector exposure database for Central Asia
  (Kazakhstan, Kyrgyz Republic, Tajikistan, Turkmenistan, Uzbekistan) developed under
  the SFRARR program. Covers population, residential and non-residential buildings,
  croplands, the transport system, airports and supply infrastructure for multi-country,
  multi-hazard risk assessment at regional, national and sub-national (oblast) scale.
...
- asset_type: null
  category: buildings
  id: rdls_exp-gfdrr_sfrarrexposure_exp
  metrics:
  - dimension: structure
    id: rdls_exp-gfdrr_sfrarrexposure_m1
    measurement:
...
resources:
- access_url: https://datacatalog.worldbank.org/search/dataset/0064117/Central-Asia-Exposure-Data
  ...
  download_url: null
  format: shp
  id: rdls_exp-gfdrr_sfrarrexposure_r1
  media_type: null
  spatial: null
  ...
  title: Central Asia exposure dataset - multiple sectors
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gfdrr_sfrarrexposure
spatial:
  bbox:
  - 46.0
  - 34.0
  ...
  - UZB
  gazetteer_entries:
  - description: Oblast codes and names are used.
    id: CA_SFRARR_exp_gaz
...
temporal: null
temporal_resolution: null
title: Central Asia Exposure - Multi-Sector Database (SFRARR)
version: '2022'
vulnerability: null
---
