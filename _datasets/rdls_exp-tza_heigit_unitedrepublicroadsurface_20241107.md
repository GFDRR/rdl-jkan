...
- entity:
    ...
    url: https://data.humdata.org/dataset/united-republic-of-tanzania-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/united-republic-of-tanzania-road-surface-data
dataset_id: rdls_exp-tza_heigit_unitedrepublicroadsurface_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.9904 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0289 and 0.6462
  (in million kms), corressponding to 2.9189% and 65.2423% respectively of the total
  road length in the dataset region. 0.3153 million km or 31.8387% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0002 million km of information (corressponding
  to 0.0722% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/united-republic-of-tanzania-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometry and attributes were extracted from OpenStreetMap
    data covering Tanzania. A hybrid deep learning model was applied to classify road
    surfaces into paved and unpaved categories, generating surface type predictions
    across approximately 0.99 million km of mapped roads. The resulting dataset provides
    infrastructure exposure data for humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/united-republic-of-tanzania-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'United Republic of Tanzania: Road Surface Data (GeoJSON data for United
    republic of tanzania.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tza_roadsurface_lines.geojson
  format: null
  id: resource_a45709a9
  ...
  title: United republic of tanzania GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'United Republic of Tanzania: Road Surface Data (Geopackage data for
    United republic of tanzania.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tza_roadsurface_lines.gpkg
  format: null
  id: resource_6a7986a1
  ...
  temporal: null
  temporal_resolution: null
  title: United republic of tanzania GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tza_heigit_unitedrepublicroadsurface_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'United Republic of Tanzania: Road Surface Data'
version: null
vulnerability: null
---
