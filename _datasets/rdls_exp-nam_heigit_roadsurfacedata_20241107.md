...
- entity:
    ...
    url: https://data.humdata.org/dataset/namibia-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/namibia-road-surface-data
dataset_id: rdls_exp-nam_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2016 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0197 and 0.1094
  (in million kms), corressponding to 9.7506% and 54.2725% respectively of the total
  road length in the dataset region. 0.0725 million km or 35.9769% of road surface
  ...
  to 0.0915% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/namibia-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    ...
    road surfaces. The resulting dataset provides 0.2016 million km of mapped roads
    with predicted surface classifications, supporting humanitarian access and logistics
    planning in Namibia.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/namibia-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Namibia: Road Surface Data (GeoJSON data for Namibia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_nam_roadsurface_lines.geojson
  format: null
  id: resource_48fcf017
  ...
  title: Namibia GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Namibia: Road Surface Data (Geopackage data for Namibia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_nam_roadsurface_lines.gpkg
  format: null
  id: resource_8e2b122b
  ...
  temporal: null
  temporal_resolution: null
  title: Namibia GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-nam_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Namibia: Road Surface Data'
version: null
vulnerability: null
---
