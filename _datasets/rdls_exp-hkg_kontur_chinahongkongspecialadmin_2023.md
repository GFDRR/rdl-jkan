...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-china-hong-kong-special-administrative-region
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-china-hong-kong-special-administrative-region
dataset_id: rdls_exp-hkg_kontur_chinahongkongspecialadmin_2023
description: 'China, Hong Kong Special Administrative Region population density for
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-china-hong-kong-special-administrative-region]'
...
lineage:
  description: Population density was calculated by fusing multiple global datasets
    ...
    multi-source fusion approach improves accuracy of population distribution estimates
    for Hong Kong SAR.
  sources:
  - id: source_1
    license: null
...
- access_url: null
  ...
  description: 'China, Hong Kong Special Administrative Region: Population Density
    for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_HK_20220630.gpkg.gz
  format: null
  id: resource_62e9476c
  ...
  title: kontur_population_HK_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_HK_20231101.gpkg.gz
  format: null
  id: resource_220a6801
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_HK_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-hkg_kontur_chinahongkongspecialadmin_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'China, Hong Kong Special Administrative Region: Population Density for 400m
  H3 Hexagons'
version: null
vulnerability: null
---
