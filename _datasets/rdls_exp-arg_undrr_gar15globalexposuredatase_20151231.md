...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-argentina
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-argentina
dataset_id: rdls_exp-arg_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-argentina]'
...
lineage:
  description: The GAR15 exposure dataset for Argentina was developed using a top-down
    ...
    population density and GDP as spatial proxies. The dataset integrates inputs from
    multiple international agencies (UNEP-GRID, WAPMERR, JRC, Kokusai Kogyo) to estimate
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-argentina
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Argentina.zip
  download_url: https://data.humdata.org/dataset/7ce4ca7f-5e49-4e3c-94ea-45bf68f9449a/resource/ee032fb5-bc69-4b5f-b20b-f1bee35bd9eb/download/arg.zip
  format: null
  id: resource_ee032fb5
  ...
  title: GAR15 Global Exposure Dataset for Argentina.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-arg_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Argentina
version: null
vulnerability: null
---
