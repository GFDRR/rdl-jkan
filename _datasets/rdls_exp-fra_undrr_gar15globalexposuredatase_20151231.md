...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-france
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-france
dataset_id: rdls_exp-fra_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-france]'
...
lineage:
  description: The GAR15 global exposure database for France was developed using a
    top-down approach where national-level socio-economic data, building type information,
    ...
    Kokusai Kogyo) to estimate economic value and asset distribution across the country.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-france
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for France.zip
  download_url: https://data.humdata.org/dataset/a5520312-f4fe-4a1e-9d0b-bf879c1587a8/resource/477f3ada-e9bb-4d6f-9885-0ccfa251257f/download/fra.zip
  format: null
  id: resource_477f3ada
  ...
  title: GAR15 Global Exposure Dataset for France.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-fra_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for France
version: null
vulnerability: null
---
