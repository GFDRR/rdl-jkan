...
- entity:
    ...
    url: https://data.humdata.org/dataset/cameroon-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/cameroon-road-surface-data
dataset_id: rdls_exp-cmr_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.2266 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0159 and 0.1103
  (in million kms), corressponding to 7.03% and 48.685% respectively of the total
  road length in the dataset region. 0.1003 million km or 44.2849% of road surface
  ...
  to 0.267% of total missing information on road surface) It is intended for use in
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cameroon-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    learning approach to classify and predict road surface types (paved vs unpaved).
    The resulting dataset provides spatial inventory of road infrastructure with surface
    classification across Cameroon, supporting humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cameroon-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Cameroon: Road Surface Data (GeoJSON data for Cameroon.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_cmr_roadsurface_lines.geojson
  format: null
  id: resource_7f77c77d
  ...
  title: Cameroon GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Cameroon: Road Surface Data (Geopackage data for Cameroon.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_cmr_roadsurface_lines.gpkg
  format: null
  id: resource_144f0090
  ...
  temporal: null
  temporal_resolution: null
  title: Cameroon GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cmr_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Cameroon: Road Surface Data'
version: null
vulnerability: null
---
