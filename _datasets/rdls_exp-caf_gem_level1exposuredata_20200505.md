...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/central-african-republic-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/central-african-republic-level-1-exposure-data
dataset_id: rdls_exp-caf_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/central-african-republic-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    Earth observation routines with minimal country-specific data collection to produce
    Level 1 global-quality exposure estimates. The dataset presents gridded (15-arcsecond
    resolution) estimates of building counts, areas, and rebuilding values intended
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/central-african-republic-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Central African Republic
    produced by ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/c252c626-b10b-408c-9cf3-b307ec41f776/resource/a54faa5a-ce30-4984-a976-363005bf2a4d/download/caf_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_a54faa5a
  ...
  title: CAF_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-caf_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Central African Republic: Level 1 Exposure Data'
version: null
vulnerability: null
---
