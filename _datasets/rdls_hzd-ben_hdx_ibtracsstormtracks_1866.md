...
- entity:
    ...
    url: https://data.humdata.org/dataset/ben-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ben-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ben_hdx_ibtracsstormtracks_1866
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ben-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Benin subset contains observed storm positions,
    wind speeds (wmo_wind), central pressures (wmo_pres), and storm classification
    (nature) extracted for cyclones affecting or passing through the Benin region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ben-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1866 to date that pass within 2000 kilometers
    of Benin.
  download_url: https://data.humdata.org/dataset/3bf3401d-e02a-49a0-beec-05b1ed8111b2/resource/56bdf27f-da8d-4046-8602-094ef9558eed/download/ibtracs_all_list_v04r01_ben.csv
  format: null
  id: resource_56bdf27f
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BEN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1866 to date that pass within 2000 kilometers
    of Benin.
  download_url: https://data.humdata.org/dataset/3bf3401d-e02a-49a0-beec-05b1ed8111b2/resource/368381a1-9d26-4523-b448-47f60ac0a62e/download/ibtracs_all_list_v04r01_lines_ben.geojson
  format: null
  id: resource_368381a1
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BEN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ben_hdx_ibtracsstormtracks_1866
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1866-09-20'
temporal_resolution: null
title: 'Benin: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
