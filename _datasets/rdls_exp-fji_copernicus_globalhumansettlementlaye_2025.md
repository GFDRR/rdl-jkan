...
- entity:
    ...
    url: https://data.humdata.org/dataset/fji-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/fji-ghsl
dataset_id: rdls_exp-fji_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/fji-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams,
    ...
    explicit exposure inventories of human settlements and infrastructure across Fiji.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fji-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/ac6e2592-150a-4037-9d1f-2c6853cb2e84/resource/d73e5b82-f7f3-4f3c-a686-31e918b8f5d0/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_fji.tif
  format: null
  id: resource_d73e5b82
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Fiji: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/ac6e2592-150a-4037-9d1f-2c6853cb2e84/resource/e1f13f38-be91-4d8b-89f3-93d6cddfcf50/download/ghs_pop_e2025_r2023a_54009_100_v1_0_fji.tif
  format: null
  id: resource_e1f13f38
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-fji_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Fiji: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
