...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-npl_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Nepal. Derived from global datasets clipped
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796765
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796765
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Nepal, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/10796765/files/NPL.zip
  format: null
  id: resource_sdkicra_npl
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Nepal
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-npl_nismod_sdkicra
spatial:
  bbox:
  - 80.03
  - 26.34
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Nepal
version: 0.1.0
vulnerability: null
---
