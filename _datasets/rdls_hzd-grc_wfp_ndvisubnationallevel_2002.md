...
- entity:
    ...
    url: https://data.humdata.org/dataset/grc-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/grc-ndvi-subnational
dataset_id: rdls_hzd-grc_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grc-ndvi-subnational]'
...
lineage:
  description: Raw MODIS Aqua and Terra 16-day composite products (MYD13C1 and MOD13C1)
    ...
    to create a time-series vegetation monitoring dataset for drought assessment.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grc-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135521559709_a49ddc1a'
  download_url: https://data.humdata.org/dataset/168273e0-3d47-4556-8269-08c685302b45/resource/d3d41f68-a6bd-4bea-af30-19728aea5d75/download/grc-ndvi-subnat-full.csv
  format: null
  id: resource_d3d41f68
  media_type: text/csv
  spatial: null
  ...
  title: grc-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135521559709_a49ddc1a'
  download_url: https://data.humdata.org/dataset/168273e0-3d47-4556-8269-08c685302b45/resource/1f343972-1b09-457f-a95a-4b1e7a64e6e6/download/grc-ndvi-subnat-5ytd.csv
  format: null
  id: resource_1f343972
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: grc-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-grc_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Greece: NDVI at Subnational Level'
version: null
vulnerability: null
---
