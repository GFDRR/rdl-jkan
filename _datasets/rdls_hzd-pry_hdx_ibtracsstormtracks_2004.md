...
- entity:
    ...
    url: https://data.humdata.org/dataset/pry-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/pry-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-pry_hdx_ibtracsstormtracks_2004
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/pry-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Paraguay
    subset contains observed storm track positions (latitude, longitude, time) with
    associated wind speed (wmo_wind) and pressure (wmo_pres) measurements. Data is
    provided in both tabular (CSV) and geospatial (GeoJSON line) formats for analysis
    of tropical cyclone hazards.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pry-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 2004 to date that pass within 2000 kilometers
    of Paraguay.
  download_url: https://data.humdata.org/dataset/672f3186-899d-484b-b8e8-1d27e9e1ad68/resource/7494df10-e9e2-4a25-8a51-5264186203be/download/ibtracs_all_list_v04r01_pry.csv
  format: null
  id: resource_7494df10
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PRY.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 2004 to date that pass within 2000 kilometers
    of Paraguay.
  download_url: https://data.humdata.org/dataset/672f3186-899d-484b-b8e8-1d27e9e1ad68/resource/73b80818-194c-46ab-860f-ae80335aa9dd/download/ibtracs_all_list_v04r01_lines_pry.geojson
  format: null
  id: resource_73b80818
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PRY.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-pry_hdx_ibtracsstormtracks_2004
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2004-03-25'
temporal_resolution: null
title: 'Paraguay: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
