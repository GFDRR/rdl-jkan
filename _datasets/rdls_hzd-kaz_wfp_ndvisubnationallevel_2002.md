...
- entity:
    ...
    url: https://data.humdata.org/dataset/kaz-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/kaz-ndvi-subnational
dataset_id: rdls_hzd-kaz_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kaz-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI indicators by WFP-defined subnational administrative units. NDVI anomalies
    were calculated as percentage deviations from long-term averages to support agricultural
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kaz-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135603523232_a8573b23'
  download_url: https://data.humdata.org/dataset/b9c8c168-c4a8-4303-a0f3-a02af61425d7/resource/cc903553-360e-4c3d-b934-88a370d742f3/download/kaz-ndvi-subnat-full.csv
  format: null
  id: resource_cc903553
  media_type: text/csv
  spatial: null
  ...
  title: kaz-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135603523232_a8573b23'
  download_url: https://data.humdata.org/dataset/b9c8c168-c4a8-4303-a0f3-a02af61425d7/resource/f6a7835e-7ba2-4fd2-a7a3-a9895d622c37/download/kaz-ndvi-subnat-5ytd.csv
  format: null
  id: resource_f6a7835e
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kaz-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-kaz_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Kazakhstan: NDVI at Subnational Level'
version: null
vulnerability: null
---
