...
- entity:
    ...
    url: https://data.humdata.org/dataset/swe-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/swe-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-swe_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/swe-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Sweden subset contains
    observed storm track positions, wind speeds (WMO standard), and central pressure
    measurements recorded during tropical cyclone events affecting or passing near
    Swedish territory.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/swe-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Sweden.
  download_url: https://data.humdata.org/dataset/57270e89-b56f-4be0-a8c6-383fef2c6771/resource/a1412ce4-1381-40a0-9ea4-06b1fa2f7d20/download/ibtracs_all_list_v04r01_swe.csv
  format: null
  id: resource_a1412ce4
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SWE.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Sweden.
  download_url: https://data.humdata.org/dataset/57270e89-b56f-4be0-a8c6-383fef2c6771/resource/ba87682c-8d0c-41a6-a452-4c5c7bc1b0be/download/ibtracs_all_list_v04r01_lines_swe.geojson
  format: null
  id: resource_ba87682c
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SWE.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-swe_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Sweden: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
