...
- entity:
    ...
    url: https://data.humdata.org/dataset/khm-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/khm-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-khm_hdx_ibtracsstormtracks_1871
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/khm-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Cambodia subset contains observed storm track positions (latitude, longitude,
    time), basin/sub-basin classification, wind speed (WMO), and central pressure
    measurements for all tropical cyclones affecting or passing through Cambodian
    territory.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/khm-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1871 to date that pass within 2000 kilometers
    of Cambodia.
  download_url: https://data.humdata.org/dataset/cb2a0772-eae3-4e13-b81f-8338ca05d388/resource/24940f21-2a94-4f68-ac24-4318af8bdc5d/download/ibtracs_all_list_v04r01_khm.csv
  format: null
  id: resource_24940f21
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_KHM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1871 to date that pass within 2000 kilometers
    of Cambodia.
  download_url: https://data.humdata.org/dataset/cb2a0772-eae3-4e13-b81f-8338ca05d388/resource/e638bae2-5b61-450d-a90b-6c50b4a1e890/download/ibtracs_all_list_v04r01_lines_khm.geojson
  format: null
  id: resource_e638bae2
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_KHM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-khm_hdx_ibtracsstormtracks_1871
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1871-07-01'
temporal_resolution: null
title: 'Cambodia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
