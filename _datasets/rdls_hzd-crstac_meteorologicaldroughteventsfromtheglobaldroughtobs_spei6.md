...
creator:
  ...
  name: Global Drought Observatory
  url: https://data.jrc.ec.europa.eu/collection/id-00321
dataset_id: rdls_hzd-crstac_meteorologicaldroughteventsfromtheglobaldroughtobs_spei6
description: 'Drought events based on Standard Precipitation and Evaporation Index
  for 6 months [Source: This metadata record was automatically extracted from the
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/hazard/precipitation-related/meteorological-drought-events-from-the-global-drought-observatory-gdo/spei6/spei6.json
...
- hazard
schema: rdls-10
slug: rdls_hzd-crstac_meteorologicaldroughteventsfromtheglobaldroughtobs_spei6
spatial:
  bbox:
  - -180.0
  - -90.0
...
title: Meteorological drought events from the Global Drought Observatory (GDO) - SPEI6
version: null
vulnerability: null
---
