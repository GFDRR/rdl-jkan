...
- entity:
    ...
    url: https://data.humdata.org/dataset/guam-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/guam-road-surface-data
dataset_id: rdls_exp-gum_heigit_guamroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/guam-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    ...
    vs unpaved road surfaces, with predictions validated against OSM-tagged surfaces
    and integrated into a combined classification layer prioritizing either OSM or
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guam-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Guam: Road Surface Data (GeoJSON data for Guam.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_gum_roadsurface_lines.geojson
  format: null
  id: resource_a70b5ec3
  ...
  title: Guam GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Guam: Road Surface Data (Geopackage data for Guam.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_gum_roadsurface_lines.gpkg
  format: null
  id: resource_f6dd9706
  ...
  temporal: null
  temporal_resolution: null
  title: Guam GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gum_heigit_guamroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
