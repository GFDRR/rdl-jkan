...
dataset_id: rdls_lss-ner_undrr_desinventar_b
...
loss:
  ...
  - asset_category: population
    ...
    description: 'Observed persons indirectly affected (disruption to services, commerce,
      ...
      with data out of 289 total drought events (1998-2005).'
  ...
  - asset_category: agriculture
    ...
    description: 'Observed hectares of crops/woods destroyed or affected from drought
      ...
      total drought events (1998-2005).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_drought
  ...
  - asset_category: agriculture
    ...
    description: 'Observed livestock lost from drought (DROUGHT) events in Niger.
      DesInventar records: 14 events with data out of 289 total drought events (1998-2005).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_drought
  ...
  - asset_category: population
    ...
    description: 'Observed persons whose goods/services suffered serious damage from
      ...
      out of 289 total drought events (1998-2005).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_drought
  ...
  - asset_category: population
    asset_dimension: population
    description: 'Observed persons indirectly affected (disruption to services, commerce,
      work) from flood (FLOOD) events in Niger. DesInventar records: 216 events with
      data out of 765 total flood events (1990-2012).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_flood
  ...
  - asset_category: agriculture
    ...
    description: 'Observed hectares of crops/woods destroyed or affected from flood
      (FLOOD) events in Niger. DesInventar records: 239 events with data out of 765
  ...
  - asset_category: population
    ...
    description: 'Observed deaths directly caused by disaster events from flood (FLOOD)
      events in Niger. DesInventar records: 49 events with data out of 765 total flood
      events (1990-2012).'
    disaster_identifiers: []
    hazard:
      classification: null
  ...
  - asset_category: infrastructure
    ...
    description: 'Observed educational facilities destroyed or affected from flood
      (FLOOD) events in Niger. DesInventar records: 5 events with data out of 765
      total flood events (1990-2012).'
    disaster_identifiers: []
    hazard:
      classification: null
  ...
  - asset_category: infrastructure
    ...
    description: 'Observed health facilities destroyed or affected from flood (FLOOD)
      events in Niger. DesInventar records: 1 events with data out of 765 total flood
      events (1990-2012).'
    disaster_identifiers: []
    hazard:
      classification: null
  ...
  - asset_category: buildings
    ...
    description: 'Observed homes with non-structural damage, still habitable from
      ...
      of 765 total flood events (1990-2012).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_flood
  ...
  - asset_category: buildings
    ...
    description: 'Observed homes destroyed beyond habitability from flood (FLOOD)
      events in Niger. DesInventar records: 412 events with data out of 765 total
  ...
  - asset_category: buildings
    ...
    description: 'Observed total economic losses in local currency from flood (FLOOD)
      events in Niger. DesInventar records: 11 events with data out of 765 total flood
      events (1990-2012).'
    disaster_identifiers: []
    hazard:
      classification: null
  ...
  - asset_category: agriculture
    ...
    description: 'Observed livestock lost from flood (FLOOD) events in Niger. DesInventar
      records: 122 events with data out of 765 total flood events (1990-2012).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_flood
  ...
  - asset_category: population
    ...
    description: 'Observed persons permanently relocated from homes from flood (FLOOD)
      events in Niger. DesInventar records: 2 events with data out of 765 total flood
      events (1990-2012).'
    disaster_identifiers: []
    hazard:
      classification: null
  ...
  - asset_category: population
    asset_dimension: population
    description: 'Observed persons whose goods/services suffered serious damage from
      flood (FLOOD) events in Niger. DesInventar records: 458 events with data out
      of 765 total flood events (1990-2012).'
    disaster_identifiers: []
    hazard:
      classification: null
  ...
  - asset_category: population
    ...
    description: 'Observed persons indirectly affected (disruption to services, commerce,
      ...
      78 events with data out of 310 total wildfire events (1992-2013).'
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_wildfire
...
- access_url: https://data.humdata.org/dataset/60bb0852-2e19-4150-a142-34f7fc1e2fc0
  ...
  description: DesInventar Disaster Loss and Damage Dataset for Niger (Disaster data
    for Niger)
...
- access_url: https://data.humdata.org/dataset/60bb0852-2e19-4150-a142-34f7fc1e2fc0
  ...
  conforms_to: null
  coordinate_system: null
  description: DesInventar Disaster Loss and Damage Dataset for Niger (Disaster tabular
    data for Niger)
...
- loss
schema: rdls-10
slug: rdls_lss-ner_undrr_desinventar_b
spatial:
  bbox:
  - 0.15
  - 11.7
