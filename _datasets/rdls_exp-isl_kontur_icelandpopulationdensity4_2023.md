...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-iceland
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-iceland
dataset_id: rdls_exp-isl_kontur_icelandpopulationdensity4_2023
description: 'Iceland population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-iceland]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    and aggregating counts into standardized 400m H3 hexagonal grid cells. The methodology
    overlays satellite-derived settlement layers with building footprints and land
    cover data to produce consistent, high-resolution population estimates suitable
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-iceland
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Iceland: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_IS_20220630.gpkg.gz
  format: null
  id: resource_658d4840
  ...
  title: kontur_population_IS_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Iceland: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_IS_20231101.gpkg.gz
  format: null
  id: resource_ee35c5f7
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_IS_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-isl_kontur_icelandpopulationdensity4_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Iceland: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
