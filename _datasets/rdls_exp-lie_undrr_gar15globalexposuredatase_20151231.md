...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-liechtenstein
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-liechtenstein
dataset_id: rdls_exp-lie_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-liechtenstein]'
...
- asset_type:
    description: Economic value of building stock estimated using national capital
      stock statistics distributed spatially via GDP and population proxies on 5x5
      or 1x1 km grids
    id: buildings
    scheme: null
    title: null
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Capital stock estimates at grid level derived from national GDP and
      socio-economic statistics as part of the GAR15 global exposure database
...
lineage:
  description: The GAR15 global exposure database was developed using a top-down approach
    ...
    typology, and capital stock were spatially disaggregated onto 5x5 or 1x1 km grids
    using population distribution and GDP as spatial proxies. The database was produced
    by UNEP-GRID in collaboration with WAPMERR, EU JRC, and Kokusai Kogyo for the
    2015 Global Assessment Report on Disaster Risk Reduction (GAR15). The resulting
    dataset provides gridded estimates of economic exposure for use in disaster risk
    assessments.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-liechtenstein
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Liechtenstein.zip
  download_url: https://data.humdata.org/dataset/02556e78-9eb2-495b-8e43-0b3337e35061/resource/9a8ece8f-ece7-4434-b2c6-bf83f4402a72/download/lie.zip
  format: null
  id: resource_9a8ece8f
  ...
  title: GAR15 Global Exposure Dataset for Liechtenstein.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lie_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Liechtenstein
version: null
vulnerability: null
---
