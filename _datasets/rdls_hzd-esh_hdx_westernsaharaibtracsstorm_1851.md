...
- entity:
    ...
    url: https://data.humdata.org/dataset/esh-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/esh-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-esh_hdx_westernsaharaibtracsstorm_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/esh-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. Track positions are
    recorded at regular intervals with associated wind speed (WMO standard) and central
    pressure measurements. The dataset provides empirical observations of historical
    and recent tropical cyclone characteristics for the Western Sahara region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/esh-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Western Sahara.
  download_url: https://data.humdata.org/dataset/73f62c45-8a8d-4052-bcf3-f3ece8f09fc4/resource/f7063f6c-f8ad-4294-afe1-07cfcc612770/download/ibtracs_all_list_v04r01_esh.csv
  format: null
  id: resource_f7063f6c
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ESH.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Western Sahara.
  download_url: https://data.humdata.org/dataset/73f62c45-8a8d-4052-bcf3-f3ece8f09fc4/resource/577f5f0b-b211-4f55-b255-f28feccdd1d8/download/ibtracs_all_list_v04r01_lines_esh.geojson
  format: null
  id: resource_577f5f0b
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ESH.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-esh_hdx_westernsaharaibtracsstorm_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-11-04'
temporal_resolution: null
title: 'Western Sahara: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
