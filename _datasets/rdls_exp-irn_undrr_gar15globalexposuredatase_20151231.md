...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-iran-islamic-republic-of
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-iran-islamic-republic-of
dataset_id: rdls_exp-irn_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-iran-islamic-republic-of]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    collaboration to create a globally consistent exposure database for Iran.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Iran (Islamic Republic of).zip
  download_url: https://data.humdata.org/dataset/5eddfa9d-ad64-4f37-88b6-fde12943a6b2/resource/7a81a0d4-3483-4ee9-829c-f49a6eaf853a/download/irn.zip
  format: null
  id: resource_7a81a0d4
  ...
  title: GAR15 Global Exposure Dataset for Iran (Islamic Republic of).zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-irn_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Iran (Islamic Republic of)
version: null
vulnerability: null
---
