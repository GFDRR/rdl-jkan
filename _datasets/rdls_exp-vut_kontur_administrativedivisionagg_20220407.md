...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-vanuatu
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-vanuatu
dataset_id: rdls_exp-vut_kontur_administrativedivisionagg_20220407
description: 'Vanuatu administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-vanuatu]'
...
lineage:
  description: Administrative boundaries for Vanuatu were extracted from OpenStreetMap
    and enriched with aggregated population counts derived from the Kontur global
    population density dataset at 400m H3 hexagon resolution. The dataset provides
    baseline population exposure data at administrative division levels, enriched
    with HASC codes from Wikidata.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-vanuatu
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Vanuatu: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_VU_20220407.gpkg.gz
  format: null
  id: resource_eef72027
  ...
  title: kontur_boundaries_VU_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Vanuatu: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_VU_20230628.gpkg.gz
  format: null
  id: resource_c5435b31
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_VU_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Vanuatu: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_VU_20230628.gpkg.gz
  format: null
  id: resource_bff74786
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_VU_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vut_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Vanuatu: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
