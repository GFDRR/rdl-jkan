...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-nzl_nismod_sdkicra__islands
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for New Zealand (Islands). Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539779
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539779
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    New Zealand (Islands), clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16539779/files/NZL.zip
  format: null
  id: resource_sdkicra_nzl
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - New Zealand
    (Islands)
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-nzl_nismod_sdkicra__islands
spatial:
  bbox:
  - -177.96
  - -52.6
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2186224/new-zealand.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for New Zealand
  (Islands)
version: 0.1.0
vulnerability: null
---
