...
- entity:
    ...
    url: https://data.humdata.org/dataset/tca-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/tca-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-tca_hdx_turkscaicosislandsibtracs_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tca-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Turks and Caicos Islands subset contains observed storm positions, wind speeds
    (wmo_wind), and central pressure (wmo_pres) at 6-hourly intervals, provided as
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tca-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/d46b1600-05dc-4408-94f0-347cf2623d4d/resource/78a6a2fa-575b-43a1-9d4f-7af6d11c6c30/download/ibtracs_all_list_v04r01_tca.csv
  format: null
  id: resource_78a6a2fa
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_TCA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Turks and Caicos Islands.
  download_url: https://data.humdata.org/dataset/d46b1600-05dc-4408-94f0-347cf2623d4d/resource/d96484be-db8c-4240-a104-5fc5d13c1a2e/download/ibtracs_all_list_v04r01_lines_tca.geojson
  format: null
  id: resource_d96484be
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_TCA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tca_hdx_turkscaicosislandsibtracs_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Turks and Caicos Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
