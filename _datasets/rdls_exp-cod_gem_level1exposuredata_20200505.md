...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/democratic-republic-of-the-congo-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/democratic-republic-of-the-congo-level-1-exposure-data
dataset_id: rdls_exp-cod_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/democratic-republic-of-the-congo-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    global-quality Level 1 exposure estimates. Data was processed to 15-arcsecond
    grid resolution (approximately 500 meters) and includes building counts, areas,
    and rebuilding values intended for CAT modeling and loss estimation.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/democratic-republic-of-the-congo-level-1-exposure-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Democratic Republic of the
    Congo produced by ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/7a166292-1d68-4db7-8224-0299211c7a30/resource/84e91b34-ecf6-4f9a-97a8-d1a67b27ede0/download/cod_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_84e91b34
  ...
  title: COD_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cod_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Democratic Republic of the Congo: Level 1 Exposure Data'
version: null
vulnerability: null
---
