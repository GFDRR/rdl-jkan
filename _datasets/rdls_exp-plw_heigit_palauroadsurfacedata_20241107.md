...
- entity:
    ...
    url: https://data.humdata.org/dataset/palau-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/palau-road-surface-data
dataset_id: rdls_exp-plw_heigit_palauroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/palau-road-surface-data]'
details: null
exposure:
- asset_type:
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/palau-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Palau: Road Surface Data (GeoJSON data for Palau.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_plw_roadsurface_lines.geojson
  format: null
  id: resource_ee49ac3e
  ...
  title: Palau GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Palau: Road Surface Data (Geopackage data for Palau.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_plw_roadsurface_lines.gpkg
  format: null
  id: resource_d65b46bb
  ...
  temporal: null
  temporal_resolution: null
  title: Palau GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-plw_heigit_palauroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
