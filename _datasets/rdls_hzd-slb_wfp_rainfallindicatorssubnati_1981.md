...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/slb-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/slb-rainfall-subnational
dataset_id: rdls_hzd-slb_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/slb-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery integrated
    ...
    units to compute dekadal rainfall indicators (10-day, 1-month, and 3-month rolling
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/slb-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135659296553_22821155'
  download_url: https://data.humdata.org/dataset/ecfa83cf-80e9-4f52-9ab7-5939d7c2b9e0/resource/4dd685c1-d120-469f-b969-9cb8f6af7655/download/slb-rainfall-subnat-full.csv
  format: null
  id: resource_4dd685c1
  media_type: text/csv
  spatial: null
  ...
  title: slb-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135659296553_22821155'
  download_url: https://data.humdata.org/dataset/ecfa83cf-80e9-4f52-9ab7-5939d7c2b9e0/resource/1c4f31e3-be8d-4ece-872e-1c1ed136e604/download/slb-rainfall-subnat-5ytd.csv
  format: null
  id: resource_1c4f31e3
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: slb-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-slb_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Solomon Islands: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
