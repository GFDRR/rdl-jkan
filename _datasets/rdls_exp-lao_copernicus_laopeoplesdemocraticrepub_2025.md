...
- entity:
    ...
    url: https://data.humdata.org/dataset/lao-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/lao-ghsl
dataset_id: rdls_exp-lao_copernicus_laopeoplesdemocraticrepub_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/lao-ghsl]'
...
lineage:
  description: 'The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale. For Lao PDR, two primary outputs
    are provided: a built-up surface layer derived from satellite classification and
    a population grid estimated through dasymetric mapping techniques.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lao-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/aec8a66d-c0eb-41a1-83bf-dd65c3c80b53/resource/9d0fee57-de98-4114-8151-f4e6a65fcc4d/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_lao.tif
  format: null
  id: resource_9d0fee57
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Lao People''s Democratic Republic: Copernicus Global Human Settlement
    Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system:
    Mollweide)'
  download_url: https://data.humdata.org/dataset/aec8a66d-c0eb-41a1-83bf-dd65c3c80b53/resource/d74bd47b-9860-465f-a806-c0dae33e7874/download/ghs_pop_e2025_r2023a_54009_100_v1_0_lao.tif
  format: null
  id: resource_d74bd47b
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-lao_copernicus_laopeoplesdemocraticrepub_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Lao People''s Democratic Republic: Copernicus Global Human Settlement Layer
  (GHSL)'
version: null
vulnerability: null
---
