...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-pyf_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for French Polynesia. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539788
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539788
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    French Polynesia, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16539788/files/PYF.zip
  format: null
  id: resource_sdkicra_pyf
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - French
    Polynesia
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-pyf_nismod_sdkicra
spatial:
  bbox:
  - -154.54
  - -27.64
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/4030656/french-polynesia.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for French Polynesia
version: 0.1.0
vulnerability: null
---
