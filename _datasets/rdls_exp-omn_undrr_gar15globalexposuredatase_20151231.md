...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-oman
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-oman
dataset_id: rdls_exp-omn_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-oman]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    distribution and GDP as spatial proxies. The dataset represents the economic and
    demographic exposure of Oman developed for the Global Assessment Report on Disaster
    Risk Reduction 2015 (GAR15).
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-oman
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Oman.zip
  download_url: https://data.humdata.org/dataset/b4eb8251-c9f4-405e-9f83-2b891d35e46c/resource/e4c22b0d-890e-4fd9-a44f-122b9a0a30e8/download/omn.zip
  format: null
  id: resource_e4c22b0d
  ...
  title: GAR15 Global Exposure Dataset for Oman.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-omn_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Oman
version: null
vulnerability: null
---
