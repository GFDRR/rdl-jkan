...
- entity:
    ...
    url: https://data.humdata.org/dataset/gum-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/gum-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-gum_hdx_guamibtracsstormtracks_1884
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/gum-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Guam subset contains
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gum-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Guam: IBTrACS Storm Tracks (IBTrACS storm tracks from 1884 to date
    that pass within 2000 kilometers of Guam.)'
  download_url: https://data.humdata.org/dataset/a0e1b324-5726-438a-9e10-6987fdc0cc7f/resource/00706bff-4b08-40b1-bc6e-0281a8d835ae/download/ibtracs_all_list_v04r01_gum.csv
  format: null
  id: resource_00706bff
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GUM.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Guam: IBTrACS Storm Tracks (IBTrACS storm tracks from 1884 to date
    that pass within 2000 kilometers of Guam.)'
  download_url: https://data.humdata.org/dataset/a0e1b324-5726-438a-9e10-6987fdc0cc7f/resource/f925fa56-9c89-4db1-8eb8-f4ecc3190637/download/ibtracs_all_list_v04r01_lines_gum.geojson
  format: null
  id: resource_f925fa56
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GUM.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gum_hdx_guamibtracsstormtracks_1884
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1884-07-08'
temporal_resolution: null
title: 'Guam: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
