...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-brunei-darussalam
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-brunei-darussalam
dataset_id: rdls_exp-brn_kontur_darussalamadministratived_20220407
description: 'Brunei Darussalam administrative division with aggregated population.
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-brunei-darussalam]'
...
lineage:
  description: Administrative boundaries for Brunei Darussalam were extracted from
    OpenStreetMap and enriched with aggregated population counts derived from the
    Kontur global population density dataset at 400m H3 hexagon resolution. The resulting
    dataset provides baseline population exposure at administrative division levels,
    enriched with HASC codes from Wikidata.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-brunei-darussalam
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Brunei Darussalam: Administrative Division with Aggregated Population
    (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_BN_20220407.gpkg.gz
  format: null
  id: resource_13498c09
  ...
  title: kontur_boundaries_BN_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Brunei Darussalam: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_BN_20230628.gpkg.gz
  format: null
  id: resource_ddad2ab5
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_BN_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Brunei Darussalam: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_BN_20230628.gpkg.gz
  format: null
  id: resource_d895da55
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_BN_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-brn_kontur_darussalamadministratived_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Brunei Darussalam: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
