...
- entity:
    ...
    url: https://data.humdata.org/dataset/ner-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ner-ndvi-subnational
dataset_id: rdls_hzd-ner_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ner-ndvi-subnational]'
...
lineage:
  description: MODIS Aqua and Terra 16-day composite products (MYD13C1 and MOD13C1)
    ...
    intervals at subnational administrative units defined by WFP boundaries. NDVI,
    long-term average NDVI, and NDVI anomaly percentage were computed for each dekad
    and administrative unit to provide vegetation condition monitoring for agricultural
    drought assessment.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ner-ndvi-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135859369554_008f5d82'
  download_url: https://data.humdata.org/dataset/4a9d75e8-9ecc-43d1-b678-031d61aea243/resource/16d77b72-3d18-4dcc-a0e7-54a9aa7c5e78/download/ner-ndvi-subnat-full.csv
  format: null
  id: resource_16d77b72
  media_type: text/csv
  spatial: null
  ...
  title: ner-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135859369554_008f5d82'
  download_url: https://data.humdata.org/dataset/4a9d75e8-9ecc-43d1-b678-031d61aea243/resource/9228a3a5-ae45-468c-92ba-7c4ccf6f35dc/download/ner-ndvi-subnat-5ytd.csv
  format: null
  id: resource_9228a3a5
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ner-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ner_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Niger: NDVI at Subnational Level'
version: null
vulnerability: null
---
