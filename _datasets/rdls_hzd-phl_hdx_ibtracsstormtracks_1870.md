...
- entity:
    ...
    url: https://data.humdata.org/dataset/phl-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/phl-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-phl_hdx_ibtracsstormtracks_1870
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/phl-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    standardized and quality-controlled. The Philippines subset contains all cyclones
    affecting or passing through the Philippine basin.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/phl-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1870 to date that pass within 2000 kilometers
    of Philippines.
  download_url: https://data.humdata.org/dataset/8965a621-4c4e-4085-a275-3b8d2880ee58/resource/25123c47-f9b1-4b7f-9d59-8e281f28bcb0/download/ibtracs_all_list_v04r01_phl.csv
  format: null
  id: resource_25123c47
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_PHL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1870 to date that pass within 2000 kilometers
    of Philippines.
  download_url: https://data.humdata.org/dataset/8965a621-4c4e-4085-a275-3b8d2880ee58/resource/ea4d8c5a-ed0b-4fa5-8113-4ed1e84b7e1f/download/ibtracs_all_list_v04r01_lines_phl.geojson
  format: null
  id: resource_ea4d8c5a
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_PHL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-phl_hdx_ibtracsstormtracks_1870
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1870-04-10'
temporal_resolution: null
title: 'Philippines: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
