...
- entity:
    ...
    url: https://data.humdata.org/dataset/bdi-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bdi-ghsl
dataset_id: rdls_exp-bdi_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bdi-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    the spatial distribution of human settlements and population density across Burundi.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bdi-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/b1e4f3cd-6a6e-4f84-9496-f7615e6626c8/resource/b1943aed-853d-401b-90dc-67ead7b80082/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bdi.tif
  format: null
  id: resource_b1943aed
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Burundi: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/b1e4f3cd-6a6e-4f84-9496-f7615e6626c8/resource/898293c1-b0ab-443c-92ea-1f1de619552f/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bdi.tif
  format: null
  id: resource_898293c1
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-bdi_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Burundi: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
