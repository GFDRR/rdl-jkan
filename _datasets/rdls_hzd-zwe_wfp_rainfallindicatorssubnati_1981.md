...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/zwe-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/zwe-rainfall-subnational
dataset_id: rdls_hzd-zwe_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/zwe-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    observations, processed into dekadal indicators including absolute rainfall, rolling
    1-month and 3-month aggregations, and anomalies relative to long-term climatology,
    then aggregated to Zimbabwe subnational administrative units for drought monitoring.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zwe-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135749022977_e4a4d7ca'
  download_url: https://data.humdata.org/dataset/a05510c2-bc9e-4e0b-8d81-26dee51fdca2/resource/8244cf88-e1d3-4514-9fd5-d332b7ca94c5/download/zwe-rainfall-subnat-full.csv
  format: null
  id: resource_8244cf88
  media_type: text/csv
  spatial: null
  ...
  title: zwe-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135749022977_e4a4d7ca'
  download_url: https://data.humdata.org/dataset/a05510c2-bc9e-4e0b-8d81-26dee51fdca2/resource/dd4c0e11-50b6-452b-9988-8c6d08086329/download/zwe-rainfall-subnat-5ytd.csv
  format: null
  id: resource_dd4c0e11
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: zwe-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-zwe_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Zimbabwe: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
