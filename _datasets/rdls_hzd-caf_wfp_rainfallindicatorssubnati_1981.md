...
- entity:
    ...
    url: https://data.humdata.org/dataset/caf-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/caf-rainfall-subnational
dataset_id: rdls_hzd-caf_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery integrated
    with in-situ rain gauge observations and aggregated to subnational administrative
    units. Dekadal rainfall indicators including 10-day totals, 1-month and 3-month
    rolling aggregations, and long-term climatological averages were computed to support
    drought monitoring and early warning in Central African Republic.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/caf-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135658590287_265d3af2'
  download_url: https://data.humdata.org/dataset/dc9bdc85-9982-46c8-80cc-918db6d5320a/resource/502a0ed6-61d3-4cf1-802a-6b0c40e39c7b/download/caf-rainfall-subnat-full.csv
  format: null
  id: resource_502a0ed6
  media_type: text/csv
  spatial: null
  ...
  title: caf-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135658590287_265d3af2'
  download_url: https://data.humdata.org/dataset/dc9bdc85-9982-46c8-80cc-918db6d5320a/resource/e9fc6711-6a95-4832-a650-07c44e9692f2/download/caf-rainfall-subnat-5ytd.csv
  format: null
  id: resource_e9fc6711
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: caf-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-caf_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Central African Republic: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
