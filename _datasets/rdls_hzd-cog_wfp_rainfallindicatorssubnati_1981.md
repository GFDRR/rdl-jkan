...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/cog-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/cog-rainfall-subnational
dataset_id: rdls_hzd-cog_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/cog-rainfall-subnational]'
...
lineage:
  description: Rainfall data are derived from CHIRPS satellite observations merged
    with rain gauge station data, processed into dekadal (10-day) aggregations at
    subnational administrative units. Rolling 1-month and 3-month accumulations are
    computed alongside long-term climatological averages and quantile-based anomalies
    to characterize meteorological drought conditions.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cog-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135515442723_96d0b5b9'
  download_url: https://data.humdata.org/dataset/d42146aa-47c5-413f-80d0-5d1f55fcee29/resource/f35cedcc-7326-428a-8359-4a15d6c9d0f6/download/cog-rainfall-subnat-full.csv
  format: null
  id: resource_f35cedcc
  media_type: text/csv
  spatial: null
  ...
  title: cog-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135515442723_96d0b5b9'
  download_url: https://data.humdata.org/dataset/d42146aa-47c5-413f-80d0-5d1f55fcee29/resource/da50cdb4-54a8-4f72-955b-53d14c559fb9/download/cog-rainfall-subnat-5ytd.csv
  format: null
  id: resource_da50cdb4
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: cog-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cog_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Congo: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
