...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/lka-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/lka-rainfall-subnational
dataset_id: rdls_hzd-lka_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    units into dekadal (10-day) indicators. Rolling 1-month and 3-month aggregations
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lka-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135604954764_37c12257'
  download_url: https://data.humdata.org/dataset/4302257e-5fa6-4c88-b8f7-f78730d8c48b/resource/afc6a8ca-dc55-4eb4-baf0-4afaa2c6673e/download/lka-rainfall-subnat-full.csv
  format: null
  id: resource_afc6a8ca
  media_type: text/csv
  spatial: null
  ...
  title: lka-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135604954764_37c12257'
  download_url: https://data.humdata.org/dataset/4302257e-5fa6-4c88-b8f7-f78730d8c48b/resource/f74c57d9-4297-4112-8ed5-684959655f93/download/lka-rainfall-subnat-5ytd.csv
  format: null
  id: resource_f74c57d9
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: lka-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lka_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Sri Lanka: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
