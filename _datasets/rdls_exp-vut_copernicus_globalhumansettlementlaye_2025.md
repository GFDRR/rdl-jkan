...
- entity:
    ...
    url: https://data.humdata.org/dataset/vut-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/vut-ghsl
dataset_id: rdls_exp-vut_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/vut-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distribution. For Vanuatu,
    this methodology generates raster layers of built-up areas and population density
    at national scale.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vut-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/27df5623-70ea-4557-91b8-79ea2187013e/resource/ee6dc6f9-bb88-4874-98a8-c26449413ef1/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_vut.tif
  format: null
  id: resource_ee6dc6f9
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Vanuatu: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/27df5623-70ea-4557-91b8-79ea2187013e/resource/c09e08fc-d2d6-4fbd-8154-51d3a3d08f83/download/ghs_pop_e2025_r2023a_54009_100_v1_0_vut.tif
  format: null
  id: resource_c09e08fc
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-vut_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Vanuatu: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
