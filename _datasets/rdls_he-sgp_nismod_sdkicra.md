...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-sgp_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Singapore. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540192
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540192
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Singapore, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/16540192/files/SGP.zip
  format: null
  id: resource_sdkicra_sgp
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Singapore
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-sgp_nismod_sdkicra
spatial:
  bbox:
  - 103.64
  - 1.26
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/1880251/singapore.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Singapore
version: 0.1.0
vulnerability: null
---
