...
- entity:
    ...
    url: https://data.humdata.org/dataset/benin-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
    email: null
    name: HeiGIT deep learning surface classification model
    url: https://data.humdata.org/dataset/benin-road-surface-data
  id: attribution_2
  role: collaborator
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/benin-road-surface-data
dataset_id: rdls_exp-ben_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.09 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0083 and 0.0324
  (in million kms), corressponding to 9.2005% and 35.9634% respectively of the total
  road length in the dataset region. 0.0493 million km or 54.8361% of road surface
  ...
  to 0.1129% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/benin-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    ...
    road surfaces. The resulting dataset combines OSM geometry with predicted surface
    classes and confidence metrics, providing a comprehensive infrastructure inventory
    for humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/benin-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Benin: Road Surface Data (GeoJSON data for Benin.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ben_roadsurface_lines.geojson
  format: null
  id: resource_72bd7495
  ...
  title: Benin GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Benin: Road Surface Data (Geopackage data for Benin.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ben_roadsurface_lines.gpkg
  format: null
  id: resource_d5d2f4d9
  ...
  temporal: null
  temporal_resolution: null
  title: Benin GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ben_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
