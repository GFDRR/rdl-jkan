...
- entity:
    ...
    url: https://data.humdata.org/dataset/shn-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/shn-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-shn_hdx_sainthelenaibtracsstormtr_2010
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/shn-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track archive. The dataset for Saint
    Helena contains observed storm track positions, timestamps, wind speeds (wmo_wind),
    and central pressure (wmo_pres) extracted from the global IBTrACS v4r01 database,
    filtered geographically for the Saint Helena region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/shn-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 2010 to date that pass within 2000 kilometers
    of Saint Helena.
  download_url: https://data.humdata.org/dataset/15366332-468c-4b12-b6a7-6da6ff250522/resource/dfe3cb27-98ab-493b-b4b6-d6e8579336b5/download/ibtracs_all_list_v04r01_shn.csv
  format: null
  id: resource_dfe3cb27
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SHN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 2010 to date that pass within 2000 kilometers
    of Saint Helena.
  download_url: https://data.humdata.org/dataset/15366332-468c-4b12-b6a7-6da6ff250522/resource/f5c0a15f-5535-414a-a84c-a880e00007c7/download/ibtracs_all_list_v04r01_lines_shn.geojson
  format: null
  id: resource_f5c0a15f
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SHN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-shn_hdx_sainthelenaibtracsstormtr_2010
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2010-03-08'
temporal_resolution: null
title: 'Saint Helena: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
