...
- entity:
    ...
    url: https://data.humdata.org/dataset/lao-people-s-democratic-republic-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/lao-people-s-democratic-republic-level-1-exposure-data
dataset_id: rdls_exp-lao_gem_laopeoplesdemocraticrepub_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lao-people-s-democratic-republic-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
license: CC-BY-4.0
lineage:
  description: Building exposure data was generated through the METEOR project's global-quality
    methodology using Earth observation and minimal country-specific data collection.
    The dataset provides gridded estimates of building count, area, and rebuilding
    value at 15-arcsecond resolution (~500m) across Lao PDR, designed specifically
    for catastrophe modeling and risk assessment applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project (Modelling Exposure Through Earth Observation Routines)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lao-people-s-democratic-republic-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Lao People's Democratic
    Republic produced by ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/cfdd0cc4-9c68-4490-8031-d1a7ac560a9d/resource/9b6cd453-0f9e-4fb7-aaa7-20906dd7ad75/download/lao_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_9b6cd453
  ...
  title: LAO_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lao_gem_laopeoplesdemocraticrepub_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Lao People''s Democratic Republic: Level 1 Exposure Data'
version: null
vulnerability: null
---
