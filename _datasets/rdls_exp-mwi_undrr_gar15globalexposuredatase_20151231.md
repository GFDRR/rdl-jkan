...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-malawi
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-malawi
dataset_id: rdls_exp-mwi_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-malawi]'
...
lineage:
  description: The GAR15 global exposure database for Malawi was developed using a
    ...
    Kogyo) to estimate the spatial distribution of economic value and asset exposure
    across the country.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-malawi
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Malawi.zip
  download_url: https://data.humdata.org/dataset/9fde9f65-9191-4811-82bd-1be81a352d23/resource/2262c048-f4ef-4481-bedc-a6f46b518349/download/mwi.zip
  format: null
  id: resource_2262c048
  ...
  title: GAR15 Global Exposure Dataset for Malawi.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mwi_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Malawi
version: null
vulnerability: null
---
