...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-com-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-com-settlement-extents-v3-0
dataset_id: rdls_exp-com_grid3_comsettlementextentsv30_2016
description: 'The GRID3 COM - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Comoros, in two forms: (1) settlement polygons, and (2) spatial
  ...
  in the codebooks. The current version supersedes GRID3 Comoros Settlement Extents,
  ...
  2024. GRID3 COM - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-com-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents and building counts were derived from open data
    ...
    inventories at 3-arc second (~100 meter) resolution. Spatial points represent
    centroids of settled grid cells within the derived settlement polygons, providing
    a gridded representation of human settlements across Comoros.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-com-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Comoros - GRID3 COM - Settlement Extents v3.0 (Contains information
    on data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/6460dd50-319e-4fbe-b02a-7d5db5dca090/resource/b8d72ffc-f8e0-490e-82a4-59c09927e0c6/download/grid3-com-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_b8d72ffc
  ...
  title: GRID3 COM - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Comoros - GRID3 COM - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/6460dd50-319e-4fbe-b02a-7d5db5dca090/resource/dc72f76f-e8e1-4aa2-ac78-7d5caa7781c2/download/grid3_com_settlement_extents_v3_0.zip
  format: null
  id: resource_dc72f76f
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_COM_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/6460dd50-319e-4fbe-b02a-7d5db5dca090/resource/4158d7b4-b3a1-4fb0-9925-1cd32f240c13/download/grid3_com_settlement_grid_v3_0.zip
  format: null
  id: resource_4158d7b4
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_COM_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-com_grid3_comsettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Comoros - GRID3 COM - Settlement Extents v3.0
version: null
vulnerability: null
---
