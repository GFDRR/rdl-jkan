...
- entity:
    ...
    url: https://data.humdata.org/dataset/tuv-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/tuv-ghsl
dataset_id: rdls_exp-tuv_copernicus_tuvaluglobalhumansettleme_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/tuv-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    and population distribution at global scale, applied here to Tuvalu.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tuv-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/3b783dc4-eb4c-4164-a24a-59df95d32338/resource/bc4e294d-8cf1-4492-9638-4e5ced98f6f3/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_tuv.tif
  format: null
  id: resource_bc4e294d
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Tuvalu: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/3b783dc4-eb4c-4164-a24a-59df95d32338/resource/d636bf1c-8c0c-4f3c-a69f-b0c9f234ba1b/download/ghs_pop_e2025_r2023a_54009_100_v1_0_tuv.tif
  format: null
  id: resource_d636bf1c
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-tuv_copernicus_tuvaluglobalhumansettleme_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Tuvalu: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
