...
- entity:
    ...
    url: https://data.humdata.org/dataset/omn-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/omn-ghsl
dataset_id: rdls_exp-omn_copernicus_omanglobalhumansettlement_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/omn-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    GeoTIFF layers represent the spatial distribution of human settlements and population
    density across Oman.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/omn-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/6ee86906-7c58-4741-857c-854da91c2c6a/resource/a9b500f6-fb84-493c-a624-f8b8c38b4df9/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_omn.tif
  format: null
  id: resource_a9b500f6
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Oman: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/6ee86906-7c58-4741-857c-854da91c2c6a/resource/e2de0efc-972a-488e-8eef-fa0fd3fba046/download/ghs_pop_e2025_r2023a_54009_100_v1_0_omn.tif
  format: null
  id: resource_e2de0efc
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-omn_copernicus_omanglobalhumansettlement_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Oman: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
