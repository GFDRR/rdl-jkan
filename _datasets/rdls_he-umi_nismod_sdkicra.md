...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-umi_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for North Pacific Islands (USA). Derived
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540129
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540129
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    North Pacific Islands (USA), clipped from global sources. Contents: (1) Hazard
  ...
  download_url: https://zenodo.org/records/16540129/files/UMI.zip
  format: null
  id: resource_sdkicra_umi
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - North
    Pacific Islands (USA)
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-umi_nismod_sdkicra
spatial:
  bbox:
  - -177.39
  - -0.39
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/5854968/united-states-minor-outlying-islands.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for North Pacific
  Islands (USA)
version: 0.1.0
vulnerability: null
---
