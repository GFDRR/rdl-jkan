...
- entity:
    ...
    url: https://data.humdata.org/dataset/hdx-hapi-ben
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HDX Humanitarian API Data
  url: https://data.humdata.org/dataset/hdx-hapi-ben
dataset_id: rdls_hel-ben_hdxapi_hdxhapi_1997
description: 'This dataset contains data obtained from the HDX Humanitarian API (HDX
  ...
  dataset: https://data.humdata.org/dataset/hdx-hapi-ben]'
...
- asset_type:
  ...
  - dimension: population
    ...
    measurement:
      ...
      unit: count
- asset_type:
    description: Food security and poverty indicators related to agricultural livelihoods
    id: agriculture
    scheme: null
    title: null
    uri: null
...
lineage:
  description: HDX HAPI aggregates standardized humanitarian indicators from multiple
    ...
    observed rainfall measurements, conflict event records, food security assessments,
    displacement counts, and baseline population statistics. The dataset integrates
    these heterogeneous sources through common administrative geographies and temporal
    reference periods to support humanitarian decision-making in Benin.
  sources:
  - id: source_1
    license: null
    name: Armed Conflict Location & Event Data Project (ACLED)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hdx-hapi-ben
  rel: source
loss:
  losses:
  - asset_category: agriculture
    asset_dimension: product
    description: Food insecurity and poverty impacts from drought conditions
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/f425b9e5-9a22-401a-95a1-e424b73d48f0/download/hdx_hapi_idps_ben.csv
  format: null
  id: resource_f425b9e5
  media_type: text/csv
  spatial: null
  ...
  title: 'Affected People: Internally-Displaced Persons for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/74b144e7-1e69-4e62-9e47-e68bf72cded8/download/hdx_hapi_refugees_ben.csv
  format: null
  id: resource_74b144e7
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Affected People: Refugees & Persons of Concern for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/f8160fb8-9cd1-449d-bbb6-dfacd94edb37/download/hdx_hapi_returnees_ben.csv
  format: null
  id: resource_f8160fb8
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Affected People: Returnees for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/b5aceb1a-ad4f-49f9-8d5d-edb442c52eb4/download/hdx_hapi_funding_ben.csv
  format: null
  id: resource_b5aceb1a
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Coordination & Context: Funding for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Conflict Event data from HDX HAPI, please see the documentation for
    ...
    Policy .'
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/a35d7a70-7f8e-4fa6-b244-178062c98b89/download/hdx_hapi_conflict_event_ben.csv
  format: null
  id: resource_a35d7a70
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Coordination & Context: Conflict Events for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'National Risk data from HDX HAPI, please see the documentation for
    ...
    (CC BY)'
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/c04071d7-2ac8-44ba-b156-3809a3fe81b2/download/hdx_hapi_national_risk_ben.csv
  format: null
  id: resource_c04071d7
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Coordination & Context: National Risk for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/f8482a0f-36cd-48a0-a255-e9134f707954/download/hdx_hapi_food_security_ben.csv
  format: null
  id: resource_f8482a0f
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Food Security, Nutrition & Poverty: Food Security for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Food Prices & Market Monitor data from HDX HAPI, please see the documentation
    ...
    Attribution for Intergovernmental Organisations (CC BY-IGO)'
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/4ee12155-e0fa-424d-991b-4da38df29264/download/hdx_hapi_food_price_ben.csv
  format: null
  id: resource_4ee12155
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Food Security, Nutrition & Poverty: Food Prices & Market Monitor for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Poverty Rate data from HDX HAPI, please see the documentation for
    ...
    Public Domain / No restrictions (CC0)'
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/56efdaf4-1605-4976-845c-460ea2167e03/download/hdx_hapi_poverty_rate_ben.csv
  format: null
  id: resource_56efdaf4
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Food Security, Nutrition & Poverty: Poverty Rate for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/36617d75-97d8-4e0a-ad77-2b28aedae2f7/download/hdx_hapi_population_ben.csv
  format: null
  id: resource_36617d75
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Geography & Infrastructure: Baseline Population for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Rainfall data from HDX HAPI, please see the documentation for more
    ...
    International (CC BY)'
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/827841cf-65cd-4d8e-9e5d-49666bd15d99/download/hdx_hapi_rainfall_ben.csv
  format: null
  id: resource_827841cf
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Climate: Rainfall for Benin'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/6d9555aa-af69-471c-b62d-fbb117ec6c4b/resource/00c27853-0079-45f7-bd3e-ebed38a28d55/download/hdx_hapi_data_availability_ben.csv
  format: null
  id: resource_00c27853
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: 'Metadata: Data Availability for Benin'
risk_data_type:
- hazard
- exposure
- loss
schema: rdls-10
slug: rdls_hel-ben_hdxapi_hdxhapi_1997
spatial:
  bbox: null
  centroid: null
  countries:
