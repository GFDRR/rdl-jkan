...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-mhl_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Marshall Islands. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540057
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540057
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Marshall Islands, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/16540057/files/MHL.zip
  format: null
  id: resource_sdkicra_mhl
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Marshall
    Islands
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-mhl_nismod_sdkicra
spatial:
  bbox:
  - 165.28
  - 4.57
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2080185/marshall-islands.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Marshall
  Islands
version: 0.1.0
vulnerability: null
---
