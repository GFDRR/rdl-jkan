...
- entity:
    ...
    url: https://data.humdata.org/dataset/guf-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/guf-rainfall-subnational
dataset_id: rdls_hzd-guf_wfp_frenchguianarainfallindic_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/guf-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    in French Guiana to support drought monitoring and early warning.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/guf-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135524423230_503bb9bd'
  download_url: https://data.humdata.org/dataset/629744bd-44a6-4111-bf6b-9337a4a2a79c/resource/dc880093-5733-4fa1-aa7f-61b2cc2339c8/download/guf-rainfall-subnat-full.csv
  format: null
  id: resource_dc880093
  media_type: text/csv
  spatial: null
  ...
  title: guf-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135524423230_503bb9bd'
  download_url: https://data.humdata.org/dataset/629744bd-44a6-4111-bf6b-9337a4a2a79c/resource/3af43b2d-6230-42c3-8c2e-3a7a10589795/download/guf-rainfall-subnat-5ytd.csv
  format: null
  id: resource_3af43b2d
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: guf-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-guf_wfp_frenchguianarainfallindic_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'French Guiana: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
