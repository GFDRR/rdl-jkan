...
- entity:
    ...
    url: https://data.humdata.org/dataset/gab-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/gab-ghsl
dataset_id: rdls_exp-gab_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gab-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    the spatial distribution of human settlements and population density across Gabon.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gab-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/d22cecdd-a3e0-4b22-a4db-1cf9553bff58/resource/1c860619-6941-467f-8328-35b0e72b05ee/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_gab.tif
  format: null
  id: resource_1c860619
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Gabon: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/d22cecdd-a3e0-4b22-a4db-1cf9553bff58/resource/89731548-57c1-49f4-9709-39af06a13c4c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_gab.tif
  format: null
  id: resource_89731548
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gab_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Gabon: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
