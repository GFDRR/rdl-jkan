...
dataset_id: rdls_hzd-T2M_daily_mean_min_topography_ZAF
description: "Nighttime Urban Heat Island corrected for topography. The baseline is\
...
purpose: 'This dataset is part of the scientific paper: Souverijns, N., De Ridder,
  ...
  and vulnerability analysis. Urban Climate, 46, 101331. https://doi.org/10.1016/j.uclim.2022.101336'
resources:
- coordinate_system: EPSG:4326
  description: Nighttime urban heat island effect, corrected for topography for 2001-2020.
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '0'
  spatial_resolution: null
  title: Nighttime Urban Heat Island Corrected for Topography  - Johannebsurg & Ekurhuleni
    (2001-2020)
- coordinate_system: EPSG:4326
  description: Projected nighttime urban heat island effect, corrected for topography
...
- hazard
schema: rdl-02
slug: rdls_hzd-T2M_daily_mean_min_topography_ZAF
spatial:
  bbox:
  - 27.676831894273278
  - -26.580113703331147
  ...
  - description: City of Ekurhuleni, Gauteng Province
    ...
    scheme: ISO 3166-2
  scale: sub-national
title: Nighttime Urban Heat Island Corrected for Topography
