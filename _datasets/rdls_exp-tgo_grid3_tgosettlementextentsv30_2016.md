...
- entity:
    ...
    name: Center for International Earth Science Information Network (CIESIN), Columbia
      University
    url: https://data.humdata.org/dataset/grid3-tgo-settlement-extents-v3-0
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: GRID3
  url: https://data.humdata.org/dataset/grid3-tgo-settlement-extents-v3-0
dataset_id: rdls_exp-tgo_grid3_tgosettlementextentsv30_2016
description: 'The GRID3 TGO - Settlement Extents v3.0 consists of a geographic representation
  of settlements in Togo, in two forms: (1) settlement polygons, and (2) spatial points
  ...
  in the codebooks. The current version supersedes GRID3 Togo Settlement Extents,
  ...
  2024. GRID3 TGO - Settlement Extents v3.0. New York: GRID3. [URL]. Accessed [DAY
  MONTH YEAR].. [Source: This metadata record was automatically extracted from the
  Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grid3-tgo-settlement-extents-v3-0]'
...
lineage:
  description: Settlement extents were derived from open data using a new methodology
    to generate building counts and settlement polygons. Population and building distributions
    were estimated at 3-arc second (~100 meter) grid resolution with probability values
    assigned to settled grid cells within settlement boundaries.
  sources:
  - id: source_1
    license: null
    name: Center for International Earth Science Information Network (CIESIN), Columbia
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grid3-tgo-settlement-extents-v3-0
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Togo - GRID3 TGO - Settlement Extents v3.0 (Contains information on
    data inputs, methodology, and codebooks)
  download_url: https://data.humdata.org/dataset/55de5fcb-a2ab-4ddf-8cab-f64f3c3d7f83/resource/1cfc4e89-c50d-4759-8f9e-f776a877f6c2/download/grid3-tgo-settlement-extents-v3.0-data-release-notes-.pdf
  format: null
  id: resource_1cfc4e89
  ...
  title: GRID3 TGO - Settlement Extents v3.0 - Data Release Notes .pdf
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Togo - GRID3 TGO - Settlement Extents v3.0 (A spatial layer representing
    settlement polygons)
  download_url: https://data.humdata.org/dataset/55de5fcb-a2ab-4ddf-8cab-f64f3c3d7f83/resource/fdee434a-05c7-4108-abef-d5a47f866909/download/grid3_tgo_settlement_extents_v3_0.zip
  format: null
  id: resource_fdee434a
  ...
  temporal: null
  temporal_resolution: null
  title: GRID3_TGO_settlement_extents_v3_0.zip
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  download_url: https://data.humdata.org/dataset/55de5fcb-a2ab-4ddf-8cab-f64f3c3d7f83/resource/f17467ba-5515-4591-b4ec-1420941d04b9/download/grid3_tgo_settlement_grid_v3_0.zip
  format: null
  id: resource_f17467ba
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: GRID3_TGO_settlement_grid_v3_0.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tgo_grid3_tgosettlementextentsv30_2016
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-01-01'
temporal_resolution: null
title: Togo - GRID3 TGO - Settlement Extents v3.0
version: null
vulnerability: null
---
