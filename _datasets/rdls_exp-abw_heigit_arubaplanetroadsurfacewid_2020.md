...
- entity:
    ...
    url: https://data.humdata.org/dataset/aruba-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/aruba-planet-road-surface-data
dataset_id: rdls_exp-abw_heigit_arubaplanetroadsurfacewid_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0002 million km (97.6169%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (25.662%) - PlanetScope predictions cover: 0.0002\
  \ million km (380.3946%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/aruba-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
license: CC-BY-4.0
lineage:
  description: Road network geometry and attributes were sourced from OpenStreetMap's
    global arterial road classification. Deep learning models were applied to PlanetScope
    ...
    Index (HPI) based on passability risk scores. The resulting dataset provides multi-temporal
    road infrastructure exposure data for humanitarian logistics and transportation
    planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/aruba-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Aruba: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Aruba)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AW_planet_roadsurface_lines.gpkg
  format: null
  id: resource_7530909f
  ...
  title: Aruba GPKG heigit_AW_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Aruba: Planet Road Surface, Width, and Passability Data (GeoJSON file
    for Aruba)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_AW_planet_roadsurface_lines.geojson
  format: null
  id: resource_a39895bb
  ...
  temporal: null
  temporal_resolution: null
  title: Aruba GeoJSON heigit_AW_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-abw_heigit_arubaplanetroadsurfacewid_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Aruba: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
