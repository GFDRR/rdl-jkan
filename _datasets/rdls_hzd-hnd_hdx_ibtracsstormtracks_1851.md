...
- entity:
    ...
    url: https://data.humdata.org/dataset/hnd-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/hnd-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-hnd_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/hnd-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates historical and recent tropical cyclone observations
    ...
    The Honduras subset contains observed storm tracks with ISO-formatted timestamps,
    geographic coordinates, wind speeds (wmo_wind), and central pressure (wmo_pres)
    for all tropical cyclones affecting the region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hnd-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Honduras.
  download_url: https://data.humdata.org/dataset/f0dba0e9-1db3-42a3-a07c-86473c2bd255/resource/5cc3c3fe-b42d-4d9b-9d70-1a333140634b/download/ibtracs_all_list_v04r01_hnd.csv
  format: null
  id: resource_5cc3c3fe
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_HND.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Honduras.
  download_url: https://data.humdata.org/dataset/f0dba0e9-1db3-42a3-a07c-86473c2bd255/resource/d34c7213-3cb6-4bab-a3c1-0442a49789e5/download/ibtracs_all_list_v04r01_lines_hnd.geojson
  format: null
  id: resource_d34c7213
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_HND.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-hnd_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Honduras: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
