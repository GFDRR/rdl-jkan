...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-khm_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Cambodia. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796795
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796795
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Cambodia, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/10796795/files/KHM.zip
  format: null
  id: resource_sdkicra_khm
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Cambodia
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-khm_nismod_sdkicra
spatial:
  bbox:
  - 102.31
  - 10.42
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Cambodia
version: 0.1.0
vulnerability: null
---
