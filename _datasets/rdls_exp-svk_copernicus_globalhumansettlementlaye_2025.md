...
- entity:
    ...
    url: https://data.humdata.org/dataset/svk-ghsl
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/svk-ghsl
dataset_id: rdls_exp-svk_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/svk-ghsl]'
...
exposure:
- asset_type:
    description: Built-up surface area derived from satellite imagery representing
      the spatial extent of human-built structures across Slovakia
    id: buildings
    scheme: null
    title: null
    uri: null
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Gridded population distribution for Slovakia derived from census
      data and satellite imagery integration
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: The GHSL is produced by the JRC using automated spatial data processing
    ...
    fine-scale global satellite imagery, census data, and crowdsourced geographic
    information. The pipeline extracts built-up surface extent and population distribution
    through machine learning and image classification methods. The resulting gridded
    datasets provide evidence-based spatial analytics of human presence for use in
    risk assessment, urban planning, and disaster preparedness.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/svk-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/01a82d31-f681-4a4e-a230-908b44b145ae/resource/894f4949-82b6-4ad7-9557-30c5010f9623/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_svk.tif
  format: null
  id: resource_894f4949
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Slovakia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/01a82d31-f681-4a4e-a230-908b44b145ae/resource/80e0c5d3-b986-494d-a50c-4d7f1a8f4d2d/download/ghs_pop_e2025_r2023a_54009_100_v1_0_svk.tif
  format: null
  id: resource_80e0c5d3
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-svk_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Slovakia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
