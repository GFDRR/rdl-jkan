...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-vnm_nismod_sdkicra__vietnam
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Vietnam. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796572
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796572
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Vietnam, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/10796572/files/VNM.zip
  format: null
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Vietnam
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-vnm_nismod_sdkicra__vietnam
spatial:
  bbox:
  - 102.12
  - 8.57
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Vietnam
version: 0.1.0
vulnerability: null
---
