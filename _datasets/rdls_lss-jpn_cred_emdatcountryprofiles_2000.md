...
creator:
  ...
  name: Centre for Research on the Epidemiology of Disasters
  url: https://data.humdata.org/dataset/emdat-country-profiles-jpn
dataset_id: rdls_lss-jpn_cred_emdatcountryprofiles_2000
description: 'Aggregated figures for natural hazard related events in EM-DAT: Japan
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/emdat-country-profiles-jpn]'
details: null
exposure: []
hazard: null
license: CC-BY-4.0
lineage:
  description: EM-DAT aggregates disaster event records from multiple sources including
    ...
    dataset presents compiled statistics for Japan across multiple hazard types, with
    total events, affected populations, deaths, and economic damages (both original
    and inflation-adjusted USD values) organized by disaster group, subgroup, type,
    and subtype.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/emdat-country-profiles-jpn
  rel: source
loss:
  losses:
  ...
  - asset_category: economic_indicator
    ...
    description: Total economic damage in USD from earthquake events
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_earthquake
  ...
  - asset_category: economic_indicator
    asset_dimension: index
    description: Total economic damage in USD from flood events
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_flood
  ...
  - asset_category: economic_indicator
    asset_dimension: index
    description: Total economic damage in USD from strong wind events
    disaster_identifiers: []
    hazard:
      classification: null
      id: hazard_strong_wind
...
- access_url: null
  ...
  description: 'EM-DAT - Country Profiles, Japan (Version: 2026-01-30)'
  download_url: https://data.humdata.org/dataset/746744c9-2e2c-45fa-b0c5-59d7c7d594a7/resource/e32c9180-674a-41ad-9321-81ed490c573b/download/emdat-country-profiles_jpn_2026_01_30.xlsx
  format: null
  id: resource_e32c9180
  ...
  title: EMDAT-country-profiles_JPN_2026_01_30.xlsx
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-jpn_cred_emdatcountryprofiles_2000
spatial:
  bbox: null
  centroid: null
  countries:
