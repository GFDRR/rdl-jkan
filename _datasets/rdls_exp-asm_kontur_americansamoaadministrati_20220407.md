...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-american-samoa
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-american-samoa
dataset_id: rdls_exp-asm_kontur_americansamoaadministrati_20220407
description: 'American Samoa administrative division with aggregated population. Built
  ...
  dataset: https://data.humdata.org/dataset/kontur-boundaries-american-samoa]'
...
lineage:
  description: Administrative boundaries for American Samoa were extracted from OpenStreetMap
    and enriched with aggregated population counts derived from the Kontur Population
    global density dataset at 400m H3 hexagon resolution. The dataset provides baseline
    population exposure data at administrative division levels, enriched with HASC
    codes from Wikidata.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-american-samoa
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'American Samoa: Administrative Division with Aggregated Population
    (Release 2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_AS_20220407.gpkg.gz
  format: null
  id: resource_53df96b8
  ...
  title: kontur_boundaries_AS_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'American Samoa: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_AS_20230628.gpkg.gz
  format: null
  id: resource_f3ed72f3
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_AS_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'American Samoa: Administrative Division with Aggregated Population
    (Release 2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_AS_20230628.gpkg.gz
  format: null
  id: resource_6a8f288d
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_AS_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-asm_kontur_americansamoaadministrati_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'American Samoa: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
