...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/pol-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/pol-rainfall-subnational
dataset_id: rdls_hzd-pol_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/pol-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    observations, processed into dekadal indicators (10-day, 1-month, 3-month rolling
    aggregations) and aggregated by Polish subnational administrative units to support
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/pol-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135546787554_66a3ef2e'
  download_url: https://data.humdata.org/dataset/e766c543-e600-4445-8c2c-c1d31e52b3d5/resource/8a975a5d-77af-4368-8407-02566f61ba71/download/pol-rainfall-subnat-full.csv
  format: null
  id: resource_8a975a5d
  media_type: text/csv
  spatial: null
  ...
  title: pol-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135546787554_66a3ef2e'
  download_url: https://data.humdata.org/dataset/e766c543-e600-4445-8c2c-c1d31e52b3d5/resource/0fa4d2bd-ff77-418d-9fd0-415e9b1c3c03/download/pol-rainfall-subnat-5ytd.csv
  format: null
  id: resource_0fa4d2bd
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: pol-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-pol_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Poland: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
