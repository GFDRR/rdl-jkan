...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-shn_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Saint Helena. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540133
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540133
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Saint Helena, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16540133/files/SHN.zip
  format: null
  id: resource_sdkicra_shn
...
- exposure
schema: rdls-10
slug: rdls_he-shn_nismod_sdkicra
spatial:
  bbox:
  - -14.42
  - -40.4
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3370751/saint-helena.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Saint Helena
version: 0.1.0
vulnerability: null
---
