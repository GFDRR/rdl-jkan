...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-saint-barthelemy
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-saint-barthelemy
dataset_id: rdls_exp-blm_kontur_saintbarthelemypopulation_2023
description: "Saint Barth\xE9lemy population density for 400m H3 hexagons. Built from\
  \ Kontur Population: Global Population Density for 400m H3 Hexagons Vector H3 hexagons\
  \ with population counts at 400m resolution. Fixed up fusion of GHSL, Facebook,\
  \ Microsoft Buildings, Copernicus Global Land Service Land Cover, Land Information\
  \ New Zealand, and OpenStreetMap data.. [Source: This metadata record was automatically\
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-saint-barthelemy]"
...
exposure:
- asset_type:
    description: Population counts aggregated to 400m H3 hexagonal grid cells derived
      from multi-source settlement data
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: "Population density was estimated by fusing multiple global datasets\
    \ (GHSL, Facebook HRSL, Microsoft Buildings, Copernicus Land Cover, and OpenStreetMap)\
    \ and aggregating results to 400m H3 hexagonal grid cells using the H3 hierarchical\
    \ spatial indexing system. The methodology overlays satellite-derived settlement\
    \ layers with building footprints and land cover data to allocate population counts\
    \ spatially at high resolution for Saint Barth\xE9lemy."
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-saint-barthelemy
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: "Saint Barth\xE9lemy: Population Density for 400m H3 Hexagons (Release\
    \ 2022-06-30)"
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_BL_20220630.gpkg.gz
  format: null
  id: resource_3228ba5d
  ...
  title: kontur_population_BL_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: "Saint Barth\xE9lemy: Population Density for 400m H3 Hexagons (Release\
    \ 2023-11-01)"
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_BL_20231101.gpkg.gz
  format: null
  id: resource_a151edf3
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_BL_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-blm_kontur_saintbarthelemypopulation_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: "Saint Barth\xE9lemy: Population Density for 400m H3 Hexagons"
version: null
vulnerability: null
---
