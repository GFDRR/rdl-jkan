...
- entity:
    ...
    url: https://data.humdata.org/dataset/liberia-motorised-travel-time-in-seconds-to-nearest-health-centre
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Data for Children Collaborative
  url: https://data.humdata.org/dataset/liberia-motorised-travel-time-in-seconds-to-nearest-health-centre
dataset_id: rdls_exp-lbr_d4cc_motorisedtraveltimesecond_20240801
description: 'A 100 m spatial resolution geotiff of motorised travel time in seconds
  to nearest health facility in Liberia. The data was generated using the Child Poverty
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/liberia-motorised-travel-time-in-seconds-to-nearest-health-centre]'
...
lineage:
  description: Travel time surface generated using the CPAS least cost path method,
    ...
    on all-weather roads and walking speeds on other terrain types, applied to a 100
    m resolution grid across Liberia to quantify accessibility to health infrastructure.
  sources:
  - id: source_1
    license: null
    name: Child Poverty and Access to Services (CPAS) software
...
- access_url: null
  ...
  download_url: https://s3.eidf.ac.uk/eidf158-motorised-travel-time-maps/service_area_Liberia_motorised.tif
  format: null
  id: resource_27256f12
  ...
  title: service-area-liberia-motorised.tif
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-lbr_d4cc_motorisedtraveltimesecond_20240801
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-08-01'
temporal_resolution: null
title: Liberia Motorised Travel Time (in seconds) to nearest health centre
version: null
vulnerability: null
---
