...
- entity:
    ...
    url: https://data.humdata.org/dataset/south-africa-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/south-africa-planet-road-surface-data
dataset_id: rdls_exp-zaf_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ surface conditions in many regions. Summary of Road Statistics Approximately 0.074\
  \ million km of arterial roads are mapped in OSM in this region. - Paved roads:\
  \ 0.067 million km (90.4883%) - Unpaved roads: 0.0047 million km (6.3582%) - Missing\
  \ OSM surface tags: 0.0 million km (0.0636%) - PlanetScope predictions cover: 0.0717\
  \ million km (152173.3154%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/south-africa-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for South Africa's
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/south-africa-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'South Africa: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for South africa)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_ZA_planet_roadsurface_lines.geojson
  format: null
  id: resource_afc7ddb5
  ...
  title: South africa GeoJSON heigit_ZA_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'South Africa: Planet Road Surface, Width, and Passability Data (Geopackage
    file for South africa)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_ZA_planet_roadsurface_lines.gpkg
  format: null
  id: resource_c1686f01
  ...
  temporal: null
  temporal_resolution: null
  title: South africa GPKG heigit_ZA_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-zaf_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'South Africa: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
