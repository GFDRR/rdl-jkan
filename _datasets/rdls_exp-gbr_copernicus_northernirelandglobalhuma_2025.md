...
- entity:
    ...
    url: https://data.humdata.org/dataset/gbr-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/gbr-ghsl
dataset_id: rdls_exp-gbr_copernicus_northernirelandglobalhuma_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gbr-ghsl]'
...
exposure:
- asset_type:
    description: Built-up surface area derived from satellite imagery for the United
      Kingdom, representing the spatial extent of human-constructed surfaces
    id: buildings
    scheme: null
    title: null
    uri: null
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Gridded population distribution for the United Kingdom, integrating
      census data and satellite-derived settlement information
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: The GHSL datasets are produced by the JRC using automated spatial data
    processing pipelines that integrate fine-scale satellite imagery, census data,
    and crowdsourced geographic information. The GHS Built-up Surface layer is derived
    from multi-temporal satellite image analysis to map human-constructed surfaces,
    while the GHS Population Grid redistributes census population counts into a regular
    spatial grid using built-up surface information as a dasymetric ancillary layer.
    These products provide spatially explicit exposure data on human settlements and
    population distribution for use in disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gbr-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/00ee35b6-4094-4397-b9fc-cc35ba2b574d/resource/b11033d6-6ffe-4719-899e-89d849e3cdca/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_gbr.tif
  format: null
  id: resource_b11033d6
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'United Kingdom of Great Britain and Northern Ireland: Copernicus Global
    Human Settlement Layer (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m,
    Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/00ee35b6-4094-4397-b9fc-cc35ba2b574d/resource/c87cb64f-1d9c-423c-a738-75b11b0eac0f/download/ghs_pop_e2025_r2023a_54009_100_v1_0_gbr.tif
  format: null
  id: resource_c87cb64f
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gbr_copernicus_northernirelandglobalhuma_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'United Kingdom of Great Britain and Northern Ireland: Copernicus Global Human
