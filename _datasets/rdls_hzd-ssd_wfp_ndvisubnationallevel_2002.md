...
- entity:
    ...
    url: https://data.humdata.org/dataset/ssd-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ssd-ndvi-subnational
dataset_id: rdls_hzd-ssd_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ssd-ndvi-subnational]'
...
lineage:
  description: MODIS Aqua and Terra 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI indicators. Raw NDVI values, long-term averages, and percentage anomalies
    were calculated and aggregated by WFP-defined subnational administrative units
    with Pcode identifiers to create a time series dataset for agricultural drought
    monitoring.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ssd-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135700006278_63457cd0'
  download_url: https://data.humdata.org/dataset/5071416d-e656-4af3-8179-057332e968f5/resource/04a1d2b4-ff9d-4d06-96b2-385d8fb78040/download/ssd-ndvi-subnat-full.csv
  format: null
  id: resource_04a1d2b4
  media_type: text/csv
  spatial: null
  ...
  title: ssd-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135700006278_63457cd0'
  download_url: https://data.humdata.org/dataset/5071416d-e656-4af3-8179-057332e968f5/resource/dca70d6c-d6ab-4923-874b-f855c53f12c6/download/ssd-ndvi-subnat-5ytd.csv
  format: null
  id: resource_dca70d6c
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ssd-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ssd_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'South Sudan: NDVI at Subnational Level'
version: null
vulnerability: null
---
