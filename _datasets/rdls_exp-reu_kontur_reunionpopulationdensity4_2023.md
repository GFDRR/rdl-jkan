...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-reunion
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-reunion
dataset_id: rdls_exp-reu_kontur_reunionpopulationdensity4_2023
description: "R\xE9union population density for 400m H3 hexagons. Built from Kontur\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-reunion]"
...
exposure:
- asset_type:
    description: Population counts distributed across 400m H3 hexagonal grid cells
...
license: CC-BY-4.0
lineage:
  description: "Population density was derived by fusing multiple global datasets\
    \ (GHSL, Facebook HRSL, Microsoft Buildings, Copernicus Land Cover, and OpenStreetMap)\
    \ and allocating population counts to 400m H3 hexagonal grid cells using spatial\
    \ overlay and integration methods. The resulting dataset provides baseline population\
    \ exposure at high spatial resolution for R\xE9union."
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-reunion
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: "R\xE9union: Population Density for 400m H3 Hexagons (Release 2022-06-30)"
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_RE_20220630.gpkg.gz
  format: null
  id: resource_ff1dbae1
  ...
  title: kontur_population_RE_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: "R\xE9union: Population Density for 400m H3 Hexagons (Release 2023-11-01)"
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_RE_20231101.gpkg.gz
  format: null
  id: resource_5dcb77b0
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_RE_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-reu_kontur_reunionpopulationdensity4_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: "R\xE9union: Population Density for 400m H3 Hexagons"
version: null
vulnerability: null
---
