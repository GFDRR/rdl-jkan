...
- entity:
    ...
    url: https://data.humdata.org/dataset/eswatini-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/eswatini-planet-road-surface-data
dataset_id: rdls_exp-swz_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0016 million km (80.7488%) - Unpaved roads: 0.0003 million km (17.2772%) - Missing\
  \ OSM surface tags: 0.0001 million km (2.74%) - PlanetScope predictions cover: 0.0019\
  \ million km (3577.6398%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/eswatini-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Eswatini. Deep learning models were applied to PlanetScope satellite imagery
    ...
    accessibility for humanitarian logistics and transportation planning.
  sources:
  - id: source_1
    license: null
    name: PlanetScope satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/eswatini-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Eswatini: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Eswatini)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_SZ_planet_roadsurface_lines.gpkg
  format: null
  id: resource_343cf0b2
  ...
  title: Eswatini GPKG heigit_SZ_planet_roadsurface_lines.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Eswatini: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Eswatini)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_SZ_planet_roadsurface_lines.geojson
  format: null
  id: resource_bea29b19
  ...
  temporal: null
  temporal_resolution: null
  title: Eswatini GeoJSON heigit_SZ_planet_roadsurface_lines.geojson
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-swz_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Eswatini: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
