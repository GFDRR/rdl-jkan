...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/burkina-faso-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/burkina-faso-level-1-exposure-data
dataset_id: rdls_exp-bfa_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/burkina-faso-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    a 15-arcsecond grid resolution (approximately 500 meters at the equator) in point
    shapefile format for use in catastrophe modeling and disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/burkina-faso-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Burkina Faso produced by
    ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/fbc08c60-5cad-4260-8014-87e2c385d4d3/resource/58f0cedd-9c4a-488c-879a-17cbc92becc5/download/bfa_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_58f0cedd
  ...
  title: BFA_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bfa_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Burkina Faso: Level 1 Exposure Data'
version: null
vulnerability: null
---
