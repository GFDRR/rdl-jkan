...
- entity:
    ...
    url: https://data.humdata.org/dataset/bra-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bra-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bra_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bra-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    wind speed (wmo_wind), and pressure (wmo_pres) at 6-hourly intervals. Data is
    provided as both tabular CSV and geospatial GeoJSON line geometries for Brazil.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bra-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Brazil.
  download_url: https://data.humdata.org/dataset/235a4cdb-a2ee-4e72-8352-55a8a17eb427/resource/3f6e9c42-1755-4ecd-8d27-70010e7524c1/download/ibtracs_all_list_v04r01_bra.csv
  format: null
  id: resource_3f6e9c42
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BRA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Brazil.
  download_url: https://data.humdata.org/dataset/235a4cdb-a2ee-4e72-8352-55a8a17eb427/resource/16d89798-3974-49e2-a447-ec23f1bd6843/download/ibtracs_all_list_v04r01_lines_bra.geojson
  format: null
  id: resource_16d89798
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BRA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bra_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-07-10'
temporal_resolution: null
title: 'Brazil: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
