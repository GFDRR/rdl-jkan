...
description: This dataset provides a collection of land use exposure datasets for
  ...
  and property values in the Kaalspruit Region of Ekurhuleni.
...
- coordinate_system: 'EPSG: 4326'
  description: This dataset provides the classification of land use types within the
    ...
    open spaces, residential and roads.
  download_url: null
  format: geojson
  id: '2'
  spatial_resolution: null
  title: Johannesburg_LanduseExposure_Kaalspruit
risk_data_type:
- exposure
schema: rdl-02
spatial:
  ...
  - description: City of Johannesburg, Gauteng Province
    ...
    scheme: ISO 3166-2
  scale: sub-national
title: Kaalspruit Land Use & Property Value Exposure
