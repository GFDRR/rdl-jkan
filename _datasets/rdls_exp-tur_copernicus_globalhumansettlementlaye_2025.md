...
- entity:
    ...
    url: https://data.humdata.org/dataset/tur-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/tur-ghsl
dataset_id: rdls_exp-tur_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/tur-ghsl]'
...
lineage:
  description: 'The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. Two primary outputs are provided: GHS Built-up Surface (representing
    built infrastructure extent) and GHS Population Grid (representing human population
    density), both derived from multi-source geospatial data fusion.'
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tur-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/418260ae-b978-4a13-845e-b7b029173b2a/resource/5e8291f1-882a-4811-8e58-aef79e9bd5c2/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_tur.tif
  format: null
  id: resource_5e8291f1
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: "T\xFCrkiye: Copernicus Global Human Settlement Layer (GHSL) (Product:\
    \ GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)"
  download_url: https://data.humdata.org/dataset/418260ae-b978-4a13-845e-b7b029173b2a/resource/b4f6af91-586f-47fc-a30c-f4588d1c71cd/download/ghs_pop_e2025_r2023a_54009_100_v1_0_tur.tif
  format: null
  id: resource_b4f6af91
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-tur_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: "T\xFCrkiye: Copernicus Global Human Settlement Layer (GHSL)"
version: null
vulnerability: null
---
