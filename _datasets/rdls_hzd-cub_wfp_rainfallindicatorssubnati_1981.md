...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/cub-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/cub-rainfall-subnational
dataset_id: rdls_hzd-cub_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/cub-rainfall-subnational]'
...
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with station
    observations and aggregated by subnational administrative units into dekadal indicators.
    Multiple rolling aggregations (1-month, 3-month) and long-term climatological
    averages computed to support drought monitoring and early warning at the subnational
    level.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cub-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135454789522_6a163950'
  download_url: https://data.humdata.org/dataset/fe215a3f-66fd-4796-ace9-27b578cac8fa/resource/2698dbca-7598-4d02-8f0d-0ada671e2731/download/cub-rainfall-subnat-full.csv
  format: null
  id: resource_2698dbca
  media_type: text/csv
  spatial: null
  ...
  title: cub-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135454789522_6a163950'
  download_url: https://data.humdata.org/dataset/fe215a3f-66fd-4796-ace9-27b578cac8fa/resource/4b53c4d3-4895-4567-834d-3b20467fcd94/download/cub-rainfall-subnat-5ytd.csv
  format: null
  id: resource_4b53c4d3
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: cub-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cub_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Cuba: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
