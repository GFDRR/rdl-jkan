...
- entity:
    ...
    url: https://data.humdata.org/dataset/saint-vincent-and-the-grenadines-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/saint-vincent-and-the-grenadines-road-surface-data
dataset_id: rdls_exp-vct_heigit_saintvincentgrenadinesroa_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/saint-vincent-and-the-grenadines-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    learning algorithm to classify and predict road surface types (paved vs unpaved).
    The model generated predictions for unmapped or uncertain road segments, with
    results integrated into a combined surface classification prioritizing either
    OSM or deep learning predictions. The final dataset provides road geometry with
    surface classifications for Saint Vincent and the Grenadines.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- access_url: null
  ...
  description: 'Saint Vincent and the Grenadines: Road Surface Data (GeoJSON data
    for Saint vincent and the grenadines.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_vct_roadsurface_lines.geojson
  format: null
  id: resource_b9ee875c
  ...
  title: Saint vincent and the grenadines GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Saint Vincent and the Grenadines: Road Surface Data (Geopackage data
    for Saint vincent and the grenadines.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_vct_roadsurface_lines.gpkg
  format: null
  id: resource_7a31c172
  ...
  temporal: null
  temporal_resolution: null
  title: Saint vincent and the grenadines GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vct_heigit_saintvincentgrenadinesroa_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Saint Vincent and the Grenadines: Road Surface Data'
version: null
vulnerability: null
---
