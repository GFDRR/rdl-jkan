...
- entity:
    ...
    url: https://data.humdata.org/dataset/cfp-reconstruction-042017
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Inter Agency Common Feedback Project Nepal (inactive)
  url: https://data.humdata.org/dataset/cfp-reconstruction-042017
dataset_id: rdls_lss-npl_iacfnpl_cfpreconstructionsurvey_201704
description: 'This data is collected from the survey conducted in 14 earthquake affected
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cfp-reconstruction-042017]'
details: null
exposure: []
hazard: null
license: CC-BY-4.0
lineage:
  description: "Post-event household survey of 2,100 respondents conducted in May\
    \ 2017 across 14 earthquake-affected districts in Nepal, targeting VDCs with \xE2\
    \u2030\xA560% household eligibility for housing reconstruction grants. Survey\
    \ data captures direct impacts on housing and reconstruction needs resulting from\
    \ the 2015 earthquake."
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cfp-reconstruction-042017
  rel: source
loss:
  losses:
  - asset_category: buildings
    asset_dimension: structure
    description: Household-level survey data on reconstruction needs and housing damage
...
- access_url: null
  ...
  description: This data is collected from the survey conducted in 14 earthquake affected
    district in Nepal in May 2017. Total of 2100 respondent were interviewed.
  download_url: https://data.humdata.org/dataset/2244853a-91d0-41b7-bc1b-f146100dcb03/resource/9939d4e8-dc48-45e1-93a9-ebb3da79ee5c/download/reconstruction_data_052017.xlsx
  format: null
  id: resource_9939d4e8
  ...
  title: CFP Reconstruction_2100_data set - April 201717.xlsx
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-npl_iacfnpl_cfpreconstructionsurvey_201704
spatial:
  bbox: null
  centroid: null
  countries:
