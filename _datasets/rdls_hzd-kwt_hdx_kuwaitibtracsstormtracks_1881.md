...
- entity:
    ...
    url: https://data.humdata.org/dataset/kwt-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/kwt-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-kwt_hdx_kuwaitibtracsstormtracks_1881
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kwt-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    unified best-track dataset. The Kuwait subset contains observed storm positions,
    wind speeds (wmo_wind), central pressures (wmo_pres), and storm classification
    (nature) at 6-hourly intervals, representing actual cyclone observations rather
    than modeled hazard.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kwt-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1881 to date that pass within 2000 kilometers
    of Kuwait.
  download_url: https://data.humdata.org/dataset/d316d5ca-dce1-4c0a-857d-3a98cd768a4c/resource/7f4cc51d-8a0a-46c1-8dc9-d46f18f13af2/download/ibtracs_all_list_v04r01_kwt.csv
  format: null
  id: resource_7f4cc51d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_KWT.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1881 to date that pass within 2000 kilometers
    of Kuwait.
  download_url: https://data.humdata.org/dataset/d316d5ca-dce1-4c0a-857d-3a98cd768a4c/resource/0718db8e-2d70-4049-b6fd-3ab493780015/download/ibtracs_all_list_v04r01_lines_kwt.geojson
  format: null
  id: resource_0718db8e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_KWT.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-kwt_hdx_kuwaitibtracsstormtracks_1881
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1881-05-26'
temporal_resolution: null
title: 'Kuwait: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
