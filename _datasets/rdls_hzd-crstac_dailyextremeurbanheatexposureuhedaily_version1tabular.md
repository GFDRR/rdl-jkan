...
creator:
  ...
  name: NASA
  url: https://doi.org/10.7927/fq7g-ny13
dataset_id: rdls_hzd-crstac_dailyextremeurbanheatexposureuhedaily_version1tabular
description: 'High Resolution Daily Extreme Urban Heat Exposure, calculated for five
  combined temperture-humidity thresholds, tabular data with lat/lon coordinates [Source:
...
resources:
- access_url: https://climate-risk-data.github.io/climate-risk-stac/stac/hazard/temperature-related/daily-extreme-urban-heat-exposure-uhe-daily/version-1-tabular/version-1-tabular.json
  ...
  title: 'STAC Item: Daily Extreme Urban Heat Exposure (UHE-Daily) - version 1 tabular'
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: Daily Extreme Urban Heat Exposure (UHE-Daily) - version 1 tabular -
    data file
  download_url: https://data.earthdata.nasa.gov/nasa-earth/human-dimensions/sedac-root/downloads/data/sdei/sdei-high-res-daily-uhe-1983-2016/sdei-high-res-daily-uhe-1983-2016-csv-json.zip
  format: null
  ...
  temporal: null
  temporal_resolution: null
  title: Daily Extreme Urban Heat Exposure (UHE-Daily) - version 1 tabular - data
    file
- access_url: https://doi.org/10.1073/pnas.2024792118
  ...
  conforms_to: null
  coordinate_system: null
  description: Daily Extreme Urban Heat Exposure (UHE-Daily) - version 1 tabular (Web
    reference)
  download_url: null
...
- access_url: https://github.com/ecohydro/GlobalUrbanHeat
  ...
  conforms_to: null
  coordinate_system: null
  description: Daily Extreme Urban Heat Exposure (UHE-Daily) - version 1 tabular (Code
    link)
  download_url: null
  format: Web reference
...
- hazard
schema: rdls-10
slug: rdls_hzd-crstac_dailyextremeurbanheatexposureuhedaily_version1tabular
spatial:
  bbox:
  - -180.0
  - -90.0
...
title: Daily Extreme Urban Heat Exposure (UHE-Daily) - version 1 tabular
version: null
vulnerability: null
---
