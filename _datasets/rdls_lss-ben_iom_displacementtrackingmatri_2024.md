...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/ben-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/ben-iom-dtm-from-api
dataset_id: rdls_lss-ben_iom_displacementtrackingmatri_2024
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ben-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through field assessments (baseline,
    emergency tracking, and site-based) across Benin, aggregating internally displaced
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ben-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Benin IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/3348bd51-0e8a-4b5f-b23f-c7b6468b8c37/resource/daf140c2-d4ce-4e03-8d8e-2d0411a61b8f/download/ben-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_daf140c2
  media_type: text/csv
  spatial: null
  ...
  title: Benin IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-ben_iom_displacementtrackingmatri_2024
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-02-29'
temporal_resolution: null
title: Benin IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
