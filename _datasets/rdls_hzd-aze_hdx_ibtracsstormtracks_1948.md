...
- entity:
    ...
    url: https://data.humdata.org/dataset/aze-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/aze-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-aze_hdx_ibtracsstormtracks_1948
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/aze-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Azerbaijan subset
    contains observed storm tracks with ISO timestamps, basin/subbasin classifications,
    wind speed (wmo_wind), and central pressure (wmo_pres) measurements. Data are
    provided as both tabular CSV and geospatial GeoJSON line geometries representing
    the historical cyclone paths.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/aze-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1948 to date that pass within 2000 kilometers
    of Azerbaijan.
  download_url: https://data.humdata.org/dataset/6dba2896-4af6-4aaa-a553-e393ba94d15b/resource/71f701c9-38fc-4b37-b070-2096cb02001a/download/ibtracs_all_list_v04r01_aze.csv
  format: null
  id: resource_71f701c9
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_AZE.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1948 to date that pass within 2000 kilometers
    of Azerbaijan.
  download_url: https://data.humdata.org/dataset/6dba2896-4af6-4aaa-a553-e393ba94d15b/resource/1b6ba62f-9528-4a16-80bf-b788db6db83e/download/ibtracs_all_list_v04r01_lines_aze.geojson
  format: null
  id: resource_1b6ba62f
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_AZE.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-aze_hdx_ibtracsstormtracks_1948
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1948-10-19'
temporal_resolution: null
title: 'Azerbaijan: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
