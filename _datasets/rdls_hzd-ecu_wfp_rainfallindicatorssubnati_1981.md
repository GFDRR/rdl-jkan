...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/ecu-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ecu-rainfall-subnational
dataset_id: rdls_hzd-ecu_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data are derived from CHIRPS satellite observations merged
    ...
    (10-day, 1-month, 3-month rolling totals and anomalies) at subnational administrative
    units in Ecuador. These indicators support drought monitoring and early warning
    by comparing current rainfall to long-term climatological averages.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with insitu Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ecu-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135827209014_3895c690'
  download_url: https://data.humdata.org/dataset/71e7771b-fbb6-4a57-a63f-d149567ea6a4/resource/88ea921b-257f-4a5c-b603-4ec1566e854e/download/ecu-rainfall-subnat-full.csv
  format: null
  id: resource_88ea921b
  media_type: text/csv
  spatial: null
  ...
  title: ecu-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135827209014_3895c690'
  download_url: https://data.humdata.org/dataset/71e7771b-fbb6-4a57-a63f-d149567ea6a4/resource/0c4bf99e-be96-4f71-bca8-ce1da0324f35/download/ecu-rainfall-subnat-5ytd.csv
  format: null
  id: resource_0c4bf99e
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ecu-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ecu_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Ecuador: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
