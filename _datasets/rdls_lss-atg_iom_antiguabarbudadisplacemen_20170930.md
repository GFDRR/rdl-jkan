...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/atg-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/atg-iom-dtm-from-api
dataset_id: rdls_lss-atg_iom_antiguabarbudadisplacemen_20170930
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/atg-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM collects displacement data through field assessments and tracking
    ...
    by displacement reason, demographics (gender), origin location, and assessment
    type (baseline, emergency tracking, or site assessment), then published via the
    DTM API for humanitarian access.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/atg-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Antigua and Barbuda IOM displacement tracking matrix data at admin
    levels 0-1, sourced from the DTM API
  download_url: https://data.humdata.org/dataset/3ae37fb0-39bf-41bf-bd46-4eed308b9083/resource/6e88adf2-2309-48aa-b33b-e601ea88a59e/download/atg-iom-dtm-from-api-admin-0-to-1.csv
  format: null
  id: resource_6e88adf2
  media_type: text/csv
  spatial: null
  ...
  title: Antigua and Barbuda IOM DTM data for admin levels 0-1
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-atg_iom_antiguabarbudadisplacemen_20170930
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2017-09-30'
temporal_resolution: null
title: Antigua and Barbuda IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
