...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/dom-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/dom-rainfall-subnational
dataset_id: rdls_hzd-dom_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/dom-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with rain gauge station data, then aggregated by dekad (10-day period) and subnational
    administrative units. Rolling 1-month and 3-month aggregations were computed alongside
    long-term climatological averages and standardized anomaly indices (rfq, r1q,
    r3q) to enable drought monitoring and early warning at the subnational level.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dom-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135534876527_9c69fa27'
  download_url: https://data.humdata.org/dataset/fb41ffe8-966d-44a4-a935-3cb348517cad/resource/45ccc397-a1ab-4858-94e4-20342e262fe0/download/dom-rainfall-subnat-full.csv
  format: null
  id: resource_45ccc397
  media_type: text/csv
  spatial: null
  ...
  title: dom-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135534876527_9c69fa27'
  download_url: https://data.humdata.org/dataset/fb41ffe8-966d-44a4-a935-3cb348517cad/resource/b6837c1f-b227-42db-885a-1f91ef494dab/download/dom-rainfall-subnat-5ytd.csv
  format: null
  id: resource_b6837c1f
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: dom-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-dom_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Dominican Republic: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
