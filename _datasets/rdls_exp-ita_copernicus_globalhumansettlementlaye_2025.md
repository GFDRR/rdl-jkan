...
- entity:
    ...
    url: https://data.humdata.org/dataset/ita-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/ita-ghsl
dataset_id: rdls_exp-ita_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ita-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distributions. The Italy
    subset provides national-scale exposure data for buildings and population derived
    from this multi-source integration.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ita-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/b34a8630-d307-43f6-860b-609d384e0e0b/resource/15a4ecc1-93be-4c36-99ab-4771ee9aa553/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_ita.tif
  format: null
  id: resource_15a4ecc1
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Italy: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/b34a8630-d307-43f6-860b-609d384e0e0b/resource/25604b44-46a8-4b90-b2dd-4f5079698e80/download/ghs_pop_e2025_r2023a_54009_100_v1_0_ita.tif
  format: null
  id: resource_25604b44
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-ita_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Italy: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
