...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/mli-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mli-rainfall-subnational
dataset_id: rdls_hzd-mli_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/mli-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with in-situ rain gauge measurements, then aggregated by dekad and subnational
    administrative units. Multiple rolling aggregations (1-month, 3-month) and long-term
    climatological averages were computed to generate drought monitoring indicators
    including rainfall anomalies and quintiles.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mli-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135628878752_9d3b4f9a'
  download_url: https://data.humdata.org/dataset/44da9888-81dc-4b9a-b0d9-1d4c2e515318/resource/1fa3b640-9c74-4f9c-8c2d-80c2b4f54904/download/mli-rainfall-subnat-full.csv
  format: null
  id: resource_1fa3b640
  media_type: text/csv
  spatial: null
  ...
  title: mli-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135628878752_9d3b4f9a'
  download_url: https://data.humdata.org/dataset/44da9888-81dc-4b9a-b0d9-1d4c2e515318/resource/34f77620-8da9-4825-9b9f-2b298feb5411/download/mli-rainfall-subnat-5ytd.csv
  format: null
  id: resource_34f77620
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mli-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mli_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Mali: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
