...
- entity:
    ...
    email: null
    name: REACH
    url: https://data.humdata.org/dataset/unhcr-irq-2019-mcna-v2-1
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: UNHCR - The UN Refugee Agency
  url: https://data.humdata.org/dataset/unhcr-irq-2019-mcna-v2-1
dataset_id: rdls_lss-irq_unhcr_multiclusterneedassessmen_2019
description: 'The Multi Cluster Needs Assessment (MCNA) is an iterative cluster-led
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/unhcr-irq-2019-mcna-v2-1]'
...
lineage:
  description: Household-level needs data collected via computer-assisted personal
    interviews (CAPI) by REACH under the Iraq Assessment Working Group multi-cluster
    framework. Data aggregated to provide quantitative evidence on multi-sectoral
    humanitarian conditions (education, food security, health, livelihoods, protection,
    shelter) across conflict-affected populations in Iraq for humanitarian planning
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/unhcr-irq-2019-mcna-v2-1
  rel: source
loss:
  losses:
...
referenced_by: []
resources:
- access_url: https://microdata.unhcr.org/index.php/auth/login/?destination=catalog/910/get-microdata
  ...
  title: Iraq - Iraq Multi Cluster Need Assessment, 2019
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Iraq - Iraq Multi Cluster Need Assessment, 2019 (Contains information
    about the dataset's metadata and data)
  download_url: https://microdata.unhcr.org/index.php/catalog/910/pdf-documentation
  format: null
  id: resource_fbd8fb5d
...
- loss
schema: rdls-10
slug: rdls_lss-irq_unhcr_multiclusterneedassessmen_2019
spatial:
  bbox: null
  centroid: null
  countries:
