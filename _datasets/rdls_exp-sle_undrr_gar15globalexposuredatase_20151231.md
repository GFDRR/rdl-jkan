...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-sierra-leone
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-sierra-leone
dataset_id: rdls_exp-sle_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-sierra-leone]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure database for Sierra Leone was developed using
    ...
    Kogyo) to estimate economic value of exposed assets across the country.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-sierra-leone
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Sierra Leone.zip
  download_url: https://data.humdata.org/dataset/26f472c4-4df0-4b3f-be13-503a250f72a8/resource/c5a2543d-42ee-4413-b8c5-991981d9fd79/download/sle.zip
  format: null
  id: resource_c5a2543d
  ...
  title: GAR15 Global Exposure Dataset for Sierra Leone.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sle_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Sierra Leone
version: null
vulnerability: null
---
