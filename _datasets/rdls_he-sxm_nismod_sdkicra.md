...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-sxm_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Sint Maarten. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796658
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796658
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Sint Maarten, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/10796658/files/SXM.zip
  format: null
  id: resource_sdkicra_sxm
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Sint
    Maarten
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-sxm_nismod_sdkicra
spatial:
  bbox:
  - -63.12
  - 18.02
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/7609695/sint-maarten.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Sint Maarten
version: 0.1.0
vulnerability: null
---
