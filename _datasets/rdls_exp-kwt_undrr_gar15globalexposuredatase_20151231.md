...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kuwait
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kuwait
dataset_id: rdls_exp-kwt_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kuwait]'
...
lineage:
  description: The GAR15 global exposure database for Kuwait was developed using a
    ...
    integrates multi-source inputs from UNEP-GRID, WAPMERR, JRC, and Kokusai Kogyo
    to estimate the economic value and spatial distribution of exposed assets.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kuwait
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Kuwait.zip
  download_url: https://data.humdata.org/dataset/879755fd-41cc-4ad4-870c-9c2f3b0c96f2/resource/3ff47053-2b45-4e99-98a2-c95eac989d0e/download/kwt.zip
  format: null
  id: resource_3ff47053
  ...
  title: GAR15 Global Exposure Dataset for Kuwait.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kwt_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Kuwait
version: null
vulnerability: null
---
