...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-virgin-islands-british
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-virgin-islands-british
dataset_id: rdls_exp-vgb_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-virgin-islands-british]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    were transposed onto 5x5 km and 1x1 km spatial grids using geographic distribution
    of population density and GDP as spatial proxies. The GAR15 global exposure database
    was developed by UNEP-GRID in collaboration with WAPMERR, EU JRC, and Kokusai
    Kogyo to create a spatially-explicit inventory of economic and structural assets
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-virgin-islands-british
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Virgin Islands (British).zip
  download_url: https://data.humdata.org/dataset/1a334371-41a7-4893-a9c4-b9b75ee46db5/resource/1a155836-3e22-4cc9-8f47-803ca6c94bb8/download/vgb.zip
  format: null
  id: resource_1a155836
  ...
  title: GAR15 Global Exposure Dataset for Virgin Islands (British).zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-vgb_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Virgin Islands (British)
version: null
vulnerability: null
---
