...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-nic_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Nicaragua. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796588
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796588
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Nicaragua, clipped from global sources. Contents: (1) Hazard - Coastal flood inundation
  ...
  download_url: https://zenodo.org/records/10796588/files/NIC.zip
  format: null
  id: resource_sdkicra_nic
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Nicaragua
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-nic_nismod_sdkicra
spatial:
  bbox:
  - -87.69
  - 10.71
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3617476/nicaragua.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Nicaragua
version: 0.1.0
vulnerability: null
---
