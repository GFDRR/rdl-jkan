...
- entity:
    ...
    url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-cambodia
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Centers for Environmental Information (NCEI / NOAA)
  url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-cambodia
dataset_id: rdls_hzd-khm_hdx_dailysummariesprecipitati_20151223
description: 'This dataset contains the daily summaries on base stations across Cambodia
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-cambodia]'
...
lineage:
  description: Daily precipitation and snow observations were collected from meteorological
    stations across Cambodia by NOAA's National Centers for Environmental Information.
    Data underwent quality control requiring a minimum of 30 years of records with
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-cambodia
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: Daily Summaries of Precipitation Indicators for Cambodia (CSV)
  download_url: https://data.humdata.org/dataset/8288b1c7-75ac-4689-93ca-bd0e18d79f7c/resource/f2541e50-bec7-4944-abc0-5334f4a52ebb/download/precipitation_khm.csv
  format: null
  id: resource_f2541e50
  media_type: text/csv
  spatial: null
  ...
  title: precipitation_khm.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-khm_hdx_dailysummariesprecipitati_20151223
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-23'
temporal_resolution: null
title: Daily Summaries of Precipitation Indicators for Cambodia
version: null
vulnerability: null
---
