...
- entity:
    ...
    url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-brazil
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Centers for Environmental Information (NCEI / NOAA)
  url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-brazil
dataset_id: rdls_hzd-bra_hdx_dailysummariesprecipitati_20151223
description: 'This dataset contains the daily summaries on base stations across Brazil
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-brazil]'
...
lineage:
  description: Daily precipitation data were collected from NOAA's National Centers
    ...
    were filtered to include only those with 30+ years of continuous records and at
    least 182 complete observation days per year. Four precipitation-related indicators
    (total precipitation, maximum snow depth, total snowfall, extreme maximum daily
    precipitation) were compiled into daily summaries for hazard characterization.
  sources:
  - id: source_1
    license: null
    name: National Centers for Environmental Information (NCEI / NOAA)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-brazil
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: Daily Summaries of Precipitation Indicators for Brazil (CSV)
  download_url: https://data.humdata.org/dataset/5c9bcc63-1a7b-4c9b-b200-078fab352bda/resource/ce32bd0c-1afc-4c5a-818a-a37d0a35f237/download/precipitation_bra.csv
  format: null
  id: resource_ce32bd0c
  media_type: text/csv
  spatial: null
  ...
  title: precipitation_bra.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bra_hdx_dailysummariesprecipitati_20151223
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-23'
temporal_resolution: null
title: Daily Summaries of Precipitation Indicators for Brazil
version: null
vulnerability: null
---
