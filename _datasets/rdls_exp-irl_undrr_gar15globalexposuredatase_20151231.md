...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ireland
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ireland
dataset_id: rdls_exp-irl_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ireland]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure dataset for Ireland was developed using a
    ...
    Kogyo) to create a harmonized exposure inventory for disaster risk assessment.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-ireland
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Ireland.zip
  download_url: https://data.humdata.org/dataset/edac1807-f0f6-4f07-b6e0-712ecfed95f0/resource/5d21cad8-708a-4020-9817-a10eff7e69ee/download/irl.zip
  format: null
  id: resource_5d21cad8
  ...
  title: GAR15 Global Exposure Dataset for Ireland.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-irl_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Ireland
version: null
vulnerability: null
---
