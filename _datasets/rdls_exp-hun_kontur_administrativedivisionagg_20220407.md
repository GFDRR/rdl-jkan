...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-hungary
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-hungary
dataset_id: rdls_exp-hun_kontur_administrativedivisionagg_20220407
description: 'Hungary administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-hungary]'
...
exposure:
- asset_type:
    description: Aggregated population counts per administrative division in Hungary,
      derived from Kontur Population 400m H3 hexagon grid
    id: population
    scheme: null
    title: null
    uri: null
...
license: ODbL-1.0/
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data with
    proprietary enhancements and enriched with HASC codes from Wikidata. Population
    data from the Kontur Population 400m H3 hexagon grid was spatially aggregated
    to each administrative unit. The resulting dataset provides a nationally consistent
    administrative division layer with associated population counts for Hungary.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-hungary
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Hungary: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_HU_20220407.gpkg.gz
  format: null
  id: resource_295856a7
  ...
  title: kontur_boundaries_HU_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Hungary: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_HU_20230628.gpkg.gz
  format: null
  id: resource_4a82b491
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_HU_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Hungary: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_HU_20230628.gpkg.gz
  format: null
  id: resource_e497de21
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_HU_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-hun_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Hungary: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
