...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/slv-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/slv-rainfall-subnational
dataset_id: rdls_hzd-slv_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/slv-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    with in-situ station measurements, then aggregated into dekadal indicators (10-day
    rainfall, 1-month and 3-month rolling accumulations) at subnational administrative
    units. Long-term climatological averages and quantile-based indices (rfq, r1q,
    r3q) were computed to enable drought monitoring and early warning relative to
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/slv-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135717714823_d152ca6e'
  download_url: https://data.humdata.org/dataset/8acb0ddb-a6cb-452c-8293-f3ca632f7b5b/resource/d4bae341-3b00-42d7-b1b4-209e7f8e326d/download/slv-rainfall-subnat-full.csv
  format: null
  id: resource_d4bae341
  media_type: text/csv
  spatial: null
  ...
  title: slv-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135717714823_d152ca6e'
  download_url: https://data.humdata.org/dataset/8acb0ddb-a6cb-452c-8293-f3ca632f7b5b/resource/b6ed4116-a79b-4edb-8831-231e9160ba3c/download/slv-rainfall-subnat-5ytd.csv
  format: null
  id: resource_b6ed4116
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: slv-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-slv_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'El Salvador: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
