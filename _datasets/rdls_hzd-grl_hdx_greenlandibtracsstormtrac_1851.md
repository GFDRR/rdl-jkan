...
- entity:
    ...
    url: https://data.humdata.org/dataset/grl-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/grl-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-grl_hdx_greenlandibtracsstormtrac_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/grl-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    recorded at regular time intervals and standardized across agencies to create
    a consistent observational hazard record for Greenland.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/grl-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Greenland.
  download_url: https://data.humdata.org/dataset/218b8a6e-4fcc-4c72-9056-5ab2739a46ff/resource/5e6641c3-3d49-401e-98c0-a5ef687086a3/download/ibtracs_all_list_v04r01_grl.csv
  format: null
  id: resource_5e6641c3
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_GRL.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Greenland.
  download_url: https://data.humdata.org/dataset/218b8a6e-4fcc-4c72-9056-5ab2739a46ff/resource/bcc79918-46c5-43a6-a7cb-aa0eeb740f1e/download/ibtracs_all_list_v04r01_lines_grl.geojson
  format: null
  id: resource_bcc79918
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_GRL.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-grl_hdx_greenlandibtracsstormtrac_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-08-16'
temporal_resolution: null
title: 'Greenland: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
