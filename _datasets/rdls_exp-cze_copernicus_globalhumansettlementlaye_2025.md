...
- entity:
    ...
    url: https://data.humdata.org/dataset/cze-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cze-ghsl
dataset_id: rdls_exp-cze_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cze-ghsl]'
...
lineage:
  description: The GHSL project processes heterogeneous geospatial data including
    Copernicus satellite imagery, census records, and crowdsourced geographic information
    through automated spatial data analytics to produce fine-scale gridded datasets
    of built-up surfaces and population distribution. The Czechia subset represents
    national-scale exposure data derived from this global processing pipeline.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cze-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/a5679ca9-cce2-4eef-a7ca-67623190fbe6/resource/3b749997-d9c9-4301-945b-4fdb2c042c53/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cze.tif
  format: null
  id: resource_3b749997
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Czechia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/a5679ca9-cce2-4eef-a7ca-67623190fbe6/resource/48773fbc-aae7-419d-88c6-a2bcebaaaec7/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cze.tif
  format: null
  id: resource_48773fbc
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cze_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Czechia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
