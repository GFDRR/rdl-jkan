...
- entity:
    ...
    url: https://data.humdata.org/dataset/che-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/che-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-che_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/che-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    recorded at regular time intervals and filtered for Switzerland's geographic domain.
    The dataset provides observed hazard characteristics for tropical cyclones affecting
    the region.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/che-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Switzerland.
  download_url: https://data.humdata.org/dataset/d34c3ad4-9232-48cf-a0f3-fade698c2bbc/resource/d9099776-9024-4812-8498-ffa976e8ec69/download/ibtracs_all_list_v04r01_che.csv
  format: null
  id: resource_d9099776
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CHE.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Switzerland.
  download_url: https://data.humdata.org/dataset/d34c3ad4-9232-48cf-a0f3-fade698c2bbc/resource/5cfad708-ca19-4ea4-b39b-b1c089d01bd4/download/ibtracs_all_list_v04r01_lines_che.geojson
  format: null
  id: resource_5cfad708
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CHE.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-che_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Switzerland: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
