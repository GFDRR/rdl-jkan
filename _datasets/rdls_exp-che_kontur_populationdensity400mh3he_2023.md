...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-switzerland
dataset_id: rdls_exp-che_kontur_populationdensity400mh3he_2023
description: 'Switzerland population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-switzerland]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    Kontur Population methodology overlays these diverse data sources to produce consistent,
    spatially-explicit population counts suitable for disaster risk assessment and
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-switzerland
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Switzerland: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CH_20220630.gpkg.gz
  format: null
  id: resource_fcd313ef
  ...
  title: kontur_population_CH_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Switzerland: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_CH_20231101.gpkg.gz
  format: null
  id: resource_448757c4
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_CH_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-che_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Switzerland: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
