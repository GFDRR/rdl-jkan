...
- entity:
    ...
    url: https://data.humdata.org/dataset/eswatini-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/eswatini-road-surface-data
dataset_id: rdls_exp-swz_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/eswatini-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated predictions for approximately 0.033 million km of mapped roads
    in Eswatini, with results integrated into a geospatial dataset containing both
    OSM-derived and AI-predicted surface classifications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/eswatini-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Eswatini: Road Surface Data (GeoJSON data for Eswatini.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_swz_roadsurface_lines.geojson
  format: null
  id: resource_65652420
  ...
  title: Eswatini GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Eswatini: Road Surface Data (Geopackage data for Eswatini.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_swz_roadsurface_lines.gpkg
  format: null
  id: resource_84540cec
  ...
  temporal: null
  temporal_resolution: null
  title: Eswatini GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-swz_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Eswatini: Road Surface Data'
version: null
vulnerability: null
---
