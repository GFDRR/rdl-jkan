...
- entity:
    ...
    url: https://data.humdata.org/dataset/niue-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
    email: null
    name: HeiGIT hybrid deep learning road surface classifier
    url: https://data.humdata.org/dataset/niue-road-surface-data
  id: attribution_2
  role: collaborator
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/niue-road-surface-data
dataset_id: rdls_exp-niu_heigit_niueroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/niue-road-surface-data]'
details: null
exposure:
- asset_type:
    description: Road network in Niue classified by surface type (paved/unpaved) derived
      from OSM data and deep learning predictions
    id: infrastructure
    scheme: null
    title: null
    uri: null
...
license: ODbL-1.0/
lineage:
  description: OSM road network data for Niue was extracted and processed using a
    hybrid deep learning approach to classify road surfaces as paved or unpaved. The
    model generates predicted surface classes for road segments, which are combined
    with existing OSM surface tags (with configurable OSM or DL priority) to produce
    a comprehensive road surface dataset. The resulting dataset supports humanitarian
    access, logistics planning, and infrastructure exposure assessments.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/niue-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Niue: Road Surface Data (GeoJSON data for Niue.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_niu_roadsurface_lines.geojson
  format: null
  id: resource_249183ae
  ...
  title: Niue GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Niue: Road Surface Data (Geopackage data for Niue.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_niu_roadsurface_lines.gpkg
  format: null
  id: resource_1efb8c92
  ...
  temporal: null
  temporal_resolution: null
  title: Niue GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-niu_heigit_niueroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
