...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-niue
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-niue
dataset_id: rdls_exp-niu_kontur_niueadministrativedivisio_20220407
description: 'Niue administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-niue]'
...
lineage:
  description: Administrative boundaries for Niue were extracted from OpenStreetMap
    data using proprietary processing methods, then enriched with aggregated population
    counts from the Kontur Population dataset (400m H3 hexagons). The resulting dataset
    provides baseline population exposure at the administrative division level, with
    HASC codes added from Wikidata for standardization.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-niue
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Niue: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_NU_20220407.gpkg.gz
  format: null
  id: resource_051cd492
  ...
  title: kontur_boundaries_NU_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Niue: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_NU_20230628.gpkg.gz
  format: null
  id: resource_0ed4c4c7
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_NU_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Niue: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_NU_20230628.gpkg.gz
  format: null
  id: resource_64b4a1c4
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_NU_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-niu_kontur_niueadministrativedivisio_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Niue: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
