...
- entity:
    ...
    url: https://data.humdata.org/dataset/irl-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/irl-ghsl
dataset_id: rdls_exp-irl_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/irl-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. The Ireland subset represents the national application of this global
    methodology for assessing human presence and settlement patterns.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/irl-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/1037eaa5-d398-4b7a-8316-08772e88b266/resource/8705bfde-b039-4f3e-8b80-8fbb978c3808/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_irl.tif
  format: null
  id: resource_8705bfde
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Ireland: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/1037eaa5-d398-4b7a-8316-08772e88b266/resource/0a7b9e13-d78d-45bc-bd9a-9cad40d9afe2/download/ghs_pop_e2025_r2023a_54009_100_v1_0_irl.tif
  format: null
  id: resource_0a7b9e13
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-irl_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Ireland: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
