...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-msr_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Montserrat. Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796621
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796621
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Montserrat, clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/10796621/files/MSR.zip
  format: null
  id: resource_sdkicra_msr
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Montserrat
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-msr_nismod_sdkicra
spatial:
  bbox:
  - -62.23
  - 16.68
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/3578097/montserrat.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Montserrat
version: 0.1.0
vulnerability: null
---
