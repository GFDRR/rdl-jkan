...
- entity:
    ...
    url: https://data.humdata.org/dataset/mng-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/mng-ndvi-subnational
dataset_id: rdls_hzd-mng_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/mng-ndvi-subnational]'
...
lineage:
  description: MODIS Aqua and Terra 16-day composite NDVI products (MYD13C1 and MOD13C1)
    were synthesized into 8-day dekadal composites and aggregated by WFP subnational
    administrative units. Dekadal NDVI values (vim), long-term averages (vim_lta),
    and percentage anomalies (viq) were computed to support agricultural drought monitoring
    and early warning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mng-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135856449874_57028971'
  download_url: https://data.humdata.org/dataset/36056181-30c4-426f-8c5d-3e57b48ed42a/resource/5414c0a8-52da-4f8b-b6b5-27820ad4d4c5/download/mng-ndvi-subnat-full.csv
  format: null
  id: resource_5414c0a8
  media_type: text/csv
  spatial: null
  ...
  title: mng-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135856449874_57028971'
  download_url: https://data.humdata.org/dataset/36056181-30c4-426f-8c5d-3e57b48ed42a/resource/dbbbf9d9-1de4-48ab-ad13-db14b7ac266b/download/mng-ndvi-subnat-5ytd.csv
  format: null
  id: resource_dbbbf9d9
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: mng-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-mng_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Mongolia: NDVI at Subnational Level'
version: null
vulnerability: null
---
