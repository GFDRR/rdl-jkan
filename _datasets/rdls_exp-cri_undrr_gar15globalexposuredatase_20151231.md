...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-costa-rica
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-costa-rica
dataset_id: rdls_exp-cri_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-costa-rica]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 global exposure database for Costa Rica was developed using
    a top-down approach where national-level socio-economic data, building type classifications,
    and capital stock information were spatially distributed onto 5x5 km and 1x1 km
    ...
    Kokusai Kogyo) to create a comprehensive gridded exposure inventory for disaster
    risk assessment.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-costa-rica
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Costa Rica.zip
  download_url: https://data.humdata.org/dataset/80e705ab-cbc8-4078-920b-7438b1fd37de/resource/ff0eb2f1-c22f-4b0f-a0e5-87e313e92116/download/cri.zip
  format: null
  id: resource_ff0eb2f1
  ...
  title: GAR15 Global Exposure Dataset for Costa Rica.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cri_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Costa Rica
version: null
vulnerability: null
---
