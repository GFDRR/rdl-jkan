...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/ken-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/ken-iom-dtm-from-api
dataset_id: rdls_lss-ken_iom_displacementtrackingmatri_2015
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ken-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to collect displacement data from affected populations and
    communities. Data is aggregated at country, state/provincial (Admin 1), and district
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ken-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Kenya IOM displacement tracking matrix data at admin levels 0-2, sourced
    from the DTM API
  download_url: https://data.humdata.org/dataset/771944aa-55d0-4de4-b42b-c8009ac8536c/resource/52191c5c-cf09-4f34-b376-3b2cd2f684fa/download/ken-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_52191c5c
  media_type: text/csv
  spatial: null
  ...
  title: Kenya IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-ken_iom_displacementtrackingmatri_2015
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-04-30'
temporal_resolution: null
title: Kenya IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
