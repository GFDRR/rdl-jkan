...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-isle-of-man
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-isle-of-man
dataset_id: rdls_exp-imn_kontur_islemanpopulationdensity4_2023
description: 'Isle of Man population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-isle-of-man]'
...
exposure:
- asset_type:
    description: Population counts at 400m H3 hexagon resolution derived from multi-source
      settlement data fusion
    id: population
    scheme: null
    title: null
    uri: null
...
license: CC-BY-4.0
lineage:
  description: Population density was derived by overlaying and fusing multiple global
    settlement datasets (GHSL, Facebook HRSL, Microsoft Buildings, Copernicus Land
    Cover, and OpenStreetMap) at 400m H3 hexagonal resolution. The multi-source fusion
    approach integrates satellite imagery, connectivity data, and volunteered geographic
    information to produce refined population count estimates for Isle of Man. This
    baseline population exposure dataset supports disaster risk assessment and humanitarian
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-isle-of-man
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Isle of Man: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_IM_20220630.gpkg.gz
  format: null
  id: resource_50086d42
  ...
  title: kontur_population_IM_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Isle of Man: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_IM_20231101.gpkg.gz
  format: null
  id: resource_ed7998be
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_IM_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-imn_kontur_islemanpopulationdensity4_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Isle of Man: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
