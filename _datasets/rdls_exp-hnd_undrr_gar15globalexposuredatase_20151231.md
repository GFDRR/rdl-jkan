...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-honduras
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-honduras
dataset_id: rdls_exp-hnd_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-honduras]'
...
lineage:
  description: The GAR15 global exposure database for Honduras was developed using
    ...
    Kogyo) to estimate economic values of exposed assets across the country.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-honduras
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Honduras.zip
  download_url: https://data.humdata.org/dataset/ea823014-b5b8-4435-ab47-8064c436de3e/resource/8609e286-c9ee-4853-ad98-ae14dc422b00/download/hnd.zip
  format: null
  id: resource_8609e286
  ...
  title: GAR15 Global Exposure Dataset for Honduras.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-hnd_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Honduras
version: null
vulnerability: null
---
