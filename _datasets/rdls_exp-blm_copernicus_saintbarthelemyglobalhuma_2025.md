...
- entity:
    ...
    url: https://data.humdata.org/dataset/blm-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/blm-ghsl
dataset_id: rdls_exp-blm_copernicus_saintbarthelemyglobalhuma_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/blm-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    of human settlements at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/blm-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/49b4736b-e248-4a95-840b-ba079eb3a957/resource/5f034ac2-df31-47e6-ba6c-143aa1e5654b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_blm.tif
  format: null
  id: resource_5f034ac2
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: "Saint Barth\xE9lemy: Copernicus Global Human Settlement Layer (GHSL)\
    \ (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)"
  download_url: https://data.humdata.org/dataset/49b4736b-e248-4a95-840b-ba079eb3a957/resource/59e0fc3c-0d9a-46cc-ad12-3036b4a58689/download/ghs_pop_e2025_r2023a_54009_100_v1_0_blm.tif
  format: null
  id: resource_59e0fc3c
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-blm_copernicus_saintbarthelemyglobalhuma_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: "Saint Barth\xE9lemy: Copernicus Global Human Settlement Layer (GHSL)"
version: null
vulnerability: null
---
