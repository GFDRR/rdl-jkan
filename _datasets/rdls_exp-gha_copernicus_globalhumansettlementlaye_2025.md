...
- entity:
    ...
    url: https://data.humdata.org/dataset/gha-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/gha-ghsl
dataset_id: rdls_exp-gha_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gha-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery (Sentinel),
    ...
    and population distribution. The resulting rasters represent human settlement
    patterns and population density at global scale with consistent methodology.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gha-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/9cf8f5e5-f14d-47e3-a396-ddc9e816f2a7/resource/45b1be1d-5883-4e3c-85f1-dbebf95d441a/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_gha.tif
  format: null
  id: resource_45b1be1d
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Ghana: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/9cf8f5e5-f14d-47e3-a396-ddc9e816f2a7/resource/b7556f36-bd2b-46ff-930e-3adf5b185a90/download/ghs_pop_e2025_r2023a_54009_100_v1_0_gha.tif
  format: null
  id: resource_b7556f36
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gha_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Ghana: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
