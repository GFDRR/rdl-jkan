...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-greenland
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-greenland
dataset_id: rdls_exp-grl_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-greenland]'
...
- asset_type:
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Population distribution used as proxy for spatial allocation of exposure
      assets
    id: population
    scheme: null
    title: null
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    were transposed onto 5x5 km and 1x1 km spatial grids using gridded population
    distribution and GDP data as geographic proxies. The dataset represents the spatial
    allocation of economic exposure assets for Greenland as part of the GAR15 global
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-greenland
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Greenland.zip
  download_url: https://data.humdata.org/dataset/9730113c-5b98-42d8-a5c3-63c8464ea9ae/resource/4d84ae5c-568c-4fca-85f9-f989a55ebfc6/download/grl.zip
  format: null
  id: resource_4d84ae5c
  ...
  title: GAR15 Global Exposure Dataset for Greenland.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-grl_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Greenland
version: null
vulnerability: null
---
