...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mongolia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mongolia
dataset_id: rdls_exp-mng_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mongolia]'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-mongolia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Mongolia.zip
  download_url: https://data.humdata.org/dataset/9f0bc134-4a21-4b2a-8d10-7bfe68b295ab/resource/6486ee8b-5c31-4c62-a794-423208ed7791/download/mng.zip
  format: null
  id: resource_6486ee8b
  ...
  title: GAR15 Global Exposure Dataset for Mongolia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mng_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Mongolia
version: null
vulnerability: null
---
