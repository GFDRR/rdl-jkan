...
- entity:
    ...
    url: https://data.humdata.org/dataset/lbr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/lbr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-lbr_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lbr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS aggregates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Liberia subset
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lbr-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Liberia.
  download_url: https://data.humdata.org/dataset/dd195f6b-81b4-4c43-b576-d7bcda5212cc/resource/63250a02-f07f-4615-93d6-f869e140b7b7/download/ibtracs_all_list_v04r01_lbr.csv
  format: null
  id: resource_63250a02
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_LBR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Liberia.
  download_url: https://data.humdata.org/dataset/dd195f6b-81b4-4c43-b576-d7bcda5212cc/resource/c8c659f3-e92a-4510-9a3f-894b1e5bf2e2/download/ibtracs_all_list_v04r01_lines_lbr.geojson
  format: null
  id: resource_c8c659f3
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_LBR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lbr_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Liberia: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
