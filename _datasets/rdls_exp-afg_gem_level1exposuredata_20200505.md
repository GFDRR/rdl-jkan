...
- entity:
    ...
    url: https://data.humdata.org/dataset/afghanistan-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/afghanistan-level-1-exposure-data
dataset_id: rdls_exp-afg_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/afghanistan-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was generated through the METEOR project methodology
    ...
    at 15-arcsecond resolution (approximately 500 meters) across Afghanistan, designed
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/afghanistan-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Afghanistan produced by
    ImageCat and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/bb0fd95d-102c-4540-b856-07fe6a873903/resource/05c0d75d-3a93-4ec9-b063-7268533ae9a6/download/afg_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_05c0d75d
  ...
  title: AFG_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-afg_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Afghanistan: Level 1 Exposure Data'
version: null
vulnerability: null
---
