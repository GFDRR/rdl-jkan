...
- entity:
    ...
    email: null
    name: WFP HungerMap
    url: https://data.humdata.org/dataset/wfp-hungermap-data-for-zmb
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/wfp-hungermap-data-for-zmb
dataset_id: rdls_lss-zmb_wfp_hungermapdata_20240119
description: 'HungerMapLIVE is the World Food Programme (WFP)''s global hunger monitoring
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/wfp-hungermap-data-for-zmb]'
details: null
exposure: []
hazard: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/wfp-hungermap-data-for-zmb
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Zambia - HungerMap data
  download_url: https://data.humdata.org/dataset/76d1e3d3-a548-4c6a-829f-2359e835a671/resource/9b221275-eb3a-47e0-8dee-b6d5a1ef7234/download/wfp-hungermap-data-for-zmb.csv
  format: null
  id: resource_9b221275
  media_type: text/csv
  spatial: null
  ...
  title: wfp-hungermap-data-for-zmb.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: Zambia - HungerMap data long format
  download_url: https://data.humdata.org/dataset/76d1e3d3-a548-4c6a-829f-2359e835a671/resource/fa2de1dc-5301-4322-9cb4-d98549e05c0d/download/wfp-hungermap-data-for-zmb-long.csv
  format: null
  id: resource_fa2de1dc
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: wfp-hungermap-data-for-zmb-long.csv
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-zmb_wfp_hungermapdata_20240119
spatial:
  bbox: null
  centroid: null
  countries:
