...
- entity:
    ...
    url: https://data.humdata.org/dataset/sau-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/sau-ghsl
dataset_id: rdls_exp-sau_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/sau-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    and population distribution at global scale. The Saudi Arabia subset represents
    the national application of this methodology for exposure mapping.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sau-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/fc28e032-c40b-4a12-858d-d0b8894fa02f/resource/82b07c14-58cd-4cb3-956c-4565614617e6/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_sau.tif
  format: null
  id: resource_82b07c14
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Saudi Arabia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/fc28e032-c40b-4a12-858d-d0b8894fa02f/resource/62cfb2e7-1a7b-4faa-b332-2da17f6c966b/download/ghs_pop_e2025_r2023a_54009_100_v1_0_sau.tif
  format: null
  id: resource_62cfb2e7
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-sau_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Saudi Arabia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
