...
- entity:
    ...
    url: https://data.humdata.org/dataset/tkl-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/tkl-ghsl
dataset_id: rdls_exp-tkl_copernicus_tokelauglobalhumansettlem_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/tkl-ghsl]'
...
license: CC-BY-4.0
lineage:
  description: The GHSL dataset for Tokelau integrates fine-scale satellite image
    ...
    built-up surface area and population distribution at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tkl-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/24550605-9cb1-4cd9-bd4a-80ace0f9c45d/resource/20835103-21b5-458c-a692-9545a93fc3f7/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_tkl.tif
  format: null
  id: resource_20835103
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Tokelau: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/24550605-9cb1-4cd9-bd4a-80ace0f9c45d/resource/0460ff7f-5a22-420b-a1bd-718f24c37e42/download/ghs_pop_e2025_r2023a_54009_100_v1_0_tkl.tif
  format: null
  id: resource_0460ff7f
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-tkl_copernicus_tokelauglobalhumansettlem_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Tokelau: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
