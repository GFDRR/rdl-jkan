...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/lby-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/lby-rainfall-subnational
dataset_id: rdls_hzd-lby_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/lby-rainfall-subnational]'
...
lineage:
  description: Rainfall data are derived from CHIRPS satellite observations merged
    with rain gauge measurements, then aggregated into dekadal indicators (10-day,
    1-month, 3-month rolling sums and anomalies) at subnational administrative units
    in Libya. These indicators support drought monitoring and early warning by comparing
    current rainfall to long-term climatological averages.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lby-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135553597365_efa563db'
  download_url: https://data.humdata.org/dataset/503fe323-664e-409a-abc4-10c0f4b063e5/resource/5d70830a-4f8d-44be-83ff-2c15e4e1f3a6/download/lby-rainfall-subnat-full.csv
  format: null
  id: resource_5d70830a
  media_type: text/csv
  spatial: null
  ...
  title: lby-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135553597365_efa563db'
  download_url: https://data.humdata.org/dataset/503fe323-664e-409a-abc4-10c0f4b063e5/resource/2f4739e6-f7a8-4b89-aa09-310df1761487/download/lby-rainfall-subnat-5ytd.csv
  format: null
  id: resource_2f4739e6
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: lby-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lby_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Libya: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
