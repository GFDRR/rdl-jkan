...
- entity:
    ...
    url: https://data.humdata.org/dataset/lby-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/lby-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-lby_hdx_ibtracsstormtracks_1887
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lby-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Libya subset contains track points with ISO timestamps, basin/subbasin classifications,
    wind speed (wmo_wind in m/s), and central pressure (wmo_pres) measurements, provided
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lby-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of Libya.
  download_url: https://data.humdata.org/dataset/931c382e-2570-4648-b212-01b5078af57a/resource/7f3df4cb-3262-448a-ae3d-7e7d74e10f99/download/ibtracs_all_list_v04r01_lby.csv
  format: null
  id: resource_7f3df4cb
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_LBY.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1887 to date that pass within 2000 kilometers
    of Libya.
  download_url: https://data.humdata.org/dataset/931c382e-2570-4648-b212-01b5078af57a/resource/8dcda99f-5b80-46a6-a34f-5a50064e8c46/download/ibtracs_all_list_v04r01_lines_lby.geojson
  format: null
  id: resource_8dcda99f
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_LBY.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lby_hdx_ibtracsstormtracks_1887
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1887-10-29'
temporal_resolution: null
title: 'Libya: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
