...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-niger
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-niger
dataset_id: rdls_exp-ner_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-niger]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    collaboration to create a globally consistent exposure database for Niger.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-niger
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Niger.zip
  download_url: https://data.humdata.org/dataset/cd92bfe7-c06b-415f-9a1f-a3e020ae0787/resource/136f55e2-464f-426f-bbbd-41d473e7df98/download/ner.zip
  format: null
  id: resource_136f55e2
  ...
  title: GAR15 Global Exposure Dataset for Niger.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ner_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Niger
version: null
vulnerability: null
---
