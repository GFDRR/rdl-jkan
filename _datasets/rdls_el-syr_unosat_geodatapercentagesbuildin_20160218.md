...
contact_point:
  ...
  url: https://data.humdata.org/dataset/geodata-of-percentages-of-buildings-damaged-aleppo-syria-february-18-2016
creator:
  affiliation: null
  email: null
  name: United Nations Satellite Centre (UNOSAT)
  url: https://data.humdata.org/dataset/geodata-of-percentages-of-buildings-damaged-aleppo-syria-february-18-2016
dataset_id: rdls_el-syr_unosat_geodatapercentagesbuildin_20160218
description: 'This map illustrates the percentages of buildings damaged in the city
  ...
  in 2009 to determine the percentage of damaged buildings across the city. This is
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/geodata-of-percentages-of-buildings-damaged-aleppo-syria-february-18-2016]'
...
exposure:
- asset_type:
    description: Building stock inventory in Aleppo city derived from pre-conflict
...
lineage:
  description: UNOSAT analysts compared multi-temporal satellite imagery (baseline
    2009, and post-conflict acquisitions from 2013-2015) to identify damaged building
    structures through visual interpretation. A total of 12,065 damaged structures
    were identified and compared against the total building count from the 2009 pre-conflict
    baseline to calculate damage percentages across Aleppo city.
  sources:
  - id: source_1
    license: null
    name: United Nations Satellite Centre (UNOSAT)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/geodata-of-percentages-of-buildings-damaged-aleppo-syria-february-18-2016
  rel: source
loss:
  losses:
  - asset_category: buildings
    ...
    description: Direct building damage assessed through satellite imagery comparison
      between 2009 baseline and 2013-2015 post-conflict periods
...
- access_url: null
  ...
  description: Geodata of Percentages of Buildings Damaged, Aleppo, Syria (Shapefile)
...
- loss
schema: rdls-10
slug: rdls_el-syr_unosat_geodatapercentagesbuildin_20160218
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2016-02-18'
temporal_resolution: null
title: Geodata of Percentages of Buildings Damaged, Aleppo, Syria
version: null
vulnerability: null
---
