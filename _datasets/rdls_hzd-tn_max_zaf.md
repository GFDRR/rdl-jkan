...
dataset_id: rdls_hzd-TN_max_ZAF
description: "Annual minimum nighttime warmest temperature. The baseline is calculated\
...
purpose: 'This dataset is part of the scientific paper: Souverijns, N., De Ridder,
  ...
  and vulnerability analysis. Urban Climate, 46, 101331. https://doi.org/10.1016/j.uclim.2022.101348'
resources:
- coordinate_system: EPSG:4326
  description: Annual minimum nighttime warmest temperature for the period 2001-2020.
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '0'
  spatial_resolution: null
  title: Annual Minimum Nighttime Warmest Temperature  - Johannebsurg & Ekurhuleni
    (2001-2020)
- coordinate_system: EPSG:4326
  description: Projected annual minimum nighttime warmest temperature under the RCP
...
spatial:
  ...
  - description: City of Ekurhuleni, Gauteng Province
    ...
    scheme: ISO 3166-2
  scale: sub-national
title: Annual Minimum Nighttime Warmest Temperature
