...
- entity:
    ...
    url: https://data.humdata.org/dataset/fiji-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/fiji-road-surface-data
dataset_id: rdls_exp-fji_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0183 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0016 and 0.0076
  (in million kms), corressponding to 8.6967% and 41.2662% respectively of the total
  road length in the dataset region. 0.0092 million km or 50.0371% of road surface
  ...
  to 0.644% of total missing information on road surface) It is intended for use in
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/fiji-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries and attributes were extracted from OpenStreetMap
    for Fiji. A hybrid deep learning model was applied to classify road surfaces as
    paved or unpaved, generating predictions for unmapped or uncertain segments. The
    final dataset combines OSM-tagged and AI-predicted surface classifications with
    road attributes (width, lanes, smoothness) to provide comprehensive infrastructure
    exposure data.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/fiji-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Fiji: Road Surface Data (GeoJSON data for Fiji.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_fji_roadsurface_lines.geojson
  format: null
  id: resource_28be0d7b
  ...
  title: Fiji GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Fiji: Road Surface Data (Geopackage data for Fiji.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_fji_roadsurface_lines.gpkg
  format: null
  id: resource_9ec4750e
  ...
  temporal: null
  temporal_resolution: null
  title: Fiji GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-fji_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
