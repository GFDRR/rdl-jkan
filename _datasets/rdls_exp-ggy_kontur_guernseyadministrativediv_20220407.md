...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-guernsey
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-guernsey
dataset_id: rdls_exp-ggy_kontur_guernseyadministrativediv_20220407
description: 'Guernsey administrative division with aggregated population. Built from
  ...
  Wikidata. Gobal version of boundaries dataset: Kontur Boundaries: Global administrative
  division with aggregated population. [Source: This metadata record was automatically
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-guernsey]'
...
lineage:
  description: Administrative boundaries for Guernsey were extracted from OpenStreetMap
    data using proprietary enhancements and enriched with aggregated population counts
    derived from the Kontur Population global 400m H3 hexagon density dataset. The
    resulting dataset provides administrative divisions with baseline population estimates
    for disaster risk assessment and planning purposes.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-guernsey
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Guernsey: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_GG_20220407.gpkg.gz
  format: null
  id: resource_1fe71c9f
  ...
  title: kontur_boundaries_GG_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Guernsey: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_GG_20230628.gpkg.gz
  format: null
  id: resource_d7302853
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_GG_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Guernsey: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_GG_20230628.gpkg.gz
  format: null
  id: resource_13d4e487
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_GG_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ggy_kontur_guernseyadministrativediv_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Guernsey: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
