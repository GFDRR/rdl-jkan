...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-fji_nismod_sdkicra__west
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Fiji (West). Derived from global datasets
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16539987
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16539987
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Fiji (West), clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16539987/files/FJI.zip
  format: null
...
- exposure
schema: rdls-10
slug: rdls_he-fji_nismod_sdkicra__west
spatial:
  bbox:
  - -180.0
  - -21.71
...
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Fiji (West)
version: 0.1.0
vulnerability: null
---
