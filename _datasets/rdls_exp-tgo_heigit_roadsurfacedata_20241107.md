...
- entity:
    ...
    url: https://data.humdata.org/dataset/togo-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/togo-road-surface-data
dataset_id: rdls_exp-tgo_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0906 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0057 and 0.0348
  (in million kms), corressponding to 6.3081% and 38.4045% respectively of the total
  road length in the dataset region. 0.0501 million km or 55.2875% of road surface
  ...
  to 0.5286% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/togo-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    ...
    road surfaces. The resulting dataset provides comprehensive road infrastructure
    inventory with predicted surface types across Togo, supporting humanitarian access
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/togo-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Togo: Road Surface Data (GeoJSON data for Togo.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tgo_roadsurface_lines.geojson
  format: null
  id: resource_0a282304
  ...
  title: Togo GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Togo: Road Surface Data (Geopackage data for Togo.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tgo_roadsurface_lines.gpkg
  format: null
  id: resource_f69f95ce
  ...
  temporal: null
  temporal_resolution: null
  title: Togo GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tgo_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
