...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-mexico
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-mexico
dataset_id: rdls_exp-mex_kontur_populationdensity400mh3he_2023
description: 'Mexico population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-mexico]'
...
lineage:
  description: Population density was calculated by fusing Global Human Settlement
    Layer, Facebook High Resolution Settlement Layer, Microsoft Buildings, Copernicus
    Land Cover, and OpenStreetMap data into H3 hexagonal grids at 400m resolution.
    The multi-source fusion approach integrates satellite-derived settlement patterns
    with connectivity-based population estimates to produce gridded population counts
    across Mexico.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-mexico
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Mexico: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MX_20220630.gpkg.gz
  format: null
  id: resource_53731682
  ...
  title: kontur_population_MX_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Mexico: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_MX_20231101.gpkg.gz
  format: null
  id: resource_285c3654
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_MX_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mex_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Mexico: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
