...
- entity:
    ...
    url: https://data.humdata.org/dataset/tha-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/tha-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-tha_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/tha-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. The Thailand subset
    contains historical and recent cyclone tracks with ISO-formatted timestamps, basin/sub-basin
    classifications, wind speed (wmo_wind), and central pressure (wmo_pres) measurements.
    Data is provided in both tabular (CSV) and geospatial (GeoJSON) formats with track
    geometries.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tha-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Thailand.
  download_url: https://data.humdata.org/dataset/6f8af32e-48ce-426a-b695-71739d8fc681/resource/56305e2f-19c7-480c-97db-b208af3305ad/download/ibtracs_all_list_v04r01_tha.csv
  format: null
  id: resource_56305e2f
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_THA.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Thailand.
  download_url: https://data.humdata.org/dataset/6f8af32e-48ce-426a-b695-71739d8fc681/resource/381ec042-8252-4ca4-b027-f4d8f9dbb926/download/ibtracs_all_list_v04r01_lines_tha.geojson
  format: null
  id: resource_381ec042
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_THA.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-tha_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Thailand: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
