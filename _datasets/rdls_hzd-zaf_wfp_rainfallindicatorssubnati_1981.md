...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Station data (CHIRPS)
      version 2
    url: https://data.humdata.org/dataset/zaf-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/zaf-rainfall-subnational
dataset_id: rdls_hzd-zaf_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/zaf-rainfall-subnational]'
...
license: CC-BY-4.0
lineage:
  description: Rainfall data derived from CHIRPS satellite imagery merged with in-situ
    station observations, aggregated into dekadal indicators (10-day, 1-month, 3-month
    rolling totals) and compared against long-term averages at subnational administrative
    units to support drought monitoring and early warning in South Africa.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Station data (CHIRPS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zaf-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135913580452_9ceb5879'
  download_url: https://data.humdata.org/dataset/20978b3b-74bd-4746-9517-ae0fb35c02b3/resource/f3c9c76f-5eb0-42a2-a61b-9466862fab82/download/zaf-rainfall-subnat-full.csv
  format: null
  id: resource_f3c9c76f
  media_type: text/csv
  spatial: null
  ...
  title: zaf-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135913580452_9ceb5879'
  download_url: https://data.humdata.org/dataset/20978b3b-74bd-4746-9517-ae0fb35c02b3/resource/2dd325e3-ae69-484e-9faa-befeb80ead94/download/zaf-rainfall-subnat-5ytd.csv
  format: null
  id: resource_2dd325e3
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: zaf-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-zaf_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'South Africa: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
