...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-moldova-republic-of
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-moldova-republic-of
dataset_id: rdls_exp-mda_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-moldova-republic-of]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    for Moldova were transposed onto 5x5 km and 1x1 km gridded layers using geographic
    ...
    of the GAR15 global exposure assessment initiative.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-moldova-republic-of
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Moldova (Republic of).zip
  download_url: https://data.humdata.org/dataset/3264a8f9-864b-48d8-b0ff-a0c77259566a/resource/8f8bd967-6b33-4b6c-a07d-0ff022a4a46c/download/mda.zip
  format: null
  id: resource_8f8bd967
  ...
  title: GAR15 Global Exposure Dataset for Moldova (Republic of).zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mda_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Moldova (Republic of)
version: null
vulnerability: null
---
