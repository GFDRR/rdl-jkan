...
- entity:
    ...
    url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-ghana
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Centers for Environmental Information (NCEI / NOAA)
  url: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-ghana
dataset_id: rdls_hzd-gha_hdx_dailysummariesprecipitati_20151223
description: 'This dataset contains the daily summaries on base stations across Ghana
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/daily-summaries-of-precipitation-indicators-for-ghana]'
...
lineage:
  description: Daily precipitation data were collected from meteorological base stations
    across Ghana by NOAA/NCEI. Stations were selected based on a 30-year minimum record
    ...
    precipitation) were extracted and compiled into daily summaries for drought hazard
    characterization.
  sources:
  - id: source_1
    license: null
...
- access_url: null
  ...
  description: Daily Summaries of Precipitation Indicators for Ghana (CSV)
  download_url: https://data.humdata.org/dataset/865c5c75-fda7-4b5e-a4e3-d564e541cbe3/resource/e7f1e3b4-2bac-4437-a170-6aa92289e247/download/precipitation_gha.csv
  format: null
  id: resource_e7f1e3b4
  media_type: text/csv
  spatial: null
  ...
  title: precipitation_gha.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-gha_hdx_dailysummariesprecipitati_20151223
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-23'
temporal_resolution: null
title: Daily Summaries of Precipitation Indicators for Ghana
version: null
vulnerability: null
---
