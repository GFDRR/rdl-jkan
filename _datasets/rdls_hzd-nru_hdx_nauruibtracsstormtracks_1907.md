...
- entity:
    ...
    url: https://data.humdata.org/dataset/nru-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/nru-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-nru_hdx_nauruibtracsstormtracks_1907
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/nru-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    Track points are georeferenced with ISO timestamps, basin/sub-basin classifications,
    and physical parameters (wind speed, pressure) to create a comprehensive observational
    record of tropical cyclones affecting Nauru.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nru-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1907 to date that pass within 2000 kilometers
    of Nauru.
  download_url: https://data.humdata.org/dataset/63d56b2d-2f1b-47ed-ba4b-0906d3dc8e64/resource/16a3d1e5-f7fd-44d2-aef7-68b607b47831/download/ibtracs_all_list_v04r01_nru.csv
  format: null
  id: resource_16a3d1e5
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NRU.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1907 to date that pass within 2000 kilometers
    of Nauru.
  download_url: https://data.humdata.org/dataset/63d56b2d-2f1b-47ed-ba4b-0906d3dc8e64/resource/a28fc71e-b2ec-4980-9f3f-c45b16b5f4e5/download/ibtracs_all_list_v04r01_lines_nru.geojson
  format: null
  id: resource_a28fc71e
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NRU.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-nru_hdx_nauruibtracsstormtracks_1907
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1907-03-26'
temporal_resolution: null
title: 'Nauru: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
