...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-monaco
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-monaco
dataset_id: rdls_exp-mco_kontur_monacoadministrativedivis_20220407
description: 'Monaco administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-monaco]'
...
lineage:
  description: Administrative boundaries for Monaco were extracted from OpenStreetMap
    data using proprietary processing methods, then enriched by aggregating population
    counts from the Kontur Population dataset (400m H3 hexagon grid). HASC codes were
    added from Wikidata to provide standardized regional identifiers.
  sources:
  - id: source_1
    license: null
    name: 'Kontur Population: Global Population Density for 400m H3 Hexagons'
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-monaco
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Monaco: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_MC_20220407.gpkg.gz
  format: null
  id: resource_dbb6e6a8
  ...
  title: kontur_boundaries_MC_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Monaco: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_MC_20230628.gpkg.gz
  format: null
  id: resource_55969d5a
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_MC_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Monaco: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_MC_20230628.gpkg.gz
  format: null
  id: resource_52901973
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_MC_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-mco_kontur_monacoadministrativedivis_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Monaco: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
