...
- entity:
    ...
    url: https://data.humdata.org/dataset/angola-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/angola-road-surface-data
dataset_id: rdls_exp-ago_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.284 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.024 and 0.1105
  (in million kms), corressponding to 8.4616% and 38.9039% respectively of the total
  road length in the dataset region. 0.1495 million km or 52.6345% of road surface
  ...
  to 0.15% of total missing information on road surface) It is intended for use in
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/angola-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model improved upon OSM's native surface classifications, resulting in a georeferenced
    dataset covering approximately 0.284 million km of mapped roads in Angola with
    enhanced surface type accuracy for humanitarian access and logistics planning.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/angola-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Angola: Road Surface Data (GeoJSON data for Angola.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ago_roadsurface_lines.geojson
  format: null
  id: resource_7d4f0996
  ...
  title: Angola GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Angola: Road Surface Data (Geopackage data for Angola.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_ago_roadsurface_lines.gpkg
  format: null
  id: resource_c26f387e
  ...
  temporal: null
  temporal_resolution: null
  title: Angola GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ago_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Angola: Road Surface Data'
version: null
vulnerability: null
---
