...
- entity:
    ...
    url: https://data.humdata.org/dataset/bgd-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bgd-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bgd_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bgd-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Bangladesh subset contains observed storm track positions, timestamps, basin/sub-basin
    classifications, wind speeds (wmo_wind), and central pressure (wmo_pres) for all
    cyclones affecting the region, provided in both tabular CSV and geospatial GeoJSON
    formats.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bgd-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Bangladesh.
  download_url: https://data.humdata.org/dataset/e0a11654-8eda-4c6b-bb13-aead7e5109b4/resource/e892582d-38f7-48e3-bb3b-b29866b810e7/download/ibtracs_all_list_v04r01_bgd.csv
  format: null
  id: resource_e892582d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BGD.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Bangladesh.
  download_url: https://data.humdata.org/dataset/e0a11654-8eda-4c6b-bb13-aead7e5109b4/resource/1563b8e5-305e-47d6-ae83-1279b7ebb2da/download/ibtracs_all_list_v04r01_lines_bgd.geojson
  format: null
  id: resource_1563b8e5
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BGD.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bgd_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Bangladesh: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
