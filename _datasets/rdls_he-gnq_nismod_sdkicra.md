...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-gnq_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Equatorial Guinea. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10410861
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10410861
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Equatorial Guinea, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/10410861/files/GNQ.zip
  format: null
  id: resource_sdkicra_gnq
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Equatorial
    Guinea
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-gnq_nismod_sdkicra
spatial:
  bbox:
  - 5.61
  - -1.48
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2309096/equatorial-guinea.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Equatorial
  Guinea
version: 0.1.0
vulnerability: null
---
