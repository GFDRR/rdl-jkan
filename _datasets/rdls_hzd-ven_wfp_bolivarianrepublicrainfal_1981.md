...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/ven-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/ven-rainfall-subnational
dataset_id: rdls_hzd-ven_wfp_bolivarianrepublicrainfal_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/ven-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    1-month, and 3-month rolling aggregations) and normalized against long-term averages
    at subnational administrative units to produce drought monitoring indicators.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ven-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135734202171_f5c2b923'
  download_url: https://data.humdata.org/dataset/c136cc6e-573e-43b3-b7db-6e7e9648fd60/resource/8ca18230-5d6c-477c-a5a5-6b9ceebc6a5f/download/ven-rainfall-subnat-full.csv
  format: null
  id: resource_8ca18230
  media_type: text/csv
  spatial: null
  ...
  title: ven-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135734202171_f5c2b923'
  download_url: https://data.humdata.org/dataset/c136cc6e-573e-43b3-b7db-6e7e9648fd60/resource/e576a114-0125-4a88-8f3a-95ef47044d28/download/ven-rainfall-subnat-5ytd.csv
  format: null
  id: resource_e576a114
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: ven-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ven_wfp_bolivarianrepublicrainfal_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Venezuela (Bolivarian Republic of): Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
