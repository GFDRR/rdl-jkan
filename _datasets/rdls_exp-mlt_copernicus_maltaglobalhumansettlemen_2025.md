...
- entity:
    ...
    url: https://data.humdata.org/dataset/mlt-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/mlt-ghsl
dataset_id: rdls_exp-mlt_copernicus_maltaglobalhumansettlemen_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/mlt-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    technologies to generate gridded estimates of built-up surface area and population
    distribution at global scale, with application to Malta.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/mlt-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/e17db159-4a58-4caa-aadf-3f32c951a9e5/resource/d8f80677-2d7d-4db3-a917-ec4667cdf7a4/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_mlt.tif
  format: null
  id: resource_d8f80677
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Malta: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/e17db159-4a58-4caa-aadf-3f32c951a9e5/resource/750a1a3e-5f55-4edc-b5d0-f82296e50fc5/download/ghs_pop_e2025_r2023a_54009_100_v1_0_mlt.tif
  format: null
  id: resource_750a1a3e
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-mlt_copernicus_maltaglobalhumansettlemen_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Malta: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
