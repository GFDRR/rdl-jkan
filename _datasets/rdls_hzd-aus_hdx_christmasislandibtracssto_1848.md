...
- entity:
    ...
    url: https://data.humdata.org/dataset/cxr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/cxr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-aus_hdx_christmasislandibtracssto_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cxr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    and standardized. The dataset provides observed hazard characteristics for tropical
    cyclones affecting Christmas Island and surrounding regions.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cxr-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Christmas Island.
  download_url: https://data.humdata.org/dataset/4499a397-1fc9-4a98-85b5-00c0a4484485/resource/f753a4fa-e0dc-4d86-9521-dce64c061767/download/ibtracs_all_list_v04r01_cxr.csv
  format: null
  id: resource_f753a4fa
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CXR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Christmas Island.
  download_url: https://data.humdata.org/dataset/4499a397-1fc9-4a98-85b5-00c0a4484485/resource/ea34e30f-8944-4868-87d6-dbee7ffc4d5f/download/ibtracs_all_list_v04r01_lines_cxr.geojson
  format: null
  id: resource_ea34e30f
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CXR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-aus_hdx_christmasislandibtracssto_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-04-20'
temporal_resolution: null
title: 'Australia - Christmas Island: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
