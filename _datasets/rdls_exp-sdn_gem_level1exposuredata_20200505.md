...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/sudan-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/sudan-level-1-exposure-data
dataset_id: rdls_exp-sdn_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sudan-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Exposure data was developed through the METEOR project using Earth
    observation routines with minimal country-specific data collection to generate
    Level 1 global-quality exposure estimates. Building counts, areas, and rebuilding
    values were modeled at 15-arcsecond grid resolution (approximately 500 meters)
    across Sudan for catastrophe modeling and disaster risk assessment applications.
  sources:
  - id: source_1
    license: null
    name: METEOR Project
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sudan-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Sudan produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/9041ebac-b05c-448d-8821-b29639812698/resource/ac37535b-b859-4ad8-90c6-8e827595e3a1/download/sdn_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_ac37535b
  ...
  title: SDN_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sdn_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Sudan: Level 1 Exposure Data'
version: null
vulnerability: null
---
