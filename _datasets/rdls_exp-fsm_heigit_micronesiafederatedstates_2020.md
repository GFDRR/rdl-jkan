...
- entity:
    ...
    url: https://data.humdata.org/dataset/micronesia-federated-states-of-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/micronesia-federated-states-of-planet-road-surface-data
dataset_id: rdls_exp-fsm_heigit_micronesiafederatedstates_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (38.7844%) - Unpaved roads: 0.0 million km (2.5523%) - Missing\
  \ OSM surface tags: 0.0001 million km (41.3366%) - PlanetScope predictions cover:\
  \ 0.0001 million km (100.0%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/micronesia-federated-states-of-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was extracted for arterial highways
    in Micronesia. Deep learning models were applied to PlanetScope satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/micronesia-federated-states-of-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Micronesia (Federated States of): Planet Road Surface, Width, and
    Passability Data (GeoJSON file for Micronesia (federated states of))'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_FM_planet_roadsurface_lines.geojson
  format: null
  id: resource_9549669f
  ...
  title: Micronesia (federated states of) GeoJSON heigit_FM_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Micronesia (Federated States of): Planet Road Surface, Width, and
    Passability Data (Geopackage file for Micronesia (federated states of))'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_FM_planet_roadsurface_lines.gpkg
  format: null
  id: resource_4328d01b
  ...
  temporal: null
  temporal_resolution: null
  title: Micronesia (federated states of) GPKG heigit_FM_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-fsm_heigit_micronesiafederatedstates_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Micronesia (Federated States of): Planet Road Surface, Width, and Passability
  Data'
version: null
vulnerability: null
---
