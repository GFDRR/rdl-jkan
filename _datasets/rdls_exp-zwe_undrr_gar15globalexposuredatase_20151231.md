...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-zimbabwe
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-zimbabwe
dataset_id: rdls_exp-zwe_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-zimbabwe]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    collaboration to create a globally consistent exposure inventory for Zimbabwe.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-zimbabwe
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Zimbabwe.zip
  download_url: https://data.humdata.org/dataset/212b5380-4084-4604-9a88-f22e78975fe0/resource/5e5447da-9311-4d59-9a76-2d2f9f1f67d1/download/zwe.zip
  format: null
  id: resource_5e5447da
  ...
  title: GAR15 Global Exposure Dataset for Zimbabwe.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-zwe_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Zimbabwe
version: null
vulnerability: null
---
