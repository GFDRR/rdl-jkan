...
- entity:
    ...
    url: https://data.humdata.org/dataset/tto-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/tto-ghsl
dataset_id: rdls_exp-tto_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/tto-ghsl]'
...
exposure:
- asset_type:
    description: Built-up surface area derived from satellite imagery for Trinidad
      and Tobago using the GHS Built-up Surface layer
    id: buildings
    scheme: null
    title: null
    uri: null
  ...
  - dimension: structure
    ...
    measurement:
      ...
      unit: null
- asset_type:
    description: Gridded population estimates for Trinidad and Tobago derived from
      the GHS Population Grid integrating census and satellite data
    id: population
    scheme: null
    title: null
    uri: null
...
lineage:
  description: The GHSL dataset is generated by the JRC using automated spatial data
    processing technologies applied to global fine-scale satellite image data streams,
    census data, and crowdsourced geographic information. The pipeline extracts built-up
    surface extent and population distribution at global scale, then subsetted here
    for Trinidad and Tobago. The resulting GeoTIFF layers provide gridded exposure
    data on built-up area and population for use in disaster risk assessments.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/tto-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/0392bbd9-ffac-443b-937c-3cb6263d786d/resource/e5679f52-6da0-49cb-8a25-6ec42933e131/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_tto.tif
  format: null
  id: resource_e5679f52
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Trinidad and Tobago: Copernicus Global Human Settlement Layer (GHSL)
    (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/0392bbd9-ffac-443b-937c-3cb6263d786d/resource/ae2bf13c-2f12-458b-bede-98ddb94c1988/download/ghs_pop_e2025_r2023a_54009_100_v1_0_tto.tif
  format: null
  id: resource_ae2bf13c
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-tto_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Trinidad and Tobago: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
