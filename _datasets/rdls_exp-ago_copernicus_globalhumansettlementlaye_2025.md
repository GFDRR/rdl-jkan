...
- entity:
    ...
    url: https://data.humdata.org/dataset/ago-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/ago-ghsl
dataset_id: rdls_exp-ago_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ago-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    to extract built-up surface extent and gridded population distribution. The Angola
    dataset represents the national application of this global methodology, providing
    rasterized exposure data for human settlements and infrastructure.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ago-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/d4f0d1c7-c772-409e-a395-faeadda616f2/resource/2e3cb0da-b476-4185-b041-3bb001e36fc3/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_ago.tif
  format: null
  id: resource_2e3cb0da
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Angola: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/d4f0d1c7-c772-409e-a395-faeadda616f2/resource/4b0fdc88-2410-4a80-801d-9b4fd464e561/download/ghs_pop_e2025_r2023a_54009_100_v1_0_ago.tif
  format: null
  id: resource_4b0fdc88
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-ago_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Angola: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
