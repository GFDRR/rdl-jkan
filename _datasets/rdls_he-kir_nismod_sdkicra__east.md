...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-kir_nismod_sdkicra__east
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Kiribati (East). Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/16540055
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/16540055
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Kiribati (East), clipped from global sources. Contents: (1) Hazard - Coastal flood
  ...
  download_url: https://zenodo.org/records/16540055/files/KIR.zip
  format: null
  id: resource_sdkicra_kir
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Kiribati
    (East)
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-kir_nismod_sdkicra__east
spatial:
  bbox:
  - -174.54
  - -11.46
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/4030945/kiribati.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Kiribati
  (East)
version: 0.1.0
vulnerability: null
---
