...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-guam
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-guam
dataset_id: rdls_exp-gum_kontur_guampopulationdensity400m_2023
description: 'Guam population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-guam]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    and OpenStreetMap) and allocating population counts to 400m H3 hexagonal grid
    cells using spatial overlay and proportional allocation methods. The resulting
    baseline population distribution dataset provides gridded population inventory
    for Guam at high spatial resolution.
  sources:
  - id: source_1
    license: null
    name: Global Human Settlement Layer (GHSL)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-guam
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Guam: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_GU_20220630.gpkg.gz
  format: null
  id: resource_6065a9b5
  ...
  title: kontur_population_GU_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Guam: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_GU_20231101.gpkg.gz
  format: null
  id: resource_7ee62b83
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_GU_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-gum_kontur_guampopulationdensity400m_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Guam: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
