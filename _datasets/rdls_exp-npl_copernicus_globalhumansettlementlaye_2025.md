...
- entity:
    ...
    url: https://data.humdata.org/dataset/npl-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/npl-ghsl
dataset_id: rdls_exp-npl_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/npl-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale, with Nepal-specific extraction
    provided here.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/npl-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/97af5288-8478-48ea-bb4e-8fb2b26f0bbf/resource/02577a82-4814-4ec8-9e0b-84b89f3ef3ba/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_npl.tif
  format: null
  id: resource_02577a82
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Nepal: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/97af5288-8478-48ea-bb4e-8fb2b26f0bbf/resource/d768698d-8a34-49db-85e5-9d89643d53eb/download/ghs_pop_e2025_r2023a_54009_100_v1_0_npl.tif
  format: null
  id: resource_d768698d
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-npl_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Nepal: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
