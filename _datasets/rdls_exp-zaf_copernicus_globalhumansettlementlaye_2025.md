...
- entity:
    ...
    url: https://data.humdata.org/dataset/zaf-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/zaf-ghsl
dataset_id: rdls_exp-zaf_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/zaf-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    spatial extent and density of human settlements and infrastructure across South
    Africa.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/zaf-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/3893356f-0aee-4757-975b-4985a00cab72/resource/3d45e6ca-15d4-4f97-b2c6-4fe1c0258a61/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_zaf.tif
  format: null
  id: resource_3d45e6ca
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'South Africa: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/3893356f-0aee-4757-975b-4985a00cab72/resource/abb2abf9-2ac9-40a0-be6f-dd52fb5f423b/download/ghs_pop_e2025_r2023a_54009_100_v1_0_zaf.tif
  format: null
  id: resource_abb2abf9
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-zaf_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'South Africa: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
