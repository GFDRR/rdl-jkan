...
- entity:
    ...
    url: https://data.humdata.org/dataset/vat-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/vat-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-vat_hdx_holyseeibtracsstormtracks_1883
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/vat-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track dataset. Source observations
    are standardized and merged using the IBTrACS algorithm to assign unique storm
    identifiers and create consistent track geometries with associated wind speed
    and pressure measurements at 6-hourly intervals.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vat-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Holy See.
  download_url: https://data.humdata.org/dataset/8c5618fc-0cee-4c9e-952d-3ca39951bf00/resource/7bf46cdf-224a-424d-96b2-7791ac35c127/download/ibtracs_all_list_v04r01_vat.csv
  format: null
  id: resource_7bf46cdf
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_VAT.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Holy See.
  download_url: https://data.humdata.org/dataset/8c5618fc-0cee-4c9e-952d-3ca39951bf00/resource/c70a3eb9-f6db-4e5a-90aa-7319023a788d/download/ibtracs_all_list_v04r01_lines_vat.geojson
  format: null
  id: resource_c70a3eb9
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_VAT.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-vat_hdx_holyseeibtracsstormtracks_1883
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1883-08-20'
temporal_resolution: null
title: 'Holy See: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
