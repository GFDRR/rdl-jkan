...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ner-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ner_hdx_ibtracsstormtracks_1866
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ner-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone track data from
    ...
    Niger subset contains observed storm positions, wind speeds (WMO standard), central
    pressure, and storm classification at 6-hourly intervals, providing the most complete
    global collection of tropical cyclone observations.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ner-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1866 to date that pass within 2000 kilometers
    of Niger.
  download_url: https://data.humdata.org/dataset/5af549d7-c71f-4fd8-baf8-b0240c1acd50/resource/3e7b7cf2-2dd7-471a-b9d3-c9766d5b4c1a/download/ibtracs_all_list_v04r01_ner.csv
  format: null
  id: resource_3e7b7cf2
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_NER.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1866 to date that pass within 2000 kilometers
    of Niger.
  download_url: https://data.humdata.org/dataset/5af549d7-c71f-4fd8-baf8-b0240c1acd50/resource/29e9b9c4-012f-4f0d-b7dd-836951b0ad5a/download/ibtracs_all_list_v04r01_lines_ner.geojson
  format: null
  id: resource_29e9b9c4
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_NER.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ner_hdx_ibtracsstormtracks_1866
spatial:
  bbox: null
  centroid: null
  countries:
