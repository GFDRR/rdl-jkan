...
- entity:
    ...
    email: null
    name: METEOR Project
    url: https://data.humdata.org/dataset/ethiopia-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/ethiopia-level-1-exposure-data
dataset_id: rdls_exp-eth_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ethiopia-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data was developed through the METEOR project using
    ...
    global-quality Level 1 exposure estimates. The dataset presents gridded building
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ethiopia-level-1-exposure-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Ethiopia produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/3638d28b-4202-44f7-a4df-84b1e8bd9dfc/resource/52f63f91-332f-4acf-8ca7-8b49b24e0dc0/download/eth_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_52f63f91
  ...
  title: ETH_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-eth_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Ethiopia: Level 1 Exposure Data'
version: null
vulnerability: null
---
