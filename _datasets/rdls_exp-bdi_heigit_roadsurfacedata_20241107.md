...
- entity:
    ...
    url: https://data.humdata.org/dataset/burundi-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/burundi-road-surface-data
dataset_id: rdls_exp-bdi_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/burundi-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    learning approach to predict and classify road surface types (paved vs unpaved).
    The model processes OSM geometries and attributes alongside satellite imagery
    to generate surface predictions, resulting in a classified road infrastructure
    dataset with both observed and predicted surface characteristics across Burundi.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/burundi-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Burundi: Road Surface Data (GeoJSON data for Burundi.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bdi_roadsurface_lines.geojson
  format: null
  id: resource_6293c54e
  ...
  title: Burundi GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Burundi: Road Surface Data (Geopackage data for Burundi.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_bdi_roadsurface_lines.gpkg
  format: null
  id: resource_ec1a22ae
  ...
  temporal: null
  temporal_resolution: null
  title: Burundi GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bdi_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Burundi: Road Surface Data'
version: null
vulnerability: null
---
