...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/lao-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/lao-rainfall-subnational
dataset_id: rdls_hzd-lao_wfp_laopeoplesdemocraticrepub_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/lao-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite imagery integrated
    ...
    units to produce dekadal rainfall indicators including 10-day totals, 1-month
    and 3-month rolling aggregations, and long-term averages for meteorological drought
    monitoring.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lao-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135611791020_1cd68264'
  download_url: https://data.humdata.org/dataset/9d4ce780-0aa6-4cc4-983f-3aef58c93e78/resource/cd8610a5-d196-486f-a2f7-a124d0695e3a/download/lao-rainfall-subnat-full.csv
  format: null
  id: resource_cd8610a5
  media_type: text/csv
  spatial: null
  ...
  title: lao-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135611791020_1cd68264'
  download_url: https://data.humdata.org/dataset/9d4ce780-0aa6-4cc4-983f-3aef58c93e78/resource/185837ea-c0f3-41d1-842a-2f989221f840/download/lao-rainfall-subnat-5ytd.csv
  format: null
  id: resource_185837ea
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: lao-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lao_wfp_laopeoplesdemocraticrepub_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Lao People''s Democratic Republic: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
