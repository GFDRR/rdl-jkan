...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kenya
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kenya
dataset_id: rdls_exp-ken_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kenya]'
...
license: CC-BY-4.0
lineage:
  description: The GAR15 exposure dataset for Kenya was developed using a top-down
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-kenya
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Kenya.zip
  download_url: https://data.humdata.org/dataset/8233018d-4536-46e2-b38b-c2b8c925595c/resource/1fa44c71-01f9-47eb-a44d-aca87b517a1b/download/ken.zip
  format: null
  id: resource_1fa44c71
  ...
  title: GAR15 Global Exposure Dataset for Kenya.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-ken_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Kenya
version: null
vulnerability: null
---
