...
- entity:
    ...
    url: https://data.humdata.org/dataset/hti-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/hti-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-hti_hdx_ibtracsstormtracks_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/hti-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    standardized and quality-controlled. The Haiti subset contains all tropical cyclones
    affecting or passing through the Haiti region with temporal resolution at observation
    times.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hti-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Haiti.
  download_url: https://data.humdata.org/dataset/9c530d8c-19dd-462b-9550-2debf698c874/resource/0b227026-bf7d-471c-b511-7a55404e154a/download/ibtracs_all_list_v04r01_hti.csv
  format: null
  id: resource_0b227026
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_HTI.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Haiti.
  download_url: https://data.humdata.org/dataset/9c530d8c-19dd-462b-9550-2debf698c874/resource/8097a2ae-db70-4662-9093-96ed19e9cad6/download/ibtracs_all_list_v04r01_lines_hti.geojson
  format: null
  id: resource_8097a2ae
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_HTI.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-hti_hdx_ibtracsstormtracks_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-23'
temporal_resolution: null
title: 'Haiti: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
