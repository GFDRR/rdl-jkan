...
- entity:
    ...
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
      (DTM)
    url: https://data.humdata.org/dataset/dji-iom-dtm-from-api
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: International Organization for Migration (IOM)
  url: https://data.humdata.org/dataset/dji-iom-dtm-from-api
dataset_id: rdls_lss-dji_iom_displacementtrackingmatri_20220930
description: 'This dataset comes from the International Organization for Migration
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/dji-iom-dtm-from-api]'
...
lineage:
  description: IOM DTM field teams conduct baseline assessments, emergency tracking,
    and site assessments to enumerate internally displaced populations across Djibouti.
    Data is aggregated at admin 0, 1, and 2 levels and made available through the
    public DTM API, with displacement counts disaggregated by sex and origin location
    to support humanitarian response planning.
  sources:
  - id: source_1
    license: null
    name: International Organization for Migration (IOM) Displacement Tracking Matrix
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dji-iom-dtm-from-api
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  description: Djibouti IOM displacement tracking matrix data at admin levels 0-2,
    sourced from the DTM API
  download_url: https://data.humdata.org/dataset/abcd4f35-8b7f-4587-870f-838cd3930edb/resource/dda02b5b-b303-4c14-bf75-cdfe3950d0f9/download/dji-iom-dtm-from-api-admin-0-to-2.csv
  format: null
  id: resource_dda02b5b
  media_type: text/csv
  spatial: null
  ...
  title: Djibouti IOM DTM data for admin levels 0-2
risk_data_type:
- loss
schema: rdls-10
slug: rdls_lss-dji_iom_displacementtrackingmatri_20220930
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-09-30'
temporal_resolution: null
title: Djibouti IOM Displacement Tracking Matrix (DTM) from API
version: null
vulnerability: null
---
