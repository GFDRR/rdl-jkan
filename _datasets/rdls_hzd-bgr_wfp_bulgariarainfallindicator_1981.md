...
- entity:
    ...
    url: https://data.humdata.org/dataset/bgr-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/bgr-rainfall-subnational
dataset_id: rdls_hzd-bgr_wfp_bulgariarainfallindicator_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/bgr-rainfall-subnational]'
...
lineage:
  description: Dekadal (10-day) precipitation estimates are derived from the CHIRPS
    v2 satellite-gauge merged product and CHIRPS-GEFS forecast data produced by the
    Climate Hazards Center, UC Santa Barbara. WFP aggregates pixel-level rainfall
    values to subnational administrative boundaries to compute rolling accumulations
    (1-month, 3-month), long-term averages, and anomaly percentiles (rfq, r1q, r3q)
    for drought monitoring and early warning purposes.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) v2
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135630441218_11862302'
  download_url: https://data.humdata.org/dataset/02fecc4d-7b91-49dd-aab1-6de428ac01ac/resource/0472503a-240e-4184-b54b-7e163232d308/download/bgr-rainfall-subnat-full.csv
  format: null
  id: resource_0472503a
  media_type: text/csv
  spatial: null
  ...
  title: bgr-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135630441218_11862302'
  download_url: https://data.humdata.org/dataset/02fecc4d-7b91-49dd-aab1-6de428ac01ac/resource/951d8f47-3553-474f-9d37-7dc7256cc4d3/download/bgr-rainfall-subnat-5ytd.csv
  format: null
  id: resource_951d8f47
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: bgr-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bgr_wfp_bulgariarainfallindicator_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Bulgaria: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
