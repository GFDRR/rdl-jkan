...
creator:
  ...
  name: IGAD DRM Team
  url: https://geoportal.icpac.net/api/v2/users/1001
dataset_id: rdls_hzd-ken_icpac_floodinundation100yearret
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://geoportal.icpac.net/layers/Kenya_flood_inundation:geonode:Kenya_flood_inundation
  rel: source
loss: null
project: null
publisher:
...
referenced_by: []
resources:
- access_url: https://geoportal.icpac.net/datasets/geonode:geonode:Kenya_flood_inundation
  baseline_period: null
  climate: null
  conforms_to: http://www.opengis.net/def/serviceType/ogc/wms
  coordinate_system: EPSG:4326
  description: 'Kenya Flood Inundation (100 year return period) (OGC WMS: geonode
    Service)'
  download_url: https://geoportal.icpac.net/geoserver/ows?service=WMS&version=1.1.1&request=GetMap&layers=geonode:geonode:Kenya_flood_inundation&format=image%2Fpng
  format: null
  id: resource_0
...
- access_url: https://geoportal.icpac.net/datasets/geonode:geonode:Kenya_flood_inundation
  ...
  coordinate_system: EPSG:4326
  description: 'Kenya Flood Inundation (100 year return period) (OGC WCS: geonode
    Service)'
  download_url: https://geoportal.icpac.net/geoserver/ows?service=WCS&version=2.0.1&request=DescribeCoverage&CoverageId=geonode__geonode:Kenya_flood_inundation
  format: null
  id: resource_1
...
- hazard
schema: rdls-10
slug: rdls_hzd-ken_icpac_floodinundation100yearret
spatial:
  bbox:
  - 33.90999435999713
  - -4.678331350466952
