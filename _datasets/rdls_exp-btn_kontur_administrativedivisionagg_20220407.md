...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-boundaries-bhutan
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-boundaries-bhutan
dataset_id: rdls_exp-btn_kontur_administrativedivisionagg_20220407
description: 'Bhutan administrative division with aggregated population. Built from
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-boundaries-bhutan]'
...
lineage:
  description: Administrative boundaries were extracted from OpenStreetMap data using
    proprietary enhancements and filtered to Bhutan. Population counts were aggregated
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-boundaries-bhutan
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Bhutan: Administrative Division with Aggregated Population (Release
    2022-04-07)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.eu-central-1.amazonaws.com/kontur_datasets/kontur_boundaries_BT_20220407.gpkg.gz
  format: null
  id: resource_8cf0dc57
  ...
  title: kontur_boundaries_BT_20220407.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Bhutan: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_boundaries_BT_20230628.gpkg.gz
  format: null
  id: resource_82f44478
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_boundaries_BT_20230628.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Bhutan: Administrative Division with Aggregated Population (Release
    2023-06-28)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_topology_boundaries_BT_20230628.gpkg.gz
  format: null
  id: resource_128ecfc9
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_topology_boundaries_BT_20230628.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-btn_kontur_administrativedivisionagg_20220407
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2022-04-07'
temporal_resolution: null
title: 'Bhutan: Administrative Division with Aggregated Population'
version: null
vulnerability: null
---
