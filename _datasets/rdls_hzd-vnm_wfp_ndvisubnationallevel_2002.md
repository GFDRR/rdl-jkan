...
- entity:
    ...
    url: https://data.humdata.org/dataset/vnm-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/vnm-ndvi-subnational
dataset_id: rdls_hzd-vnm_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/vnm-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI indicators at sub-national administrative units defined by WFP. NDVI anomalies
    were computed as percentage deviations from long-term averages to characterize
    vegetation stress patterns indicative of agricultural drought conditions.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/vnm-ndvi-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135809119987_c448d5f1'
  download_url: https://data.humdata.org/dataset/e211a1f7-2d29-4b97-8956-ba68548f4318/resource/f8172d5c-9343-47aa-9db2-1e2dd2563036/download/vnm-ndvi-subnat-full.csv
  format: null
  id: resource_f8172d5c
  media_type: text/csv
  spatial: null
  ...
  title: vnm-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135809119987_c448d5f1'
  download_url: https://data.humdata.org/dataset/e211a1f7-2d29-4b97-8956-ba68548f4318/resource/0153a5b4-f41a-470d-8000-910d6d3625a0/download/vnm-ndvi-subnat-5ytd.csv
  format: null
  id: resource_0153a5b4
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: vnm-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-vnm_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Viet Nam: NDVI at Subnational Level'
version: null
vulnerability: null
---
