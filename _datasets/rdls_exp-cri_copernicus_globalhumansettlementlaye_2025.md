...
- entity:
    ...
    url: https://data.humdata.org/dataset/cri-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cri-ghsl
dataset_id: rdls_exp-cri_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cri-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery, census data,
    ...
    distribution. The Costa Rica subset represents the national application of this
    global methodology for characterizing human settlement patterns.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cri-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/48e64551-0259-4e5d-b8ff-321c5d0b2a10/resource/227624a0-b886-4675-a1dd-5508cabc0b31/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cri.tif
  format: null
  id: resource_227624a0
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Costa Rica: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/48e64551-0259-4e5d-b8ff-321c5d0b2a10/resource/4173c326-4402-41d6-a4bc-54933a204b8c/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cri.tif
  format: null
  id: resource_4173c326
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cri_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Costa Rica: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
