...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/com-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/com-rainfall-subnational
dataset_id: rdls_hzd-com_wfp_rainfallindicatorssubnati_1981
description: 'This dataset contains dekadal rainfall indicators, computed from Climate
  ...
  https://data.humdata.org/dataset/com-rainfall-subnational]'
...
lineage:
  description: Rainfall data were derived from CHIRPS satellite observations merged
    ...
    at subnational administrative units in Comoros to produce drought monitoring indicators.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/com-rainfall-subnational
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135446867059_e5550f82'
  download_url: https://data.humdata.org/dataset/a043460f-3389-44cf-b199-323a9fc242c2/resource/a9a1bcbb-2ca4-4275-b261-6185c52879c5/download/com-rainfall-subnat-full.csv
  format: null
  id: resource_a9a1bcbb
  media_type: text/csv
  spatial: null
  ...
  title: com-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135446867059_e5550f82'
  download_url: https://data.humdata.org/dataset/a043460f-3389-44cf-b199-323a9fc242c2/resource/3e2d86c8-82ab-49b6-8cc3-5f5a277705f4/download/com-rainfall-subnat-5ytd.csv
  format: null
  id: resource_3e2d86c8
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: com-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-com_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Comoros: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
