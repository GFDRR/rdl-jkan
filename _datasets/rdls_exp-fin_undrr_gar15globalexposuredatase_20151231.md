...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-finland
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-finland
dataset_id: rdls_exp-fin_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-finland]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    ...
    for the GAR15 global exposure database to provide spatially-explicit asset inventories
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-finland
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Finland.zip
  download_url: https://data.humdata.org/dataset/b2bc0d6f-c90a-495a-9860-28cdd55130cd/resource/4e9c3c2e-9ad5-41fe-9e63-7b49ef6137eb/download/fin.zip
  format: null
  id: resource_4e9c3c2e
  ...
  title: GAR15 Global Exposure Dataset for Finland.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-fin_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Finland
version: null
vulnerability: null
---
