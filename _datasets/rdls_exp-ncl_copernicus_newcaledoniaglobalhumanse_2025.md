...
- entity:
    ...
    url: https://data.humdata.org/dataset/ncl-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/ncl-ghsl
dataset_id: rdls_exp-ncl_copernicus_newcaledoniaglobalhumanse_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/ncl-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    automated spatial data analytics to produce gridded estimates of built-up surface
    extent and population distribution at fine spatial resolution.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ncl-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/78d25672-d2f5-4e72-8280-748d73335091/resource/61a39d9c-a8a5-4208-947c-9697f197a66b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_ncl.tif
  format: null
  id: resource_61a39d9c
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'New Caledonia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/78d25672-d2f5-4e72-8280-748d73335091/resource/875ed1d6-7868-43d1-a893-bddebcf2b40b/download/ghs_pop_e2025_r2023a_54009_100_v1_0_ncl.tif
  format: null
  id: resource_875ed1d6
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-ncl_copernicus_newcaledoniaglobalhumanse_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'New Caledonia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
