...
creator:
  ...
  name: Tom Russell
  url: https://orcid.org/0000-0002-0081-400X
dataset_id: rdls_he-cxr_nismod_sdkicra
description: Starter data kit collecting extracts from global, open datasets relating
  ...
  roads, railways, power infrastructure) for Christmas Island. Derived from global
...
publisher:
  ...
  name: Zenodo
  url: https://zenodo.org/records/10796647
...
referenced_by: []
resources:
- access_url: https://zenodo.org/records/10796647
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Single ZIP archive containing all hazard and exposure datasets for
    Christmas Island, clipped from global sources. Contents: (1) Hazard - Coastal
  ...
  download_url: https://zenodo.org/records/10796647/files/CXR.zip
  format: null
  id: resource_sdkicra_cxr
  ...
  title: Starter Data Kit for Infrastructure Climate Resilience Assessment - Christmas
    Island
risk_data_type:
- hazard
- exposure
schema: rdls-10
slug: rdls_he-cxr_nismod_sdkicra
spatial:
  bbox:
  - 105.58
  - -10.57
  ...
  - description: Geonames
    id: gazetteer_1
    scheme: GEONAMES
    uri: https://www.geonames.org/2078138/christmas-island.html
  scale: national
spatial_resolution: null
temporal: null
temporal_resolution: null
title: Infrastructure Climate Resilience Assessment Data Starter Kit for Christmas
  Island
version: 0.1.0
vulnerability: null
---
