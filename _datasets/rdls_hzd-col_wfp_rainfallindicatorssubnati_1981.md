...
- entity:
    ...
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
      2
    url: https://data.humdata.org/dataset/col-rainfall-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/col-rainfall-subnational
dataset_id: rdls_hzd-col_wfp_rainfallindicatorssubnati_1981
...
lineage:
  description: Rainfall data derived from CHIRPS satellite observations merged with
    in-situ station measurements, aggregated into dekadal indicators (10-day, 1-month,
    and 3-month rolling aggregations) at subnational administrative boundaries. Indicators
    include absolute rainfall amounts and anomalies relative to long-term averages,
    computed to characterize meteorological drought conditions.
  sources:
  - id: source_1
    license: null
    name: Climate Hazards Group InfraRed Precipitation with Stations (CHIRPS) version
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/col-rainfall-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135441752143_245118fb'
  download_url: https://data.humdata.org/dataset/c454f2ed-0d2e-4ca6-a35b-d00220e16fcf/resource/d001e1f2-4667-40ec-83c2-5dbb2e4878b0/download/col-rainfall-subnat-full.csv
  format: null
  id: resource_d001e1f2
  media_type: text/csv
  spatial: null
  ...
  title: col-rainfall-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135441752143_245118fb'
  download_url: https://data.humdata.org/dataset/c454f2ed-0d2e-4ca6-a35b-d00220e16fcf/resource/91291d68-0f1a-4b6f-8d44-7f3b509a7a21/download/col-rainfall-subnat-5ytd.csv
  format: null
  id: resource_91291d68
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: col-rainfall-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-col_wfp_rainfallindicatorssubnati_1981
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1981-01-01'
temporal_resolution: null
title: 'Colombia: Rainfall Indicators at Subnational Level'
version: null
vulnerability: null
---
