...
- entity:
    ...
    url: https://data.humdata.org/dataset/denmark-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/denmark-planet-road-surface-data
dataset_id: rdls_exp-dnk_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ surface conditions in many regions. Summary of Road Statistics Approximately 0.0134\
  \ million km of arterial roads are mapped in OSM in this region. - Paved roads:\
  \ 0.0133 million km (99.2665%) - Unpaved roads: 0.0 million km (0.0%) - Missing\
  \ OSM surface tags: 0.0 million km (0.0048%) - PlanetScope predictions cover: 0.0133\
  \ million km (2071631.2594%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/denmark-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries from OpenStreetMap were extracted for arterial
    highways in Denmark. Deep learning models trained on PlanetScope satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/denmark-planet-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Denmark: Planet Road Surface, Width, and Passability Data (GeoJSON
    file for Denmark)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_DK_planet_roadsurface_lines.geojson
  format: null
  id: resource_e1207349
  ...
  title: Denmark GeoJSON heigit_DK_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Denmark: Planet Road Surface, Width, and Passability Data (Geopackage
    file for Denmark)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_DK_planet_roadsurface_lines.gpkg
  format: null
  id: resource_e537efdf
  ...
  temporal: null
  temporal_resolution: null
  title: Denmark GPKG heigit_DK_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dnk_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Denmark: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
