...
- entity:
    ...
    url: https://data.humdata.org/dataset/alb-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/alb-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-alb_hdx_ibtracsstormtracks_1883
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/alb-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Albania
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/alb-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Albania.
  download_url: https://data.humdata.org/dataset/886b40c9-1fed-43da-a04f-a775e8ed0d4d/resource/9c7d7828-19d3-43de-bab8-9dcd773481da/download/ibtracs_all_list_v04r01_alb.csv
  format: null
  id: resource_9c7d7828
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_ALB.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Albania.
  download_url: https://data.humdata.org/dataset/886b40c9-1fed-43da-a04f-a775e8ed0d4d/resource/5a47f656-4d6b-40c3-83f5-3aa3f6c671a2/download/ibtracs_all_list_v04r01_lines_alb.geojson
  format: null
  id: resource_5a47f656
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_ALB.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-alb_hdx_ibtracsstormtracks_1883
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1883-08-20'
temporal_resolution: null
title: 'Albania: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
