...
- entity:
    ...
    url: https://data.humdata.org/dataset/icpac-geonode-sudan-flood-inundation-100-year-return-period
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: IGAD Climate Prediction and Applications Center (ICPAC)
  url: https://data.humdata.org/dataset/icpac-geonode-sudan-flood-inundation-100-year-return-period
dataset_id: rdls_hzd-sdn_icpac_floodinundation100yearret_20250328
description: 'This dataset is the output from the Global Flood Model intercomparison
  ...
  https://data.humdata.org/dataset/icpac-geonode-sudan-flood-inundation-100-year-return-period]'
...
license: CC-BY-4.0
lineage:
  description: Fluvial flood inundation extents were generated by 6 global flood models
    as part of the Global Flood Partnership intercomparison project. Model outputs
    were harmonized to WGS84 at ~90m resolution and reclassified to integer values
    (0-6) representing the number of models agreeing that each cell is inundated at
    the 100-year return period. The dataset provides a probabilistic consensus hazard
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/icpac-geonode-sudan-flood-inundation-100-year-return-period
  rel: source
loss: null
project: null
publisher:
...
referenced_by: []
resources:
- access_url: https://geoportal.icpac.net/geoserver/ows?service=WCS&request=GetCoverage&coverageid=geonode__Sudan_flood_inundation&format=image%2Ftiff&version=2.0.1&compression=DEFLATE&tileWidth=512&tileHeight=512
  ...
  title: Sudan Flood Inundation (100 year return period) GeoTIFF
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-sdn_icpac_floodinundation100yearret_20250328
spatial:
  bbox: null
  centroid: null
  countries:
