...
- entity:
    ...
    url: https://data.humdata.org/dataset/bgr-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/bgr-ghsl
dataset_id: rdls_exp-bgr_copernicus_bulgariaglobalhumansettle_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/bgr-ghsl]'
...
lineage:
  description: The GHSL dataset integrates global fine-scale satellite imagery, census
    ...
    distribution. The Bulgaria subset represents national-scale exposure data derived
    from this global processing pipeline.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bgr-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/7cc7455b-84c2-49c4-87f7-de00c7ae77ac/resource/ef5197cf-a61c-4c77-93e9-64f653ca472c/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_bgr.tif
  format: null
  id: resource_ef5197cf
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Bulgaria: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/7cc7455b-84c2-49c4-87f7-de00c7ae77ac/resource/3b242e86-950b-4bba-a23d-cfd620160299/download/ghs_pop_e2025_r2023a_54009_100_v1_0_bgr.tif
  format: null
  id: resource_3b242e86
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-bgr_copernicus_bulgariaglobalhumansettle_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Bulgaria: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
