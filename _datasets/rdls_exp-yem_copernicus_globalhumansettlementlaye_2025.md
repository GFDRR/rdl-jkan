...
- entity:
    ...
    url: https://data.humdata.org/dataset/yem-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/yem-ghsl
dataset_id: rdls_exp-yem_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/yem-ghsl]'
...
lineage:
  description: The GHSL dataset integrates multi-source geospatial data including
    fine-scale satellite imagery, census records, and crowdsourced geographic information
    through automated spatial data processing technologies to produce gridded estimates
    of built-up surfaces and population distribution at global scale.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/yem-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/4350bff4-1d2e-49d9-91f9-faa2593f3c87/resource/1681165c-debd-42c9-8038-f7ed4cb097c3/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_yem.tif
  format: null
  id: resource_1681165c
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Yemen: Copernicus Global Human Settlement Layer (GHSL) (Product: GHS-POP,
    Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/4350bff4-1d2e-49d9-91f9-faa2593f3c87/resource/7a531261-7153-4a5b-a3d5-5afb260ed4a4/download/ghs_pop_e2025_r2023a_54009_100_v1_0_yem.tif
  format: null
  id: resource_7a531261
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-yem_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Yemen: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
