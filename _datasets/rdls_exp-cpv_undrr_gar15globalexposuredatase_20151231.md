...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cabo-verde
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cabo-verde
dataset_id: rdls_exp-cpv_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cabo-verde]'
...
lineage:
  description: National-level socio-economic data, building type distributions, and
    capital stock were obtained from statistical sources and transposed onto 5x5 km
    and 1x1 km gridded surfaces using geographic population density and GDP as spatial
    proxies. The dataset was developed collaboratively by UNEP-GRID, WAPMERR, JRC,
    and Kokusai Kogyo for the Global Assessment Report on Disaster Risk Reduction
    (GAR15) to create a spatially explicit exposure database for Cabo Verde.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cabo-verde
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Cabo Verde.zip
  download_url: https://data.humdata.org/dataset/87bbdfa3-511c-4e43-a52f-2c45b0d547fc/resource/a44bc060-fa31-454b-9b0f-b535c71b51ca/download/cpv.zip
  format: null
  id: resource_a44bc060
  ...
  title: GAR15 Global Exposure Dataset for Cabo Verde.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cpv_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Cabo Verde
version: null
vulnerability: null
---
