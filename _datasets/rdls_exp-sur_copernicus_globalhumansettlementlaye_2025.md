...
- entity:
    ...
    url: https://data.humdata.org/dataset/sur-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/sur-ghsl
dataset_id: rdls_exp-sur_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/sur-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery (Sentinel),
    ...
    and population distribution at global scale. For Suriname, this produces rasterized
    exposure layers representing building infrastructure and human settlement patterns.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sur-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/5ce30887-3179-404a-80a9-d5c51e687368/resource/c849d5be-0c1b-4cfc-aa34-b242fc036bef/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_sur.tif
  format: null
  id: resource_c849d5be
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Suriname: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/5ce30887-3179-404a-80a9-d5c51e687368/resource/14df94a6-4664-4697-be00-344bd14d2cf3/download/ghs_pop_e2025_r2023a_54009_100_v1_0_sur.tif
  format: null
  id: resource_14df94a6
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-sur_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Suriname: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
