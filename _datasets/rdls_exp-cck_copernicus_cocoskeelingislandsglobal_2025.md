...
- entity:
    ...
    url: https://data.humdata.org/dataset/cck-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/cck-ghsl
dataset_id: rdls_exp-cck_copernicus_cocoskeelingislandsglobal_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/cck-ghsl]'
...
lineage:
  description: The GHSL project processes global fine-scale satellite imagery, census
    ...
    Cocos (Keeling) Islands, two GeoTIFF rasters represent built-up surface extent
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cck-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/9f1ae444-d7df-4e37-afb8-b5ed115cec3e/resource/9808e84c-2672-49d2-8a6f-cf6cb0893b4b/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_cck.tif
  format: null
  id: resource_9808e84c
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Cocos (Keeling) Islands: Copernicus Global Human Settlement Layer
    (GHSL) (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/9f1ae444-d7df-4e37-afb8-b5ed115cec3e/resource/3eedfad5-46f8-4033-9bb4-6975df237595/download/ghs_pop_e2025_r2023a_54009_100_v1_0_cck.tif
  format: null
  id: resource_3eedfad5
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-cck_copernicus_cocoskeelingislandsglobal_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Cocos (Keeling) Islands: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
