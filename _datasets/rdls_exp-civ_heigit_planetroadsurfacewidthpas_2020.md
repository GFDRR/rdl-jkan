...
- entity:
    ...
    url: https://data.humdata.org/dataset/cote-divoire-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/cote-divoire-planet-road-surface-data
dataset_id: rdls_exp-civ_heigit_planetroadsurfacewidthpas_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0091 million km (72.3946%) - Unpaved roads: 0.003 million km (24.1239%) - Missing\
  \ OSM surface tags: 0.0 million km (0.3811%) - PlanetScope predictions cover: 0.0121\
  \ million km (25324.8992%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cote-divoire-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: "Road network data from OpenStreetMap was extracted for arterial highways\
    \ in C\xF4te d'Ivoire. Deep learning models were applied to PlanetScope satellite\
    ...
    \ (HPI) based on passability risk scores. The resulting dataset supports humanitarian\
    \ logistics planning and transportation infrastructure assessment."
  sources:
  - id: source_1
    license: null
    name: PlanetScope satellite imagery
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cote-divoire-planet-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: "C\xF4te d'Ivoire: Planet Road Surface, Width, and Passability Data\
    \ (Geopackage file for C\xF4te d'ivoire)"
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_CI_planet_roadsurface_lines.gpkg
  format: null
  id: resource_c04274c8
  ...
  title: "C\xF4te d'ivoire GPKG heigit_CI_planet_roadsurface_lines.gpkg"
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: "C\xF4te d'Ivoire: Planet Road Surface, Width, and Passability Data\
    \ (GeoJSON file for C\xF4te d'ivoire)"
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_CI_planet_roadsurface_lines.geojson
  format: null
  id: resource_aecabb77
  ...
  temporal: null
  temporal_resolution: null
  title: "C\xF4te d'ivoire GeoJSON heigit_CI_planet_roadsurface_lines.geojson"
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-civ_heigit_planetroadsurfacewidthpas_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: "C\xF4te d'Ivoire: Planet Road Surface, Width, and Passability Data"
version: null
vulnerability: null
---
