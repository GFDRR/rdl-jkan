...
- entity:
    ...
    url: https://data.humdata.org/dataset/smr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/smr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-smr_hdx_sanmarinoibtracsstormtrac_1865
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/smr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    positions, wind speeds (WMO standard), and central pressures are recorded at regular
    time intervals and filtered for San Marino's geographic region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/smr-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of San Marino.
  download_url: https://data.humdata.org/dataset/545ec10b-f155-4520-ad1f-32d4d20f43bf/resource/40be05a5-a2fb-43d0-965c-001270547f7b/download/ibtracs_all_list_v04r01_smr.csv
  format: null
  id: resource_40be05a5
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_SMR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of San Marino.
  download_url: https://data.humdata.org/dataset/545ec10b-f155-4520-ad1f-32d4d20f43bf/resource/585cb9a2-e340-43bb-ae08-6f04a4c0890a/download/ibtracs_all_list_v04r01_lines_smr.geojson
  format: null
  id: resource_585cb9a2
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_SMR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-smr_hdx_sanmarinoibtracsstormtrac_1865
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1865-10-24'
temporal_resolution: null
title: 'San Marino: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
