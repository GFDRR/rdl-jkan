...
- entity:
    ...
    url: https://data.humdata.org/dataset/dnk-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/dnk-ghsl
dataset_id: rdls_exp-dnk_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/dnk-ghsl]'
...
lineage:
  description: The GHSL dataset combines fine-scale satellite imagery, census data,
    ...
    distribution at global scale, with Denmark-specific outputs provided as GeoTIFF
    rasters.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dnk-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/deb52aeb-b22b-44fc-9a58-7f2b33331858/resource/e47a7317-9637-4407-93b5-04449cecfd6d/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_dnk.tif
  format: null
  id: resource_e47a7317
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Denmark: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/deb52aeb-b22b-44fc-9a58-7f2b33331858/resource/ccba138e-7f79-442a-b900-b9ea8116a605/download/ghs_pop_e2025_r2023a_54009_100_v1_0_dnk.tif
  format: null
  id: resource_ccba138e
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-dnk_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Denmark: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
