...
- entity:
    ...
    url: https://data.humdata.org/dataset/aut-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/aut-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-aut_hdx_ibtracsstormtracks_1853
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/aut-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    meteorological agencies into a unified best-track archive. The dataset for Austria
    contains observed storm track positions, wind speeds (wmo_wind), and central pressure
    (wmo_pres) at regular time intervals, providing empirical hazard characterization
    of tropical cyclone events affecting or passing near the region.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/aut-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Austria.
  download_url: https://data.humdata.org/dataset/97a0d886-b3b2-443c-a223-6c954e850c9e/resource/a6f22121-504b-41c5-ac22-61cbecb6c764/download/ibtracs_all_list_v04r01_aut.csv
  format: null
  id: resource_a6f22121
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_AUT.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1853 to date that pass within 2000 kilometers
    of Austria.
  download_url: https://data.humdata.org/dataset/97a0d886-b3b2-443c-a223-6c954e850c9e/resource/00a1a89f-af9a-413c-9f00-b1879f2c22ca/download/ibtracs_all_list_v04r01_lines_aut.geojson
  format: null
  id: resource_00a1a89f
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_AUT.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-aut_hdx_ibtracsstormtracks_1853
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1853-08-30'
temporal_resolution: null
title: 'Austria: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
