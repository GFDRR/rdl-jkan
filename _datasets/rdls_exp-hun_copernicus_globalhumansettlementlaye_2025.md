...
- entity:
    ...
    url: https://data.humdata.org/dataset/hun-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/hun-ghsl
dataset_id: rdls_exp-hun_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/hun-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    surfaces and population distribution. The Hungary subset represents national-scale
    exposure data derived from this global processing pipeline.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hun-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/f6e1e9a4-9247-40ab-9ede-ad11a54ac693/resource/e8279000-e098-41da-920c-ae36fdb39c44/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_hun.tif
  format: null
  id: resource_e8279000
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Hungary: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/f6e1e9a4-9247-40ab-9ede-ad11a54ac693/resource/2de9beab-aab1-4423-9d25-e298163c38db/download/ghs_pop_e2025_r2023a_54009_100_v1_0_hun.tif
  format: null
  id: resource_2de9beab
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-hun_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Hungary: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
