...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-bonaire-sint-eustatius-and-saba
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-bonaire-sint-eustatius-and-saba
dataset_id: rdls_exp-bes_kontur_bonairesinteustatiussabap_2023
description: 'Bonaire, Sint Eustatius and Saba population density for 400m H3 hexagons.
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-bonaire-sint-eustatius-and-saba]'
...
lineage:
  description: Population density was derived by fusing multiple global datasets (GHSL,
    ...
    to create a harmonized settlement layer. Population counts were then allocated
    to 400m H3 hexagonal grid cells using the H3 hierarchical spatial indexing system,
    producing a high-resolution baseline population exposure dataset for the three
    Caribbean islands.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-bonaire-sint-eustatius-and-saba
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Bonaire, Sint Eustatius and Saba: Population Density for 400m H3 Hexagons
    (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_BQ_20220630.gpkg.gz
  format: null
  id: resource_913d141f
  ...
  title: kontur_population_BQ_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'Bonaire, Sint Eustatius and Saba: Population Density for 400m H3 Hexagons
    (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_BQ_20231101.gpkg.gz
  format: null
  id: resource_7c43281d
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_BQ_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-bes_kontur_bonairesinteustatiussabap_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Bonaire, Sint Eustatius and Saba: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
