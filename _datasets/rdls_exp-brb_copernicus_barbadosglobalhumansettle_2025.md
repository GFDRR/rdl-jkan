...
- entity:
    ...
    url: https://data.humdata.org/dataset/brb-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/brb-ghsl
dataset_id: rdls_exp-brb_copernicus_barbadosglobalhumansettle_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/brb-ghsl]'
...
lineage:
  description: The GHSL project processes multi-source geospatial data including Copernicus
    ...
    the spatial distribution of human settlements and population density at national
    scale for Barbados.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/brb-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/9663bf23-bc40-46c2-adb7-60437f5ea6f8/resource/317f2ced-19c0-41b5-9853-f493a03c6e0a/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_brb.tif
  format: null
  id: resource_317f2ced
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Barbados: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/9663bf23-bc40-46c2-adb7-60437f5ea6f8/resource/eba055a6-3bec-46e6-a59d-58bc39948f92/download/ghs_pop_e2025_r2023a_54009_100_v1_0_brb.tif
  format: null
  id: resource_eba055a6
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-brb_copernicus_barbadosglobalhumansettle_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Barbados: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
