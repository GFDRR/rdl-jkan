...
- entity:
    ...
    url: https://data.humdata.org/dataset/chile-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/chile-road-surface-data
dataset_id: rdls_exp-chl_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.4409 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.1117 and 0.2348
  (in million kms), corressponding to 25.3428% and 53.2609% respectively of the total
  road length in the dataset region. 0.0943 million km or 21.3964% of road surface
  ...
  to 1.1864% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/chile-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The model generated surface type predictions for approximately 0.44 million km
    of mapped roads in Chile, with quantified estimates of paved (0.1117 million km)
    and unpaved (0.2348 million km) road lengths. The resulting classified road network
    is provided in GeoJSON and GeoPackage formats for humanitarian access and logistics
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/chile-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Chile: Road Surface Data (GeoJSON data for Chile.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_chl_roadsurface_lines.geojson
  format: null
  id: resource_e56088f0
  ...
  title: Chile GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Chile: Road Surface Data (Geopackage data for Chile.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_chl_roadsurface_lines.gpkg
  format: null
  id: resource_ddaddd63
  ...
  temporal: null
  temporal_resolution: null
  title: Chile GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-chl_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
