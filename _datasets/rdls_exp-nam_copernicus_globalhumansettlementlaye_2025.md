...
- entity:
    ...
    url: https://data.humdata.org/dataset/nam-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/nam-ghsl
dataset_id: rdls_exp-nam_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/nam-ghsl]'
...
lineage:
  description: The GHSL dataset integrates multi-source geospatial data including
    ...
    estimates of built-up surfaces and population distribution across Namibia.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/nam-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/80b5ffdd-5f52-4c04-804e-c0a192b755fd/resource/7f0aee7d-0f10-4e8f-9eb6-36bbb4272195/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_nam.tif
  format: null
  id: resource_7f0aee7d
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Namibia: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/80b5ffdd-5f52-4c04-804e-c0a192b755fd/resource/14548ca1-d462-43e8-b422-549f1fcf82f8/download/ghs_pop_e2025_r2023a_54009_100_v1_0_nam.tif
  format: null
  id: resource_14548ca1
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-nam_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Namibia: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
