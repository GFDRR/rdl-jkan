...
creator:
  ...
  name: Chiara Scaini
  url: null
dataset_id: rdls_exp-gfdrr_sfrarrresprojected
description: Current and projected (2080) residential building exposure for Central
  Asia (Kazakhstan, Kyrgyz Republic, Tajikistan, Turkmenistan, Uzbekistan), developed
  under the SFRARR program to support forward-looking multi-country risk assessment.
...
- asset_type: null
  category: buildings
  id: rdls_exp-gfdrr_sfrarrresprojected_exp
  metrics:
  - dimension: structure
    id: rdls_exp-gfdrr_sfrarrresprojected_m1
    measurement:
...
resources:
- access_url: https://datacatalog.worldbank.org/search/dataset/0064254
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Regional layer of residential buildings in Central Asia. Central Asia
    projected (2080) residential exposure. Oblast level: SSP4 Dataset includes SSP1,
    SSP4, SSP5 scenarios. Files: RESIDENTIAL_[OBLAST]._2080_[SSP].csv'
  download_url: null
  format: csv
  id: rdls_exp-gfdrr_sfrarrresprojected_r1
  media_type: text/csv
  spatial: null
...
- exposure
schema: rdls-10
slug: rdls_exp-gfdrr_sfrarrresprojected
spatial:
  bbox:
  - 46.0
  - 34.0
...
temporal: null
temporal_resolution: null
title: Central Asia Exposure - Projected Residential Buildings (SFRARR)
version: '2022'
vulnerability: null
---
