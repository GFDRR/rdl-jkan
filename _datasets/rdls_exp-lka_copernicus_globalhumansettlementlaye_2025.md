...
- entity:
    ...
    url: https://data.humdata.org/dataset/lka-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/lka-ghsl
dataset_id: rdls_exp-lka_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/lka-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite image data streams
    ...
    area and population distribution at global scale, applied here to Sri Lanka.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lka-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/a7c409b4-10cb-4e05-be7d-a737ac66fa75/resource/50cd7ae9-1243-45ef-83be-9029aae19fa1/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_lka.tif
  format: null
  id: resource_50cd7ae9
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'Sri Lanka: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/a7c409b4-10cb-4e05-be7d-a737ac66fa75/resource/16cfcb03-be64-4df1-94a6-e201d6c3935f/download/ghs_pop_e2025_r2023a_54009_100_v1_0_lka.tif
  format: null
  id: resource_16cfcb03
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-lka_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'Sri Lanka: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
