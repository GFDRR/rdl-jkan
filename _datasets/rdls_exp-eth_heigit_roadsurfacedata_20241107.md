...
- entity:
    ...
    url: https://data.humdata.org/dataset/ethiopia-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/ethiopia-road-surface-data
dataset_id: rdls_exp-eth_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.477 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0363 and 0.079
  (in million kms), corressponding to 7.6172% and 16.5703% respectively of the total
  road length in the dataset region. 0.3616 million km or 75.8125% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0018 million km of information (corressponding
  to 0.5095% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ethiopia-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    The resulting dataset provides spatial infrastructure inventory with surface type
    attribution across Ethiopia's road network, supporting humanitarian access and
    logistics planning.
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ethiopia-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Ethiopia: Road Surface Data (GeoJSON data for Ethiopia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_eth_roadsurface_lines.geojson
  format: null
  id: resource_ab8060d9
  ...
  title: Ethiopia GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Ethiopia: Road Surface Data (Geopackage data for Ethiopia.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_eth_roadsurface_lines.gpkg
  format: null
  id: resource_cdab8744
  ...
  temporal: null
  temporal_resolution: null
  title: Ethiopia GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-eth_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Ethiopia: Road Surface Data'
version: null
vulnerability: null
---
