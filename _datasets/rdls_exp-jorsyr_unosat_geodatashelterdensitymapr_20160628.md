...
contact_point:
  ...
  url: https://data.humdata.org/dataset/geodata-of-shelter-density-map-at-rukban-border-crossing-jordan-syria-border-june-28-2016
creator:
  affiliation: null
  email: null
  name: United Nations Satellite Centre (UNOSAT)
  url: https://data.humdata.org/dataset/geodata-of-shelter-density-map-at-rukban-border-crossing-jordan-syria-border-june-28-2016
dataset_id: rdls_exp-jorsyr_unosat_geodatashelterdensitymapr_20160628
description: 'This map illustrates shelters in the area of the Rukban border crossing
  ...
  satellite on 26 June 2016, UNOSAT located 7,925 probable shelters along the Jordanian
  side of the border, 25 kilometers southwest of the Al Waleed crossing. This is an
  24 percent increase in apparent shelters visible compared to the previous UNOSAT
  analysis done using an image collected 23 May 2016. Due to the small size and the
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/geodata-of-shelter-density-map-at-rukban-border-crossing-jordan-syria-border-june-28-2016]'
...
lineage:
  description: UNOSAT analysts interpreted Demios-2 satellite imagery acquired on
    ...
    shelter structures on the Jordanian side of the Syria-Jordan border. Change detection
    analysis compared this image to a previous acquisition from 23 May 2016 to quantify
    temporal trends in shelter density. Shelter locations and attributes were digitized
    into vector geodata with confidence and validation fields.
  sources:
  - id: source_1
    license: null
    name: United Nations Satellite Centre (UNOSAT)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/geodata-of-shelter-density-map-at-rukban-border-crossing-jordan-syria-border-june-28-2016
  rel: source
loss:
  losses: []
project: null
...
- exposure
schema: rdls-10
slug: rdls_exp-jorsyr_unosat_geodatashelterdensitymapr_20160628
spatial:
  bbox: null
  centroid: null
  countries:
