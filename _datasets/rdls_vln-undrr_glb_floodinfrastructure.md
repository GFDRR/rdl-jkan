...
creator:
  email: sadhana.nirandjan@vu.nl
  name: Sadhana Nirandjan
dataset_id: rdls_vln-undrr_glb_floodinfrastructure
...
- coordinate_system: null
  description: Fragility and vulnerability functions as damage factor with associated
    economic costs
  download_url: https://github.com/GFDRR/rdl-jkan/blob/rdl-0.3/dataset_download/CI_VLN-FL.zip
  format: xlsx
  id: '0'
...
- vulnerability
schema: rdl-02
slug: rdls_vln-undrr_glb_floodinfrastructure
spatial:
  countries:
  - GLO
  scale: global
