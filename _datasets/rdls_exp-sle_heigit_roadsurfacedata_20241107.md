...
- entity:
    ...
    url: https://data.humdata.org/dataset/sierra-leone-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/sierra-leone-road-surface-data
dataset_id: rdls_exp-sle_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0688 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0032 and 0.0218
  (in million kms), corressponding to 4.6778% and 31.6255% respectively of the total
  road length in the dataset region. 0.0438 million km or 63.6967% of road surface
  ...
  to 1.1796% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sierra-leone-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    classification using a hybrid deep learning approach trained to distinguish paved
    from unpaved surfaces. The model predictions were integrated with existing OSM
    surface attributes to create a comprehensive road surface inventory for Sierra
    Leone, supporting humanitarian access and infrastructure planning applications.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/sierra-leone-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Sierra Leone: Road Surface Data (GeoJSON data for Sierra leone.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_sle_roadsurface_lines.geojson
  format: null
  id: resource_1790bc7b
  ...
  title: Sierra leone GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Sierra Leone: Road Surface Data (Geopackage data for Sierra leone.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_sle_roadsurface_lines.gpkg
  format: null
  id: resource_e7cd5750
  ...
  temporal: null
  temporal_resolution: null
  title: Sierra leone GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-sle_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Sierra Leone: Road Surface Data'
version: null
vulnerability: null
---
