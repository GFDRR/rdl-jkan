...
- entity:
    ...
    url: https://data.humdata.org/dataset/kiribati-level-1-exposure-data
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Global Earthquake Model Foundation
  url: https://data.humdata.org/dataset/kiribati-level-1-exposure-data
dataset_id: rdls_exp-kir_gem_level1exposuredata_20200505
description: 'This data was developed as part of the Modelling Exposure Through Earth
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kiribati-level-1-exposure-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Building exposure data for Kiribati was developed through the METEOR
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kiribati-level-1-exposure-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: OED format (csv) Level 1 exposure data for Kiribati produced by ImageCat
    and the METEOR project consortium.
  download_url: https://data.humdata.org/dataset/c03430e9-4d4f-44a5-a3d9-3f34810b39a7/resource/47699bc7-d128-41dd-9c31-e0dd63049537/download/kir_oed_exposure_20200811_hdx.zip
  format: null
  id: resource_47699bc7
  ...
  title: KIR_oed_exposure_20200811_hdx.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-kir_gem_level1exposuredata_20200505
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-05-05'
temporal_resolution: null
title: 'Kiribati: Level 1 Exposure Data'
version: null
vulnerability: null
---
