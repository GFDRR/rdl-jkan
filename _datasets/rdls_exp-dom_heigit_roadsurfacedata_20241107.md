...
- entity:
    ...
    url: https://data.humdata.org/dataset/dominican-republic-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/dominican-republic-road-surface-data
dataset_id: rdls_exp-dom_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  Roughly 0.0827 million km of roads are mapped in OSM in this region. Based on AI-mapped
  estimates the share of paved and unpaved roads is approximately 0.0124 and 0.0054
  (in million kms), corressponding to 15.0271% and 6.5606% respectively of the total
  road length in the dataset region. 0.0648 million km or 78.4123% of road surface
  information is missing in OSM. In order to fill this gap, Mapillary derived road
  surface dataset provides an additional 0.0005 million km of information (corressponding
  to 0.6976% of total missing information on road surface) It is intended for use
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/dominican-republic-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced with AI-based surface
    classification using a hybrid deep learning approach to predict paved vs unpaved
    road surfaces. The resulting dataset provides geometric road features with both
    OSM-derived and model-predicted surface classifications, supporting humanitarian
    access and infrastructure planning assessments.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/dominican-republic-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Dominican Republic: Road Surface Data (GeoJSON data for Dominican
    republic.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_dom_roadsurface_lines.geojson
  format: null
  id: resource_1c1eb6a5
  ...
  title: Dominican republic GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Dominican Republic: Road Surface Data (Geopackage data for Dominican
    republic.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_dom_roadsurface_lines.gpkg
  format: null
  id: resource_6fa03687
  ...
  temporal: null
  temporal_resolution: null
  title: Dominican republic GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-dom_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Dominican Republic: Road Surface Data'
version: null
vulnerability: null
---
