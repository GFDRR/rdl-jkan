...
- entity:
    ...
    url: https://data.humdata.org/dataset/geo-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/geo-ndvi-subnational
dataset_id: rdls_hzd-geo_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/geo-ndvi-subnational]'
...
lineage:
  description: Raw MODIS AQUA and TERRA 16-day composite products (MYD13C1 and MOD13C1)
    ...
    NDVI values by subnational administrative units defined by WFP. NDVI anomalies
    were calculated as percentage deviations from long-term averages to characterize
    vegetation stress indicative of agricultural drought conditions.
  sources:
  - id: source_1
    license: null
    name: NASA Moderate Resolution Imaging Spectroradiometer (MODIS)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/geo-ndvi-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135514036671_e4a7f5d3'
  download_url: https://data.humdata.org/dataset/07dbb4d1-76af-4d86-844b-130bf88db476/resource/5f796166-9d4b-48d8-9ea7-d5dd5a5a602c/download/geo-ndvi-subnat-full.csv
  format: null
  id: resource_5f796166
  media_type: text/csv
  spatial: null
  ...
  title: geo-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135514036671_e4a7f5d3'
  download_url: https://data.humdata.org/dataset/07dbb4d1-76af-4d86-844b-130bf88db476/resource/85909285-e526-462d-bbb2-0cd89dd44b94/download/geo-ndvi-subnat-5ytd.csv
  format: null
  id: resource_85909285
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: geo-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-geo_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Georgia: NDVI at Subnational Level'
version: null
vulnerability: null
---
