...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-tokelau
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-tokelau
dataset_id: rdls_exp-tkl_kontur_tokelaupopulationdensity4_2023
description: 'Tokelau population density for 400m H3 hexagons. Built from Kontur Population:
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-tokelau]'
...
lineage:
  description: Population density estimates were generated by fusing multiple global
    ...
    at 400m resolution. The methodology overlays settlement layers and building footprints
    to produce spatially consistent population counts suitable for disaster risk assessment
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-tokelau
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Tokelau: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TK_20220630.gpkg.gz
  format: null
  id: resource_b2a3e0cb
  ...
  title: kontur_population_TK_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Tokelau: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_TK_20231101.gpkg.gz
  format: null
  id: resource_7e0ee019
  media_type: application/geopackage+sqlite3
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: kontur_population_TK_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tkl_kontur_tokelaupopulationdensity4_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Tokelau: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
