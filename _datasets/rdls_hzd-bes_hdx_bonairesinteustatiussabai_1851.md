...
- entity:
    ...
    url: https://data.humdata.org/dataset/bes-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/bes-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-bes_hdx_bonairesinteustatiussabai_1851
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/bes-ibtracs-tropical-storm-tracks]'
...
license: CC-BY-4.0
lineage:
  description: IBTrACS merges historical and recent tropical cyclone data from multiple
    international agencies (WMO, RSMC, national meteorological services) into a unified
    best-track dataset. Track positions, wind speeds (wmo_wind), and central pressures
    (wmo_pres) are standardized and quality-controlled. The dataset for Bonaire, Sint
    Eustatius and Saba represents all tropical cyclone observations affecting this
    Caribbean region extracted from the global IBTrACS archive.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/bes-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/c825aebd-aa54-4e28-bace-95d957df9105/resource/a08c4a7e-6e86-4f96-8147-e57c40845773/download/ibtracs_all_list_v04r01_bes.csv
  format: null
  id: resource_a08c4a7e
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_BES.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1851 to date that pass within 2000 kilometers
    of Bonaire, Sint Eustatius and Saba.
  download_url: https://data.humdata.org/dataset/c825aebd-aa54-4e28-bace-95d957df9105/resource/fd46d666-651c-4287-8b85-dbc129a25bb8/download/ibtracs_all_list_v04r01_lines_bes.geojson
  format: null
  id: resource_fd46d666
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_BES.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-bes_hdx_bonairesinteustatiussabai_1851
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1851-06-29'
temporal_resolution: null
title: 'Bonaire, Sint Eustatius and Saba: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
