...
- entity:
    ...
    url: https://data.humdata.org/dataset/cck-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/cck-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-cck_hdx_cocoskeelingislandsibtrac_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/cck-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone observations from multiple national
    ...
    intervals and merged using a standardized algorithm to create the most complete
    global collection of tropical cyclone hazard data.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/cck-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/6b2ba5c1-7d48-40b2-8baf-d110d1668423/resource/7dbb655d-dd88-42c6-9f7a-32397033e220/download/ibtracs_all_list_v04r01_cck.csv
  format: null
  id: resource_7dbb655d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_CCK.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Cocos (Keeling) Islands.
  download_url: https://data.humdata.org/dataset/6b2ba5c1-7d48-40b2-8baf-d110d1668423/resource/1f3e6d19-72d8-4b1e-9360-0155c1524f62/download/ibtracs_all_list_v04r01_lines_cck.geojson
  format: null
  id: resource_1f3e6d19
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_CCK.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-cck_hdx_cocoskeelingislandsibtrac_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'Cocos (Keeling) Islands: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
