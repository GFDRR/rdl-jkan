...
- entity:
    ...
    url: https://data.humdata.org/dataset/slv-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/slv-ghsl
dataset_id: rdls_exp-slv_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/slv-ghsl]'
...
lineage:
  description: The GHSL dataset integrates fine-scale satellite imagery from Copernicus,
    ...
    and population distribution at global scale, applied here to El Salvador.
  sources:
  - id: source_1
    license: null
    name: European Commission, Joint Research Centre (JRC)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/slv-ghsl
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/9c91b180-372c-4496-ae81-3a55833405c2/resource/aee79424-4f59-4e3b-8f3b-5da6d78131db/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_slv.tif
  format: null
  id: resource_aee79424
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: 'El Salvador: Copernicus Global Human Settlement Layer (GHSL) (Product:
    GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)'
  download_url: https://data.humdata.org/dataset/9c91b180-372c-4496-ae81-3a55833405c2/resource/ba895409-d181-4ede-8156-79972935921f/download/ghs_pop_e2025_r2023a_54009_100_v1_0_slv.tif
  format: null
  id: resource_ba895409
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-slv_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: 'El Salvador: Copernicus Global Human Settlement Layer (GHSL)'
version: null
vulnerability: null
---
