...
- entity:
    ...
    url: https://data.humdata.org/dataset/chad-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/chad-road-surface-data
dataset_id: rdls_exp-tcd_heigit_roadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/chad-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    ...
    model generated predictions for approximately 0.2286 million km of mapped roads
    in Chad, with results provided in both GeoJSON and GeoPackage formats containing
    geometry, surface classifications, and prediction confidence metrics.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/chad-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Chad: Road Surface Data (GeoJSON data for Chad.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tcd_roadsurface_lines.geojson
  format: null
  id: resource_644551b6
  ...
  title: Chad GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Chad: Road Surface Data (Geopackage data for Chad.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tcd_roadsurface_lines.gpkg
  format: null
  id: resource_013f92c7
  ...
  temporal: null
  temporal_resolution: null
  title: Chad GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tcd_heigit_roadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
