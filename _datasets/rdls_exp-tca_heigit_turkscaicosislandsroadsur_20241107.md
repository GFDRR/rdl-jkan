...
- entity:
    ...
    url: https://data.humdata.org/dataset/turks-and-caicos-islands-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/turks-and-caicos-islands-road-surface-data
dataset_id: rdls_exp-tca_heigit_turkscaicosislandsroadsur_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/turks-and-caicos-islands-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was enhanced using a hybrid deep
    learning model developed by HeiGIT to classify road surfaces as paved or unpaved.
    The model predictions were integrated with existing OSM surface attributes, prioritizing
    OSM data where available and using AI predictions to fill gaps, resulting in a
    comprehensive road surface classification dataset for humanitarian access and
    logistics planning.
  sources:
  - id: source_1
    license: null
...
- access_url: null
  ...
  description: 'Turks and Caicos Islands: Road Surface Data (GeoJSON data for Turks
    and caicos islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tca_roadsurface_lines.geojson
  format: null
  id: resource_d9291a7d
  ...
  title: Turks and caicos islands GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Turks and Caicos Islands: Road Surface Data (Geopackage data for Turks
    and caicos islands.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_tca_roadsurface_lines.gpkg
  format: null
  id: resource_f8f1dc98
  ...
  temporal: null
  temporal_resolution: null
  title: Turks and caicos islands GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-tca_heigit_turkscaicosislandsroadsur_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Turks and Caicos Islands: Road Surface Data'
version: null
vulnerability: null
---
