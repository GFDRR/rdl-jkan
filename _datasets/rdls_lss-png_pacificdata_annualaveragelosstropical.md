...
dataset_id: rdls_lss-png_pacificdata_annualaveragelosstropical
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://geonode.pacificdata.org/catalogue/#/dataset/267
  rel: source
loss:
  losses:
...
publisher:
  ...
  url: https://geonode.pacificdata.org/catalogue/#/dataset/267
purpose: null
referenced_by: []
resources:
- access_url: null
  ...
  description: Annual Average Loss from Tropical Cyclones and Earthquakes at district
    level for Papua New Guinea (Zipped Shapefile)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Apg_localgovernmentlevel_aal_tc_eq&outputFormat=SHAPE-ZIP&srs=EPSG%3A4326&format_options=charset%3AUTF-8
  format: null
  id: resource_0
...
- access_url: null
  ...
  coordinate_system: EPSG:4326
  description: Annual Average Loss from Tropical Cyclones and Earthquakes at district
    level for Papua New Guinea (GML 3.1.1)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Apg_localgovernmentlevel_aal_tc_eq&outputFormat=text%2Fxml%3B+subtype%3Dgml%2F3.1.1&srs=EPSG%3A4326
  format: null
  id: resource_1
...
- access_url: null
  ...
  coordinate_system: EPSG:4326
  description: Annual Average Loss from Tropical Cyclones and Earthquakes at district
    level for Papua New Guinea (CSV)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Apg_localgovernmentlevel_aal_tc_eq&outputFormat=csv&srs=EPSG%3A4326
  format: null
  id: resource_2
  media_type: text/csv
  spatial: null
...
- access_url: null
  ...
  coordinate_system: EPSG:4326
  description: Annual Average Loss from Tropical Cyclones and Earthquakes at district
    level for Papua New Guinea (Excel)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Apg_localgovernmentlevel_aal_tc_eq&outputFormat=excel&srs=EPSG%3A4326
  format: null
  id: resource_3
...
- access_url: null
  ...
  coordinate_system: EPSG:4326
  description: Annual Average Loss from Tropical Cyclones and Earthquakes at district
    level for Papua New Guinea (JSON)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Apg_localgovernmentlevel_aal_tc_eq&outputFormat=json&srs=EPSG%3A4326&srsName=EPSG%3A4326
  format: null
  id: resource_4
...
- access_url: null
  ...
  coordinate_system: EPSG:4326
  description: Annual Average Loss from Tropical Cyclones and Earthquakes at district
    level for Papua New Guinea (GML 2.0)
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typename=geonode%3Apg_localgovernmentlevel_aal_tc_eq&outputFormat=gml2&srs=EPSG%3A4326
  format: null
  id: resource_5
  media_type: application/gml+xml
  spatial: null
  ...
  temporal_resolution: null
  title: GML 2.0
- access_url: https://geonode.pacificdata.org/datasets/geonode:pg_localgovernmentlevel_aal_tc_eq
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: EPSG:4326
  description: 'Annual Average Loss from Tropical Cyclones and Earthquakes at district
    level for Papua New Guinea (OGC WMS: geonode Service)'
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WMS&version=1.1.1&request=GetMap&layers=geonode:pg_localgovernmentlevel_aal_tc_eq&format=image%2Fpng
  format: null
  id: resource_6
...
- access_url: https://geonode.pacificdata.org/datasets/geonode:pg_localgovernmentlevel_aal_tc_eq
  ...
  coordinate_system: EPSG:4326
  description: 'Annual Average Loss from Tropical Cyclones and Earthquakes at district
    level for Papua New Guinea (OGC WFS: geonode Service)'
  download_url: https://geonode.pacificdata.org/geoserver/ows?service=WFS&version=1.0.0&request=GetFeature&typeName=geonode:pg_localgovernmentlevel_aal_tc_eq&outputFormat=application%2Fjson
  format: null
  id: resource_7
  media_type: application/geo+json
  spatial: null
...
- loss
schema: rdls-10
slug: rdls_lss-png_pacificdata_annualaveragelosstropical
spatial:
  bbox:
  - 140.8405349997904
  - -11.65615599969965
...
temporal: null
temporal_resolution: null
title: Annual Average Loss from Tropical Cyclones and Earthquakes at district level
