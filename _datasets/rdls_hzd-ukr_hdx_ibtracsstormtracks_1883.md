...
- entity:
    ...
    url: https://data.humdata.org/dataset/ukr-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/ukr-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-ukr_hdx_ibtracsstormtracks_1883
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/ukr-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    The Ukraine subset contains observed storm track positions (latitude, longitude,
    ISO timestamp), basin/sub-basin classification, nature of the system, and physical
    parameters (WMO wind speed and pressure) extracted from the global IBTrACS archive.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/ukr-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Ukraine.
  download_url: https://data.humdata.org/dataset/53b4a1ad-344e-414c-b6b5-a581d361a2f1/resource/435fc567-227d-4508-8166-6422bdeb47cc/download/ibtracs_all_list_v04r01_ukr.csv
  format: null
  id: resource_435fc567
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_UKR.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1883 to date that pass within 2000 kilometers
    of Ukraine.
  download_url: https://data.humdata.org/dataset/53b4a1ad-344e-414c-b6b5-a581d361a2f1/resource/ea2df28c-9509-4db4-adf5-1b8087c4a231/download/ibtracs_all_list_v04r01_lines_ukr.geojson
  format: null
  id: resource_ea2df28c
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_UKR.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-ukr_hdx_ibtracsstormtracks_1883
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1883-08-20'
temporal_resolution: null
title: 'Ukraine: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
