...
- entity:
    ...
    url: https://data.humdata.org/dataset/anguilla-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/anguilla-road-surface-data
dataset_id: rdls_exp-aia_heigit_anguillaroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/anguilla-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network data from OpenStreetMap was processed using a hybrid deep
    ...
    comprehensive road surface inventory with both observed and predicted surface
    classifications across Anguilla.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/anguilla-road-surface-data
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'Anguilla: Road Surface Data (GeoJSON data for Anguilla.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_aia_roadsurface_lines.geojson
  format: null
  id: resource_a3fd8640
  ...
  title: Anguilla GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Anguilla: Road Surface Data (Geopackage data for Anguilla.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_aia_roadsurface_lines.gpkg
  format: null
  id: resource_2d0f7e7b
  ...
  temporal: null
  temporal_resolution: null
  title: Anguilla GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-aia_heigit_anguillaroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Anguilla: Road Surface Data'
version: null
vulnerability: null
---
