...
- entity:
    ...
    url: https://data.humdata.org/dataset/civ-ghsl
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: Copernicus
  url: https://data.humdata.org/dataset/civ-ghsl
dataset_id: rdls_exp-civ_copernicus_globalhumansettlementlaye_2025
description: 'Open and free data for assessing the human presence on the planet. The
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/civ-ghsl]'
...
lineage:
  description: "The GHSL dataset integrates fine-scale satellite imagery from Copernicus,\
    ...
    \ and population distribution at global scale. The resulting GeoTIFF rasters represent\
    \ spatially explicit exposure inventories for buildings and population in C\xF4\
    te d'Ivoire."
  sources:
  - id: source_1
    license: null
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/civ-ghsl
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Product: GHS-BUILT-S, Epoch: 2025, Resolution: 100m, Coordinate system:
    ...
    classification.'
  download_url: https://data.humdata.org/dataset/c62a3338-8a2f-4e82-8f13-fb36e5744edb/resource/26b325fc-c0f3-496a-9ce2-456a801f192f/download/ghs_built_s_e2025_r2023a_54009_100_v1_0_civ.tif
  format: null
  id: resource_26b325fc
...
- access_url: null
  ...
  conforms_to: null
  coordinate_system: null
  description: "C\xF4te d'Ivoire: Copernicus Global Human Settlement Layer (GHSL)\
    \ (Product: GHS-POP, Epoch: 2025, Resolution: 100m, Coordinate system: Mollweide)"
  download_url: https://data.humdata.org/dataset/c62a3338-8a2f-4e82-8f13-fb36e5744edb/resource/85ab5836-9619-4751-a639-13bbf808578f/download/ghs_pop_e2025_r2023a_54009_100_v1_0_civ.tif
  format: null
  id: resource_85ab5836
  media_type: image/tiff;application=geotiff
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
...
- exposure
schema: rdls-10
slug: rdls_exp-civ_copernicus_globalhumansettlementlaye_2025
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2025-01-01'
temporal_resolution: null
title: "C\xF4te d'Ivoire: Copernicus Global Human Settlement Layer (GHSL)"
version: null
vulnerability: null
---
