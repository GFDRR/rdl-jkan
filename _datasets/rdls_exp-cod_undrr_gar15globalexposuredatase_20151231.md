...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-congo-democratic-republic-of-the
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-congo-democratic-republic-of-the
dataset_id: rdls_exp-cod_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-congo-democratic-republic-of-the]'
...
lineage:
  description: National-level socio-economic, building type, and capital stock statistics
    were transposed onto 5x5 km and 1x1 km gridded layers using geographic population
    distribution and GDP as spatial proxies. The dataset was developed collaboratively
    by UNEP-GRID, WAPMERR, EU JRC, and Kokusai Kogyo for the GAR15 global exposure
    database, providing gridded estimates of economic value and asset distribution
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-congo-democratic-republic-of-the
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Congo (Democratic Republic of the).zip
  download_url: https://data.humdata.org/dataset/ebb5514b-5286-400e-b9d7-5ea88a7227c4/resource/268f3b9a-87fd-427f-9a86-e17b3ae5db3d/download/cod.zip
  format: null
  id: resource_268f3b9a
  ...
  title: GAR15 Global Exposure Dataset for Congo (Democratic Republic of the).zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-cod_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Congo (Democratic Republic of the)
version: null
vulnerability: null
---
