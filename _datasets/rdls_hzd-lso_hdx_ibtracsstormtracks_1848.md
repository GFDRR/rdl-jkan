...
- entity:
    ...
    url: https://data.humdata.org/dataset/lso-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/lso-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-lso_hdx_ibtracsstormtracks_1848
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/lso-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS integrates tropical cyclone track data from multiple international
    agencies into a unified best-track archive. The dataset for Lesotho contains observed
    storm positions, wind speeds (wmo_wind), and pressure measurements (wmo_pres)
    with temporal and spatial coordinates, representing actual historical cyclone
    observations rather than modeled or probabilistic hazard estimates.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/lso-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Lesotho.
  download_url: https://data.humdata.org/dataset/5c15db5f-bc67-4314-b564-2c32e002efe1/resource/ea52df37-78fe-4d9d-b606-4f0b04af9119/download/ibtracs_all_list_v04r01_lso.csv
  format: null
  id: resource_ea52df37
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_LSO.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1848 to date that pass within 2000 kilometers
    of Lesotho.
  download_url: https://data.humdata.org/dataset/5c15db5f-bc67-4314-b564-2c32e002efe1/resource/5f9e8080-9378-43be-a1ac-3d2f85678cdb/download/ibtracs_all_list_v04r01_lines_lso.geojson
  format: null
  id: resource_5f9e8080
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_LSO.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-lso_hdx_ibtracsstormtracks_1848
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1848-01-11'
temporal_resolution: null
title: 'Lesotho: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
