...
- entity:
    ...
    url: https://data.humdata.org/dataset/barbados-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/barbados-road-surface-data
dataset_id: rdls_exp-brb_heigit_barbadosroadsurfacedata_20241107
description: 'This dataset provides detailed information on road surfaces from OpenStreetMap
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/barbados-road-surface-data]'
details: null
exposure:
- asset_type:
...
lineage:
  description: Road network geometries from OpenStreetMap were processed through a
    ...
    model predictions were integrated with existing OSM surface attributes to create
    a comprehensive road surface dataset for Barbados, with both OSM-based and AI-predicted
    classifications provided for comparison.
  sources:
  - id: source_1
    license: null
    name: OpenStreetMap (OSM)
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/barbados-road-surface-data
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Barbados: Road Surface Data (GeoJSON data for Barbados.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_brb_roadsurface_lines.geojson
  format: null
  id: resource_5d8064a5
  ...
  title: Barbados GeoJSON Resource
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Barbados: Road Surface Data (Geopackage data for Barbados.)'
  download_url: https://downloads.ohsome.org/hdx/mapillary_road_surface/heigit_brb_roadsurface_lines.gpkg
  format: null
  id: resource_39bef216
  ...
  temporal: null
  temporal_resolution: null
  title: Barbados GeoPackage Resource
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-brb_heigit_barbadosroadsurfacedata_20241107
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2024-11-07'
temporal_resolution: null
title: 'Barbados: Road Surface Data'
version: null
vulnerability: null
---
