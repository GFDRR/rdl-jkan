...
- entity:
    ...
    url: https://data.humdata.org/dataset/kontur-population-australia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: Kontur
  url: https://data.humdata.org/dataset/kontur-population-australia
dataset_id: rdls_exp-aus_kontur_populationdensity400mh3he_2023
description: 'Australia population density for 400m H3 hexagons. Built from Kontur
  ...
  from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/kontur-population-australia]'
...
lineage:
  description: Population density estimates were derived by fusing multiple global
    ...
    LINZ, and OpenStreetMap) and allocating population counts to 400m H3 hexagonal
    grid cells using the H3 hierarchical spatial indexing system. The resulting gridded
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/kontur-population-australia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: 'Australia: Population Density for 400m H3 Hexagons (Release 2022-06-30)'
  download_url: https://geodata-eu-central-1-kontur-public.s3.amazonaws.com/kontur_datasets/kontur_population_AU_20220630.gpkg.gz
  format: null
  id: resource_e222c59a
  ...
  title: kontur_population_AU_20220630.gpkg
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Australia: Population Density for 400m H3 Hexagons (Release 2023-11-01)'
  ...
  temporal: null
  temporal_resolution: null
  title: kontur_population_AU_20231101.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-aus_kontur_populationdensity400mh3he_2023
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2023-07-10'
temporal_resolution: null
title: 'Australia: Population Density for 400m H3 Hexagons'
version: null
vulnerability: null
---
