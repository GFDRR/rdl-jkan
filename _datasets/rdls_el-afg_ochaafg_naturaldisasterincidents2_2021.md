...
- entity:
    ...
    email: null
    name: OCHA
    url: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-in-2021
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: OCHA Afghanistan
  url: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-in-2021
dataset_id: rdls_el-afg_ochaafg_naturaldisasterincidents2_2021
description: '1) Natural disaster events include avalanches, earthquakes, flooding,
  ...
  dataset: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-in-2021]'
...
lineage:
  description: Post-event natural disaster incident data compiled from direct field
    assessments conducted by OCHA and humanitarian partners (ANDMA, IOM, Red Crescent,
    NGOs, ERM) across Afghanistan. Affected population counts and building damage
    figures were extracted from incident reports and assessments submitted by field
    offices during January-July 2021, aggregated into a single incident database covering
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/afghanistan-natural-disaster-incidents-in-2021
  rel: source
loss:
  losses:
...
- access_url: null
  ...
  download_url: https://data.humdata.org/dataset/c35fac3a-1e16-4a77-b221-16dcb997afa9/resource/b34797bf-42b6-4f92-96d6-2b49f70e6885/download/afghanistan-natural-disaster-incidents-from-january-to-july-2021.xlsx
  format: null
  id: resource_b34797bf
  ...
  title: afghanistan-natural-disaster-incidents-from-january-to-july-2021.xlsx
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: Natural disaster events include avalanches, earthquakes, flooding,
    heavy rainfall & snowfall, and landslides & mudflows as recorded by OCHA field
    offices based on assessments in the field.
  download_url: https://data.humdata.org/dataset/c35fac3a-1e16-4a77-b221-16dcb997afa9/resource/d3ee1adf-8c4e-46db-94b8-b5eeec2b339b/download/afghanistan-natural-disaster-incidents-from-january-to-july-2021.csv
  format: null
  id: resource_d3ee1adf
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: afghanistan-natural-disaster-incidents-from-january-to-july-2021.csv
risk_data_type:
- exposure
- loss
schema: rdls-10
slug: rdls_el-afg_ochaafg_naturaldisasterincidents2_2021
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2021-01-01'
temporal_resolution: null
title: Afghanistan - Natural Disaster Incidents in 2021
version: null
vulnerability: null
---
