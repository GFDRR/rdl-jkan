...
- entity:
    ...
    email: null
    name: UNEP-GRID
    url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cambodia
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: United Nations Office for Disaster Risk Reduction (UNDRR)
  url: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cambodia
dataset_id: rdls_exp-khm_undrr_gar15globalexposuredatase_20151231
description: 'The GAR15 global exposure database is based on a top-down approach where
  ...
  (HDX); Original dataset: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cambodia]'
...
lineage:
  description: National socio-economic, building type, and capital stock statistics
    ...
    distribution and GDP as spatial proxies. The dataset was developed through a top-down
    approach by UNEP-GRID in collaboration with WAPMERR, JRC, and Kokusai Kogyo for
    the GAR15 global exposure database.
  sources:
  - id: source_1
    license: null
    name: UNEP-GRID
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/gar15-global-exposure-dataset-for-cambodia
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: GAR15 Global Exposure Dataset for Cambodia.zip
  download_url: https://data.humdata.org/dataset/d302a434-6745-469e-93df-456103eee40d/resource/54d8531b-b60b-4e9d-96cb-ea7fe8bc0496/download/khm.zip
  format: null
  id: resource_54d8531b
  ...
  title: GAR15 Global Exposure Dataset for Cambodia.zip
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-khm_undrr_gar15globalexposuredatase_20151231
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2015-12-31'
temporal_resolution: null
title: GAR15 Global Exposure Dataset for Cambodia
version: null
vulnerability: null
---
