...
- entity:
    ...
    url: https://data.humdata.org/dataset/col-ndvi-subnational
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: WFP - World Food Programme
  url: https://data.humdata.org/dataset/col-ndvi-subnational
dataset_id: rdls_hzd-col_wfp_ndvisubnationallevel_2002
description: 'This dataset contains dekadal NDVI indicators computed from NASA''s
  ...
  Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/col-ndvi-subnational]'
...
lineage:
  description: MODIS Aqua and Terra 16-day composite products (MYD13C1 and MOD13C1)
    ...
    at sub-national administrative units defined by WFP. NDVI anomalies were calculated
    as percentage deviations from long-term averages to support agricultural drought
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/col-ndvi-subnational
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: 'This resource contains the full timeseries to date. File id: 20260123T135446867935_22f64579'
  download_url: https://data.humdata.org/dataset/7f2ba5ba-8df1-41cf-ab18-fc1da928a1e5/resource/b3c16a2b-e563-4d6d-bdea-b3bea835014a/download/col-ndvi-subnat-full.csv
  format: null
  id: resource_b3c16a2b
  media_type: text/csv
  spatial: null
  ...
  title: col-ndvi-subnat-full.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: 'This resource contains a subset of the full timeseries covering the
    past five years to date. File id: 20260123T135446867935_22f64579'
  download_url: https://data.humdata.org/dataset/7f2ba5ba-8df1-41cf-ab18-fc1da928a1e5/resource/be4beefc-ee9d-4eed-ad5f-d99b08975a8e/download/col-ndvi-subnat-5ytd.csv
  format: null
  id: resource_be4beefc
  media_type: text/csv
  spatial: null
  spatial_aggregation: null
  spatial_resolution: null
  temporal: null
  temporal_resolution: null
  title: col-ndvi-subnat-5ytd.csv
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-col_wfp_ndvisubnationallevel_2002
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2002-07-01'
temporal_resolution: null
title: 'Colombia: NDVI at Subnational Level'
version: null
vulnerability: null
---
