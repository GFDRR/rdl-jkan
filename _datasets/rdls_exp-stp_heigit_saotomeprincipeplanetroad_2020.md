...
- entity:
    ...
    url: https://data.humdata.org/dataset/sao-tome-and-principe-planet-road-surface-data
  id: attribution_1
  role: collaborator
- entity:
    affiliation: null
...
creator:
  ...
  name: HeiGIT (Heidelberg Institute for Geoinformation Technology)
  url: https://data.humdata.org/dataset/sao-tome-and-principe-planet-road-surface-data
dataset_id: rdls_exp-stp_heigit_saotomeprincipeplanetroad_2020
description: "This dataset provides AI-derived road surface type, road width, road\
  ...
  \ 0.0001 million km (72.4199%) - Unpaved roads: 0.0 million km (0.0169%) - Missing\
  \ OSM surface tags: 0.0 million km (23.6461%) - PlanetScope predictions cover: 0.0001\
  \ million km (306.3378%) of missing data AI-Derived Attributes Included DL Surface\
  ...
  \ extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/sao-tome-and-principe-planet-road-surface-data]"
details: null
exposure:
- asset_type:
...
lineage:
  description: "Road network data from OpenStreetMap was extracted for arterial highways\
    \ in S\xE3o Tom\xE9 and Pr\xEDncipe. Deep learning models were applied to PlanetScope\
    ...
    \ Index (HPI) with risk scoring. The resulting dataset provides spatially explicit\
...
- access_url: null
  ...
  description: 'Sao Tome and Principe: Planet Road Surface, Width, and Passability
    Data (GeoJSON file for Sao tome and principe)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_ST_planet_roadsurface_lines.geojson
  format: null
  id: resource_4651c24f
  ...
  title: Sao tome and principe GeoJSON heigit_ST_planet_roadsurface_lines.geojson
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  coordinate_system: null
  description: 'Sao Tome and Principe: Planet Road Surface, Width, and Passability
    Data (Geopackage file for Sao tome and principe)'
  download_url: https://warm.storage.heigit.org/heigit-hdx-public/planet_road_data/heigit_ST_planet_roadsurface_lines.gpkg
  format: null
  id: resource_675c5527
  ...
  temporal: null
  temporal_resolution: null
  title: Sao tome and principe GPKG heigit_ST_planet_roadsurface_lines.gpkg
risk_data_type:
- exposure
schema: rdls-10
slug: rdls_exp-stp_heigit_saotomeprincipeplanetroad_2020
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '2020-06-01'
temporal_resolution: null
title: 'Sao Tome and Principe: Planet Road Surface, Width, and Passability Data'
version: null
vulnerability: null
---
