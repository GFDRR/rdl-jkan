...
- entity:
    ...
    url: https://data.humdata.org/dataset/qat-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/qat-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-qat_hdx_ibtracsstormtracks_1842
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/qat-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    ...
    Track positions, timestamps, wind speeds, and central pressures are quality-controlled
    and standardized. The Qatar subset contains all cyclone tracks affecting or passing
    through the Qatar region with 6-hourly or sub-6-hourly observations.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/qat-ibtracs-tropical-storm-tracks
  rel: source
loss:
  losses: []
project: null
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Qatar.
  download_url: https://data.humdata.org/dataset/db5ae928-7dee-4d63-9b16-8ea9387408ae/resource/ab914029-6ce8-4b92-9ccf-89d3d5fc6622/download/ibtracs_all_list_v04r01_qat.csv
  format: null
  id: resource_ab914029
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_QAT.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1842 to date that pass within 2000 kilometers
    of Qatar.
  download_url: https://data.humdata.org/dataset/db5ae928-7dee-4d63-9b16-8ea9387408ae/resource/24a594bb-da20-4cbe-a532-fe14a319095e/download/ibtracs_all_list_v04r01_lines_qat.geojson
  format: null
  id: resource_24a594bb
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_QAT.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-qat_hdx_ibtracsstormtracks_1842
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1842-10-25'
temporal_resolution: null
title: 'Qatar: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
