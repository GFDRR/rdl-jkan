...
- entity:
    ...
    url: https://data.humdata.org/dataset/hun-ibtracs-tropical-storm-tracks
  id: attribution_1
  role: collaborator
...
creator:
  ...
  name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
    for Environmental Information (NCEI)
  url: https://data.humdata.org/dataset/hun-ibtracs-tropical-storm-tracks
dataset_id: rdls_hzd-hun_hdx_ibtracsstormtracks_1865
description: 'The International Best Track Archive for Climate Stewardship (IBTrACS)
  ...
  extracted from the Humanitarian Data Exchange (HDX); Original dataset: https://data.humdata.org/dataset/hun-ibtracs-tropical-storm-tracks]'
...
lineage:
  description: IBTrACS merges historical and recent tropical cyclone observations
    from multiple international agencies into a unified best-track dataset. The Hungary
    subset contains observed storm track positions with associated wind speed (wmo_wind)
    and pressure (wmo_pres) measurements at specific times and locations, representing
    actual cyclone observations rather than modeled or probabilistic hazard estimates.
  sources:
  - id: source_1
    license: null
    name: National Oceanic and Atmospheric Administration (NOAA) / National Centers
...
- href: https://docs.riskdatalibrary.org/en/1__0__0/rdls_schema.json
  rel: describedby
- href: https://data.humdata.org/dataset/hun-ibtracs-tropical-storm-tracks
  rel: source
loss: null
project: null
publisher:
...
- access_url: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Hungary.
  download_url: https://data.humdata.org/dataset/da6895cb-449f-4da6-8283-f81a1b125fa8/resource/6bf6371d-73e7-4086-b1aa-15de12921dc5/download/ibtracs_all_list_v04r01_hun.csv
  format: null
  id: resource_6bf6371d
  media_type: text/csv
  spatial: null
  ...
  title: ibtracs_ALL_list_v04r01_HUN.csv
- access_url: null
  baseline_period: null
  climate: null
  conforms_to: null
  ...
  description: IBTrACS storm tracks from 1865 to date that pass within 2000 kilometers
    of Hungary.
  download_url: https://data.humdata.org/dataset/da6895cb-449f-4da6-8283-f81a1b125fa8/resource/9f2f9f2c-378f-4625-b276-766af502e49f/download/ibtracs_all_list_v04r01_lines_hun.geojson
  format: null
  id: resource_9f2f9f2c
  ...
  temporal: null
  temporal_resolution: null
  title: ibtracs_ALL_list_v04r01_lines_HUN.geojson
risk_data_type:
- hazard
schema: rdls-10
slug: rdls_hzd-hun_hdx_ibtracsstormtracks_1865
spatial:
  bbox: null
  centroid: null
  countries:
...
temporal:
  ...
  start: '1865-10-24'
temporal_resolution: null
title: 'Hungary: IBTrACS Storm Tracks'
version: null
vulnerability: null
---
