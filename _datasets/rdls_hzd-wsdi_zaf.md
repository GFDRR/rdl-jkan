...
purpose: 'This dataset is part of the scientific paper: Souverijns, N., De Ridder,
  ...
  and vulnerability analysis. Urban Climate, 46, 101331. https://doi.org/10.1016/j.uclim.2022.101352'
resources:
- coordinate_system: EPSG:4326
  description: Annual number of days with at least six consecutive days when daytime
    temperatures exceed the 90th percentile for the period 2001-2020.
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '0'
  spatial_resolution: null
  title: Warm Spell Duration Index - Johannebsurg & Ekurhuleni (2001-2020)
- coordinate_system: EPSG:4326
  description: Projected annual number of days with at least six consecutive days
    when daytime temperatures exceed the 90th percentile under the RCP 4.5 and 8.5
    scenario for 2021-2040.
  download_url: https://zenodo.org/records/6394130
  format: geotiff
  id: '1'
  spatial_resolution: null
  title: Warm Spell Duration Index - Johannebsurg & Ekurhuleni (2021-2040, RCP4.5
    & RCP8.5)
- coordinate_system: EPSG:4326
  description: Projected annual number of days with at least six consecutive days
    when daytime temperatures exceed the 90th percentile under the RCP 4.5 and 8.5
  ...
  id: '2'
  spatial_resolution: null
  title: Warm Spell Duration Index - Johannebsurg & Ekurhuleni (2041-2060, RCP4.5
    & RCP8.5)
risk_data_type:
- hazard
schema: rdl-02
slug: rdls_hzd-WSDI_ZAF
spatial:
  bbox:
  - 27.676831894273278
  - -26.580113703331147
